...
void ConstantPoolMap::setClassFileOracleAndInitialize(ClassFileOracle* classFileOracle)
{
...
void ConstantPoolMap::computeConstantPoolMapAndSizes()
{
    ...
    if ((NULL == _romConstantPoolEntries) || (NULL == _romConstantPoolTypes) || (NULL == _staticSplitEntries)
...
bool ConstantPoolMap::isVarHandleMethod(U_32 classIndex, U_32 nasIndex)
{
    bool result = false;
    ...
    if ((sizeof(VARHANDLE_CLASS_NAME) - 1) == classNameLength) {
        ...
        if (0 == strcmp(classNameData, VARHANDLE_CLASS_NAME)) {
            ...
            case 3:
                if ((0 == strcmp(methodNameData, "get")) || (0 == strcmp(methodNameData, "set"))) {
                    result = true;
                }
                break;
            case 9:
                if ((0 == strcmp(methodNameData, "getOpaque")) || (0 == strcmp(methodNameData, "setOpaque"))
                    || (0 == strcmp(methodNameData, "getAndSet")) || (0 == strcmp(methodNameData, "getAndAdd"))) {
                    result = true;
                }
                break;
            case 10:
                if ((0 == strcmp(methodNameData, "getAcquire")) || (0 == strcmp(methodNameData, "setRelease"))) {
                    result = true;
                }
                break;
            case 11:
                if ((0 == strcmp(methodNameData, "getVolatile")) || (0 == strcmp(methodNameData, "setVolatile"))) {
                    result = true;
                }
                break;
            case 16:
            ...
            case 25:
                ...
                break;
            default:
                if ((0 == strcmp(methodNameData, "compareAndSet")) || (0 == strcmp(methodNameData, "getAndBitwiseOr"))
...
void ConstantPoolMap::findVarHandleMethodRefs()
{
    PORT_ACCESS_FROM_PORT(_context->portLibrary());
        ...
        if ((J9CPTYPE_INSTANCE_METHOD == _romConstantPoolTypes[i])
            ...
            if (isVarHandleMethod(slot1, slot2)) {
                if (NULL == varHandleMethodTable) {
                    ...
                    varHandleMethodTable
                        = (U_16*)j9mem_allocate_memory(_romConstantPoolCount * sizeof(U_16), OMRMEM_CATEGORY_VM);
                    if (NULL == varHandleMethodTable) {
                        _buildResult = OutOfMemory;
                        break;
                    }
    ...
    if (NULL != varHandleMethodTable) {
        _varHandleMethodTypeLookupTable
            = (U_16*)j9mem_allocate_memory(_varHandleMethodTypeCount * sizeof(U_16), OMRMEM_CATEGORY_VM);
...
void ConstantPoolMap::constantPoolDo(ConstantPoolVisitor* visitor)
{
    for (UDATA i = 1; i < _romConstantPoolCount; i++) {
        ...
        case J9CPTYPE_CONSTANT_DYNAMIC:
             ...
             */
            {
                ...
                case 'B':
                    visitor->visitConstantDynamic(
                        slot1, slot2, (J9DescriptionReturnTypeByte << J9DescriptionReturnTypeShift));
                    break;
                case 'C':
                    visitor->visitConstantDynamic(
                        slot1, slot2, (J9DescriptionReturnTypeChar << J9DescriptionReturnTypeShift));
                    break;
                case 'D':
                    visitor->visitConstantDynamic(
                        slot1, slot2, (J9DescriptionReturnTypeDouble << J9DescriptionReturnTypeShift));
                    break;
                case 'F':
                    visitor->visitConstantDynamic(
                        slot1, slot2, (J9DescriptionReturnTypeFloat << J9DescriptionReturnTypeShift));
                    break;
                case 'I':
                    visitor->visitConstantDynamic(
                        slot1, slot2, (J9DescriptionReturnTypeInt << J9DescriptionReturnTypeShift));
                    break;
                case 'J':
                    visitor->visitConstantDynamic(
                        slot1, slot2, (J9DescriptionReturnTypeLong << J9DescriptionReturnTypeShift));
                    break;
                case 'S':
                    visitor->visitConstantDynamic(
                        slot1, slot2, (J9DescriptionReturnTypeShort << J9DescriptionReturnTypeShift));
                    break;
                case 'Z':
                    visitor->visitConstantDynamic(
                        slot1, slot2, (J9DescriptionReturnTypeBoolean << J9DescriptionReturnTypeShift));
                    break;
                default:
