 ...
 * 		That is the reason why these values are bitwise, all the range check results between start/end addresses of
 * shared cache(s) and a specific memory address are ORed.
 *
 */
...
public:
    ...
    bool findUtf8(J9InternSearchInfo* searchInfo, J9SharedInvariantInternTable* sharedInternTable,
        bool requiresSharedUtf8, J9InternSearchResult* result);

    void markNodeAsUsed(J9InternSearchResult* result, J9SharedInvariantInternTable* sharedInternTable);

    void internUtf8(J9UTF8* utf8, J9ClassLoader* classLoader, bool fromSharedROMClass = false,
        J9SharedInvariantInternTable* sharedInternTable = NULL);
     ...
     *
     */
    static bool areAddressesInSRPRange(void* addr1, void* addr2)
    {
...
private:
    ...
    J9SharedInternSRPHashTableEntry* insertSharedNode(
    ...
    bool testNodePromotionWeight(J9SharedInvariantInternTable* table, J9InternHashTableEntry* node,
