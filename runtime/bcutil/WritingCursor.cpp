...
void WritingCursor::writeU8(U_8 u8Value, DataType dataType)
{
...
void WritingCursor::writeU16(U_16 u16Value, DataType dataType)
{
...
void WritingCursor::writeU32(U_32 u32Value, DataType dataType)
{
...
void WritingCursor::writeU64(U_32 u32ValueHigh, U_32 u32ValueLow, DataType dataType)
{
...
void WritingCursor::writeUTF8(U_8* UTF8Data, U_16 UTF8Length, DataType dataType)
{
    /* intern this string */
...
void WritingCursor::writeSRP(UDATA srpKey, DataType dataType)
{
...
void WritingCursor::writeWSRP(UDATA srpKey, DataType dataType)
{
...
void WritingCursor::writeData(U_8* bytes, UDATA length, DataType dataType)
{
    U_8* u8Addr = (U_8*)(_baseAddress + _count);
...
void WritingCursor::padToAlignment(UDATA byteAlignment, DataType dataType)
{
...
void WritingCursor::mark(UDATA srpKey) { Trc_BCU_Assert_Equals(_count, getOffsetForSRPKey(srpKey)); }
