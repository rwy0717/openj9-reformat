...
J9TranslationBufferSet* j9bcutil_allocTranslationBuffers(J9PortLibrary* portLib)
{
    ...
    translationBuffers
        = (J9TranslationBufferSet*)j9mem_allocate_memory((UDATA)sizeof(J9TranslationBufferSet), J9MEM_CATEGORY_CLASSES);
...
#ifdef J9VM_OPT_ZIP_SUPPORT
        translationBuffers->closeZipFileFunction = (I_32(*)(J9VMInterface * vmi, struct VMIZipFile * zipFile))(
            (*VMI)->GetZipFunctions(VMI)->zip_closeZipFile);
#endif
