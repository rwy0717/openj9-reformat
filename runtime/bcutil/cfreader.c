...
static I_32 checkAttributes(J9CfrClassFile* classfile, J9CfrAttribute** attributes, U_32 attributesCount, U_8* segment,
    I_32 maxBootstrapMethodIndex, U_32 extra, U_32 flags);
static I_32 readAttributes(J9CfrClassFile* classfile, J9CfrAttribute*** pAttributes, U_32 attributesCount, U_8* data,
...
static I_32 readAnnotations(J9CfrClassFile* classfile, J9CfrAnnotation* pAnnotations, U_32 annotationCount, U_8* data,
    U_8* dataEnd, U_8* segment, U_8* segmentEnd, U_8** pIndex, U_8** pFreePointer, U_32 flags);
static I_32 readTypeAnnotation(J9CfrClassFile* classfile, J9CfrTypeAnnotation* pAnnotations, U_8* data, U_8* dataEnd,
    U_8* segment, U_8* segmentEnd, U_8** pIndex, U_8** pFreePointer, U_32 flags);
static I_32 readAnnotationElement(J9CfrClassFile* classfile, J9CfrAnnotationElement** pAnnotationElement, U_8* data,
    U_8* dataEnd, U_8* segment, U_8* segmentEnd, U_8** pIndex, U_8** pFreePointer, U_32 flags);
...
static I_32 readMethods(J9CfrClassFile* classfile, U_8* data, U_8* dataEnd, U_8* segment, U_8* segmentEnd, U_8** pIndex,
    U_8** pFreePointer, U_32 flags);
static I_32 readPool(J9CfrClassFile* classfile, U_8* data, U_8* dataEnd, U_8* segment, U_8* segmentEnd, U_8** pIndex,
    U_8** pFreePointer);
static I_32 checkDuplicateMembers(
    J9PortLibrary* portLib, J9CfrClassFile* classfile, U_8* segment, U_32 flags, UDATA memberSize);
static I_32 checkPool(
    J9CfrClassFile* classfile, U_8* segment, U_8* poolStart, I_32* maxBootstrapMethodIndex, U_32 flags);
static I_32 checkClass(J9PortLibrary* portLib, J9CfrClassFile* classfile, U_8* segment, U_32 endOfConstantPool,
    U_32 vmVersionShifted, U_32 flags);
static I_32 readFields(J9CfrClassFile* classfile, U_8* data, U_8* dataEnd, U_8* segment, U_8* segmentEnd, U_8** pIndex,
    U_8** pFreePointer, U_32 flags);
...
static const U_8 cpTypeCharConversion[] = { 0, CFR_CONSTANT_Integer, CFR_CONSTANT_Integer, CFR_CONSTANT_Double, 0,
    CFR_CONSTANT_Float, 0, 0, CFR_CONSTANT_Integer, CFR_CONSTANT_Long, 0, CFR_CONSTANT_String, 0, 0, 0, 0, 0, 0,
    CFR_CONSTANT_Integer, 0, 0, 0, 0, 0, 0, CFR_CONSTANT_Integer };
...
static U_8 attributeTagFor(J9CfrConstantPoolInfo* utf8, BOOLEAN stripDebugAttributes)
{
    ...
    return (U_8)(stripDebugAttributes ? CFR_ATTRIBUTE_StrippedUnknown : CFR_ATTRIBUTE_Unknown);
}
    ...
    U_8* dataEnd, U_8* segment, U_8* segmentEnd, U_8** pIndex, U_8** pFreePointer, U_32 flags, UDATA* syntheticFound)
{
    ...
    for (i = 0; i < attributesCount; i++) {
        ...
        case CFR_ATTRIBUTE_Code:
            ...
            if ((result = readAttributes(classfile, &(code->attributes), code->attributesCount, data, dataEnd, segment,
                     segmentEnd, &index, &freePointer, flags, NULL))
                != 0) {
                return result;
            }
            break;
        ...
        case CFR_ATTRIBUTE_LineNumberTable:
            ...
            if (!ALLOC_ARRAY(((J9CfrAttributeLineNumberTable*)attrib)->lineNumberTable,
                    ((J9CfrAttributeLineNumberTable*)attrib)->lineNumberTableLength, J9CfrLineNumberTableEntry)) {
                return -2;
            }
        ...
        case CFR_ATTRIBUTE_LocalVariableTable:
            ...
            if (!ALLOC_ARRAY(((J9CfrAttributeLocalVariableTable*)attrib)->localVariableTable,
        ...
        case CFR_ATTRIBUTE_LocalVariableTypeTable:
            ...
            if (!ALLOC_ARRAY(((J9CfrAttributeLocalVariableTypeTable*)attrib)->localVariableTypeTable,
            ...
            for (j = 0; j < ((J9CfrAttributeLocalVariableTypeTable*)attrib)->localVariableTypeTableLength; j++) {
                ...
                NEXT_U16(
                    ((J9CfrAttributeLocalVariableTypeTable*)attrib)->localVariableTypeTable[j].signatureIndex, index);
        ...
        case CFR_ATTRIBUTE_AnnotationDefault: {
            ...
            result = readAnnotationElement(classfile, &((J9CfrAttributeAnnotationDefault*)attrib)->defaultValue, data,
        ...
        case CFR_ATTRIBUTE_RuntimeVisibleAnnotations: {
            ...
            result = readAnnotations(classfile, annotations->annotations, annotations->numberOfAnnotations, data,
                dataEnd, segment, segmentEnd, &index, &freePointer, flags);
        ...
        case CFR_ATTRIBUTE_MethodParameters:
            ...
            if (!ALLOC_ARRAY(((J9CfrAttributeMethodParameters*)attrib)->methodParametersIndexTable,
                    ((J9CfrAttributeMethodParameters*)attrib)->numberOfMethodParameters, U_16)) {
                return -2;
            }

            if (!ALLOC_ARRAY(((J9CfrAttributeMethodParameters*)attrib)->flags,
                    ((J9CfrAttributeMethodParameters*)attrib)->numberOfMethodParameters, U_16)) {
                return -2;
            }
        ...
        case CFR_ATTRIBUTE_RuntimeVisibleParameterAnnotations: {
            ...
            if (!ALLOC_ARRAY(
                    annotations->parameterAnnotations, annotations->numberOfParameters, J9CfrParameterAnnotations)) {
                return -2;
            }
            ...
            for (j = 0; j < annotations->numberOfParameters; j++, parameterAnnotations++) {
                ...
                if (!ALLOC_ARRAY(parameterAnnotations->annotations, parameterAnnotations->numberOfAnnotations,
                        J9CfrAnnotation)) {
                    return -2;
                }

                result = readAnnotations(classfile, parameterAnnotations->annotations,
                    parameterAnnotations->numberOfAnnotations, data, dataEnd, segment, segmentEnd, &index, &freePointer,
                    flags);
        ...
        case CFR_ATTRIBUTE_RuntimeVisibleTypeAnnotations: {
            ...
            for (j = 0; j < annotations->numberOfAnnotations; j++, typeAnnotations++) {
                result = readTypeAnnotation(
                    classfile, typeAnnotations, data, dataEnd, segment, segmentEnd, &index, &freePointer, flags);
                if (BCT_ERR_NO_ERROR != result) {
                    break;
                }
            }
        ...
        case CFR_ATTRIBUTE_BootstrapMethods:
            ...
            if (!ALLOC_ARRAY(bootstrapMethods->bootstrapMethods, bootstrapMethods->numberOfBootstrapMethods,
            ...
            for (j = 0; j < bootstrapMethods->numberOfBootstrapMethods; j++) {
                ...
                if (!ALLOC_ARRAY(bootstrapMethods->bootstrapMethods[j].bootstrapArguments,
                        bootstrapMethods->bootstrapMethods[j].numberOfBootstrapArguments, U_16)) {
                    return -2;
                }
    ...
    U_8** pFreePointer, U_32 flags)
{
    ...
    for (i = 0; i < classfile->methodsCount; i++) {
        ...
        /* Read the attributes. */
        if ((result = readAttributes(classfile, &(method->attributes), method->attributesCount, data, dataEnd, segment,
                 segmentEnd, &index, &freePointer, flags, &syntheticFound))
            != 0) {
            return result;
        }
        if (syntheticFound) {
    ...
    U_8** pFreePointer, U_32 flags)
{
    ...
    for (i = 0; i < classfile->fieldsCount; i++, field++) {
        ...
        /* Read the attributes. */
        if ((result = readAttributes(classfile, &(field->attributes), field->attributesCount, data, dataEnd, segment,
                 segmentEnd, &index, &freePointer, flags, &syntheticFound))
            != 0) {
            return result;
        }
...
static I_32 readPool(
    J9CfrClassFile* classfile, U_8* data, U_8* dataEnd, U_8* segment, U_8* segmentEnd, U_8** pIndex, U_8** pFreePointer)
{
    U_8* index = *pIndex;
    U_8* freePointer = *pFreePointer;
    J9CfrConstantPoolInfo* info;
...
static I_32 checkMethods(J9CfrClassFile* classfile, U_8* segment, U_32 vmVersionShifted, U_32 flags)
{
    ...
    for (i = 0; i < classfile->methodsCount; i++) {
        ...
        /* Xfuture qualification added to pass CLDC TCK mthacc00601m5_1 - wants 45.3 class file rejected with ACC_STRICT
         * set */
        ...
        if (classfile->accessFlags & CFR_ACC_INTERFACE) {
            if (classfileVersion < BCT_Java8MajorVersionShifted) {
                ...
                /* check that there are no flags set that are not allowed AND the required flags are set */
                if ((value & ~mask)
                    || ((value & CFR_INTERFACE_METHOD_ACCESS_REQUIRED) != CFR_INTERFACE_METHOD_ACCESS_REQUIRED)) {
                ...
                if ((CFR_ACC_ABSTRACT == (value & CFR_ACC_ABSTRACT))
                    && (0 != (value & ~CFR_ABSTRACT_METHOD_ACCESS_MASK))) {
                    errorCode = J9NLS_CFR_ERR_INTERFACE_METHOD_JAVA_8__ID;
                    goto _errorFound;
                }
            }
    ...
    I_32 maxBootstrapMethodIndex, U_32 extra, U_32 flags)
{
    ...
    for (i = 0; i < attributesCount; i++) {
        ...
        case CFR_ATTRIBUTE_Code:
            ...
            if (checkAttributes(
                    classfile, code->attributes, code->attributesCount, segment, -1, code->codeLength, flags)) {
                return -1;
            }
            break;
        ...
        case CFR_ATTRIBUTE_MethodParameters: {
            /* 97986 Errors here are not fatal. Check the validity in
             * ClassFileOracle::walkMethodMethodParametersAttribute */
            break;
        }
        case CFR_ATTRIBUTE_LineNumberTable:
            ...
            for (j = 0; j < bootstrapMethods->numberOfBootstrapMethods; j++) {
                ...
                for (k = 0; k < numberOfBootstrapArguments; k++) {
                    ...
                    default:
                        ...
                        buildBootstrapMethodError(
                            (J9CfrError*)segment, errorCode, errorType, attrib->romAddress, j, value, cpValueTag);
                        return -1;
                    }
                }
            }
    ...
    U_32 vmVersionShifted, U_32 flags)
{
    ...
    if (value == 0) {
        /* Check against j.l.O. */
        if (!utf8Equal(&classfile->constantPool[classfile->constantPool[classfile->thisClass].slot1],
                "java/lang/Object", 16)) {
    ...
    if (classfile->accessFlags & CFR_ACC_INTERFACE) {
        /* Check against j.l.O. */
        if (!utf8Equal(&classfile->constantPool[classfile->constantPool[classfile->superClass].slot1],
                "java/lang/Object", 16)) {
    ...
    if (checkAttributes(classfile, classfile->attributes, classfile->attributesCount, segment, maxBootstrapMethodIndex,
            OUTSIDE_CODE, flags)) {
        return -1;
    }
...
I_32 j9bcutil_readClassFileBytes(J9PortLibrary* portLib,
    IDATA (*verifyFunction)(J9PortLibrary* aPortLib, J9CfrClassFile* classfile, U_8* segment, U_8* segmentLength,
        U_8* freePointer, U_32 vmVersionShifted, U_32 flags, I_32* hasRET),
    U_8* data, UDATA dataLength, U_8* segment, UDATA segmentLength, U_32 flags, U_8** segmentFreePointer,
    void* verboseContext, UDATA findClassFlags, UDATA romClassSortingThreshold)
{
    ...
    /* Read the attributes. */
    if ((result = readAttributes(classfile, &(classfile->attributes), classfile->attributesCount, data, dataEnd,
             segment, segmentEnd, &index, &freePointer, flags, &syntheticFound))
        != 0) {
        Trc_BCU_j9bcutil_readClassFileBytes_Exit(result);
        return result;
    }
    ...
    if (0 != (flags & CFR_StaticVerification)) {
        if ((result = (I_32)(verifyFunction)(
                 portLib, classfile, segment, segmentEnd, freePointer, vmVersionShifted, flags, &hasRET))
            != 0) {
            Trc_BCU_j9bcutil_readClassFileBytes_Exit(result);
            return result;
        }
    ...
    if (((classfile->j9Flags & CFR_J9FLAG_HAS_JSR) == CFR_J9FLAG_HAS_JSR) && ((flags & CFR_LeaveJSRs) == 0)) {
        ...
        if ((classfile->majorVersion >= 51)
            ...
            buildMethodErrorWithExceptionDetails((J9CfrError*)segment, errorCode, 0, CFR_ThrowVerifyError, 0, 0,
                &(classfile->methods[0]), classfile->constantPool, 0, -1, 0);
            Trc_BCU_j9bcutil_readClassFileBytes_VerifyError_Exception(
                ((J9CfrError*)segment)->errorCode, getJ9CfrErrorDescription(portLib, (J9CfrError*)segment));
            Trc_BCU_j9bcutil_readClassFileBytes_Exit(-1);
            return -1;
        }
        ...
        for (i = 0; i < classfile->methodsCount; i++) {
            ...
            if ((method->j9Flags & CFR_J9FLAG_HAS_JSR) == CFR_J9FLAG_HAS_JSR) {
                ...
                Trc_BCU_inlineJsrs_Entry(
                    (classfile->constantPool[classfile->constantPool[classfile->thisClass].slot1]).slot1,
                    (classfile->constantPool[classfile->constantPool[classfile->thisClass].slot1]).bytes,
                    (classfile->constantPool[method->nameIndex]).slot1,
                    (classfile->constantPool[method->nameIndex]).bytes,
                    (classfile->constantPool[method->descriptorIndex]).slot1,
                ...
                if (inlineBuffers.errorCode) {
                    ...
                    if (inlineBuffers.errorCode == BCT_ERR_VERIFY_ERROR_INLINING) {
                        /* Jazz 82615: Set the verbose error type and the local variable index if used for the error
                         * message framework */
                        buildMethodErrorWithExceptionDetails((J9CfrError*)segment, inlineBuffers.verifyError,
                            inlineBuffers.verboseErrorType, CFR_ThrowVerifyError, (I_32)i,
                            (U_16)inlineBuffers.verifyErrorPC, method, classfile->constantPool,
                            inlineBuffers.errorLocalIndex, -1, 0);
        ...
        for (i = 0; i < classfile->methodsCount; i++) {
            ...
            if (CFR_J9FLAG_HAS_JSR == (method->j9Flags & CFR_J9FLAG_HAS_JSR)) {
                ...
                memcpy(method->codeAttribute->code, method->codeAttribute->originalCode,
                    method->codeAttribute->codeLength);
            }
        }
...
_errorFound:
    ...
    Trc_BCU_j9bcutil_readClassFileBytes_ClassFormatError_Exception(
        ((J9CfrError*)segment)->errorCode, getJ9CfrErrorDescription(portLib, (J9CfrError*)segment));
                ...
                for (k = (I_32)(count - 1); k >= 0; k--) {
                    ...
                    for (j = 0; j < name->slot1; j++) {
                        ...
                        if (++j < name->slot1)
                            hash ^= (U_32)RandomValues[name->bytes[j]] << 8;
                        if (++j < name->slot1)
                            hash ^= (U_32)RandomValues[name->bytes[j]] << 16;
                    }
                    for (j = 0; j < sig->slot1; j++) {
                        ...
                        if (++j < sig->slot1)
                            hash ^= (U_32)RandomValues[sig->bytes[j]] << 8;
                        if (++j < sig->slot1)
                            hash ^= (U_32)RandomValues[sig->bytes[j]] << 16;
                    }
                    hash %= tableSize;
...
static BOOLEAN memberEqual(J9CfrClassFile* classfile, J9CfrMember* a, J9CfrMember* b)
{
    return utf8EqualUtf8(&classfile->constantPool[a->nameIndex], &classfile->constantPool[b->nameIndex])
    ...
    U_8* dataEnd, U_8* segment, U_8* segmentEnd, U_8** pIndex, U_8** pFreePointer, U_32 flags)
{
    ...
    for (i = 0; i < annotationCount; i++) {
        ...
        if (!ALLOC_ARRAY(annotationList[i].elementValuePairs, annotationList[i].numberOfElementValuePairs,
        ...
        for (j = 0; j < annotationList[i].numberOfElementValuePairs; j++) {
            ...
            result = readAnnotationElement(classfile, &annotationList[i].elementValuePairs[j].value, data, dataEnd,
...
static I_32 readTypeAnnotation(J9CfrClassFile* classfile, J9CfrTypeAnnotation* tAnn, U_8* data, U_8* dataEnd,
    U_8* segment, U_8* segmentEnd, U_8** pIndex, U_8** pFreePointer, U_32 flags)
{
    U_8 targetType = 0;
    U_8* index = *pIndex;
    ...
    result = readAnnotations(
        classfile, &(tAnn->annotation), 1, data, dataEnd, segment, segmentEnd, &index, &freePointer, flags);
    *pFreePointer = freePointer;
    *pIndex = index;
    return result;
    ...
    U_8* dataEnd, U_8* segment, U_8* segmentEnd, U_8** pIndex, U_8** pFreePointer, U_32 flags)
{
    ...
    case '@':
        ...
        result = readAnnotations(
            classfile, annotation, 1, data, dataEnd, segment, segmentEnd, &index, &freePointer, flags);
        if (BCT_ERR_NO_ERROR != result) {
            return result;
        }
    ...
    case '[':
        ...
        for (j = 0; j < array->numberOfValues; j++, arrayWalk++) {
            result = readAnnotationElement(
                classfile, arrayWalk, data, dataEnd, segment, segmentEnd, &index, &freePointer, flags);
            if (result != 0) {
                return result;
            }
        }
...
static VMINLINE U_16 getUTF8Length(J9CfrConstantPoolInfo* constantPool, U_16 cpIndex)
{
    return (U_16)constantPool[cpIndex].slot1;
}

static VMINLINE U_8* getUTF8Data(J9CfrConstantPoolInfo* constantPool, U_16 cpIndex)
{
...
static IDATA compareMethodIDs(J9CfrConstantPoolInfo* constantPool, J9CfrMethod* a, J9CfrMethod* b)
{
    ...
    return compareMethodNameAndSignature(
        aNameData, aNameLength, aSigData, aSigLength, bNameData, bNameLength, bSigData, bSigLength);
}
