...
void jitResetAllUntranslateableMethods(J9VMThread* vmThread)
{
                ...
                while (0 != methodCount) {
                    if (0 == ((J9_JAVA_NATIVE | J9_JAVA_ABSTRACT) & J9_ROM_METHOD_FROM_RAM_METHOD(method)->modifiers)) {
                        if (J9_JIT_NEVER_TRANSLATE == (IDATA)method->extra) {
                            /* This call resets the methodRunAddress to the JIT counting send target, and reinitializes
                             * the count (extra) field. */
