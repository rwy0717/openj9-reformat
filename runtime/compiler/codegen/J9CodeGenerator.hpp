...
public:
    ...
    void rematerializeCompressedRefs(
        TR::SymbolReference*&, TR::TreeTop*, TR::Node*, int32_t, TR::Node*, vcount_t, List<TR::Node>*);
    ...
    enum GPUScopeType { naturalLoopScope = 0, singleKernelScope = 1 };
...
private:
    ...
    static bool wantToPatchClassPointer(TR::Compilation* comp, const TR_OpaqueClassBlock* allegedClassPointer,
        const char* locationDescription, const void* location)
    {
        ...
        return !performTransformation(comp,
            ...
            allegedClassPointer, locationDescription, location);
    }
...
public:
    static bool wantToPatchClassPointer(
