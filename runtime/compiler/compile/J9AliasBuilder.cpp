...
void J9::AliasBuilder::createAliasInfo()
{
    ...
    static TR_RuntimeHelper helpersThatMayThrow[] = { TR_typeCheckArrayStore, TR_arrayStoreException,
        ...
        TR_monitorExit, TR_newObject, TR_newObjectNoZeroInit, TR_newArray, TR_nullCheck, TR_methodTypeCheck,
        TR_incompatibleReceiver, TR_IncompatibleClassChangeError, TR_multiANewArray };
