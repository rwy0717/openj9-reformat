...
public:
    ...
    TR_MethodToBeCompiled* findAndDequeueFromLPQ(
...
public:
    ...
    { /* TODO: prune list when classes change or get unloaded */
    }
...
public:
    ...
    static void* compilationEnd(J9VMThread* context, TR::IlGeneratorMethodDetails& details, J9JITConfig* jitConfig,
        void* startPC, void* oldStartPC, TR_FrontEnd* vm = 0, TR_MethodToBeCompiled* entry = NULL,
        TR::Compilation* comp = NULL);
    static bool isInterpreted(J9Method* method) { return !isCompiled(method); }
    static bool isCompiled(J9Method* method) { return (((uintptrj_t)method->extra) & J9_STARTPC_NOT_TRANSLATED) == 0; }
    ...
    static int32_t getJ9MethodVMExtra(J9Method* method) { return (int32_t)((intptrj_t)method->extra); }
    ...
    static void setJ9MethodExtra(J9Method* method, intptrj_t newValue) { method->extra = (void*)newValue; }
    ...
    TR_MethodToBeCompiled* getNextMethodToBeCompiled(
        TR::CompilationInfoPerThread* compInfoPT, bool compThreadCameOutOfSleep, TR_CompThreadActions*);
    ...
    void* compileOnApplicationThread(J9VMThread* context, TR::IlGeneratorMethodDetails& details, void* oldStartPC,
        TR_CompilationErrorCode*, TR_OptimizationPlan* optPlan);
    void* compileOnSeparateThread(J9VMThread* context, TR::IlGeneratorMethodDetails& details, void* oldStartPC,
        TR_YesNoMaybe async, TR_CompilationErrorCode*, bool* queued, TR_OptimizationPlan* optPlan);
    void invalidateRequestsForUnloadedMethods(
        TR_OpaqueClassBlock* unloadedClass, J9VMThread* vmThread, bool hotCodeReplacement);
    ...
    void printCompQueue();
    TR::CompilationInfoPerThread* getCompilationInfoForDumpThread() const
    {
    ...
    void emitJvmpiExtendedDataBuffer(
    ...
    */
    ...
    uint64_t computeFreePhysicalLimitAndAbortCompilationIfLow(
...
private:
    ...
    uint8_t* bufferPopulateLineNumberTable(
    ...
    TR::CompilationInfoPerThread*
        _arrayOfCompilationInfoPerThread[MAX_TOTAL_COMP_THREADS]; // first NULL entry means end of the array
