...
/* If debuginfoserver has been loaded and no FSD support, unload this library and aot */
        ...
        /* Platform detection seems difficult at this point.                              */
        {
            ...
            static bool disableZeroedTLHPages
                = disableDualTLH && (((notlhPrefetch >= 0) || (ptype != TR_PPCp6 && ptype != TR_PPCp7)));
#endif // TR_HOST_POWER
#endif // TR_HOST_X86
    ...
    case JIT_INITIALIZED:
        if (isJIT || isAOT) {
            /* We need to initialize the following if we allow JIT compilation, AOT compilation or AOT relocation to be
             * done */
            try {
                /*
                ...
                if (isJIT && argIndexXjit >= 0) {
                    ...
                    do {
                        ...
                        if (!(xjitCommandLineOptions
                                = (char*)j9mem_allocate_memory(size * sizeof(char), J9MEM_CATEGORY_JIT)))
                            return J9VMDLLMAIN_FAILED;
    ...
    case VM_INITIALIZATION_COMPLETE: {
        ...
        if (isJIT || isAOT) {
            ...
            if (iProfiler) {
                ...
                if (iProfilerThread) {
                    vm->internalVMFunctions->initializeAttachedThread(curThread, "IProfiler", vm->systemThreadGroupRef,
            ...
            if (jProfiler) {
                ...
                if (jProfilerThread) {
                    vm->internalVMFunctions->initializeAttachedThread(curThread, "JProfiler", vm->systemThreadGroupRef,
