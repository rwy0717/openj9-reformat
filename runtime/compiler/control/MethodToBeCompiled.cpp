...
void TR_MethodToBeCompiled::initialize(TR::IlGeneratorMethodDetails& details, void* oldStartPC, CompilationPriority p,
...
bool TR_MethodToBeCompiled::isCompiled() { return TR::CompilationInfo::isCompiled(getMethodDetails().getMethod()); }

bool TR_MethodToBeCompiled::isJNINative() { return TR::CompilationInfo::isJNINative(getMethodDetails().getMethod()); }
