 ...
 * system. I_32 numberOfCpus; // number of CPUs as reported by the operating system
 *
 * } J9SysinfoCPUTime;
 *
...
int32_t CpuUtilization::getCpuUtil(
    J9JITConfig* jitConfig, J9SysinfoCPUTime* machineCpuStats, j9thread_process_time_t* vmCpuStats)
{
...
CpuSelfThreadUtilization::CpuSelfThreadUtilization(
    TR::PersistentInfo* persistentInfo, J9JITConfig* jitConfig, int64_t minPeriodNs, int32_t id)
