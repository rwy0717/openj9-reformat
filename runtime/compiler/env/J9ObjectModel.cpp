...
void J9::ObjectModel::initialize()
{
    ...
    //
    uintptr_t result
        = mmf->j9gc_modron_getConfigurationValueForKey(vm, j9gc_modron_configuration_discontiguousArraylets, &value);
    if (result == 1 && value == 1) {
...
bool J9::ObjectModel::generateCompressedObjectHeaders()
{
...
uintptrj_t J9::ObjectModel::contiguousArrayHeaderSizeInBytes() { return sizeof(J9IndexableObjectContiguous); }

uintptrj_t J9::ObjectModel::discontiguousArrayHeaderSizeInBytes() { return sizeof(J9IndexableObjectDiscontiguous); }
...
uintptrj_t J9::ObjectModel::offsetOfObjectVftField() { return TMP_OFFSETOF_J9OBJECT_CLAZZ; }

uintptrj_t J9::ObjectModel::offsetOfHeaderFlags()
{
...
uintptrj_t J9::ObjectModel::maskOfObjectVftField()
{
...
uintptrj_t J9::ObjectModel::offsetOfContiguousArraySizeField() { return TMP_OFFSETOF_J9INDEXABLEOBJECTCONTIGUOUS_SIZE; }

uintptrj_t J9::ObjectModel::offsetOfDiscontiguousArraySizeField()
{
    return TMP_OFFSETOF_J9INDEXABLEOBJECTDISCONTIGUOUS_SIZE;
}

uintptrj_t J9::ObjectModel::objectHeaderSizeInBytes() { return sizeof(J9Object); }

uintptrj_t J9::ObjectModel::offsetOfIndexableSizeField() { return offsetof(J9ROMArrayClass, arrayShape); }

bool J9::ObjectModel::shouldGenerateReadBarriersForFieldLoads() { return _shouldGenerateReadBarriersForFieldLoads; }

bool J9::ObjectModel::shouldReplaceGuardedLoadWithSoftwareReadBarrier()
{
    return _shouldReplaceGuardedLoadWithSoftwareReadBarrier;
}

bool J9::ObjectModel::isDiscontiguousArray(TR::Compilation* comp, uintptrj_t objectPointer)
{
 ...
 */
uintptrj_t J9::ObjectModel::getAddressOfElement(TR::Compilation* comp, uintptrj_t objectPointer, int64_t offset)
{
...
uintptrj_t J9::ObjectModel::getArrayElementWidthInBytes(TR::DataType type)
{
    if (type == TR::Address)
        return TR::Compiler->om.sizeofReferenceField();
    else
...
uintptrj_t J9::ObjectModel::getArrayElementWidthInBytes(TR::Compilation* comp, uintptrj_t objectPointer)
{
...
uintptrj_t J9::ObjectModel::getArrayLengthInBytes(TR::Compilation* comp, uintptrj_t objectPointer)
{
    TR_ASSERT(TR::Compiler->vm.hasAccess(comp), "Must haveAccess in getArrayLengthInBytes");
    return (uintptrj_t)TR::Compiler->om.getArrayLengthInElements(comp, objectPointer)
        * TR::Compiler->om.getArrayElementWidthInBytes(comp, objectPointer);
}

intptrj_t J9::ObjectModel::getArrayLengthInElements(TR::Compilation* comp, uintptrj_t objectPointer)
{
    return comp->fej9()->getArrayLengthInElements(objectPointer);
}

uintptrj_t J9::ObjectModel::decompressReference(TR::Compilation* comp, uintptrj_t compressedReference)
{
