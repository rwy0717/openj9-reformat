...
UDATA
J9::VMEnv::heapBaseAddress() { return 0; }
...
uintptrj_t J9::VMEnv::thisThreadGetPendingExceptionOffset() { return offsetof(J9VMThread, jitException); }
...
uintptrj_t J9::VMEnv::getOverflowSafeAllocSize(TR::Compilation* comp)
{
...
uintptrj_t J9::VMEnv::OSRFrameHeaderSizeInBytes(TR::Compilation* comp)
{
    return comp->fej9()->getOSRFrameHeaderSizeInBytes();
}

uintptrj_t J9::VMEnv::OSRFrameSizeInBytes(TR::Compilation* comp, TR_OpaqueMethodBlock* method)
{
    return comp->fej9()->getOSRFrameSizeInBytes(method);
}

bool J9::VMEnv::ensureOSRBufferSize(TR::Compilation* comp, uintptrj_t osrFrameSizeInBytes,
    uintptrj_t osrScratchBufferSizeInBytes, uintptrj_t osrStackFrameSizeInBytes)
{
    return comp->fej9()->ensureOSRBufferSize(
        osrFrameSizeInBytes, osrScratchBufferSizeInBytes, osrStackFrameSizeInBytes);
}

uintptrj_t J9::VMEnv::thisThreadGetOSRReturnAddressOffset(TR::Compilation* comp)
{
    return comp->fej9()->thisThreadGetOSRReturnAddressOffset();
}

uintptrj_t J9::VMEnv::thisThreadGetGSIntermediateResultOffset(TR::Compilation* comp)
{
    return comp->fej9()->thisThreadGetGSIntermediateResultOffset();
}

uintptrj_t J9::VMEnv::thisThreadGetConcurrentScavengeActiveByteAddressOffset(TR::Compilation* comp)
{
    return comp->fej9()->thisThreadGetConcurrentScavengeActiveByteAddressOffset();
}

uintptrj_t J9::VMEnv::thisThreadGetEvacuateBaseAddressOffset(TR::Compilation* comp)
{
    return comp->fej9()->thisThreadGetEvacuateBaseAddressOffset();
}

uintptrj_t J9::VMEnv::thisThreadGetEvacuateTopAddressOffset(TR::Compilation* comp)
{
    return comp->fej9()->thisThreadGetEvacuateTopAddressOffset();
}

uintptrj_t J9::VMEnv::thisThreadGetGSOperandAddressOffset(TR::Compilation* comp)
{
    return comp->fej9()->thisThreadGetGSOperandAddressOffset();
}

uintptrj_t J9::VMEnv::thisThreadGetGSHandlerAddressOffset(TR::Compilation* comp)
{
