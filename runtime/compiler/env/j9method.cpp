...
static SYS_FLOAT* orderDouble(TR_Memory* m, SYS_FLOAT* result) { return result; }
...
TR_Method* TR_J9VMBase::createMethod(TR_Memory* trMemory, TR_OpaqueClassBlock* clazz, int32_t refOffset)
{
...
const char* TR_J9MethodBase::signature(TR_Memory* trMemory, TR_AllocationKind allocKind)
{
    if (!_fullSignature) {
        ...
        sprintf(s, "%.*s.%.*s%.*s", classNameLength(), classNameChars(), nameLength(), nameChars(), signatureLength(),
            signatureChars());
...
const char* recognizedBigDecimalMethods[/* NUMRECBDMETHODS */][NUMNAMEFIELDS] = {
    ...
    { "longConstructor", "(JILjava/math/MathContext;)V" }, { "charParser", "([CIILjava/math/MathContext;)V" },
    { "bigIntegerConstructor", "(Ljava/math/BigInteger;ILjava/math/MathContext;)V" },
    { "postSetScaleProcessing", "(Ljava/math/BigDecimal;)V" }, { "valueOf", "(JI)Ljava/math/BigDecimal;" },
    ...
    // DFPBCDDigits
    { "precision", "()I" }, { "signum", "()I" }, { "unscaledValue", "()Ljava/math/BigInteger;" },
    { "toString2", "()Ljava/lang/String;" }, { "toStringExpDFP", "(I)[C" }, { "prePaddedStringDFP", "(II)[C" },
    { "DFPToLL", "()V" },
    // DFPExponent
    { "scale", "()I" },
    // DFPSetScale
    { "setScale", "(IZ)Ljava/math/BigDecimal;" }, { "setScale2", "(IIJLjava/math/BigDecimal;)Ljava/math/BigDecimal;" },
    // DFPHWAvailable
    { "<init>", "(DLjava/math/MathContext;)V" }, { "multiply", "(Ljava/math/BigDecimal;)Ljava/math/BigDecimal;" },
    ...
    { "negate", "(Ljava/math/MathContext;)Ljava/math/BigDecimal;" }, { "byteValueExact", "()B" },
    { "shortValueExact", "()S" }, { "intValueExact", "()I" }, { "longValueExact", "()J" },
    { "toBigIntegerExact", "()Ljava/math/BigInteger;" }, { "toBigInteger", "()Ljava/math/BigInteger;" },
    { "pow", "(ILjava/math/MathContext;)Ljava/math/BigDecimal;" }, { "movePointLeft", "(I)Ljava/math/BigDecimal;" },
    { "movePointRight", "(I)Ljava/math/BigDecimal;" }, { "scaleByPowerOfTen", "(I)Ljava/math/BigDecimal;" },
    { "setScale", "(II)Ljava/math/BigDecimal;" }, { "stripTrailingZeros", "()Ljava/math/BigDecimal;" },
    { "toEngineeringString", "()Ljava/lang/String;" }, { "toPlainString", "()Ljava/lang/String;" },
    ...
    { "DFPDivideHelper",
        "(Ljava/math/BigDecimal;Ljava/math/BigDecimal;Ljava/math/BigDecimal;Ljava/math/MathContext;)Z" },
    ...
    { "DFPMultiplyHelper", "(Ljava/math/BigDecimal;Ljava/math/BigDecimal;)Z" }, { "DFPPrecisionHelper", "()I" },
    { "DFPRoundHelper", "(II)V" }, { "DFPSetScaleHelper", "(Ljava/math/BigDecimal;I)Z" },
    { "DFPSetScaleHelper", "(Ljava/math/BigDecimal;JII)Z" }, { "DFPSignumHelper", "()I" },
    ...
    { "charParser",
        "([CIILjava/math/MathContext;[C)V" }, // signature has changed from r9 -- now has an extra char array
...
bool TR_J9MethodBase::isBigDecimalNameAndSignature(J9UTF8* name, J9UTF8* signature)
{
    TR_ASSERT(NUMRECBDMETHODS == sizeof(recognizedBigDecimalMethods) / sizeof(recognizedBigDecimalMethods[0]),
        "recognizedBigDecimalMethods array size expected %d; actual %d", NUMRECBDMETHODS,
        sizeof(recognizedBigDecimalMethods) / sizeof(recognizedBigDecimalMethods[0]));
    TR_ASSERT(NUMRECBDMETHODS == sizeof(recognizedBigDecimalLengths) / sizeof(recognizedBigDecimalLengths[0]),
        "recognizedBigDecimalLengths array size expected %d; actual %d", NUMRECBDMETHODS,
        sizeof(recognizedBigDecimalLengths) / sizeof(recognizedBigDecimalLengths[0]));
...
bool TR_J9MethodBase::isBigDecimalMethod(J9ROMMethod* romMethod, J9ROMClass* romClass)
{
    return TR_J9VMBase::isBigDecimalClass(J9ROMCLASS_CLASSNAME(romClass))
        && isBigDecimalNameAndSignature(
               J9ROMMETHOD_GET_NAME(romClass, romMethod), J9ROMMETHOD_GET_SIGNATURE(romClass, romMethod));
}

bool TR_J9MethodBase::isBigDecimalMethod(J9Method* j9Method)
{
    /*J9UTF8 * className;
    J9UTF8 * name;
    J9UTF8 * signature;
...
bool TR_J9MethodBase::isBigDecimalMethod(J9UTF8* className, J9UTF8* name, J9UTF8* signature)
{
    return TR_J9VMBase::isBigDecimalClass(className) && isBigDecimalNameAndSignature(name, signature);
}

bool TR_J9MethodBase::isBigDecimalMethod(TR::Compilation* comp)
{
...
bool TR_J9MethodBase::isBigDecimalConvertersNameAndSignature(J9UTF8* name, J9UTF8* signature)
{
...
bool TR_J9MethodBase::isBigDecimalConvertersMethod(J9ROMMethod* romMethod, J9ROMClass* romClass)
{
    return TR_J9VMBase::isBigDecimalConvertersClass(J9ROMCLASS_CLASSNAME(romClass))
        && isBigDecimalConvertersNameAndSignature(
               J9ROMMETHOD_GET_NAME(romClass, romMethod), J9ROMMETHOD_GET_SIGNATURE(romClass, romMethod));
}

bool TR_J9MethodBase::isBigDecimalConvertersMethod(J9Method* j9Method)
{
    return isBigDecimalConvertersMethod(
        J9_ROM_METHOD_FROM_RAM_METHOD(j9Method), J9_CLASS_FROM_METHOD(j9Method)->romClass);
}

bool TR_J9MethodBase::isBigDecimalConvertersMethod(J9UTF8* className, J9UTF8* name, J9UTF8* signature)
{
    return TR_J9VMBase::isBigDecimalConvertersClass(className)
        && isBigDecimalConvertersNameAndSignature(name, signature);
}

bool TR_J9MethodBase::isBigDecimalConvertersMethod(TR::Compilation* comp)
{
...
bool TR_ResolvedJ9MethodBase::owningMethodDoesntMatter()
{
    ...
    if (aggressiveJSR292Opts && strchr(aggressiveJSR292Opts, '3')) {
        if (J9UTF8_LENGTH(className) >= 17 && !strncmp((char*)J9UTF8_DATA(className), "java/lang/invoke/", 17)) {
            ...
            switch (getRecognizedMethod()) {
            case TR::java_lang_invoke_MethodHandle_invokeExactTargetAddress: // This is just a getter that's practically
                                                                             // always inlined
                return true;
            default:
                break;
...
TR_OpaqueClassBlock* TR_ResolvedJ9MethodBase::getDeclaringClassFromFieldOrStatic(TR::Compilation* comp, int32_t cpIndex)
{
...

    {
        ...
        vmThread->javaVM->internalVMFunctions->instanceFieldOffset(
            vmThread, cpClass, (U_8*)field, fieldLen, (U_8*)sig, sigLen, &containingClass, NULL, J9_LOOK_NO_JAVA);
    }
...
char* TR_ResolvedJ9MethodBase::fieldOrStaticName(
    I_32 cpIndex, int32_t& len, TR_Memory* trMemory, TR_AllocationKind kind)
{
    if (cpIndex == -1)
    ...
    sprintf(s, "%.*s.%.*s %.*s", J9UTF8_LENGTH(declName), utf8Data(declName),
...
I_32 TR_ResolvedJ9MethodBase::exceptionData(
        ...
        if (!compInfo->isRomClassForMethodInSharedCache(method, jitConfig->javaVM)) {
            ...
            if (!startupTimeMatters) {
                ...
                if (useHigherMethodCounts) {
                    ...
                    if (className->length > 5 && !strncmp(utf8Data(className), "java/", 5)) {
                        initialCount = 10000;
                    } else {
                        if (J9ROMMETHOD_HAS_BACKWARDS_BRANCHES(romMethod))
...
TR::SymbolReferenceTable* TR_ResolvedJ9MethodBase::_genMethodILForPeeking(
    TR::ResolvedMethodSymbol* methodSymbol, TR::Compilation* c, bool resetVisitCount, TR_PrexArgInfo* argInfo)
{
...
TR_ResolvedRelocatableJ9Method::TR_ResolvedRelocatableJ9Method(
    TR_OpaqueMethodBlock* aMethod, TR_FrontEnd* fe, TR_Memory* trMemory, TR_ResolvedMethod* owner, uint32_t vTableSlot)
...
int32_t TR_ResolvedRelocatableJ9Method::virtualCallSelector(U_32 cpIndex)
{
    return TR_ResolvedJ9Method::virtualCallSelector(cpIndex);
    // return -1;
}

bool TR_ResolvedRelocatableJ9Method::unresolvedFieldAttributes(
    I_32 cpIndex, TR::DataType* type, bool* volatileP, bool* isFinal, bool* isPrivate)
{
    U_32 ltype;
...
bool TR_ResolvedRelocatableJ9Method::unresolvedStaticAttributes(
    I_32 cpIndex, TR::DataType* type, bool* volatileP, bool* isFinal, bool* isPrivate)
{
    U_32 ltype;
    I_32 myVolatile, myFinal, myPrivate;
...
char* TR_ResolvedRelocatableJ9Method::fieldOrStaticNameChars(I_32 cpIndex, int32_t& len)
{
    len = 0;
...
TR_OpaqueClassBlock* TR_ResolvedRelocatableJ9Method::getClassFromConstantPool(
    TR::Compilation* comp, uint32_t cpIndex, bool returnClassForAOT)
{
...
bool TR_ResolvedRelocatableJ9Method::validateClassFromConstantPool(
    TR::Compilation* comp, J9Class* clazz, uint32_t cpIndex, TR_ExternalRelocationTargetKind reloKind)
{
    if (comp->getOption(TR_UseSymbolValidationManager)) {
        return comp->getSymbolValidationManager()->addClassFromCPRecord(
            reinterpret_cast<TR_OpaqueClassBlock*>(clazz), cp(), cpIndex);
    } else {
...
TR_ResolvedMethod* TR_ResolvedRelocatableJ9Method::getResolvedPossiblyPrivateVirtualMethod(
...
bool storeValidationRecordIfNecessary(TR::Compilation* comp, J9ConstantPool* constantPool, int32_t cpIndex,
    TR_ExternalRelocationTargetKind reloKind, J9Method* ramMethod, J9Class* definingClass)
{
    ...
    if (!definingClass) {
        definingClass = (J9Class*)reloRuntime->getClassFromCP(
            fej9->vmThread(), fej9->_jitConfig->javaVM, constantPool, cpIndex, isStatic);
        ...
        for (auto info = aotClassInfo->begin(); info != aotClassInfo->end(); ++info) {
            ...
            if ((*info)->_reloKind == reloKind) {
                if (isStatic)
                    ...
                    inLocalList = (classChain == (*info)->_classChain && cpIndex == (*info)->_cpIndex
    ...
    TR::AOTClassInfo* classInfo = new (comp->trHeapMemory()) TR::AOTClassInfo(fej9, (TR_OpaqueClassBlock*)definingClass,
        (void*)classChain, (TR_OpaqueMethodBlock*)ramMethod, cpIndex, reloKind);
    if (classInfo) {
        ...
        if (comp->getOption(TR_DisableAOTInstanceFieldResolution))
            ...
            if (needAOTValidation) {
                if (comp->getOption(TR_UseSymbolValidationManager)) {
                    ...
                    TR_OpaqueClassBlock* clazz = reloRuntime->getClassFromCP(
                        fej9->vmThread(), fej9->_jitConfig->javaVM, constantPool, cpIndex, false);

                    fieldInfoCanBeUsed = comp->getSymbolValidationManager()->addDefiningClassFromCPRecord(
                        clazz, constantPool, cpIndex);
                } else {
                    fieldInfoCanBeUsed = storeValidationRecordIfNecessary(
    ...
    if (needAOTValidation) {
        if (comp->getOption(TR_UseSymbolValidationManager)) {
            ...
            TR_OpaqueClassBlock* clazz
                = reloRuntime->getClassFromCP(fej9->vmThread(), fej9->_jitConfig->javaVM, constantPool, cpIndex, true);
...
static bool doResolveAtRuntime(J9Method* method, I_32 cpIndex, TR::Compilation* comp)
{
    ...
    if (!method)
        ...
        == J9VMJAVALANGINVOKEMETHODHANDLE_INVOKEWITHARGUMENTSHELPER_METHOD(fej9->getJ9JITConfig()->javaVM)) {
...
bool TR_ResolvedRelocatableJ9Method::getUnresolvedSpecialMethodInCP(I_32 cpIndex)
{
...

    {
        ...
        method = jitResolveSpecialMethodRef(_fe->vmThread(), (J9ConstantPool*)(J9_CP_FROM_METHOD(ramMethod())), cpIndex,
            J9_RESOLVE_FLAG_JIT_COMPILE_TIME);
    }
...
TR_ResolvedMethod* TR_ResolvedRelocatableJ9Method::getResolvedImproperInterfaceMethod(
    TR::Compilation* comp, I_32 cpIndex)
{
    if (comp->getOption(TR_UseSymbolValidationManager))
...
TR_ResolvedMethod* TR_ResolvedRelocatableJ9Method::createResolvedMethodFromJ9Method(TR::Compilation* comp, I_32 cpIndex,
    uint32_t vTableSlot, J9Method* j9method, bool* unresolvedInCP, TR_AOTInliningStats* aotStats)
{
    ...
    if (comp->getOption(TR_DisableDFP)
        ...
        if (TR::CompilationInfo::get(_fe->_jitConfig)
                ->isRomClassForMethodInSharedCache(j9method, _fe->_jitConfig->javaVM)) {
            ...
            && !TR::CompilationInfo::get(_fe->_jitConfig)
                    ->isRomClassForMethodInSharedCache(j9method, _fe->_jitConfig->javaVM)) {
...
U_8* TR_ResolvedRelocatableJ9Method::allocateException(uint32_t numBytes, TR::Compilation* comp)
{
    ...
    eTbl = (J9JITExceptionTable*)_fe->allocateDataCacheRecord(
        numBytes, comp, true, &shouldRetryAllocation, J9_JIT_DCE_EXCEPTION_INFO, &size);
    if (!eTbl) {
...
TR_ResolvedJ9Method::TR_ResolvedJ9Method(
    TR_OpaqueMethodBlock* aMethod, TR_FrontEnd* fe, TR_Memory* trMemory, TR_ResolvedMethod* owner, uint32_t vTableSlot)
...
#define x(a, b, c) a, sizeof(b) - 1, b, (int16_t)strlen(c), c
    ...
    static X ClassMethods[] = { { x(TR::java_lang_Class_newInstancePrototype, "newInstancePrototype",
        ...
        { x(TR::java_lang_Class_isInterface, "isInterface", "()Z") }, { TR::unknownMethod } };
    ...
    static X DoubleMethods[] = { { x(TR::java_lang_Double_longBitsToDouble, "longBitsToDouble", "(J)D") },
        ...
        { TR::java_lang_Double_init, 6, "<init>", (int16_t)-1, "*" }, { TR::unknownMethod } };

    static X FloatMethods[] = { { x(TR::java_lang_Float_intBitsToFloat, "intBitsToFloat", "(I)F") },
        { x(TR::java_lang_Float_floatToIntBits, "floatToIntBits", "(F)I") },
        { x(TR::java_lang_Float_floatToRawIntBits, "floatToRawIntBits", "(F)I") },
        { TR::java_lang_Float_init, 6, "<init>", (int16_t)-1, "*" }, { TR::unknownMethod } };
    ...
    static X HashMapMethods[] = { { x(TR::java_util_HashMap_rehash, "rehash", "()V") },
        ...
        { x(TR::java_util_HashMap_resize, "resize", "()[Ljava/util/HashMap$Node;") }, { TR::unknownMethod } };
    ...
    static X BitsMethods[] = { { x(TR::java_nio_Bits_copyToByteArray, "copyToByteArray", "(JLjava/lang/Object;JJ)V") },
        ...
        { x(TR::java_nio_Bits_keepAlive, "keepAlive", "(Ljava/lang/Object;)V") }, { TR::unknownMethod } };
    ...
    static X ObjectMethods[] = { { TR::java_lang_Object_init, 6, "<init>", (int16_t)-1, "*" },
    ...
    static X DataAccessByteArrayUtilMethods[] = {
        ...
        { x(TR::com_ibm_dataaccess_ByteArrayUtils_trailingZerosQuadWordAtATime_, "trailingZerosQuadWordAtATime_",
            "([BI)I") },
        { TR::unknownMethod }
    };
    ...
    static X DataAccessDecimalDataMethods[] = {
        ...
        { x(TR::com_ibm_dataaccess_DecimalData_DFPConvertPackedToDFP, "DFPConvertPackedToDFP",
            "(Ljava/math/BigDecimal;JIZ)Z") },
        { x(TR::com_ibm_dataaccess_DecimalData_DFPConvertDFPToPacked, "DFPConvertDFPToPacked", "(JZ)J") },
        { x(TR::com_ibm_dataaccess_DecimalData_createZeroBigDecimal, "createZeroBigDecimal",
    ...
    static X PrefetchMethods[] = {
        ...
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Prefetch_Load",
            "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V") },
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Prefetch_Load_L1",
            "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V") },
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Prefetch_Load_L2",
            "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V") },
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Prefetch_Load_L3",
            "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V") },
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Prefetch_Store",
            "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V") },
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Prefetch_LoadNTA",
            "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V") },
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Prefetch_StoreNTA",
            "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V") },
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Prefetch_StoreConditional",
            "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V") },
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Release_StoreOnly",
            "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V") },
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Release_All",
            "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V") },
        { x(TR::com_ibm_Compiler_Internal__TR_Prefetch, "_TR_Prefetch_Load",
    ...
    static X otivmMethods[] = { { TR::com_ibm_oti_vm_VM_callerClass, 11, "callerClass", (int16_t)-1, "*" },
        { x(TR::java_lang_ClassLoader_callerClassLoader, "callerClassLoader", "()Ljava/lang/ClassLoader;") },
        { TR::unknownMethod } };

    static X ArraysMethods[] = { { TR::java_util_Arrays_fill, 4, "fill", (int16_t)-1, "*" },
    ...
    static X StringMethods[] = { { x(TR::java_lang_String_trim, "trim", "()Ljava/lang/String;") },
        ...
        { x(TR::java_lang_String_getChars_byteArray, "getChars", "(II[BI)V") }, { TR::unknownMethod } };
    ...
    static X StringCodingMethods[]
        = { { x(TR::java_lang_StringCoding_decode, "decode", "(Ljava/nio/charset/Charset;[BII)[C") },
              ...
              { x(TR::java_lang_StringCoding_encodeUTF8, "encodeUTF8", "(B[B)[B") }, { TR::unknownMethod } };
    ...
    static X StringBuilderMethods[] = { { x(TR::java_lang_StringBuilder_init, "<init>", "()V") },
    ...
    static X SystemMethods[] = { { TR::java_lang_System_arraycopy, 9, "arraycopy", (int16_t)-1, "*" },
    ...
    static X ThreadMethods[]
        = { { x(TR::java_lang_Thread_currentThread, "currentThread", "()Ljava/lang/Thread;") }, { TR::unknownMethod } };
    ...
    static X UnsafeMethods[] = {
        ...
        { x(TR::sun_misc_Unsafe_putObjectVolatile_jlObjectJjlObject_V, "putObjectRelease",
            "(Ljava/lang/Object;JLjava/lang/Object;)V") },
        ...
        { x(TR::sun_misc_Unsafe_getObjectVolatile_jlObjectJ_jlObject, "getObjectAcquire",
            "(Ljava/lang/Object;J)Ljava/lang/Object;") },
        ...
        { x(TR::sun_misc_Unsafe_compareAndExchangeInt_jlObjectJII_Z, "compareAndExchangeInt",
            "(Ljava/lang/Object;JII)I") },
        { x(TR::sun_misc_Unsafe_compareAndExchangeLong_jlObjectJJJ_Z, "compareAndExchangeLong",
            "(Ljava/lang/Object;JJJ)J") },
        { x(TR::sun_misc_Unsafe_compareAndExchangeObject_jlObjectJjlObjectjlObject_Z, "compareAndExchangeObject",
            "(Ljava/lang/Object;JLjava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;") },

        { x(TR::sun_misc_Unsafe_compareAndExchangeInt_jlObjectJII_Z, "compareAndExchangeIntVolatile",
            "(Ljava/lang/Object;JII)I") },
        { x(TR::sun_misc_Unsafe_compareAndExchangeLong_jlObjectJJJ_Z, "compareAndExchangeLongVolatile",
            "(Ljava/lang/Object;JJJ)J") },
        { x(TR::sun_misc_Unsafe_compareAndExchangeObject_jlObjectJjlObjectjlObject_Z,
    ...
    static X VectorMethods[] = { { TR::java_util_Vector_subList, 7, "subList", (int16_t)-1, "*" },
        { x(TR::java_util_Vector_contains, "contains", "(Ljava/lang/Object;)Z") },
        { x(TR::java_util_Vector_addElement, "addElement", "(Ljava/lang/Object;)V") }, { TR::unknownMethod } };
    ...
    static X StringLatin1Methods[]
        = { { x(TR::java_lang_StringLatin1_indexOf, "indexOf", "([BI[BII)I") }, { TR::unknownMethod } };

    static X StringUTF16Methods[] = { { x(TR::java_lang_StringUTF16_getChar, "getChar", "([BI)C") },
        { x(TR::java_lang_StringUTF16_indexOf, "indexOf", "([BI[BII)I") },
        { x(TR::java_lang_StringUTF16_toBytes, "toBytes", "([CII)[B") }, { TR::unknownMethod } };
    ...
    static X IntegerMethods[] = { { x(TR::java_lang_Integer_bitCount, "bitCount", "(I)I") },
        ...
        { x(TR::java_lang_Integer_toUnsignedLong, "toUnsignedLong", "(I)J") }, { TR::unknownMethod } };

    static X LongMethods[] = { { x(TR::java_lang_Long_bitCount, "bitCount", "(J)I") },
        ...
        { TR::java_lang_Long_init, 6, "<init>", (int16_t)-1, "*" }, { TR::unknownMethod } };

    static X BooleanMethods[]
        = { { TR::java_lang_Boolean_init, 6, "<init>", (int16_t)-1, "*" }, { TR::unknownMethod } };

    static X CharacterMethods[] = { { TR::java_lang_Character_init, 6, "<init>", (int16_t)-1, "*" },
        ...
        { x(TR::java_lang_Character_isAlphabetic, "isAlphabetic", "(I)Z") }, { TR::unknownMethod } };
    ...
    static X CRC32Methods[] = { { x(TR::java_util_zip_CRC32_update, "update", "(II)I") },
        ...
        { x(TR::java_util_zip_CRC32_updateByteBuffer, "updateByteBuffer", "(IJII)I") }, { TR::unknownMethod } };

    static X ByteMethods[] = { { TR::java_lang_Byte_init, 6, "<init>", (int16_t)-1, "*" }, { TR::unknownMethod } };

    static X ShortMethods[] = { { x(TR::java_lang_Short_reverseBytes, "reverseBytes", "(S)S") },
        { TR::java_lang_Short_init, 6, "<init>", (int16_t)-1, "*" }, { TR::unknownMethod } };
    ...
    static X SubMapMethods[] = { { x(TR::java_util_TreeMapSubMap_setLastKey, "setLastKey", "()V") },
        { x(TR::java_util_TreeMapSubMap_setFirstKey, "setFirstKey", "()V") }, { TR::unknownMethod } };
    ...
    static X VMInternalsMethods[] = {
        ...
        { x(TR::java_lang_J9VMInternals_rawNewArrayInstance, "rawNewArrayInstance",
    ...
    static X JavaUtilConcurrentAtomicFencesMethods[] = {
        ...
        { x(TR::java_util_concurrent_atomic_Fences_postStorePreLoadFence_jlObject, "postStorePreLoadFence",
            "(Ljava/lang/Object;)V") },
        { x(TR::java_util_concurrent_atomic_Fences_postLoadFence_jlObjectjlrField, "postLoadFence",
            "(Ljava/lang/Object;Ljava/lang/reflect/Field;)V") },
        { x(TR::java_util_concurrent_atomic_Fences_preStoreFence_jlObjectjlrField, "preStoreFence",
            "(Ljava/lang/Object;Ljava/lang/reflect/Field;)V") },
        { x(TR::java_util_concurrent_atomic_Fences_postStorePreLoadFence_jlObjectjlrField, "postStorePreLoadFence",
            "(Ljava/lang/Object;Ljava/lang/reflect/Field;)V") },
        { x(TR::java_util_concurrent_atomic_Fences_postLoadFence_jlObjectI, "postLoadFence",
            "([Ljava/lang/Object;I)V") },
        { x(TR::java_util_concurrent_atomic_Fences_preStoreFence_jlObjectI, "preStoreFence",
            "([Ljava/lang/Object;I)V") },
        { x(TR::java_util_concurrent_atomic_Fences_postStorePreLoadFence_jlObjectI, "postStorePreLoadFence",
            "([Ljava/lang/Object;I)V") },
    ...
    static X MethodHandleMethods[] = { { TR::java_lang_invoke_MethodHandle_doCustomizationLogic, 20,
                                           "doCustomizationLogic", (int16_t)-1, "*" },
        ...
        { TR::java_lang_invoke_MethodHandle_invokeExactTargetAddress, 24, "invokeExactTargetAddress", (int16_t)-1,
            "*" },
        { x(TR::java_lang_invoke_MethodHandle_invokeWithArgumentsHelper, "invokeWithArgumentsHelper",
    ...
    static X VarHandleMethods[] = { // Recognized method only works for resovled methods
    ...
    static X ILGenMacrosMethods[] = { { TR::java_lang_invoke_ILGenMacros_placeholder, 11, "placeholder", (int16_t)-1,
                                          "*" },
    ...
    static X SpreadHandleMethods[]
        = { { x(TR::java_lang_invoke_SpreadHandle_numArgsToPassThrough, "numArgsToPassThrough", "()I") },
              ...
              { TR::java_lang_invoke_SpreadHandle_arrayArg, 8, "arrayArg", (int16_t)-1, "*" }, { TR::unknownMethod } };

    static X FoldHandleMethods[] = { { x(TR::java_lang_invoke_FoldHandle_foldPosition, "foldPosition", "()I") },
    ...
    static X SIMDMethods[] = { // ---- Integer Type Operations
        ...
        { x(TR::com_ibm_dataaccess_SIMD_vectorSqrtDouble, "vectorSqrtDouble", "([DI[DI)V") }, { TR::unknownMethod }
    };
    ...
    static Y class13[] = { { "java/nio/Bits", BitsMethods }, { 0 } };

    static Y class14[] = { { "java/lang/Math", MathMethods }, { "java/lang/Long", LongMethods },
        { "java/lang/Byte", ByteMethods }, { "java/io/Writer", WriterMethods }, { 0 } };

    static Y class15[] = { { "java/lang/Class", ClassMethods }, { "java/lang/Float", FloatMethods },
        { "sun/misc/Unsafe", UnsafeMethods }, { "java/lang/Short", ShortMethods }, { 0 } };

    static Y class16[] = { { "java/lang/Double", DoubleMethods }, { "java/lang/Object", ObjectMethods },
        { "java/lang/String", StringMethods }, { "java/lang/System", SystemMethods },
        { "java/lang/Thread", ThreadMethods }, { "java/util/Vector", VectorMethods },
        { "java/util/Arrays", ArraysMethods }, { 0 } };

    static Y class17[] = { { "com/ibm/oti/vm/VM", otivmMethods }, { "java/lang/Integer", IntegerMethods },
        { "java/lang/Boolean", BooleanMethods }, { "java/util/TreeMap", TreeMapMethods },
        { "java/util/HashMap", HashMapMethods }, { 0 } };

    static Y class18[] = { { "com/ibm/gpu/Kernel", GPUMethods }, { 0 } };

    static Y class19[] = { { "java/util/Hashtable", HashtableMethods }, { "java/lang/Throwable", ThrowableMethods },
        { "java/lang/Character", CharacterMethods }, { "java/util/ArrayList", ArrayListMethods },
        { "java/util/zip/CRC32", CRC32Methods }, { 0 } };

    static Y class20[] = { { "java/lang/StrictMath", StrictMathMethods }, { "java/math/BigDecimal", BigDecimalMethods },
        { "java/math/BigInteger", BigIntegerMethods }, { 0 } };

    static Y class21[]
        = { { "java/lang/ClassLoader", ClassLoaderMethods }, { "java/lang/StringUTF16", StringUTF16Methods }, { 0 } };

    static Y class22[] = { { "java/lang/StringBuffer", StringBufferMethods },
        { "sun/reflect/Reflection", ReflectionMethods }, { "java/text/NumberFormat", NumberFormatMethods },
        { "com/ibm/jit/JITHelpers", JITHelperMethods }, { "java/lang/StringCoding", StringCodingMethods },
        { "java/lang/StringLatin1", StringLatin1Methods }, { 0 } };
    ...
    static Y class24[] = { { "java/util/TreeMap$SubMap", SubMapMethods }, { "sun/nio/cs/UTF_8$Decoder", EncodeMethods },
        { "sun/nio/cs/UTF_8$Encoder", EncodeMethods }, { "sun/nio/cs/UTF16_Encoder", EncodeMethods },
        { "jdk/internal/misc/Unsafe", UnsafeMethods }, { 0 } };

    static Y class25[] = { { 0 } };

    static Y class27[] = { { "sun/io/ByteToCharSingleByte", DoubleByteConverterMethods },
        { "com/ibm/oti/vm/ORBVMHelpers", ORBVMHelperMethods },
        { "java/util/GregorianCalendar", GregorianCalendarMethods }, { "sun/nio/cs/US_ASCII$Encoder", EncodeMethods },
        { "sun/nio/cs/US_ASCII$Decoder", EncodeMethods }, { "sun/nio/cs/ext/SBCS_Encoder", EncodeMethods },
        { "sun/nio/cs/ext/SBCS_Decoder", EncodeMethods }, { "java/lang/invoke/FoldHandle", FoldHandleMethods },
        { "java/lang/ref/SoftReference", JavaLangRefSoftReferenceMethods }, { 0 } };

    static Y class28[] = { { "sun/io/ByteToCharDBCS_EBCDIC", DoubleByteConverterMethods },
        { "java/lang/invoke/ILGenMacros", ILGenMacrosMethods }, { "java/lang/invoke/CatchHandle", CatchHandleMethods },
        { "com/ibm/tenant/TenantContext", MTTenantContext },
        { "java/util/stream/IntPipeline", JavaUtilStreamIntPipelineMethods }, { 0 } };

    static Y class29[] = { { "java/lang/invoke/MethodHandle", MethodHandleMethods },
        ...
        { "java/lang/invoke/DirectHandle", DirectHandleMethods }, { "sun/nio/cs/ISO_8859_1$Encoder", EncodeMethods },
        { "sun/nio/cs/ISO_8859_1$Decoder", EncodeMethods },
        { "java/io/ByteArrayOutputStream", ByteArrayOutputStreamMethods }, { 0 } };

    static Y class30[] = { { "com/ibm/Compiler/Internal/Quad", QuadMethods },
        ...
        { "java/util/HashMap$HashIterator", HashMapHashIteratorMethods }, { 0 } };

    static Y class31[] = { { "com/ibm/jit/DecimalFormatHelper", DecimalFormatHelperMethods }, { 0 } };
    static Y class32[] = { { "java/lang/invoke/MutableCallSite", MutableCallSiteMethods },
        { "java/lang/invoke/PrimitiveHandle", PrimitiveHandleMethods },
        { "com/ibm/dataaccess/PackedDecimal", DataAccessPackedDecimalMethods }, { 0 } };

    static Y class33[] = { { "com/ibm/dataaccess/ByteArrayUtils", DataAccessByteArrayUtilMethods },
        { "java/util/stream/AbstractPipeline", JavaUtilStreamAbstractPipelineMethods },
        { "java/util/stream/IntPipeline$Head", JavaUtilStreamIntPipelineHeadMethods }, { 0 } };

    static Y class34[] = { { "java/util/Hashtable$HashEnumerator", HashtableHashEnumeratorMethods },
        ...
        { "java/lang/invoke/VarHandleInternal", VarHandleMethods }, { 0 } };

    static Y class35[] = { { "java/lang/invoke/ExplicitCastHandle", ExplicitCastHandleMethods }, { 0 } };

    static Y class36[] = { { "java/lang/invoke/GuardWithTestHandle", GuardWithTestHandleMethods },
        ...
        { "java/lang/StringCoding$StringEncoder", StringCoding_StringEncoderMethods }, { 0 } };

    // 1421
    static Y class38[] = { { "java/util/concurrent/atomic/AtomicLong", JavaUtilConcurrentAtomicLongMethods },
        ...
        { "com/ibm/crypto/provider/P384PrimeField", CryptoECC384Methods }, { 0 } };

    static Y class39[] = { { "com/ibm/jit/crypto/JITFullHardwareCrypt", ZCryptoMethods }, { 0 } };

    static Y class40[] = { { "java/util/TreeMap$UnboundedValueIterator", TreeMapUnboundedValueIteratorMethods },
        ...
        { "com/ibm/jit/crypto/JITAESCryptInHardware", XPCryptoMethods }, { 0 } };

    static Y class41[] = { { "org/apache/harmony/luni/platform/OSMemory", OSMemoryMethods },
        { "java/util/concurrent/atomic/AtomicBoolean", JavaUtilConcurrentAtomicBooleanMethods },
        { "java/util/concurrent/atomic/AtomicInteger", JavaUtilConcurrentAtomicIntegerMethods }, { 0 } };

    static Y class42[] = { { "com/ibm/crypto/provider/AESCryptInHardware", CryptoAESMethods },
        { "java/util/concurrent/ConcurrentLinkedQueue", JavaUtilConcurrentConcurrentLinkedQueueMethods }, { 0 } };

    static Y class43[] = { { "java/util/concurrent/atomic/AtomicReference", JavaUtilConcurrentAtomicReferenceMethods },
    ...
    static Y class46[] = { { "java/util/concurrent/atomic/AtomicIntegerArray",
                               JavaUtilConcurrentAtomicIntegerArrayMethods },
        { "java/util/concurrent/ConcurrentHashMap$TreeBin", JavaUtilConcurrentConcurrentHashMapTreeBinMethods },
        { "java/io/ObjectInputStream$BlockDataInputStream", ObjectInputStream_BlockDataInputStreamMethods }, { 0 } };
    ...
    static Y class53[] = { { "java/util/concurrent/atomic/AtomicIntegerFieldUpdater",
                               JavaUtilConcurrentAtomicIntegerFieldUpdaterMethods },
        { 0 } };

    static Y class55[] = { { "java/util/concurrent/atomic/AtomicReferenceFieldUpdater",
    ...
    static Y* recognizedClasses[] = { 0, 0, 0, class13, class14, class15, class16, class17, class18, class19, class20,
        ...
        class34, class35, class36, 0, class38, class39, class40, class41, class42, class43, 0, class45, class46, 0,
        class48, 0, class50, 0, 0, class53, 0, class55 };
    ...
    if (isMethodInValidLibrary(fe, this)) {
        ...
        if (TR_Method::getMandatoryRecognizedMethod() == TR::unknownMethod) {
            ...
            if ((classNameLen == 17) && !strncmp(className, "java/util/TreeMap", 17))
                ...
                && !strncmp(
                       className, "java/lang/invoke/InstanceFieldVarHandle$InstanceFieldVarHandleOperations$Op", 75)) {
                setRecognizedMethodInfo(
                    TR::java_lang_invoke_InstanceFieldVarHandle_InstanceFieldVarHandleOperations_OpMethod);
            } else if ((classNameLen >= 75 + 3 && classNameLen <= 75 + 7)
                && !strncmp(
                       className, "java/lang/invoke/ByteArrayViewVarHandle$ByteArrayViewVarHandleOperations$Op", 75)) {
                setRecognizedMethodInfo(
        ...
        && !failBecauseOfHCR) // With HCR, non-native methods can change, so we shouldn't "recognize" them
    {
        ...
        if (disableRecMethods && fej9()->isAOT_DEPRECATED_DO_NOT_USE()) // AOT_JIT_GAP
        {
            ...
            case TR::org_apache_harmony_luni_platform_OSMemory_getAddress_J_J:
                ...
                // from bool TR::TreeEvaluator::VMinlineCallEvaluator(TR::Node *node, bool isIndirect, TR::CodeGenerator
                // *cg)
                // case TR::sun_misc_Unsafe_copyMemory:
...
void TR_ResolvedJ9Method::setQuadClassSeen()
{
    TR::Compilation* comp = (fej9()->_compInfoPT) ? fej9()->_compInfoPT->getCompilation() : NULL;
    // TODO:
...
intptrj_t TR_ResolvedJ9Method::getInvocationCount() { return TR::CompilationInfo::getInvocationCount(ramMethod()); }

bool TR_ResolvedJ9Method::setInvocationCount(intptrj_t oldCount, intptrj_t newCount)
{
    ...
    if (comp->getOptLevel() >= warm) {
        ...
        if (clazz) {
            ...
            for (int i = 0; i < numMethods; ++i) {
                ...
                J9UTF8* name = J9ROMMETHOD_GET_NAME(
                    J9_CLASS_FROM_METHOD(method)->romClass, J9_ROM_METHOD_FROM_RAM_METHOD(method));

                if (J9UTF8_LENGTH(name) == 13) {
                    char s[15];
                    sprintf(s, "%.*s", J9UTF8_LENGTH(name), J9UTF8_DATA(name));
...
U_16 TR_ResolvedJ9Method::archetypeArgPlaceholderSlot(TR_Memory* mem)
{
    ...
    // TR_ASSERT(((TR_ResolvedMethod*)this)->numberOfParameterSlots() == archetype->numberOfParameterSlots(), "not equal
    // %d %d", ((TR_ResolvedMethod*)this)->numberOfParameterSlots(), archetype->numberOfParameterSlots());
...
J9ClassLoader* TR_ResolvedJ9Method::getClassLoader() { return cp()->ramClass->classLoader; }
...
bool TR_J9MethodBase::isUnsafeCAS(TR::Compilation* c)
{
    TR::RecognizedMethod rm = getRecognizedMethod();
    switch (rm) {
    case TR::sun_misc_Unsafe_compareAndSwapInt_jlObjectJII_Z:
...
bool TR_J9MethodBase::isVarHandleAccessMethod(TR::Compilation* comp)
{
...
U_8* TR_ResolvedJ9Method::allocateException(uint32_t numBytes, TR::Compilation* comp)
{
    ...
    bool shouldRetryAllocation;
    eTbl = (J9JITExceptionTable*)_fe->allocateDataCacheRecord(
        numBytes, comp, false, &shouldRetryAllocation, J9_JIT_DCE_EXCEPTION_INFO, &size);
    if (!eTbl) {
        if (shouldRetryAllocation) {
            // force a retry
            comp->failCompilation<J9::RecoverableDataCacheError>("Failed to allocate exception table");
...
I_32 TR_ResolvedJ9Method::exceptionData(I_32 exceptionNumber, I_32* startIndex, I_32* endIndex, I_32* catchType)
{
    ...
    return TR_ResolvedJ9MethodBase::exceptionData(
        exceptionHandler, 0, exceptionNumber, startIndex, endIndex, catchType);
}
...
void* TR_ResolvedJ9Method::dynamicConstant(I_32 cpIndex)
{
    TR_ASSERT_FATAL(cpIndex != -1, "ConstantDynamic cpIndex shouldn't be -1");
...
void* TR_ResolvedJ9Method::varHandleMethodTypeTableEntryAddress(int32_t cpIndex)
{
    ...
    TR_ASSERT(
        varHandleMethodTypeLookupTable[methodTypeIndex] == cpIndex, "Could not find the VarHandle callsite MethodType");
...
TR_OpaqueClassBlock* TR_ResolvedJ9Method::getClassFromCP(
    TR_J9VMBase* fej9, J9ConstantPool* cp, TR::Compilation* comp, uint32_t cpIndex)
{
    ...
    if (cpIndex != -1
        ...
        && (resolvedClass = fej9->_vmFunctionTable->resolveClassRef(
                fej9->vmThread(), cp, cpIndex, J9_RESOLVE_FLAG_JIT_COMPILE_TIME))) {
...
bool TR_ResolvedJ9Method::validateClassFromConstantPool(
    TR::Compilation* comp, J9Class* clazz, uint32_t cpIndex, TR_ExternalRelocationTargetKind reloKind)
{
    return true;
}
...
const char* TR_ResolvedJ9Method::newInstancePrototypeSignature(TR_Memory* m, TR_AllocationKind allocKind)
{
    ...
    J9Class* clazz
        = _j9classForNewInstance; //((J9Class*)((uintptrj_t)(ramMethod()->extra) & ~J9_STARTPC_NOT_TRANSLATED);
...
U_32 TR_ResolvedJ9Method::vTableSlot(U_32 cpIndex)
{
    TR_ASSERT(cpIndex != -1, "cpIndex shouldn't be -1");
...
TR_OpaqueMethodBlock* TR_ResolvedJ9Method::getVirtualMethod(
    TR_J9VMBase* fej9, J9ConstantPool* cp, I_32 cpIndex, UDATA* vTableOffset, bool* unresolvedInCP)
{
    ...
    *vTableOffset >>= 8;
    if (J9VTABLE_INITIAL_VIRTUAL_OFFSET == *vTableOffset) {
        ...
        *vTableOffset = fej9->_vmFunctionTable->resolveVirtualMethodRefInto(
            fej9->vmThread(), cp, cpIndex, J9_RESOLVE_FLAG_JIT_COMPILE_TIME, &ramMethod, NULL);
...
TR_OpaqueClassBlock* TR_ResolvedJ9Method::getInterfaceITableIndexFromCP(
    TR_J9VMBase* fej9, J9ConstantPool* cp, int32_t cpIndex, UDATA* pITableIndex)
{
...
U_32 TR_ResolvedJ9Method::getResolvedInterfaceMethodOffset(TR_OpaqueClassBlock* classObject, I_32 cpIndex)
{
...

    {
        ...
        vTableOffset = jitGetInterfaceVTableOffsetFromCP(
            _fe->vmThread(), cp(), cpIndex, TR::Compiler->cls.convertClassOffsetToClassPtr(classObject));
    }
...
TR_ResolvedMethod* TR_ResolvedJ9Method::getResolvedInterfaceMethod(
    TR::Compilation* comp, TR_OpaqueClassBlock* classObject, I_32 cpIndex)
{
    TR_J9VMBase* fej9 = (TR_J9VMBase*)_fe;
        ...
        if (m) {
            ...
            if (c && !fej9->isInterfaceClass(c)) {
                ...
                TR::DebugCounter::incStaticDebugCounter(
                    comp, "resources.resolvedMethods/interface:#bytes", sizeof(TR_ResolvedJ9Method));
                return m;
            }
        }
    }
...
TR_ResolvedMethod* TR_ResolvedJ9Method::getResolvedStaticMethod(
    TR::Compilation* comp, I_32 cpIndex, bool* unresolvedInCP)
{
    TR_ResolvedMethod* resolvedMethod = NULL;
    ...
    if (comp->compileRelocatableCode() && comp->getOption(TR_UseSymbolValidationManager) && ramMethod) {
        if (!comp->getSymbolValidationManager()->addStaticMethodFromCPRecord(
                (TR_OpaqueMethodBlock*)ramMethod, cp(), cpIndex))
            ramMethod = NULL;
    }
...
TR_ResolvedMethod* TR_ResolvedJ9Method::getResolvedSpecialMethod(
    TR::Compilation* comp, I_32 cpIndex, bool* unresolvedInCP)
{
    TR_ResolvedMethod* resolvedMethod = NULL;
    ...
    if (!((_fe->_jitConfig->runtimeFlags & J9JIT_RUNTIME_RESOLVE)
        ...
        if (ramMethod) {
            ...
            if (comp->getOption(TR_UseSymbolValidationManager)) {
                if (!comp->getSymbolValidationManager()->addSpecialMethodFromCPRecord(
                        (TR_OpaqueMethodBlock*)ramMethod, cp(), cpIndex))
            ...
            if (createResolvedMethod)
                resolvedMethod
                    = createResolvedMethodFromJ9Method(comp, cpIndex, 0, ramMethod, unresolvedInCP, aotStats);
            if (unresolvedInCP)
                *unresolvedInCP = false;
        }
    }
...
TR_ResolvedMethod* TR_ResolvedJ9Method::getResolvedPossiblyPrivateVirtualMethod(
    TR::Compilation* comp, I_32 cpIndex, bool ignoreRtResolve, bool* unresolvedInCP)
{
    TR_ASSERT(cpIndex != -1, "cpIndex shouldn't be -1");
#if TURN_OFF_INLINING
    return 0;
    ...
    if (!((_fe->_jitConfig->runtimeFlags & J9JIT_RUNTIME_RESOLVE)
        ...
        if (comp->compileRelocatableCode() && ramMethod && comp->getOption(TR_UseSymbolValidationManager)) {
            if (!comp->getSymbolValidationManager()->addVirtualMethodFromCPRecord(
                    (TR_OpaqueMethodBlock*)ramMethod, cp(), cpIndex))
                createResolvedMethod = false;
        }
        ...
        if (vTableOffset) {
            ...
            if (createResolvedMethod)
                resolvedMethod = createResolvedMethodFromJ9Method(
                    comp, cpIndex, vTableOffset, ramMethod, unresolvedInCP, aotStats);
        }
    }
    ...
    if (resolvedMethod == NULL) {
        ...
        if (((TR_ResolvedJ9Method*)resolvedMethod)->isVarHandleAccessMethod()) {
            // VarHandle access methods are resolved to *_impl()V, restore their signatures to obtain function
            // correctness in the Walker
        ...
        TR::DebugCounter::incStaticDebugCounter(
            comp, "resources.resolvedMethods/virtual:#bytes", sizeof(TR_ResolvedJ9Method));
    }
...
TR_ResolvedMethod* TR_ResolvedJ9Method::getResolvedVirtualMethod(
    TR::Compilation* comp, I_32 cpIndex, bool ignoreRtResolve, bool* unresolvedInCP)
{
...
TR_ResolvedMethod* TR_ResolvedJ9Method::getResolvedDynamicMethod(
    TR::Compilation* comp, I_32 callSiteIndex, bool* unresolvedInCP)
{
    ...
    // See if the constant pool entry is already resolved or not
    {
        ...
        TR_OpaqueMethodBlock* dummyInvokeExact = _fe->getMethodFromName(
            "java/lang/invoke/MethodHandle", "invokeExact", JSR292_invokeExactSig, getNonPersistentIdentifier());
        result = _fe->createResolvedMethodWithSignature(
            comp->trMemory(), dummyInvokeExact, NULL, utf8Data(signature), J9UTF8_LENGTH(signature), this);
    }
...
TR_ResolvedMethod* TR_ResolvedJ9Method::getResolvedHandleMethod(
    TR::Compilation* comp, I_32 cpIndex, bool* unresolvedInCP)
{
    TR_ASSERT(cpIndex != -1, "cpIndex shouldn't be -1");
...
#endif
        result = _fe->createResolvedMethodWithSignature(
            comp->trMemory(), dummyInvokeExact, NULL, signature, signatureLength, this);
    }
...
TR_ResolvedMethod* TR_ResolvedJ9Method::getResolvedHandleMethodWithSignature(
    TR::Compilation* comp, I_32 cpIndex, char* signature)
{
#if TURN_OFF_INLINING
    return 0;
#else
    ...
    TR_OpaqueMethodBlock* dummyInvokeExact = _fe->getMethodFromName(
        "java/lang/invoke/MethodHandle", "invokeExact", JSR292_invokeExactSig, getNonPersistentIdentifier());
    TR_ResolvedMethod* resolvedMethod = _fe->createResolvedMethodWithSignature(
        comp->trMemory(), dummyInvokeExact, NULL, signature, strlen(signature), this);
    return resolvedMethod;
#endif
}

TR_ResolvedMethod* TR_ResolvedJ9Method::getResolvedVirtualMethod(
    TR::Compilation* comp, TR_OpaqueClassBlock* classObject, I_32 virtualCallOffset, bool ignoreRtResolve)
{
    TR_J9VMBase* fej9 = (TR_J9VMBase*)_fe;
    ...
    bool* volatileP, bool* isFinal, bool* isPrivate, bool isStore, bool* unresolvedInCP, bool needAOTValidation)
{
    ...
    bool doRuntimeResolveForEarlyCompilation
        = isUnresolvedInCP && isColdOrReducedWarm && !comp->ilGenRequest().details().isMethodHandleThunk();
...
TR_OpaqueMethodBlock* TR_J9VMBase::getResolvedVirtualMethod(
...
TR_OpaqueMethodBlock* TR_J9VMBase::getResolvedInterfaceMethod(
    J9ConstantPool* ownerCP, TR_OpaqueClassBlock* classObject, int32_t cpIndex)
{
    ...
    J9Method* ramMethod = jitGetInterfaceMethodFromCP(
        vmThread(), ownerCP, cpIndex, TR::Compiler->cls.convertClassOffsetToClassPtr(classObject));

    return (TR_OpaqueMethodBlock*)ramMethod;
}

TR_OpaqueMethodBlock* TR_J9VMBase::getResolvedInterfaceMethod(
    TR_OpaqueMethodBlock* interfaceMethod, TR_OpaqueClassBlock* classObject, I_32 cpIndex)
{
    return getResolvedInterfaceMethod(
        (J9ConstantPool*)(J9_CP_FROM_METHOD((J9Method*)interfaceMethod)), classObject, cpIndex);
}

TR_OpaqueMethodBlock* TR_J9SharedCacheVM::getResolvedVirtualMethod(
    TR_OpaqueClassBlock* classObject, I_32 virtualCallOffset, bool ignoreRtResolve)
{
    ...
    TR::Compilation* comp = TR::comp();
    if (comp && comp->getOption(TR_UseSymbolValidationManager)) {
        if (!comp->getSymbolValidationManager()->addVirtualMethodFromOffsetRecord(
                ramMethod, classObject, virtualCallOffset, ignoreRtResolve))
            return NULL;
    }
...
TR_OpaqueMethodBlock* TR_J9SharedCacheVM::getResolvedInterfaceMethod(
    TR_OpaqueMethodBlock* interfaceMethod, TR_OpaqueClassBlock* classObject, I_32 cpIndex)
{
...
TR_OpaqueClassBlock* TR_ResolvedRelocatableJ9Method::getDeclaringClassFromFieldOrStatic(
...
TR_J9MethodParameterIterator::TR_J9MethodParameterIterator(
    TR_J9MethodBase& j9Method, TR::Compilation& comp, TR_ResolvedMethod* resolvedMethod)
...
static J9::MethodHandleThunkDetails* getMethodHandleThunkDetails(
    TR_J9ByteCodeIlGenerator* ilgen, TR::Compilation* comp, TR::SymbolReference* macro)
{
    TR_J9VMBase* fej9 = (TR_J9VMBase*)(comp->fe());
...
bool TR_J9ByteCodeIlGenerator::runFEMacro(TR::SymbolReference* symRef)
{
    ...
    case TR::java_lang_invoke_CollectHandle_numArgsAfterCollectArray: {
...

        {
            ...
            arguments = fej9->getReferenceField(
                fej9->getReferenceField(methodHandle, "type", "Ljava/lang/invoke/MethodType;"), "arguments",
                "[Ljava/lang/Class;");
    ...
    case TR::java_lang_invoke_ExplicitCastHandle_convertArgs: {
...

        {
            ...
            methodDescriptorRef = fej9->getReferenceField(
                fej9->getReferenceField(
                    fej9->getReferenceField(methodHandle, "next", "Ljava/lang/invoke/MethodHandle;"), "type",
        ...
        for (int32_t argIndex = 0; sourceSig[0] != ')';
            ...
            char* sourceName = sourceBuf;
            char* sourceType = sourceBuf;
            char* targetName = targetBuf;
            char* targetType = targetBuf;
            switch (sourceSig[0]) {
            case 'L':
            case '[':
                sourceName = "object";
            ...
            if (strcmp(sourceType, targetType)) {
                ...
                argValue = TR::Node::createWithSymRef(
                    methodSymRef->getSymbol()->castToMethodSymbol()->getMethod()->directCallOpCode(), 1, 1, argValue,
                    methodSymRef);
                genTreeTop(argValue);
            }
            ...
            if (targetType[0] == 'L') {
...

                {
                    ...
                    parmClass = (TR_OpaqueClassBlock*)(intptrj_t)fej9->getInt64Field(
                        fej9->getReferenceElement(arguments, argIndex),
    ...
    case TR::java_lang_invoke_PermuteHandle_permuteArgs: {
...

        {
            ...
            for (i = 0; i < permuteLength; i++) {
                ...
                if (argIndex >= 0) {
                    newSignature = artificialSignature(stackAlloc, "(.*.@)I", newSignature, 0, oldSignature, argIndex);
                    push(originalArgs->getChild(argIndex));
                    if (comp()->getOption(TR_TraceILGen))
                        traceMsg(comp(), "  permuteArgs:   %d: incoming argument\n", argIndex);
                } else {
                    newSignature = artificialSignature(stackAlloc, "(.*.@)I", newSignature, 0, nextHandleSignature, i);
                    ...
                    case '[':
                        ...
                        extraSignature
                            = artificialSignature(stackAlloc, "(L" JSR292_ArgumentMoverHandle ";I)Ljava/lang/Object;");
                        break;
                    default:
                        sprintf(extraName, "extra_%c", argType[0]);
                        extraSignature = artificialSignature(
                            stackAlloc, "(L" JSR292_ArgumentMoverHandle ";I).@", nextHandleSignature, i);
                        break;
                    }
                    if (comp()->getOption(TR_TraceILGen))
                        traceMsg(comp(), "  permuteArgs:   %d: call to %s.%s%s\n", argIndex, JSR292_ArgumentMoverHandle,
                            extraName, extraSignature);
                    TR::SymbolReference* extra = comp()->getSymRefTab()->methodSymRefFromName(
                        _methodSymbol, JSR292_ArgumentMoverHandle, extraName, extraSignature, TR::MethodSymbol::Static);
    ...
    case TR::java_lang_invoke_GuardWithTestHandle_numGuardArgs: {
...

        {
            ...
            methodHandle = *thunkDetails->getHandleRef();
            guardArgs = fej9->getReferenceField(fej9->methodHandle_type(fej9->getReferenceField(
                                                    methodHandle, "guard", "Ljava/lang/invoke/MethodHandle;")),
                "arguments", "[Ljava/lang/Class;");
    ...
    case TR::java_lang_invoke_DirectHandle_directCall: {
...

        {
            ...
            if (isInterface) {
                ...
                TR_OpaqueMethodBlock** vtable
                    = (TR_OpaqueMethodBlock**)(((uintptrj_t)fej9->getClassFromJavaLangClass(jlClass))
                        + J9JIT_INTERP_VTABLE_OFFSET);
        ...
        if (isIndirect) {
            ...
            TR::Node* vftLoad = TR::Node::createWithSymRef(
                TR::aloadi, 1, 1, callNode->getArgument(0), symRefTab()->findOrCreateVftSymbolRef());
    ...
    case TR::java_lang_invoke_DirectHandle_compiledEntryPoint: {
        ...
        TR::Node* extra
            = TR::Node::createWithSymRef(comp()->il.opCodeForIndirectLoad(extraField->getSymbol()->getDataType()), 1, 1,
                j9methodAddress, extraField);
        TR::Node* result = 0;
        switch (symRef->getSymbol()->castToMethodSymbol()->getMandatoryRecognizedMethod()) {
        case TR::java_lang_invoke_DirectHandle_isAlreadyCompiled: {
            ...
            TR::Node* mask = TR::Compiler->target.is64Bit() ? TR::Node::lconst(extra, J9_STARTPC_NOT_TRANSLATED)
        ...
        case TR::java_lang_invoke_DirectHandle_compiledEntryPoint:
            if (TR::Compiler->target.cpu.isI386()) {
                ...
                TR::Node* linkageInfo
                    = TR::Node::createWithSymRef(TR::iloadi, 1, 1, TR::Node::create(x2a, 1, extra), linkageInfoSymRef);
    ...
    case TR::java_lang_invoke_SpreadHandle_arrayArg: {
        ...
        int32_t spreadPosition = -1;
        {
            ...
            arrayJ9Class = (J9ArrayClass*)(intptrj_t)fej9->getInt64Field(
                arrayClass, "vmRef" /* should use fej9->getOffsetOfClassFromJavaLangClassField() */);
        ...
        char* leafClassNameChars = fej9->getClassNameChars(
            (TR_OpaqueClassBlock*)leafClass, leafClassNameLength); // eww, TR_FrontEnd downcast
    ...
    case TR::java_lang_invoke_SpreadHandle_spreadStart: {
...

        {
            ...
            methodHandle = *thunkDetails->getHandleRef();
            arguments
                = fej9->getReferenceField(fej9->methodHandle_type(methodHandle), "arguments", "[Ljava/lang/Class;");
            numArguments = (int32_t)fej9->getArrayLengthInElements(arguments);
    ...
    case TR::java_lang_invoke_FoldHandle_argIndices: {
        ...
        uintptrj_t argIndices;
        {
            ...
            if (arrayLength != 0) {
                ...
                uintptrj_t combinerArguments
                    = fej9->getReferenceField(fej9->methodHandle_type(combiner), "arguments", "[Ljava/lang/Class;");
    ...
    case TR::java_lang_invoke_FilterArgumentsHandle_filterArguments: {
...

        {
...

            {
                ...
                startPos = (int32_t)fej9->getInt32Field(methodHandle, "startPos");
                uintptrj_t methodDescriptorRef = fej9->getReferenceField(
                    fej9->getReferenceField(
                        fej9->getReferenceField(methodHandle, "next", "Ljava/lang/invoke/MethodHandle;"), "type",
                        "Ljava/lang/invoke/MethodType;"),
                    "methodDescriptor", "Ljava/lang/String;");
            ...
            for (int32_t childIndex = firstFilteredArgIndex; childIndex < placeholder->getNumChildren(); childIndex++) {
                ...
                if (haveFilter[arrayIndex]) {
                    ...
                    TR::SymbolReference* invokeExactWithSig = symRefWithArtificialSignature(
                        invokeExact, "(.@).@", placeholderSignature, childIndex, nextSignature, argumentIndex);
    ...
    case TR::java_lang_invoke_CatchHandle_numCatchTargetArgsToPassThrough: {
...

        {
            ...
            uintptrj_t methodHandle = *thunkDetails->getHandleRef();
            uintptrj_t catchTarget
                = fej9->getReferenceField(methodHandle, "catchTarget", "Ljava/lang/invoke/MethodHandle;");
            uintptrj_t catchArguments
                = fej9->getReferenceField(fej9->getReferenceField(catchTarget, "type", "Ljava/lang/invoke/MethodType;"),
                    "arguments", "[Ljava/lang/Class;");
    ...
    case TR::java_lang_invoke_ILGenMacros_parameterCount: {
...

        {
            ...
            uintptrj_t arguments = fej9->getReferenceField(
                fej9->getReferenceField(methodHandle, "type", "Ljava/lang/invoke/MethodType;"), "arguments",
                "[Ljava/lang/Class;");
...
uintptrj_t TR_J9ByteCodeIlGenerator::walkReferenceChain(TR::Node* node, uintptrj_t receiver)
{
    TR_J9VMBase* fej9 = (TR_J9VMBase*)(comp()->fe());
    uintptrj_t result = 0;
