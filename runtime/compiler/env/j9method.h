...
public:
    ...
    virtual const char* signature(
        TR_Memory*, TR_AllocationKind = heapAlloc); // this actually returns the class, method, and signature!
...
public:
    ...
    static TR_OpaqueClassBlock* getClassFromCP(
    ...
    static TR_OpaqueMethodBlock* getVirtualMethod(
        TR_J9VMBase* fej9, J9ConstantPool* cp, I_32 cpIndex, UDATA* vTableOffset, bool* unresolvedInCP);
    static TR_OpaqueClassBlock* getInterfaceITableIndexFromCP(
        TR_J9VMBase* fej9, J9ConstantPool* cp, int32_t cpIndex, uintptrj_t* pITableIndex);
    ...
    virtual TR_ResolvedMethod* getResolvedVirtualMethod(
        TR::Compilation*, int32_t cpIndex, bool ignoreRtResolve, bool* unresolvedInCP);
    virtual TR_ResolvedMethod* getResolvedPossiblyPrivateVirtualMethod(
        TR::Compilation*, int32_t cpIndex, bool ignoreRtResolve, bool* unresolvedInCP);
    ...
    virtual TR_ResolvedMethod* getResolvedVirtualMethod(
        TR::Compilation*, TR_OpaqueClassBlock* classObject, int32_t virtualCallOffset, bool ignoreRtResolve = true);
...
public:
    ...
    virtual TR_OpaqueClassBlock* getClassFromConstantPool(
        TR::Compilation*, uint32_t cpIndex, bool returnClassToAOT = false);
    virtual bool validateClassFromConstantPool(TR::Compilation* comp, J9Class* clazz, uint32_t cpIndex,
        TR_ExternalRelocationTargetKind reloKind = TR_ValidateClass);
    virtual bool validateArbitraryClass(TR::Compilation* comp, J9Class* clazz);
...
private:
    ...
    bool unresolvedFieldAttributes(
        int32_t cpIndex, TR::DataType* type, bool* volatileP, bool* isFinal, bool* isPrivate);
    bool unresolvedStaticAttributes(
        int32_t cpIndex, TR::DataType* type, bool* volatileP, bool* isFinal, bool* isPrivate);
    void setAttributeResult(
        bool, bool, uintptr_t, int32_t, int32_t, int32_t, TR::DataType*, bool*, bool*, bool*, void**);
    char* fieldOrStaticNameChars(int32_t cpIndex, int32_t& len);
