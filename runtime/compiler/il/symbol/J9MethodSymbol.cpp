...
TR_RuntimeHelper J9::MethodSymbol::getVMCallHelperFor(
    TR::DataType returnType, bool isSync, bool isNative, TR::Compilation* comp)
{
    if (isNative)
...
TR_RuntimeHelper J9::MethodSymbol::getVMCallHelper() { return self()->getVMCallHelper(TR::comp()); }

TR_RuntimeHelper J9::MethodSymbol::getVMCallHelper(TR::Compilation* comp)
{
    // Note: Unresolved methods are considered unsynchronized here.  Runtime
    // resolve helper corrects this if necessary.
    return self()->getVMCallHelperFor(self()->getMethod()->returnType(), self()->isSynchronised(),
        (self()->isVMInternalNative() || self()->isJITInternalNative()), comp);
}
...
static TR::RecognizedMethod canSkipNullChecks[] = {
    ...
    TR::java_math_BigDecimal_longString1C, TR::java_math_BigDecimal_longString2, TR::java_util_EnumMap__nec_,
    TR::java_util_TreeMapUnboundedValueIterator_next, TR::java_util_TreeMapSubMap_setFirstKey,
    TR::java_util_TreeMapSubMap_setLastKey, TR::java_lang_String_init_int_String_int_String_String,
    TR::java_lang_String_init_int_int_char_boolean, TR::java_lang_String_split_str_int, TR::java_nio_HeapByteBuffer_put,
    TR::unknownMethod
};
...
static TR::RecognizedMethod canSkipBoundChecks[] = {
    ...
    TR::java_lang_String_trim, TR::java_lang_String_charAt, TR::java_lang_String_charAtInternal_I,
    TR::java_lang_String_charAtInternal_IB, TR::java_lang_String_indexOf_String,
    ...
    TR::java_lang_String_split_str_int, TR::java_util_Hashtable_get, TR::java_util_Hashtable_put,
    TR::java_util_Hashtable_clone, TR::java_util_Hashtable_rehash, TR::java_util_Hashtable_remove,
    TR::java_util_Hashtable_contains, TR::java_util_Hashtable_getEntry,
    TR::java_util_HashtableHashEnumerator_hasMoreElements, TR::java_util_HashtableHashEnumerator_nextElement,
    TR::java_util_HashMap_getNode, TR::java_util_HashMap_resize, TR::java_util_HashMapHashIterator_nextNode,
    TR::java_util_HashMapHashIterator_init, TR::java_util_EnumMap_put, TR::java_util_EnumMap_typeCheck,
    TR::java_util_EnumMap__init_, TR::java_util_EnumMap__nec_, TR::java_util_TreeMap_all,
    TR::java_util_TreeMap_rbInsert, TR::java_math_BigDecimal_longString1C, TR::java_math_BigDecimal_longString2,
    TR::java_util_TreeMapUnboundedValueIterator_next, TR::java_util_TreeMapSubMap_setFirstKey,
    TR::java_util_TreeMapSubMap_setLastKey, TR::java_util_HashMap_get, TR::java_util_HashMap_findNonNullKeyEntry,
    TR::java_util_HashMap_putImpl, TR::java_lang_String_init_int_String_int_String_String,
    TR::java_lang_String_init_int_int_char_boolean, TR::java_nio_HeapByteBuffer_put, TR::unknownMethod
};
...
//
static TR::RecognizedMethod canSkipArrayStoreChecks[] = { TR::java_util_ArrayList_add,
    TR::java_util_ArrayList_ensureCapacity, TR::java_util_ArrayList_get, TR::java_util_ArrayList_remove,
    ...
    TR::java_util_TreeMap_rbInsert, TR::java_util_TreeMapUnboundedValueIterator_next,
    TR::java_util_TreeMapSubMap_setLastKey, TR::java_util_TreeMapSubMap_setFirstKey,
...
static TR::RecognizedMethod canSkipChecksOnArrayCopies[] = {
    ...
    TR::java_lang_String_concat, TR::java_lang_String_replace, TR::java_lang_String_toLowerCase,
    TR::java_lang_String_toUpperCase, TR::java_lang_String_toLowerCaseCore, TR::java_lang_String_toUpperCaseCore,
    TR::java_lang_String_toCharArray, TR::java_lang_StringBuffer_append, TR::java_lang_StringBuffer_ensureCapacityImpl,
    TR::java_lang_String_init_int_String_int_String_String, TR::java_lang_String_init_int_int_char_boolean,
    TR::java_util_HashMap_resize, TR::java_util_HashMapHashIterator_nextNode, TR::unknownMethod
};
...
static TR::RecognizedMethod canSkipZeroInitializationOnNewarrays[]
    = { TR::java_lang_String_init, TR::java_lang_String_init_int_int_char_boolean, TR::java_lang_String_concat,
          ...
          TR::java_lang_String_toLowerCaseCore,
          // TR::java_lang_String_toUpperCaseCore,
          TR::java_lang_String_split_str_int, TR::java_math_BigDecimal_toString, TR::java_lang_StringCoding_encode,
          ...
          TR::java_io_Writer_write_lStringII, TR::java_io_Writer_write_I, TR::unknownMethod };
