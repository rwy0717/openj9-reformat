...
template TR::StaticSymbol* J9::StaticSymbol::createRecognized(
    TR_HeapMemory m, TR::DataType d, TR::Symbol::RecognizedField f);
template TR::StaticSymbol* J9::StaticSymbol::createMethodTypeTableEntry(TR_HeapMemory m, int32_t methodTypeIndex);

template TR::StaticSymbol* J9::StaticSymbol::createRecognized(
    TR_StackMemory m, TR::DataType d, TR::Symbol::RecognizedField f);
template TR::StaticSymbol* J9::StaticSymbol::createMethodTypeTableEntry(TR_StackMemory m, int32_t methodTypeIndex);

template TR::StaticSymbol* J9::StaticSymbol::createRecognized(
    PERSISTENT_NEW_DECLARE m, TR::DataType d, TR::Symbol::RecognizedField f);
template TR::StaticSymbol* J9::StaticSymbol::createMethodTypeTableEntry(
    PERSISTENT_NEW_DECLARE m, int32_t methodTypeIndex);
