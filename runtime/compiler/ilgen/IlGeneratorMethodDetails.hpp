...
public:
    DumpMethodDetails(J9Method* const method)
        : TR::IlGeneratorMethodDetails(method)
    {}
    DumpMethodDetails(TR_ResolvedMethod* method)
        : TR::IlGeneratorMethodDetails(method)
    {}
    DumpMethodDetails(const DumpMethodDetails& other)
...
public:
    ArchetypeSpecimenDetails(J9Method* const method)
        : TR::IlGeneratorMethodDetails(method)
    {}
