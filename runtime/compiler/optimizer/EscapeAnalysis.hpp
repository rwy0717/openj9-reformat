...
public:
    ...
    bool checkOverlappingLoopAllocation(
    ...
    void referencedField(
        TR::Node* base, TR::Node* field, bool isStore, bool seenSelfStore = false, bool seenStoreToLocalObject = false);
