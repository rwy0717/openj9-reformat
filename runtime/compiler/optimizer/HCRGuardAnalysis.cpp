...
void TR_HCRGuardAnalysis::analyzeNode(
    TR::Node* node, vcount_t visitCount, TR_BlockStructure* block, TR_SingleBitContainer* bv)
{}
...
TR_HCRGuardAnalysis::TR_HCRGuardAnalysis(TR::Compilation* comp, TR::Optimizer* optimizer, TR_Structure* rootStructure)
    : TR_UnionSingleBitContainerAnalysis(
          comp, comp->getFlowGraph(), optimizer, false /*comp->getOption(TR_TraceFearPointAnalysis)*/)
{
...
void TR_HCRGuardAnalysis::initializeGenAndKillSetInfo()
{
    ...
    for (TR::TreeTop* treeTop = comp()->getStartTree(); treeTop; treeTop = treeTop->getNextTreeTop()) {
        ...
        } else if (ttNode->isTheVirtualGuardForAGuardedInlinedCall() && TR_FearPointAnalysis::virtualGuardsKillFear()
