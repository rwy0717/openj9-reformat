...
//*****************************************************************************************
TR_PCISCNode* createIdiomIOP2VarInLoop(
    TR_PCISCGraph* tgt, int32_t ctrl, int dagId, TR_PCISCNode* pred, int opcode, TR_PCISCNode* v, TR_PCISCNode* val)
{
...
//*****************************************************************************************
TR_PCISCNode* createIdiomDecVarInLoop(
    TR_PCISCGraph* tgt, int32_t ctrl, int dagId, TR_PCISCNode* pred, TR_PCISCNode* v, TR_PCISCNode* subval)
{
...
// create the idiom for "v = v + val"
//*****************************************************************************************
TR_PCISCNode* createIdiomIncVarInLoop(
    TR_PCISCGraph* tgt, int32_t ctrl, int dagId, TR_PCISCNode* pred, TR_PCISCNode* v, TR_PCISCNode* addval)
{
...
{
    return createIdiomArrayRelatedConst(
        tgt, ctrl, id, dagId, -(int32_t)TR::Compiler->om.contiguousArrayHeaderSizeInBytes());
}

//*****************************************************************************************
// when the environment is under 64-bit, it'll insert "i2l" to the node.
//*****************************************************************************************
TR_PCISCNode* createIdiomI2LIfNecessary(
    TR_PCISCGraph* tgt, int32_t ctrl, int dagId, TR_PCISCNode** pred, TR_PCISCNode* node)
{
...
// "InLoop" means that it sets the given dagId to all nodes in this subroutine.
//*****************************************************************************************
TR_PCISCNode* createIdiomArrayAddressInLoop(
    TR_PCISCGraph* tgt, int32_t ctrl, int dagId, TR_PCISCNode* pred, TR_PCISCNode* base, TR_PCISCNode* indexTree)
{
    TR_PCISCNode* n1;
    ...
    int opcode, TR::DataType dataType, TR_PCISCNode* addr, TR_PCISCNode* storeval)
{
    ...
    if (ctrl & CISCUtilCtl_NoConversion) {
        ...
        i2c = new (PERSISTENT_NEW)
            TR_PCISCNode(tgt->trMemory(), (opcode == TR::cstorei) ? (TR_CISCOps)TR::i2s : TR_conversion,
                (opcode == TR::cstorei) ? TR::Int16 : TR::NoType, tgt->incNumNodes(), dagId, 1, 1, pred);
        tgt->addNode(i2c);
...
// "InLoop" means that it sets the given dagId to all nodes in this subroutine.
//*****************************************************************************************
TR_PCISCNode* createIdiomCharArrayStoreBodyInLoop(
    TR_PCISCGraph* tgt, int32_t ctrl, int dagId, TR_PCISCNode* pred, TR_PCISCNode* addr, TR_PCISCNode* storeval)
{
...
{
    return createIdiomArrayStoreInLoop(
        tgt, ctrl, dagId, pred, TR::cstorei, TR::Int16, base, index, cmah, const2, storeval);
}
...
// "InLoop" means that it sets the given dagId to all nodes in this subroutine.
//*****************************************************************************************
TR_PCISCNode* createIdiomByteDirectArrayLoadInLoop(
    TR_PCISCGraph* tgt, int32_t ctrl, int dagId, TR_PCISCNode* pred, TR_PCISCNode* base, TR_PCISCNode* index)
{
    TR_PCISCNode* n2;
    TR_PCISCNode* n0;
    TR_PCISCNode* parentIndex;
...
//*****************************************************************************************
bool getThreeNodesForArray(
    TR_CISCNode* top, TR_CISCNode** ixloadORstore, TR_CISCNode** aload, TR_CISCNode** iload, bool allowArrayIndex)
{
    TR_CISCNode* p;
...
//*****************************************************************************************
TR::Node* createArrayAddressTree(
    TR::Compilation* comp, bool is64bit, TR::Node* baseNode, TR::Node* indexNode, int multiply)
{
...
//*****************************************************************************************
TR::Node* createArrayLoad(
    TR::Compilation* comp, bool is64bit, TR::Node* ixload, TR::Node* baseNode, TR::Node* indexNode, int multiply)
{
    TR::Node *top, *c1;
...
//*****************************************************************************************
TR::Node* replaceIndexInAddressTree(
    TR::Compilation* comp, TR::Node* tree, TR::SymbolReference* symRef, TR::Node* newNode)
{
...
//*****************************************************************************************
TR::Node* createTableLoad(
    TR::Compilation* comp, TR::Node* repNode, uint8_t inputSize, uint8_t outputSize, void* array, bool dispTrace)
{
    TR_SetTranslateTable setTable(
        comp, inputSize, outputSize, array, TR_TranslateTable::tableSize(inputSize, outputSize));
...
//*****************************************************************************************
bool getMultiplier(
    TR_CISCTransformer* trans, TR_CISCNode* mulConst, TR::Node** multiplier, int* elementSize, TR::DataType srcNodeType)
{
...
//*****************************************************************************************
void getP2TTrRepNodes(
    TR_CISCTransformer* trans, TR::Node** n1, TR::Node** n2, TR::Node** n3, TR::Node** n4, TR::Node** n5)
{
    TR::Node* array[5];
...
//*****************************************************************************************
void getP2TTrRepNodes(
    TR_CISCTransformer* trans, TR::Node** n1, TR::Node** n2, TR::Node** n3, TR::Node** n4, TR::Node** n5, TR::Node** n6)
{
    TR::Node* array[6];
...
//*****************************************************************************************
TR::Node* createTableAlignmentCheck(
    TR::Compilation* comp, TR::Node* tableNode, bool isByteSource, bool isByteTarget, bool tableBackedByRawStorage)
{
...
// will be replaced with the targetNode.
//*****************************************************************************************
bool findAndOrReplaceNodesWithMatchingSymRefNumber(
    TR::Node* curNode, TR::Node* targetNode, int32_t symRefNumberToBeMatched)
{
    bool isFound = false;
