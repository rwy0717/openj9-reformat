...
static const OptimizationStrategy J9EarlyGlobalOpts[] = { { OMR::stringBuilderTransformer },
    { OMR::stringPeepholes }, // need stringpeepholes to catch bigdecimal patterns
    { OMR::methodHandleInvokeInliningGroup, OMR::IfMethodHandleInvokes }, { OMR::inlining },
    { OMR::osrGuardInsertion, OMR::IfVoluntaryOSR }, { OMR::osrExceptionEdgeRemoval }, // most inlining is done by now
    { OMR::jProfilingBlock }, { OMR::stringBuilderTransformer },
    {
        OMR::stringPeepholes,
    },
    ...
    { OMR::treeSimplification }, { OMR::CFGSimplification }, { OMR::endGroup } };

static const OptimizationStrategy J9EarlyLocalOpts[] = { { OMR::localValuePropagation },
    //{ localValuePropagationGroup           },
    { OMR::localReordering }, { OMR::switchAnalyzer },
    ...
    { OMR::profiledNodeVersioning }, { OMR::endGroup } };
...
//
// **********************************************************
static const OptimizationStrategy noOptStrategyOpts[] = { { OMR::trivialDeadTreeRemoval, OMR::IfEnabled },
    { OMR::treeSimplification }, { OMR::recompilationModifier, OMR::IfEnabled },
    { OMR::globalLiveVariablesForGC, OMR::IfAggressiveLiveness }, { OMR::endOpts } };
...
static const OptimizationStrategy coldStrategyOpts[] = { { OMR::trivialDeadTreeRemoval, OMR::IfEnabled },
    { OMR::coldBlockOutlining }, { OMR::stringBuilderTransformer, OMR::IfNotQuickStart },
    { OMR::stringPeepholes, OMR::IfNotQuickStart }, // need stringpeepholes to catch bigdecimal patterns
    { OMR::trivialInlining }, { OMR::jProfilingBlock }, { OMR::virtualGuardTailSplitter },
    { OMR::recompilationModifier, OMR::IfEnabled }, { OMR::samplingJProfiling },
    { OMR::treeSimplification }, // cleanup before basicBlockExtension
    { OMR::basicBlockExtension }, { OMR::localValuePropagationGroup }, { OMR::deadTreesElimination },
    { OMR::localCSE, OMR::IfEnabled }, { OMR::treeSimplification }, { OMR::arraycopyTransformation },
    ...
    { OMR::localDeadStoreElimination, OMR::IfEnabled }, { OMR::deadTreesElimination, OMR::IfEnabled },
    { OMR::localCSE, OMR::IfEnabled }, { OMR::treeSimplification }, { OMR::dynamicLiteralPool, OMR::IfNotProfiling },
    { OMR::localCSE, OMR::IfEnabled }, { OMR::treeSimplification, OMR::MarkLastRun }, { OMR::rematerialization },
    { OMR::compactNullChecks, OMR::IfEnabled }, { OMR::signExtendLoadsGroup, OMR::IfEnabled },
    { OMR::jProfilingRecompLoopTest, OMR::IfLoops }, { OMR::jProfilingValue, OMR::MustBeDone },
    {
        OMR::trivialDeadTreeRemoval,
    },
    { OMR::cheapTacticalGlobalRegisterAllocatorGroup, OMR::IfAOTAndEnabled },
    { OMR::globalLiveVariablesForGC, OMR::IfAggressiveLiveness }, { OMR::profilingGroup, OMR::IfProfiling },
    { OMR::regDepCopyRemoval }, { OMR::endOpts } };
...
// ***************************************************************************
//
static const OptimizationStrategy warmStrategyOpts[] = { { OMR::trivialDeadTreeRemoval, OMR::IfEnabled },
    { OMR::coldBlockOutlining }, { OMR::stringBuilderTransformer },
    { OMR::stringPeepholes }, // need stringpeepholes to catch bigdecimal patterns
    { OMR::methodHandleInvokeInliningGroup, OMR::IfMethodHandleInvokes }, { OMR::inlining },
    { OMR::osrGuardInsertion, OMR::IfVoluntaryOSR }, { OMR::osrExceptionEdgeRemoval }, // most inlining is done by now
    { OMR::jProfilingBlock }, { OMR::virtualGuardTailSplitter }, // merge virtual guards
    { OMR::treeSimplification },
    { OMR::sequentialLoadAndStoreWarmGroup,
        OMR::IfEnabled }, // disabled by default, enabled by -Xjit:enableSequentialLoadStoreWarm
    { OMR::cheapGlobalValuePropagationGroup },
    { OMR::dataAccessAccelerator }, // globalValuePropagation and inlinging might expose opportunities for
                                    // dataAccessAccelerator
    { OMR::globalCopyPropagation, OMR::IfVoluntaryOSR }, { OMR::lastLoopVersionerGroup, OMR::IfLoops },
    { OMR::globalDeadStoreElimination, OMR::IfEnabledAndLoops }, { OMR::deadTreesElimination },
    ...
    { OMR::basicBlockOrdering, OMR::IfLoops }, // required for loop reduction
    { OMR::treeSimplification }, { OMR::loopReduction }, { OMR::blockShuffling }, // to stress idiom recognition
    { OMR::idiomRecognition, OMR::IfLoopsAndNotProfiling }, { OMR::blockSplitter }, { OMR::treeSimplification },
    { OMR::inductionVariableAnalysis, OMR::IfLoopsAndNotProfiling },
    { OMR::generalLoopUnroller, OMR::IfLoopsAndNotProfiling }, { OMR::virtualGuardHeadMerger },
    { OMR::basicBlockExtension, OMR::MarkLastRun }, // extend blocks; move trees around if reqd
    { OMR::treeSimplification }, // revisit; not really required ?
    { OMR::localValuePropagationGroup }, { OMR::arraycopyTransformation }, { OMR::treeSimplification, OMR::IfEnabled },
    ...
    { OMR::treeSimplification, OMR::IfEnabled }, { OMR::localCSE }, { OMR::treeSimplification, OMR::MarkLastRun },
    ...
    { OMR::generalStoreSinking }, { OMR::treesCleansing, OMR::IfEnabled },
    { OMR::deadTreesElimination, OMR::IfEnabled }, // cleanup at the end
    { OMR::localCSE, OMR::IfEnabled }, // common up expressions for sunk stores
    { OMR::treeSimplification, OMR::IfEnabledMarkLastRun }, // cleanup the trees after sunk store and localCSE
    { OMR::dynamicLiteralPool, OMR::IfNotProfiling }, { OMR::samplingJProfiling }, { OMR::trivialBlockExtension },
    { OMR::localDeadStoreElimination, OMR::IfEnabled }, // remove the astore if no literal pool is required
    { OMR::localCSE, OMR::IfEnabled }, // common up lit pool refs in the same block
    { OMR::deadTreesElimination, OMR::IfEnabled }, // cleanup at the end
    ...
    { OMR::treeSimplification,
        OMR::IfEnabledMarkLastRun }, // Simplify non-normalized address computations introduced by prefetch insertion
    { OMR::trivialDeadTreeRemoval, OMR::IfEnabled }, // final cleanup before opcode expansion
    { OMR::globalDeadStoreElimination, OMR::IfVoluntaryOSR }, { OMR::arraysetStoreElimination },
    { OMR::checkcastAndProfiledGuardCoalescer }, { OMR::jProfilingRecompLoopTest, OMR::IfLoops },
    { OMR::jProfilingValue, OMR::MustBeDone }, { OMR::cheapTacticalGlobalRegisterAllocatorGroup, OMR::IfEnabled },
    {
        OMR::globalDeadStoreGroup,
    },
    { OMR::rematerialization }, { OMR::compactNullChecks, OMR::IfEnabled }, // cleanup at the end
    { OMR::deadTreesElimination, OMR::IfEnabled }, // remove dead anchors created by check/store removal
    { OMR::deadTreesElimination, OMR::IfEnabled }, // remove dead RegStores produced by previous deadTrees pass
    { OMR::compactLocals, OMR::IfNotJitProfiling }, // analysis results are invalidated by profilingGroup
    { OMR::globalLiveVariablesForGC }, { OMR::profilingGroup, OMR::IfProfiling }, { OMR::regDepCopyRemoval },
    { OMR::endOpts } };
...
// ***************************************************************************
//
static const OptimizationStrategy reducedWarmStrategyOpts[] = { { OMR::inlining },
    { OMR::osrGuardInsertion, OMR::IfVoluntaryOSR }, { OMR::osrExceptionEdgeRemoval }, // most inlining is done by now
    { OMR::jProfilingBlock },
    { OMR::dataAccessAccelerator }, // immediate does unconditional dataAccessAccelerator after inlining
    { OMR::treeSimplification }, { OMR::deadTreesElimination }, { OMR::treeSimplification },
    { OMR::basicBlockExtension }, // extend blocks; move trees around if reqd
    { OMR::treeSimplification }, // revisit; not really required ?
    { OMR::localCSE }, { OMR::treeSimplification, OMR::MarkLastRun },
    { OMR::deadTreesElimination, OMR::IfEnabled }, // cleanup at the end
    { OMR::jProfilingRecompLoopTest, OMR::IfLoops }, { OMR::jProfilingValue, OMR::MustBeDone },
    { OMR::cheapTacticalGlobalRegisterAllocatorGroup, OMR::IfEnabled }, { OMR::endOpts } };
...
const OptimizationStrategy hotStrategyOpts[]
    = { { OMR::trivialDeadTreeRemoval, OMR::IfEnabled }, { OMR::coldBlockOutlining }, { OMR::earlyGlobalGroup },
          { OMR::earlyLocalGroup }, { OMR::stripMiningGroup, OMR::IfLoops }, // strip mining in loops
          ...
          { OMR::expensiveGlobalValuePropagationGroup }, { OMR::dataAccessAccelerator },
          { OMR::osrGuardRemoval, OMR::IfEnabled }, // run after calls/monents/asyncchecks have been removed
          {
              OMR::globalDeadStoreGroup,
          },
          { OMR::idiomRecognition,
              OMR::IfLoopsAndNotProfiling }, // Early pass of idiomRecognition - Loop Canonicalizer transformations
                                             // break certain idioms (i.e. arrayTranslateAndTest)
          ...
          { OMR::inductionVariableAnalysis, OMR::IfLoops }, { OMR::redundantInductionVarElimination, OMR::IfLoops },
          { OMR::loopAliasRefinerGroup, OMR::IfLoops }, { OMR::recompilationModifier, OMR::IfEnabledAndNotProfiling },
          {
              OMR::sequentialStoreSimplificationGroup,
          }, // reduce sequential stores into an arrayset
          { OMR::prefetchInsertionGroup, OMR::IfLoops }, // created IL should not be moved
          { OMR::partialRedundancyEliminationGroup }, { OMR::globalDeadStoreElimination, OMR::IfLoopsAndNotProfiling },
          { OMR::inductionVariableAnalysis, OMR::IfLoopsAndNotProfiling },
          { OMR::loopSpecializerGroup, OMR::IfLoopsAndNotProfiling },
          { OMR::inductionVariableAnalysis, OMR::IfLoopsAndNotProfiling },
          { OMR::generalLoopUnroller, OMR::IfLoopsAndNotProfiling }, // unroll Loops
          { OMR::blockManipulationGroup }, { OMR::lateLocalGroup },
          ...
          { OMR::dynamicLiteralPool, OMR::IfNotProfiling }, { OMR::trivialBlockExtension },
          { OMR::localDeadStoreElimination, OMR::IfEnabled }, // remove the astore if no literal pool is required
          { OMR::localCSE, OMR::IfEnabled }, // common up lit pool refs in the same block
          { OMR::deadTreesElimination, OMR::IfEnabled }, // cleanup at the end
          { OMR::signExtendLoadsGroup, OMR::IfEnabled }, // last opt before GRA
          { OMR::trivialDeadTreeRemoval, OMR::IfEnabled }, // final cleanup before opcode expansion
          { OMR::arraysetStoreElimination }, { OMR::localValuePropagation, OMR::MarkLastRun },
          { OMR::arraycopyTransformation }, { OMR::checkcastAndProfiledGuardCoalescer },
          { OMR::jProfilingRecompLoopTest, OMR::IfLoops }, { OMR::jProfilingValue, OMR::MustBeDone },
          ...
          { OMR::profilingGroup, OMR::IfProfiling }, { OMR::regDepCopyRemoval }, { OMR::endOpts } };
...
const OptimizationStrategy scorchingStrategyOpts[] = {
   ...
   { OMR::endOpts                                            }
#else
    { OMR::coldBlockOutlining }, { OMR::earlyGlobalGroup }, { OMR::earlyLocalGroup },
    ...
    { OMR::veryExpensiveGlobalValuePropagationGroup }, { OMR::dataAccessAccelerator }, // always run after GVP
    { OMR::osrGuardRemoval, OMR::IfEnabled }, // run after calls/monents/asyncchecks have been removed
    {
        OMR::globalDeadStoreGroup,
    },
    ...
    { OMR::expressionsSimplification, OMR::IfLoops }, { OMR::recompilationModifier, OMR::IfEnabled },

    { OMR::sequentialStoreSimplificationGroup }, // reduce sequential stores into an arrayset
    { OMR::prefetchInsertionGroup, OMR::IfLoops }, // created IL should not be moved
    { OMR::partialRedundancyEliminationGroup }, { OMR::globalDeadStoreElimination, OMR::IfLoops },
    { OMR::inductionVariableAnalysis, OMR::IfLoops }, { OMR::loopSpecializerGroup, OMR::IfLoops },
    { OMR::inductionVariableAnalysis, OMR::IfLoops }, { OMR::generalLoopUnroller, OMR::IfLoops }, // unroll Loops
    { OMR::blockSplitter, OMR::MarkLastRun }, { OMR::blockManipulationGroup }, { OMR::lateLocalGroup },
    { OMR::redundantAsyncCheckRemoval, OMR::IfNotJitProfiling }, // optimize async check placement
    { OMR::recompilationModifier, OMR::IfProfiling }, // do before GRA to avoid commoning of longs afterwards
    { OMR::globalCopyPropagation, OMR::IfMoreThanOneBlock }, // Can produce opportunities for store sinking
    { OMR::generalStoreSinking }, { OMR::localCSE, OMR::IfEnabled }, // common up lit pool refs in the same block
    { OMR::treeSimplification, OMR::IfEnabled }, // cleanup the trees after sunk store and localCSE
    { OMR::dynamicLiteralPool, OMR::IfNotProfiling }, { OMR::trivialBlockExtension },
    { OMR::localDeadStoreElimination, OMR::IfEnabled }, // remove the astore if no literal pool is required
    { OMR::localCSE, OMR::IfEnabled }, // common up lit pool refs in the same block
    ...
    { OMR::arraysetStoreElimination }, { OMR::localValuePropagation, OMR::MarkLastRun },
    { OMR::arraycopyTransformation }, { OMR::checkcastAndProfiledGuardCoalescer },
    { OMR::jProfilingValue, OMR::MustBeDone }, { OMR::tacticalGlobalRegisterAllocatorGroup, OMR::IfEnabled },
    { OMR::globalDeadStoreElimination, OMR::IfMoreThanOneBlock }, // global dead store removal
    { OMR::deadTreesElimination }, // cleanup after dead store removal
    { OMR::compactNullChecks }, // cleanup at the end
    { OMR::finalGlobalGroup }, // done just before codegen
...
//
// **********************************************************
static const OptimizationStrategy AOTStrategyOpts[] = { { OMR::earlyGlobalGroup }, { OMR::earlyLocalGroup },
    { OMR::stripMiningGroup, OMR::IfLoops }, // strip mining in loops
    { OMR::loopReplicator, OMR::IfLoops }, // tail-duplication in loops
    ...
    { OMR::localCSE, OMR::IfEnabled }, // common up lit pool refs in the same block
    { OMR::signExtendLoadsGroup, OMR::IfEnabled }, // last opt before GRA
    { OMR::arraysetStoreElimination }, { OMR::tacticalGlobalRegisterAllocatorGroup, OMR::IfEnabled },
...
static const OptimizationStrategy* j9CompilationStrategies[] = { noOptStrategyOpts, coldStrategyOpts, warmStrategyOpts,
    hotStrategyOpts, veryHotStrategyOpts, scorchingStrategyOpts, AOTStrategyOpts, reducedWarmStrategyOpts };
...
// ***************************************************************************
//
static const OptimizationStrategy cheapWarmStrategyOpts[] = { { OMR::trivialDeadTreeRemoval, OMR::IfEnabled },
    { OMR::coldBlockOutlining }, { OMR::stringBuilderTransformer },
    { OMR::stringPeepholes }, // need stringpeepholes to catch bigdecimal patterns
    { OMR::methodHandleInvokeInliningGroup, OMR::IfMethodHandleInvokes }, { OMR::inlining },
    { OMR::osrGuardInsertion, OMR::IfVoluntaryOSR }, { OMR::osrExceptionEdgeRemoval }, // most inlining is done by now
...
#endif
    { OMR::cheapGlobalValuePropagationGroup }, { OMR::dataAccessAccelerator },
#ifdef TR_HOST_S390
    ...
    { OMR::globalDeadStoreElimination, OMR::IfEnabledAndLoops }, { OMR::deadTreesElimination },
    { OMR::recompilationModifier, OMR::IfEnabledAndNotProfiling },
    { OMR::localReordering, OMR::IfNoLoopsOREnabledAndLoops }, { OMR::basicBlockOrdering, OMR::IfLoops },
    { OMR::treeSimplification }, { OMR::loopReduction }, { OMR::blockShuffling },
#endif
    { OMR::localCSE, OMR::IfLoopsAndNotProfiling }, { OMR::idiomRecognition, OMR::IfLoopsAndNotProfiling },
    { OMR::blockSplitter }, { OMR::treeSimplification }, // revisit; not really required ?
    { OMR::virtualGuardHeadMerger },
    { OMR::basicBlockExtension, OMR::MarkLastRun }, // extend blocks; move trees around if reqd
    { OMR::localValuePropagationGroup }, { OMR::explicitNewInitialization, OMR::IfNews },
    { OMR::arraycopyTransformation }, { OMR::treeSimplification, OMR::IfEnabled },
    { OMR::asyncCheckInsertion, OMR::IfNotJitProfiling }, { OMR::localCSE },
    { OMR::treeSimplification, OMR::MarkLastRun },
    { OMR::andSimplification, OMR::IfEnabled }, // clean up after versioner
    { OMR::compactNullChecks }, // cleanup at the end
    { OMR::deadTreesElimination, OMR::IfEnabled }, // cleanup at the end
    { OMR::globalCopyPropagation,
        OMR::IfMethodHandleInvokes }, // Does a lot of good after methodHandleInvokeInliningGroup
    { OMR::treesCleansing, OMR::IfEnabled }, { OMR::deadTreesElimination, OMR::IfEnabled }, // cleanup at the end
    { OMR::localCSE, OMR::IfEnabled }, // common up expressions for sunk stores
    { OMR::treeSimplification, OMR::IfEnabledMarkLastRun }, // cleanup the trees after sunk store and localCSE
...
static const OptimizationStrategy profilingOpts[]
    = { { OMR::profileGenerator, OMR::MustBeDone }, { OMR::deadTreesElimination, OMR::IfEnabled }, { OMR::endGroup } };
    ...
    : OMR::Optimizer(comp, methodSymbol, isIlGen, strategy, VNType)
{
    ...
    _opts[OMR::expensiveGlobalValuePropagationGroup] = new (comp->allocator()) TR::OptimizationManager(
        self(), NULL, OMR::expensiveGlobalValuePropagationGroup, expensiveGlobalValuePropagationOpts);
    ...
    _opts[OMR::sequentialStoreSimplificationGroup] = new (comp->allocator()) TR::OptimizationManager(
        self(), NULL, OMR::sequentialStoreSimplificationGroup, sequentialStoreSimplificationOpts);
