...
public:
    ...
    void transformCallToIconstInPlaceOrInDelayedTransformations(
        TR::TreeTop* callTree, int32_t result, bool isGlobal, bool inPlace = true);
...
private:
    struct TreeIntResultPair {
        ...
        TR::TreeTop* _tree;
        int32_t _result;
        TreeIntResultPair(TR::TreeTop* tree, int32_t result)
            : _tree(tree)
            , _result(result)
        {}
    };
