...
public:
    ...
    static bool addProfilingTrees(TR::Compilation* comp, TR::TreeTop* insertionPoint, TR::Node* value,
        TR_AbstractHashTableProfilerInfo* table, TR::Node* optionalTest = NULL, bool extendBlocks = true,
        bool trace = false);

private:
    static TR::Node* computeHash(
    ...
    static TR::Node* loadValue(
        TR::Compilation* comp, TR::DataType dataType, TR::Node* base, TR::Node* index = NULL, TR::Node* offset = NULL);
    ...
    static TR::Node* effectiveAddress(
        TR::DataType dataType, TR::Node* base, TR::Node* index = NULL, TR::Node* offset = NULL);
