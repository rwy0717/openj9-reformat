...
void TR_LoopAliasRefiner::collectArrayAliasCandidates(
    TR::Node* parentArrayNode, TR::Node* node, vcount_t visitCount, bool isStore)
{
...
void TR_LoopAliasRefiner::refineArrayAliases(TR_RegionStructure* whileLoop)
{
    if (_arrayRanges
        && !performTransformation(
               comp(), "%sRefining aliasing in loop %d\n", optDetailString(), whileLoop->getNumber()))
        return;
 ...
 */
TR::Node* TR_LoopAliasRefiner::ArrayRangeLimits::createRangeTestExpr(
    TR::Compilation* comp, ArrayRangeLimits* other, TR::Block* targetBlock, bool trace)
{
