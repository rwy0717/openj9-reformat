...
public:
    ...
    static void collectPredsAndSuccs(TR::CFGNode*, TR_BitVector*, TR_BitVector**, TR_BitVector**, List<TR::CFGEdge>*,
        TR_BitVector*, TR::Compilation*);
...
private:
    ...
    TR_Array<TR::Block*>* createFailHandlerBlocks(
    ...
    bool checkIfSuccsInList(
        TR::CFGEdgeList&, TR_BitVector*, bool checkIfControlFlowInCatch = false, TR::Block* block = NULL);
    ...
    bool addClassThatShouldNotBeNewlyExtended(
        TR_OpaqueClassBlock* clazz, TR_LinkHead<TR_ClassExtendCheck>*, bool stackAllocation);
