...
public:
    ...
    char* getName() { return getName(_sign); }
    ...
    static TR_BCDSignConstraint getMergedSignConstraint(
        TR_BCDSignConstraint signConstraintOne, TR_BCDSignConstraint signConstraintTwo)
    {
