...
bool CPU::isCompatible(TR_Processor processorSignature, TR_ProcessorFeatureFlags processorFeatureFlags)
{
    ...
    if ((processorSignature == TR_PPCgp || processorSignature == TR_PPCgr || processorSignature == TR_PPCp6
            || (processorSignature >= TR_PPCp7 && processorSignature <= TR_LastPPCProcessor))
        && (targetProcessor == TR_PPCgp || targetProcessor == TR_PPCgr || targetProcessor == TR_PPCp6
