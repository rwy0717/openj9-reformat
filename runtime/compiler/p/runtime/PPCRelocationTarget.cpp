...
void TR_PPCRelocationTarget::storeAddress(
...
void TR_PPCRelocationTarget::patchMTIsolatedOffset(uint32_t offset, uint8_t* reloLocation)
{
...
void TR_PPC64RelocationTarget::platformAddPICtoPatchPtrOnClassUnload(TR_OpaqueClassBlock* classKey, void* ptr)
{
    ...
    createClassUnloadPicSite(
        classKey, sitePointer, sizeof(int32_t), reloRuntime()->comp()->getMetadataAssumptionList());
}
