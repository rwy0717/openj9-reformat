...
TR::MemorySegment& J9::DebugSegmentProvider::request(size_t requiredSize)
{
    ...
    if (!segmentAllocation)
        throw std::bad_alloc();
    TR::MemorySegment& newSegment = *new (segmentArea) TR::MemorySegment(segmentArea, adjustedSize);
    return newSegment;
}

void J9::DebugSegmentProvider::release(TR::MemorySegment& segment) throw()
{
...
size_t J9::DebugSegmentProvider::bytesAllocated() const throw() { return 0; }
