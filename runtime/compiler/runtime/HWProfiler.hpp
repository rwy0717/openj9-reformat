...
public:
     ...
     */
    virtual void processBufferRecords(
        J9VMThread* vmThread, uint8_t* dataStart, uintptrj_t size, uintptrj_t bufferFilledSize, uint32_t dataTag = 0)
        = 0;
     ...
     * @return the Bytecode PC
     */
    uintptrj_t getPCFromMethodAndBCIndex(TR_OpaqueMethodBlock* method, uint32_t byteCodeIndex, TR::Compilation* comp);
     ...
     */
    TR_HWPBytecodePCToIAMap createBCMap(
