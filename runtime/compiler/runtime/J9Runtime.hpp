...
inline uint32_t getJitEntryOffset(TR_LinkageInfo* linkageInfo) { return linkageInfo->getReservedWord() & 0x0ffff; }
#endif
...
typedef enum { inlinedMethodIsStatic = 1, inlinedMethodIsSpecial = 2, inlinedMethodIsVirtual = 3 } TR_InlinedMethodKind;
