 ...
 */
template <typename T>
uint32_t TR_HashTableProfilerInfo<T>::getTotalFrequency()
{
 ...
 */
template <typename T>
uint32_t TR_HashTableProfilerInfo<T>::getNumProfiledValues()
{
    uint32_t* freqs = getFrequencies();
 ...
 */
template <typename T>
uint32_t TR_HashTableProfilerInfo<T>::getTopValue(T& value)
{
 ...
 */
template <typename T>
uint32_t TR_HashTableProfilerInfo<T>::getMaxValue(T& value)
{
    uint32_t topFrequency = 0;
    uint32_t* freqs = getFrequencies();
    T* values = getKeys();
 ...
 */
template <typename T>
void TR_HashTableProfilerInfo<T>::getList(TR::vector<TR_ProfiledValue<T>, TR::Region&>& vec)
{
    uint32_t numProfiled = 0;
    uint32_t* freqs = getFrequencies();
    T* values = getKeys();
 ...
 */
template <typename T>
void TR_HashTableProfilerInfo<T>::dumpInfo(TR::FILE* logFile)
{
    uint32_t* freqs = getFrequencies();
    T* values = getKeys();
 ...
 */
template <typename T, size_t bits>
bool TR_EmbeddedHashTable<T, bits>::resetLowFreqKeys()
{
    uint32_t matched = 0;
 ...
 */
template <typename T, size_t bits>
void TR_EmbeddedHashTable<T, bits>::reset()
{
 ...
 */
template <typename T, size_t bits>
void TR_EmbeddedHashTable<T, bits>::addKey(T value)
{
 ...
 */
template <typename T>
size_t TR_HashTableProfilerInfo<T>::initialHashConfig(HashFunction& hash, T value)
{
    ...
    if (getHashType() == BitIndexHash && ~value != 0 || getHashType() == BitShiftHash && (~value >> 8) != 0) {
        size_t firstZero = 0;
 ...
 */
template <typename T>
void TR_HashTableProfilerInfo<T>::updateHashConfig(HashFunction& hash, T mask)
{
 ...
 */
template <typename T, size_t bits>
T TR_EmbeddedHashTable<T, bits>::recursivelySplit(T mask, T choices)
{
    T key0, key1;
 ...
 */
template <typename T>
size_t TR_HashTableProfilerInfo<T>::applyHash(HashFunction& hash, T value)
{
    size_t result = 0;
    if (getHashType() == BitMaskHash) {
        size_t i = 1;
 ...
 */
template <typename T, size_t bits>
void TR_EmbeddedHashTable<T, bits>::rearrange(HashFunction& hash)
{
    static bool dumpInfo = feGetEnv("TR_JProfilingValueDumpInfo") != NULL;
...
public:
    ...
    TR_LinkedListProfilerInfo(
        TR_ByteCodeInfo& bci, TR_ValueInfoKind kind, T initialValue, uint32_t initialFreq, bool external = false)
        : TR_AbstractProfilerInfo(bci)
        , _kind(kind)
 ...
 */
template <typename T>
uint32_t TR_LinkedListProfilerInfo<T>::getNumProfiledValues()
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <typename T>
uint32_t TR_LinkedListProfilerInfo<T>::getTopValue(T& value)
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <typename T>
uint32_t TR_LinkedListProfilerInfo<T>::getMaxValue(T& value)
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <typename T>
void TR_LinkedListProfilerInfo<T>::getList(TR::vector<TR_ProfiledValue<T>, TR::Region&>& vec)
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <>
void TR_LinkedListProfilerInfo<TR_ByteInfo>::dumpInfo(TR::FILE* logFile);

template <typename T>
void TR_LinkedListProfilerInfo<T>::dumpInfo(TR::FILE* logFile)
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <typename T>
uint32_t TR_LinkedListProfilerInfo<T>::getTotalFrequency(uintptr_t** addrOfTotalFrequency)
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <typename T>
void TR_LinkedListProfilerInfo<T>::incrementOrCreate(
    T& value, uintptr_t** addrOfTotalFrequency, uint32_t maxNumValuesProfiled, uint32_t inc, TR::Region* region)
{
 ...
 */
template <typename T>
uint32_t TR_ArrayProfilerInfo<T>::getNumProfiledValues()
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <typename T>
uint32_t TR_ArrayProfilerInfo<T>::getTopValue(T& value)
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <typename T>
uint32_t TR_ArrayProfilerInfo<T>::getMaxValue(T& value)
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <typename T>
void TR_ArrayProfilerInfo<T>::getList(TR::vector<TR_ProfiledValue<T>, TR::Region&>& vec)
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <typename T>
void TR_ArrayProfilerInfo<T>::dumpInfo(TR::FILE* logFile)
{
    OMR::CriticalSection lock(vpMonitor);
 ...
 */
template <typename T>
void TR_ArrayProfilerInfo<T>::incrementOrCreate(const T& value)
{
 ...
 */
template <typename T>
float TR_GenericValueInfo<T>::getTopProbability()
{
    T tmp;
 ...
 */
template <typename T>
T TR_GenericValueInfo<T>::getTopValue()
{
    T temp;
 ...
 */
template <typename T>
T TR_GenericValueInfo<T>::getMaxValue()
{
    T temp;
 ...
 */
template <typename T>
void TR_GenericValueInfo<T>::getSortedList(Vector& vec)
{
 ...
 */
template <typename T>
void TR_GenericValueInfo<T>::getSortedList(TR::Compilation* comp, List<ProfiledValue>* sortedList)
{
