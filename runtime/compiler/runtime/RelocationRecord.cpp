...
TR_RelocationRecordBinaryTemplate* TR_RelocationRecordGroup::firstRecord(TR_RelocationTarget* reloTarget)
{
...
int32_t TR_RelocationRecordGroup::applyRelocations(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloOrigin)
{
...
int32_t TR_RelocationRecordGroup::handleRelocation(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget,
    TR_RelocationRecord* reloRecord, uint8_t* reloOrigin)
{
    ...
    TR_RelocationTarget* reloTarget, TR_RelocationRecordBinaryTemplate* record)
{
    ...
    // based on the type of the relocation record, create an object of a particular variety of TR_RelocationRecord
    // object
...
int32_t TR_RelocationRecord::bytesInHeaderAndPayload() { return sizeof(TR_RelocationRecordBinaryTemplate); }
...
uint8_t* TR_RelocationRecord::computeHelperAddress(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* baseLocation)
{
    ...
    if (reloRuntime->options()->getOption(TR_StressTrampolines)
        ...
        helperAddress = (uint8_t*)TR::CodeCacheManager::instance()->findHelperTrampoline(
            (void*)baseLocation, reloPrivateData->_helperID);
    }
...
bool TR_RelocationRecord::ignore(TR_RelocationRuntime* reloRuntime) { return false; }

int32_t TR_RelocationRecord::applyRelocationAtAllOffsets(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloOrigin)
{
...
void TR_RelocationRecordWithOffset::setOffset(TR_RelocationTarget* reloTarget, uintptrj_t offset)
{
    reloTarget->storeRelocationRecordValue(
        offset, (uintptrj_t*)&((TR_RelocationRecordWithOffsetBinaryTemplate*)_record)->_offset);
}

uintptrj_t TR_RelocationRecordWithOffset::offset(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordWithOffsetBinaryTemplate*)_record)->_offset);
}

int32_t TR_RelocationRecordWithOffset::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordWithOffsetBinaryTemplate);
}

void TR_RelocationRecordWithOffset::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    ...
    RELO_LOG(
        reloRuntime->reloLogger(), 6, "\tpreparePrivateData: addressToPatch: %p \n", reloPrivateData->_addressToPatch);
}

int32_t TR_RelocationRecordWithOffset::applyRelocation(
...
int32_t TR_RelocationRecordWithOffset::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    TR_RelocationRecordWithOffsetPrivateData* reloPrivateData = &(privateData()->offset);
    reloTarget->storeAddress(
        reloPrivateData->_addressToPatch, reloLocationHigh, reloLocationLow, reloFlags(reloTarget));
    return 0;
}

// TR_GlobalValue
//
char* TR_RelocationRecordGlobalValue::name() { return "TR_GlobalValue"; }

void TR_RelocationRecordGlobalValue::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationRecordWithOffsetPrivateData* reloPrivateData = &(privateData()->offset);
    reloPrivateData->_addressToPatch = (uint8_t*)reloRuntime->getGlobalValue((TR_GlobalValueItem)offset(reloTarget));
    RELO_LOG(
        reloRuntime->reloLogger(), 6, "\tpreparePrivateData: global value %p \n", reloPrivateData->_addressToPatch);
}

// TR_BodyInfoLoad
char* TR_RelocationRecordBodyInfoLoad::name() { return "TR_BodyInfoLoad"; }

void TR_RelocationRecordBodyInfoLoad::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationRecordWithOffsetPrivateData* reloPrivateData = &(privateData()->offset);
...
int32_t TR_RelocationRecordBodyInfoLoad::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordWithOffsetPrivateData* reloPrivateData = &(privateData()->offset);
    reloTarget->storeAddressSequence(reloPrivateData->_addressToPatch, reloLocation, reloFlags(reloTarget));
...
int32_t TR_RelocationRecordBodyInfoLoad::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    TR_RelocationRecordWithOffsetPrivateData* reloPrivateData = &(privateData()->offset);
    reloTarget->storeAddress(
...
// TR_ArrayCopyHelper
char* TR_RelocationRecordArrayCopyHelper::name() { return "TR_ArrayCopyHelper"; }

void TR_RelocationRecordArrayCopyHelper::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    ...
    RELO_LOG(
        reloRuntime->reloLogger(), 6, "\tpreparePrivateData: arraycopy helper %p\n", reloPrivateData->_addressToPatch);
}

int32_t TR_RelocationRecordArrayCopyHelper::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordArrayCopyPrivateData* reloPrivateData = &(privateData()->arraycopy);
    reloTarget->storeAddressSequence(reloPrivateData->_addressToPatch, reloLocation, reloFlags(reloTarget));
...
int32_t TR_RelocationRecordArrayCopyHelper::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    TR_RelocationRecordArrayCopyPrivateData* reloPrivateData = &(privateData()->arraycopy);
    reloTarget->storeAddress(
...
// TR_ArrayCopyToc
char* TR_RelocationRecordArrayCopyToc::name() { return "TR_ArrayCopyToc"; }

void TR_RelocationRecordArrayCopyToc::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationRecordArrayCopyPrivateData* reloPrivateData = &(privateData()->arraycopy);
    J9JITConfig* jitConfig = reloRuntime->jitConfig();
    ...
    RELO_LOG(
        reloRuntime->reloLogger(), 6, "\tpreparePrivateData: arraycopy toc %p\n", reloPrivateData->_addressToPatch);
}

// TR_RamMethodSequence
char* TR_RelocationRecordRamSequence::name() { return "TR_RamMethodSequence"; }

void TR_RelocationRecordRamSequence::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationRecordWithOffsetPrivateData* reloPrivateData = &(privateData()->offset);
...
void TR_RelocationRecordWithInlinedSiteIndex::setInlinedSiteIndex(
    TR_RelocationTarget* reloTarget, uintptrj_t inlinedSiteIndex)
{
    reloTarget->storeRelocationRecordValue(inlinedSiteIndex,
        (uintptrj_t*)&((TR_RelocationRecordWithInlinedSiteIndexBinaryTemplate*)_record)->_inlinedSiteIndex);
}

uintptrj_t TR_RelocationRecordWithInlinedSiteIndex::inlinedSiteIndex(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordWithInlinedSiteIndexBinaryTemplate*)_record)->_inlinedSiteIndex);
}

int32_t TR_RelocationRecordWithInlinedSiteIndex::bytesInHeaderAndPayload()
{
...
TR_OpaqueMethodBlock* TR_RelocationRecordWithInlinedSiteIndex::getInlinedSiteMethod(
    TR_RelocationRuntime* reloRuntime, uintptrj_t siteIndex)
{
...
bool TR_RelocationRecordWithInlinedSiteIndex::ignore(TR_RelocationRuntime* reloRuntime)
{
...
char* TR_RelocationRecordConstantPool::name() { return "TR_ConstantPool"; }
...
int32_t TR_RelocationRecordConstantPool::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordConstantPoolBinaryTemplate);
}

void TR_RelocationRecordConstantPool::setConstantPool(TR_RelocationTarget* reloTarget, uintptrj_t constantPool)
{
    reloTarget->storeRelocationRecordValue(
        constantPool, (uintptrj_t*)&((TR_RelocationRecordConstantPoolBinaryTemplate*)_record)->_constantPool);
}

uintptrj_t TR_RelocationRecordConstantPool::constantPool(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordConstantPoolBinaryTemplate*)_record)->_constantPool);
}

uintptrj_t TR_RelocationRecordConstantPool::currentConstantPool(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uintptrj_t oldValue)
{
...
uintptrj_t TR_RelocationRecordConstantPool::findConstantPool(
    TR_RelocationTarget* reloTarget, uintptrj_t oldValue, TR_OpaqueMethodBlock* ramMethod)
{
    uintptrj_t oldCPBase = constantPool(reloTarget);
...
uintptrj_t TR_RelocationRecordConstantPool::computeNewConstantPool(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uintptrj_t oldConstantPool)
{
    uintptrj_t newCP;
...
int32_t TR_RelocationRecordConstantPool::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
int32_t TR_RelocationRecordConstantPool::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    if (eipRelative(reloTarget)) {
        // j9tty_printf(PORTLIB, "\nInternal Error AOT: relocateConstantPool: Relocation type was IP-relative.\n");
...
void TR_RelocationRecordConstantPoolWithIndex::setCpIndex(TR_RelocationTarget* reloTarget, uintptrj_t cpIndex)
{
    reloTarget->storeRelocationRecordValue(
        cpIndex, (uintptrj_t*)&((TR_RelocationRecordConstantPoolWithIndexBinaryTemplate*)_record)->_index);
}

uintptrj_t TR_RelocationRecordConstantPoolWithIndex::cpIndex(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordConstantPoolWithIndexBinaryTemplate*)_record)->_index);
}

int32_t TR_RelocationRecordConstantPoolWithIndex::bytesInHeaderAndPayload()
{
    ...
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex)
{
    ...
    TR_OpaqueMethodBlock* method
        = (TR_OpaqueMethodBlock*)jitResolveSpecialMethodRef(vmThread, cp, cpIndex, J9_RESOLVE_FLAG_AOT_LOAD_TIME);
    ...
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex)
{
...

    {
        ...
        UDATA vTableOffset = javaVM->internalVMFunctions->resolveVirtualMethodRefInto(
            javaVM->internalVMFunctions->currentVMThread(javaVM), cp, cpIndex, J9_RESOLVE_FLAG_AOT_LOAD_TIME, &method,
            NULL);
    }
...
TR_OpaqueMethodBlock* TR_RelocationRecordConstantPoolWithIndex::getStaticMethodFromCP(
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex)
{
    ...
    TR_OpaqueMethodBlock* method = (TR_OpaqueMethodBlock*)jitResolveStaticMethodRef(
        javaVM->internalVMFunctions->currentVMThread(javaVM), cp, cpIndex, J9_RESOLVE_FLAG_AOT_LOAD_TIME);
    ...
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex, TR_OpaqueMethodBlock* callerMethod)
{
...

    {
        ...
        interfaceClass = (TR_OpaqueClassBlock*)javaVM->internalVMFunctions->resolveClassRef(
            reloRuntime->currentThread(), cp, romMethodRef->classRefCPIndex, J9_RESOLVE_FLAG_AOT_LOAD_TIME);
    }
    ...
    if (interfaceClass) {
        ...
        TR_ResolvedMethod* calleeResolvedMethod = chTable->findSingleInterfaceImplementer(
            interfaceClass, cpIndex, callerResolvedMethod, reloRuntime->comp(), false, false);
    ...
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex, TR_OpaqueMethodBlock* callerMethod)
{
...

    {
        ...
        vTableOffset = javaVM->internalVMFunctions->resolveVirtualMethodRefInto(
            reloRuntime->currentThread(), cp, cpIndex, J9_RESOLVE_FLAG_AOT_LOAD_TIME, &method, NULL);
    }
    ...
    if (abstractClass && method) {
        ...
        TR_ResolvedMethod* calleeResolvedMethod = chTable->findSingleAbstractImplementer(
            abstractClass, vftSlot, callerResolvedMethod, reloRuntime->comp(), false, false);
...
// TR_HelperAddress
char* TR_RelocationRecordHelperAddress::name() { return "TR_HelperAddress"; }
...
int32_t TR_RelocationRecordHelperAddress::bytesInHeaderAndPayload()
{
...
{
    reloTarget->storeUnsigned32b(
        helperID, (uint8_t*)&(((TR_RelocationRecordHelperAddressBinaryTemplate*)_record)->_helperID));
}
...
void TR_RelocationRecordHelperAddress::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationRecordHelperAddressPrivateData* reloPrivateData = &(privateData()->helperAddress);
...
int32_t TR_RelocationRecordHelperAddress::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint8_t* baseLocation = 0;
    if (eipRelative(reloTarget))
...
int32_t TR_RelocationRecordHelperAddress::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
...
char* TR_RelocationRecordAbsoluteHelperAddress::name() { return "TR_AbsoluteHelperAddress"; }

int32_t TR_RelocationRecordAbsoluteHelperAddress::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordHelperAddressPrivateData* reloPrivateData = &(privateData()->helperAddress);
    uint8_t* helperAddress = reloPrivateData->_helper;
...
int32_t TR_RelocationRecordAbsoluteHelperAddress::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    TR_RelocationRecordHelperAddressPrivateData* reloPrivateData = &(privateData()->helperAddress);
    uint8_t* helperAddress = reloPrivateData->_helper;
...
//
char* TR_RelocationRecordMethodAddress::name() { return "TR_MethodAddress"; }

uint8_t* TR_RelocationRecordMethodAddress::currentMethodAddress(
    TR_RelocationRuntime* reloRuntime, uint8_t* oldMethodAddress)
{
...
int32_t TR_RelocationRecordMethodAddress::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
int32_t TR_RelocationRecordMethodAddress::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    TR_RelocationRecordWithOffsetPrivateData* reloPrivateData = &(privateData()->offset);
    ...
    RELO_LOG(
        reloRuntime->reloLogger(), 6, "\t\tapplyRelocation: oldAddress %p newAddress %p\n", oldAddress, newAddress);
...
char* TR_RelocationRecordDirectJNICall::name() { return "TR_JNITargetAddress"; }

TR_OpaqueMethodBlock* TR_RelocationRecordDirectJNICall::getMethodFromCP(
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex)
{
...
TR_OpaqueMethodBlock* TR_RelocationRecordDirectJNISpecialMethodCall::getMethodFromCP(
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex)
{
    return getSpecialMethodFromCP(reloRuntime, void_cp, cpIndex);
}

TR_OpaqueMethodBlock* TR_RelocationRecordDirectJNIStaticMethodCall::getMethodFromCP(
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex)
{
    return getStaticMethodFromCP(reloRuntime, void_cp, cpIndex);
}

TR_OpaqueMethodBlock* TR_RelocationRecordDirectJNIVirtualMethodCall::getMethodFromCP(
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex)
{
    return getVirtualMethodFromCP(reloRuntime, void_cp, cpIndex);
}

int32_t TR_RelocationRecordRamMethodConst::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRuntimeLogger* reloLogger = reloRuntime->reloLogger();
...
int32_t TR_RelocationRecordDirectJNICall::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
char* TR_RelocationRecordDataAddress::name() { return "TR_DataAddress"; }
...
void TR_RelocationRecordDataAddress::setOffset(TR_RelocationTarget* reloTarget, uintptrj_t offset)
{
    reloTarget->storeRelocationRecordValue(
        offset, (uintptrj_t*)&((TR_RelocationRecordDataAddressBinaryTemplate*)_record)->_offset);
}

uintptrj_t TR_RelocationRecordDataAddress::offset(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordDataAddressBinaryTemplate*)_record)->_offset);
}

int32_t TR_RelocationRecordDataAddress::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordDataAddressBinaryTemplate);
}

uint8_t* TR_RelocationRecordDataAddress::findDataAddress(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    J9JITConfig* jitConfig = reloRuntime->jitConfig();
    J9JavaVM* javaVM = jitConfig->javaVM;
...
int32_t TR_RelocationRecordDataAddress::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
int32_t TR_RelocationRecordDataAddress::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    uint8_t* newAddress = findDataAddress(reloRuntime, reloTarget);
...
char* TR_RelocationRecordClassAddress::name() { return "TR_ClassAddress"; }

TR_OpaqueClassBlock* TR_RelocationRecordClassAddress::computeNewClassAddress(
    TR_RelocationRuntime* reloRuntime, uintptrj_t newConstantPool, uintptrj_t inlinedSiteIndex, uintptrj_t cpIndex)
{
    J9JavaVM* javaVM = reloRuntime->jitConfig()->javaVM;
...

    {
        ...
        resolvedClass = javaVM->internalVMFunctions->resolveClassRef(
            vmThread, (J9ConstantPool*)newConstantPool, cpIndex, J9_RESOLVE_FLAG_AOT_LOAD_TIME);
    }
...
int32_t TR_RelocationRecordClassAddress::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uintptrj_t oldAddress = (uintptrj_t)reloTarget->loadAddress(reloLocation);
    ...
    if (TR::CodeGenerator::wantToPatchClassPointer(reloRuntime->comp(), newAddress, reloLocation)) {
        ...
        RELO_LOG(
            reloRuntime->reloLogger(), 6, "\t\tapplyRelocation: hcr enabled, registered class redefinition site\n");
    }
...
int32_t TR_RelocationRecordClassAddress::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    uintptrj_t oldValue = (uintptrj_t)reloTarget->loadAddress(reloLocationHigh, reloLocationLow);
...
char* TR_RelocationRecordMethodObject::name() { return "TR_MethodObject"; }

int32_t TR_RelocationRecordMethodObject::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uintptrj_t oldAddress = (uintptrj_t)reloTarget->loadAddress(reloLocation);
...
int32_t TR_RelocationRecordMethodObject::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
...
char* TR_RelocationRecordBodyInfo::name() { return "TR_BodyInfo"; }

int32_t TR_RelocationRecordBodyInfo::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
char* TR_RelocationRecordThunks::name() { return "TR_Thunks"; }

int32_t TR_RelocationRecordThunks::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
int32_t TR_RelocationRecordThunks::relocateAndRegisterThunk(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uintptrj_t cp, uintptr_t cpIndex, uint8_t* reloLocation)
{
    J9JITConfig* jitConfig = reloRuntime->jitConfig();
    J9JavaVM* javaVM = reloRuntime->jitConfig()->javaVM;
    ...
    RELO_LOG(reloRuntime->reloLogger(), 6, "\t\trelocateAndRegisterThunk: %.*s%.*s\n",
        ...
        &(J9UTF8_DATA(J9ROMNAMEANDSIGNATURE_NAME(nameAndSignature))), signatureLength, signatureString);
    ...
    if (existingThunk != NULL) {
        ...
        RELO_LOG(
            reloRuntime->reloLogger(), 6, "\t\t\trelocateAndRegisterThunk:found matching thunk %p\n", existingThunk);
    ...
    javaVM->sharedClassConfig->findSharedData(reloRuntime->currentThread(), signatureString, signatureLength,
    ...
    if (firstDescriptor.address) {
        ...
        U_8* thunkStart = TR::CodeCacheManager::instance()->allocateCodeMemory(
            firstDescriptor.length, 0, &codeCache, &coldCode, true);
        U_8* thunkAddress;
        if (thunkStart) {
            // Relocate the thunk
            //
            RELO_LOG(
                reloRuntime->reloLogger(), 7, "\t\t\trelocateAndRegisterThunk: thunkStart from cache %p\n", thunkStart);
...
char* TR_RelocationRecordJ2IVirtualThunkPointer::name() { return "TR_J2IVirtualThunkPointer"; }

int32_t TR_RelocationRecordJ2IVirtualThunkPointer::bytesInHeaderAndPayload()
{
...
void TR_RelocationRecordJ2IVirtualThunkPointer::relocateJ2IVirtualThunkPointer(
    TR_RelocationTarget* reloTarget, uint8_t* reloLocation, void* thunk)
{
...
uintptrj_t TR_RelocationRecordJ2IVirtualThunkPointer::offsetToJ2IVirtualThunkPointer(TR_RelocationTarget* reloTarget)
{
...
char* TR_RelocationRecordPicTrampolines::name() { return "TR_PicTrampolines"; }
...
int32_t TR_RelocationRecordPicTrampolines::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordPicTrampolineBinaryTemplate);
}

void TR_RelocationRecordPicTrampolines::setNumTrampolines(TR_RelocationTarget* reloTarget, int numTrampolines)
{
    reloTarget->storeUnsigned8b(
        numTrampolines, (uint8_t*)&(((TR_RelocationRecordPicTrampolineBinaryTemplate*)_record)->_numTrampolines));
}

uint8_t TR_RelocationRecordPicTrampolines::numTrampolines(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadUnsigned8b(
        (uint8_t*)&(((TR_RelocationRecordPicTrampolineBinaryTemplate*)_record)->_numTrampolines));
}

int32_t TR_RelocationRecordPicTrampolines::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    if (reloRuntime->codeCache()->reserveNTrampolines(numTrampolines(reloTarget))
        != OMR::CodeCacheErrorCode::ERRORCODE_SUCCESS) {
        RELO_LOG(reloRuntime->reloLogger(), 1,
...
char* TR_RelocationRecordTrampolines::name() { return "TR_Trampolines"; }

int32_t TR_RelocationRecordTrampolines::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint8_t* oldAddress = reloTarget->loadAddress(reloLocation);
...
int32_t TR_RelocationRecordInlinedAllocation::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordInlinedAllocationBinaryTemplate);
}

void TR_RelocationRecordInlinedAllocation::setBranchOffset(TR_RelocationTarget* reloTarget, uintptrj_t branchOffset)
{
    reloTarget->storeRelocationRecordValue(
        branchOffset, (uintptrj_t*)&((TR_RelocationRecordInlinedAllocationBinaryTemplate*)_record)->_branchOffset);
}

uintptrj_t TR_RelocationRecordInlinedAllocation::branchOffset(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordInlinedAllocationBinaryTemplate*)_record)->_branchOffset);
}

void TR_RelocationRecordInlinedAllocation::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    ...
    if (reloRuntime->comp()->getOption(TR_UseSymbolValidationManager)) {
        ...
        clazz = javaVM->internalVMFunctions->resolveClassRef(javaVM->internalVMFunctions->currentVMThread(javaVM),
            newConstantPool, cpIndex(reloTarget), J9_RESOLVE_FLAG_AOT_LOAD_TIME);
    }

    bool inlinedCodeIsOkay = false;
    if (clazz) {
        RELO_LOG(reloRuntime->reloLogger(), 6, "\tpreparePrivateData: clazz %p %.*s\n", clazz,
            J9ROMCLASS_CLASSNAME(clazz->romClass)->length, J9ROMCLASS_CLASSNAME(clazz->romClass)->data);
...
bool TR_RelocationRecordInlinedAllocation::verifyClass(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, TR_OpaqueClassBlock* clazz)
{
    TR_ASSERT(0, "TR_RelocationRecordInlinedAllocation::verifyClass should never be called");
    return false;
}

int32_t TR_RelocationRecordInlinedAllocation::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordInlinedAllocationPrivateData* reloPrivateData = &(privateData()->inlinedAllocation);
...
char* TR_RelocationRecordVerifyRefArrayForAlloc::name() { return "TR_VerifyRefArrayForAlloc"; }

bool TR_RelocationRecordVerifyRefArrayForAlloc::verifyClass(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, TR_OpaqueClassBlock* clazz)
{
...
char* TR_RelocationRecordVerifyClassObjectForAlloc::name() { return "TR_VerifyClassObjectForAlloc"; }
...
int32_t TR_RelocationRecordVerifyClassObjectForAlloc::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordVerifyClassObjectForAllocBinaryTemplate);
}

void TR_RelocationRecordVerifyClassObjectForAlloc::setAllocationSize(
    TR_RelocationTarget* reloTarget, uintptrj_t allocationSize)
{
    reloTarget->storeRelocationRecordValue(allocationSize,
        (uintptrj_t*)&((TR_RelocationRecordVerifyClassObjectForAllocBinaryTemplate*)_record)->_allocationSize);
}

uintptrj_t TR_RelocationRecordVerifyClassObjectForAlloc::allocationSize(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordVerifyClassObjectForAllocBinaryTemplate*)_record)->_allocationSize);
}

bool TR_RelocationRecordVerifyClassObjectForAlloc::verifyClass(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, TR_OpaqueClassBlock* clazz)
{
...
void TR_RelocationRecordInlinedMethod::print(TR_RelocationRuntime* reloRuntime)
{
    ...
    TR_RelocationRuntimeLogger* reloLogger = reloRuntime->reloLogger();
    TR_RelocationRecordConstantPoolWithIndex::print(reloRuntime);
    J9ROMClass* inlinedCodeRomClass = (J9ROMClass*)reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(
        (void*)romClassOffsetInSharedCache(reloTarget));
    ...
    reloLogger->printf("\tromClassOffsetInSharedCache %x %.*s\n", romClassOffsetInSharedCache(reloTarget),
        inlinedCodeClassName->length, inlinedCodeClassName->data);
    // reloLogger->printf("\tromClassOffsetInSharedCache %x %.*s\n", romClassOffsetInSharedCache(reloTarget),
...
void TR_RelocationRecordInlinedMethod::setRomClassOffsetInSharedCache(
    TR_RelocationTarget* reloTarget, uintptrj_t romClassOffsetInSharedCache)
{
    reloTarget->storeRelocationRecordValue(romClassOffsetInSharedCache,
        (uintptrj_t*)&((TR_RelocationRecordInlinedMethodBinaryTemplate*)_record)->_romClassOffsetInSharedCache);
}

uintptrj_t TR_RelocationRecordInlinedMethod::romClassOffsetInSharedCache(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordInlinedMethodBinaryTemplate*)_record)->_romClassOffsetInSharedCache);
}

int32_t TR_RelocationRecordInlinedMethod::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordInlinedMethodBinaryTemplate);
}

void TR_RelocationRecordInlinedMethod::fixInlinedSiteInfo(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, TR_OpaqueMethodBlock* inlinedMethod)
{
    TR_InlinedCallSite* inlinedCallSite = (TR_InlinedCallSite*)getInlinedCallSiteArrayElement(
    ...
    if (reloRuntime->fej9()->isUnloadAssumptionRequired(
            classOfInlinedMethod, reloRuntime->comp()->getCurrentMethod())) {
        reloTarget->addPICtoPatchPtrOnClassUnload(classOfInlinedMethod, &(inlinedCallSite->_methodInfo));
    }
}

void TR_RelocationRecordInlinedMethod::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
...
bool TR_RelocationRecordInlinedMethod::inlinedSiteValid(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, TR_OpaqueMethodBlock** theMethod)
{
    ...
    RELO_LOG(reloRuntime->reloLogger(), 6, "\tinlinedSiteValid: caller method %.*s.%.*s%.*s\n", callerClassName->length,
        callerClassName->data, callerMethodName->length, callerMethodName->data, callerMethodSignature->length,
        callerMethodSignature->data);
    ...
    if (!cp) {
        ...
        if (reloRuntime->comp()->getOption(TR_UseSymbolValidationManager)) {
            ...
            if (needsReceiverClassFromID())
                reloPrivateData->_receiverClass
                    = (TR_OpaqueClassBlock*)reloRuntime->comp()->getSymbolValidationManager()->getSymbolFromID(
                        receiverClassID);
            else
            ...
            currentMethod
                = (J9Method*)getMethodFromCP(reloRuntime, cp, cpIndex(reloTarget), (TR_OpaqueMethodBlock*)callerMethod);
            if (!currentMethod)
                inlinedSiteIsValid = false;
        }
        ...
        if (inlinedSiteIsValid
            ...
            RELO_LOG(reloRuntime->reloLogger(), 6,
                "\tinlinedSiteValid: target may need enter/exit tracing so disabling inline site\n");
            inlinedSiteIsValid = false;
        }

        if (inlinedSiteIsValid) {
            /* Calculate the runtime rom class value from the code cache */
            void* compileRomClass = reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(
                (void*)romClassOffsetInSharedCache(reloTarget));
            ...
            if (compileRomClass == currentRomClass) {
                ...
                RELO_LOG(reloRuntime->reloLogger(), 6, "\tinlinedSiteValid: inlined method %.*s.%.*s%.*s\n",
                    className->length, className->data, methodName->length, methodName->data, methodSignature->length,
...
int32_t TR_RelocationRecordInlinedMethod::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
void TR_RelocationRecordNopGuard::setDestinationAddress(TR_RelocationTarget* reloTarget, uintptrj_t destinationAddress)
{
    reloTarget->storeRelocationRecordValue(
        destinationAddress, (uintptrj_t*)&((TR_RelocationRecordNopGuardBinaryTemplate*)_record)->_destinationAddress);
}

uintptrj_t TR_RelocationRecordNopGuard::destinationAddress(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordNopGuardBinaryTemplate*)_record)->_destinationAddress);
}

void TR_RelocationRecordNopGuard::invalidateGuard(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordInlinedMethodPrivateData* reloPrivateData = &(privateData()->inlinedMethod);
...
void TR_RelocationRecordNopGuard::activateGuard(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
int32_t TR_RelocationRecordNopGuard::bytesInHeaderAndPayload()
{
...
char* TR_RelocationRecordInlinedStaticMethodWithNopGuard::name() { return "TR_InlinedStaticMethodWithNopGuard"; }
...
char* TR_RelocationRecordInlinedSpecialMethodWithNopGuard::name() { return "TR_InlinedSpecialMethodWithNopGuard"; }
...
char* TR_RelocationRecordInlinedVirtualMethodWithNopGuard::name() { return "TR_InlinedVirtualMethodWithNopGuard"; }
...
void TR_RelocationRecordInlinedVirtualMethodWithNopGuard::createAssumptions(
    TR_RelocationRuntime* reloRuntime, uint8_t* reloLocation)
{
    TR_RelocationRecordInlinedMethodPrivateData* reloPrivateData = &(privateData()->inlinedMethod);
...
char* TR_RelocationRecordInlinedVirtualMethod::name() { return "TR_InlinedVirtualMethod"; }

void TR_RelocationRecordInlinedVirtualMethod::print(TR_RelocationRuntime* reloRuntime) { Base::print(reloRuntime); }

void TR_RelocationRecordInlinedVirtualMethod::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    Base::preparePrivateData(reloRuntime, reloTarget);
}

TR_OpaqueMethodBlock* TR_RelocationRecordInlinedVirtualMethod::getMethodFromCP(
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex)
{
    return getVirtualMethodFromCP(reloRuntime, void_cp, cpIndex);
}
...
char* TR_RelocationRecordInlinedInterfaceMethodWithNopGuard::name() { return "TR_InlinedInterfaceMethodWithNopGuard"; }

void TR_RelocationRecordInlinedInterfaceMethodWithNopGuard::createAssumptions(
    TR_RelocationRuntime* reloRuntime, uint8_t* reloLocation)
{
    TR_RelocationRecordInlinedMethodPrivateData* reloPrivateData = &(privateData()->inlinedMethod);
    ...
    sites.add(&site);
    TR_ClassQueries::addAnAssumptionForEachSubClass(
        table, table->findClassInfo(reloPrivateData->_receiverClass), sites, reloRuntime->comp());
}
...
char* TR_RelocationRecordInlinedInterfaceMethod::name() { return "TR_InlinedInterfaceMethod"; }

void TR_RelocationRecordInlinedInterfaceMethod::print(TR_RelocationRuntime* reloRuntime)
{
    TR_RelocationRecordInlinedMethod::print(reloRuntime);
}

void TR_RelocationRecordInlinedInterfaceMethod::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationRecordInlinedMethod::preparePrivateData(reloRuntime, reloTarget);
}

TR_OpaqueMethodBlock* TR_RelocationRecordInlinedInterfaceMethod::getMethodFromCP(
    TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpIndex, TR_OpaqueMethodBlock* callerMethod)
{
    return getInterfaceMethodFromCP(reloRuntime, void_cp, cpIndex, callerMethod);
}
...
char* TR_RelocationRecordInlinedAbstractMethodWithNopGuard::name() { return "TR_InlinedAbstractMethodWithNopGuard"; }
...
void TR_RelocationRecordInlinedAbstractMethodWithNopGuard::createAssumptions(
    TR_RelocationRuntime* reloRuntime, uint8_t* reloLocation)
{
    TR_RelocationRecordInlinedMethodPrivateData* reloPrivateData = &(privateData()->inlinedMethod);
    TR_PersistentCHTable* table = reloRuntime->getPersistentInfo()->getPersistentCHTable();
...
char* TR_RelocationRecordProfiledInlinedMethod::name() { return "TR_ProfiledInlinedMethod"; }
...
int32_t TR_RelocationRecordProfiledInlinedMethod::bytesInHeaderAndPayload()
{
...
void TR_RelocationRecordProfiledInlinedMethod::setClassChainIdentifyingLoaderOffsetInSharedCache(
    TR_RelocationTarget* reloTarget, uintptrj_t classChainIdentifyingLoaderOffsetInSharedCache)
{
    reloTarget->storeRelocationRecordValue(classChainIdentifyingLoaderOffsetInSharedCache,
        (uintptrj_t*)&((TR_RelocationRecordProfiledInlinedMethodBinaryTemplate*)_record)
            ->_classChainIdentifyingLoaderOffsetInSharedCache);
}

uintptrj_t TR_RelocationRecordProfiledInlinedMethod::classChainIdentifyingLoaderOffsetInSharedCache(
...
void TR_RelocationRecordProfiledInlinedMethod::setClassChainForInlinedMethod(
    TR_RelocationTarget* reloTarget, uintptrj_t classChainForInlinedMethod)
{
    reloTarget->storeRelocationRecordValue(classChainForInlinedMethod,
        (uintptrj_t*)&((TR_RelocationRecordProfiledInlinedMethodBinaryTemplate*)_record)->_classChainForInlinedMethod);
}

uintptrj_t TR_RelocationRecordProfiledInlinedMethod::classChainForInlinedMethod(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordProfiledInlinedMethodBinaryTemplate*)_record)->_classChainForInlinedMethod);
}

void TR_RelocationRecordProfiledInlinedMethod::setVTableSlot(TR_RelocationTarget* reloTarget, uintptrj_t vTableSlot)
{
    reloTarget->storeRelocationRecordValue(
        vTableSlot, (uintptrj_t*)&((TR_RelocationRecordProfiledInlinedMethodBinaryTemplate*)_record)->_vTableSlot);
}

uintptrj_t TR_RelocationRecordProfiledInlinedMethod::vTableSlot(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordProfiledInlinedMethodBinaryTemplate*)_record)->_vTableSlot);
}

bool TR_RelocationRecordProfiledInlinedMethod::checkInlinedClassValidity(
    TR_RelocationRuntime* reloRuntime, TR_OpaqueClassBlock* inlinedClass)
{
    return true;
}

void TR_RelocationRecordProfiledInlinedMethod::setupInlinedMethodData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
...
void TR_RelocationRecordProfiledInlinedMethod::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationRecordProfiledInlinedMethodPrivateData* reloPrivateData = &(privateData()->profiledInlinedMethod);
...
#else
    void* classChainIdentifyingLoader = reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(
        (void*)classChainIdentifyingLoaderOffsetInSharedCache(reloTarget));
    RELO_LOG(reloRuntime->reloLogger(), 6, "\tpreparePrivateData: classChainIdentifyingLoader %p\n",
        classChainIdentifyingLoader);
    J9ClassLoader* classLoader = (J9ClassLoader*)reloRuntime->fej9()
                                     ->sharedCache()
                                     ->persistentClassLoaderTable()
                                     ->lookupClassLoaderAssociatedWithClassChain(classChainIdentifyingLoader);
#endif
    ...
    if (classLoader) {
...

        {
            ...
            inlinedCodeClass = (TR_OpaqueClassBlock*)jitGetClassInClassloaderFromUTF8(
                vmThread, classLoader, J9UTF8_DATA(inlinedCodeClassName), J9UTF8_LENGTH(inlinedCodeClassName));
        }
        ...
        if (inlinedCodeClass && checkInlinedClassValidity(reloRuntime, inlinedCodeClass)) {
            ...
            uintptrj_t* chainData = (uintptrj_t*)reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(
                (void*)classChainForInlinedMethod(reloTarget));
            if (reloRuntime->fej9()->sharedCache()->classMatchesCachedVersion(inlinedCodeClass, chainData)) {
                ...
                TR_OpaqueMethodBlock* inlinedMethod = *(
                    TR_OpaqueMethodBlock**)(((uint8_t*)reloPrivateData->_inlinedCodeClass) + vTableSlot(reloTarget));

                if (reloRuntime->fej9()->isAnyMethodTracingEnabled(inlinedMethod)) {
                    RELO_LOG(reloRuntime->reloLogger(), 6,
                        "\tpreparePrivateData: target may need enter/exit tracing so disable inline site\n");
                } else {
                    fixInlinedSiteInfo(reloRuntime, reloTarget, inlinedMethod);

                    reloPrivateData->_needUnloadAssumption = !reloRuntime->fej9()->sameClassLoaders(
                        inlinedCodeClass, reloRuntime->comp()->getCurrentMethod()->classOfMethod());
...
// TR_ProfiledGuard
void TR_RelocationRecordProfiledGuard::activateGuard(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{}

void TR_RelocationRecordProfiledGuard::invalidateGuard(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{}

// TR_ProfileClassGuard
char* TR_RelocationRecordProfiledClassGuard::name() { return "TR_ProfiledClassGuard"; }

bool TR_RelocationRecordProfiledClassGuard::checkInlinedClassValidity(
    TR_RelocationRuntime* reloRuntime, TR_OpaqueClassBlock* inlinedCodeClass)
{
    return true;
    return !reloRuntime->fej9()->classHasBeenExtended(inlinedCodeClass)
        && !reloRuntime->options()->getOption(TR_DisableProfiledInlining);
}

void TR_RelocationRecordProfiledClassGuard::setupInlinedMethodData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationRecordProfiledInlinedMethodPrivateData* reloPrivateData = &(privateData()->profiledInlinedMethod);
...
char* TR_RelocationRecordProfiledMethodGuard::name() { return "TR_ProfiledMethodGuard"; }

bool TR_RelocationRecordProfiledMethodGuard::checkInlinedClassValidity(
    TR_RelocationRuntime* reloRuntime, TR_OpaqueClassBlock* inlinedCodeClass)
{
    return true;
...
void TR_RelocationRecordProfiledMethodGuard::setupInlinedMethodData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationRecordProfiledInlinedMethodPrivateData* reloPrivateData = &(privateData()->profiledInlinedMethod);
    TR_OpaqueMethodBlock* inlinedMethod
...
char* TR_RelocationRecordRamMethod::name() { return "TR_RamMethod"; }

int32_t TR_RelocationRecordRamMethod::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
int32_t TR_RelocationRecordRamMethod::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    RELO_LOG(reloRuntime->reloLogger(), 6, "\t\tapplyRelocation: method pointer %p\n",
        reloRuntime->exceptionTable()->ramMethod);
    reloTarget->storeAddress(
        (uint8_t*)reloRuntime->exceptionTable()->ramMethod, reloLocationHigh, reloLocationLow, reloFlags(reloTarget));
    return 0;
}
...
int32_t TR_RelocationRecordMethodTracingCheck::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordMethodTracingCheckBinaryTemplate);
}

void TR_RelocationRecordMethodTracingCheck::setDestinationAddress(
    TR_RelocationTarget* reloTarget, uintptrj_t destinationAddress)
{
    reloTarget->storeRelocationRecordValue(destinationAddress,
        (uintptrj_t*)&((TR_RelocationRecordMethodTracingCheckBinaryTemplate*)_record)->_destinationAddress);
}

uintptrj_t TR_RelocationRecordMethodTracingCheck::destinationAddress(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordMethodTracingCheckBinaryTemplate*)_record)->_destinationAddress);
}

void TR_RelocationRecordMethodTracingCheck::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
...
int32_t TR_RelocationRecordMethodTracingCheck::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordMethodTracingCheckPrivateData* reloPrivateData = &(privateData()->methodTracingCheck);
...
// TR_MethodEnterCheck
char* TR_RelocationRecordMethodEnterCheck::name() { return "TR_MethodEnterCheck"; }

bool TR_RelocationRecordMethodEnterCheck::ignore(TR_RelocationRuntime* reloRuntime)
{
    bool reportMethodEnter
        = reloRuntime->fej9()->isMethodEnterTracingEnabled((TR_OpaqueMethodBlock*)reloRuntime->method())
        || reloRuntime->fej9()->canMethodEnterEventBeHooked();
...
// TR_MethodExitCheck
char* TR_RelocationRecordMethodExitCheck::name() { return "TR_MethodExitCheck"; }

bool TR_RelocationRecordMethodExitCheck::ignore(TR_RelocationRuntime* reloRuntime)
{
    bool reportMethodExit
        = reloRuntime->fej9()->isMethodExitTracingEnabled((TR_OpaqueMethodBlock*)reloRuntime->method())
        || reloRuntime->fej9()->canMethodExitEventBeHooked();
...
char* TR_RelocationRecordValidateClass::name() { return "TR_ValidateClass"; }
...
int32_t TR_RelocationRecordValidateClass::bytesInHeaderAndPayload()
{
...
void TR_RelocationRecordValidateClass::setClassChainOffsetInSharedCache(
    TR_RelocationTarget* reloTarget, uintptrj_t classChainOffsetInSharedCache)
{
    reloTarget->storeRelocationRecordValue(classChainOffsetInSharedCache,
        (uintptrj_t*)&((TR_RelocationRecordValidateClassBinaryTemplate*)_record)->_classChainOffsetInSharedCache);
}

uintptrj_t TR_RelocationRecordValidateClass::classChainOffsetInSharedCache(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateClassBinaryTemplate*)_record)->_classChainOffsetInSharedCache);
}

void TR_RelocationRecordValidateClass::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{}

bool TR_RelocationRecordValidateClass::validateClass(
    TR_RelocationRuntime* reloRuntime, TR_OpaqueClassBlock* clazz, void* classChainOrRomClass)
{
...
int32_t TR_RelocationRecordValidateClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    ...
    bool verified = false;
    if (definingClass) {
        void* classChain = reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(
            (void*)classChainOffsetInSharedCache(reloTarget));
...
TR_OpaqueClassBlock* TR_RelocationRecordValidateClass::getClassFromCP(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, void* void_cp)
{
...
int32_t TR_RelocationRecordValidateClass::failureCode() { return compilationAotClassReloFailure; }

// TR_VerifyInstanceField
char* TR_RelocationRecordValidateInstanceField::name() { return "TR_ValidateInstanceField"; }

TR_OpaqueClassBlock* TR_RelocationRecordValidateInstanceField::getClassFromCP(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, void* void_cp)
{
    TR_OpaqueClassBlock* definingClass = NULL;
    if (void_cp) {
        J9JavaVM* javaVM = reloRuntime->javaVM();
        definingClass = reloRuntime->getClassFromCP(javaVM->internalVMFunctions->currentVMThread(javaVM), javaVM,
            (J9ConstantPool*)void_cp, cpIndex(reloTarget), false);
    }

    return definingClass;
}

int32_t TR_RelocationRecordValidateInstanceField::failureCode() { return compilationAotValidateFieldFailure; }

// TR_VerifyStaticField
char* TR_RelocationRecordValidateStaticField::name() { return "TR_ValidateStaticField"; }
...
int32_t TR_RelocationRecordValidateStaticField::bytesInHeaderAndPayload()
{
...
{
    reloTarget->storeRelocationRecordValue(romClassOffsetInSharedCache,
        (uintptrj_t*)&((TR_RelocationRecordValidateStaticFieldBinaryTemplate*)_record)->_romClassOffsetInSharedCache);
}

uintptrj_t TR_RelocationRecordValidateStaticField::romClassOffsetInSharedCache(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateStaticFieldBinaryTemplate*)_record)->_romClassOffsetInSharedCache);
}

TR_OpaqueClassBlock* TR_RelocationRecordValidateStaticField::getClass(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, void* void_cp)
{
    TR_OpaqueClassBlock* definingClass = NULL;
    if (void_cp) {
        J9JavaVM* javaVM = reloRuntime->javaVM();
        definingClass = reloRuntime->getClassFromCP(javaVM->internalVMFunctions->currentVMThread(javaVM), javaVM,
            (J9ConstantPool*)void_cp, cpIndex(reloTarget), true);
    }

    return definingClass;
}

bool TR_RelocationRecordValidateStaticField::validateClass(
    TR_RelocationRuntime* reloRuntime, TR_OpaqueClassBlock* clazz, void* classChainOrRomClass)
{
...
char* TR_RelocationRecordValidateArbitraryClass::name() { return "TR_ValidateArbitraryClass"; }
...
void TR_RelocationRecordValidateArbitraryClass::print(TR_RelocationRuntime* reloRuntime)
{
    ...
    reloLogger->printf(
        "\tclassChainOffsetForClassBeingValidated %p\n", classChainOffsetForClassBeingValidated(reloTarget));
}

void TR_RelocationRecordValidateArbitraryClass::setClassChainIdentifyingLoaderOffset(
    TR_RelocationTarget* reloTarget, uintptrj_t offset)
{
    reloTarget->storeRelocationRecordValue(offset,
        (uintptrj_t*)&((TR_RelocationRecordValidateArbitraryClassBinaryTemplate*)_record)->_loaderClassChainOffset);
}

uintptrj_t TR_RelocationRecordValidateArbitraryClass::classChainIdentifyingLoaderOffset(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateArbitraryClassBinaryTemplate*)_record)->_loaderClassChainOffset);
}
...
{
    reloTarget->storeRelocationRecordValue(offset,
        (uintptrj_t*)&((TR_RelocationRecordValidateArbitraryClassBinaryTemplate*)_record)
            ->_classChainOffsetForClassBeingValidated);
}

uintptrj_t TR_RelocationRecordValidateArbitraryClass::classChainOffsetForClassBeingValidated(
    TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateArbitraryClassBinaryTemplate*)_record)
...
int32_t TR_RelocationRecordValidateArbitraryClass::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordValidateArbitraryClassBinaryTemplate);
}

void TR_RelocationRecordValidateArbitraryClass::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{}

int32_t TR_RelocationRecordValidateArbitraryClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_AOTStats* aotStats = reloRuntime->aotStats();
    if (aotStats)
    ...
    void* classChainIdentifyingLoader = reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(
        (void*)classChainIdentifyingLoaderOffset(reloTarget));
    RELO_LOG(reloRuntime->reloLogger(), 6, "\t\tpreparePrivateData: classChainIdentifyingLoader %p\n",
        classChainIdentifyingLoader);
    ...
    if (classLoader) {
        uintptrj_t* classChainForClassBeingValidated
            = (uintptrj_t*)reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(
                (void*)classChainOffsetForClassBeingValidated(reloTarget));
        TR_OpaqueClassBlock* clazz = reloRuntime->fej9()->sharedCache()->lookupClassFromChainAndLoader(
            classChainForClassBeingValidated, classLoader);
...
int32_t TR_RelocationRecordValidateClassByName::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassByNameBinaryTemplate*)_record)->_classID);
    uint16_t beholderID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassByNameBinaryTemplate*)_record)->_beholderID);
    char primitiveType = (char)reloTarget->loadUnsigned8b(
        (uint8_t*)&((TR_RelocationRecordValidateClassByNameBinaryTemplate*)_record)->_primitiveType);
    void* romClassOffset = (void*)reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateClassByNameBinaryTemplate*)_record)->_romClassOffsetInSCC);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateClassByNameRecord(
            classID, beholderID, static_cast<J9ROMClass*>(romClass), primitiveType))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateProfiledClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateProfiledClassBinaryTemplate*)_record)->_classID);
    char primitiveType = (char)reloTarget->loadUnsigned8b(
        (uint8_t*)&((TR_RelocationRecordValidateProfiledClassBinaryTemplate*)_record)->_primitiveType);

    void* classChainForCLOffset = (void*)reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateProfiledClassBinaryTemplate*)_record)->_classChainOffsetForCLInScc);
    void* classChainForCL = reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(classChainForCLOffset);

    void* classChainOffset = (void*)reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateProfiledClassBinaryTemplate*)_record)->_classChainOffsetInSCC);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateProfiledClassRecord(
            classID, primitiveType, classChainForCL, classChain))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateClassFromCP::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classID = reloTarget->loadUnsigned16b(
    ...
    uint32_t cpIndex = reloTarget->loadUnsigned32b(
...
int32_t TR_RelocationRecordValidateDefiningClassFromCP::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classID = reloTarget->loadUnsigned16b(
    ...
    bool isStatic = (bool)reloTarget->loadUnsigned8b(
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateDefiningClassFromCPRecord(
            classID, beholderID, cpIndex, isStatic))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateStaticClassFromCP::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateStaticClassFromCPBinaryTemplate*)_record)->_classID);
    uint16_t beholderID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateStaticClassFromCPBinaryTemplate*)_record)->_beholderID);
    uint32_t cpIndex = reloTarget->loadUnsigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateStaticClassFromCPBinaryTemplate*)_record)->_cpIndex);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateStaticClassFromCPRecord(
            classID, beholderID, cpIndex))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateClassFromMethod::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassFromMethodBinaryTemplate*)_record)->_classID);
    uint16_t methodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassFromMethodBinaryTemplate*)_record)->_methodID);
...
int32_t TR_RelocationRecordValidateComponentClassFromArrayClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t componentClassID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateCompFromArrayBinaryTemplate*)_record)->_componentClassID);
    uint16_t arrayClassID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateCompFromArrayBinaryTemplate*)_record)->_arrayClassID);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateComponentClassFromArrayClassRecord(
            componentClassID, arrayClassID))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateArrayClassFromComponentClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t arrayClassID = reloTarget->loadUnsigned16b(
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateArrayClassFromComponentClassRecord(
            arrayClassID, componentClassID))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateSuperClassFromClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t superClassID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateSuperClassFromClassBinaryTemplate*)_record)->_superClassID);
    uint16_t childClassID = reloTarget->loadUnsigned16b(
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateSuperClassFromClassRecord(
            superClassID, childClassID))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateClassInstanceOfClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classOneID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassInstanceOfClassBinaryTemplate*)_record)->_classOneID);
    uint16_t classTwoID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassInstanceOfClassBinaryTemplate*)_record)->_classTwoID);
    bool objectTypeIsFixed = (bool)reloTarget->loadUnsigned8b(
        (uint8_t*)&((TR_RelocationRecordValidateClassInstanceOfClassBinaryTemplate*)_record)->_objectTypeIsFixed);
    bool castTypeIsFixed = (bool)reloTarget->loadUnsigned8b(
        (uint8_t*)&((TR_RelocationRecordValidateClassInstanceOfClassBinaryTemplate*)_record)->_castTypeIsFixed);
    bool isInstanceOf = (bool)reloTarget->loadUnsigned8b(
    ...
    if (reloRuntime->reloLogger()->logEnabled()) {
        ...
        reloRuntime->reloLogger()->printf(
            "\tapplyRelocation: objectTypeIsFixed %s\n", objectTypeIsFixed ? "true" : "false'");
        reloRuntime->reloLogger()->printf(
            "\tapplyRelocation: castTypeIsFixed %s\n", castTypeIsFixed ? "true" : "false'");
        reloRuntime->reloLogger()->printf("\tapplyRelocation: isInstanceOf %s\n", isInstanceOf ? "true" : "false'");
    }

    if (reloRuntime->comp()->getSymbolValidationManager()->validateClassInstanceOfClassRecord(
            classOneID, classTwoID, objectTypeIsFixed, castTypeIsFixed, isInstanceOf))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateSystemClassByName::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t systemClassID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateSystemClassByNameBinaryTemplate*)_record)->_systemClassID);
    void* romClassOffset = (void*)reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateSystemClassByNameBinaryTemplate*)_record)->_romClassOffsetInSCC);
    void* romClass = reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(romClassOffset);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateSystemClassByNameRecord(
            systemClassID, static_cast<J9ROMClass*>(romClass)))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateClassFromITableIndexCP::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassFromITableIndexCPBinaryTemplate*)_record)->_classID);
    uint16_t beholderID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassFromITableIndexCPBinaryTemplate*)_record)->_beholderID);
    uint32_t cpIndex = reloTarget->loadUnsigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateClassFromITableIndexCPBinaryTemplate*)_record)->_cpIndex);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateClassFromITableIndexCPRecord(
            classID, beholderID, cpIndex))
        return 0;
    else
        return compilationAotClassReloFailure;
...
int32_t TR_RelocationRecordValidateDeclaringClassFromFieldOrStatic::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateDeclaringClassFromFieldOrStaticBinaryTemplate*)_record)->_classID);
    uint16_t beholderID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateDeclaringClassFromFieldOrStaticBinaryTemplate*)_record)->_beholderID);
    uint32_t cpIndex = reloTarget->loadUnsigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateDeclaringClassFromFieldOrStaticBinaryTemplate*)_record)->_cpIndex);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateDeclaringClassFromFieldOrStaticRecord(
            classID, beholderID, cpIndex))
        return 0;
    else
        return compilationAotClassReloFailure;
...
int32_t TR_RelocationRecordValidateClassClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classClassID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassClassBinaryTemplate*)_record)->_classClassID);
    uint16_t objectClassID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassClassBinaryTemplate*)_record)->_objectClassID);
...
int32_t TR_RelocationRecordValidateConcreteSubClassFromClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t childClassID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateConcreteSubFromClassBinaryTemplate*)_record)->_childClassID);
    uint16_t superClassID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateConcreteSubFromClassBinaryTemplate*)_record)->_superClassID);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateConcreteSubClassFromClassRecord(
            childClassID, superClassID))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateClassChain::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassChainBinaryTemplate*)_record)->_classID);
    void* classChainOffset = (void*)reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateClassChainBinaryTemplate*)_record)->_classChainOffsetInSCC);
    void* classChain = reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(classChainOffset);
...
int32_t TR_RelocationRecordValidateMethodByName::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodByNameBinaryTemplate*)_record)->_methodID);
    uint16_t beholderID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodByNameBinaryTemplate*)_record)->_beholderID);

    void* romClassOffset = (void*)reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateMethodByNameBinaryTemplate*)_record)->_romClassOffsetInSCC);
    void* romClass = reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(romClassOffset);

    void* romMethodOffset = (void*)reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateMethodByNameBinaryTemplate*)_record)->_romMethodOffsetInSCC);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateMethodByNameRecord(
            methodID, beholderID, static_cast<J9ROMClass*>(romClass), static_cast<J9ROMMethod*>(romMethod)))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateMethodFromClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
    ...
    uint32_t index = reloTarget->loadUnsigned32b(
...
int32_t TR_RelocationRecordValidateStaticMethodFromCP::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateStaticMethodFromCPBinaryTemplate*)_record)->_methodID);
    uint16_t beholderID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateStaticMethodFromCPBinaryTemplate*)_record)->_beholderID);
    uint32_t cpIndex = reloTarget->loadUnsigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateStaticMethodFromCPBinaryTemplate*)_record)->_cpIndex);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateStaticMethodFromCPRecord(
            methodID, beholderID, cpIndex))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateSpecialMethodFromCP::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateSpecialMethodFromCPBinaryTemplate*)_record)->_methodID);
    uint16_t beholderID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateSpecialMethodFromCPBinaryTemplate*)_record)->_beholderID);
    uint32_t cpIndex = reloTarget->loadUnsigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateSpecialMethodFromCPBinaryTemplate*)_record)->_cpIndex);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateSpecialMethodFromCPRecord(
            methodID, beholderID, cpIndex))
        return 0;
    else
        return compilationAotClassReloFailure;
...
int32_t TR_RelocationRecordValidateVirtualMethodFromCP::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateVirtualMethodFromCPBinaryTemplate*)_record)->_methodID);
    uint16_t beholderID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateVirtualMethodFromCPBinaryTemplate*)_record)->_beholderID);
    uint32_t cpIndex = reloTarget->loadUnsigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateVirtualMethodFromCPBinaryTemplate*)_record)->_cpIndex);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateVirtualMethodFromCPRecord(
            methodID, beholderID, cpIndex))
        return 0;
    else
        return compilationAotClassReloFailure;
...
int32_t TR_RelocationRecordValidateVirtualMethodFromOffset::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
    ...
    uint32_t virtualCallOffset = reloTarget->loadUnsigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateVirtualMethodFromOffsetBinaryTemplate*)_record)->_virtualCallOffset);
    bool ignoreRtResolve = (bool)reloTarget->loadUnsigned8b(
        (uint8_t*)&((TR_RelocationRecordValidateVirtualMethodFromOffsetBinaryTemplate*)_record)->_ignoreRtResolve);
    ...
    if (reloRuntime->reloLogger()->logEnabled()) {
        ...
        reloRuntime->reloLogger()->printf(
            "\tapplyRelocation: ignoreRtResolve %s\n", ignoreRtResolve ? "true" : "false");
    }

    if (reloRuntime->comp()->getSymbolValidationManager()->validateVirtualMethodFromOffsetRecord(
            methodID, beholderID, virtualCallOffset, ignoreRtResolve))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateInterfaceMethodFromCP::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
    ...
    uint16_t lookupID = reloTarget->loadUnsigned16b(
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateInterfaceMethodFromCPRecord(
            methodID, beholderID, lookupID, cpIndex))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateImproperInterfaceMethodFromCP::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateImproperInterfaceMethodFromCPBinaryTemplate*)_record)->_methodID);
    uint16_t beholderID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateImproperInterfaceMethodFromCPBinaryTemplate*)_record)->_beholderID);
    uint32_t cpIndex = reloTarget->loadUnsigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateImproperInterfaceMethodFromCPBinaryTemplate*)_record)->_cpIndex);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateImproperInterfaceMethodFromCPRecord(
            methodID, beholderID, cpIndex))
        return 0;
    else
        return compilationAotClassReloFailure;
...
int32_t TR_RelocationRecordValidateMethodFromClassAndSig::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromClassAndSigBinaryTemplate*)_record)->_methodID);
    uint16_t methodClassID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromClassAndSigBinaryTemplate*)_record)->_methodClassID);
    uint16_t beholderID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromClassAndSigBinaryTemplate*)_record)->_beholderID);

    void* romMethodOffset = (void*)reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordValidateMethodFromClassAndSigBinaryTemplate*)_record)
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateMethodFromClassAndSignatureRecord(
            methodID, methodClassID, beholderID, static_cast<J9ROMMethod*>(romMethod)))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateStackWalkerMaySkipFrames::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
    ...
    bool skipFrames = reloTarget->loadUnsigned8b(
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateStackWalkerMaySkipFramesRecord(
            methodID, methodClassID, skipFrames))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateClassInfoIsInitialized::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t classID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateClassInfoIsInitializedBinaryTemplate*)_record)->_classID);
    bool wasInitialized = (bool)reloTarget->loadUnsigned8b(
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateClassInfoIsInitializedRecord(
            classID, wasInitialized))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateMethodFromSingleImpl::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromSingleImplBinaryTemplate*)_record)->_methodID);
    uint16_t thisClassID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromSingleImplBinaryTemplate*)_record)->_thisClassID);
    int32_t cpIndexOrVftSlot = reloTarget->loadSigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromSingleImplBinaryTemplate*)_record)->_cpIndexOrVftSlot);
    uint16_t callerMethodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromSingleImplBinaryTemplate*)_record)->_callerMethodID);
    uint16_t useGetResolvedInterfaceMethod = reloTarget->loadUnsigned16b(
    ...
    if (reloRuntime->reloLogger()->logEnabled()) {
        ...
        reloRuntime->reloLogger()->printf(
            "\tapplyRelocation: useGetResolvedInterfaceMethod %d\n", useGetResolvedInterfaceMethod);
    }

    if (reloRuntime->comp()->getSymbolValidationManager()->validateMethodFromSingleImplementerRecord(
            methodID, thisClassID, cpIndexOrVftSlot, callerMethodID, (TR_YesNoMaybe)useGetResolvedInterfaceMethod))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateMethodFromSingleInterfaceImpl::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
    ...
    int32_t cpIndex = reloTarget->loadSigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromSingleInterfaceImplBinaryTemplate*)_record)->_cpIndex);
    uint16_t callerMethodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromSingleInterfaceImplBinaryTemplate*)_record)->_callerMethodID);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateMethodFromSingleInterfaceImplementerRecord(
            methodID, thisClassID, cpIndex, callerMethodID))
        return 0;
    else
        return compilationAotClassReloFailure;
}

int32_t TR_RelocationRecordValidateMethodFromSingleAbstractImpl::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    uint16_t methodID = reloTarget->loadUnsigned16b(
    ...
    int32_t vftSlot = reloTarget->loadSigned32b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromSingleAbstractImplBinaryTemplate*)_record)->_vftSlot);
    uint16_t callerMethodID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordValidateMethodFromSingleAbstractImplBinaryTemplate*)_record)->_callerMethodID);
    ...
    if (reloRuntime->comp()->getSymbolValidationManager()->validateMethodFromSingleAbstractImplementerRecord(
            methodID, thisClassID, vftSlot, callerMethodID))
        return 0;
    else
        return compilationAotClassReloFailure;
}

void TR_RelocationRecordSymbolFromManager::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationSymbolFromManagerPrivateData* reloPrivateData = &(privateData()->symbolFromManager);

    uint16_t symbolID = reloTarget->loadUnsigned16b(
        (uint8_t*)&((TR_RelocationRecordSymbolFromManagerBinaryTemplate*)_record)->_symbolID);
    uint16_t symbolType = reloTarget->loadUnsigned16b(
...
int32_t TR_RelocationRecordSymbolFromManager::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationSymbolFromManagerPrivateData* reloPrivateData = &(privateData()->symbolFromManager);
...
bool TR_RelocationRecordSymbolFromManager::needsRedefinitionAssumption(
    TR_RelocationRuntime* reloRuntime, uint8_t* reloLocation, TR_OpaqueClassBlock* clazz, TR::SymbolType symbolType)
{
    if (!reloRuntime->options()->getOption(TR_EnableHCR))
        return false;
    ...
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    ...
    if (needsRedefinitionAssumption(reloRuntime, reloLocation, clazz, symbolType)) {
        ...
        createClassRedefinitionPicSite((void*)reloPrivateData->_symbol, (void*)reloLocation, sizeof(uintptrj_t), false,
...
// TR_HCR
char* TR_RelocationRecordHCR::name() { return "TR_HCR"; }

bool TR_RelocationRecordHCR::ignore(TR_RelocationRuntime* reloRuntime)
{
...
int32_t TR_RelocationRecordHCR::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    void* methodAddress = (void*)reloRuntime->exceptionTable()->ramMethod;
    if (offset(reloTarget)) // non-NULL means resolved
        createClassRedefinitionPicSite(methodAddress, (void*)reloLocation, sizeof(UDATA), true,
            getMetadataAssumptionList(reloRuntime->exceptionTable()));
    else {
...
int32_t TR_RelocationRecordPointer::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordPointerBinaryTemplate);
}

bool TR_RelocationRecordPointer::ignore(TR_RelocationRuntime* reloRuntime)
{
...
{
    reloTarget->storeRelocationRecordValue(classChainIdentifyingLoaderOffsetInSharedCache,
        (uintptrj_t*)&((TR_RelocationRecordPointerBinaryTemplate*)_record)
            ->_classChainIdentifyingLoaderOffsetInSharedCache);
}

uintptrj_t TR_RelocationRecordPointer::classChainIdentifyingLoaderOffsetInSharedCache(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue((uintptrj_t*)&((TR_RelocationRecordPointerBinaryTemplate*)_record)
                                                     ->_classChainIdentifyingLoaderOffsetInSharedCache);
}
...
{
    reloTarget->storeRelocationRecordValue(classChainForInlinedMethod,
        (uintptrj_t*)&((TR_RelocationRecordPointerBinaryTemplate*)_record)->_classChainForInlinedMethod);
}

uintptrj_t TR_RelocationRecordPointer::classChainForInlinedMethod(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordPointerBinaryTemplate*)_record)->_classChainForInlinedMethod);
}
...
void TR_RelocationRecordPointer::preparePrivateData(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    ...
    if (getInlinedSiteMethod(reloRuntime, inlinedSiteIndex(reloTarget)) != (TR_OpaqueMethodBlock*)-1) {
        ...
        RELO_LOG(reloRuntime->reloLogger(), 6, "\tpreparePrivateData: classChainIdentifyingLoader %p\n",
            classChainIdentifyingLoader);
        classLoader = (J9ClassLoader*)reloRuntime->fej9()
                          ->sharedCache()
                          ->persistentClassLoaderTable()
                          ->lookupClassLoaderAssociatedWithClassChain(classChainIdentifyingLoader);
#endif
        ...
        if (classLoader != NULL) {
            uintptrj_t* classChain = (uintptrj_t*)reloRuntime->fej9()->sharedCache()->pointerFromOffsetInSharedCache(
                (void*)classChainForInlinedMethod(reloTarget));
            RELO_LOG(reloRuntime->reloLogger(), 6, "\tpreparePrivateData: classChain %p\n", classChain);

#if !defined(PUBLIC_BUILD)
            classPointer = (J9Class*)reloRuntime->fej9()->sharedCache()->lookupClassFromChainAndLoader(
                classChain, (void*)classLoader);
#endif
    ...
    if (classPointer != NULL) {
        ...
        reloPrivateData->_needUnloadAssumption = !reloRuntime->fej9()->sameClassLoaders(
            reloPrivateData->_clazz, reloRuntime->comp()->getCurrentMethod()->classOfMethod());
...
void TR_RelocationRecordPointer::activatePointer(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordPointerPrivateData* reloPrivateData = &(privateData()->pointer);
...
{
    TR_RelocationRecordPointerPrivateData* reloPrivateData = &(privateData()->pointer);
    createClassRedefinitionPicSite((void*)reloPrivateData->_pointer, (void*)reloLocation, sizeof(uintptrj_t), false,
        reloRuntime->comp()->getMetadataAssumptionList());
    reloRuntime->comp()->setHasClassRedefinitionAssumptions();
}

int32_t TR_RelocationRecordPointer::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordPointerPrivateData* reloPrivateData = &(privateData()->pointer);
...
// TR_ClassPointer
char* TR_RelocationRecordClassPointer::name() { return "TR_ClassPointer"; }

uintptrj_t TR_RelocationRecordClassPointer::computePointer(
    TR_RelocationTarget* reloTarget, TR_OpaqueClassBlock* classPointer)
{
    return (uintptrj_t)classPointer;
}

void TR_RelocationRecordClassPointer::activatePointer(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
char* TR_RelocationRecordArbitraryClassAddress::name() { return "TR_ArbitraryClassAddress"; }

int32_t TR_RelocationRecordArbitraryClassAddress::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordPointerPrivateData* reloPrivateData = &(privateData()->pointer);
...
int32_t TR_RelocationRecordArbitraryClassAddress::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    TR_RelocationRecordPointerPrivateData* reloPrivateData = &(privateData()->pointer);
    TR_OpaqueClassBlock* clazz = (TR_OpaqueClassBlock*)reloPrivateData->_pointer;
...
void TR_RelocationRecordArbitraryClassAddress::activatePointer(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
void TR_RelocationRecordArbitraryClassAddress::assertBootstrapLoader(
    TR_RelocationRuntime* reloRuntime, TR_OpaqueClassBlock* clazz)
{
...
// TR_MethodPointer
char* TR_RelocationRecordMethodPointer::name() { return "TR_MethodPointer"; }
...
void TR_RelocationRecordMethodPointer::setVTableSlot(TR_RelocationTarget* reloTarget, uintptrj_t vTableSlot)
{
    reloTarget->storeRelocationRecordValue(
        vTableSlot, (uintptrj_t*)&((TR_RelocationRecordMethodPointerBinaryTemplate*)_record)->_vTableSlot);
}

uintptrj_t TR_RelocationRecordMethodPointer::vTableSlot(TR_RelocationTarget* reloTarget)
{
    return reloTarget->loadRelocationRecordValue(
        (uintptrj_t*)&((TR_RelocationRecordMethodPointerBinaryTemplate*)_record)->_vTableSlot);
}

int32_t TR_RelocationRecordMethodPointer::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordMethodPointerBinaryTemplate);
}

uintptrj_t TR_RelocationRecordMethodPointer::computePointer(
    TR_RelocationTarget* reloTarget, TR_OpaqueClassBlock* classPointer)
{
...
void TR_RelocationRecordMethodPointer::activatePointer(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordPointer::activatePointer(reloRuntime, reloTarget, reloLocation);
    if (reloRuntime->options()->getOption(TR_EnableHCR))
...
int32_t TR_RelocationRecordEmitClass::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordEmitClassBinaryTemplate);
}

void TR_RelocationRecordEmitClass::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    TR_RelocationRecordEmitClassPrivateData* reloPrivateData = &(privateData()->emitClass);

    reloPrivateData->_bcIndex
        = reloTarget->loadSigned32b((uint8_t*)&(((TR_RelocationRecordEmitClassBinaryTemplate*)_record)->_bcIndex));
    reloPrivateData->_method = getInlinedSiteMethod(reloRuntime);
}

int32_t TR_RelocationRecordEmitClass::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
    TR_RelocationRecordEmitClassPrivateData* reloPrivateData = &(privateData()->emitClass);
...
char* TR_RelocationRecordDebugCounter::name() { return "TR_RelocationRecordDebugCounter"; }

int32_t TR_RelocationRecordDebugCounter::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordDebugCounterBinaryTemplate);
}

void TR_RelocationRecordDebugCounter::preparePrivateData(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget)
{
    ...
    reloPrivateData->_bcIndex
        = reloTarget->loadSigned32b((uint8_t*)&(((TR_RelocationRecordDebugCounterBinaryTemplate*)_record)->_bcIndex));
    reloPrivateData->_delta
        = reloTarget->loadSigned32b((uint8_t*)&(((TR_RelocationRecordDebugCounterBinaryTemplate*)_record)->_delta));
    reloPrivateData->_fidelity
        = reloTarget->loadUnsigned8b((uint8_t*)&(((TR_RelocationRecordDebugCounterBinaryTemplate*)_record)->_fidelity));
    reloPrivateData->_staticDelta = reloTarget->loadSigned32b(
        (uint8_t*)&(((TR_RelocationRecordDebugCounterBinaryTemplate*)_record)->_staticDelta));

    UDATA offset = (UDATA)reloTarget->loadPointer(
        (uint8_t*)&(((TR_RelocationRecordDebugCounterBinaryTemplate*)_record)->_offsetOfNameString));
    reloPrivateData->_name = reloRuntime->fej9()->sharedCache()->getDebugCounterName(offset);
}

int32_t TR_RelocationRecordDebugCounter::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
int32_t TR_RelocationRecordDebugCounter::applyRelocation(TR_RelocationRuntime* reloRuntime,
    TR_RelocationTarget* reloTarget, uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
{
    TR::DebugCounterBase* counter = findOrCreateCounter(reloRuntime);
    if (counter == NULL) {
    ...
    // Update Counter Location
    reloTarget->storeAddress(
        (uint8_t*)counter->getBumpCountAddress(), reloLocationHigh, reloLocationLow, reloFlags(reloTarget));
...
TR::DebugCounterBase* TR_RelocationRecordDebugCounter::findOrCreateCounter(TR_RelocationRuntime* reloRuntime)
{
    ...
    if (isAggregateCounter) {
        counter = comp->getPersistentInfo()->getDynamicCounters()->findAggregation(
            reloPrivateData->_name, strlen(reloPrivateData->_name));
        if (!counter) {
        ...
        counter = TR::DebugCounter::getDebugCounter(
            comp, reloPrivateData->_name, reloPrivateData->_fidelity, reloPrivateData->_staticDelta);
    }
...
char* TR_RelocationRecordClassUnloadAssumption::name() { return "TR_ClassUnloadAssumption"; }

int32_t TR_RelocationRecordClassUnloadAssumption::bytesInHeaderAndPayload()
{
    return sizeof(TR_RelocationRecordClassUnloadAssumptionBinaryTemplate);
}

int32_t TR_RelocationRecordClassUnloadAssumption::applyRelocation(
    TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
{
...
uint32_t TR_RelocationRecord::_relocationRecordHeaderSizeTable[TR_NumExternalRelocationKinds] = {
    ...
    sizeof(
        TR_RelocationRecordConstantPoolWithIndexBinaryTemplate), // TR_JNIVirtualTargetAddress                      = 11
    sizeof(
        TR_RelocationRecordConstantPoolWithIndexBinaryTemplate), // TR_JNIStaticTargetAddress                       = 12
    ...
    sizeof(
        TR_RelocationRecordConstantPoolWithIndexBinaryTemplate), // TR_JNISpecialTargetAddress                      = 52
    sizeof(
    ...
    sizeof(
        TR_RelocationRecordValidateCompFromArrayBinaryTemplate), // TR_ValidateComponentClassFromArrayClass         = 70
    sizeof(
    ...
    sizeof(TR_RelocationRecordValidateDeclaringClassFromFieldOrStaticBinaryTemplate), // TR_ValidateDeclaringClassFromFieldOrStatic
                                                                                      // = 76
    ...
    sizeof(
        TR_RelocationRecordValidateMethodByNameBinaryTemplate), // TR_ValidatedMethodByName                        = 83
    ...
    sizeof(TR_RelocationRecordValidateStackWalkerMaySkipFramesBinaryTemplate), // TR_ValidateStackWalkerMaySkipFramesRecord
                                                                               // = 91
    ...
    sizeof(TR_RelocationRecordValidateMethodFromSingleInterfaceImplBinaryTemplate), // TR_ValidateMethodFromSingleInterfaceImplementer
                                                                                    // = 95
    sizeof(TR_RelocationRecordValidateMethodFromSingleAbstractImplBinaryTemplate), // TR_ValidateMethodFromSingleAbstractImplementer
                                                                                   // = 96
    sizeof(TR_RelocationRecordValidateImproperInterfaceMethodFromCPBinaryTemplate), // TR_ValidateImproperInterfaceMethodFromCP
                                                                                    // = 97
