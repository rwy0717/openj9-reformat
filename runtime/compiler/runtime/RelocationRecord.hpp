...
typedef TR_RelocationRecordValidateClassFromCPBinaryTemplate
...
public:
    TR_RelocationRecordGroup(TR_RelocationRecordBinaryTemplate* groupData)
        : _group(groupData) {};
    ...
    int32_t applyRelocations(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloOrigin);

private:
    int32_t handleRelocation(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget,
...
public:
    ...
    static TR_RelocationRecord* create(TR_RelocationRecord* storage, TR_RelocationRuntime* reloRuntime,
        TR_RelocationTarget* reloTarget, TR_RelocationRecordBinaryTemplate* recordPointer);
    ...
    virtual int32_t applyRelocationAtAllOffsets(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* relocationOrigin);

    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation)
    {
        return -1;
    }
    virtual int32_t applyRelocation(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget,
        uint8_t* reloLocationHigh, uint8_t* reloLocationLow)
    {
        return -1;
    }
...
protected:
    ...
    uint8_t* computeHelperAddress(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* baseLocation);

    TR_RelocationRecordPrivateData* privateData() { return &_privateData; }
...
public:
    ...
    TR_RelocationRecordBodyInfo(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
...
public:
    ...
    TR_RelocationRecordWithOffset(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    virtual void print(TR_RelocationRuntime* reloRuntime);
...
public:
    ...
    TR_RelocationRecordGlobalValue(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordWithOffset(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordBodyInfoLoad(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordArrayCopyHelper(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordArrayCopyToc(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordArrayCopyHelper(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordRamSequence(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordWithOffset(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordConstantPool(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
...
protected:
    uintptrj_t currentConstantPool(
    ...
    uintptrj_t computeNewConstantPool(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uintptrj_t oldValue);
};
...
public:
    ...
    TR_RelocationRecordConstantPoolWithIndex(
        TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordConstantPool(reloRuntime, record)
    {}
    virtual void print(TR_RelocationRuntime* reloRuntime);
...
public:
    ...
    TR_RelocationRecordHelperAddress(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    virtual char* name();
    virtual void print(TR_RelocationRuntime* reloRuntime);
...
public:
    ...
    TR_RelocationRecordAbsoluteHelperAddress(
        TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordHelperAddress(reloRuntime, record)
    {}
    virtual char* name();
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
...
public:
    ...
    TR_RelocationRecordDataAddress(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
...
public:
    ...
    TR_RelocationRecordMethodAddress(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordClassAddress(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordConstantPoolWithIndex(reloRuntime, record)
    {}
    virtual char* name();

    TR_OpaqueClassBlock* computeNewClassAddress(
...
public:
    ...
    TR_RelocationRecordDirectJNICall(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordConstantPoolWithIndex(reloRuntime, record)
    {}
    virtual char* name();
    virtual int32_t applyRelocation(
...
public:
    ...
    TR_RelocationRecordDirectJNISpecialMethodCall(
        TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordDirectJNICall(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordRamMethodConst(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordConstantPoolWithIndex(reloRuntime, record)
    {}
    virtual char* name() = 0;
    virtual int32_t applyRelocation(
...
public:
    ...
    TR_RelocationRecordStaticRamMethodConst(
        TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordRamMethodConst(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordThunks(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordConstantPool(reloRuntime, record)
    {}
    virtual char* name();
    virtual int32_t applyRelocation(
...
protected:
    int32_t relocateAndRegisterThunk(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uintptrj_t cp,
        uintptr_t cpIndex, uint8_t* reloLocation);
...
public:
    ...
    TR_RelocationRecordTrampolines(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordConstantPool(reloRuntime, record)
    {}
    virtual char* name();
    virtual int32_t applyRelocation(
...
public:
    ...
    TR_RelocationRecordPicTrampolines(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    virtual char* name();
    virtual void print(TR_RelocationRuntime* reloRuntime);
...
public:
    ...
    TR_RelocationRecordInlinedAllocation(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordConstantPoolWithIndex(reloRuntime, record)
    {}
    virtual void print(TR_RelocationRuntime* reloRuntime);
...
public:
    ...
    TR_RelocationRecordVerifyRefArrayForAlloc(
        TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordInlinedAllocation(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordInlinedMethod(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordConstantPoolWithIndex(reloRuntime, record)
    {}
    virtual void print(TR_RelocationRuntime* reloRuntime);
...
protected:
    virtual void fixInlinedSiteInfo(
...
private:
    virtual bool inlinedSiteValid(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, TR_OpaqueMethodBlock** theMethod);

    virtual TR_OpaqueMethodBlock* getMethodFromCP(
        TR_RelocationRuntime* reloRuntime, void* void_cp, int32_t cpindex, TR_OpaqueMethodBlock* callerMethod)
    {
        return NULL;
    }

    virtual void invalidateGuard(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation) {};
    virtual void activateGuard(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation) {};
...
public:
    ...
    TR_RelocationRecordNopGuard(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordInlinedMethod(reloRuntime, record)
    {}
    virtual void print(TR_RelocationRuntime* reloRuntime);
...
public:
    ...
    TR_RelocationRecordInlinedStaticMethodWithNopGuard(
        TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordNopGuard(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordProfiledGuard(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordProfiledInlinedMethod(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordProfiledClassGuard(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordProfiledGuard(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordProfiledMethodGuard(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordProfiledGuard(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordMethodTracingCheck(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    virtual void print(TR_RelocationRuntime* reloRuntime);
...
public:
    ...
    TR_RelocationRecordMethodEnterCheck(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordMethodTracingCheck(reloRuntime, record)
    {}
    virtual char* name();
    virtual bool ignore(TR_RelocationRuntime* reloRuntime);
};
...
public:
    ...
    TR_RelocationRecordMethodExitCheck(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordMethodTracingCheck(reloRuntime, record)
    {}
    virtual char* name();
    virtual bool ignore(TR_RelocationRuntime* reloRuntime);
...
public:
    ...
    TR_RelocationRecordRamMethod(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordValidateInstanceField(
        TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordValidateClass(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordValidateStaticField(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordValidateInstanceField(reloRuntime, record)
    {}
    virtual char* name();
    virtual void print(TR_RelocationRuntime* reloRuntime);
...
public:
    ...
    TR_RelocationRecordValidateClassByName(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    virtual int32_t bytesInHeaderAndPayload()
    {
        return sizeof(TR_RelocationRecordValidateStaticClassFromCPBinaryTemplate);
    }
    virtual void preparePrivateData(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget) {}
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
...
public:
    ...
    virtual int32_t bytesInHeaderAndPayload()
    {
        return sizeof(TR_RelocationRecordValidateClassFromMethodBinaryTemplate);
    }
    virtual void preparePrivateData(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget) {}
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
...
public:
    ...
    virtual int32_t bytesInHeaderAndPayload()
    {
        return sizeof(TR_RelocationRecordValidateClassFromITableIndexCPBinaryTemplate);
    }
    virtual void preparePrivateData(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget) {}
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
...
public:
    ...
    virtual int32_t bytesInHeaderAndPayload()
    {
        return sizeof(TR_RelocationRecordValidateDeclaringClassFromFieldOrStaticBinaryTemplate);
    }
    virtual void preparePrivateData(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget) {}
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
...
public:
    ...
    virtual int32_t bytesInHeaderAndPayload()
    {
        return sizeof(TR_RelocationRecordValidateConcreteSubFromClassBinaryTemplate);
    }
    virtual void preparePrivateData(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget) {}
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
...
public:
    ...
    TR_RelocationRecordValidateClassChain(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    virtual bool isValidationRecord() { return true; }
...
public:
    ...
    virtual int32_t bytesInHeaderAndPayload()
    {
        return sizeof(TR_RelocationRecordValidateStaticMethodFromCPBinaryTemplate);
    }
    virtual void preparePrivateData(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget) {}
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
...
public:
    ...
    virtual int32_t bytesInHeaderAndPayload()
    {
        return sizeof(TR_RelocationRecordValidateSpecialMethodFromCPBinaryTemplate);
    }
    virtual void preparePrivateData(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget) {}
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
...
public:
    ...
    virtual int32_t bytesInHeaderAndPayload()
    {
        return sizeof(TR_RelocationRecordValidateVirtualMethodFromCPBinaryTemplate);
    }
    virtual void preparePrivateData(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget) {}
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
...
public:
    ...
    virtual int32_t bytesInHeaderAndPayload()
    {
        return sizeof(TR_RelocationRecordValidateImproperInterfaceMethodFromCPBinaryTemplate);
    }
    virtual void preparePrivateData(TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget) {}
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
...
public:
    ...
    TR_RelocationRecordSymbolFromManager(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    ...
    virtual int32_t applyRelocation(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
    virtual void activatePointer(
        TR_RelocationRuntime* reloRuntime, TR_RelocationTarget* reloTarget, uint8_t* reloLocation);
    bool needsUnloadAssumptions(TR::SymbolType symbolType);
    bool needsRedefinitionAssumption(TR_RelocationRuntime* reloRuntime, uint8_t* reloLocation,
        TR_OpaqueClassBlock* clazz, TR::SymbolType symbolType);
};
/* SYMBOL VALIDATION MANAGER */
...
public:
    ...
    TR_RelocationRecordHCR(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordWithOffset(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordPointer(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordWithInlinedSiteIndex(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordClassPointer(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordPointer(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordArbitraryClassAddress(
        TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordClassPointer(reloRuntime, record)
    {}
    virtual char* name();
...
public:
    ...
    TR_RelocationRecordMethodPointer(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordPointer(reloRuntime, record)
    {}
    virtual char* name();
    virtual void print(TR_RelocationRuntime* reloRuntime);
...
public:
    ...
    TR_RelocationRecordEmitClass(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordWithInlinedSiteIndex(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordDebugCounter(TR_RelocationRuntime* reloRuntime, TR_RelocationRecordBinaryTemplate* record)
        : TR_RelocationRecordWithInlinedSiteIndex(reloRuntime, record)
    {}
    virtual char* name();
