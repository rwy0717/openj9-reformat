...
void J9::X86::AheadOfTimeCompile::processRelocations()
{
    ...
    if (TR::Compiler->target.is64Bit() && TR::CodeCacheManager::instance()->codeCacheConfig().needsMethodTrampolines()
        && _cg->getPicSlotCount()) {
        _cg->addExternalRelocation(new (_cg->trHeapMemory()) TR::ExternalRelocation(
                                       NULL, (uint8_t*)_cg->getPicSlotCount(), TR_PicTrampolines, _cg),
            __FILE__, __LINE__, NULL);
    }

    for (auto aotIterator = _cg->getExternalRelocationList().begin();
         aotIterator != _cg->getExternalRelocationList().end(); ++aotIterator)
    ...
    if (self()->getSizeOfAOTRelocations() != 0) {
        uint8_t* relocationDataCursor = self()->setRelocationData(
            fej9->allocateRelocationData(self()->comp(), self()->getSizeOfAOTRelocations() + SIZEPOINTER));
        ...
        *(uint64_t*)relocationDataCursor = self()->getSizeOfAOTRelocations() + SIZEPOINTER;
        ...
        for (s = self()->getAOTRelocationTargets().getFirst(); s != 0; s = s->getNext()) {
...
uint8_t* J9::X86::AheadOfTimeCompile::initializeAOTRelocationHeader(TR::IteratedExternalRelocation* relocation)
{
    ...
    *flagsCursor = wideOffsets;
    ...
    TR_RelocationRecord* reloRecord = TR_RelocationRecord::create(&storage, reloRuntime, reloTarget,
        reinterpret_cast<TR_RelocationRecordBinaryTemplate*>(relocation->getRelocationData()));
    ...
    case TR_MethodPointer: {
        ...
        *(uintptrj_t*)cursor = inlinedSiteIndex;
        ...
        uintptrj_t classChainOffsetInSharedCache
            = (uintptrj_t)sharedCache->offsetInSharedCacheFromPointer(classChainIdentifyingLoaderForClazz);
    ...
    case TR_ArbitraryClassAddress: {
        ...
        uintptr_t inlinedSiteIndex = self()->findCorrectInlinedSiteIndex(
            symRef->getOwningMethod(comp)->constantPool(), (uintptr_t)relocation->getTargetAddress2());
    ...
    case TR_InlinedHCRMethod: {
        ...
        *(uintptrj_t*)cursor
            = (uintptrj_t)guard->getSymbolReference()->getOwningMethod(comp)->constantPool(); // record constant pool
        cursor += SIZEPOINTER;
    ...
    case TR_SpecialRamMethodConst: {
        ...
        inlinedSiteIndex
            = self()->findCorrectInlinedSiteIndex(tempSR->getOwningMethod(comp)->constantPool(), inlinedSiteIndex);
    ...
    case TR_ValidateProfiledClass: {
        ...
        if (primitiveType != '\0') {
            ...
            void* classChainIdentifyingLoaderForClazzToValidate
                = sharedCache->persistentClassLoaderTable()->lookupClassChainAssociatedWithClassLoader(
                    loaderForClazzToValidate);
            classChainOffsetInSharedCacheForCL = reinterpret_cast<uintptrj_t>(
                sharedCache->offsetInSharedCacheFromPointer(classChainIdentifyingLoaderForClazzToValidate));
    ...
    case TR_ValidateDefiningClassFromCP: {
        TR::DefiningClassFromCPRecord* record
    ...
    case TR_ValidateStaticClassFromCP: {
        TR::StaticClassFromCPRecord* record
    ...
    case TR_ValidateClassFromMethod: {
        TR::ClassFromMethodRecord* record
            = reinterpret_cast<TR::ClassFromMethodRecord*>(relocation->getTargetAddress());
    ...
    case TR_ValidateComponentClassFromArrayClass: {
        TR::ComponentClassFromArrayClassRecord* record
            = reinterpret_cast<TR::ComponentClassFromArrayClassRecord*>(relocation->getTargetAddress());
    ...
    case TR_ValidateArrayClassFromComponentClass: {
        TR::ArrayClassFromComponentClassRecord* record
    ...
    case TR_ValidateSuperClassFromClass: {
        TR::SuperClassFromClassRecord* record
    ...
    case TR_ValidateClassInstanceOfClass: {
        TR::ClassInstanceOfClassRecord* record
    ...
    case TR_ValidateSystemClassByName: {
        TR::SystemClassByNameRecord* record
    ...
    case TR_ValidateClassFromITableIndexCP: {
        TR::ClassFromITableIndexCPRecord* record
    ...
    case TR_ValidateDeclaringClassFromFieldOrStatic: {
        TR::DeclaringClassFromFieldOrStaticRecord* record
    ...
    case TR_ValidateConcreteSubClassFromClass: {
        TR::ConcreteSubClassFromClassRecord* record
    ...
    case TR_ValidateMethodByName: {
        ...
        TR_OpaqueClassBlock* classOfMethod
            = reinterpret_cast<TR_OpaqueClassBlock*>(J9_CLASS_FROM_METHOD(methodToValidate));
    ...
    case TR_ValidateMethodFromClass: {
        TR::MethodFromClassRecord* record
    ...
    case TR_ValidateStaticMethodFromCP: {
        TR::StaticMethodFromCPRecord* record
    ...
    case TR_ValidateSpecialMethodFromCP: {
        TR::SpecialMethodFromCPRecord* record
    ...
    case TR_ValidateInterfaceMethodFromCP: {
        TR::InterfaceMethodFromCPRecord* record
    ...
    case TR_ValidateImproperInterfaceMethodFromCP: {
        TR::ImproperInterfaceMethodFromCPRecord* record
    ...
    case TR_ValidateMethodFromClassAndSig: {
        TR::MethodFromClassAndSigRecord* record
    ...
    case TR_ValidateMethodFromSingleImplementer: {
        TR::MethodFromSingleImplementer* record
    ...
    case TR_ValidateMethodFromSingleInterfaceImplementer: {
        TR::MethodFromSingleInterfaceImplementer* record
    ...
    case TR_ValidateMethodFromSingleAbstractImplementer: {
        TR::MethodFromSingleAbstractImplementer* record
    ...
    case TR_ValidateStackWalkerMaySkipFramesRecord: {
        TR::StackWalkerMaySkipFramesRecord* record
    ...
    case TR_ValidateClassInfoIsInitialized: {
        TR::ClassInfoIsInitialized* record
    ...
    case TR_ValidateArbitraryClass: {
        ...
        void* classChainIdentifyingLoaderForClazzToValidate
            = sharedCache->persistentClassLoaderTable()->lookupClassChainAssociatedWithClassLoader(
                loaderForClazzToValidate);
        uintptrj_t classChainOffsetInSharedCacheForCL
            = (uintptrj_t)sharedCache->offsetInSharedCacheFromPointer(classChainIdentifyingLoaderForClazzToValidate);
...
//       or by defining in the runtime.hpp the sizes of the relocation items
    ...
    sizeof(
        TR_RelocationRecordValidateDefiningClassFromCPBinaryTemplate), // TR_ValidateDefiningClassFromCP         = 67,
    ...
    sizeof(
        TR_RelocationRecordValidateSuperClassFromClassBinaryTemplate), // TR_ValidateSuperClassFromClass         = 72,
    sizeof(
        TR_RelocationRecordValidateClassInstanceOfClassBinaryTemplate), // TR_ValidateClassInstanceOfClass       = 73,
    sizeof(TR_RelocationRecordValidateSystemClassByNameBinaryTemplate), // TR_ValidateSystemClassByName            = 74,
    sizeof(
        TR_RelocationRecordValidateClassFromITableIndexCPBinaryTemplate), // TR_ValidateClassFromITableIndexCP   = 75,
    sizeof(
        TR_RelocationRecordValidateDeclaringClassFromFieldOrStaticBinaryTemplate), // TR_ValidateDeclaringClassFromFieldOrStatic=76,
    sizeof(TR_RelocationRecordValidateClassClassBinaryTemplate), // TR_ValidateClassClass                  = 77,
    sizeof(
        TR_RelocationRecordValidateConcreteSubFromClassBinaryTemplate), // TR_ValidateConcreteSubClassFromClass  = 78,
    ...
    sizeof(
        TR_RelocationRecordValidateSpecialMethodFromCPBinaryTemplate), // TR_ValidateSpecialMethodFromCP         = 86,
    sizeof(
        TR_RelocationRecordValidateVirtualMethodFromCPBinaryTemplate), // TR_ValidateVirtualMethodFromCP         = 87,
    sizeof(
        TR_RelocationRecordValidateVirtualMethodFromOffsetBinaryTemplate), // TR_ValidateVirtualMethodFromOffset = 88,
    sizeof(
        TR_RelocationRecordValidateInterfaceMethodFromCPBinaryTemplate), // TR_ValidateInterfaceMethodFromCP     = 89,
    sizeof(
        TR_RelocationRecordValidateMethodFromClassAndSigBinaryTemplate), // TR_ValidateMethodFromClassAndSig     = 90,
    ...
    sizeof(
        TR_RelocationRecordValidateClassInfoIsInitializedBinaryTemplate), // TR_ValidateClassInfoIsInitialized   = 93,
    sizeof(
