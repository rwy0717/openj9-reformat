...
public:
    S390CHelperLinkage(
        TR::CodeGenerator* cg, TR_S390LinkageConventions elc = TR_JavaHelper, TR_LinkageConventions lc = TR_CHelper);
    ...
    TR::Register* buildDirectDispatch(
        TR::Node* callNode, TR::RegisterDependencyConditions** deps, TR::Register* returnReg = NULL);
};
} // namespace TR
