...
////////////////////////////////////////////////////////////////////////////////
void TR::J9S390zLinuxSystemLinkage::generateInstructionsForCall(TR::Node* callNode,
    ...
    TR::S390JNICallDataSnippet* jniCallDataSnippet, bool isJNIGCPoint)
{
     ...
     *
     */
    if (fej9->helpersNeedRelocation() && !(callNode->getSymbol()->isResolvedMethod() || jniCallDataSnippet)) {
        ...
        && jniCallDataSnippet) // unresolved means a helper being called using system linkage
    {
        generateRXInstruction(codeGen, TR::InstOpCode::getLoadOpCode(), callNode, systemReturnAddressRegister,
            generateS390MemoryReference(
                jniCallDataSnippet->getBaseRegister(), jniCallDataSnippet->getTargetAddressOffset(), codeGen));
        ...
        generateRegLitRefInstruction(cg(), TR::InstOpCode::getLoadOpCode(), callNode, systemReturnAddressRegister,
            (uintptrj_t)targetAddress, reloType, NULL, NULL, NULL);
    } else {
        genLoadAddressConstant(
            codeGen, callNode, targetAddress, systemReturnAddressRegister, NULL, NULL, javaLitPoolRegister);
    }
    ...
    if (parm5) {
        ...
        generateRRInstruction(
            codeGen, TR::InstOpCode::getLoadRegOpCode(), callNode, javaLitOffsetReg, javaLitPoolRegister);
        generateRRInstruction(codeGen, TR::InstOpCode::getLoadRegOpCode(), callNode, javaLitPoolRegister, parm5);
    }
    // call the JNI function
    TR::Instruction* gcPoint = generateRRInstruction(
        codeGen, TR::InstOpCode::BASR, callNode, systemReturnAddressRegister, systemReturnAddressRegister, deps);
    ...
    if (parm5) {
        ...
        generateRRInstruction(
            codeGen, TR::InstOpCode::getLoadRegOpCode(), callNode, javaLitPoolRegister, javaLitOffsetReg);
    }
}

void TR::J9S390zLinuxSystemLinkage::setupRegisterDepForLinkage(TR::Node* callNode, TR_DispatchType dispatchType,
...
void TR::J9S390zLinuxSystemLinkage::setupBuildArgForLinkage(TR::Node* callNode, TR_DispatchType dispatchType,
...
{
    TR::S390PrivateLinkage* privateLinkage = (TR::S390PrivateLinkage*)cg()->getLinkage(TR_Private);
    privateLinkage->setupBuildArgForLinkage(
        callNode, dispatchType, deps, isFastJNI, isPassReceiver, killMask, GlobalRegDeps, hasGlRegDeps, systemLinkage);
}

void TR::J9S390zLinuxSystemLinkage::performCallNativeFunctionForLinkage(TR::Node* callNode,
    TR_DispatchType dispatchType, TR::Register*& javaReturnRegister, TR::SystemLinkage* systemLinkage,
    TR::RegisterDependencyConditions*& deps, TR::Register* javaLitOffsetReg, TR::Register* methodAddressReg,
    bool isJNIGCPoint)
{
...
void TR::J9S390zLinuxSystemLinkage::doNotKillSpecialRegsForBuildArgs(
    TR::Linkage* linkage, bool isFastJNI, int64_t& killMask)
{
    TR::S390PrivateLinkage* privateLinkage = (TR::S390PrivateLinkage*)cg()->getLinkage(TR_Private);
    privateLinkage->doNotKillSpecialRegsForBuildArgs(linkage, isFastJNI, killMask);
}

void TR::J9S390zLinuxSystemLinkage::addSpecialRegDepsForBuildArgs(
...
int64_t TR::J9S390zLinuxSystemLinkage::addFECustomizedReturnRegDependency(
...
int32_t TR::J9S390zLinuxSystemLinkage::storeExtraEnvRegForBuildArgs(TR::Node* callNode, TR::Linkage* linkage,
    TR::RegisterDependencyConditions* dependencies, bool isFastJNI, int32_t stackOffset, int8_t gprSize,
    uint32_t& numIntegerArgs)
{
    TR::S390PrivateLinkage* privateLinkage = (TR::S390PrivateLinkage*)cg()->getLinkage(TR_Private);
    stackOffset = privateLinkage->storeExtraEnvRegForBuildArgs(
        callNode, linkage, dependencies, isFastJNI, stackOffset, gprSize, numIntegerArgs);
    return stackOffset;
}
...
//  customization of callNativeFunction
////////////////////////////////////////////////////////////////////////////////
void TR::J9S390zOSSystemLinkage::generateInstructionsForCall(TR::Node* callNode, TR::RegisterDependencyConditions* deps,
    ...
    TR::LabelSymbol* returnFromJNICallLabel, TR::S390JNICallDataSnippet* jniCallDataSnippet, bool isJNIGCPoint)
{
    ...
    // save litpool reg GPR6
    generateRRInstruction(
        codeGen, TR::InstOpCode::getLoadRegOpCode(), callNode, javaLitOffsetReg, systemEntryPointRegister);
    ...
    TR::Register* methodMetaDataVirtualRegister
        = ((TR::S390PrivateLinkage*)privateLinkage)->getMethodMetaDataRealRegister();

    if (cg()->supportsJITFreeSystemStackPointer()) {
        auto* systemSPOffsetMR = generateS390MemoryReference(
            methodMetaDataVirtualRegister, static_cast<int32_t>(fej9->thisThreadGetSystemSPOffset()), codeGen);
        ...
        if (codeGen->getS390ProcessorInfo()->supportsArch(TR_S390ProcessorInfo::TR_z10)) {
            ...
            generateRXInstruction(
                codeGen, TR::InstOpCode::getStoreOpCode(), callNode, methodAddressReg, systemSPOffsetMR);
        }
    }
    ...
    gcPoint = generateRRInstruction(
        codeGen, TR::InstOpCode::BASR, callNode, systemReturnAddressRegister, systemEntryPointRegister, callPreDeps);
    if (isJNIGCPoint)
        gcPoint->setNeedsGCMap(0x00000000);
    ...
    // restore litpool reg GPR6
    generateRRInstruction(
        codeGen, TR::InstOpCode::getLoadRegOpCode(), callNode, systemEntryPointRegister, javaLitOffsetReg);
}

void TR::J9S390zOSSystemLinkage::setupRegisterDepForLinkage(TR::Node* callNode, TR_DispatchType dispatchType,
    TR::RegisterDependencyConditions*& deps, int64_t& killMask, TR::SystemLinkage* systemLinkage,
    TR::Node*& GlobalRegDeps, bool& hasGlRegDeps, TR::Register** methodAddressReg, TR::Register*& javaLitOffsetReg)
{
    // call j9 private linkage specialization
...
void TR::J9S390zOSSystemLinkage::setupBuildArgForLinkage(TR::Node* callNode, TR_DispatchType dispatchType,
    TR::RegisterDependencyConditions* deps, bool isFastJNI, bool isPassReceiver, int64_t& killMask,
    TR::Node* GlobalRegDeps, bool hasGlRegDeps, TR::SystemLinkage* systemLinkage)
{
    TR::S390PrivateLinkage* privateLinkage = (TR::S390PrivateLinkage*)cg()->getLinkage(TR_Private);
...
void TR::J9S390zOSSystemLinkage::performCallNativeFunctionForLinkage(TR::Node* callNode, TR_DispatchType dispatchType,
...
void TR::J9S390zOSSystemLinkage::doNotKillSpecialRegsForBuildArgs(
    TR::Linkage* linkage, bool isFastJNI, int64_t& killMask)
{
    TR::S390PrivateLinkage* privateLinkage = (TR::S390PrivateLinkage*)cg()->getLinkage(TR_Private);
    privateLinkage->doNotKillSpecialRegsForBuildArgs(linkage, isFastJNI, killMask);
...
void TR::J9S390zOSSystemLinkage::addSpecialRegDepsForBuildArgs(
    TR::Node* callNode, TR::RegisterDependencyConditions* dependencies, int32_t& from, int32_t step)
{
    TR::S390PrivateLinkage* privateLinkage = (TR::S390PrivateLinkage*)cg()->getLinkage(TR_Private);
    privateLinkage->addSpecialRegDepsForBuildArgs(callNode, dependencies, from, step);
...
int32_t TR::J9S390zOSSystemLinkage::storeExtraEnvRegForBuildArgs(TR::Node* callNode, TR::Linkage* linkage,
    TR::RegisterDependencyConditions* dependencies, bool isFastJNI, int32_t stackOffset, int8_t gprSize,
    uint32_t& numIntegerArgs)
{
    TR::S390PrivateLinkage* privateLinkage = (TR::S390PrivateLinkage*)cg()->getLinkage(TR_Private);
...
int64_t TR::J9S390zOSSystemLinkage::addFECustomizedReturnRegDependency(
    int64_t killMask, TR::Linkage* linkage, TR::DataType resType, TR::RegisterDependencyConditions* dependencies)
{
    TR::S390PrivateLinkage* privateLinkage = (TR::S390PrivateLinkage*)cg()->getLinkage(TR_Private);
    killMask = privateLinkage->addFECustomizedReturnRegDependency(killMask, linkage, resType, dependencies);
 ...
 */
TR::Instruction* TR::J9S390zOSSystemLinkage::genCallNOPAndDescriptor(
    TR::Instruction* cursor, TR::Node* node, TR::Node* callNode, TR_XPLinkCallTypes callType)
{
    ...
    if (TR::Compiler->target.is32Bit()) {
        ...
        TR::S390ConstantDataSnippet* callDescSnippet
            = cg()->findOrCreate8ByteConstant(node, (int64_t)callDescValues, false);
        ...
        TR::S390PseudoInstruction* pseudoCallDesc = static_cast<TR::S390PseudoInstruction*>(
            generateS390PseudoInstruction(codeGen, TR::InstOpCode::XPCALLDESC, node, NULL, cursor));
