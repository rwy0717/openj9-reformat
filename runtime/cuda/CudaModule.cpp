 ...
 */
jlong JNICALL Java_com_ibm_cuda_CudaModule_getFunction(JNIEnv* env, jclass, jint deviceId, jlong module, jstring name)
{
    ...
    if (NULL == cName) {
        ...
        error = j9cuda_moduleGetFunction((uint32_t)deviceId, (J9CudaModule)module, cName, &function);
 ...
 */
jlong JNICALL Java_com_ibm_cuda_CudaModule_getGlobal(JNIEnv* env, jclass, jint deviceId, jlong module, jstring name)
{
    J9VMThread* thread = (J9VMThread*)env;
    ...
    if (NULL == cName) {
        ...
        error = j9cuda_moduleGetGlobal((uint32_t)deviceId, (J9CudaModule)module, cName, &symbol, &size);
 ...
 */
jlong JNICALL Java_com_ibm_cuda_CudaModule_getSurface(JNIEnv* env, jclass, jint deviceId, jlong module, jstring name)
{
    J9VMThread* thread = (J9VMThread*)env;
    ...
    if (NULL == cName) {
        ...
        error = j9cuda_moduleGetSurfaceRef((uint32_t)deviceId, (J9CudaModule)module, cName, &surface);
 ...
 */
jlong JNICALL Java_com_ibm_cuda_CudaModule_getTexture(JNIEnv* env, jclass, jint deviceId, jlong module, jstring name)
{
    J9VMThread* thread = (J9VMThread*)env;
    ...
    if (NULL == cName) {
        ...
        error = j9cuda_moduleGetTextureRef((uint32_t)deviceId, (J9CudaModule)module, cName, &texture);
 ...
 */
jlong JNICALL Java_com_ibm_cuda_CudaModule_load(JNIEnv* env, jclass, jint deviceId, jbyteArray image, jlong options)
{
    J9VMThread* thread = (J9VMThread*)env;
    ...
    if (NULL == imageData) {
        ...
        error = j9cuda_moduleLoad((uint32_t)deviceId, imageData, (J9CudaJitOptions*)options, &module);
 ...
 * @param[in] module    the module pointer
 */
void JNICALL Java_com_ibm_cuda_CudaModule_unload(JNIEnv* env, jclass, jint deviceId, jlong module)
{
    J9VMThread* thread = (J9VMThread*)env;
