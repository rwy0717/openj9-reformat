...
#define PARSE_FUNC_PTR(args, pFunc) parseFuncPtr(args, (void (**)(void*, J9PoolWalkData*))(&pFunc))
...
static J9PoolPuddle* mapPuddle(J9Pool* head, UDATA addr)
{
    UDATA bytesToBeRead;
    IDATA segmentOffset;
 ...
 */
static UDATA puddleContainsElement(J9Pool* head, J9PoolPuddle* puddle, void* element)
{
