...
const J9DDRStructDefinition** initializeDDRComponents(OMRPortLibrary* portLib)
{
    OMRPORT_ACCESS_FROM_OMRPORT(portLib);

    const J9DDRStructDefinition** list
        = omrmem_allocate_memory((J9DDR_COMPONENT_COUNT + 1) * sizeof(J9DDRStructDefinition*), OMRMEM_CATEGORY_VM);
