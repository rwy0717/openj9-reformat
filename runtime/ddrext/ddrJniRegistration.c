...
static JNINativeMethod jniMemoryMethods[] = {
    ...
    { "getValidRegionVirtual", "(JJ)Lcom/ibm/j9ddr/corereaders/memory/MemoryRange;",
        (void*)Java_com_ibm_j9ddr_corereaders_debugger_JniMemory_getValidRegionVirtual },
};

static JNINativeMethod jniNativesMethods[] = {
    { "getPlatform", "()Lcom/ibm/j9ddr/corereaders/Platform;",
        (void*)Java_com_ibm_j9ddr_corereaders_debugger_JniNatives_getPlatform },
};
...
static JNINativeMethod jniRegistersMethods[] = {
    ...
    { "getRegisterName", "(J)Ljava/lang/String;",
        (void*)Java_com_ibm_j9ddr_corereaders_debugger_JniRegisters_getRegisterName },
    { "getRegisterValue", "(JJ)Ljava/lang/Number;",
        (void*)Java_com_ibm_j9ddr_corereaders_debugger_JniRegisters_getRegisterValue },
 ...
 */
static BOOLEAN registerDDRNatives(JNIEnv* env, char* class, JNINativeMethod* methods, jint nMethods)
{
    jclass cls;
    jint r = -1;
...
register_ddr_natives(JNIEnv* env)
{
    ...
    if (registerDDRNatives(env, "com/ibm/j9ddr/corereaders/debugger/JniSearchableMemory", jniSearchableMemoryMethods, 1)
        == FALSE) {
        return FALSE;
    }

    if (registerDDRNatives(env, "com/ibm/j9ddr/corereaders/debugger/JniOutputStream", jniOutputStreamMemoryMethods, 2)
        == FALSE) {
        return FALSE;
    }
