...
static void initializeRegionDescriptor(J9MM_IterateRegionDescriptor* descriptor, const char* name, UDATA id,
    UDATA objectAlignment, UDATA objectMinimumSize, void* start, UDATA size);

static void initializeRegionDescriptor(
    MM_GCExtensionsBase* extensions, J9MM_IterateRegionDescriptor* descriptor, MM_HeapRegionDescriptor* region);
static void initializeObjectDescriptor(J9JavaVM* javaVM, J9MM_IterateObjectDescriptor* descriptor,
    J9MM_IterateRegionDescriptor* regionDesc, j9object_t object);

static jvmtiIterationControl iterateRegions(J9JavaVM* vm, J9MM_IterateSpaceDescriptor* space, UDATA flags,
    jvmtiIterationControl (*func)(J9JavaVM* vm, J9MM_IterateRegionDescriptor* regionDesc, void* userData),
    void* userData);

static jvmtiIterationControl iterateRegionObjects(J9JavaVM* vm, J9MM_IterateRegionDescriptor* region, UDATA flags,
...
typedef enum J9MM_RegionType { j9mm_region_type_region = 0 } J9MM_RegionType;
...
jvmtiIterationControl static iterateObjectSlotDo(J9JavaVM* javaVM, GC_SlotObject* slotObject,
    J9MM_IterateObjectDescriptor* object, J9MM_IteratorObjectRefType type, UDATA flags,
...
jvmtiIterationControl static iterateMixedObjectSlots(J9JavaVM* javaVM, J9Object* objectPtr,
    ...
    void* userData)
{
    ...
    while ((slotObject = mixedObjectIterator.nextSlot()) != NULL) {
        returnCode = iterateObjectSlotDo(
            javaVM, slotObject, object, j9mm_iterator_object_ref_type_object, flags, func, userData);
...
jvmtiIterationControl static iterateArrayObjectSlots(J9JavaVM* javaVM, J9Object* objectPtr,
    J9MM_IterateObjectDescriptor* object, UDATA flags,
    jvmtiIterationControl (*func)(J9JavaVM* javaVM, J9MM_IterateObjectDescriptor* objectDesc,
        J9MM_IterateObjectRefDescriptor* refDesc, void* userData),
    void* userData)
...
jvmtiIterationControl static iterateArrayletSlots(J9JavaVM* javaVM, J9Object* objectPtr,
    J9MM_IterateObjectDescriptor* object, UDATA flags,
    jvmtiIterationControl (*func)(J9JavaVM* javaVM, J9MM_IterateObjectDescriptor* objectDesc,
        J9MM_IterateObjectRefDescriptor* refDesc, void* userData),
    void* userData)
{
    ...
    if (j9mm_iterator_flag_include_arraylet_leaves == (flags & j9mm_iterator_flag_include_arraylet_leaves)) {
        if (MM_GCExtensions::getExtensions(javaVM->omrVM)
                ->indexableObjectModel.hasArrayletLeafPointers((J9IndexableObject*)objectPtr)) {
            ...
            while (NULL != (slotObject = arrayletLeafIterator.nextLeafPointer())) {
                returnCode = iterateObjectSlotDo(
                    javaVM, slotObject, object, j9mm_iterator_object_ref_type_arraylet_leaf, flags, func, userData);
                if (JVMTI_ITERATION_ABORT == returnCode) {
                    break;
                }
            }
 ...
 * @param userData Pointer to storage for userData.
 */
jvmtiIterationControl j9mm_iterate_all_objects(J9JavaVM* vm, J9PortLibrary* portLibrary, UDATA flags,
    ...
    MM_GCExtensionsBase* extensions, J9MM_IterateRegionDescriptor* descriptor, MM_HeapRegionDescriptor* region)
{
    ...
    initializeRegionDescriptor(descriptor, regionName, (UDATA)region, objectAlignment, objectMinimumSize,
        region->getLowAddress(), region->getSize());
}
    ...
    void* userData)
{
    ...
    while (NULL != (object = objectHeapIterator.nextObject())) {
        ...
        if ((extensions->objectModel.isDeadObject(object))
            || (0 != (J9CLASS_FLAGS(J9GC_J9OBJECT_CLAZZ(object)) & J9_JAVA_CLASS_DYING))) {
            if (0 != (flags & j9mm_iterator_flag_include_holes)) {
                if (extensions->objectModel.isDeadObject(object)) {
                    ...
                    /* this object is not marked as a hole, but its class has been partially unloaded so it's treated
                     * like a hole here */
...
j9mm_abandon_object(J9JavaVM* javaVM, J9MM_IterateRegionDescriptor* region, J9MM_IterateObjectDescriptor* objectDesc)
{
    ...
    if (j9mm_region_type_region == privateRegion->type) {
        ...
        UDATA deadObjectByteSize
            = MM_GCExtensions::getExtensions(javaVM)->objectModel.getConsumedSizeInBytesWithHeader(objectDesc->object);
