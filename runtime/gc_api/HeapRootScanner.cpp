 ...
 */
void MM_HeapRootScanner::doClassLoader(J9ClassLoader* classLoader)
{
...
void MM_HeapRootScanner::doOwnableSynchronizerObject(J9Object* objectPtr) { doObject(objectPtr); }

#if defined(J9VM_GC_FINALIZATION)
/**
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::doUnfinalizedObject(J9Object* objectPtr) { doObject(objectPtr); }
#endif /* J9VM_GC_FINALIZATION */
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::doFinalizableObject(J9Object* objectPtr) { doObject(objectPtr); }
#endif /* J9VM_GC_FINALIZATION */

/**
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::doMonitorReference(
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::doJNIWeakGlobalReference(J9Object** slotPtr) { doSlot(slotPtr); }

#if defined(J9VM_GC_MODRON_SCAVENGER)
/**
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::doRememberedSetSlot(
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::doStringTableSlot(J9Object** slotPtr, GC_StringTableIterator* stringTableIterator)
{
    doSlot(slotPtr);
}
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::doVMClassSlot(J9Class** slotPtr, GC_VMClassSlotIterator* vmClassSlotIterator)
{
    doClassSlot(slotPtr);
}
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::doJVMTIObjectTagSlot(
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::scanClasses()
{
    ...
    MM_GCExtensions::DynamicClassUnloading dynamicClassUnloadingFlag
        = (MM_GCExtensions::DynamicClassUnloading)_extensions->dynamicClassUnloading;
#endif
 ...
 */
void MM_HeapRootScanner::scanVMClassSlots()
{
 ...
 */
void MM_HeapRootScanner::doClassSlot(J9Class** slotPtr) { doClass(*slotPtr); }

/**
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::doVMThreadSlot(J9Object** slotPtr, GC_VMThreadIterator* vmThreadIterator) { doSlot(slotPtr); }

/**
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::doJNIGlobalReferenceSlot(
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::scanClassLoaders()
{
#if defined(J9VM_GC_DYNAMIC_CLASS_UNLOADING)
    J9ClassLoader* sysClassLoader = _javaVM->systemClassLoader;
    J9ClassLoader* appClassLoader = _javaVM->applicationClassLoader;
 ...
 * thread).
 */
void MM_HeapRootScanner::scanThreads()
{
 ...
 **/
bool MM_HeapRootScanner::scanOneThread(J9VMThread* walkThread)
{
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::scanFinalizableObjects()
{
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::scanJNIGlobalReferences()
{
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::scanStringTable()
{
 ...
 */
void MM_HeapRootScanner::scanUnfinalizedObjects()
{
...
void MM_HeapRootScanner::scanOwnableSynchronizerObjects()
{
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::scanMonitorReferences()
{
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::scanJNIWeakGlobalReferences()
{
 ...
 * @todo Provide function documentation
 */
void MM_HeapRootScanner::scanRememberedSet()
{
 ...
 */
void MM_HeapRootScanner::scanJVMTIObjectTagTables()
{
