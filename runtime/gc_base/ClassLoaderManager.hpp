...
private:
    ...
    UDATA _lastUnloadNumOfAnonymousClasses; /**< number of anonymous classes last seen during a dynamic class unloading
                                               pass */
    ...
    omrthread_monitor_t
        _classLoaderListMonitor; /**< monitor that controls modification of the classLoader linked list */
...
public:
     ...
     */
    void cleanUpClassLoadersStart(MM_EnvironmentBase* env, J9ClassLoader* classLoaderUnloadList, MM_HeapMap* markMap,
     ...
     */
    void cleanUpSegmentsAlongClassLoaderLink(
     ...
     */
    void cleanUpClassLoaders(MM_EnvironmentBase* env, J9ClassLoader* classLoadersUnloadedList,
     ...
     */
    J9ClassLoader* identifyClassLoadersToUnload(
...
private:
     ...
     */
    J9Class* addDyingClassesToList(MM_EnvironmentBase* env, J9ClassLoader* classLoader, MM_HeapMap* markMap,
        bool setAll, J9Class* classUnloadListStart, UDATA* classUnloadCountOut);
