...
protected:
public:
    MM_IndexableObjectAllocationModel(
        MM_EnvironmentBase* env, J9Class* clazz, uint32_t numberOfIndexedFields, uintptr_t allocateObjectFlags = 0)
        : MM_JavaObjectAllocationModel(
              env, clazz, allocation_category_indexable, 0, allocateObjectFlags | OMR_GC_ALLOCATE_OBJECT_INDEXABLE)
