...
private:
     ...
     */
    static uintptr_t calculateRequiredSize(MM_EnvironmentBase* env, J9Class* clazz, uintptr_t allocateFlags)
    {
...
public:
    ...
    MM_MixedObjectAllocationModel(MM_EnvironmentBase* env, J9Class* clazz, uintptr_t allocateObjectFlags = 0)
        : MM_JavaObjectAllocationModel(env, clazz, allocation_category_mixed,
              calculateRequiredSize(env, clazz, allocateObjectFlags), allocateObjectFlags)
    {}
    ...
    MMINLINE bool initializeAllocateDescription(MM_EnvironmentBase* env)
    {
        ...
        if (isAllocatable() && env->getExtensions()->isVLHGC()) {
             ...
             */
            uintptr_t objectSizeAfterGrowing
                = getAllocateDescription()->getBytesRequested() + env->getObjectAlignmentInBytes();
     ...
     * Initializer.
     */
    MMINLINE omrobjectptr_t initializeMixedObject(MM_EnvironmentBase* env, void* allocatedBytes)
    {
