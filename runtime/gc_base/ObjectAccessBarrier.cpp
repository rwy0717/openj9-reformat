...
bool MM_ObjectAccessBarrier::initialize(MM_EnvironmentBase* env)
{
    ...
    if (_extensions->isMetronomeGC()) {
        if (DEFAULT_LOW_MEMORY_HEAP_CEILING_SHIFT < omrVM->_compressedPointersShift) {
            ...
            _extensions->heapInitializationFailureReason
                = MM_GCExtensionsBase::HEAP_INITIALIZATION_FAILURE_REASON_METRONOME_DOES_NOT_SUPPORT_4BIT_SHIFT;
            return false;
        }
    }
     ...
     */
    if (0
        != vm->internalVMFunctions->addHiddenInstanceField(
               vm, "java/lang/ref/Reference", "gcLink", "Ljava/lang/ref/Reference;", &_referenceLinkOffset)) {
        return false;
    }
    /* request an extra slot in java/util/concurrent/locks/AbstractOwnableSynchronizer which we will use to maintain
     * linked lists of ownable synchronizer objects */
    if (0
        != vm->internalVMFunctions->addHiddenInstanceField(vm, "java/util/concurrent/locks/AbstractOwnableSynchronizer",
               "ownableSynchronizerLink", "Ljava/util/concurrent/locks/AbstractOwnableSynchronizer;",
               &_ownableSynchronizerLinkOffset)) {
        return false;
    }
...
void MM_ObjectAccessBarrier::kill(MM_EnvironmentBase* env)
{
    tearDown(env);
    env->getForge()->free(this);
}

void MM_ObjectAccessBarrier::tearDown(MM_EnvironmentBase* env) {}
 ...
 */
mm_j9object_t MM_ObjectAccessBarrier::readObjectImpl(
    J9VMThread* vmThread, mm_j9object_t srcObject, fj9object_t* srcAddress, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
mm_j9object_t MM_ObjectAccessBarrier::staticReadObjectImpl(
    J9VMThread* vmThread, J9Class* clazz, j9object_t* srcAddress, bool isVolatile)
{
    return *srcAddress;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
mm_j9object_t MM_ObjectAccessBarrier::readObjectFromInternalVMSlotImpl(
    J9VMThread* vmThread, j9object_t* srcAddress, bool isVolatile)
{
    return *srcAddress;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeObjectImpl(
    J9VMThread* vmThread, mm_j9object_t destObject, fj9object_t* destAddress, mm_j9object_t value, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::staticStoreObjectImpl(
    J9VMThread* vmThread, J9Class* clazz, j9object_t* destAddress, mm_j9object_t value, bool isVolatile)
{
    *destAddress = value;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeObjectToInternalVMSlotImpl(
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
U_8 MM_ObjectAccessBarrier::readU8Impl(J9VMThread* vmThread, mm_j9object_t srcObject, U_8* srcAddress, bool isVolatile)
{
    return *srcAddress;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeU8Impl(
    J9VMThread* vmThread, mm_j9object_t destObject, U_8* destAddress, U_8 value, bool isVolatile)
{
    *destAddress = value;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
I_8 MM_ObjectAccessBarrier::readI8Impl(J9VMThread* vmThread, mm_j9object_t srcObject, I_8* srcAddress, bool isVolatile)
{
    return *srcAddress;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeI8Impl(
    J9VMThread* vmThread, mm_j9object_t destObject, I_8* destAddress, I_8 value, bool isVolatile)
{
    *destAddress = value;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
U_16 MM_ObjectAccessBarrier::readU16Impl(
    J9VMThread* vmThread, mm_j9object_t srcObject, U_16* srcAddress, bool isVolatile)
{
    return *srcAddress;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeU16Impl(
    J9VMThread* vmThread, mm_j9object_t destObject, U_16* destAddress, U_16 value, bool isVolatile)
{
    *destAddress = value;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
I_16 MM_ObjectAccessBarrier::readI16Impl(
    J9VMThread* vmThread, mm_j9object_t srcObject, I_16* srcAddress, bool isVolatile)
{
    return *srcAddress;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeI16Impl(
    J9VMThread* vmThread, mm_j9object_t destObject, I_16* destAddress, I_16 value, bool isVolatile)
{
    *destAddress = value;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
U_32 MM_ObjectAccessBarrier::readU32Impl(
    J9VMThread* vmThread, mm_j9object_t srcObject, U_32* srcAddress, bool isVolatile)
{
    return *srcAddress;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeU32Impl(
    J9VMThread* vmThread, mm_j9object_t destObject, U_32* destAddress, U_32 value, bool isVolatile)
{
    *destAddress = value;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
I_32 MM_ObjectAccessBarrier::readI32Impl(
    J9VMThread* vmThread, mm_j9object_t srcObject, I_32* srcAddress, bool isVolatile)
{
    return *srcAddress;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeI32Impl(
    J9VMThread* vmThread, mm_j9object_t destObject, I_32* destAddress, I_32 value, bool isVolatile)
{
    *destAddress = value;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
U_64 MM_ObjectAccessBarrier::readU64Impl(
    J9VMThread* vmThread, mm_j9object_t srcObject, U_64* srcAddress, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeU64Impl(
    J9VMThread* vmThread, mm_j9object_t destObject, U_64* destAddress, U_64 value, bool isVolatile)
{
#if !defined(J9VM_ENV_DATA64)
    if (isVolatile) {
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
I_64 MM_ObjectAccessBarrier::readI64Impl(
    J9VMThread* vmThread, mm_j9object_t srcObject, I_64* srcAddress, bool isVolatile)
{
#if !defined(J9VM_ENV_DATA64)
    if (isVolatile) {
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeI64Impl(
    J9VMThread* vmThread, mm_j9object_t destObject, I_64* destAddress, I_64 value, bool isVolatile)
{
#if !defined(J9VM_ENV_DATA64)
    if (isVolatile) {
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void* MM_ObjectAccessBarrier::readAddressImpl(
    J9VMThread* vmThread, mm_j9object_t srcObject, void** srcAddress, bool isVolatile)
{
    return *srcAddress;
}
 ...
 * @param isVolatile non-zero if the field is volatile, zero otherwise
 */
void MM_ObjectAccessBarrier::storeAddressImpl(
    J9VMThread* vmThread, mm_j9object_t destObject, void** destAddress, void* value, bool isVolatile)
{
    *destAddress = value;
}
 ...
 */
void MM_ObjectAccessBarrier::protectIfVolatileBefore(J9VMThread* vmThread, bool isVolatile, bool isRead, bool isWide)
{
    if (isVolatile) {
 ...
 * @param isWide true if the field is wide (64-bit), false otherwise
 */
void MM_ObjectAccessBarrier::protectIfVolatileAfter(J9VMThread* vmThread, bool isVolatile, bool isRead, bool isWide)
{
    if (isVolatile) {
        /* need to insert a sync instruction
         * As this is inline, compiler should optimize this away when not necessary.
 ...
 */
J9Object* MM_ObjectAccessBarrier::mixedObjectReadObject(
    J9VMThread* vmThread, J9Object* srcObject, UDATA srcOffset, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void* MM_ObjectAccessBarrier::mixedObjectReadAddress(
    J9VMThread* vmThread, J9Object* srcObject, UDATA srcOffset, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
U_32 MM_ObjectAccessBarrier::mixedObjectReadU32(
    J9VMThread* vmThread, J9Object* srcObject, UDATA srcOffset, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
I_32 MM_ObjectAccessBarrier::mixedObjectReadI32(
    J9VMThread* vmThread, J9Object* srcObject, UDATA srcOffset, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
U_64 MM_ObjectAccessBarrier::mixedObjectReadU64(
    J9VMThread* vmThread, J9Object* srcObject, UDATA srcOffset, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
I_64 MM_ObjectAccessBarrier::mixedObjectReadI64(
    J9VMThread* vmThread, J9Object* srcObject, UDATA srcOffset, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::mixedObjectStoreObject(
    J9VMThread* vmThread, J9Object* destObject, UDATA destOffset, J9Object* value, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::mixedObjectStoreAddress(
    J9VMThread* vmThread, J9Object* destObject, UDATA destOffset, void* value, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::mixedObjectStoreU32(
    J9VMThread* vmThread, J9Object* destObject, UDATA destOffset, U_32 value, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::mixedObjectStoreI32(
    J9VMThread* vmThread, J9Object* destObject, UDATA destOffset, I_32 value, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::mixedObjectStoreU64(
    J9VMThread* vmThread, J9Object* destObject, UDATA destOffset, U_64 value, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::mixedObjectStoreI64(
    J9VMThread* vmThread, J9Object* destObject, UDATA destOffset, I_64 value, bool isVolatile)
{
 ...
 */
J9Object* MM_ObjectAccessBarrier::indexableReadObject(
    J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 srcIndex, bool isVolatile)
{
    fj9object_t* actualAddress
        = (fj9object_t*)indexableEffectiveAddress(vmThread, srcObject, srcIndex, sizeof(fj9object_t));
    J9Object* result = NULL;
 ...
 * @param srcIndex The element index
 */
void* MM_ObjectAccessBarrier::indexableReadAddress(
    J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 srcIndex, bool isVolatile)
{
 ...
 * @param srcIndex The element index
 */
U_8 MM_ObjectAccessBarrier::indexableReadU8(
    J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 srcIndex, bool isVolatile)
{
 ...
 * @param srcIndex The element index
 */
I_8 MM_ObjectAccessBarrier::indexableReadI8(
    J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 srcIndex, bool isVolatile)
{
 ...
 * @param srcIndex The element index
 */
U_16 MM_ObjectAccessBarrier::indexableReadU16(
    J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 srcIndex, bool isVolatile)
{
 ...
 * @param srcIndex The element index
 */
I_16 MM_ObjectAccessBarrier::indexableReadI16(
    J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 srcIndex, bool isVolatile)
{
 ...
 * @param srcIndex The element index
 */
U_32 MM_ObjectAccessBarrier::indexableReadU32(
    J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 srcIndex, bool isVolatile)
{
 ...
 * @param srcIndex The element index
 */
I_32 MM_ObjectAccessBarrier::indexableReadI32(
    J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 srcIndex, bool isVolatile)
{
 ...
 * @param srcIndex The element index
 */
U_64 MM_ObjectAccessBarrier::indexableReadU64(
    J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 srcIndex, bool isVolatile)
{
 ...
 * @param srcIndex The element index
 */
I_64 MM_ObjectAccessBarrier::indexableReadI64(
    J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 srcIndex, bool isVolatile)
{
 ...
 */
void MM_ObjectAccessBarrier::indexableStoreObject(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, J9Object* value, bool isVolatile)
{
    fj9object_t* actualAddress
        = (fj9object_t*)indexableEffectiveAddress(vmThread, destObject, destIndex, sizeof(fj9object_t));
 ...
 * @param value The value to store.
 */
void MM_ObjectAccessBarrier::indexableStoreAddress(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, void* value, bool isVolatile)
{
 ...
 * @param value The value to store.
 */
void MM_ObjectAccessBarrier::indexableStoreU8(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, U_8 value, bool isVolatile)
{
 ...
 * @param value The value to store.
 */
void MM_ObjectAccessBarrier::indexableStoreI8(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, I_8 value, bool isVolatile)
{
 ...
 * @param value The value to store.
 */
void MM_ObjectAccessBarrier::indexableStoreU16(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, U_16 value, bool isVolatile)
{
 ...
 * @param value The value to store.
 */
void MM_ObjectAccessBarrier::indexableStoreI16(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, I_16 value, bool isVolatile)
{
 ...
 * @param value The value to store.
 */
void MM_ObjectAccessBarrier::indexableStoreU32(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, U_32 value, bool isVolatile)
{
 ...
 * @param value The value to store.
 */
void MM_ObjectAccessBarrier::indexableStoreI32(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, I_32 value, bool isVolatile)
{
 ...
 * @param value The value to store.
 */
void MM_ObjectAccessBarrier::indexableStoreU64(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, U_64 value, bool isVolatile)
{
 ...
 * @param value The value to store.
 */
void MM_ObjectAccessBarrier::indexableStoreI64(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, I_64 value, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
J9Object* MM_ObjectAccessBarrier::staticReadObject(
    J9VMThread* vmThread, J9Class* clazz, J9Object** srcSlot, bool isVolatile)
{
    J9Object* result = NULL;
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void* MM_ObjectAccessBarrier::staticReadAddress(J9VMThread* vmThread, J9Class* clazz, void** srcSlot, bool isVolatile)
{
    void* result;
    protectIfVolatileBefore(vmThread, isVolatile, true, true);
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
U_32 MM_ObjectAccessBarrier::staticReadU32(J9VMThread* vmThread, J9Class* clazz, U_32* srcSlot, bool isVolatile)
{
    U_32 result;
    protectIfVolatileBefore(vmThread, isVolatile, true, true);
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
I_32 MM_ObjectAccessBarrier::staticReadI32(J9VMThread* vmThread, J9Class* clazz, I_32* srcSlot, bool isVolatile)
{
    I_32 result;
    protectIfVolatileBefore(vmThread, isVolatile, true, true);
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
U_64 MM_ObjectAccessBarrier::staticReadU64(J9VMThread* vmThread, J9Class* clazz, U_64* srcSlot, bool isVolatile)
{
    U_64 result;
    protectIfVolatileBefore(vmThread, isVolatile, true, true);
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
I_64 MM_ObjectAccessBarrier::staticReadI64(J9VMThread* vmThread, J9Class* clazz, I_64* srcSlot, bool isVolatile)
{
    I_64 result;
    protectIfVolatileBefore(vmThread, isVolatile, true, true);
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::staticStoreObject(
    J9VMThread* vmThread, J9Class* clazz, J9Object** destSlot, J9Object* value, bool isVolatile)
{
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::staticStoreAddress(
    J9VMThread* vmThread, J9Class* clazz, void** destSlot, void* value, bool isVolatile)
{
    protectIfVolatileBefore(vmThread, isVolatile, false, true);
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::staticStoreU32(
    J9VMThread* vmThread, J9Class* clazz, U_32* destSlot, U_32 value, bool isVolatile)
{
    protectIfVolatileBefore(vmThread, isVolatile, false, true);
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::staticStoreI32(
    J9VMThread* vmThread, J9Class* clazz, I_32* destSlot, I_32 value, bool isVolatile)
{
    protectIfVolatileBefore(vmThread, isVolatile, false, true);
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::staticStoreU64(
    J9VMThread* vmThread, J9Class* clazz, U_64* destSlot, U_64 value, bool isVolatile)
{
    protectIfVolatileBefore(vmThread, isVolatile, false, true);
 ...
 * @param isVolatile non-zero if the field is volatile.
 */
void MM_ObjectAccessBarrier::staticStoreI64(
    J9VMThread* vmThread, J9Class* clazz, I_64* destSlot, I_64 value, bool isVolatile)
{
    protectIfVolatileBefore(vmThread, isVolatile, false, true);
 ...
 */
U_8* MM_ObjectAccessBarrier::getArrayObjectDataAddress(J9VMThread* vmThread, J9IndexableObject* arrayObject)
{
 ...
 */
j9objectmonitor_t* MM_ObjectAccessBarrier::getLockwordAddress(J9VMThread* vmThread, J9Object* object)
{
 ...
 */
void MM_ObjectAccessBarrier::cloneObject(J9VMThread* vmThread, J9Object* srcObject, J9Object* destObject)
{
    copyObjectFields(
        vmThread, J9GC_J9OBJECT_CLAZZ(srcObject), srcObject, J9_OBJECT_HEADER_SIZE, destObject, J9_OBJECT_HEADER_SIZE);
}
 ...
 */
void MM_ObjectAccessBarrier::copyObjectFields(J9VMThread* vmThread, J9Class* objectClass, J9Object* srcObject,
    UDATA srcOffset, J9Object* destObject, UDATA destOffset)
{
    ...
    while (offset < limit) {
        ...
        if (descriptionBits & 1) {
            ...
            *(fj9object_t*)((UDATA)destObject + destOffset + offset)
                = *(fj9object_t*)((UDATA)srcObject + srcOffset + offset);
        }
        descriptionBits >>= 1;
 ...
 * @TODO This does not currently check if the fields that it is reading are volatile.
 */
void MM_ObjectAccessBarrier::cloneIndexableObject(
    J9VMThread* vmThread, J9IndexableObject* srcObject, J9IndexableObject* destObject)
{
    j9objectmonitor_t* lockwordAddress = NULL;
 ...
 */
J9Object* MM_ObjectAccessBarrier::asConstantPoolObject(J9VMThread* vmThread, J9Object* toConvert, UDATA allocationFlags)
{
 ...
 * @param value the value to be stored
 */
void MM_ObjectAccessBarrier::storeObjectToInternalVMSlot(J9VMThread* vmThread, J9Object** destSlot, J9Object* value)
{
 ...
 */
J9Object* MM_ObjectAccessBarrier::readObjectFromInternalVMSlot(J9VMThread* vmThread, J9Object** srcSlot)
{
 ...
 **/
bool MM_ObjectAccessBarrier::compareAndSwapObject(
    J9VMThread* vmThread, J9Object* destObject, fj9object_t* destAddress, J9Object* compareObject, J9Object* swapObject)
{
    ...
    if (preObjectRead(vmThread, destObject, actualDestAddress)) {
        ...
        result = ((U_32)(UDATA)compareValue
            == MM_AtomicOperations::lockCompareExchangeU32(
                   (U_32*)actualDestAddress, (U_32)(UDATA)compareValue, (U_32)(UDATA)swapValue));
#else
        result = ((UDATA)compareValue
            == MM_AtomicOperations::lockCompareExchange(
                   (UDATA*)actualDestAddress, (UDATA)compareValue, (UDATA)swapValue));
#endif
 ...
 * @todo This should be converted to take the offset, not the address
 **/
bool MM_ObjectAccessBarrier::staticCompareAndSwapObject(
    J9VMThread* vmThread, J9Class* destClass, j9object_t* destAddress, J9Object* compareObject, J9Object* swapObject)
{
    /* Note: This is a bit of a special case -- we call preObjectStore even though the store
     * may not actually occur. This is safe and correct for Metronome.
     */
    ...
    bool result = ((UDATA)compareObject
        == MM_AtomicOperations::lockCompareExchange((UDATA*)destAddress, (UDATA)compareObject, (UDATA)swapObject));
 ...
 **/
bool MM_ObjectAccessBarrier::mixedObjectCompareAndSwapInt(
    J9VMThread* vmThread, J9Object* destObject, UDATA offset, U_32 compareValue, U_32 swapValue)
{
    U_32* actualDestAddress = J9OAB_MIXEDOBJECT_EA(destObject, offset, U_32);

    protectIfVolatileBefore(vmThread, true, false, false);
    bool result
        = (compareValue == MM_AtomicOperations::lockCompareExchangeU32(actualDestAddress, compareValue, swapValue));
    protectIfVolatileAfter(vmThread, true, false, false);
    return result;
}
 ...
 * @param swapValue the value to be stored in the destSlot if compareValue is there now
 **/
bool MM_ObjectAccessBarrier::staticCompareAndSwapInt(
    J9VMThread* vmThread, J9Class* destClass, U_32* destAddress, U_32 compareValue, U_32 swapValue)
{
    protectIfVolatileBefore(vmThread, true, false, false);
 ...
 * @param swapValue the value to be stored in the destSlot if compareValue is there now
 **/
bool MM_ObjectAccessBarrier::mixedObjectCompareAndSwapLong(
    J9VMThread* vmThread, J9Object* destObject, UDATA offset, U_64 compareValue, U_64 swapValue)
{
    U_64* actualDestAddress = J9OAB_MIXEDOBJECT_EA(destObject, offset, U_64);

    protectIfVolatileBefore(vmThread, true, false, true);
    bool result
        = (compareValue == MM_AtomicOperations::lockCompareExchangeU64(actualDestAddress, compareValue, swapValue));
 ...
 * @param swapValue the value to be stored in the destSlot if compareValue is there now
 **/
bool MM_ObjectAccessBarrier::staticCompareAndSwapLong(
    J9VMThread* vmThread, J9Class* destClass, U_64* destAddress, U_64 compareValue, U_64 swapValue)
{
    protectIfVolatileBefore(vmThread, true, false, true);
 ...
 * @todo This should be converted to take the offset, not the address
 **/
J9Object* MM_ObjectAccessBarrier::compareAndExchangeObject(
    J9VMThread* vmThread, J9Object* destObject, fj9object_t* destAddress, J9Object* compareObject, J9Object* swapObject)
{
    fj9object_t* actualDestAddress;
    fj9object_t compareValue = convertTokenFromPointer(compareObject);
...
#if defined(J9VM_GC_COMPRESSED_POINTERS)
        J9Object* result = (J9Object*)(UDATA)MM_AtomicOperations::lockCompareExchangeU32(
            (U_32*)actualDestAddress, (U_32)(UDATA)compareValue, (U_32)(UDATA)swapValue);
#else
        J9Object* result = (J9Object*)MM_AtomicOperations::lockCompareExchange(
            (UDATA*)actualDestAddress, (UDATA)compareValue, (UDATA)swapValue);
#endif
 ...
 * @todo This should be converted to take the offset, not the address
 **/
J9Object* MM_ObjectAccessBarrier::staticCompareAndExchangeObject(
    J9VMThread* vmThread, J9Class* destClass, j9object_t* destAddress, J9Object* compareObject, J9Object* swapObject)
{
    /* Note: This is a bit of a special case -- we call preObjectStore even though the store
     * may not actually occur. This is safe and correct for Metronome.
 ...
 **/
U_32 MM_ObjectAccessBarrier::mixedObjectCompareAndExchangeInt(
    J9VMThread* vmThread, J9Object* destObject, UDATA offset, U_32 compareValue, U_32 swapValue)
{
    U_32* actualDestAddress = J9OAB_MIXEDOBJECT_EA(destObject, offset, U_32);
 ...
 * @return the int stored in the object field before the update
 **/
U_32 MM_ObjectAccessBarrier::staticCompareAndExchangeInt(
    J9VMThread* vmThread, J9Class* destClass, U_32* destAddress, U_32 compareValue, U_32 swapValue)
{
    protectIfVolatileBefore(vmThread, true, false, false);
 ...
 **/
U_64 MM_ObjectAccessBarrier::mixedObjectCompareAndExchangeLong(
    J9VMThread* vmThread, J9Object* destObject, UDATA offset, U_64 compareValue, U_64 swapValue)
{
    U_64* actualDestAddress = J9OAB_MIXEDOBJECT_EA(destObject, offset, U_64);
 ...
 * @return the long stored in the object field before the update
 **/
U_64 MM_ObjectAccessBarrier::staticCompareAndExchangeLong(
    J9VMThread* vmThread, J9Class* destClass, U_64* destAddress, U_64 compareValue, U_64 swapValue)
{
    protectIfVolatileBefore(vmThread, true, false, true);
 ...
 */
bool MM_ObjectAccessBarrier::preObjectStore(
 ...
 */
void MM_ObjectAccessBarrier::postObjectStore(
    J9VMThread* vmThread, J9Object* destObject, fj9object_t* destAddress, J9Object* value, bool isVolatile)
{}
 ...
 */
void MM_ObjectAccessBarrier::postObjectStore(
    J9VMThread* vmThread, J9Class* destObject, J9Object** destAddress, J9Object* value, bool isVolatile)
{}
 ...
 */
bool MM_ObjectAccessBarrier::preBatchObjectStore(J9VMThread* vmThread, J9Object* destObject, bool isVolatile)
{
#if defined(J9VM_GC_COMBINATION_SPEC)
    /* (assert here to verify that we aren't defaulting to this implementation through some unknown path - delete once
...
bool MM_ObjectAccessBarrier::preBatchObjectStore(J9VMThread* vmThread, J9Class* destClass, bool isVolatile)
{
#if defined(J9VM_GC_COMBINATION_SPEC)
    /* (assert here to verify that we aren't defaulting to this implementation through some unknown path - delete once
     * combination is stable) */
...
bool MM_ObjectAccessBarrier::preObjectRead(J9VMThread* vmThread, J9Object* srcObject, fj9object_t* srcAddress)
{
    return true;
}

bool MM_ObjectAccessBarrier::preMonitorTableSlotRead(J9VMThread* vmThread, j9object_t* srcAddress) { return true; }

bool MM_ObjectAccessBarrier::preMonitorTableSlotRead(J9JavaVM* vm, j9object_t* srcAddress) { return true; }

bool MM_ObjectAccessBarrier::preObjectRead(J9VMThread* vmThread, J9Class* srcClass, J9Object** srcAddress)
{
    return true;
}

bool MM_ObjectAccessBarrier::postObjectRead(J9VMThread* vmThread, J9Object* srcObject, fj9object_t* srcAddress)
{
    return true;
}

bool MM_ObjectAccessBarrier::postObjectRead(J9VMThread* vmThread, J9Class* srcClass, J9Object** srcAddress)
{
    return true;
}
 ...
 */
void MM_ObjectAccessBarrier::fillArrayOfObjects(
    J9VMThread* vmThread, j9array_t destObject, I_32 destIndex, I_32 count, j9object_t value)
{
#if defined(J9VM_GC_COMBINATION_SPEC)
    /* (assert here to verify that we aren't defaulting to this implementation through some unknown path - delete once
     * combination is stable) */
 ...
 */
I_32 MM_ObjectAccessBarrier::doCopyContiguousBackward(J9VMThread* vmThread, J9IndexableObject* srcObject,
 ...
 * @return this cannot fail (overloaded can) => returns ARRAY_COPY_NOT_DONE
 */
I_32 MM_ObjectAccessBarrier::doCopyContiguousForward(J9VMThread* vmThread, J9IndexableObject* srcObject,
    J9IndexableObject* destObject, I_32 srcIndex, I_32 destIndex, I_32 lengthInSlots)
{
    fj9object_t* srcSlot = (fj9object_t*)indexableEffectiveAddress(vmThread, srcObject, srcIndex, sizeof(fj9object_t));
    fj9object_t* destSlot
...
I_32 MM_ObjectAccessBarrier::getObjectHashCode(J9JavaVM* vm, J9Object* object)
{
    return _extensions->objectModel.getObjectHashCode(vm, object);
}

void MM_ObjectAccessBarrier::setFinalizeLink(j9object_t object, j9object_t value)
{
    fj9object_t* finalizeLink = getFinalizeLinkAddress(object);
    *finalizeLink = convertTokenFromPointer(value);
}

void MM_ObjectAccessBarrier::setReferenceLink(j9object_t object, j9object_t value)
{
...
void MM_ObjectAccessBarrier::setOwnableSynchronizerLink(j9object_t object, j9object_t value)
{
    Assert_MM_true(NULL != object);
...
void MM_ObjectAccessBarrier::printNativeMethod(J9VMThread* vmThread)
{
    ...
    if (NULL != method) {
        ...
        Trc_MM_ObjectAccessBarrier_printNativeMethod(vmThread, method, (U_32)J9UTF8_LENGTH(className),
            J9UTF8_DATA(className), (U_32)J9UTF8_LENGTH(name), J9UTF8_DATA(name), (U_32)J9UTF8_LENGTH(sig),
            J9UTF8_DATA(sig));
    } else {
