 ...
 * @ingroup GC_Base
 */
static UDATA isValidClass(J9JavaVM* javaVM, J9Class* ptr, UDATA flags)
{
...
j9gc_ext_check_is_valid_heap_object(J9JavaVM* javaVM, J9Object* ptr, UDATA flags)
{
    ...
    if (extensions->objectModel.isObjectArray(ptr) || extensions->objectModel.isPrimitiveArray(ptr)) {
