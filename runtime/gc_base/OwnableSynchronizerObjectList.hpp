...
private:
    ...
    MM_OwnableSynchronizerObjectList*
        _nextList; /**< a pointer to the next OwnableSynchronizer list in the global linked list of lists */
    MM_OwnableSynchronizerObjectList*
        _previousList; /**< a pointer to the previous OwnableSynchronizer list in the global linked list of lists */
...
public:
     ...
     */
    MMINLINE void backupList() { _priorHead = _head; }
    ...
    /**
     * Return a pointer to the next OwnableSynchronizer object list in the global linked list of lists, or NULL if this
     * is the last list.
    ...
    /**
     * Return a pointer to the previous OwnableSynchronizer object list in the global linked list of lists, or NULL if
    ...
    MMINLINE void incrementObjectCount(UDATA count) { MM_AtomicOperations::add((volatile UDATA*)&_objectCount, count); }
#endif /* defined(J9VM_GC_VLHGC) */
};
