...
void j9gc_ext_reachable_objects_do(
    J9VMThread* vmThread, J9MODRON_REFERENCE_CHAIN_WALKER_CALLBACK userCallback, void* userData, UDATA walkFlags)
{
 ...
 * @param userData Pointer to storage for userData.
 */
void j9gc_ext_reachable_from_object_do(J9VMThread* vmThread, J9Object* objectPtr,
    J9MODRON_REFERENCE_CHAIN_WALKER_CALLBACK userCallback, void* userData, UDATA walkFlags)
{
    MM_EnvironmentBase* env = MM_EnvironmentBase::getEnvironment(vmThread->omrVMThread);
 ...
 */
bool MM_ReferenceChainWalker::initialize(MM_EnvironmentBase* env)
{
    ...
    if (result) {
        _queue = (J9Object**)env->getForge()->allocate(
            _queueSlots * sizeof(J9Object**), MM_AllocationCategory::REFERENCES, J9_GET_CALLSITE());
        if (NULL != _queue) {
 ...
 * @param env
 */
void MM_ReferenceChainWalker::tearDown(MM_EnvironmentBase* env)
{
    if (NULL != _queue) {
 ...
 */
void MM_ReferenceChainWalker::doSlot(J9Object** slotPtr, IDATA type, IDATA index, J9Object* sourceObj)
{
 ...
 * @param sourceObj the object which contains this slot, or NULL if a root
 */
void MM_ReferenceChainWalker::doClassSlot(J9Class** slotPtr, IDATA type, IDATA index, J9Object* sourceObj)
{
    if (*slotPtr != NULL) {
 ...
 */
void MM_ReferenceChainWalker::doFieldSlot(GC_SlotObject* slotObject, IDATA type, IDATA index, J9Object* sourceObj)
{
 ...
 * Clears the queue
 */
void MM_ReferenceChainWalker::clearQueue()
{
    _queueCurrent = _queue;
 ...
 */
void MM_ReferenceChainWalker::pushObject(J9Object* objectPtr)
{
 ...
 */
J9Object* MM_ReferenceChainWalker::popObject()
{
    J9Object* objectPtr;
 ...
 */
void MM_ReferenceChainWalker::completeScan()
{
    J9Object* objectPtr;
 ...
 */
void MM_ReferenceChainWalker::scanObject(J9Object* objectPtr)
{
 ...
 */
void MM_ReferenceChainWalker::scanMixedObject(J9Object* objectPtr)
{
    GC_MixedObjectDeclarationOrderIterator objectIterator(
        static_cast<J9JavaVM*>(_omrVM->_language_vm), objectPtr, _shouldPreindexInterfaceFields);
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::scanPointerArrayObject(J9IndexableObject* objectPtr)
{
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::scanReferenceMixedObject(J9Object* objectPtr)
{
    GC_MixedObjectDeclarationOrderIterator objectIterator(
        static_cast<J9JavaVM*>(_omrVM->_language_vm), objectPtr, _shouldPreindexInterfaceFields);
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::scanClass(J9Class* clazz)
{
    J9Object* referrer = J9VM_J9CLASS_TO_HEAPCLASS(clazz);

    GC_ClassIteratorDeclarationOrder classIterator(
        static_cast<J9JavaVM*>(_omrVM->_language_vm), clazz, _shouldPreindexInterfaceFields);
 ...
 */
void MM_ReferenceChainWalker::findOverflowObjects()
{
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doSlot(J9Object** slotPtr) { doSlot(slotPtr, J9GC_ROOT_TYPE_UNKNOWN, -1, NULL); }

/**
 * Process a class slot pointer.
 * @param slotPtr a pointer to a class slot
 */
void MM_ReferenceChainWalker::doClassSlot(J9Class** slotPtr) { doClassSlot(slotPtr, J9GC_ROOT_TYPE_CLASS, -1, NULL); }

/**
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doClass(J9Class* clazz) { doClassSlot(&clazz); }

/**
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doClassLoader(J9ClassLoader* classLoader)
{
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doUnfinalizedObject(J9Object* objectPtr, MM_UnfinalizedObjectList* list)
{
...
void MM_ReferenceChainWalker::doOwnableSynchronizerObject(J9Object* objectPtr, MM_OwnableSynchronizerObjectList* list)
{
    J9Object* object = objectPtr;
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doMonitorReference(
    J9ObjectMonitor* objectMonitor, GC_HashTableIterator* monitorReferenceIterator)
{
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doJNIWeakGlobalReference(J9Object** slotPtr)
{
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doRememberedSetSlot(
    J9Object** slotPtr, GC_RememberedSetSlotIterator* rememberedSetSlotIterator)
{
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doStringTableSlot(J9Object** slotPtr, GC_StringTableIterator* stringTableIterator)
{
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doVMClassSlot(J9Class** slotPtr, GC_VMClassSlotIterator* vmClassSlotIterator)
{
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doStackSlot(J9Object** slotPtr, void* walkState, const void* stackLocation)
{
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doJVMTIObjectTagSlot(
    J9Object** slotPtr, GC_JVMTIObjectTagTableIterator* objectTagTableIterator)
{
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doVMThreadSlot(J9Object** slotPtr, GC_VMThreadIterator* vmThreadIterator)
{
    J9Object* slotValue = *slotPtr;
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doFinalizableObject(J9Object* objectPtr)
{
    J9Object* object = objectPtr;
 ...
 * @todo Provide function documentation
 */
void MM_ReferenceChainWalker::doJNIGlobalReferenceSlot(
