 ...
 */
void MM_RootScanner::doClassLoader(J9ClassLoader* classLoader)
{
...
void MM_RootScanner::scanModularityObjects(J9ClassLoader* classLoader)
{
 ...
 * @todo Provide function documentation
 */
MM_RootScanner::CompletePhaseCode MM_RootScanner::scanWeakReferencesComplete(MM_EnvironmentBase* env)
{
 ...
 * @todo Provide function documentation
 */
MM_RootScanner::CompletePhaseCode MM_RootScanner::scanSoftReferencesComplete(MM_EnvironmentBase* env)
{
    return complete_phase_OK;
}
 ...
 * @todo Provide function documentation
 */
MM_RootScanner::CompletePhaseCode MM_RootScanner::scanPhantomReferencesComplete(MM_EnvironmentBase* env)
{
    return complete_phase_OK;
}

#if defined(J9VM_GC_FINALIZATION)
void MM_RootScanner::doUnfinalizedObject(J9Object* objectPtr, MM_UnfinalizedObjectList* list)
{
 ...
 * @todo Provide function documentation
 */
MM_RootScanner::CompletePhaseCode MM_RootScanner::scanUnfinalizedObjectsComplete(MM_EnvironmentBase* env)
{
    return complete_phase_OK;
}
#endif /* J9VM_GC_FINALIZATION */

void MM_RootScanner::doOwnableSynchronizerObject(J9Object* objectPtr, MM_OwnableSynchronizerObjectList* list)
{
...
MM_RootScanner::CompletePhaseCode MM_RootScanner::scanOwnableSynchronizerObjectsComplete(MM_EnvironmentBase* env)
{
    return complete_phase_OK;
}
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::doMonitorReference(J9ObjectMonitor* objectMonitor, GC_HashTableIterator* monitorReferenceIterator)
{
    J9ThreadAbstractMonitor* monitor = (J9ThreadAbstractMonitor*)objectMonitor->monitor;
    doSlot((J9Object**)&monitor->userData);
}

MM_RootScanner::CompletePhaseCode MM_RootScanner::scanMonitorReferencesComplete(MM_EnvironmentBase* env)
{
    return complete_phase_OK;
}
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::doMonitorLookupCacheSlot(j9objectmonitor_t* slotPtr)
{
    if (0 != *slotPtr) {
        *slotPtr = 0;
    }
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::doJNIWeakGlobalReference(J9Object** slotPtr) { doSlot(slotPtr); }

#if defined(J9VM_GC_MODRON_SCAVENGER)
/**
 * @todo Provide function documentation
 */
void MM_RootScanner::doRememberedSetSlot(J9Object** slotPtr, GC_RememberedSetSlotIterator* rememberedSetSlotIterator)
{
    doSlot(slotPtr);
}
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::doStringTableSlot(J9Object** slotPtr, GC_StringTableIterator* stringTableIterator)
{
    doSlot(slotPtr);
}
 ...
 */
void MM_RootScanner::doStringCacheTableSlot(J9Object** slotPtr) { doSlot(slotPtr); }

/**
 * @todo Provide function documentation
 */
void MM_RootScanner::doVMClassSlot(J9Class** slotPtr, GC_VMClassSlotIterator* vmClassSlotIterator)
{
    doClassSlot(slotPtr);
}
 ...
 */
void MM_RootScanner::doFieldSlot(GC_SlotObject* slotObject)
{
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::doJVMTIObjectTagSlot(J9Object** slotPtr, GC_JVMTIObjectTagTableIterator* objectTagTableIterator)
{
    doSlot(slotPtr);
}
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::scanClasses(MM_EnvironmentBase* env)
{
    reportScanningStarted(RootScannerEntity_Classes);

    GC_SegmentIterator segmentIterator(
        static_cast<J9JavaVM*>(_omrVM->_language_vm)->classMemorySegments, MEMORY_TYPE_RAM_CLASS);
 ...
 */
void MM_RootScanner::scanVMClassSlots(MM_EnvironmentBase* env)
{
 ...
 */
void MM_RootScanner::doClassSlot(J9Class** slotPtr) { /* ignore class slots by default */ }

/**
 * @todo Provide function documentation
 */
void MM_RootScanner::doStackSlot(J9Object** slotPtr, void* walkState, const void* stackLocation)
{
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::doVMThreadSlot(J9Object** slotPtr, GC_VMThreadIterator* vmThreadIterator) { doSlot(slotPtr); }

/**
 * @todo Provide function documentation
 */
void MM_RootScanner::doJNIGlobalReferenceSlot(
    J9Object** slotPtr, GC_JNIGlobalReferenceIterator* jniGlobalReferenceIterator)
{
    doSlot(slotPtr);
}
 ...
 * class loader).
 */
void MM_RootScanner::scanPermanentClasses(MM_EnvironmentBase* env)
{
    ...
    if (NULL != static_cast<J9JavaVM*>(_omrVM->_language_vm)->systemClassLoader) {
        GC_ClassLoaderSegmentIterator segmentIterator(
            static_cast<J9JavaVM*>(_omrVM->_language_vm)->systemClassLoader, MEMORY_TYPE_RAM_CLASS);
    ...
    if (NULL != static_cast<J9JavaVM*>(_omrVM->_language_vm)->applicationClassLoader) {
        GC_ClassLoaderSegmentIterator segmentIterator(
            static_cast<J9JavaVM*>(_omrVM->_language_vm)->applicationClassLoader, MEMORY_TYPE_RAM_CLASS);
        while (NULL != (segment = segmentIterator.nextSegment())) {
            if (_singleThread || J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
                GC_ClassHeapIterator classHeapIterator(static_cast<J9JavaVM*>(_omrVM->_language_vm), segment);
                while (NULL != (clazz = classHeapIterator.nextClass())) {
 ...
 */
MM_RootScanner::CompletePhaseCode MM_RootScanner::scanClassesComplete(MM_EnvironmentBase* env)
{
    return complete_phase_OK;
}
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::scanClassLoaders(MM_EnvironmentBase* env)
{
    if (_singleThread || J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
 ...
 * @todo Provide function documentation
 */
void stackSlotIterator(
    J9JavaVM* javaVM, J9Object** slot, void* localData, J9StackWalkState* walkState, const void* stackLocation)
{
 ...
 * thread).
 */
void MM_RootScanner::scanThreads(MM_EnvironmentBase* env)
{
 ...
 **/
bool MM_RootScanner::scanOneThread(MM_EnvironmentBase* env, J9VMThread* walkThread, void* localData)
{
    ...
    GC_VMThreadStackSlotIterator::scanSlots((J9VMThread*)env->getOmrVMThread()->_language_vmthread, walkThread,
        localData, stackSlotIterator, isStackFrameClassWalkNeeded(), _trackVisibleStackFrameDepth);
    return false;
}
 ...
 * @param walkThead the thread to be scanned
 **/
void MM_RootScanner::scanSingleThread(MM_EnvironmentBase* env, J9VMThread* walkThread)
{
    StackIteratorData localData;
    localData.rootScanner = this;
    localData.env = env;
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::scanFinalizableObjects(MM_EnvironmentBase* env)
{
    if (_singleThread || J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::scanJNIGlobalReferences(MM_EnvironmentBase* env)
{
    /* JNI Global References */
    if (_singleThread || J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
        reportScanningStarted(RootScannerEntity_JNIGlobalReferences);

        GC_JNIGlobalReferenceIterator jniGlobalReferenceIterator(
            static_cast<J9JavaVM*>(_omrVM->_language_vm)->jniGlobalReferences);
        J9Object** slot;
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::scanStringTable(MM_EnvironmentBase* env)
{
 ...
 */
void MM_RootScanner::scanWeakReferenceObjects(MM_EnvironmentBase* env) {}
 ...
 * thus reference objects created by NHRTs do not need to go on the list.
 */
void MM_RootScanner::scanSoftReferenceObjects(MM_EnvironmentBase* env) {}
 ...
 * thus reference objects created by NHRTs do not need to go on the list.
 */
void MM_RootScanner::scanPhantomReferenceObjects(MM_EnvironmentBase* env) {}
 ...
 */
void MM_RootScanner::scanUnfinalizedObjects(MM_EnvironmentBase* env)
{
...
void MM_RootScanner::scanOwnableSynchronizerObjects(MM_EnvironmentBase* env)
{
 ...
 */
void MM_RootScanner::scanMonitorLookupCaches(MM_EnvironmentBase* env)
{
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::scanMonitorReferences(MM_EnvironmentBase* env)
{
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::scanJNIWeakGlobalReferences(MM_EnvironmentBase* env)
{
    if (_singleThread || J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
        reportScanningStarted(RootScannerEntity_JNIWeakGlobalReferences);

        GC_JNIWeakGlobalReferenceIterator jniWeakGlobalReferenceIterator(
            static_cast<J9JavaVM*>(_omrVM->_language_vm)->jniWeakGlobalReferences);
        J9Object** slot;
 ...
 * @todo Provide function documentation
 */
void MM_RootScanner::scanRememberedSet(MM_EnvironmentBase* env)
{
    if (_singleThread || J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
 ...
 */
void MM_RootScanner::scanJVMTIObjectTagTables(MM_EnvironmentBase* env)
{
    if (_singleThread || J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
 ...
 */
void MM_RootScanner::scanRoots(MM_EnvironmentBase* env)
{
 ...
 * @note This includes all references to classes.
 */
void MM_RootScanner::scanClearable(MM_EnvironmentBase* env)
{
 ...
 */
void MM_RootScanner::scanAllSlots(MM_EnvironmentBase* env)
{
    if (!_nurseryReferencesOnly && !_nurseryReferencesPossibly) {
        scanClasses(env);
...
bool MM_RootScanner::shouldYieldFromClassScan(UDATA timeSlackNanoSec) { return false; }

bool MM_RootScanner::shouldYieldFromStringScan() { return false; }

bool MM_RootScanner::shouldYieldFromMonitorScan() { return false; }

bool MM_RootScanner::shouldYield() { return false; }

void MM_RootScanner::yield() {}

bool MM_RootScanner::condYield(U_64 timeSlackNanoSec)
{
