...
void MM_ScavengerForwardedHeader::validateAssumptions()
{
 ...
 */
omrobjectptr_t MM_ScavengerForwardedHeader::setForwardedObject(omrobjectptr_t destinationObjectPtr)
{
    ...
    if (MM_AtomicOperations::lockCompareExchange((volatile UDATA*)&objectHeader->clazz, oldValue, newValue)
        != oldValue) {
...
omrobjectptr_t MM_ScavengerForwardedHeader::setForwardedObjectGrowing(
    omrobjectptr_t destinationObjectPtr, bool isObjectGrowing)
{
...
bool MM_ScavengerForwardedHeader::didObjectGrowOnCopy()
{
