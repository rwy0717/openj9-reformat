...
public:
     ...
     */
    UDATA getTableIndex(UDATA hash) { return hash % _tableCount; }
    /**
     ...
     * @param tableIndex index of hash table into the array of sub-tables
     */
    void lockTable(UDATA tableIndex) { omrthread_monitor_enter(_mutex[tableIndex]); }

    /*
     * Unlock sub-table with provided index
     * @param tableIndex index of hash table into the array of sub-tables
     */
    void unlockTable(UDATA tableIndex) { omrthread_monitor_exit(_mutex[tableIndex]); }
