...
J9Object* j9gc_objaccess_mixedObjectReadObject(
    J9VMThread* vmThread, J9Object* srcObject, UDATA offset, UDATA isVolatile)
{
...
void j9gc_objaccess_mixedObjectStoreObject(
    J9VMThread* vmThread, J9Object* destObject, UDATA offset, J9Object* value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    barrier->mixedObjectStoreObject(vmThread, destObject, offset, value, 0 != isVolatile);
}

void* j9gc_objaccess_mixedObjectReadAddress(J9VMThread* vmThread, J9Object* srcObject, UDATA offset, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
void j9gc_objaccess_mixedObjectStoreAddress(
    J9VMThread* vmThread, J9Object* destObject, UDATA offset, void* value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
void j9gc_objaccess_mixedObjectStoreU32(
    J9VMThread* vmThread, J9Object* destObject, UDATA offset, U_32 value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
void j9gc_objaccess_mixedObjectStoreI32(
    J9VMThread* vmThread, J9Object* destObject, UDATA offset, I_32 value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    barrier->mixedObjectStoreI32(vmThread, destObject, offset, value, 0 != isVolatile);
}

U_64 j9gc_objaccess_mixedObjectReadU64(J9VMThread* vmThread, J9Object* srcObject, UDATA offset, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
void j9gc_objaccess_mixedObjectStoreU64(
    J9VMThread* vmThread, J9Object* destObject, UDATA offset, U_64 value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    barrier->mixedObjectStoreU64(vmThread, destObject, offset, value, 0 != isVolatile);
}

I_64 j9gc_objaccess_mixedObjectReadI64(J9VMThread* vmThread, J9Object* srcObject, UDATA offset, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
void j9gc_objaccess_mixedObjectStoreI64(
    J9VMThread* vmThread, J9Object* destObject, UDATA offset, I_64 value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    barrier->mixedObjectStoreI64(vmThread, destObject, offset, value, 0 != isVolatile);
}

void j9gc_objaccess_mixedObjectStoreU64Split(
    J9VMThread* vmThread, J9Object* destObject, UDATA delta, U_32 valueSlot0, U_32 valueSlot1, UDATA isVolatile)
{
    U_64 value64;
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
J9Object* j9gc_objaccess_indexableReadObject(
...
void j9gc_objaccess_indexableStoreObject(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 index, J9Object* value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
U_64 j9gc_objaccess_indexableReadU64(J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
I_64 j9gc_objaccess_indexableReadI64(J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
void j9gc_objaccess_indexableStoreU64Split(
    J9VMThread* vmThread, J9IndexableObject* destObject, I_32 index, U_32 valueSlot0, U_32 valueSlot1, UDATA isVolatile)
{
    U_64 value64;
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
J9Object* j9gc_objaccess_staticReadObject(J9VMThread* vmThread, J9Class* clazz, J9Object** srcSlot, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
void j9gc_objaccess_staticStoreObject(
    J9VMThread* vmThread, J9Class* clazz, J9Object** destSlot, J9Object* value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    barrier->staticStoreObject(vmThread, clazz, destSlot, value, 0 != isVolatile);
}

void* j9gc_objaccess_staticReadAddress(J9VMThread* vmThread, J9Class* clazz, void** srcSlot, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
void j9gc_objaccess_staticStoreU32(J9VMThread* vmThread, J9Class* clazz, U_32* destSlot, U_32 value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
void j9gc_objaccess_staticStoreI32(J9VMThread* vmThread, J9Class* clazz, I_32* destSlot, I_32 value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    barrier->staticStoreI32(vmThread, clazz, destSlot, value, 0 != isVolatile);
}

U_64 j9gc_objaccess_staticReadU64(J9VMThread* vmThread, J9Class* clazz, U_64* srcSlot, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    return barrier->staticReadU64(vmThread, clazz, srcSlot, 0 != isVolatile);
}

void j9gc_objaccess_staticStoreU64(J9VMThread* vmThread, J9Class* clazz, U_64* destSlot, U_64 value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    barrier->staticStoreU64(vmThread, clazz, destSlot, value, 0 != isVolatile);
}

I_64 j9gc_objaccess_staticReadI64(J9VMThread* vmThread, J9Class* clazz, I_64* srcSlot, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    return barrier->staticReadI64(vmThread, clazz, srcSlot, 0 != isVolatile);
}

void j9gc_objaccess_staticStoreI64(J9VMThread* vmThread, J9Class* clazz, I_64* destSlot, I_64 value, UDATA isVolatile)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    barrier->staticStoreI64(vmThread, clazz, destSlot, value, 0 != isVolatile);
}

void j9gc_objaccess_staticStoreU64Split(
 ...
 */
U_8* j9gc_objaccess_getArrayObjectDataAddress(J9VMThread* vmThread, J9IndexableObject* arrayObject)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    return barrier->getArrayObjectDataAddress(vmThread, arrayObject);
}

j9objectmonitor_t* j9gc_objaccess_getLockwordAddress(J9VMThread* vmThread, J9Object* object)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
 ...
 */
void j9gc_objaccess_storeObjectToInternalVMSlot(J9VMThread* vmThread, J9Object** destSlot, J9Object* value)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
 ...
 * waiting until we have a consistent story for NHRT barriers.
 */
J9Object* j9gc_objaccess_readObjectFromInternalVMSlot(J9VMThread* vmThread, J9Object** srcSlot)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
j9gc_objaccess_compareAndSwapObject(
    J9VMThread* vmThread, J9Object* destObject, J9Object** destAddress, J9Object* compareObject, J9Object* swapObject)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
UDATA
j9gc_objaccess_mixedObjectCompareAndSwapLongSplit(J9VMThread* vmThread, J9Object* destObject, UDATA offset,
    U_32 compareValueSlot0, U_32 compareValueSlot1, U_32 swapValueSlot0, U_32 swapValueSlot1)
{
...
UDATA
j9gc_objaccess_staticCompareAndSwapLongSplit(J9VMThread* vmThread, J9Class* destClass, U_64* destAddress,
    U_32 compareValueSlot0, U_32 compareValueSlot1, U_32 swapValueSlot0, U_32 swapValueSlot1)
{
    U_64 compareValue64 = 0;
    U_64 swapValue64 = 0;
...
j9object_t j9gc_objaccess_compareAndExchangeObject(
    J9VMThread* vmThread, J9Object* destObject, J9Object** destAddress, J9Object* compareObject, J9Object* swapObject)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    return barrier->compareAndExchangeObject(
        vmThread, destObject, (fj9object_t*)destAddress, compareObject, swapObject);
}

j9object_t j9gc_objaccess_staticCompareAndExchangeObject(
    J9VMThread* vmThread, J9Class* destClass, j9object_t* destAddress, J9Object* compareObject, J9Object* swapObject)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
 ...
 */
mm_j9object_t j9gc_objaccess_pointerFromToken(J9VMThread* vmThread, fj9object_t token)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
 ...
 */
fj9object_t j9gc_objaccess_tokenFromPointer(J9VMThread* vmThread, mm_j9object_t object)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
 ...
 */
void j9gc_objaccess_cloneObject(J9VMThread* vmThread, J9Object* srcObject, J9Object* destObject)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
 ...
 */
void j9gc_objaccess_copyObjectFields(J9VMThread* vmThread, J9Class* valueClass, J9Object* srcObject, UDATA srcOffset,
 ...
 */
j9object_t j9gc_objaccess_asConstantPoolObject(J9VMThread* vmThread, j9object_t toConvert, UDATA allocationFlags)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
...
void J9WriteBarrierStore(J9VMThread* vmThread, J9Object* dstObject, J9Object* srcObject)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread->javaVM)->accessBarrier;
    barrier->postObjectStore(vmThread, dstObject, (fj9object_t*)0, srcObject);
}

void J9WriteBarrierJ9ClassStore(J9VMThread* vmThread, J9Class* dstObject, J9Object* srcObject)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread->javaVM)->accessBarrier;
    barrier->postObjectStore(vmThread, dstObject, (J9Object**)0, srcObject);
}

void J9WriteBarrierBatchStore(J9VMThread* vmThread, J9Object* dstObject)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread->javaVM)->accessBarrier;
...
void J9WriteBarrierJ9ClassBatchStore(J9VMThread* vmThread, J9Class* dstJ9Class)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread->javaVM)->accessBarrier;
    /* In Metronome, write barriers are always pre-store */
...
void J9ReadBarrier(J9VMThread* vmThread, fj9object_t* srcAddress)
{
...
void J9ReadBarrierJ9Class(J9VMThread* vmThread, j9object_t* srcAddress)
{
#if defined(OMR_GC_CONCURRENT_SCAVENGER)
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread->javaVM)->accessBarrier;
    barrier->preObjectRead(vmThread, NULL, srcAddress);
...
j9object_t j9gc_objaccess_monitorTableReadObject(J9VMThread* vmThread, j9object_t* srcAddress)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread->javaVM)->accessBarrier;
...
j9object_t j9gc_objaccess_monitorTableReadObjectVM(J9JavaVM* vm, j9object_t* srcAddress)
{
...
void j9gc_objaccess_recentlyAllocatedObject(J9VMThread* vmThread, J9Object* dstObject)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    return barrier->recentlyAllocatedObject(vmThread, dstObject);
}

void j9gc_objaccess_postStoreClassToClassLoader(J9VMThread* vmThread, J9ClassLoader* destClassLoader, J9Class* srcClass)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread)->accessBarrier;
    return barrier->postStoreClassToClassLoader(vmThread, destClassLoader, srcClass);
}

I_32 j9gc_objaccess_getObjectHashCode(J9JavaVM* vm, J9Object* object)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vm)->accessBarrier;
    return barrier->getObjectHashCode(vm, object);
}

void* j9gc_objaccess_jniGetPrimitiveArrayCritical(J9VMThread* vmThread, jarray array, jboolean* isCopy)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread->javaVM)->accessBarrier;
    return barrier->jniGetPrimitiveArrayCritical(vmThread, array, isCopy);
}

void j9gc_objaccess_jniReleasePrimitiveArrayCritical(J9VMThread* vmThread, jarray array, void* elems, jint mode)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread->javaVM)->accessBarrier;
    barrier->jniReleasePrimitiveArrayCritical(vmThread, array, elems, mode);
}

const jchar* j9gc_objaccess_jniGetStringCritical(J9VMThread* vmThread, jstring str, jboolean* isCopy)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread->javaVM)->accessBarrier;
    return barrier->jniGetStringCritical(vmThread, str, isCopy);
}

void j9gc_objaccess_jniReleaseStringCritical(J9VMThread* vmThread, jstring str, const jchar* elems)
{
    MM_ObjectAccessBarrier* barrier = MM_GCExtensions::getExtensions(vmThread->javaVM)->accessBarrier;
