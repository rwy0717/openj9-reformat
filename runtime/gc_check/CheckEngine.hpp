...
private:
    ...
    J9Class*
        _checkedClassCache[CLASS_CACHE_SIZE]; /**< A cache of recently checked classes, guaranteed not to be undead */
    J9Class* _checkedClassCacheAllowUndead[CLASS_CACHE_SIZE]; /**< A cache of recently checked classes, including
                                                                 checked undead classes */
...
#define UNINITIALIZED_SIZE_FOR_OWNABLESYNCHRONIER ((UDATA)-1)
    UDATA _ownableSynchronizerObjectCountOnList; /**< the count of ownableSynchronizerObjects on the
                                                    ownableSynchronizerLists, =UNINITIALIZED_SIZE_FOR_OWNABLESYNCHRONIER
                                                    indicates that the count has not been calculated */
    UDATA _ownableSynchronizerObjectCountOnHeap; /**< the count of ownableSynchronizerObjects on the heap,
                                                    =UNINITIALIZED_SIZE_FOR_OWNABLESYNCHRONIER indicates that the count
...
public:
    ...
    UDATA checkObjectHeap(
        J9JavaVM* javaVM, J9MM_IterateObjectDescriptor* objectDesc, J9MM_IterateRegionDescriptor* regionDesc);
    UDATA checkSlotObjectHeap(J9JavaVM* javaVM, J9Object* objectPtr, fj9object_t* objectIndirect,
        J9MM_IterateRegionDescriptor* regionDesc, J9Object* objectIndirectBase);
    UDATA checkSlotVMThread(J9JavaVM* javaVM, J9Object** objectIndirect, void* objectIndirectBase, UDATA objectType,
        GC_VMThreadIterator* vmthreadIterator);
     ...
     */
    UDATA checkSlotOwnableSynchronizerList(
