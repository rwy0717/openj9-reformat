...
private:
    void initialize(void* object, void* slot, const void* stackLocation, GC_CheckCycle* cycle, GC_Check* check,
        const char* elementName, UDATA errorCode, UDATA errorNumber, UDATA objectType)
    {
        _object = object;
        _slot = slot;
    ...
    void initialize(void* object, void* slot, GC_CheckCycle* cycle, GC_Check* check, const char* elementName,
        UDATA errorCode, UDATA errorNumber, UDATA objectType)
    {
        initialize(object, slot, NULL, cycle, check, elementName, errorCode, errorNumber, objectType);
    }

    void initialize(void* object, void* slot, GC_CheckCycle* cycle, GC_Check* check, UDATA errorCode, UDATA errorNumber,
        UDATA objectType)
    {
    ...
    void initialize(void* object, GC_CheckCycle* cycle, GC_Check* check, const char* elementName, UDATA errorCode,
        UDATA errorNumber, UDATA objectType)
    {
        initialize(object, NULL, NULL, cycle, check, elementName, errorCode, errorNumber, objectType);
    }

    void initialize(
        void* object, GC_CheckCycle* cycle, GC_Check* check, UDATA errorCode, UDATA errorNumber, UDATA objectType)
    {
...
public:
     ...
     */
    GC_CheckError(void* object, void* slot, GC_CheckCycle* cycle, GC_Check* check, const char* elementName,
        UDATA errorCode, UDATA errorNumber, UDATA objectType)
    {
     ...
     */
    GC_CheckError(void* object, void* slot, GC_CheckCycle* cycle, GC_Check* check, UDATA errorCode, UDATA errorNumber,
        UDATA objectType)
    {
     ...
     */
    GC_CheckError(void* object, GC_CheckCycle* cycle, GC_Check* check, const char* elementName, UDATA errorCode,
        UDATA errorNumber, UDATA objectType)
    {
     ...
     */
    GC_CheckError(J9Class* object, void* slot, GC_CheckCycle* cycle, GC_Check* check, const char* elementName,
        UDATA errorCode, UDATA errorNumber)
    {
     ...
     */
    GC_CheckError(
        J9Class* object, void* slot, GC_CheckCycle* cycle, GC_Check* check, UDATA errorCode, UDATA errorNumber)
    {
     ...
     * an object directly on the heap (not through a slot).
     */
    GC_CheckError(J9Class* object, GC_CheckCycle* cycle, GC_Check* check, const char* elementName, UDATA errorCode,
        UDATA errorNumber)
    {
     ...
     * Create a new CheckError object, with a blank elementName.
     */
    GC_CheckError(J9VMThread* object, J9Object** slot, const void* stackLocation, GC_CheckCycle* cycle, GC_Check* check,
        UDATA errorCode, UDATA errorNumber)
    {
     ...
     */
    GC_CheckError(J9Object* object, fj9object_t* slot, GC_CheckCycle* cycle, GC_Check* check, const char* elementName,
        UDATA errorCode, UDATA errorNumber)
    {
     ...
     */
    GC_CheckError(
        J9Object* object, fj9object_t* slot, GC_CheckCycle* cycle, GC_Check* check, UDATA errorCode, UDATA errorNumber)
    {
     ...
     * an object directly on the heap (not through a slot).
     */
    GC_CheckError(J9Object* object, GC_CheckCycle* cycle, GC_Check* check, const char* elementName, UDATA errorCode,
        UDATA errorNumber)
    {
     ...
     */
    GC_CheckError(MM_SublistPuddle* object, J9Object** slot, GC_CheckCycle* cycle, GC_Check* check,
        const char* elementName, UDATA errorCode, UDATA errorNumber)
    {
     ...
     * Create a new CheckError object, with a blank elementName.
     */
    GC_CheckError(MM_SublistPuddle* object, J9Object** slot, GC_CheckCycle* cycle, GC_Check* check, UDATA errorCode,
        UDATA errorNumber)
    {
     ...
     * an object directly on the heap (not through a slot).
     */
    GC_CheckError(MM_SublistPuddle* object, GC_CheckCycle* cycle, GC_Check* check, const char* elementName,
        UDATA errorCode, UDATA errorNumber)
    {
     ...
     * Create a new CheckError object, with a blank elementName.
     */
    GC_CheckError(MM_UnfinalizedObjectList* object, J9Object** slot, GC_CheckCycle* cycle, GC_Check* check,
        UDATA errorCode, UDATA errorNumber)
    {
     ...
     * Create a new CheckError object, with a blank elementName.
     */
    GC_CheckError(GC_FinalizeListManager* object, J9Object** slot, GC_CheckCycle* cycle, GC_Check* check,
        UDATA errorCode, UDATA errorNumber)
    {
     ...
     * Create a new CheckError object, with a blank elementName.
     */
    GC_CheckError(MM_OwnableSynchronizerObjectList* object, J9Object** slot, GC_CheckCycle* cycle, GC_Check* check,
        UDATA errorCode, UDATA errorNumber)
    {
