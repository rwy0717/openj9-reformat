...
protected:
    ...
    MMINLINE UDATA getSpineSizeWithoutHeader(ArrayLayout layout, UDATA numberArraylets, UDATA dataSize, bool alignData)
    {
...
public:
    /* forward declare methods from parent class to avoid namespace issues */
    MMINLINE UDATA arrayletSize(J9IndexableObject* objPtr, UDATA index, UDATA dataSizeInBytes, UDATA numberOfArraylets)
    {
        return GC_ArrayletObjectModelBase::arrayletSize(objPtr, index, dataSizeInBytes, numberOfArraylets);
    }
    MMINLINE UDATA numArraylets(UDATA unadjustedDataSizeInBytes)
    {
     ...
     */
    MMINLINE UDATA getSpineSize(J9IndexableObject* objPtr)
    {
     ...
     */
    MMINLINE UDATA getSpineSize(
        J9Class* clazzPtr, ArrayLayout layout, UDATA numberArraylets, UDATA dataSize, bool alignData)
    {
        UDATA result
            = getHeaderSize(clazzPtr, layout) + getSpineSizeWithoutHeader(layout, numberArraylets, dataSize, alignData);
        return result;
    }
     ...
     */
    MMINLINE UDATA numArraylets(J9IndexableObject* objPtr) { return numArraylets(getDataSizeInBytes(objPtr)); }
     ...
     */
    MMINLINE bool isInlineContiguousArraylet(J9IndexableObject* objPtr)
    {
     ...
     */
    MMINLINE UDATA numExternalArraylets(J9IndexableObject* objPtr)
    {
        ArrayLayout layout = getArrayLayout(objPtr);
     ...
     */
    MMINLINE UDATA externalArrayletsSize(J9IndexableObject* objPtr)
    {
     ...
     */
    MMINLINE bool hasArrayletLeafPointers(J9IndexableObject* objPtr)
    {
     ...
     */
    MMINLINE UDATA arrayletSize(J9IndexableObject* objPtr, UDATA index)
    {
     ...
     * 			includes header, arraylet ptrs, and (if present) padding & inline data
     */
    MMINLINE UDATA getSpineSize(J9IndexableObject* objPtr, ArrayLayout layout)
    {
     ...
     * 			includes header, arraylet ptrs, and (if present) padding & inline data
     */
    MMINLINE UDATA getSpineSize(J9Class* clazzPtr, ArrayLayout layout, UDATA size)
    {
     ...
     */
    MMINLINE UDATA getSpineSizeWithoutHeader(J9Class* clazzPtr, ArrayLayout layout, UDATA size)
    {
     ...
     */
    MMINLINE void copyInWords(UDATA* destAddr, UDATA* sourceAddr, UDATA lengthInBytes)
    {
     ...
     */
    MMINLINE UDATA getHeaderSize(J9Class* clazzPtr, ArrayLayout layout)
    {
#if defined(J9VM_GC_HYBRID_ARRAYLETS)
     ...
     */
    MMINLINE UDATA getDataSizeInBytes(J9IndexableObject* arrayPtr)
    {
     ...
     * @return Aligned size in bytes excluding the header, or UDATA_MAX if an overflow occurs
     */
    MMINLINE UDATA getDataSizeInBytes(J9Class* clazzPtr, UDATA numberOfElements)
    {
     ...
     */
    MMINLINE ArrayLayout getArrayLayout(J9IndexableObject* objPtr)
    {
    ...
    MMINLINE ArrayLayout getArrayletLayout(J9Class* clazz, UDATA dataSizeInBytes)
    {
        return getArrayletLayout(clazz, dataSizeInBytes, _largestDesirableArraySpineSize);
    }

    /**
     * Get the layout of an indexable object given it's class, data size in bytes and the subspace's
     * largestDesirableSpine.
     ...
     */
    MMINLINE void memcpyArray(J9IndexableObject* destObject, J9IndexableObject* srcObject)
    {
#if defined(J9VM_GC_HYBRID_ARRAYLETS)
     ...
     */
    /*MMINLINE*/ void memcpyFromArray(
        void* destData, J9IndexableObject* srcObject, I_32 elementIndex, I_32 elementCount)
    {
     ...
     */
    MMINLINE void memcpyToArray(J9IndexableObject* destObject, I_32 elementIndex, I_32 elementCount, void* srcData)
    {
     ...
     */
    MMINLINE UDATA getSizeInBytesWithoutHeader(J9IndexableObject* arrayPtr)
    {
     ...
     */
    MMINLINE UDATA getSizeInBytesWithHeader(J9Class* clazz, UDATA numberOfElements)
    {
     ...
     * @return Size of object in bytes including the header
     */
    MMINLINE UDATA getSizeInBytesWithHeader(J9Class* clazz, ArrayLayout layout, UDATA numberOfElements)
    {
     ...
     * @return Size of object in bytes including the header
     */
    MMINLINE UDATA getSizeInBytesWithHeader(J9IndexableObject* arrayPtr)
    {
        ArrayLayout layout = getArrayLayout(arrayPtr);
     ...
     * @return Size of header in bytes
     */
    MMINLINE UDATA getHeaderSize(J9IndexableObject* arrayPtr)
    {
#if defined(J9VM_GC_HYBRID_ARRAYLETS)
     ...
     * @return Arrayoid ptr
     */
    MMINLINE fj9object_t* getArrayoidPointer(J9IndexableObject* arrayPtr)
    {
     ...
     */
    MMINLINE void* getDataPointerForContiguous(J9IndexableObject* arrayPtr)
    {
#if defined(J9VM_GC_HYBRID_ARRAYLETS)
     ...
     */
    MMINLINE UDATA getHashcodeOffset(J9Class* clazzPtr, UDATA numberOfElements)
    {
        ArrayLayout layout = InlineContiguous;
#if defined(J9VM_GC_HYBRID_ARRAYLETS)
        if (0 == numberOfElements) {
     ...
     * @return offset of the hashcode slot
     */
    MMINLINE UDATA getHashcodeOffset(J9Class* clazzPtr, ArrayLayout layout, UDATA numberOfElements)
    {
     ...
     * @return offset of the hashcode slot
     */
    MMINLINE UDATA getHashcodeOffset(J9IndexableObject* arrayPtr)
    {
        ArrayLayout layout = getArrayLayout(arrayPtr);
    ...
    {
        GC_ArrayletObjectModelBase::expandArrayletSubSpaceRange(
            subSpace, rangeBase, rangeTop, largestDesirableArraySpineSize);
    }
