...
protected:
    ...
    volatile bool _scavenger_shouldScavengeFinalizableObjects; /**< Set to true at the beginning of a collection if
                                                                  there are any pending finalizable objects */
    volatile bool _scavenger_shouldScavengeUnfinalizedObjects; /**< Set to true at the beginning of a collection if
                                                                  there are any unfinalized objects */
    volatile bool _scavenger_shouldScavengeSoftReferenceObjects; /**< Set to true if there are any SoftReference objects
                                                                    discovered */
    volatile bool _scavenger_shouldScavengeWeakReferenceObjects; /**< Set to true if there are any WeakReference objects
                                                                    discovered */
    volatile bool _scavenger_shouldScavengePhantomReferenceObjects; /**< Set to true if there are any PhantomReference
                                                                       objects discovered */
...
public:
    ...
    static MM_CollectorLanguageInterfaceImpl* getInterface(MM_CollectorLanguageInterface* cli)
    {
        return (MM_CollectorLanguageInterfaceImpl*)cli;
    }
    ...
    virtual bool scavenger_internalGarbageCollect_shouldPercolateGarbageCollect(
        MM_EnvironmentBase* envBase, PercolateReason* reason, U_32* gcCode);
    ...
    void scavenger_setShouldScavengeUnfinalizedObjects(bool shouldScavenge)
    {
        _scavenger_shouldScavengeUnfinalizedObjects = shouldScavenge;
    }

    volatile bool scavenger_getShouldScavengeFinalizableObjects()
    {
        return _scavenger_shouldScavengeFinalizableObjects;
    }
    volatile bool scavenger_getShouldScavengeUnfinalizedObjects()
    {
        return _scavenger_shouldScavengeUnfinalizedObjects;
    }
    volatile bool scavenger_getShouldScavengeSoftReferenceObjects()
    {
        return _scavenger_shouldScavengeSoftReferenceObjects;
    }
    volatile bool scavenger_getShouldScavengeWeakReferenceObjects()
    {
        return _scavenger_shouldScavengeWeakReferenceObjects;
    }
    volatile bool scavenger_getShouldScavengePhantomReferenceObjects()
    {
        return _scavenger_shouldScavengePhantomReferenceObjects;
    }
