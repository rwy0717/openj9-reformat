...
void MM_CompactSchemeFixupRoots::fixupFinalizableObjects(MM_EnvironmentBase* env)
{
...
void MM_CompactSchemeFixupRoots::fixupUnfinalizedObjects(MM_EnvironmentBase* env)
{
    MM_GCExtensions* extensions = MM_GCExtensions::getExtensions(env);
