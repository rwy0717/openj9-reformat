...
public:
                ...
                for (UDATA i = 0; i < regionExtension->_maxListIndex; i++) {
                    ...
                    if (!list->wasEmpty()) {
                        ...
                        while (NULL != object) {
                            ...
                            /* the last object in the list pointing itself, after the object moved, the link still
                             * points to old object address */
                            if (object != next) {
                                object = next;
                            } else {
    ...
    void doFinalizableObject(J9Object* objectPtr) { Assert_MM_unreachable(); }
