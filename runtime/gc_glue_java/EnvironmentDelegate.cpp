 ...
 */
bool MM_EnvironmentDelegate::initialize(MM_EnvironmentBase* env)
{
    _env = env;
    ...
    if ((NULL == _gcEnv._referenceObjectBuffer) || (NULL == _gcEnv._unfinalizedObjectBuffer)
 ...
 */
void MM_EnvironmentDelegate::tearDown()
{
...
void MM_EnvironmentDelegate::detachVMThread(OMR_VM* omrVM, OMR_VMThread* omrThread, uintptr_t reason)
{
    J9JavaVM* javaVM = (J9JavaVM*)omrVM->_language_vm;
...
void MM_EnvironmentDelegate::flushNonAllocationCaches()
{
#if defined(J9VM_GC_GENERATIONAL)
    if (_env->getExtensions()->isStandardGC()) {
        MM_SublistFragment::flush(
            (J9VMGC_SublistFragment*)&((J9VMThread*)_env->getLanguageVMThread())->gcRememberedSet);
    }
...
void MM_EnvironmentDelegate::setGCMasterThread(bool isMasterThread)
{
...
void MM_EnvironmentDelegate::releaseCriticalHeapAccess(uintptr_t* data)
{
    J9VMThread* vmThread = (J9VMThread*)_env->getOmrVMThread()->_language_vmthread;
...
void MM_EnvironmentDelegate::reacquireCriticalHeapAccess(uintptr_t data)
{
    J9VMThread* vmThread = (J9VMThread*)_env->getOmrVMThread()->_language_vmthread;
...
void MM_EnvironmentDelegate::forceOutOfLineVMAccess()
{
 ...
 *
 */
void MM_EnvironmentDelegate::disableInlineTLHAllocate()
{
    J9VMThread* vmThread = (J9VMThread*)_env->getOmrVMThread()->_language_vmthread;
 ...
 */
void MM_EnvironmentDelegate::enableInlineTLHAllocate()
{
    J9VMThread* vmThread = (J9VMThread*)_env->getOmrVMThread()->_language_vmthread;
    J9ModronThreadLocalHeap* tlh = (J9ModronThreadLocalHeap*)&vmThread->allocateThreadLocalHeap;
 ...
 */
bool MM_EnvironmentDelegate::isInlineTLHAllocateEnabled()
{
    J9VMThread* vmThread = (J9VMThread*)_env->getOmrVMThread()->_language_vmthread;
    J9ModronThreadLocalHeap* tlh = (J9ModronThreadLocalHeap*)&vmThread->allocateThreadLocalHeap;
