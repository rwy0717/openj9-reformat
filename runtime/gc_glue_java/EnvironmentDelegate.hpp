...
public:
    ...
    MM_ReferenceObjectBuffer*
        _referenceObjectBuffer; /**< The thread-specific buffer of recently discovered reference objects */
    MM_UnfinalizedObjectBuffer*
        _unfinalizedObjectBuffer; /**< The thread-specific buffer of recently allocated unfinalized objects */
    MM_OwnableSynchronizerObjectBuffer* _ownableSynchronizerObjectBuffer; /**< The thread-specific buffer of recently
                                                                             allocated ownable synchronizer objects */
...
public:
     ...
     * You are however guaranteed by the start of the next gc, you will be notified for all objects allocated since the
     * last gc. hooktool is actually functionality better for this but is probably too heavy-weight for what we want for
     * performant code.
     */
