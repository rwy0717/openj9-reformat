...
private:
    ...
    volatile bool _anotherClassMarkLoopIteration; /**< Used in completeClassMark for another loop iteration request (set
...
public:
        ...
        MM_MarkingSchemeScanReason reason, uintptr_t* sizeToDo)
    {
        ...
        case GC_ObjectModel::SCAN_POINTER_ARRAY_OBJECT: {
            ...
            objectScanner = GC_PointerArrayObjectScanner::newInstance(
                env, objectPtr, scannerSpace, GC_ObjectScanner::indexableObject, slotsToDo, startIndex);
            break;
        }
     ...
     */
    MMINLINE bool shouldScanUnfinalizedObjects() { return _shouldScanUnfinalizedObjects; }

    MMINLINE void shouldScanUnfinalizedObjects(bool shouldScanUnfinalizedObjects)
    {
        _shouldScanUnfinalizedObjects = shouldScanUnfinalizedObjects;
    }

    MMINLINE bool shouldScanOwnableSynchronizerObjects() { return _shouldScanOwnableSynchronizerObjects; }

    MMINLINE void shouldScanOwnableSynchronizerObjects(bool shouldScanOwnableSynchronizerObjects)
    {
    ...
    void processReferenceList(MM_EnvironmentBase* env, MM_HeapRegionDescriptorStandard* region,
