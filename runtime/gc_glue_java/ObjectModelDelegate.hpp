...
public:
     ...
     */
    MMINLINE void setArrayObjectModel(GC_ArrayObjectModel* arrayObjectModel) { _arrayObjectModel = arrayObjectModel; }

    /**
     * Get the array object model.
     */
    MMINLINE GC_ArrayObjectModel* getArrayObjectModel() { return _arrayObjectModel; }

    /**
     * Set the array object model.
     */
    MMINLINE void setMixedObjectModel(GC_MixedObjectModel* mixedObjectModel) { _mixedObjectModel = mixedObjectModel; }

    /**
     * Get the array object model.
     */
    MMINLINE GC_MixedObjectModel* getMixedObjectModel() { return _mixedObjectModel; }
     ...
     * @return the exact size of an object, in bytes, excluding padding bytes and header bytes
     */
    MMINLINE uintptr_t getObjectSizeInBytesWithHeader(omrobjectptr_t objectPtr, bool includeHashCode)
    {
        uintptr_t dataSize = 0;
    ...
    {
        uintptr_t flags
            = ((*((fomrobject_t*)objectPtr)) >> getObjectHeaderSlotFlagsShift()) & _delegateHeaderSlotFlagsMask;
    ...
    {
        J9Class* clazz
            = (J9Class*)((uintptr_t)(forwardedHeader->getPreservedSlot()) & ~(UDATA)_delegateHeaderSlotFlagsMask);
        return J9GC_CLASS_IS_ARRAY(clazz);
    }
