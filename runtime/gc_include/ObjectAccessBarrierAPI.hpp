...
public:
    ...
    static VMINLINE void internalPostBatchStoreObjectCardTableAndGenerational(J9VMThread* vmThread, j9object_t object)
    {
        /* Check to see if object is old.  If object is not old neither barrier is required
         * if ((object - vmThread->omrVMThread->heapBaseForBarrierRange0) <
         * vmThread->omrVMThread->heapSizeForBarrierRange0) then old
         *
    ...
    static VMINLINE void internalPostBatchStoreObjectGenerational(J9VMThread* vmThread, j9object_t object)
    {
        /* Check to see if object is old.  If object is not old neither barrier is required
         * if ((object - vmThread->omrVMThread->heapBaseForBarrierRange0) <
         * vmThread->omrVMThread->heapSizeForBarrierRange0) then old
    ...
    static VMINLINE void internalPostBatchStoreObjectCardTableIncremental(J9VMThread* vmThread, j9object_t object)
    {
        /* Check to see if object is within the barrier range.
         * if ((object - vmThread->omrVMThread->heapBaseForBarrierRange0) <
         * vmThread->omrVMThread->heapSizeForBarrierRange0)
         *
         * Since card dirtying also requires this calculation remember these values
         */
        UDATA base = (UDATA)vmThread->omrVMThread->heapBaseForBarrierRange0;
    ...
    static VMINLINE void internalPostBatchStoreObjectCardTable(J9VMThread* vmThread, j9object_t object)
    {
        /* Check to see if object is old.  If object is not old neither barrier is required
         * if ((object - vmThread->omrVMThread->heapBaseForBarrierRange0) <
         * vmThread->omrVMThread->heapSizeForBarrierRange0) then old
     ...
     *
     */
    static VMINLINE void internalPostObjectStoreCardTableAndGenerational(
        J9VMThread* vmThread, j9object_t object, j9object_t value)
    {
     ...
     *
     */
    static VMINLINE void internalPostObjectStoreCardTable(J9VMThread* vmThread, j9object_t object, j9object_t value)
    {
        /* if value is NULL neither barrier is required */
        if (NULL != value) {
     ...
     *
     */
    static VMINLINE void internalPostObjectStoreCardTableIncremental(
        J9VMThread* vmThread, j9object_t object, j9object_t value)
    {
        /* if value is NULL neither barrier is required */
        if (NULL != value) {
     ...
     *
     */
    static VMINLINE void internalPostObjectStoreGenerational(J9VMThread* vmThread, j9object_t object, j9object_t value)
    {
        /* if value is NULL neither barrier is required */
        if (NULL != value) {
            /* Check to see if object is old.
     ...
     *
     */
    static VMINLINE void internalPostObjectStoreGenerationalNoValueCheck(J9VMThread* vmThread, j9object_t object)
    {
        /* Check to see if object is old.
         * if ((object - vmThread->omrVMThread->heapBaseForBarrierRange0) <
         * vmThread->omrVMThread->heapSizeForBarrierRange0) then old
     ...
     */
    VMINLINE j9objectmonitor_t* getLockwordAddress(J9Object* object)
    {
    ...
    VMINLINE void cloneArray(
        J9VMThread* currentThread, j9object_t original, j9object_t copy, J9Class* objectClass, U_32 size)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        currentThread->javaVM->memoryManagerFunctions->j9gc_objaccess_cloneIndexableObject(
            currentThread, (J9IndexableObject*)original, (J9IndexableObject*)copy);
        ...
        if (OBJECT_HEADER_SHAPE_POINTERS == J9CLASS_SHAPE(objectClass)) {
            ...
            VM_ArrayCopyHelpers::primitiveArrayCopy(currentThread, original, 0, copy, 0, size,
                (((J9ROMArrayClass*)objectClass->romClass)->arrayShape & 0x0000FFFF));
        }
#if defined(J9VM_THR_LOCK_NURSERY)
        if (copyLockword) {
    ...
    VMINLINE UDATA mixedObjectGetHeaderSize() { return sizeof(J9Object); }

    VMINLINE UDATA mixedObjectGetDataSize(J9Class* objectClass, bool dontIncludeLockword)
    {
    ...
    VMINLINE void cloneObject(J9VMThread* currentThread, j9object_t original, j9object_t copy, J9Class* objectClass)
    {
        copyObjectFields(
            currentThread, objectClass, original, mixedObjectGetHeaderSize(), copy, mixedObjectGetHeaderSize());
    }
     ...
     */
    VMINLINE void copyObjectFields(J9VMThread* vmThread, J9Class* objectClass, j9object_t srcObject, UDATA srcOffset,
        j9object_t destObject, UDATA destOffset)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_copyObjectFields(
            vmThread, objectClass, srcObject, srcOffset, destObject, destOffset);
#else /* defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER) */
        if (j9gc_modron_readbar_none != _readBarrierType) {
            ...
            while (offset < limit) {
                *(fj9object_t*)((UDATA)destObject + offset + destOffset)
                    = *(fj9object_t*)((UDATA)srcObject + offset + srcOffset);
     ...
     */
    VMINLINE j9object_t inlineMixedObjectReadObject(
        J9VMThread* vmThread, j9object_t srcObject, UDATA srcOffset, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectReadObject(
            vmThread, srcObject, srcOffset, isVolatile);
...
#error unsupported barrier
     ...
     */
    VMINLINE void inlineMixedObjectStoreObject(
        J9VMThread* vmThread, j9object_t srcObject, UDATA srcOffset, j9object_t value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectStoreObject(
            vmThread, srcObject, srcOffset, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     */
    VMINLINE bool inlineMixedObjectCompareAndSwapObject(J9VMThread* vmThread, j9object_t destObject, UDATA destOffset,
...
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (1
            == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_compareAndSwapObject(
                   vmThread, destObject, (J9Object**)destAddress, compareObject, swapObject));
#elif defined(J9VM_GC_COMBINATION_SPEC)
        if (j9gc_modron_wrtbar_always == _writeBarrierType) {
            return (1
                == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_compareAndSwapObject(
...
#error unsupported barrier
     ...
     */
    VMINLINE j9object_t inlineMixedObjectCompareAndExchangeObject(J9VMThread* vmThread, j9object_t destObject,
        UDATA destOffset, j9object_t compareObject, j9object_t swapObject, bool isVolatile = false)
    {
        fj9object_t* destAddress = J9OAB_MIXEDOBJECT_EA(destObject, destOffset, fj9object_t);

#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_compareAndExchangeObject(
            vmThread, destObject, (J9Object**)destAddress, compareObject, swapObject);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        if (j9gc_modron_wrtbar_always == _writeBarrierType) {
            return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_compareAndExchangeObject(
            ...
            protectIfVolatileBefore(isVolatile, false);
            fj9object_t resultToken
                = compareAndExchangeObjectImpl(vmThread, destAddress, compareObject, swapObject, isVolatile);
            protectIfVolatileAfter(isVolatile, false);
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile.
     */
    VMINLINE I_32 inlineMixedObjectReadI32(
        J9VMThread* vmThread, j9object_t srcObject, UDATA srcOffset, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (I_32)vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectReadI32(
            vmThread, srcObject, srcOffset, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void inlineMixedObjectStoreI32(
        J9VMThread* vmThread, j9object_t srcObject, UDATA srcOffset, I_32 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectStoreI32(
            vmThread, srcObject, srcOffset, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        I_32* actualAddress = J9OAB_MIXEDOBJECT_EA(srcObject, srcOffset, I_32);
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile.
     */
    VMINLINE U_32 inlineMixedObjectReadU32(
        J9VMThread* vmThread, j9object_t srcObject, UDATA srcOffset, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (U_32)vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectReadU32(
            vmThread, srcObject, srcOffset, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void inlineMixedObjectStoreU32(
        J9VMThread* vmThread, j9object_t srcObject, UDATA srcOffset, U_32 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectStoreU32(
            vmThread, srcObject, srcOffset, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        U_32* actualAddress = J9OAB_MIXEDOBJECT_EA(srcObject, srcOffset, U_32);
...
#error unsupported barrier
     ...
     * @return true on success, false otherwise
     */
    VMINLINE bool inlineMixedObjectCompareAndSwapU32(J9VMThread* vmThread, j9object_t destObject, UDATA destOffset,
        U_32 compareValue, U_32 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (1
            == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectCompareAndSwapInt(
                   vmThread, destObject, destOffset, compareValue, swapValue));
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     */
    VMINLINE U_32 inlineMixedObjectCompareAndExchangeU32(J9VMThread* vmThread, j9object_t destObject, UDATA destOffset,
        U_32 compareValue, U_32 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectCompareAndExchangeInt(
            vmThread, destObject, destOffset, compareValue, swapValue);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        U_32* actualAddress = J9OAB_MIXEDOBJECT_EA(destObject, destOffset, U_32);
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile.
     */
    VMINLINE I_64 inlineMixedObjectReadI64(
        J9VMThread* vmThread, j9object_t srcObject, UDATA srcOffset, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectReadI64(
            vmThread, srcObject, srcOffset, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void inlineMixedObjectStoreI64(
        J9VMThread* vmThread, j9object_t srcObject, UDATA srcOffset, I_64 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectStoreI64(
            vmThread, srcObject, srcOffset, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        I_64* actualAddress = J9OAB_MIXEDOBJECT_EA(srcObject, srcOffset, I_64);
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile.
     */
    VMINLINE U_64 inlineMixedObjectReadU64(
        J9VMThread* vmThread, j9object_t srcObject, UDATA srcOffset, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectReadU64(
            vmThread, srcObject, srcOffset, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void inlineMixedObjectStoreU64(
        J9VMThread* vmThread, j9object_t srcObject, UDATA srcOffset, U_64 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectStoreU64(
            vmThread, srcObject, srcOffset, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        U_64* actualAddress = J9OAB_MIXEDOBJECT_EA(srcObject, srcOffset, U_64);
...
#error unsupported barrier
     ...
     * @return true on success, false otherwise
     */
    VMINLINE bool inlineMixedObjectCompareAndSwapU64(J9VMThread* vmThread, j9object_t destObject, UDATA destOffset,
        U_64 compareValue, U_64 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (1
            == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectCompareAndSwapLong(
                   vmThread, destObject, destOffset, compareValue, swapValue));
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @return the value stored in the object field before the update
     */
    VMINLINE U_64 inlineMixedObjectCompareAndExchangeU64(J9VMThread* vmThread, j9object_t destObject, UDATA destOffset,
        U_64 compareValue, U_64 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_mixedObjectCompareAndExchangeLong(
            vmThread, destObject, destOffset, compareValue, swapValue);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        U_64* actualAddress = J9OAB_MIXEDOBJECT_EA(destObject, destOffset, U_64);
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile.
     */
    VMINLINE j9object_t inlineStaticReadObject(
        J9VMThread* vmThread, J9Class* clazz, j9object_t* srcAddress, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticReadObject(
            vmThread, clazz, srcAddress, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void inlineStaticStoreObject(
        J9VMThread* vmThread, J9Class* clazz, j9object_t* srcAddress, j9object_t value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticStoreObject(
            vmThread, clazz, srcAddress, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        if (j9gc_modron_wrtbar_always == _writeBarrierType) {
            vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticStoreObject(
                vmThread, clazz, srcAddress, value, isVolatile);
...
#error unsupported barrier
     ...
     * @return true on success, false otherwise
     */
    VMINLINE bool inlineStaticCompareAndSwapObject(J9VMThread* vmThread, J9Class* clazz, j9object_t* destAddress,
        j9object_t compareObject, j9object_t swapObject, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (1
            == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticCompareAndSwapObject(
                   vmThread, clazz, destAddress, compareObject, swapObject));
#elif defined(J9VM_GC_COMBINATION_SPEC)
        if (j9gc_modron_wrtbar_always == _writeBarrierType) {
            return (1
                == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticCompareAndSwapObject(
...
#error unsupported barrier
     ...
     */
    VMINLINE j9object_t inlineStaticCompareAndExchangeObject(J9VMThread* vmThread, J9Class* clazz,
        j9object_t* destAddress, j9object_t compareObject, j9object_t swapObject, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticCompareAndExchangeObject(
            vmThread, clazz, destAddress, compareObject, swapObject);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        if (j9gc_modron_wrtbar_always == _writeBarrierType) {
            return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticCompareAndExchangeObject(
            ...
            protectIfVolatileBefore(isVolatile, false);
            j9object_t result
                = staticCompareAndExchangeObjectImpl(vmThread, destAddress, compareObject, swapObject, isVolatile);
            protectIfVolatileAfter(isVolatile, false);
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile.
     */
    VMINLINE U_32 inlineStaticReadU32(J9VMThread* vmThread, J9Class* clazz, U_32* srcAddress, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (U_32)vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticReadU32(
            vmThread, clazz, srcAddress, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void inlineStaticStoreU32(
        J9VMThread* vmThread, J9Class* clazz, U_32* srcAddress, U_32 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticStoreU32(
            vmThread, clazz, srcAddress, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @return true on success, false otherwise
     */
    VMINLINE bool inlineStaticCompareAndSwapU32(J9VMThread* vmThread, J9Class* clazz, U_32* destAddress,
        U_32 compareValue, U_32 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (1
            == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticCompareAndSwapInt(
                   vmThread, clazz, destAddress, compareValue, swapValue));
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     */
    VMINLINE U_32 inlineStaticCompareAndExchangeU32(J9VMThread* vmThread, J9Class* clazz, U_32* destAddress,
        U_32 compareValue, U_32 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticCompareAndExchangeInt(
            vmThread, clazz, destAddress, compareValue, swapValue);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile.
     */
    VMINLINE U_64 inlineStaticReadU64(J9VMThread* vmThread, J9Class* clazz, U_64* srcAddress, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticReadU64(
            vmThread, clazz, srcAddress, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void inlineStaticStoreU64(
        J9VMThread* vmThread, J9Class* clazz, U_64* srcAddress, U_64 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticStoreU64(
            vmThread, clazz, srcAddress, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @return true on success, false otherwise
     */
    VMINLINE bool inlineStaticCompareAndSwapU64(J9VMThread* vmThread, J9Class* clazz, U_64* destAddress,
        U_64 compareValue, U_64 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (1
            == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticCompareAndSwapLong(
                   vmThread, clazz, destAddress, compareValue, swapValue));
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @return the value stored in the static field before the update
     */
    VMINLINE U_64 inlineStaticCompareAndExchangeU64(J9VMThread* vmThread, J9Class* clazz, U_64* destAddress,
        U_64 compareValue, U_64 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (1
            == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_staticCompareAndExchangeLong(
                   vmThread, clazz, destAddress, compareValue, swapValue));
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     */
    VMINLINE I_8 inlineIndexableObjectReadI8(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (I_8)vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableReadI8(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     */
    VMINLINE void inlineIndexableObjectStoreI8(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, I_8 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableStoreI8(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, (I_32)value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        I_8* actualAddress = J9JAVAARRAY_EA(vmThread, srcArray, srcIndex, I_8);
...
#error unsupported barrier
     ...
     * @param srcIndex the index to be read
     */
    VMINLINE U_8 inlineIndexableObjectReadU8(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (U_8)vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableReadU8(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param value the value being store
     */
    VMINLINE void inlineIndexableObjectStoreU8(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, U_8 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableStoreU8(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        U_8* actualAddress = J9JAVAARRAY_EA(vmThread, srcArray, srcIndex, U_8);
...
#error unsupported barrier
     ...
     * @param srcIndex the index to be read
     */
    VMINLINE I_16 inlineIndexableObjectReadI16(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (I_16)vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableReadI16(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param value the value being store
     */
    VMINLINE void inlineIndexableObjectStoreI16(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, I_16 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableStoreI16(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        I_16* actualAddress = J9JAVAARRAY_EA(vmThread, srcArray, srcIndex, I_16);
...
#error unsupported barrier
     ...
     * @param srcIndex the index to be read
     */
    VMINLINE U_16 inlineIndexableObjectReadU16(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (U_16)vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableReadU16(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param value the value being store
     */
    VMINLINE void inlineIndexableObjectStoreU16(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, U_16 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableStoreU16(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        U_16* actualAddress = J9JAVAARRAY_EA(vmThread, srcArray, srcIndex, U_16);
...
#error unsupported barrier
     ...
     * @param srcIndex the index to be read
     */
    VMINLINE I_32 inlineIndexableObjectReadI32(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (I_32)vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableReadI32(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param value the value being store
     */
    VMINLINE void inlineIndexableObjectStoreI32(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, I_32 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableStoreI32(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        I_32* actualAddress = J9JAVAARRAY_EA(vmThread, srcArray, srcIndex, I_32);
...
#error unsupported barrier
     ...
     * @param srcIndex the index to be read
     */
    VMINLINE U_32 inlineIndexableObjectReadU32(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return (U_32)vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableReadU32(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param value the value being store
     */
    VMINLINE void inlineIndexableObjectStoreU32(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, U_32 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableStoreI32(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, value, isVolatile);
...
#error unsupported barrier
     ...
     * @return true on success, false otherwise
     */
    VMINLINE bool inlineIndexableObjectCompareAndSwapU32(J9VMThread* vmThread, j9object_t destArray, UDATA destIndex,
        U_32 compareValue, U_32 swapValue, bool isVolatile = false)
    {
...
#error unsupported barrier
     ...
     */
    VMINLINE U_32 inlineIndexableObjectCompareAndExchangeU32(J9VMThread* vmThread, j9object_t destArray,
        UDATA destIndex, U_32 compareValue, U_32 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER) || defined(J9VM_GC_COMBINATION_SPEC)
        U_32* actualAddress = J9JAVAARRAY_EA(vmThread, destArray, destIndex, U_32);
...
#error unsupported barrier
     ...
     * @param srcIndex the index to be read
     */
    VMINLINE I_64 inlineIndexableObjectReadI64(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableReadI64(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param value the value being store
     */
    VMINLINE void inlineIndexableObjectStoreI64(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, I_64 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableStoreI64(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        I_64* actualAddress = J9JAVAARRAY_EA(vmThread, srcArray, srcIndex, I_64);
...
#error unsupported barrier
     ...
     * @param srcIndex the index to be read
     */
    VMINLINE U_64 inlineIndexableObjectReadU64(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableReadU64(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param value the value being store
     */
    VMINLINE void inlineIndexableObjectStoreU64(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, U_64 value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableStoreU64(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        U_64* actualAddress = J9JAVAARRAY_EA(vmThread, srcArray, srcIndex, U_64);
...
#error unsupported barrier
     ...
     * @return true on success, false otherwise
     */
    VMINLINE bool inlineIndexableObjectCompareAndSwapU64(J9VMThread* vmThread, j9object_t destArray, UDATA destIndex,
        U_64 compareValue, U_64 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER) || defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @return the value stored in the array before the update
     */
    VMINLINE U_64 inlineIndexableObjectCompareAndExchangeU64(J9VMThread* vmThread, j9object_t destArray,
        UDATA destIndex, U_64 compareValue, U_64 swapValue, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER) || defined(J9VM_GC_COMBINATION_SPEC)
        U_64* actualAddress = J9JAVAARRAY_EA(vmThread, destArray, destIndex, U_64);
...
#error unsupported barrier
     ...
     * @param srcIndex the index to be read
     */
    VMINLINE j9object_t inlineIndexableObjectReadObject(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableReadObject(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
...
#error unsupported barrier
     ...
     * @param value the value being store
     */
    VMINLINE void inlineIndexableObjectStoreObject(
        J9VMThread* vmThread, j9object_t srcArray, UDATA srcIndex, j9object_t value, bool isVolatile = false)
    {
#if defined(J9VM_GC_ALWAYS_CALL_OBJECT_ACCESS_BARRIER)
        vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableStoreObject(
            vmThread, (J9IndexableObject*)srcArray, (I_32)srcIndex, value, isVolatile);
#elif defined(J9VM_GC_COMBINATION_SPEC)
        if (j9gc_modron_wrtbar_always == _writeBarrierType) {
            vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_indexableStoreObject(
...
#error unsupported barrier
     ...
     * @return true on success, false otherwise
     */
    VMINLINE bool inlineIndexableObjectCompareAndSwapObject(J9VMThread* vmThread, j9object_t destArray, UDATA destIndex,
        j9object_t compareObject, j9object_t swapObject, bool isVolatile = false)
    {
        ...
        return (1
            == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_compareAndSwapObject(
                   vmThread, destArray, (J9Object**)actualAddress, compareObject, swapObject));
#elif defined(J9VM_GC_COMBINATION_SPEC)
        if (j9gc_modron_wrtbar_always == _writeBarrierType) {
            return (1
                == vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_compareAndSwapObject(
...
#error unsupported barrier
     ...
     */
    VMINLINE j9object_t inlineIndexableObjectCompareAndExchangeObject(J9VMThread* vmThread, j9object_t destArray,
        UDATA destIndex, j9object_t compareObject, j9object_t swapObject, bool isVolatile = false)
    {
        fj9object_t* actualAddress = J9JAVAARRAY_EA(vmThread, destArray, destIndex, fj9object_t);
        ...
        if (j9gc_modron_wrtbar_always == _writeBarrierType) {
            ...
            protectIfVolatileBefore(isVolatile, false);
            fj9object_t resultToken
                = compareAndExchangeObjectImpl(vmThread, actualAddress, compareObject, swapObject, isVolatile);
            protectIfVolatileAfter(isVolatile, false);
...
#error unsupported barrier
     ...
     */
    static VMINLINE fj9object_t convertTokenFromPointer(j9object_t pointer, UDATA compressedPointersShift)
    {
#if defined(J9VM_GC_COMPRESSED_POINTERS)
     ...
     */
    static VMINLINE j9object_t convertPointerFromToken(fj9object_t token, UDATA compressedPointersShift)
    {
#if defined(J9VM_GC_COMPRESSED_POINTERS)
     ...
     */
    static VMINLINE j9object_t asConstantPoolObject(J9VMThread* vmThread, j9object_t toConvert, UDATA allocateFlags)
    {
        return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_asConstantPoolObject(
            vmThread, toConvert, allocateFlags);
    }
...
protected:
     ...
     *
     */
    VMINLINE void preMixedObjectStoreObject(
        J9VMThread* vmThread, j9object_t object, fj9object_t* destAddress, j9object_t value)
    {
     ...
     *
     */
    VMINLINE void preIndexableObjectStoreObject(
        J9VMThread* vmThread, j9object_t object, fj9object_t* destAddress, j9object_t value)
    {
        internalPreStoreObject(vmThread, object, destAddress, value);
    }
     ...
     *
     */
    VMINLINE void preStaticStoreObject(
        J9VMThread* vmThread, j9object_t object, j9object_t* destAddress, j9object_t value)
    {
     ...
     *
     */
    VMINLINE void postMixedObjectStoreObject(
        J9VMThread* vmThread, j9object_t object, fj9object_t* destAddress, j9object_t value)
    {
     ...
     *
     */
    VMINLINE void postIndexableObjectStoreObject(
        J9VMThread* vmThread, j9object_t object, fj9object_t* destAddress, j9object_t value)
    {
        internalPostStoreObject(vmThread, object, value);
    }
     ...
     *
     */
    VMINLINE void postStaticStoreObject(
        J9VMThread* vmThread, j9object_t object, j9object_t* destAddress, j9object_t value)
    {
        internalPostStoreObject(vmThread, object, value);
    }

    VMINLINE void postBatchStoreObject(J9VMThread* vmThread, j9object_t object)
    {
     ...
     */
    VMINLINE void preMixedObjectReadObject(J9VMThread* vmThread, j9object_t object, fj9object_t* srcAddress)
    {
     ...
     * @param sreAddress the address of the slot being read
     */
    VMINLINE void preIndexableObjectReadObject(J9VMThread* vmThread, j9object_t object, fj9object_t* srcAddress)
    {
        internalPreReadObject(vmThread, object, srcAddress);
    }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void* readAddressImpl(J9VMThread* vmThread, void** srcAddress, bool isVolatile) { return *srcAddress; }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE I_16 readI16Impl(J9VMThread* vmThread, I_16* srcAddress, bool isVolatile) { return *srcAddress; }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE U_16 readU16Impl(J9VMThread* vmThread, U_16* srcAddress, bool isVolatile) { return *srcAddress; }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE I_32 readI32Impl(J9VMThread* vmThread, I_32* srcAddress, bool isVolatile) { return *srcAddress; }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE U_32 readU32Impl(J9VMThread* vmThread, U_32* srcAddress, bool isVolatile) { return *srcAddress; }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE I_64 readI64Impl(J9VMThread* vmThread, I_64* srcAddress, bool isVolatile)
    {
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE U_64 readU64Impl(J9VMThread* vmThread, U_64* srcAddress, bool isVolatile)
    {
#if !defined(J9VM_ENV_DATA64)
        if (isVolatile) {
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE I_8 readI8Impl(J9VMThread* vmThread, I_8* srcAddress, bool isVolatile) { return *srcAddress; }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE U_8 readU8Impl(J9VMThread* vmThread, U_8* srcAddress, bool isVolatile) { return *srcAddress; }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE mm_j9object_t readObjectImpl(J9VMThread* vmThread, fj9object_t* srcAddress, bool isVolatile)
    {
     ...
     */
    VMINLINE void preStaticReadObject(J9VMThread* vmThread, J9Class* clazz, j9object_t* srcAddress)
    {
        if (j9gc_modron_readbar_none != _readBarrierType) {
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE mm_j9object_t staticReadObjectImpl(J9VMThread* vmThread, j9object_t* srcAddress, bool isVolatile)
    {
        return *srcAddress;
    }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void storeAddressImpl(J9VMThread* vmThread, void** destAddress, void* value, bool isVolatile)
    {
        *destAddress = value;
    }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void storeI16Impl(J9VMThread* vmThread, I_16* destAddress, I_16 value, bool isVolatile)
    {
        *destAddress = value;
    }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void storeU16Impl(J9VMThread* vmThread, U_16* destAddress, U_16 value, bool isVolatile)
    {
        *destAddress = value;
    }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void storeI32Impl(J9VMThread* vmThread, I_32* destAddress, I_32 value, bool isVolatile)
    {
        *destAddress = value;
    }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void storeU32Impl(J9VMThread* vmThread, U_32* destAddress, U_32 value, bool isVolatile)
    {
        *destAddress = value;
    }

    VMINLINE bool compareAndSwapU32Impl(
        J9VMThread* vmThread, U_32* destAddress, U_32 compareValue, U_32 swapValue, bool isVolatile)
    {
        return (compareValue == VM_AtomicSupport::lockCompareExchangeU32(destAddress, compareValue, swapValue));
    }

    VMINLINE U_32 compareAndExchangeU32Impl(
        J9VMThread* vmThread, U_32* destAddress, U_32 compareValue, U_32 swapValue, bool isVolatile)
    {
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void storeI64Impl(J9VMThread* vmThread, I_64* destAddress, I_64 value, bool isVolatile)
    {
#if !defined(J9VM_ENV_DATA64)
        if (isVolatile) {
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void storeU64Impl(J9VMThread* vmThread, U_64* destAddress, U_64 value, bool isVolatile)
    {
#if !defined(J9VM_ENV_DATA64)
        if (isVolatile) {
    ...
    VMINLINE bool compareAndSwapU64Impl(
    ...
    VMINLINE U_64 compareAndExchangeU64Impl(
        J9VMThread* vmThread, U_64* destAddress, U_64 compareValue, U_64 swapValue, bool isVolatile)
    {
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void storeI8Impl(J9VMThread* vmThread, I_8* destAddress, I_8 value, bool isVolatile)
    {
        *destAddress = value;
    }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void storeU8Impl(J9VMThread* vmThread, U_8* destAddress, U_8 value, bool isVolatile)
    {
        *destAddress = value;
    }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void storeObjectImpl(J9VMThread* vmThread, fj9object_t* destAddress, mm_j9object_t value, bool isVolatile)
    {
        *destAddress = internalConvertTokenFromPointer(value);
    }

    VMINLINE bool compareAndSwapObjectImpl(J9VMThread* vmThread, fj9object_t* destAddress, j9object_t compareObject,
        j9object_t swapObject, bool isVolatile)
    {
        ...
        if (sizeof(fj9object_t) == sizeof(UDATA)) {
            result = ((UDATA)compareValue
                == VM_AtomicSupport::lockCompareExchange((UDATA*)destAddress, (UDATA)compareValue, (UDATA)swapValue));
        } else if (sizeof(fj9object_t) == sizeof(U_32)) {
            result = ((U_32)(UDATA)compareValue
                == VM_AtomicSupport::lockCompareExchangeU32(
                       (U_32*)destAddress, (U_32)(UDATA)compareValue, (U_32)(UDATA)swapValue));
        }

        return result;
    }

    VMINLINE fj9object_t compareAndExchangeObjectImpl(J9VMThread* vmThread, fj9object_t* destAddress,
        j9object_t compareObject, j9object_t swapObject, bool isVolatile)
    {
        ...
        if (sizeof(fj9object_t) == sizeof(UDATA)) {
            result = (fj9object_t)VM_AtomicSupport::lockCompareExchange(
                (UDATA*)destAddress, (UDATA)compareValue, (UDATA)swapValue);
        } else if (sizeof(fj9object_t) == sizeof(U_32)) {
            result = (fj9object_t)VM_AtomicSupport::lockCompareExchangeU32(
                (U_32*)destAddress, (U_32)(UDATA)compareValue, (U_32)(UDATA)swapValue);
        }
     ...
     * @param isVolatile non-zero if the field is volatile, zero otherwise
     */
    VMINLINE void staticStoreObjectImpl(
        J9VMThread* vmThread, j9object_t* destAddress, mm_j9object_t value, bool isVolatile)
    {
        *destAddress = value;
    }

    VMINLINE bool staticCompareAndSwapObjectImpl(
        J9VMThread* vmThread, j9object_t* destAddress, j9object_t compareObject, j9object_t swapObject, bool isVolatile)
    {
        return ((UDATA)compareObject
            == VM_AtomicSupport::lockCompareExchange((UDATA*)destAddress, (UDATA)compareObject, (UDATA)swapObject));
    }

    VMINLINE j9object_t staticCompareAndExchangeObjectImpl(
        J9VMThread* vmThread, j9object_t* destAddress, j9object_t compareObject, j9object_t swapObject, bool isVolatile)
    {
        return (j9object_t)VM_AtomicSupport::lockCompareExchange(
            (UDATA*)destAddress, (UDATA)compareObject, (UDATA)swapObject);
    }
     ...
     */
    VMINLINE static void protectIfVolatileBefore(bool isVolatile, bool isRead)
    {
        if (isVolatile) {
            if (!isRead) {
     ...
     * @param isRead true if the field is being read, false if it is being written
     */
    VMINLINE static void protectIfVolatileAfter(bool isVolatile, bool isRead)
    {
        if (isVolatile) {
            if (isRead) {
     ...
     * @return the object token
     */
    VMINLINE fj9object_t internalConvertTokenFromPointer(j9object_t pointer)
    {
#if defined(J9VM_GC_COMPRESSED_POINTERS)
     ...
     * @return the object pointer
     */
    VMINLINE j9object_t internalConvertPointerFromToken(fj9object_t token)
    {
#if defined(J9VM_GC_COMPRESSED_POINTERS)
...
private:
     ...
     *
     */
    VMINLINE void internalPreStoreObject(
        J9VMThread* vmThread, j9object_t object, fj9object_t* destAddress, j9object_t value)
    {
     ...
     *
     */
    VMINLINE void internalStaticPreStoreObject(
        J9VMThread* vmThread, j9object_t object, j9object_t* destAddress, j9object_t value)
    {
        if ((j9gc_modron_wrtbar_satb == _writeBarrierType)
            || (j9gc_modron_wrtbar_satb_and_oldcheck == _writeBarrierType)) {
     ...
     *
     */
    VMINLINE void internalPreStoreObjectSATB(
        J9VMThread* vmThread, j9object_t object, fj9object_t* destAddress, j9object_t value)
    {
        ...
        if (0 != parent->globalFragmentIndex) {
            ...
            if (0 == fragment->localFragmentIndex) {
                vmThread->javaVM->memoryManagerFunctions->J9MetronomeWriteBarrierStore(
                    vmThread, object, destAddress, value);
            } else {
     ...
     *
     */
    VMINLINE void internalStaticPreStoreObjectSATB(
        J9VMThread* vmThread, j9object_t object, j9object_t* destAddress, j9object_t value)
    {
#if defined(J9VM_GC_REALTIME)
        J9VMGCRememberedSetFragment* fragment = &vmThread->sATBBarrierRememberedSetFragment;
        ...
        if (0 != parent->globalFragmentIndex) {
            /* if the double barrier is enabled call OOL */
            if (0 == fragment->localFragmentIndex) {
                vmThread->javaVM->memoryManagerFunctions->J9MetronomeWriteBarrierJ9ClassStore(
                    vmThread, object, destAddress, value);
            } else {
     ...
     */
    VMINLINE bool isMarked(J9VMThread* vmThread, j9object_t object)
    {
        UDATA heapMapBits = 0;
     ...
     * @param value the object reference being stored
     */
    VMINLINE void internalPostStoreObject(J9VMThread* vmThread, j9object_t object, j9object_t value)
    {
    ...
    VMINLINE void internalPostBatchStoreObject(J9VMThread* vmThread, j9object_t object)
    {
        switch (_writeBarrierType) {
        case j9gc_modron_wrtbar_cardmark_and_oldcheck:
     ...
     * @param sreAddress the address of the slot being read
     */
    VMINLINE void internalPreReadObject(J9VMThread* vmThread, j9object_t object, fj9object_t* srcAddress)
    {
        if (j9gc_modron_readbar_none != _readBarrierType) {
     ...
     *
     */
    static VMINLINE void dirtyCard(J9VMThread* vmThread, UDATA objectDelta)
    {
     ...
     *
     */
    static VMINLINE void rememberObject(J9VMThread* vmThread, j9object_t object)
    {
        ...
        if (atomicSetRemembered(object)) {
            ...
            do {
                ...
                if (next > fragment->fragmentTop) {
                    if (0
                        != vmThread->javaVM->memoryManagerFunctions->allocateMemoryForSublistFragment(
                               vmThread->omrVMThread, (J9VMGC_SublistFragment*)fragment)) {
                        break;
                    }
                } else {
     ...
     */
    static VMINLINE bool atomicSetRemembered(j9object_t objectPtr)
    {
        bool result = true;
        ...
        do {
            ...
            newFlags
                = (oldFlags & ~J9_OBJECT_HEADER_REMEMBERED_MASK_FOR_CLEAR) | J9_OBJECT_HEADER_REMEMBERED_BITS_TO_SET;
        }
