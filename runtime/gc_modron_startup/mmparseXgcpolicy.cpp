...
bool MMINLINE isOptthruputGCPolicySupported(MM_GCExtensions* extensions)
{
...
bool MMINLINE isNoGcGCPolicySupported(MM_GCExtensions* extensions) { return true; }

bool MMINLINE isOptavgpauseGCPolicySupported(MM_GCExtensions* extensions)
{
#if defined(J9VM_GC_MODRON_STANDARD)
    return true;
#endif /* J9VM_GC_MODRON_STANDARD */
...
bool MMINLINE isGenconGCPolicySupported(MM_GCExtensions* extensions)
{
...
bool MMINLINE isSubpoolAliasGCPolicySupported(MM_GCExtensions* extensions)
{
...
bool MMINLINE isMetronomeGCPolicySupported(MM_GCExtensions* extensions)
{
...
bool MMINLINE isBalancedGCPolicySupported(MM_GCExtensions* extensions)
{
