 ...
 */
MM_Timer* MM_Timer::newInstance(MM_EnvironmentBase* env, MM_OSInterface* osInterface)
{
    MM_Timer* timer;
 ...
 */
void MM_Timer::kill(MM_EnvironmentBase* env)
{
    tearDown(env);
 ...
 */
void MM_Timer::tearDown(MM_EnvironmentBase* env) {}

/**
 * Initialize an instance of the MM_Timer class.
 */
bool MM_Timer::initialize(MM_EnvironmentBase* env, MM_OSInterface* osInterface)
{
 ...
 */
U_64 MM_Timer::getTimeInNanos() { return _osInterface->nanoTime(); }

/**
 * Reset the timer to the current time in nanoseconds
 */
void MM_Timer::reset() { rebaseTime(); }
 ...
 */
U_64 MM_Timer::peekElapsedTime(U_64 timerBase)
{
 ...
 */
bool MM_Timer::hasTimeElapsed(U_64 startTimeInNanos, U_64 timeToWaitInNanos)
{
