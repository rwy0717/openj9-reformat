...
public:
    ...
    UDATA _ownableSynchronizerCandidates; /**< number of ownable synchronizer objects visited this cycle, used by both
                                             MarkingScheme */
    UDATA _ownableSynchronizerSurvived; /**< number of ownable synchronizer objects survived this cycle, used only by
                                           PMS */
    UDATA
        _ownableSynchronizerCleared; /**< number of ownable synchronizer objects cleared this cycle, used only by GMP */
    ...
    UDATA _stringConstantsCandidates; /**< The number of string constants that have been visited in string table during
                                         marking */

#if defined(J9MODRON_TGC_PARALLEL_STATISTICS)
    UDATA _splitArraysProcessed; /**< The number of array chunks (not counting parts smaller than the split size)
