...
protected:
    ...
    fj9object_t* _arrayoid; /**< The pointer to the beginning of the arraylet leaf pointers (that is, the first slot
                               after the object header) */
    UDATA _numLeafs; /**< The number of leaf pointers beginning at the _arrayoid.  This includes inline and out-of-line
                        leaf pointers */
...
public:
    ...
    MMINLINE void initialize(J9IndexableObject* objectPtr)
    {
