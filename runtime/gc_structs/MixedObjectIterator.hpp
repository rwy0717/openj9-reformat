...
protected:
     ...
     */
    MMINLINE void initializeDescriptionBits(J9Class* clazzPtr)
    {
...
public:
     ...
     */
    MMINLINE void initialize(J9Class* clazzPtr, fj9object_t* addr)
    {
        _objectPtr = NULL;
        initializeDescriptionBits(clazzPtr);
    ...
    MMINLINE J9Object* getObject() { return _objectPtr; }
