...
private:
#if !defined(J9VM_GC_ARRAYLETS)
    GC_PointerContiguousArrayIterator
        _contiguousArrayIterator; /**< Iterator instance specific for Contiguous (standard) array */
#elif defined(J9VM_GC_HYBRID_ARRAYLETS)
    bool _contiguous;
    GC_PointerContiguousArrayIterator _contiguousArrayIterator;
    GC_PointerArrayletIterator
        _pointerArrayletIterator; /**< Iterator instance specific for Contiguous (standard) array */
#else
    GC_PointerArrayletIterator
        _pointerArrayletIterator; /**< Iterator instance specific for Discontiguous array (arraylet)*/
#endif
