...
typedef struct TgcInterRegionRememberedSetDemographicsExtension {
    ...
    omrthread_monitor_t
        mutex; /**< A monitor used to protect the shared resources when parallel threads merge their results */
...
public:
     ...
     */
    static MM_TgcExtensions* getExtensions(MM_GCExtensions* extensions)
    {
        return (MM_TgcExtensions*)extensions->tgcExtensions;
    }
     ...
     * @return the TGC extensions
     */
    static MM_TgcExtensions* getExtensions(J9JavaVM* javaVM)
    {
        return getExtensions(MM_GCExtensions::getExtensions(javaVM));
    }
     ...
     * @return the TGC extensions
     */
    static MM_TgcExtensions* getExtensions(OMR_VMThread* omrVMThread)
    {
        return getExtensions(MM_GCExtensions::getExtensions(omrVMThread));
    }
