 ...
 */
static jvmtiIterationControl fix_heapIteratorCallback(
    J9JavaVM* vm, J9MM_IterateHeapDescriptor* heapDesc, void* userData);
static jvmtiIterationControl fix_spaceIteratorCallback(
    J9JavaVM* vm, J9MM_IterateSpaceDescriptor* spaceDesc, void* userData);
static jvmtiIterationControl fix_regionIteratorCallback(
    J9JavaVM* vm, J9MM_IterateRegionDescriptor* regionDesc, void* userData);
static jvmtiIterationControl fix_objectIteratorCallback(
    J9JavaVM* vm, J9MM_IterateObjectDescriptor* objectDesc, void* userData);
static jvmtiIterationControl dump_objectIteratorCallback(
    J9JavaVM* vm, J9MM_IterateObjectDescriptor* objectDesc, void* userData);

/**
 * @todo Provide function documentation
 */
static void dumpHeap(J9JavaVM* javaVM)
{
    ...
    TRIGGER_J9HOOK_MM_PRIVATE_WALK_HEAP_START(
        MM_GCExtensions::getExtensions(javaVM)->privateHookInterface, extensions->getOmrVM());

    javaVM->memoryManagerFunctions->j9mm_iterate_all_objects(
        javaVM, javaVM->portLibrary, j9mm_iterator_flag_include_holes, dump_objectIteratorCallback, terseExtensions);
    ...
    J9JavaVM* vm, J9MM_IterateObjectDescriptor* objectDesc, void* userData)
{
    ...
    tgcExtensions->printf(
        "*DH(%d)* %p %s", terseExtensions->gcCount, objectDesc->object, objectDesc->isObject ? "a" : "f");
 ...
 * @todo Provide function documentation
 */
static void tgcHookGlobalGcEnd(J9HookInterface** hook, UDATA eventNum, void* eventData, void* userData)
{
 ...
 * @todo Provide function documentation
 */
static void tgcHookLocalGcEnd(J9HookInterface** hook, UDATA eventNum, void* eventData, void* userData)
{
 ...
 * @todo Provide function documentation
 */
static void tgcHookGlobalGcSweepEnd(J9HookInterface** hook, UDATA eventNum, void* eventData, void* userData)
{
    ...
    javaVM->memoryManagerFunctions->j9mm_iterate_heaps(
        javaVM, javaVM->portLibrary, 0, fix_heapIteratorCallback, &iteratorData);
}
    ...
    J9JavaVM* vm, J9MM_IterateHeapDescriptor* heapDesc, void* userData)
{
    ...
    vm->memoryManagerFunctions->j9mm_iterate_spaces(
        vm, vm->portLibrary, heapDesc, 0, fix_spaceIteratorCallback, castUserData);
    return JVMTI_ITERATION_CONTINUE;
}
    ...
    J9JavaVM* vm, J9MM_IterateSpaceDescriptor* spaceDesc, void* userData)
{
    ...
    vm->memoryManagerFunctions->j9mm_iterate_regions(
        vm, vm->portLibrary, spaceDesc, 0, fix_regionIteratorCallback, castUserData);
    return JVMTI_ITERATION_CONTINUE;
}
    ...
    J9JavaVM* vm, J9MM_IterateRegionDescriptor* regionDesc, void* userData)
{
    ...
    vm->memoryManagerFunctions->j9mm_iterate_region_objects(
        vm, vm->portLibrary, regionDesc, 0, fix_objectIteratorCallback, castUserData);
    return JVMTI_ITERATION_CONTINUE;
}
