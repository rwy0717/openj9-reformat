...
private:
     ...
     */
    void outputUnfinalizedInfo(
        MM_EnvironmentBase* env, UDATA indent, UDATA unfinalizedCandidates, UDATA unfinalizedCount);
     ...
     */
    void outputOwnableSynchronizerInfo(
     ...
     * @param maxThreshold maximum threshold value for reference. If it equal 0 thresholds should not be included to
     * output line
     */
    void outputReferenceInfo(MM_EnvironmentBase* env, UDATA indent, const char* referenceType,
     ...
     */
    void outputMarkSummary(MM_EnvironmentBase* env, const char* markType, MM_MarkVLHGCStats* markStats,
        MM_WorkPacketStats* workPacketStats, MM_InterRegionRememberedSetStats* irrsStats);
