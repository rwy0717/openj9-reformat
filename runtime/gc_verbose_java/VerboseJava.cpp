 ...
 */
J9MemoryManagerVerboseInterface functionTable = { gcDebugVerboseStartupLogging, gcDebugVerboseShutdownLogging,
    gcDumpMemorySizes, configureVerbosegc, queryVerbosegc };
...
static void gcDumpMemorySizes(J9JavaVM* javaVM)
{
    ...
    /* If entry at index 1 of supported page size array is non zero, then large pages are available */
    {
        ...
        optionDescription = j9nls_lookup_message(
            J9NLS_DO_NOT_APPEND_NEWLINE | J9NLS_DO_NOT_PRINT_MESSAGE_TAG, J9NLS_GC_VERB_SIZES_XLP, NULL);
        ...
        optionDescription = j9nls_lookup_message(
            J9NLS_DO_NOT_APPEND_NEWLINE | J9NLS_DO_NOT_PRINT_MESSAGE_TAG, J9NLS_GC_VERB_SIZES_AVAILABLE_XLP, NULL);
