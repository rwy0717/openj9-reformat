...
private:
    ...
    UDATA _cardCleaningPhase1Threshold; /**< the number of free bytes at which we wish to start the first card cleaning
                                           phase */
    ...
    UDATA
        _threadsToScanCount; /**< the number of threads which were live at kickoff whose stacks needed to be scanned */
