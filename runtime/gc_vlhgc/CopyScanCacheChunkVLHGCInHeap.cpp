...
MM_CopyScanCacheChunkVLHGCInHeap* MM_CopyScanCacheChunkVLHGCInHeap::newInstance(MM_EnvironmentVLHGC* env, void* buffer,
...
bool MM_CopyScanCacheChunkVLHGCInHeap::initialize(MM_EnvironmentVLHGC* env, UDATA cacheEntryCount,
...
void MM_CopyScanCacheChunkVLHGCInHeap::kill(MM_EnvironmentVLHGC* env)
{
    tearDown(env);
