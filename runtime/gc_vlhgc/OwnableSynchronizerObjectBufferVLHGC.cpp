...
MM_OwnableSynchronizerObjectBufferVLHGC::MM_OwnableSynchronizerObjectBufferVLHGC(
...
MM_OwnableSynchronizerObjectBufferVLHGC* MM_OwnableSynchronizerObjectBufferVLHGC::newInstance(MM_EnvironmentBase* env)
{
    MM_OwnableSynchronizerObjectBufferVLHGC* ownableObjectBuffer = NULL;
    MM_GCExtensions* extensions = MM_GCExtensions::getExtensions(env);

    ownableObjectBuffer = (MM_OwnableSynchronizerObjectBufferVLHGC*)env->getForge()->allocate(
        sizeof(MM_OwnableSynchronizerObjectBufferVLHGC), MM_AllocationCategory::FIXED, J9_GET_CALLSITE());
...
bool MM_OwnableSynchronizerObjectBufferVLHGC::initialize(MM_EnvironmentBase* base) { return true; }

void MM_OwnableSynchronizerObjectBufferVLHGC::tearDown(MM_EnvironmentBase* base) {}

void MM_OwnableSynchronizerObjectBufferVLHGC::flushImpl(MM_EnvironmentBase* env)
{
    MM_HeapRegionDescriptorVLHGC* region = (MM_HeapRegionDescriptorVLHGC*)_region;
    /* both addAll and incrementObjectCount are atomic, but getObjectCount could get inconsistent count, for current use
     * case, it would be fine. */
...
void MM_OwnableSynchronizerObjectBufferVLHGC::addForOnlyCompactedRegion(MM_EnvironmentBase* env, j9object_t object)
{
