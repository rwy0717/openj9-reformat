...
void MM_ParallelPartialMarkTask::masterSetup(MM_EnvironmentBase* env)
{
...
void MM_ParallelPartialMarkTask::masterCleanup(MM_EnvironmentBase* envBase)
{
...
void MM_ParallelPartialMarkTask::run(MM_EnvironmentBase* envBase)
{
    MM_EnvironmentVLHGC* env = MM_EnvironmentVLHGC::getEnvironment(envBase);
...
void MM_ParallelPartialMarkTask::setup(MM_EnvironmentBase* envBase)
{
    MM_EnvironmentVLHGC* env = MM_EnvironmentVLHGC::getEnvironment(envBase);
...
void MM_ParallelPartialMarkTask::cleanup(MM_EnvironmentBase* envBase)
{
    MM_EnvironmentVLHGC* env = MM_EnvironmentVLHGC::getEnvironment(envBase);
     ...
     * -Xtgc:parallel */
    Trc_MM_ParallelPartialMarkTask_parallelStats(env->getLanguageVMThread(), (U_32)env->getSlaveID(),
        ...
        (U_32)env->_markVLHGCStats._syncStallCount, env->_workPacketStats.workPacketsAcquired,
...
void MM_ParallelPartialMarkTask::synchronizeGCThreads(MM_EnvironmentBase* envBase, const char* id)
{
    MM_EnvironmentVLHGC* env = MM_EnvironmentVLHGC::getEnvironment(envBase);
    PORT_ACCESS_FROM_ENVIRONMENT(env);
...
bool MM_ParallelPartialMarkTask::synchronizeGCThreadsAndReleaseMaster(MM_EnvironmentBase* envBase, const char* id)
{
    MM_EnvironmentVLHGC* env = MM_EnvironmentVLHGC::getEnvironment(envBase);
    PORT_ACCESS_FROM_ENVIRONMENT(env);
    U_64 startTime = j9time_hires_clock();
...
bool MM_ParallelPartialMarkTask::synchronizeGCThreadsAndReleaseSingleThread(MM_EnvironmentBase* envBase, const char* id)
{
    MM_EnvironmentVLHGC* env = MM_EnvironmentVLHGC::getEnvironment(envBase);
    PORT_ACCESS_FROM_ENVIRONMENT(env);
    U_64 startTime = j9time_hires_clock();
 ...
 */
MM_PartialMarkingScheme* MM_PartialMarkingScheme::newInstance(MM_EnvironmentVLHGC* env)
{
    MM_PartialMarkingScheme* markingScheme;

    markingScheme = (MM_PartialMarkingScheme*)env->getForge()->allocate(
        sizeof(MM_PartialMarkingScheme), MM_AllocationCategory::FIXED, J9_GET_CALLSITE());
    if (markingScheme) {
 ...
 */
void MM_PartialMarkingScheme::kill(MM_EnvironmentVLHGC* env)
{
    tearDown(env);
 ...
 */
bool MM_PartialMarkingScheme::initialize(MM_EnvironmentVLHGC* env)
{
 ...
 */
void MM_PartialMarkingScheme::tearDown(MM_EnvironmentVLHGC* env) {}
 ...
 */
bool MM_PartialMarkingScheme::heapAddRange(
 ...
 * @return true if operation completes with success (always)
 */
bool MM_PartialMarkingScheme::heapRemoveRange(MM_EnvironmentVLHGC* env, MM_MemorySubSpace* subspace, UDATA size,
 ...
 ****************************************
 */
void MM_PartialMarkingScheme::masterSetupForGC(MM_EnvironmentVLHGC* env)
{
    ...
    static_cast<MM_CycleStateVLHGC*>(env->_cycleState)->_vlhgcIncrementStats._markStats._ownableSynchronizerCandidates
        = ownableSynchronizerCandidates;
}

void MM_PartialMarkingScheme::masterCleanupAfterGC(MM_EnvironmentVLHGC* env)
{
    Assert_MM_true(static_cast<MM_CycleStateVLHGC*>(env->_cycleState)
                       ->_vlhgcIncrementStats._markStats._ownableSynchronizerCandidates
        >= static_cast<MM_CycleStateVLHGC*>(env->_cycleState)
               ->_vlhgcIncrementStats._markStats._ownableSynchronizerSurvived);
    static_cast<MM_CycleStateVLHGC*>(env->_cycleState)->_vlhgcIncrementStats._markStats._ownableSynchronizerCleared
        = static_cast<MM_CycleStateVLHGC*>(env->_cycleState)
              ->_vlhgcIncrementStats._markStats._ownableSynchronizerCandidates
        - static_cast<MM_CycleStateVLHGC*>(env->_cycleState)
              ->_vlhgcIncrementStats._markStats._ownableSynchronizerSurvived;
...
void MM_PartialMarkingScheme::workerSetupForGC(MM_EnvironmentVLHGC* env)
{
...
void MM_PartialMarkingScheme::setCachedState(MM_MarkMap* markMap, bool dynamicClassUnloadingEnabled)
{
...
void MM_PartialMarkingScheme::clearCachedState() { _markMap = NULL; }

/****************************************
 * Marking Helpers
 ****************************************
 */
bool MM_PartialMarkingScheme::isMarked(J9Object* objectPtr)
{
...
MMINLINE bool MM_PartialMarkingScheme::markObjectNoCheck(MM_EnvironmentVLHGC* env, J9Object* objectPtr, bool leafType)
{
...
MMINLINE bool MM_PartialMarkingScheme::markObject(MM_EnvironmentVLHGC* env, J9Object* objectPtr, bool leafType)
{
    bool didMark = false;
...
MMINLINE void MM_PartialMarkingScheme::rememberReferenceIfRequired(
    MM_EnvironmentVLHGC* env, J9Object* from, J9Object* to)
{
    if (NULL != to) {
...
MMINLINE void MM_PartialMarkingScheme::markObjectClass(MM_EnvironmentVLHGC* env, J9Object* objectPtr)
{
#if defined(J9VM_GC_DYNAMIC_CLASS_UNLOADING)
...
MMINLINE void MM_PartialMarkingScheme::updateScanStats(MM_EnvironmentVLHGC* env, UDATA bytesScanned, ScanReason reason)
{
...
MMINLINE void MM_PartialMarkingScheme::addOwnableSynchronizerObjectInList(MM_EnvironmentVLHGC* env, j9object_t object)
{
 ...
 ****************************************
 */
void MM_PartialMarkingScheme::scanMixedObject(MM_EnvironmentVLHGC* env, J9Object* objectPtr, ScanReason reason)
{
...
void MM_PartialMarkingScheme::scanReferenceMixedObject(MM_EnvironmentVLHGC* env, J9Object* objectPtr, ScanReason reason)
{
    fj9object_t* endScanPtr;
    UDATA* descriptionPtr;
    UDATA descriptionBits;
    ...
    /* we can tell if the reference object is in the collection set if it came from a packet or overflowed region. Dirty
     * cards (in PGC) are only used for remembered objects. */
    ...
    if (SCAN_REASON_OVERFLOWED_REGION == reason) {
        ...
        if (referentMustBeCleared) {
            /* Discovering this object at this stage in the GC indicates that it is being resurrected. Clear its
             * referent slot. */
...
UDATA
MM_PartialMarkingScheme::scanPointerArrayObjectSplit(
    MM_EnvironmentVLHGC* env, J9IndexableObject* objectPtr, UDATA startIndex, ScanReason reason)
{
    UDATA slotsToScan = 0;
...
void MM_PartialMarkingScheme::scanPointerArrayObject(
    MM_EnvironmentVLHGC* env, J9IndexableObject* objectPtr, ScanReason reason)
{
...
void MM_PartialMarkingScheme::scanClassObject(MM_EnvironmentVLHGC* env, J9Object* classObject, ScanReason reason)
{
...
void MM_PartialMarkingScheme::scanClassLoaderObject(
    MM_EnvironmentVLHGC* env, J9Object* classLoaderObject, ScanReason reason)
{
...
void MM_PartialMarkingScheme::scanClassLoaderSlots(
    MM_EnvironmentVLHGC* env, J9ClassLoader* classLoader, ScanReason reason)
{
    if (NULL != classLoader) {
        /* This method should only be necessary for the system class loader and application class loader since they may
         * not necessarily have a class loader object but still need to keep their loaded classes alive
         */
...
void MM_PartialMarkingScheme::scanObject(MM_EnvironmentVLHGC* env, J9Object* objectPtr, ScanReason reason)
{
    Assert_MM_true(
        PACKET_INVALID_OBJECT != (UDATA)objectPtr); /* Invalid objects can only exist on the GMP's work packets */
 ...
 */
MMINLINE void MM_PartialMarkingScheme::completeScan(MM_EnvironmentVLHGC* env)
{
    PORT_ACCESS_FROM_ENVIRONMENT(env);
    do {
         ...
         * Adding a synchronization point here means one additional synchronization per increment but means that a
         * thread which times out will wait for the overflow to occur before deciding if it needs to handle the overflow
         * or exit the loop
         */
...
#if defined(J9VM_GC_FINALIZATION)
void MM_PartialMarkingScheme::scanUnfinalizedObjects(MM_EnvironmentVLHGC* env)
{
    GC_FinalizableObjectBuffer buffer(_extensions);

    /* we need to sync to ensure that all clearable processing is complete up to this point since this phase resurrects
     * objects */
    env->_currentTask->synchronizeGCThreads(env, UNIQUE_ID);
...
private:
    virtual void doSlot(J9Object** slotPtr) { _markingScheme->markObject((MM_EnvironmentVLHGC*)_env, *slotPtr); }
...
private:
    ...
    virtual void doClass(J9Class* clazz) { assume0(0); /* Should not have gotten here - how do you clear a class? */ }
 ...
 */
void MM_PartialMarkingScheme::markLiveObjectsInit(MM_EnvironmentVLHGC* env)
{
...
void MM_PartialMarkingScheme::initializeForPartialCollect(MM_EnvironmentVLHGC* env)
{
    Assert_MM_true(MM_CycleState::CT_PARTIAL_GARBAGE_COLLECTION == env->_cycleState->_collectionType);
...
void MM_PartialMarkingScheme::cleanCardTableForPartialCollect(MM_EnvironmentVLHGC* env, MM_CardCleaner* cardCleaner)
{
    PORT_ACCESS_FROM_ENVIRONMENT(env);
 ...
 */
void MM_PartialMarkingScheme::markLiveObjectsRoots(MM_EnvironmentVLHGC* env)
{
...
void MM_PartialMarkingScheme::markLiveObjectsScan(MM_EnvironmentVLHGC* env) { completeScan(env); }

/**
 *  Final Mark services including scanning of Clearables
 *  @param[in] env - passed Environment
 */
void MM_PartialMarkingScheme::markLiveObjectsComplete(MM_EnvironmentVLHGC* env)
{
    ...
    if (env->_currentTask->synchronizeGCThreadsAndReleaseSingleThread(env, UNIQUE_ID)) {
        ...
        /* weak and soft references resurrected by finalization need to be cleared immediately since weak and soft
...
void MM_PartialMarkingScheme::deleteDeadObjectsFromExternalCycle(MM_EnvironmentVLHGC* env)
{
    ...
    Trc_MM_PartialMarkingScheme_deleteDeadObjectsFromExternalCycle_Exit(
        env->getLanguageVMThread(), deletedCount, totalCount);
}

bool MM_PartialMarkingScheme::handleOverflow(MM_EnvironmentVLHGC* env)
{
...
void MM_PartialMarkingScheme::cleanRegion(
    MM_EnvironmentVLHGC* env, MM_HeapRegionDescriptorVLHGC* region, U_8 flagToClean)
{
...
void MM_PartialMarkingScheme::scanObjectsInRange(
...
void MM_PartialMarkingScheme::scanWeakReferenceObjects(MM_EnvironmentVLHGC* env)
{
    ...
    while (NULL != (region = regionIterator.nextRegion())) {
        if (region->_markData._shouldMark) {
            if (!region->getReferenceObjectList()->wasWeakListEmpty()) {
                if (J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
                    processReferenceList(env, region->getReferenceObjectList()->getPriorWeakList(),
                        &env->_markVLHGCStats._weakReferenceStats);
                }
            }
        }
    }
...
void MM_PartialMarkingScheme::scanSoftReferenceObjects(MM_EnvironmentVLHGC* env)
{
    Assert_MM_true(env->getGCEnvironment()->_referenceObjectBuffer->isEmpty());
    ...
    while (NULL != (region = regionIterator.nextRegion())) {
        if (region->_markData._shouldMark) {
            if (!region->getReferenceObjectList()->wasSoftListEmpty()) {
                if (J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
                    processReferenceList(env, region->getReferenceObjectList()->getPriorSoftList(),
                        &env->_markVLHGCStats._softReferenceStats);
                }
            }
        }
    }
...
void MM_PartialMarkingScheme::scanPhantomReferenceObjects(MM_EnvironmentVLHGC* env)
{
    ...
    while (NULL != (region = regionIterator.nextRegion())) {
        if (region->_markData._shouldMark) {
            if (!region->getReferenceObjectList()->wasPhantomListEmpty()) {
                if (J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
                    processReferenceList(env, region->getReferenceObjectList()->getPriorPhantomList(),
                        &env->_markVLHGCStats._phantomReferenceStats);
                }
            }
        }
    }
...
void MM_PartialMarkingScheme::processReferenceList(
    MM_EnvironmentVLHGC* env, J9Object* headOfList, MM_ReferenceStats* referenceStats)
{
...
void MM_PartialMarkingScheme::rememberReferenceList(MM_EnvironmentVLHGC* env, J9Object* headOfList)
{
...
void MM_PartialMarkingScheme::flushBuffers(MM_EnvironmentVLHGC* env)
{
