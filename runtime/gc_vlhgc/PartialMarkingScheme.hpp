...
public:
     ...
     */
    MM_ParallelPartialMarkTask(MM_EnvironmentBase* env, MM_Dispatcher* dispatcher,
        MM_PartialMarkingScheme* markingScheme, MM_CycleState* cycleState)
...
private:
    ...
    /**
     * Called whenever a ownable synchronizer object is scaned during PartialMarkingScheme. Places the object on the
