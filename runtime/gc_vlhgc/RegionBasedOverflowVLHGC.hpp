...
private:
    ...
    MM_HeapRegionManager* const
        _heapRegionManager; /**< The region manager used to translate object addresses into region addresses */
    ...
    enum {
        ...
        OVERFLOW_GLOBAL_COLLECT
        = 0x2, /**< Overflow flag set if we overflowed a region when marking for a GMP or global collect */
    };
    /* Methods */
public:
    static MM_RegionBasedOverflowVLHGC* newInstance(
...
private:
    ...
    bool isEvacuateRegion(MM_HeapRegionDescriptorVLHGC* region) { return region->_markData._shouldMark; }
};
