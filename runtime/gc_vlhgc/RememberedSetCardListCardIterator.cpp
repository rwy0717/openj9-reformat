...
bool GC_RememberedSetCardListCardIterator::nextBuffer(
    MM_EnvironmentBase* env, MM_CardBufferControlBlock* cardBufferControlBlock)
{
...
bool GC_RememberedSetCardListCardIterator::nextBucket(MM_EnvironmentBase* env)
{
...
MM_RememberedSetCard GC_RememberedSetCardListCardIterator::nextReferencingCard(MM_EnvironmentBase* env)
{
    do {
        do {
...
void* GC_RememberedSetCardListCardIterator::nextReferencingCardHeapAddress(MM_EnvironmentBase* env)
{
