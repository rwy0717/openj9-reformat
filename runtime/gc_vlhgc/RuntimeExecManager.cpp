...
typedef jint(JNICALL* forkAndExecNativeFunctionV6)(JNIEnv* env, jobject receiver, jobject arg1, jobject arg2, jint arg3,
    jobject arg4, jint arg5, jobject arg6, jboolean arg7, jobject arg8, jobject arg9, jobject arg10);
typedef jint(JNICALL* forkAndExecNativeFunctionV7)(JNIEnv* env, jobject receiver, jobject arg1, jobject arg2, jint arg3,
    jobject arg4, jint arg5, jobject arg6, jobject arg7, jboolean arg8);
typedef jint(JNICALL* forkAndExecNativeFunctionV8)(JNIEnv* env, jobject receiver, jint arg1, jobject arg2, jobject arg3,
    jobject arg4, jint arg5, jobject arg6, jint arg7, jobject arg8, jobject arg9, jboolean arg10);
...
bool MM_RuntimeExecManager::initialize(MM_EnvironmentBase* env)
{
    bool result = true;
#if defined(LINUX) && !defined(J9ZTPF)
        ...
        if (NULL == vmHookInterface) {
            result = false;
                       ...
                       ->J9HookRegisterWithCallSite(
                           vmHookInterface, J9HOOK_VM_JNI_NATIVE_BIND, jniNativeBindHook, OMR_GET_CALLSITE(), this)) {
            result = false;
        }
    }
#endif /* defined (LINUX) && !defined (J9ZTPF) */
...
void MM_RuntimeExecManager::tearDown(MM_EnvironmentBase* env)
{
#if defined(LINUX) && !defined(J9ZTPF)
...
#if defined(LINUX) && !defined(J9ZTPF)
void MM_RuntimeExecManager::jniNativeBindHook(J9HookInterface** hook, UDATA eventNum, void* eventData, void* userData)
{
    ...
    if (methodClass->classLoader == vmThread->javaVM->systemClassLoader) {
        ...
        if (literalCheck) {
            if (J9UTF8_LITERAL_EQUALS(J9UTF8_DATA(methodName), J9UTF8_LENGTH(methodName), METHOD_NAME)) {
                Trc_MM_RuntimeExecManager_jniNativeBindHook_foundMethod(vmThread, J9UTF8_LENGTH(classNameUTF8),
                    J9UTF8_DATA(classNameUTF8), J9UTF8_LENGTH(methodName), J9UTF8_DATA(methodName),
                    J9UTF8_LENGTH(methodSignature), J9UTF8_DATA(methodSignature));
                if (J9UTF8_LITERAL_EQUALS(
                        J9UTF8_DATA(methodSignature), J9UTF8_LENGTH(methodSignature), METHOD_SIGNATURE_V6)) {
                ...
                } else if (J9UTF8_LITERAL_EQUALS(
                               J9UTF8_DATA(methodSignature), J9UTF8_LENGTH(methodSignature), METHOD_SIGNATURE_V7)) {
                    Assert_MM_true(NULL == runtimeExecManager->_savedForkAndExecNative);
                    runtimeExecManager->_savedForkAndExecNative = jniNativeBindEvent->nativeMethodAddress;
                    jniNativeBindEvent->nativeMethodAddress = (void*)forkAndExecNativeV7;
                } else if (J9UTF8_LITERAL_EQUALS(
                               J9UTF8_DATA(methodSignature), J9UTF8_LENGTH(methodSignature), METHOD_SIGNATURE_V8)) {
                    Assert_MM_true(NULL == runtimeExecManager->_savedForkAndExecNative);
                    runtimeExecManager->_savedForkAndExecNative = jniNativeBindEvent->nativeMethodAddress;
                    jniNativeBindEvent->nativeMethodAddress = (void*)forkAndExecNativeV8;
                }
                Trc_MM_RuntimeExecManager_jniNativeBindHook_replacedMethod(
                    vmThread, runtimeExecManager->_savedForkAndExecNative, jniNativeBindEvent->nativeMethodAddress);
            }
        }
    }
}

jint MM_RuntimeExecManager::forkAndExecNativeV6(JNIEnv* jniEnv, jobject receiver, jobject arg1, jobject arg2, jint arg3,
    jobject arg4, jint arg5, jobject arg6, jboolean arg7, jobject arg8, jobject arg9, jobject arg10)
{
    ...
    forkAndExecNativeFunctionV6 savedForkAndExecNative
        = (forkAndExecNativeFunctionV6)runtimeExecManager->_savedForkAndExecNative;
...
jint MM_RuntimeExecManager::forkAndExecNativeV7(JNIEnv* jniEnv, jobject receiver, jobject arg1, jobject arg2, jint arg3,
    jobject arg4, jint arg5, jobject arg6, jobject arg7, jboolean arg8)
{
    J9VMThread* vmThread = (J9VMThread*)jniEnv;
    MM_EnvironmentVLHGC* env = MM_EnvironmentVLHGC::getEnvironment(vmThread);
    ...
    MM_GlobalAllocationManagerTarok* allocationManager
        = (MM_GlobalAllocationManagerTarok*)MM_GCExtensions::getExtensions(env)->globalAllocationManager;
    MM_RuntimeExecManager* runtimeExecManager = &allocationManager->_runtimeExecManager;
    forkAndExecNativeFunctionV7 savedForkAndExecNative
        = (forkAndExecNativeFunctionV7)runtimeExecManager->_savedForkAndExecNative;
    MM_AllocationContextTarok* allocationContext = (MM_AllocationContextTarok*)env->getAllocationContext();
...
jint MM_RuntimeExecManager::forkAndExecNativeV8(JNIEnv* jniEnv, jobject receiver, jint arg1, jobject arg2, jobject arg3,
    jobject arg4, jint arg5, jobject arg6, jint arg7, jobject arg8, jobject arg9, jboolean arg10)
{
    J9VMThread* vmThread = (J9VMThread*)jniEnv;
    MM_EnvironmentVLHGC* env = MM_EnvironmentVLHGC::getEnvironment(vmThread);
    ...
    MM_GlobalAllocationManagerTarok* allocationManager
        = (MM_GlobalAllocationManagerTarok*)env->getExtensions()->globalAllocationManager;
    MM_RuntimeExecManager* runtimeExecManager = &allocationManager->_runtimeExecManager;
    forkAndExecNativeFunctionV8 savedForkAndExecNative
        = (forkAndExecNativeFunctionV8)runtimeExecManager->_savedForkAndExecNative;
    MM_AllocationContextTarok* allocationContext = (MM_AllocationContextTarok*)env->getAllocationContext();
