...
int plugin_session_init(int session_id, struct plugin_service_ops* a_plugin_service)
{
...
int plugin_get_version(void) { return PLUGIN_CURRENT_VERSION; }

const char* plugin_get_name(void) { return "j9gdb"; }
