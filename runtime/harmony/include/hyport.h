...
#define HyOpenCreateNew                                                                                               \
    64 /* Use this flag with HyOpenCreate, if this flag is specified then trying to create an existing file will fail \
        */
...
typedef UDATA (*hysig_handler_fn)(
    struct HyPortLibrary* portLib, U_32 gpType, void* gpInfo, void* handler_arg); /* Forward struct declaration */
...
typedef struct HyPortLibrary {
    ...
    I_32 (*error_set_last_error_with_message)
    ...
    IDATA (*vmem_decommit_memory)
    (struct HyPortLibrary* portLibrary, void* address, UDATA byteAmount, struct HyPortVmemIdentifier* identifier);
    /** see @ref hyvmem.c::hyvmem_free_memory "hyvmem_free_memory"*/
    I_32 (*vmem_free_memory)
    (struct HyPortLibrary* portLibrary, void* userAddress, UDATA byteAmount, struct HyPortVmemIdentifier* identifier);
    /** see @ref hyvmem.c::hyvmem_reserve_memory "hyvmem_reserve_memory"*/
    void* (*vmem_reserve_memory)(struct HyPortLibrary* portLibrary, void* address, UDATA byteAmount,
    ...
    I_32 (*sock_sockaddr_init)
    (struct HyPortLibrary* portLibrary, hysockaddr_t handle, I_16 family, U_32 nipAddr, U_16 nPort);
    ...
    void (*nls_set_catalog)(struct HyPortLibrary* portLibrary, const char** paths, const int nPaths,
        const char* baseName, const char* extension);
    /** see @ref hynls.c::hynls_set_locale "hynls_set_locale"*/
    void (*nls_set_locale)(
        struct HyPortLibrary* portLibrary, const char* lang, const char* region, const char* variant);
    ...
    I_32 (*sig_protect)
    (struct HyPortLibrary* portLibrary, hysig_protected_fn fn, void* fn_arg, hysig_handler_fn handler,
        void* handler_arg, U_32 flags, UDATA* result);
    ...
    I_32 (*sig_set_async_signal_handler)
    ...
    I_32 (*sock_select)
    (struct HyPortLibrary* portLibrary, I_32 nfds, hyfdset_t readfds, hyfdset_t writefds, hyfdset_t exceptfds,
        hytimeval_t timeout);
    ...
    I_32 (*sock_getaddrinfo_create_hints)
    (struct HyPortLibrary* portLibrary, hyaddrinfo_t* result, I_16 family, I_32 socktype, I_32 protocol, I_32 flags);
    ...
    I_32 (*sock_getnameinfo)
    (struct HyPortLibrary* portLibrary, hysockaddr_t in_addr, I_32 sockaddr_size, char* name, I_32 name_length,
        int flags);
    /** see @ref hysock.c::hysock_ipv6_mreq_init "hysock_ipv6_mreq_init"*/
    I_32 (*sock_ipv6_mreq_init)
    ...
    I_32 (*sock_sockaddr_init6)
    (struct HyPortLibrary* portLibrary, hysockaddr_t handle, U_8* addr, I_32 addrlength, I_16 family, U_16 nPort,
    ...
    I_32 (*sock_select_read)
    (struct HyPortLibrary* portLibrary, hysocket_t hysocketP, I_32 secTime, I_32 uSecTime, BOOLEAN accept);
    ...
    I_32 (*sock_get_network_interfaces)
    ...
    I_32 (*sock_free_network_interface_struct)
    ...
    I_32 (*sock_connect_with_timeout)
    ...
    IDATA (*shsem_open)
    (struct HyPortLibrary* portLibrary, struct hyshsem_handle** handle, const char* semname, int setSize,
    ...
    IDATA (*shmem_open)
    (struct HyPortLibrary* portLibrary, struct hyshmem_handle** handle, const char* rootname, I_32 size, I_32 perm,
        UDATA flags);
    ...
    char* (*buf_write_text)(struct HyPortLibrary* portLibrary, const char* buf, IDATA nbytes);
    ...
    IDATA (*process_create)
    (struct HyPortLibrary* portLibrary, char* command[], UDATA commandLength, char* env[], UDATA envSize, char* dir,
        U_32 options, IDATA fdInput, IDATA fdOutput, IDATA fdError, struct HyProcessHandleStruct* processHandle);
    /** see @ref hymem.c::hyprocess_getStream "hyprocess_getStream"*/
    IDATA (*process_getStream)
    ...
    IDATA (*process_waitfor)(struct HyPortLibrary* portLibrary, HyProcessHandle processHandle);
    /** see @ref hymem.c::hyprocess_close "hyprocess_close"*/
    IDATA (*process_close)(struct HyPortLibrary* portLibrary, HyProcessHandle processHandle, U_32 options);
    /** see @ref hymem.c::hyprocess_isComplete "hyprocess_isComplete"*/
    IDATA (*process_isComplete)(struct HyPortLibrary* portLibrary, HyProcessHandle processHandle);
    /** see @ref hymem.c::hyprocess_terminate "hyprocess_terminate"*/
    IDATA (*process_terminate)(struct HyPortLibrary* portLibrary, HyProcessHandle processHandle);
    /** see @ref hymem.c::hyprocess_get_exitCode "hyprocess_get_exitCode"*/
    IDATA (*process_get_exitCode)(struct HyPortLibrary* portLibrary, HyProcessHandle processHandle);
    /** see @ref hymem.c::hyprocess_get_available "hyprocess_get_available"*/
    IDATA (*process_get_available)(struct HyPortLibrary* portLibrary, HyProcessHandle processHandle, UDATA flag);
...
#define HYPORT_CAPABILITY_MASK                                                                    \
    ((U_64)(HYPORT_CAPABILITY_STANDARD | HYPORT_CAPABILITY_FILESYSTEM | HYPORT_CAPABILITY_SOCKETS \
...
extern HY_CFUNC I_32 hyport_create_library(
    struct HyPortLibrary* portLibrary, struct HyPortLibraryVersion* version, UDATA size);
extern HY_CFUNC I_32 hyport_init_library(
    struct HyPortLibrary* portLibrary, struct HyPortLibraryVersion* version, UDATA size);
extern HY_CFUNC I_32 hyport_shutdown_library(struct HyPortLibrary* portLibrary);
extern HY_CFUNC I_32 hyport_startup_library(struct HyPortLibrary* portLibrary);
/** Port library self allocation routines */
extern HY_CFUNC I_32 hyport_allocate_library(
    struct HyPortLibraryVersion* expectedVersion, struct HyPortLibrary** portLibrary);
 ...
 * @{
 */
extern HY_CFUNC UDATA hyport_getSize(struct HyPortLibraryVersion* version);
extern HY_CFUNC I_32 hyport_getVersion(struct HyPortLibrary* portLibrary, struct HyPortLibraryVersion* version);
extern HY_CFUNC I_32 hyport_isCompatible(struct HyPortLibraryVersion* expectedVersion);
...
#define hyerror_set_last_error(param1, param2) \
    privatePortLibrary->error_set_last_error(privatePortLibrary, param1, param2)
#define hyerror_set_last_error_with_message(param1, param2) \
    privatePortLibrary->error_set_last_error_with_message(privatePortLibrary, param1, param2)
...
#define hytime_hires_delta(param1, param2, param3) \
    privatePortLibrary->time_hires_delta(privatePortLibrary, param1, param2, param3)
...
#define hysysinfo_get_env(param1, param2, param3) \
    privatePortLibrary->sysinfo_get_env(privatePortLibrary, param1, param2, param3)
...
#define hysysinfo_get_executable_name(param1, param2) \
    privatePortLibrary->sysinfo_get_executable_name(privatePortLibrary, param1, param2)
#define hysysinfo_get_number_CPUs() privatePortLibrary->sysinfo_get_number_CPUs(privatePortLibrary)
#define hysysinfo_get_username(param1, param2) \
    privatePortLibrary->sysinfo_get_username(privatePortLibrary, param1, param2)
...
#define hyfile_write_text(param1, param2, param3) \
    privatePortLibrary->file_write_text(privatePortLibrary, param1, param2, param3)
#define hybuf_write_text(param1, param2) privatePortLibrary->buf_write_text(privatePortLibrary, param1, param2)
#define hyfile_vprintf(param1, param2, param3) \
    privatePortLibrary->file_vprintf(privatePortLibrary, param1, param2, param3)
...
#define hysl_open_shared_library(param1, param2, param3) \
    privatePortLibrary->sl_open_shared_library(privatePortLibrary, param1, param2, param3)
#define hysl_lookup_name(param1, param2, param3, param4) \
    privatePortLibrary->sl_lookup_name(privatePortLibrary, param1, param2, param3, param4)
...
#define hymem_allocate_memory_callSite(param1, param2) \
    privatePortLibrary->mem_allocate_memory_callSite(privatePortLibrary, param1, param2)
#define hymem_free_memory(param1) privatePortLibrary->mem_free_memory(privatePortLibrary, param1)
#define hymem_reallocate_memory(param1, param2) \
    privatePortLibrary->mem_reallocate_memory(privatePortLibrary, param1, param2)
...
#define hyvmem_commit_memory(param1, param2, param3) \
    privatePortLibrary->vmem_commit_memory(privatePortLibrary, param1, param2, param3)
#define hyvmem_decommit_memory(param1, param2, param3) \
    privatePortLibrary->vmem_decommit_memory(privatePortLibrary, param1, param2, param3)
#define hyvmem_free_memory(param1, param2, param3) \
    privatePortLibrary->vmem_free_memory(privatePortLibrary, param1, param2, param3)
#define hyvmem_reserve_memory(param1, param2, param3, param4, param5) \
    privatePortLibrary->vmem_reserve_memory(privatePortLibrary, param1, param2, param3, param4, param5)
...
#define hygp_register_handler(param1, param2) \
    privatePortLibrary->gp_register_handler(privatePortLibrary, param1, param2)
#define hygp_info(param1, param2, param3, param4, param5) \
...
#define hystr_vprintf(param1, param2, param3, param4) \
    privatePortLibrary->str_vprintf(privatePortLibrary, param1, param2, param3, param4)
...
#define hydump_create(param1, param2, param3) \
    privatePortLibrary->dump_create(privatePortLibrary, param1, param2, param3)
...
#define hynls_set_catalog(param1, param2, param3, param4) \
    privatePortLibrary->nls_set_catalog(privatePortLibrary, param1, param2, param3, param4)
#define hynls_set_locale(param1, param2, param3) \
    privatePortLibrary->nls_set_locale(privatePortLibrary, param1, param2, param3)
...
#define hynls_vprintf(param1, param2, param3, param4) \
    privatePortLibrary->nls_vprintf(privatePortLibrary, param1, param2, param3, param4)
#define hynls_lookup_message(param1, param2, param3, param4) \
    privatePortLibrary->nls_lookup_message(privatePortLibrary, param1, param2, param3, param4)
...
#define hysig_protect(param1, param2, param3, param4, param5, param6) \
    privatePortLibrary->sig_protect(privatePortLibrary, param1, param2, param3, param4, param5, param6)
#define hysig_can_protect(param1) privatePortLibrary->sig_can_protect(privatePortLibrary, param1)
#define hysig_set_async_signal_handler(param1, param2, param3) \
    privatePortLibrary->sig_set_async_signal_handler(privatePortLibrary, param1, param2, param3)
#define hysig_info(param1, param2, param3, param4, param5) \
    privatePortLibrary->sig_info(privatePortLibrary, param1, param2, param3, param4, param5)
...
#define hyfile_read_text(param1, param2, param3) \
    privatePortLibrary->file_read_text(privatePortLibrary, param1, param2, param3)
...
#define hysock_accept(param1, param2, param3) \
...
#define hysock_gethostbyaddr(param1, param2, param3, param4) \
...
#define hysock_hostent_aliaslist(param1, param2) \
    privatePortLibrary->sock_hostent_aliaslist(privatePortLibrary, param1, param2)
#define hysock_hostent_hostname(param1, param2) \
...
#define hysock_ipmreq_init(param1, param2, param3) \
...
#define hysock_select_read(param1, param2, param3, param4) \
    privatePortLibrary->sock_select_read(privatePortLibrary, param1, param2, param3, param4)
#define hysock_set_nonblocking(param1, param2) \
...
#define hysock_get_network_interfaces(param1, param2) \
    privatePortLibrary->sock_get_network_interfaces(privatePortLibrary, param1, param2)
#define hysock_free_network_interface_struct(param1) \
    privatePortLibrary->sock_free_network_interface_struct(privatePortLibrary, param1)
#define hysock_connect_with_timeout(param1, param2, param3, param4, param5) \
...
#define hyshsem_open(param1, param2, param3, param4, param5) \
    privatePortLibrary->shsem_open(privatePortLibrary, param1, param2, param3, param4, param5)
...
#define hyshsem_setVal(param1, param2, param3) \
...
#define hyshmem_open(param1, param2, param3, param4, param5) \
    privatePortLibrary->shmem_open(privatePortLibrary, param1, param2, param3, param4, param5)
...
#define hynls_lookup_message(param1, param2, param3) \
    privatePortLibrary->nls_lookup_message(privatePortLibrary, param1, param2, param3)
#undef hynls_vprintf
#define hynls_vprintf(param1, param2, param3) \
    privatePortLibrary->hynls_vprintf(privatePortLibrary, param1, param2, param3)
#undef hymem_allocate_memory
#define hymem_allocate_memory(param1) \
    privatePortLibrary->mem_allocate_memory_callSite(privatePortLibrary, param1, HY_GET_CALLSITE())
#undef hymem_allocate_code_memory
#define hymem_allocate_code_memory(param1) \
    privatePortLibrary->mem_allocate_code_memory_callSite(privatePortLibrary, param1, HY_GET_CALLSITE())
...
#define hyprocess_create(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10) \
...
#define hyprocess_getStream(param1, param2, param3) \
