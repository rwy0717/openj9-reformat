...
I_32 hystub_port_shutdown_library(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9port_shutdown_library();
}

I_32 hystub_port_isFunctionOverridden(struct HyPortLibrary* portLibrary, UDATA offset)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9port_isFunctionOverridden(offset);
}

void hystub_port_tls_free(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9port_tls_free();
}

I_32 hystub_error_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9error_startup();
}

void hystub_error_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9error_shutdown();
}

I_32 hystub_error_last_error_number(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9error_last_error_number();
}

const char* hystub_error_last_error_message(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9error_last_error_message();
}

I_32 hystub_error_set_last_error(struct HyPortLibrary* portLibrary, I_32 platformCode, I_32 portableCode)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9error_set_last_error(platformCode, portableCode);
}

I_32 hystub_error_set_last_error_with_message(
    struct HyPortLibrary* portLibrary, I_32 portableCode, const char* errorMessage)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9error_set_last_error_with_message(portableCode, errorMessage);
}

I_32 hystub_time_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9time_startup();
}

void hystub_time_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9time_shutdown();
}
...
I_64 hystub_time_current_time_millis(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9time_current_time_millis();
}

U_64 hystub_time_hires_clock(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9time_hires_clock();
}

U_64 hystub_time_hires_frequency(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9time_hires_frequency();
}

U_64 hystub_time_hires_delta(struct HyPortLibrary* portLibrary, U_64 startTime, U_64 endTime, UDATA requiredResolution)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9time_hires_delta(startTime, endTime, requiredResolution);
}

I_32 hystub_sysinfo_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sysinfo_startup();
}
void hystub_sysinfo_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9sysinfo_shutdown();
}
...
U_64 hystub_sysinfo_get_physical_memory(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sysinfo_get_physical_memory();
}
const char* hystub_sysinfo_get_OS_version(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
const char* hystub_sysinfo_get_CPU_architecture(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sysinfo_get_CPU_architecture();
}

const char* hystub_sysinfo_get_OS_type(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sysinfo_get_OS_type();
}

U_16 hystub_sysinfo_get_classpathSeparator(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_file_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_startup();
}

void hystub_file_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9file_shutdown();
}
...
void hystub_file_vprintf(struct HyPortLibrary* portLibrary, IDATA fd, const char* format, va_list args)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9file_vprintf(fd, format, args);
}

void hystub_file_printf(struct HyPortLibrary* portLibrary, IDATA fd, const char* format, ...)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    va_list args;
...
I_32 hystub_file_close(struct HyPortLibrary* portLibrary, IDATA fd)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_close(fd);
}

I_64 hystub_file_seek(struct HyPortLibrary* portLibrary, IDATA fd, I_64 offset, I_32 whence)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_file_unlink(struct HyPortLibrary* portLibrary, const char* path)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_unlink(path);
}

I_32 hystub_file_attr(struct HyPortLibrary* portLibrary, const char* path)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_attr(path);
}

I_64 hystub_file_lastmod(struct HyPortLibrary* portLibrary, const char* path)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    I_64 rc;
...
I_64 hystub_file_length(struct HyPortLibrary* portLibrary, const char* path)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_length(path);
}

I_32 hystub_file_set_length(struct HyPortLibrary* portLibrary, IDATA fd, I_64 newLength)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_set_length(fd, newLength);
}

I_32 hystub_file_sync(struct HyPortLibrary* portLibrary, IDATA fd)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_sync(fd);
}

I_32 hystub_sl_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sl_startup();
}

void hystub_sl_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9sl_shutdown();
}
...
UDATA
hystub_sl_lookup_name(
    struct HyPortLibrary* portLibrary, UDATA descriptor, char* name, UDATA* func, const char* argSignature)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sl_lookup_name(descriptor, name, func, argSignature);
}

I_32 hystub_tty_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9tty_startup();
}

void hystub_tty_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9tty_shutdown();
}

void hystub_tty_printf(struct HyPortLibrary* portLibrary, const char* format, ...)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    va_list args;
...
void hystub_tty_vprintf(struct HyPortLibrary* portLibrary, const char* format, va_list args)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9tty_vprintf(format, args);
}
...
void hystub_tty_err_printf(struct HyPortLibrary* portLibrary, const char* format, ...)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    va_list args;
...
void hystub_tty_err_vprintf(struct HyPortLibrary* portLibrary, const char* format, va_list args)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9tty_err_vprintf(format, args);
}
...
I_32 hystub_mem_startup(struct HyPortLibrary* portLibrary, UDATA portGlobalSize)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9mem_startup(portGlobalSize);
}

void hystub_mem_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9mem_shutdown();
}

void* hystub_mem_allocate_memory(struct HyPortLibrary* portLibrary, UDATA byteAmount)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9mem_allocate_memory(byteAmount, J9MEM_CATEGORY_HARMONY);
}

void* hystub_mem_allocate_memory_callSite(struct HyPortLibrary* portLibrary, UDATA byteAmount, char* callSite)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return OMRPORT_FROM_J9PORT(PORTLIB)->mem_allocate_memory(
        OMRPORT_FROM_J9PORT(PORTLIB), byteAmount, callSite, J9MEM_CATEGORY_HARMONY);
}

void hystub_mem_free_memory(struct HyPortLibrary* portLibrary, void* memoryPointer)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9mem_free_memory(memoryPointer);
}

void* hystub_mem_reallocate_memory(struct HyPortLibrary* portLibrary, void* memoryPointer, UDATA byteAmount)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return OMRPORT_FROM_J9PORT(PORTLIB)->mem_reallocate_memory(
        OMRPORT_FROM_J9PORT(PORTLIB), memoryPointer, byteAmount, NULL, J9MEM_CATEGORY_HARMONY);
}

I_32 hystub_cpu_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9cpu_startup();
}

void hystub_cpu_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9cpu_shutdown();
}

void hystub_cpu_flush_icache(struct HyPortLibrary* portLibrary, void* memoryPointer, UDATA byteAmount)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9cpu_flush_icache(memoryPointer, byteAmount);
}

I_32 hystub_vmem_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9vmem_startup();
}

void hystub_vmem_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9vmem_shutdown();
}

void* hystub_vmem_commit_memory(
    struct HyPortLibrary* portLibrary, void* address, UDATA byteAmount, struct HyPortVmemIdentifier* identifier)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
void* hystub_vmem_reserve_memory(struct HyPortLibrary* portLibrary, void* address, UDATA byteAmount,
    struct HyPortVmemIdentifier* identifier, UDATA mode, UDATA pageSize)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9vmem_reserve_memory(
        address, byteAmount, (struct J9PortVmemIdentifier*)identifier, mode, pageSize, J9MEM_CATEGORY_HARMONY);
}

UDATA* hystub_vmem_supported_page_sizes(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9vmem_supported_page_sizes();
}

I_32 hystub_sock_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_startup();
}

I_32 hystub_sock_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_shutdown();
}

U_16 hystub_sock_htons(struct HyPortLibrary* portLibrary, U_16 val)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_htons(val);
}

I_32 hystub_sock_write(struct HyPortLibrary* portLibrary, hysocket_t sock, U_8* buf, I_32 nbyte, I_32 flags)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_write((j9socket_t)sock, buf, nbyte, flags);
}

I_32 hystub_sock_sockaddr(struct HyPortLibrary* portLibrary, hysockaddr_t handle, char* addrStr, U_16 port)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_sockaddr((j9sockaddr_t)handle, addrStr, port);
}

I_32 hystub_sock_read(struct HyPortLibrary* portLibrary, hysocket_t sock, U_8* buf, I_32 nbyte, I_32 flags)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_read((j9socket_t)sock, buf, nbyte, flags);
}

I_32 hystub_sock_socket(
    struct HyPortLibrary* portLibrary, hysocket_t* handle, I_32 family, I_32 socktype, I_32 protocol)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_socket((j9socket_t*)handle, family, socktype, protocol);
}

I_32 hystub_sock_close(struct HyPortLibrary* portLibrary, hysocket_t* sock)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_close((j9socket_t*)sock);
}

I_32 hystub_sock_connect(struct HyPortLibrary* portLibrary, hysocket_t sock, hysockaddr_t addr)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_connect((j9socket_t)sock, (j9sockaddr_t)addr);
}

I_32 hystub_sock_inetaddr(struct HyPortLibrary* portLibrary, char* addrStr, U_32* addr)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_inetaddr(addrStr, addr);
}

I_32 hystub_sock_gethostbyname(struct HyPortLibrary* portLibrary, char* name, hyhostent_t handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_gethostbyname(name, (j9hostent_t)handle);
}

I_32 hystub_sock_hostent_addrlist(struct HyPortLibrary* portLibrary, hyhostent_t handle, U_32 index)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_hostent_addrlist((j9hostent_t)handle, index);
}

I_32 hystub_sock_sockaddr_init(
    struct HyPortLibrary* portLibrary, hysockaddr_t handle, I_16 family, U_32 nipAddr, U_16 port)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_sockaddr_init((j9sockaddr_t)handle, family, nipAddr, port);
}

I_32 hystub_sock_linger_init(struct HyPortLibrary* portLibrary, hylinger_t handle, I_32 enabled, U_16 timeout)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_linger_init((j9linger_t)handle, enabled, timeout);
}

I_32 hystub_sock_setopt_linger(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, hylinger_t optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_setopt_linger((j9socket_t)socketP, optlevel, optname, (j9linger_t)optval);
}

I_32 hystub_gp_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9gp_startup();
}

void hystub_gp_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9gp_shutdown();
}
...
void hystub_gp_register_handler(struct HyPortLibrary* portLibrary, handler_fn fn, void* aUserData)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
U_32 hystub_gp_info(
    struct HyPortLibrary* portLibrary, void* info, U_32 category, I_32 index, const char** name, void** value)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9gp_info(info, category, index, name, value);
}

U_32 hystub_gp_info_count(struct HyPortLibrary* portLibrary, void* info, U_32 category)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9gp_info_count(info, category);
}

void hystub_gp_handler_function(void* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)((HyPortLibrary*)portLibrary)->self_handle);
    j9gp_handler_function();
}

I_32 hystub_str_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9str_startup();
}

void hystub_str_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9str_shutdown();
}

U_32 hystub_str_printf(struct HyPortLibrary* portLibrary, char* buf, U_32 bufLen, const char* format, ...)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    U_32 rc;
    va_list args;
...
U_32 hystub_str_vprintf(struct HyPortLibrary* portLibrary, char* buf, U_32 bufLen, const char* format, va_list args)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    IDATA actualLen;
...
I_32 hystub_exit_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9exit_startup();
}

void hystub_exit_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9exit_shutdown();
}

I_32 hystub_exit_get_exit_code(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9exit_get_exit_code();
}

void hystub_exit_shutdown_and_exit(struct HyPortLibrary* portLibrary, I_32 exitCode)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_nls_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9nls_startup();
}

void hystub_nls_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9nls_shutdown();
}

void hystub_nls_set_catalog(struct HyPortLibrary* portLibrary, const char** paths, const int nPaths,
...
void hystub_nls_set_locale(struct HyPortLibrary* portLibrary, const char* lang, const char* region, const char* variant)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9nls_set_locale(lang, region, variant);
}

const char* hystub_nls_get_language(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9nls_get_language();
}

const char* hystub_nls_get_region(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9nls_get_region();
}

const char* hystub_nls_get_variant(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9nls_get_variant();
}

void hystub_nls_printf(struct HyPortLibrary* portLibrary, UDATA flags, U_32 module_name, U_32 message_num, ...)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    va_list(args);
...
void hystub_nls_vprintf(
    struct HyPortLibrary* portLibrary, UDATA flags, U_32 module_name, U_32 message_num, va_list args)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9nls_vprintf(flags, module_name, message_num, args);
}

const char* hystub_nls_lookup_message(
    struct HyPortLibrary* portLibrary, UDATA flags, U_32 module_name, U_32 message_num, const char* default_string)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return OMRPORT_FROM_J9PORT(PORTLIB)->nls_lookup_message(
        OMRPORT_FROM_J9PORT(PORTLIB), flags, module_name, message_num, default_string);
}

I_32 hystub_ipcmutex_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9ipcmutex_startup();
}

void hystub_ipcmutex_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9ipcmutex_shutdown();
}

I_32 hystub_ipcmutex_acquire(struct HyPortLibrary* portLibrary, const char* name)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9ipcmutex_acquire(name);
}

I_32 hystub_ipcmutex_release(struct HyPortLibrary* portLibrary, const char* name)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9ipcmutex_release(name);
}

I_32 hystub_port_control(struct HyPortLibrary* portLibrary, char* key, UDATA value)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    ...
    if (0 == strcmp(J9PORT_CTLDATA_SHMEM_CONTROL_DIR, key)) {
        if ((value != 0) && (ctrlDirName == NULL)) {
            /* ctrlDirName is set to NULL in shim portlibrary startup and conditionally freed in shim portlibrary
             * shutdown */
...
I_32 hystub_sig_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sig_startup();
}

void hystub_sig_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9sig_shutdown();
}

I_32 hystub_sig_protect(struct HyPortLibrary* portLibrary, hysig_protected_fn fn, void* fn_arg,
    hysig_handler_fn handler, void* handler_arg, U_32 flags, UDATA* result)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sig_protect((j9sig_protected_fn)fn, fn_arg, (j9sig_handler_fn)handler, handler_arg, flags, result);
}

I_32 hystub_sig_can_protect(struct HyPortLibrary* portLibrary, U_32 flags)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sig_can_protect(flags);
}

I_32 hystub_sig_set_async_signal_handler(
    struct HyPortLibrary* portLibrary, hysig_handler_fn handler, void* handler_arg, U_32 flags)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sig_set_async_signal_handler((j9sig_handler_fn)handler, handler_arg, flags);
}

U_32 hystub_sig_info(
    struct HyPortLibrary* portLibrary, void* info, U_32 category, I_32 index, const char** name, void** value)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
U_32 hystub_sig_info_count(struct HyPortLibrary* portLibrary, void* info, U_32 category)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sig_info_count(info, category);
}

I_32 hystub_sig_set_options(struct HyPortLibrary* portLibrary, U_32 options)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sig_set_options(options);
}

U_32 hystub_sig_get_options(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
char* hystub_file_read_text(struct HyPortLibrary* portLibrary, IDATA fd, char* buf, IDATA nbytes)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_read_text(fd, buf, nbytes);
}

I_32 hystub_file_mkdir(struct HyPortLibrary* portLibrary, const char* path)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_mkdir(path);
}

I_32 hystub_file_move(struct HyPortLibrary* portLibrary, const char* pathExist, const char* pathNew)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_move(pathExist, pathNew);
}

I_32 hystub_file_unlinkdir(struct HyPortLibrary* portLibrary, const char* path)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_file_findnext(struct HyPortLibrary* portLibrary, UDATA findhandle, char* resultbuf)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_findnext(findhandle, resultbuf);
}

void hystub_file_findclose(struct HyPortLibrary* portLibrary, UDATA findhandle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9file_findclose(findhandle);
}

const char* hystub_file_error_message(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9file_error_message();
}

I_32 hystub_sock_htonl(struct HyPortLibrary* portLibrary, I_32 val)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_htonl(val);
}

I_32 hystub_sock_bind(struct HyPortLibrary* portLibrary, hysocket_t sock, hysockaddr_t addr)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_bind((j9socket_t)sock, (j9sockaddr_t)addr);
}

I_32 hystub_sock_accept(
    struct HyPortLibrary* portLibrary, hysocket_t serverSock, hysockaddr_t addrHandle, hysocket_t* sockHandle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_accept((j9socket_t)serverSock, (j9sockaddr_t)addrHandle, (j9socket_t*)sockHandle);
}

I_32 hystub_sock_shutdown_input(struct HyPortLibrary* portLibrary, hysocket_t sock)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_shutdown_input((j9socket_t)sock);
}

I_32 hystub_sock_shutdown_output(struct HyPortLibrary* portLibrary, hysocket_t sock)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_shutdown_output((j9socket_t)sock);
}

I_32 hystub_sock_listen(struct HyPortLibrary* portLibrary, hysocket_t sock, I_32 backlog)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_listen((j9socket_t)sock, backlog);
}

I_32 hystub_sock_ntohl(struct HyPortLibrary* portLibrary, I_32 val)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_ntohl(val);
}

U_16 hystub_sock_ntohs(struct HyPortLibrary* portLibrary, U_16 val)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_ntohs(val);
}

I_32 hystub_sock_getpeername(struct HyPortLibrary* portLibrary, hysocket_t handle, hysockaddr_t addrHandle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getpeername((j9socket_t)handle, (j9sockaddr_t)addrHandle);
}

I_32 hystub_sock_getsockname(struct HyPortLibrary* portLibrary, hysocket_t handle, hysockaddr_t addrHandle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getsockname((j9socket_t)handle, (j9sockaddr_t)addrHandle);
}

I_32 hystub_sock_readfrom(
    struct HyPortLibrary* portLibrary, hysocket_t sock, U_8* buf, I_32 nbyte, I_32 flags, hysockaddr_t addrHandle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_readfrom((j9socket_t)sock, buf, nbyte, flags, (j9sockaddr_t)addrHandle);
}

I_32 hystub_sock_select(struct HyPortLibrary* portLibrary, I_32 nfds, hyfdset_t readfds, hyfdset_t writefds,
...
I_32 hystub_sock_inetntoa(struct HyPortLibrary* portLibrary, char** addrStr, U_32 nipAddr)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_inetntoa(addrStr, nipAddr);
}

I_32 hystub_sock_gethostbyaddr(
    struct HyPortLibrary* portLibrary, char* addr, I_32 length, I_32 type, hyhostent_t handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_gethostbyaddr(addr, length, type, (j9hostent_t)handle);
}

I_32 hystub_sock_gethostname(struct HyPortLibrary* portLibrary, char* buffer, I_32 length)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_gethostname(buffer, length);
}

I_32 hystub_sock_hostent_aliaslist(struct HyPortLibrary* portLibrary, hyhostent_t handle, char*** aliasList)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_hostent_aliaslist((j9hostent_t)handle, aliasList);
}

I_32 hystub_sock_hostent_hostname(struct HyPortLibrary* portLibrary, hyhostent_t handle, char** hostName)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_hostent_hostname((j9hostent_t)handle, hostName);
}

U_16 hystub_sock_sockaddr_port(struct HyPortLibrary* portLibrary, hysockaddr_t handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_sockaddr_port((j9sockaddr_t)handle);
}

I_32 hystub_sock_sockaddr_address(struct HyPortLibrary* portLibrary, hysockaddr_t handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_sockaddr_address(handle);
}

I_32 hystub_sock_fdset_init(struct HyPortLibrary* portLibrary, hysocket_t socketP)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_fdset_init((j9socket_t)socketP);
}

I_32 hystub_sock_fdset_size(struct HyPortLibrary* portLibrary, hysocket_t handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_fdset_size((j9socket_t)handle);
}

I_32 hystub_sock_timeval_init(struct HyPortLibrary* portLibrary, U_32 secTime, U_32 uSecTime, hytimeval_t timeP)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_timeval_init(secTime, uSecTime, (j9timeval_t)timeP);
}

I_32 hystub_sock_getopt_int(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, I_32* optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getopt_int((j9socket_t)socketP, optlevel, optname, optval);
}

I_32 hystub_sock_setopt_int(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, I_32* optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_sock_getopt_bool(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, BOOLEAN* optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getopt_bool((j9socket_t)socketP, optlevel, optname, optval);
}

I_32 hystub_sock_setopt_bool(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, BOOLEAN* optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_sock_getopt_byte(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, U_8* optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getopt_byte((j9socket_t)socketP, optlevel, optname, optval);
}

I_32 hystub_sock_setopt_byte(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, U_8* optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_sock_getopt_linger(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, hylinger_t optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_sock_getopt_sockaddr(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, hysockaddr_t optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getopt_sockaddr((j9socket_t)socketP, optlevel, optname, (j9sockaddr_t)optval);
}

I_32 hystub_sock_setopt_sockaddr(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, hysockaddr_t optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_sock_setopt_ipmreq(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, hyipmreq_t optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_setopt_ipmreq((j9socket_t)socketP, optlevel, optname, (j9ipmreq_t)optval);
}

I_32 hystub_sock_linger_enabled(struct HyPortLibrary* portLibrary, hylinger_t handle, BOOLEAN* enabled)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_linger_enabled((j9linger_t)handle, enabled);
}

I_32 hystub_sock_linger_linger(struct HyPortLibrary* portLibrary, hylinger_t handle, U_16* linger)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_linger_linger((j9linger_t)handle, linger);
}

I_32 hystub_sock_ipmreq_init(struct HyPortLibrary* portLibrary, hyipmreq_t handle, U_32 nipmcast, U_32 nipinterface)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_ipmreq_init((j9ipmreq_t)handle, nipmcast, nipinterface);
}

I_32 hystub_sock_setflag(struct HyPortLibrary* portLibrary, I_32 flag, I_32* arg)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_setflag(flag, arg);
}

I_32 hystub_sock_freeaddrinfo(struct HyPortLibrary* portLibrary, hyaddrinfo_t handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_freeaddrinfo((j9addrinfo_t)handle);
}

I_32 hystub_sock_getaddrinfo(struct HyPortLibrary* portLibrary, char* name, hyaddrinfo_t hints, hyaddrinfo_t result)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getaddrinfo(name, (j9addrinfo_t)hints, (j9addrinfo_t)result);
}

I_32 hystub_sock_getaddrinfo_address(
    struct HyPortLibrary* portLibrary, hyaddrinfo_t handle, U_8* address, int index, U_32* scope_id)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    I_32 rc;
...
I_32 hystub_sock_getaddrinfo_create_hints(
    struct HyPortLibrary* portLibrary, hyaddrinfo_t* handle, I_16 family, I_32 socktype, I_32 protocol, I_32 flags)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getaddrinfo_create_hints((j9addrinfo_t*)handle, family, socktype, protocol, flags);
}

I_32 hystub_sock_getaddrinfo_family(struct HyPortLibrary* portLibrary, hyaddrinfo_t handle, I_32* family, int index)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getaddrinfo_family((j9addrinfo_t)handle, family, index);
}

I_32 hystub_sock_getaddrinfo_length(struct HyPortLibrary* portLibrary, hyaddrinfo_t handle, I_32* length)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getaddrinfo_length((j9addrinfo_t)handle, length);
}

I_32 hystub_sock_getaddrinfo_name(struct HyPortLibrary* portLibrary, hyaddrinfo_t handle, char* name, int index)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_getaddrinfo_name((j9addrinfo_t)handle, name, index);
}

I_32 hystub_sock_getnameinfo(struct HyPortLibrary* portLibrary, hysockaddr_t in_addr, I_32 sockaddr_size, char* name,
...
I_32 hystub_sock_ipv6_mreq_init(
    struct HyPortLibrary* portLibrary, hyipv6_mreq_t handle, U_8* ipmcast_addr, U_32 ipv6mr_interface)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_ipv6_mreq_init((j9ipv6_mreq_t)handle, ipmcast_addr, ipv6mr_interface);
}

I_32 hystub_sock_setopt_ipv6_mreq(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, hyipv6_mreq_t optval)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_setopt_ipv6_mreq((j9socket_t)socketP, optlevel, optname, (j9ipv6_mreq_t)optval);
}

I_32 hystub_sock_sockaddr_address6(
    struct HyPortLibrary* portLibrary, hysockaddr_t handle, U_8* address, U_32* length, U_32* scope_id)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_sockaddr_address6((j9sockaddr_t)handle, address, length, scope_id);
}

I_32 hystub_sock_sockaddr_family(struct HyPortLibrary* portLibrary, I_16* family, hysockaddr_t handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_sockaddr_family(family, (hysockaddr_t)handle);
}

I_32 hystub_sock_sockaddr_init6(struct HyPortLibrary* portLibrary, hysockaddr_t handle, U_8* addr, I_32 addrlength,
    I_16 family, U_16 nPort, U_32 flowinfo, U_32 scope_id, hysocket_t sock)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_sockaddr_init6(
        (j9sockaddr_t)handle, addr, addrlength, family, nPort, flowinfo, scope_id, (j9socket_t)sock);
}

I_32 hystub_sock_socketIsValid(struct HyPortLibrary* portLibrary, hysocket_t handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_socketIsValid((j9socket_t)handle);
}

I_32 hystub_sock_select_read(
    struct HyPortLibrary* portLibrary, hysocket_t socketP, I_32 secTime, I_32 uSecTime, BOOLEAN accept)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_select_read((j9socket_t)socketP, secTime, uSecTime, accept);
}

I_32 hystub_sock_set_nonblocking(struct HyPortLibrary* portLibrary, hysocket_t socketP, BOOLEAN nonblocking)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_set_nonblocking((j9socket_t)socketP, nonblocking);
}

const char* hystub_sock_error_message(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_error_message();
}

I_32 hystub_sock_get_network_interfaces(
    struct HyPortLibrary* portLibrary, struct hyNetworkInterfaceArray_struct* array, BOOLEAN preferIPv4Stack)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_get_network_interfaces((struct j9NetworkInterfaceArray_struct*)array, preferIPv4Stack);
}

I_32 hystub_sock_free_network_interface_struct(
    struct HyPortLibrary* portLibrary, struct hyNetworkInterfaceArray_struct* array)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_free_network_interface_struct((struct j9NetworkInterfaceArray_struct*)array);
}

I_32 hystub_sock_connect_with_timeout(
    struct HyPortLibrary* portLibrary, hysocket_t sock, hysockaddr_t addr, U_32 timeout, U_32 step, U_8** context)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9sock_connect_with_timeout((j9socket_t)sock, (j9sockaddr_t)addr, timeout, step, context);
}

U_32 hystub_strftime(struct HyPortLibrary* portLibrary, char* buf, U_32 bufLen, const char* format)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return (U_32)j9str_ftime(buf, bufLen, format, j9time_current_time_millis());
}

I_32 hystub_mmap_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9mmap_startup();
}

void hystub_mmap_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9mmap_shutdown();
}

I_32 hystub_mmap_capabilities(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9mmap_capabilities();
}

void* hystub_mmap_map_file(struct HyPortLibrary* portLibrary, const char* path, void** handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
void hystub_mmap_unmap_file(struct HyPortLibrary* portLibrary, void* handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9mmap_unmap_file(handle);
}

I_32 hystub_shsem_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9shsem_deprecated_startup();
}

void hystub_shsem_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
IDATA
hystub_shsem_open(struct HyPortLibrary* portLibrary, struct hyshsem_handle** handle, const char* semname, int setSize,
    int permission, UDATA flags)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    ensureDirectory(portLibrary);
    return j9shsem_deprecated_open(
        cacheDirName, groupPerm, (struct j9shsem_handle**)handle, semname, setSize, permission, flags, NULL);
}
...
void hystub_shsem_close(struct HyPortLibrary* portLibrary, struct hyshsem_handle** handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_shmem_startup(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    ctrlDirName = NULL;
    cacheDirName = NULL;
...
void hystub_shmem_shutdown(struct HyPortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    if (ctrlDirName) {
...
IDATA
hystub_shmem_open(struct HyPortLibrary* portLibrary, struct hyshmem_handle** handle, const char* rootname, I_32 size,
    I_32 perm, UDATA flags)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    ensureDirectory(portLibrary);
    return j9shmem_open(cacheDirName, groupPerm, (struct j9shmem_handle**)handle, rootname, (UDATA)size, (U_32)perm,
        J9MEM_CATEGORY_HARMONY, flags, NULL);
}

void* hystub_shmem_attach(struct HyPortLibrary* portLibrary, struct hyshmem_handle* handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
void hystub_shmem_close(struct HyPortLibrary* portLibrary, struct hyshmem_handle** handle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
I_32 hystub_shmem_findnext(struct HyPortLibrary* portLibrary, UDATA findhandle, char* resultbuf)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9shmem_findnext(findhandle, resultbuf);
}

void hystub_shmem_findclose(struct HyPortLibrary* portLibrary, UDATA findhandle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
char* hystub_buf_write_text(struct HyPortLibrary* portLibrary, const char* buf, IDATA nbytes)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
HyThreadLibrary* hystub_port_get_thread_library(struct HyPortLibrary* portLibrary)
{
    return (HyThreadLibrary*)portLibrary->portGlobals;
}

void hystub_sock_fdset_zero(struct HyPortLibrary* portLibrary, hyfdset_t hyfdset)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    j9sock_fdset_zero((j9fdset_t)hyfdset);
}
void hystub_sock_fdset_set(struct HyPortLibrary* portLibrary, hysocket_t aSocket, hyfdset_t hyfdset)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
IDATA
hystub_process_create(struct HyPortLibrary* portLibrary, char* command[], UDATA commandLength, char* env[],
    UDATA envSize, char* dir, U_32 options, IDATA fdInput, IDATA fdOutput, IDATA fdError,
    struct HyProcessHandleStruct* processHandle)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
    return j9process_create((const char**)command, commandLength, env, envSize, dir, options, fdInput, fdOutput,
        fdError, (J9ProcessHandle*)processHandle);
}

IDATA
hystub_process_getStream(
    struct HyPortLibrary* portLibrary, HyProcessHandle processHandle, UDATA streamFlag, IDATA* stream)
{
    PORT_ACCESS_FROM_PORT((J9PortLibrary*)portLibrary->self_handle);
...
J9_CFUNC I_32 hyport_allocate_library_maptoj9(
    struct J9PortLibrary* j9PortLib, struct HyPortLibraryVersion* expectedVersion, struct HyPortLibrary** portLibrary)
{
    ...
    *portLibrary = j9mem_allocate_memory(sizeof(struct HyPortLibrary), J9MEM_CATEGORY_HARMONY);
    ...
    hyPortLib->error_set_last_error_with_message
        = hystub_error_set_last_error_with_message; /* error_set_last_error_with_message */
    ...
    hyPortLib->sysinfo_get_classpathSeparator
        = hystub_sysinfo_get_classpathSeparator; /* sysinfo_get_classpathSeparator */
    ...
    hyPortLib->sysinfo_weak_memory_consistency
        = hystub_sysinfo_weak_memory_consistency; /* sysinfo_weak_memory_consistency */
    ...
    hyPortLib->sock_free_network_interface_struct
        = hystub_sock_free_network_interface_struct; /* sock_free_network_interface_struct */
    ...
    hyPortLib->sysinfo_get_processing_capacity
        = hystub_sysinfo_get_processing_capacity; /* sysinfo_get_processing_capacity */
