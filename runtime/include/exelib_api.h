 ...
 * @return I_32
 */
I_32 main_prependToClassPath(J9PortLibrary* portLib, U_16 sep, J9StringBuffer** classPath, char* toPrepend);
 ...
 * @return void
 */
void memoryCheck_print_report(J9PortLibrary* portLib);
