 ...
 * @htmlonly <a name='VMIExports'>&nbsp;</a> @endhtmlonly Non-table VM interface functions. Directly exported from the
 * VMI library.
 */
 ...
 *
 * @code vmiError JNICALL IterateSystemProperties(VMInterface* vmi, vmiSystemPropertyIterator iterator, void* userData);
 * @endcode
 *
 * @param[in] vmi  The VM interface pointer
