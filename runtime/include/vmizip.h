...
typedef struct VMIZipFunctionTable {
    ...
    (VMInterface* vmi, VMIZipFile* zipFile, VMIZipEntry* entry, const char* filename, I_32 flags);
    ...
    (VMInterface* vmi, VMIZipFile* zipFile, VMIZipEntry* entry, IDATA offset, I_32 flags);
    I_32 (*zip_getZipEntryRawData)
    (VMInterface* vm, VMIZipFile* zipFile, VMIZipEntry* entry, U_8* buffer, U_32 bufferSize, U_32 offset);
