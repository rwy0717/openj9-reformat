...
typedef struct J9ZipFunctionTable {
    ...
    (J9PortLibrary* portLib, J9ZipFile* zipFile, J9ZipEntry* zipEntry, IDATA* nextEntryPointer,
        BOOLEAN readDataPointer);
    I_32 (*zip_getZipComment)(J9PortLibrary* portLib, J9ZipFile* zipFile, U_8** commentString, UDATA* commentLength);
    I_32 (*zip_getZipEntry)
    (J9PortLibrary* portLib, J9ZipFile* zipFile, J9ZipEntry* entry, const char* filename, IDATA fileNameLength,
        U_32 flags);
    ...
    (J9PortLibrary* portLib, char* filename, J9ZipFile* zipFile, J9ZipCachePool* cachePool, U_32 flags);
 ...
 * @return J9ZipCache *
 */
J9ZipCache* zipCachePool_findCache(
    J9ZipCachePool* zcp, char const* zipFileName, IDATA zipFileNameLength, IDATA zipFileSize, I_64 zipTimeStamp);
...
void zip_triggerZipLoadHook(J9PortLibrary* portLib, const char* filename, UDATA newState, J9ZipCachePool* cachePool);
