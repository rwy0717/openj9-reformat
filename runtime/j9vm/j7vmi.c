...
static J9ThreadEnv* getJ9ThreadEnv(JNIEnv* env)
{
    JavaVM* jniVM;
 ...
 */
void JNICALL JVM_ArrayCopy(
    JNIEnv* env, jclass ignored, jobject src, jint src_pos, jobject dst, jint dst_pos, jint length)
{
        ...
        if (J9CLASS_IS_ARRAY(srcArrayClass) && J9CLASS_IS_ARRAY(dstArrayClass)) {
            if ((src_pos < 0) || (dst_pos < 0) || (length < 0)
                ...
                vmFuncs->setCurrentException(
                    currentThread, J9VMCONSTANTPOOL_JAVALANGARRAYINDEXOUTOFBOUNDSEXCEPTION, NULL);
            } else {
                ...
                if (J9ROMCLASS_IS_PRIMITIVE_TYPE(srcTypeOfArray->romClass)
                        ...
                        if (vm->longReflectClass == srcTypeOfArray) {
                            if ((srcArray == dstArray) && (((src_pos < dst_pos) && (src_pos + length > dst_pos)))) {
                                for (i = length - 1; i >= 0; i--) {
                                    J9JAVAARRAYOFLONG_STORE(currentThread, dstArray, i + dst_pos,
                                        J9JAVAARRAYOFLONG_LOAD(currentThread, srcArray, i + src_pos));
                                }
                            } else {
                                for (i = 0; i < length; i++) {
                                    J9JAVAARRAYOFLONG_STORE(currentThread, dstArray, i + dst_pos,
                            ...
                            if ((srcArray == dstArray) && (((src_pos < dst_pos) && (src_pos + length > dst_pos)))) {
                                for (i = length - 1; i >= 0; i--) {
                                    J9JAVAARRAYOFBOOLEAN_STORE(currentThread, dstArray, i + dst_pos,
                                        J9JAVAARRAYOFBOOLEAN_LOAD(currentThread, srcArray, i + src_pos));
                                }
                            } else {
                                for (i = 0; i < length; i++) {
                                    J9JAVAARRAYOFBOOLEAN_STORE(currentThread, dstArray, i + dst_pos,
                            ...
                            if ((srcArray == dstArray) && (((src_pos < dst_pos) && (src_pos + length > dst_pos)))) {
                                for (i = length - 1; i >= 0; i--) {
                                    J9JAVAARRAYOFBYTE_STORE(currentThread, dstArray, i + dst_pos,
                                        J9JAVAARRAYOFBYTE_LOAD(currentThread, srcArray, i + src_pos));
                                }
                            } else {
                                for (i = 0; i < length; i++) {
                                    J9JAVAARRAYOFBYTE_STORE(currentThread, dstArray, i + dst_pos,
                            ...
                            if ((srcArray == dstArray) && (((src_pos < dst_pos) && (src_pos + length > dst_pos)))) {
                                for (i = length - 1; i >= 0; i--) {
                                    J9JAVAARRAYOFCHAR_STORE(currentThread, dstArray, i + dst_pos,
                                        J9JAVAARRAYOFCHAR_LOAD(currentThread, srcArray, i + src_pos));
                                }
                            } else {
                                for (i = 0; i < length; i++) {
                                    J9JAVAARRAYOFCHAR_STORE(currentThread, dstArray, i + dst_pos,
                            ...
                            if ((srcArray == dstArray) && (((src_pos < dst_pos) && (src_pos + length > dst_pos)))) {
                                for (i = length - 1; i >= 0; i--) {
                                    J9JAVAARRAYOFSHORT_STORE(currentThread, dstArray, i + dst_pos,
                                        J9JAVAARRAYOFSHORT_LOAD(currentThread, srcArray, i + src_pos));
                                }
                            } else {
                                for (i = 0; i < length; i++) {
                                    J9JAVAARRAYOFSHORT_STORE(currentThread, dstArray, i + dst_pos,
                            ...
                            if ((srcArray == dstArray) && (((src_pos < dst_pos) && (src_pos + length > dst_pos)))) {
                                for (i = length - 1; i >= 0; i--) {
                                    J9JAVAARRAYOFINT_STORE(currentThread, dstArray, i + dst_pos,
                                        J9JAVAARRAYOFINT_LOAD(currentThread, srcArray, i + src_pos));
                                }
                            } else {
                                for (i = 0; i < length; i++) {
                                    J9JAVAARRAYOFINT_STORE(currentThread, dstArray, i + dst_pos,
                            ...
                            if ((srcArray == dstArray) && (((src_pos < dst_pos) && (src_pos + length > dst_pos)))) {
                                for (i = length - 1; i >= 0; i--) {
                                    J9JAVAARRAYOFFLOAT_STORE(currentThread, dstArray, i + dst_pos,
                                        J9JAVAARRAYOFFLOAT_LOAD(currentThread, srcArray, i + src_pos));
                                }
                            } else {
                                for (i = 0; i < length; i++) {
                                    J9JAVAARRAYOFFLOAT_STORE(currentThread, dstArray, i + dst_pos,
                            ...
                            if ((srcArray == dstArray) && (((src_pos < dst_pos) && (src_pos + length > dst_pos)))) {
                                for (i = length - 1; i >= 0; i--) {
                                    J9JAVAARRAYOFDOUBLE_STORE(currentThread, dstArray, i + dst_pos,
                                        J9JAVAARRAYOFDOUBLE_LOAD(currentThread, srcArray, i + src_pos));
                                }
                            } else {
                                for (i = 0; i < length; i++) {
                                    J9JAVAARRAYOFDOUBLE_STORE(currentThread, dstArray, i + dst_pos,
                            ...
                            vmFuncs->setCurrentException(
                                currentThread, J9VMCONSTANTPOOL_JAVALANGILLEGALARGUMENTEXCEPTION, NULL);
                        }
                    } else {
                    ...
                    if (srcArray == dstArray) {
                        if ((((src_pos < dst_pos) && (src_pos + length > dst_pos)))) {
                            for (i = length - 1; i >= 0; i--) {
                                J9JAVAARRAYOFOBJECT_STORE(currentThread, dstArray, i + dst_pos,
                                    J9JAVAARRAYOFOBJECT_LOAD(currentThread, srcArray, i + src_pos));
                            }
                        } else {
                            for (i = 0; i < length; i++) {
                                J9JAVAARRAYOFOBJECT_STORE(currentThread, dstArray, i + dst_pos,
                        ...
                        for (i = 0; i < length; i++) {
                            ...
                            if (NULL == srcObject) {
                                ...
                                if (isSameOrSuperClassOf(dstTypeOfArray, srcObjectClass)) {
                                    ...
                                    vmFuncs->setCurrentException(
                                        currentThread, J9VMCONSTANTPOOL_JAVALANGARRAYSTOREEXCEPTION, NULL);
                                    break;
                                }
                            }
                        }
...
jobject JNICALL JVM_AssertionStatusDirectives(jint arg0, jint arg1)
{
    assert(!"JVM_AssertionStatusDirectives() stubbed!");
    return NULL;
}

jobject JNICALL JVM_Clone(jint arg0, jint arg1)
{
    assert(!"JVM_Clone() stubbed!");
    return NULL;
}

jobject JNICALL JVM_CompileClass(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_CompileClass() stubbed!");
    return NULL;
}

jobject JNICALL JVM_CompileClasses(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_CompileClasses() stubbed!");
    return NULL;
}

jobject JNICALL JVM_CompilerCommand(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_CompilerCommand() stubbed!");
    return NULL;
}

jobject JNICALL JVM_CountStackFrames(jint arg0, jint arg1)
{
    assert(!"JVM_CountStackFrames() stubbed!");
    return NULL;
}

jobject JNICALL JVM_CurrentThread(JNIEnv* env, jclass java_lang_Thread)
{
...
jboolean JNICALL JVM_DesiredAssertionStatus(JNIEnv* env, jobject arg1, jobject arg2) { return JNI_FALSE; }

jobject JNICALL JVM_DisableCompiler(jint arg0, jint arg1)
{
    assert(!"JVM_DisableCompiler() stubbed!");
    return NULL;
}

static jclass java_lang_J9VMInternals(JNIEnv* env)
{
...
static jmethodID java_lang_J9VMInternals_doPrivileged(JNIEnv* env)
{
    ...
    cached = (*env)->GetStaticMethodID(
        env, java_lang_J9VMInternals(env), "doPrivileged", "(Ljava/security/PrivilegedAction;)Ljava/lang/Object;");
    assert(cached != NULL);
    return cached;
}

static jmethodID java_lang_J9VMInternals_doPrivilegedWithException(JNIEnv* env)
{
    static jmethodID cached = NULL;
    if (NULL != cached) {
        return cached;
    ...
    cached = (*env)->GetStaticMethodID(env, java_lang_J9VMInternals(env), "doPrivileged",
        "(Ljava/security/PrivilegedExceptionAction;)Ljava/lang/Object;");
    assert(cached != NULL);
    return cached;
}

jobject JNICALL JVM_DoPrivileged(
    JNIEnv* env, jobject java_security_AccessController, jobject action, jboolean unknown, jboolean isExceptionAction)
{
    ...
    return (*env)->CallStaticObjectMethod(env, java_lang_J9VMInternals(env), methodID, action);
}

jobject JNICALL JVM_EnableCompiler(jint arg0, jint arg1)
{
...
void JNICALL JVM_FillInStackTrace(JNIEnv* env, jobject throwable)
{
    ...
    if ((0 == (javaVM->runtimeFlags & J9_RUNTIME_OMIT_STACK_TRACES)) &&
        ...
        /* TODO should be: (0 == J9VMCONSTANTPOOL_FIELDREF_AT(javaVM,
           J9VMCONSTANTPOOL_JAVALANGTHROWABLE_ENABLEWRITABLESTACKTRACE)->flags) */
        ((J9_CP_TYPE(J9ROMCLASS_CPSHAPEDESCRIPTION(J9_CLASS_FROM_CP((javaVM)->jclConstantPool)->romClass),
              J9VMCONSTANTPOOL_JAVALANGTHROWABLE_ENABLEWRITABLESTACKTRACE)
             == J9CPTYPE_UNUSED)
        ...
        /* Do not hide exception frames if fillInStackTrace is called on an exception which already has a stack trace.
         * In the out of memory case,
         * there is a bit indicating that we should explicitly override this behaviour, since we've precached the stack
         * trace array. */
        if ((NULL == result)
        ...
        if (J9_STACKWALK_RC_NONE != rc) {
            ...
            vmfns->setNativeOutOfMemoryError(
                currentThread, J9NLS_JCL_FAILED_TO_CREATE_STACK_TRACE); /* TODO replace with local NLS message */
            goto done;
        }
        framesWalked = walkState->framesWalked;

        /* If there is no stack trace in the exception, or we are not in the out of memory case, allocate a new stack
         * trace. */
        if ((NULL == result) || (0 == (currentThread->privateFlags & J9_PRIVATE_FLAGS_FILL_EXISTING_TRACE))) {
            ...
            result = javaVM->memoryManagerFunctions->J9AllocateIndexableObject(
                currentThread, arrayClass, (U_32)framesWalked, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
            if (NULL == result) {
 ...
 */
jobject JNICALL JVM_FindClassFromBootLoader(JNIEnv* env, char* className)
{
    return JVM_FindClassFromClassLoader(env, className, JNI_TRUE, NULL, JNI_FALSE);
}

jobject JNICALL JVM_FindLoadedClass(JNIEnv* env, jobject classLoader, jobject className)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    ...
    loadedClass = vm->internalVMFunctions->internalFindClassString(
        currentThread, NULL, J9_JNI_UNWRAP_REFERENCE(className), vmClassLoader, J9_FINDCLASS_FLAG_EXISTING_ONLY);
done:
...
jobject JNICALL JVM_FindPrimitiveClass(JNIEnv* env, char* name)
{
 ...
 */
jobject JNICALL JVM_GetArrayElement(JNIEnv* env, jobject array, jint index)
{
    J9VMThread* currentThread;
    J9JavaVM* vm;
    J9InternalVMFunctions* vmFuncs;
                ...
                if (J9ROMCLASS_IS_PRIMITIVE_TYPE(typeOfArray->romClass)) {
                    ...
                    if (vm->longReflectClass == typeOfArray) {
                        primitiveElement = memManagerFuncs->J9AllocateObject(
                            currentThread, J9VMJAVALANGLONG_OR_NULL(vm), J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        ...
                        primitiveElement = memManagerFuncs->J9AllocateObject(
                            currentThread, J9VMJAVALANGBOOLEAN_OR_NULL(vm), J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (NULL != primitiveElement) {
                        ...
                        primitiveElement = memManagerFuncs->J9AllocateObject(
                            currentThread, J9VMJAVALANGBYTE_OR_NULL(vm), J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (NULL != primitiveElement) {
                        ...
                        primitiveElement = memManagerFuncs->J9AllocateObject(
                            currentThread, J9VMJAVALANGCHARACTER_OR_NULL(vm), J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (NULL != primitiveElement) {
                        ...
                        primitiveElement = memManagerFuncs->J9AllocateObject(
                            currentThread, J9VMJAVALANGSHORT_OR_NULL(vm), J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (NULL != primitiveElement) {
                        ...
                        primitiveElement = memManagerFuncs->J9AllocateObject(
                            currentThread, J9VMJAVALANGINTEGER_OR_NULL(vm), J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (NULL != primitiveElement) {
                        ...
                        primitiveElement = memManagerFuncs->J9AllocateObject(
                            currentThread, J9VMJAVALANGFLOAT_OR_NULL(vm), J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (NULL != primitiveElement) {
                        ...
                        primitiveElement = memManagerFuncs->J9AllocateObject(
                            currentThread, J9VMJAVALANGDOUBLE_OR_NULL(vm), J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (NULL != primitiveElement) {
 ...
 */
jint JNICALL JVM_GetArrayLength(JNIEnv* env, jobject array)
{
    J9VMThread* currentThread;
    J9JavaVM* vm;
    J9InternalVMFunctions* vmFuncs;
 ...
 */
static char* utf8_to_cstring(JNIEnv* env, J9UTF8* utf)
{
    PORT_ACCESS_FROM_ENV(env);
 ...
 */
static jobject utf8_to_java_lang_String(JNIEnv* env, J9UTF8* utf)
{
    PORT_ACCESS_FROM_ENV(env);
...
jobject JNICALL JVM_GetClassDeclaredConstructors(JNIEnv* env, jclass clazz, jboolean unknown)
{
    J9Class* ramClass;
    J9ROMClass* romClass;
...
jobject JNICALL JVM_GetClassDeclaredFields(JNIEnv* env, jobject clazz, jint arg2)
{
    J9Class* ramClass;
    J9ROMClass* romClass;
    jclass jlrField;
...
jobject JNICALL JVM_GetClassDeclaredMethods(JNIEnv* env, jobject clazz, jboolean unknown)
{
    J9Class* ramClass;
    J9ROMClass* romClass;
    jclass jlrMethod;
...
jobject JNICALL JVM_GetClassInterfaces(jint arg0, jint arg1)
{
    assert(!"JVM_GetClassInterfaces() stubbed!");
    return NULL;
}

jint JNICALL JVM_GetClassModifiers(JNIEnv* env, jclass clazz)
{
...
jobject JNICALL JVM_GetClassSigners(jint arg0, jint arg1)
{
    assert(!"JVM_GetClassSigners() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetComponentType(JNIEnv* env, jclass clazz)
{
    J9Class* ramClass = java_lang_Class_vmRef(env, clazz);
    J9ROMClass* romClass = ramClass->romClass;
...
jobject JNICALL JVM_GetDeclaredClasses(jint arg0, jint arg1)
{
    assert(!"JVM_GetDeclaredClasses() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetDeclaringClass(jint arg0, jint arg1)
{
    assert(!"JVM_GetDeclaringClass() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetInheritedAccessControlContext(jint arg0, jint arg1)
{
 ...
 */
jvalue JNICALL JVM_GetPrimitiveArrayElement(JNIEnv* env, jobject array, jint index, jint wCode)
{
    J9VMThread* currentThread;
    J9JavaVM* vm;
    J9InternalVMFunctions* vmFuncs;
...
jobject JNICALL JVM_GetProtectionDomain(jint arg0, jint arg1)
{
    assert(!"JVM_GetProtectionDomain() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetStackAccessControlContext(JNIEnv* env, jclass java_security_AccessController) { return NULL; }
...
jint JNICALL JVM_GetStackTraceDepth(JNIEnv* env, jobject throwable)
{
    ...
    vmfns->internalEnterVMFromJNI(currentThread);
    numberOfFrames
        = (jint)vmfns->iterateStackTrace(currentThread, (j9object_t*)throwable, NULL, NULL, pruneConstructors);
    vmfns->internalExitVMToJNI(currentThread);

    return numberOfFrames;
}

static jclass java_lang_StackTraceElement(JNIEnv* env)
{
    static jclass cached = NULL;
    jclass localRef = NULL;
...
static jmethodID java_lang_StackTraceElement_init(JNIEnv* env)
{
    static jmethodID cached = NULL;
    if (NULL != cached) {
        return cached;
    ...
    cached = (*env)->GetMethodID(
        env, java_lang_StackTraceElement(env), "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V");
    assert(cached != NULL);
    return cached;
}
...
static UDATA getStackTraceElementIterator(J9VMThread* vmThread, void* voidUserData, J9ROMClass* romClass,
    J9ROMMethod* romMethod, J9UTF8* fileName, UDATA lineNumber, J9ClassLoader* classLoader)
{
...
jobject JNICALL JVM_GetStackTraceElement(JNIEnv* env, jobject throwable, jint index)
{
    ...
    vmfns->internalEnterVMFromJNI(currentThread);
    vmfns->iterateStackTrace(
        currentThread, (j9object_t*)throwable, getStackTraceElementIterator, &userData, pruneConstructors);
    vmfns->internalExitVMToJNI(currentThread);
    ...
    stackTraceElement = (*env)->NewObject(env, java_lang_StackTraceElement(env), java_lang_StackTraceElement_init(env),
...
jobject JNICALL JVM_HoldsLock(jint arg0, jint arg1, jint arg2)
{
...
jobject JNICALL JVM_Interrupt(jint arg0, jint arg1)
{
    assert(!"JVM_Interrupt() stubbed!");
    return NULL;
}

jboolean JNICALL JVM_IsArrayClass(JNIEnv* env, jclass clazz)
{
    J9Class* ramClass = java_lang_Class_vmRef(env, clazz);
...
jboolean JNICALL JVM_IsInterface(JNIEnv* env, jclass clazz)
{
    J9Class* ramClass = java_lang_Class_vmRef(env, clazz);
...
jboolean JNICALL JVM_IsInterrupted(JNIEnv* env, jobject thread, jboolean unknown)
{
    J9VMThread* currentThread = (J9VMThread*)env;
...
jboolean JNICALL JVM_IsPrimitiveClass(JNIEnv* env, jclass clazz)
{
    J9Class* ramClass = java_lang_Class_vmRef(env, clazz);
...
jboolean JNICALL JVM_IsThreadAlive(JNIEnv* jniEnv, jobject targetThread)
{
...
jobject JNICALL JVM_NewArray(JNIEnv* jniEnv, jclass componentType, jint dimension)
{
    J9VMThread* currentThread = (J9VMThread*)jniEnv;
    J9JavaVM* vm = currentThread->javaVM;
    ...
    if (ramClass->arrayClass == NULL) {
        vm->internalVMFunctions->setCurrentException(
            currentThread, J9VMCONSTANTPOOL_JAVALANGILLEGALARGUMENTEXCEPTION, NULL);
        return NULL;
    }
...
static J9Class* fetchArrayClass(struct J9VMThread* vmThread, J9Class* elementTypeClass)
{
    ...
    if (NULL == resultClass) {
        ...
        J9ROMArrayClass* arrayOfObjectsROMClass
            = (J9ROMArrayClass*)J9ROMIMAGEHEADER_FIRSTCLASS(vmThread->javaVM->arrayROMClasses);
...
#define MAX_DIMENSIONS 255
    ...
    if (NULL == dim) {
        ...
        if (dimensions > MAX_DIMENSIONS) {
            /* the spec says to throw this exception if the number of dimensions in greater than the count we support
             * (and a NULL message appears to be the behaviour of the reference implementation) */
            vmFuncs->setCurrentException(currentThread, J9VMCONSTANTPOOL_JAVALANGILLEGALARGUMENTEXCEPTION, NULL);
        } else {
            ...
            if (NULL != componentTypeClassObject) {
                ...
                if (!exceptionIsPending) {
                    ...
                    directObject = vmFuncs->helperMultiANewArray(currentThread, (J9ArrayClass*)componentArrayClass,
                        (UDATA)dimensions, onStackDimensions, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
...
jobject JNICALL JVM_ResolveClass(jint arg0, jint arg1)
{
    assert(!"JVM_ResolveClass() stubbed!");
    return NULL;
}

jobject JNICALL JVM_ResumeThread(jint arg0, jint arg1)
{
 ...
 */
void JNICALL JVM_SetArrayElement(JNIEnv* env, jobject array, jint index, jobject value)
{
    J9VMThread* currentThread;
    J9JavaVM* vm;
    J9InternalVMFunctions* vmFuncs;
        ...
        if (J9CLASS_IS_ARRAY(arrayClass)) {
            if ((index < 0) || (((jint)J9INDEXABLEOBJECT_SIZE(currentThread, j9array)) <= index)) {
                ...
                if (J9ROMCLASS_IS_PRIMITIVE_TYPE(typeOfArray->romClass)) {
                    if (NULL == value) {
                        vmFuncs->setCurrentException(
                            currentThread, J9VMCONSTANTPOOL_JAVALANGNULLPOINTEREXCEPTION, NULL);
                    } else {
                        ...
                        if (vm->longReflectClass == typeOfArray) {
                            ...
                            if (booleanWrapperClass == valueClass) {
                                J9JAVAARRAYOFBOOLEAN_STORE(
                                    currentThread, j9array, index, J9VMJAVALANGBOOLEAN_VALUE(currentThread, j9value));
                            } else {
                                invalidArgument = TRUE;
                            }
                        } else if (vm->byteReflectClass == typeOfArray) {
                            if (byteWrapperClass == valueClass) {
                                J9JAVAARRAYOFBYTE_STORE(
                                    currentThread, j9array, index, J9VMJAVALANGBYTE_VALUE(currentThread, j9value));
                            } else {
                                invalidArgument = TRUE;
                            }
                        } else if (vm->charReflectClass == typeOfArray) {
                            if (charWrapperClass == valueClass) {
                                J9JAVAARRAYOFCHAR_STORE(
                                    currentThread, j9array, index, J9VMJAVALANGCHARACTER_VALUE(currentThread, j9value));
                            } else {
                                invalidArgument = TRUE;
                            }
                        } else if (vm->shortReflectClass == typeOfArray) {
...
jobject JNICALL JVM_SetClassSigners(jint arg0, jint arg1, jint arg2)
{
 ...
 */
void JNICALL JVM_SetPrimitiveArrayElement(JNIEnv* env, jobject array, jint index, jvalue value, unsigned char vCode)
{
    J9VMThread* currentThread;
    J9JavaVM* vm;
    J9InternalVMFunctions* vmFuncs;
...
jobject JNICALL JVM_SetProtectionDomain(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_SetProtectionDomain() stubbed!");
    return NULL;
}

void JNICALL JVM_SetThreadPriority(JNIEnv* env, jobject thread, jint priority)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
...
void JNICALL JVM_StartThread(JNIEnv* jniEnv, jobject newThread)
{
    J9VMThread* currentThread = (J9VMThread*)jniEnv;
    J9JavaVM* javaVM = currentThread->javaVM;
    ...
    result = javaVM->internalVMFunctions->startJavaThread(currentThread, newThreadObject,
        J9_PRIVATE_FLAGS_DAEMON_THREAD | J9_PRIVATE_FLAGS_NO_EXCEPTION_IN_START_JAVA_THREAD, javaVM->defaultOSStackSize,
        priority, (omrthread_entrypoint_t)javaVM->internalVMFunctions->javaThreadProc, javaVM, NULL);
...
jobject JNICALL JVM_StopThread(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_StopThread() stubbed!");
    return NULL;
}

jobject JNICALL JVM_SuspendThread(jint arg0, jint arg1)
{
...
jobject JNICALL JVM_Yield(jint arg0, jint arg1)
{
 ...
 * 	This method is still kept within the actual jvm dll in case that a launcher uses this jvm dll directly without
 * going through the redirector. If this method need to be modified, the changes have to be synchronized for both
 * versions.
 */
...
void JNICALL JVM_ExtendBootClassPath(JNIEnv* env, const char* pathSegment)
{
    ENSURE_VMI();
...
#define MAX_RETRY_COUNT 2
    ...
    if (NULL != className) {
        utf8Name = (U_8*)vmFuncs->copyStringToUTF8WithMemAlloc(currentThread, J9_JNI_UNWRAP_REFERENCE(className),
            J9_STR_NULL_TERMINATE_RESULT | J9_STR_XLAT, "", 0, utf8NameStackBuffer, J9VM_PACKAGE_NAME_BUFFER_LENGTH,
            &utf8Length);
        if (NULL == utf8Name) {
...
retry:
    ...
    if (vmFuncs->hashClassTableAt(classLoader, utf8Name, utf8Length) != NULL) {
        ...
        vmFuncs->setCurrentException(
            currentThread, J9VMCONSTANTPOOL_JAVALANGLINKAGEERROR, (UDATA*)*(j9object_t*)className);
        goto done;
    }
    ...
    loadedClass
        = vmFuncs->romClassLoadFromCookie(currentThread, (U_8*)utf8Name, utf8Length, (U_8*)classBytes, (UDATA)length);
    ...
    if (NULL != loadedClass) {
        ...
        if ((NULL == vm->sharedClassConfig) || (0 == vm->sharedClassConfig->isBCIEnabled(vm))) {
            clazz = vm->internalVMFunctions->internalCreateRAMClassFromROMClass(currentThread, classLoader, loadedClass,
                0, NULL, protectionDomain ? *(j9object_t*)protectionDomain : NULL, NULL, J9_CP_INDEX_NONE,
                LOAD_LOCATION_UNKNOWN, NULL, NULL);
    ...
    clazz = dynFuncs->internalDefineClassFunction(currentThread, utf8Name, utf8Length, tempClassBytes,
        (UDATA)tempLength, NULL, classLoader, protectionDomain ? *(j9object_t*)protectionDomain : NULL,
        options | J9_FINDCLASS_FLAG_THROW_ON_FAIL | J9_FINDCLASS_FLAG_NO_CHECK_FOR_EXISTING_CLASS, loadedClass, NULL,
        &localBuffer);
...
jobject JNICALL JVM_Bind(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_Bind() stubbed!");
    return NULL;
}

jobject JNICALL JVM_DTraceActivate(jint arg0, jint arg1, jint arg2, jint arg3, jint arg4)
{
    assert(!"JVM_DTraceActivate() stubbed!");
    return NULL;
}

jobject JNICALL JVM_DTraceDispose(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_DTraceDispose() stubbed!");
    return NULL;
}

jobject JNICALL JVM_DTraceGetVersion(jint arg0)
{
    assert(!"JVM_DTraceGetVersion() stubbed!");
    return NULL;
}

jobject JNICALL JVM_DTraceIsProbeEnabled(jint arg0, jint arg1)
{
    assert(!"JVM_DTraceIsProbeEnabled() stubbed!");
    return NULL;
}

jobject JNICALL JVM_DTraceIsSupported(jint arg0)
{
    assert(!"JVM_DTraceIsSupported() stubbed!");
    return NULL;
}

jobject JNICALL JVM_DefineClass(jint arg0, jint arg1, jint arg2, jint arg3, jint arg4, jint arg5)
{
    assert(!"JVM_DefineClass() stubbed!");
    return NULL;
}

jobject JNICALL JVM_DefineClassWithSourceCond(
    jint arg0, jint arg1, jint arg2, jint arg3, jint arg4, jint arg5, jint arg6, jint arg7)
{
    assert(!"JVM_DefineClassWithSourceCond() stubbed!");
    return NULL;
}

jobject JNICALL JVM_EnqueueOperation(jint arg0, jint arg1, jint arg2, jint arg3, jint arg4)
{
    assert(!"JVM_EnqueueOperation() stubbed!");
    return NULL;
}

jobject JNICALL JVM_Exit(jint arg0)
{
    assert(!"JVM_Exit() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetCPFieldNameUTF(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_GetCPFieldNameUTF() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetClassConstructor(jint arg0, jint arg1, jint arg2, jint arg3)
{
    assert(!"JVM_GetClassConstructor() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetClassConstructors(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_GetClassConstructors() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetClassField(jint arg0, jint arg1, jint arg2, jint arg3)
{
    assert(!"JVM_GetClassField() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetClassFields(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_GetClassFields() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetClassMethod(jint arg0, jint arg1, jint arg2, jint arg3, jint arg4)
{
    assert(!"JVM_GetClassMethod() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetClassMethods(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_GetClassMethods() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetField(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_GetField() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetFieldAnnotations(jint arg0, jint arg1)
{
    assert(!"JVM_GetFieldAnnotations() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetMethodAnnotations(jint arg0, jint arg1)
{
    assert(!"JVM_GetMethodAnnotations() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetMethodDefaultAnnotationValue(jint arg0, jint arg1)
{
    assert(!"JVM_GetMethodDefaultAnnotationValue() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetMethodParameterAnnotations(jint arg0, jint arg1)
{
    assert(!"JVM_GetMethodParameterAnnotations() stubbed!");
    return NULL;
}

jobject JNICALL JVM_GetPrimitiveField(jint arg0, jint arg1, jint arg2, jint arg3)
{
    assert(!"JVM_GetPrimitiveField() stubbed!");
    return NULL;
}

jobject JNICALL JVM_InitializeCompiler(jint arg0, jint arg1)
{
    assert(!"JVM_InitializeCompiler() stubbed!");
    return NULL;
}

jobject JNICALL JVM_IsSilentCompiler(jint arg0, jint arg1)
{
    assert(!"JVM_IsSilentCompiler() stubbed!");
    return NULL;
}

jobject JNICALL JVM_LoadClass0(jint arg0, jint arg1, jint arg2, jint arg3)
{
    assert(!"JVM_LoadClass0() stubbed!");
    return NULL;
}

jobject JNICALL JVM_NewInstance(jint arg0, jint arg1)
{
    assert(!"JVM_NewInstance() stubbed!");
    return NULL;
}

jobject JNICALL JVM_PrintStackTrace(jint arg0, jint arg1, jint arg2)
{
    assert(!"JVM_PrintStackTrace() stubbed!");
    return NULL;
}

jobject JNICALL JVM_SetField(jint arg0, jint arg1, jint arg2, jint arg3)
{
    assert(!"JVM_SetField() stubbed!");
    return NULL;
}

jobject JNICALL JVM_SetPrimitiveField(jint arg0, jint arg1, jint arg2, jint arg3, jint arg4, jint arg5)
{
    assert(!"JVM_SetPrimitiveField() stubbed!");
    return NULL;
}

void JNICALL JVM_SetNativeThreadName(jint arg0, jobject arg1, jstring arg2)
{
