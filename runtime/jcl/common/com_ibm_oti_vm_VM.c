 ...
 */
jlong JNICALL Java_com_ibm_oti_vm_VM_getProcessId(JNIEnv* env, jclass clazz)
{
 ...
 */
jlong JNICALL Java_com_ibm_oti_vm_VM_getUid(JNIEnv* env, jclass clazz)
{
...
jobject JNICALL Java_com_ibm_oti_vm_VM_getNonBootstrapClassLoader(JNIEnv* env, jclass jlClass)
{
