...
static jboolean scanDumpTypeForToolDump(char** typeString)
{
    ...
    do {
        ...
        if (try_scan(typeString, "tool")) {
            ...
            if (*typeString[0] == '+' || *typeString[0] == ':' || *typeString[0] == '\0') {
                return JNI_TRUE;
            }
        } else {
            /* Any more dump types? */
...
jboolean JNICALL Java_com_ibm_jvm_Dump_isToolDump(JNIEnv* env, jclass clazz, jstring jopts)
{
#if defined(J9VM_RAS_DUMP_AGENTS)
...
jstring JNICALL Java_com_ibm_jvm_Dump_triggerDumpsImpl(JNIEnv* env, jclass clazz, jstring jopts, jstring jevent)
{
#if defined(J9VM_RAS_DUMP_AGENTS)
    J9VMThread* thr = (J9VMThread*)env;
    J9JavaVM* vm = thr->javaVM;
...
void JNICALL Java_com_ibm_jvm_Dump_setDumpOptionsImpl(JNIEnv* env, jclass clazz, jstring jopts)
{
    J9VMThread* thr = (J9VMThread*)env;
    J9JavaVM* vm = thr->javaVM;
    char* optsBuffer = NULL;
