...
static void** extractArguments(JNIEnv* env, jintArray argSizes, jlongArray argValues)
{
...
jint JNICALL Java_com_ibm_gpu_Kernel_launch(JNIEnv* env, jobject thisObject, /* Kernel object */
    jobject invokeObject, /* object on which the method will be invoked */
    jobject mymethod, jint deviceId, jint gridDimX, jint gridDimY, jint gridDimZ, jint blockDimX, jint blockDimY,
    jint blockDimZ, jintArray argSizes, jlongArray argValues)
{
    ...
    if (NULL != jvm->jitConfig) {
        ...
        result = jvm->jitConfig->launchGPU(vmThread, invokeObject, ramMethod, deviceId, gridDimX, gridDimY, gridDimZ,
            blockDimX, blockDimY, blockDimZ, args);
...
void JNICALL Java_java_util_stream_IntPipeline_promoteGPUCompile(JNIEnv* env, jclass clazz)
{
    J9VMThread* vmThread = (J9VMThread*)env;
