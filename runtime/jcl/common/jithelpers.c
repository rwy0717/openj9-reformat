...
/*
 * The following natives are called by the JITHelpers static initializer. They do not require special treatment by the
 * JIT.
 */
...
jint JNICALL Java_com_ibm_jit_JITHelpers_j9ObjectJ9ClassOffset(JNIEnv* env, jclass ignored)
{
    return (jint)offsetof(J9Object, clazz);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_objectHeaderHasBeenMovedInClass(JNIEnv* env, jclass ignored)
{
    return (jint)OBJECT_HEADER_HAS_BEEN_MOVED_IN_CLASS;
}

jint JNICALL Java_com_ibm_jit_JITHelpers_objectHeaderHasBeenHashedInClass(JNIEnv* env, jclass ignored)
{
    return (jint)OBJECT_HEADER_HAS_BEEN_HASHED_IN_CLASS;
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9ObjectFlagsMask32(JNIEnv* env, jclass ignored)
{
    return (jint)(J9_REQUIRED_CLASS_ALIGNMENT - 1);
}

jlong JNICALL Java_com_ibm_jit_JITHelpers_j9ObjectFlagsMask64(JNIEnv* env, jclass ignored)
{
    return (jlong)(J9_REQUIRED_CLASS_ALIGNMENT - 1);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_javaLangThreadJ9ThreadOffset(JNIEnv* env, jclass ignored)
{
    J9VMThread* vmThread = (J9VMThread*)env;
    return (jint)J9VMJAVALANGTHREAD_THREADREF_OFFSET(vmThread);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9ThreadJ9JavaVMOffset(JNIEnv* env, jclass ignored)
{
    return (jint)offsetof(J9VMThread, javaVM);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9ROMArrayClassArrayShapeOffset(JNIEnv* env, jclass ignored)
{
    return (jint)offsetof(J9ROMArrayClass, arrayShape);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9ClassBackfillOffsetOffset(JNIEnv* env, jclass ignored)
{
    return (jint)offsetof(J9Class, backfillOffset);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_arrayShapeElementCountMask(JNIEnv* env, jclass ignored)
{
    return (jint)0x0000FFFF;
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9JavaVMIdentityHashDataOffset(JNIEnv* env, jclass ignored)
{
    return (jint)offsetof(J9JavaVM, identityHashData);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9IdentityHashDataHashData1Offset(JNIEnv* env, jclass ignored)
{
    return (jint)offsetof(J9IdentityHashData, hashData1);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9IdentityHashDataHashData2Offset(JNIEnv* env, jclass ignored)
{
    return (jint)offsetof(J9IdentityHashData, hashData2);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9IdentityHashDataHashData3Offset(JNIEnv* env, jclass ignored)
{
    return (jint)offsetof(J9IdentityHashData, hashData3);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9IdentityHashDataHashSaltTableOffset(JNIEnv* env, jclass ignored)
{
    return (jint)offsetof(J9IdentityHashData, hashSaltTable);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9IdentityHashSaltPolicyStandard(JNIEnv* env, jclass ignored)
{
    return (jint)J9_IDENTITY_HASH_SALT_POLICY_STANDARD;
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9IdentityHashSaltPolicyRegion(JNIEnv* env, jclass ignored)
{
    return (jint)J9_IDENTITY_HASH_SALT_POLICY_REGION;
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9IdentityHashSaltPolicyNone(JNIEnv* env, jclass ignored)
{
    return (jint)J9_IDENTITY_HASH_SALT_POLICY_NONE;
}

jint JNICALL Java_com_ibm_jit_JITHelpers_identityHashSaltPolicy(JNIEnv* env, jclass ignored)
{
    J9VMThread* vmThread = (J9VMThread*)env;
...
jint JNICALL Java_com_ibm_jit_JITHelpers_j9ContiguousArrayHeaderSize(JNIEnv* env, jclass ignored)
{
    return (jint)sizeof(J9IndexableObjectContiguous);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9DiscontiguousArrayHeaderSize(JNIEnv* env, jclass ignored)
{
    return (jint)sizeof(J9IndexableObjectDiscontiguous);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9ObjectContiguousLengthOffset(JNIEnv* env, jclass ignored)
{
    return (jint)offsetof(J9IndexableObjectContiguous, size);
}

jint JNICALL Java_com_ibm_jit_JITHelpers_j9ObjectDiscontiguousLengthOffset(JNIEnv* env, jclass ignored)
{
...
jobject JNICALL Java_com_ibm_jit_JITHelpers_getClassFromJ9Class64(JNIEnv* env, jobject rcv, jlong j9clazz)
{
    J9VMThread* vmThread = (J9VMThread*)env;
...
jobject JNICALL Java_com_ibm_jit_JITHelpers_getClassFromJ9Class32(JNIEnv* env, jobject rcv, jint j9clazz)
{
    J9VMThread* vmThread = (J9VMThread*)env;
    J9InternalVMFunctions* vmfns = vmThread->javaVM->internalVMFunctions;
    jobject classRef;
