...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_ClassLoadingMXBeanImpl_isVerboseImpl(
...
jint JNICALL Java_com_ibm_java_lang_management_internal_ClassLoadingMXBeanImpl_getLoadedClassCountImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    jint result;
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_ClassLoadingMXBeanImpl_getTotalLoadedClassCountImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    jlong result;
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_ClassLoadingMXBeanImpl_getUnloadedClassCountImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    jlong result;
...
void JNICALL Java_com_ibm_java_lang_management_internal_ClassLoadingMXBeanImpl_setVerboseImpl(
