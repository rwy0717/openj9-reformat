...
jobject JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_getHeapMemoryUsageImpl(
    JNIEnv* env, jobject beanInstance, jclass memoryUsage, jobject memUsageConstructor)
{
    ...
    return (*env)->NewObject(env, memoryUsage, ctor, (jlong)javaVM->managementData->initialHeapSize, used, committed,
        (jlong)javaVM->managementData->maximumHeapSize);
}
    ...
    JNIEnv* env, jobject beanInstance, jclass memoryUsage, jobject memUsageConstructor)
{
    ...
    /* The classTableMutex is held while allocating RAM class fragments from free lists. @see
     * createramclass.c#internalCreateRAMClassFromROMClass() */
...
jint JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_getObjectPendingFinalizationCountImpl(
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_isVerboseImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
...
void JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_setVerboseImpl(
...
void JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_createMemoryManagers(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    jclass memBean = NULL;
...
void JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_createMemoryPools(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    jclass memBean = NULL;
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_getMaxHeapSizeLimitImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_getMinHeapSizeImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
...
void JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_setMaxHeapSizeImpl(
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_setSharedClassCacheSoftmxBytesImpl(
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_setSharedClassCacheMinAotBytesImpl(
    JNIEnv* env, jobject beanInstance, jlong value)
{
    jboolean ret = JNI_FALSE;
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_setSharedClassCacheMaxAotBytesImpl(
    JNIEnv* env, jobject beanInstance, jlong value)
{
    jboolean ret = JNI_FALSE;
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_setSharedClassCacheMinJitDataBytesImpl(
    JNIEnv* env, jobject beanInstance, jlong value)
{
    jboolean ret = JNI_FALSE;
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_setSharedClassCacheMaxJitDataBytesImpl(
    JNIEnv* env, jobject beanInstance, jlong value)
{
    jboolean ret = JNI_FALSE;
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_getSharedClassCacheSoftmxUnstoredBytesImpl(
    JNIEnv* env, jobject beanInstance)
{
    U_32 ret = 0;
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_getSharedClassCacheMaxAotUnstoredBytesImpl(
    JNIEnv* env, jobject beanInstance)
{
    U_32 ret = 0;
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_isSetMaxHeapSizeSupportedImpl(
    JNIEnv* env, jobject beanInstance)
{
    return JNI_TRUE;
}

jstring JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_getGCModeImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_getGCMasterThreadCpuUsedImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    J9JavaLangManagementData* mgmt = javaVM->managementData;
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_MemoryMXBeanImpl_getGCSlaveThreadsCpuUsedImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    J9JavaLangManagementData* mgmt = javaVM->managementData;
...
/* Implementation of the main loop of a thread that processes and dispatches memory usage notifications to Java
 * handlers. */
void JNICALL Java_com_ibm_lang_management_internal_MemoryNotificationThread_processNotificationLoop(
    JNIEnv* env, jobject threadInstance)
{
    ...
    helperMemID
        = (*env)->GetMethodID(env, threadClass, "dispatchMemoryNotificationHelper", "(Ljava/lang/String;JJJJJJZ)V");
    if (NULL == helperMemID) {
        return;
    }

    helperGCID = (*env)->GetMethodID(env, threadClass, "dispatchGCNotificationHelper",
        "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JJJ[J[J[J[J[J[J[JJ)V");
    if (NULL == helperGCID) {
        return;
    }
    ...
    while (1) {
        ...
        if (NOTIFIER_SHUTDOWN_REQUEST == notification->type) {
            ...
            (*env)->SetLongArrayRegion(
                env, postCommittedArray, 0, gcInfo->arraySize, (jlong*)&gcInfo->postCommitted[0]);
            if ((*env)->ExceptionCheck(env)) {
                return;
            }
            ...
            (*env)->CallVoidMethod(env, threadInstance, helperGCID, gcName, gcAction, gcCause, (jlong)gcInfo->index,
                (jlong)gcInfo->startTime, (jlong)gcInfo->endTime, initialArray, preUsedArray, preCommittedArray,
                preMaxArray, postUsedArray, postCommittedArray, postMaxArray, (jlong)notification->sequenceNumber);
            if ((*env)->ExceptionCheck(env)) {
                return;
            }
        } else {
            ...
            if (THRESHOLD_EXCEEDED == notification->type) {
                ...
                (*env)->CallVoidMethod(env, threadInstance, helperMemID, poolName, (jlong)pool->initialSize,
                    (jlong)usageThreshold->usedSize, (jlong)usageThreshold->totalSize, (jlong)usageThreshold->maxSize,
                    (jlong)usageThreshold->thresholdCrossingCount, (jlong)notification->sequenceNumber, JNI_FALSE);
                if ((*env)->ExceptionCheck(env)) {
                    return;
                }
            } else { /* COLLECTION_THRESHOLD_EXCEEDED == notification->type) */
                /* heap collection usage threshold exceeded */
                (*env)->CallVoidMethod(env, threadInstance, helperMemID, poolName, pool->initialSize,
                    (jlong)usageThreshold->usedSize, (jlong)usageThreshold->totalSize, (jlong)usageThreshold->maxSize,
                    (jlong)usageThreshold->thresholdCrossingCount, (jlong)notification->sequenceNumber, JNI_TRUE);
                if ((*env)->ExceptionCheck(env)) {
                    return;
                }
            }
...
void JNICALL Java_com_ibm_lang_management_internal_MemoryNotificationThreadShutdown_sendShutdownNotification(
    JNIEnv* env, jobject instance)
{
    ...
    if (NULL != notification) {
        ...
        /* replace the queue with just this notification - the notifier thread does not care that the pending count
         * might be >1, it will not process anything after the shutdown request */
        j9thread_monitor_enter(mgmt->notificationMonitor);
...
static UDATA getIndexFromMemoryPoolID(J9JavaLangManagementData* mgmt, UDATA id)
{
    ...
    for (; idx < mgmt->supportedMemoryPools; ++idx) {
        if ((mgmt->memoryPools[idx].id & J9VM_MANAGEMENT_POOL_HEAP_ID_MASK)
            == (id & J9VM_MANAGEMENT_POOL_HEAP_ID_MASK)) {
            break;
        }
    }
    return idx;
...
static UDATA getIndexFromGCID(J9JavaLangManagementData* mgmt, UDATA id)
{
    ...
    for (; idx < mgmt->supportedCollectors; ++idx) {
        if ((J9VM_MANAGEMENT_GC_HEAP_ID_MASK & mgmt->garbageCollectors[idx].id)
            == (J9VM_MANAGEMENT_GC_HEAP_ID_MASK & id)) {
            break;
        }
    }
    return idx;
