...
static jobject processSegmentList(JNIEnv* env, jclass memoryUsage, jobject memUsageConstructor,
    J9MemorySegmentList* segList, U_64 initSize, U_64* storedPeakSize, U_64* storedPeakUsed, UDATA action);
...
jobject JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_getCollectionUsageImpl(
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_getCollectionUsageThresholdImpl(
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_getCollectionUsageThresholdCountImpl(
    JNIEnv* env, jobject beanInstance, jint id)
{
    jlong count = -1;
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
...
jobject JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_getPeakUsageImpl(
    JNIEnv* env, jobject beanInstance, jint id, jclass memoryUsage, jobject memUsageConstructor)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    J9JavaLangManagementData* mgmt = javaVM->managementData;
    ...
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
        ...
        javaVM->memoryManagerFunctions->j9gc_pools_memory(
            javaVM, (id & J9VM_MANAGEMENT_POOL_HEAP_ID_MASK), &totals[0], &frees[0], FALSE);
        ...
        if (NULL != segList) {
            return processSegmentList(env, memoryUsage, memUsageConstructor, segList,
                mgmt->nonHeapMemoryPools[id - J9VM_MANAGEMENT_POOL_NONHEAP_SEG].initialSize,
                &mgmt->nonHeapMemoryPools[id - J9VM_MANAGEMENT_POOL_NONHEAP_SEG].peakSize,
                &mgmt->nonHeapMemoryPools[id - J9VM_MANAGEMENT_POOL_NONHEAP_SEG].peakUsed, 1);
        } else {
            return NULL;
        }
    }
...
jobject JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_getUsageImpl(
    JNIEnv* env, jobject beanInstance, jint id, jclass memoryUsage, jobject memUsageConstructor)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    J9JavaLangManagementData* mgmt = javaVM->managementData;
    ...
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
        ...
        if (NULL != segList) {
            return processSegmentList(env, memoryUsage, memUsageConstructor, segList,
                mgmt->nonHeapMemoryPools[id - J9VM_MANAGEMENT_POOL_NONHEAP_SEG].initialSize,
                &mgmt->nonHeapMemoryPools[id - J9VM_MANAGEMENT_POOL_NONHEAP_SEG].peakSize,
                &mgmt->nonHeapMemoryPools[id - J9VM_MANAGEMENT_POOL_NONHEAP_SEG].peakUsed, 0);
        } else {
            return NULL;
        }
    }
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_getUsageThresholdImpl(
    JNIEnv* env, jobject beanInstance, jint id)
{
    jlong count = -1;
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_getUsageThresholdCountImpl(
    JNIEnv* env, jobject beanInstance, jint id)
{
    jlong count = -1;
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_isCollectionUsageThresholdExceededImpl(
    JNIEnv* env, jobject beanInstance, jint id)
{
    ...
    JNIEnv* env, jobject beanInstance, jint id)
{
    ...
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
        ...
        if ((0 != max)
            && (0
                   != javaVM->memoryManagerFunctions->j9gc_is_collectionusagethreshold_supported(
                          javaVM, (id & J9VM_MANAGEMENT_POOL_HEAP_ID_MASK)))) {
            result = JNI_TRUE;
        }
    }
    return result;
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_isUsageThresholdExceededImpl(
    JNIEnv* env, jobject beanInstance, jint id)
{
    jboolean result = JNI_FALSE;
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_isUsageThresholdSupportedImpl(
    JNIEnv* env, jobject beanInstance, jint id)
{
    jboolean result = JNI_FALSE;
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
        ...
        if ((0 != max)
            && (0
                   != javaVM->memoryManagerFunctions->j9gc_is_usagethreshold_supported(
                          javaVM, (id & J9VM_MANAGEMENT_POOL_HEAP_ID_MASK)))) {
            result = JNI_TRUE;
        }
    }
...
void JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_resetPeakUsageImpl(
    JNIEnv* env, jobject beanInstance, jint id)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    J9JavaLangManagementData* mgmt = javaVM->managementData;
    ...
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
        ...
        J9MemorySegmentList* segList = getMemorySegmentList(javaVM, id);
        if (NULL != segList) {
            processSegmentList(env, NULL, NULL, segList, 0,
                &mgmt->nonHeapMemoryPools[id - J9VM_MANAGEMENT_POOL_NONHEAP_SEG].peakSize,
                &mgmt->nonHeapMemoryPools[id - J9VM_MANAGEMENT_POOL_NONHEAP_SEG].peakUsed, 2);
        }
    }
}

void JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_setCollectionUsageThresholdImpl(
...
void JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_setUsageThresholdImpl(
    JNIEnv* env, jobject beanInstance, jint id, jlong newThreshold)
{
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
        J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
...
jobject JNICALL Java_com_ibm_java_lang_management_internal_MemoryPoolMXBeanImpl_getPreCollectionUsageImpl(
    JNIEnv* env, jobject beanInstance, jint id, jclass memoryUsage, jobject memUsageConstructor)
{
    if (0 != (id & J9VM_MANAGEMENT_POOL_HEAP)) {
        J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
...
static jobject processSegmentList(JNIEnv* env, jclass memoryUsage, jobject memUsageConstructor,
    J9MemorySegmentList* segList, U_64 initialSize, U_64* storedPeakSize, U_64* storedPeakUsed, UDATA action)
{
    jlong used = 0;
    jlong committed = 0;
    jlong peakUsed = 0;
    ...
    if (2 != action) {
        ...
        if (0 == action) {
            ...
            memoryUsageObj
                = (*env)->NewObject(env, memoryUsage, ctor, (jlong)initialSize, peakUsed, peakSize, (jlong)-1);
        }
    }
