...
static ThreadInfo* getArrayOfThreadInfo(JNIEnv* env, jlong* threadIDs, jint numThreads, jint maxStackDepth,
    jboolean getLockedMonitors, jboolean getLockedSynchronizers);
static IDATA getThreadInfo(J9VMThread* currentThread, J9VMThread* targetThread, ThreadInfo* info, jint maxStackDepth,
    jboolean getLockedMonitors);
static void getContentionStats(J9VMThread* currentThread, J9VMThread* vmThread, ThreadInfo* tinfo);
static IDATA getStackFramePCs(
    J9VMThread* currentThread, J9VMThread* targetThread, ThreadInfo* tinfo, jint maxStackDepth);
...
static jvmtiIterationControl getSynchronizersHeapIterator(
    J9VMThread* vmThread, J9MM_IterateObjectDescriptor* objectDesc, void* userData);
...
jobject JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_findMonitorDeadlockedThreadsImpl(
...
jlongArray JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_findDeadlockedThreadsImpl(
    JNIEnv* env, jobject beanInstance)
{
    jlongArray result;

    result = findDeadlockedThreads(
        env, J9VMTHREAD_FINDDEADLOCKFLAG_INCLUDESYNCHRONIZERS | J9VMTHREAD_FINDDEADLOCKFLAG_INCLUDEWAITING);
    return result;
}

jobject JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_getAllThreadIdsImpl(
    JNIEnv* env, jobject beanInstance)
{
    ...
    do {
        {
            if ((currentThread->threadObject != NULL)
                && (J9VMJAVALANGTHREAD_THREADREF((J9VMThread*)env, currentThread->threadObject) != NULL)) {
 ...
 */
jlong JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_getThreadCpuTimeImpl(
    JNIEnv* env, jobject beanInstance, jlong threadID)
{
    ...
    omrthread_monitor_enter(javaVM->vmThreadListMutex);
    for (targetThread = currentThread->linkNext; targetThread != currentThread; targetThread = targetThread->linkNext) {
 ...
 * TODO This API should be split for current vs arbitrary thread.
 */
jlong JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_getThreadUserTimeImpl(
    JNIEnv* env, jobject beanInstance, jlong threadID)
{
    jlong userTime = -1;
    J9VMThread* currentThread = (J9VMThread*)env;
...
jint JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_getDaemonThreadCountImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9VMThread* vmThread = (J9VMThread*)env;
    J9JavaVM* javaVM = vmThread->javaVM;
...
jint JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_getPeakThreadCountImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9VMThread* vmThread = (J9VMThread*)env;
    J9JavaVM* javaVM = vmThread->javaVM;
...
jint JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_getThreadCountImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9VMThread* vmThread = (J9VMThread*)env;
    J9JavaVM* javaVM = vmThread->javaVM;
...
jlong JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_getTotalStartedThreadCountImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9VMThread* vmThread = (J9VMThread*)env;
    J9JavaVM* javaVM = vmThread->javaVM;
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_isThreadCpuTimeSupportedImpl(
    JNIEnv* env, jobject beanInstance)
{
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_isThreadContentionMonitoringEnabledImpl(
    JNIEnv* env, jobject beanInstance)
{
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_isThreadContentionMonitoringSupportedImpl(
    JNIEnv* env, jobject beanInstance)
{
    return JNI_TRUE;
}

jboolean JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_isThreadCpuTimeEnabledImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    J9JavaLangManagementData* mgmt = javaVM->managementData;
...
void JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_resetPeakThreadCountImpl(
    JNIEnv* env, jobject beanInstance)
{
    J9VMThread* vmThread = (J9VMThread*)env;
    J9JavaVM* javaVM = vmThread->javaVM;
...
void JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_setThreadContentionMonitoringEnabledImpl(
    JNIEnv* env, jobject beanInstance, jboolean flag)
{
    ...
    if (flag == JNI_TRUE) {
        ...
        (*vmHooks)->J9HookRegisterWithCallSite(
            vmHooks, J9HOOK_VM_MONITOR_CONTENDED_ENTER, handlerContendedEnter, OMR_GET_CALLSITE(), NULL);
        (*vmHooks)->J9HookRegisterWithCallSite(
            vmHooks, J9HOOK_VM_MONITOR_CONTENDED_ENTERED, handlerContendedEntered, OMR_GET_CALLSITE(), NULL);
        (*vmHooks)->J9HookRegisterWithCallSite(
            vmHooks, J9HOOK_VM_MONITOR_WAIT, handlerMonitorWait, OMR_GET_CALLSITE(), NULL);
        (*vmHooks)->J9HookRegisterWithCallSite(
            vmHooks, J9HOOK_VM_MONITOR_WAITED, handlerMonitorWaited, OMR_GET_CALLSITE(), NULL);
        (*vmHooks)->J9HookRegisterWithCallSite(vmHooks, J9HOOK_VM_PARK, handlerMonitorWait, OMR_GET_CALLSITE(), NULL);
        (*vmHooks)->J9HookRegisterWithCallSite(
            vmHooks, J9HOOK_VM_UNPARKED, handlerMonitorWaited, OMR_GET_CALLSITE(), NULL);
        (*vmHooks)->J9HookRegisterWithCallSite(vmHooks, J9HOOK_VM_SLEEP, handlerMonitorWait, OMR_GET_CALLSITE(), NULL);
        (*vmHooks)->J9HookRegisterWithCallSite(
            vmHooks, J9HOOK_VM_SLEPT, handlerMonitorWaited, OMR_GET_CALLSITE(), NULL);
    }
...
void JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_setThreadCpuTimeEnabledImpl(
    JNIEnv* env, jobject beanInstance, jboolean flag)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    J9JavaLangManagementData* mgmt = javaVM->managementData;
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_isCurrentThreadCpuTimeSupportedImpl(
    JNIEnv* env, jobject beanInstance)
{
    jboolean isSupported = JNI_FALSE;
...
jboolean JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_isObjectMonitorUsageSupportedImpl(
    JNIEnv* env, jobject beanInstance)
{
    return JNI_TRUE;
}

jboolean JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_isSynchronizerUsageSupportedImpl(
    JNIEnv* env, jobject beanInstance)
{
    return JNI_TRUE;
}

jobject JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_getThreadInfoImpl(
    JNIEnv* env, jobject beanInstance, jlong id, jint maxStackDepth)
{
    ...
    Trc_JCL_threadmxbean_getThreadInfoImpl6_Entry(env, id, maxStackDepth, getLockedMonitors, getLockedSynchronizers);
...
jobjectArray JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_getMultiThreadInfoImpl(JNIEnv* env,
    jobject beanInstance, jlongArray ids, jint maxStackDepth, jboolean getLockedMonitors,
    jboolean getLockedSynchronizers)
{
    ThreadInfo* allinfo = NULL;
    ...
    Trc_JCL_threadmxbean_getArrayOfThreadInfo_Entry(env, ids, getLockedMonitors, getLockedSynchronizers);
    ...
    if (0 == numThreads) {
        ...
        allinfo = getArrayOfThreadInfo(
            env, threadIDs, numThreads, maxStackDepth, getLockedMonitors, getLockedSynchronizers);
...
jobjectArray JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_dumpAllThreadsImpl(
    JNIEnv* env, jobject beanInstance, jboolean getLockedMonitors, jboolean getLockedSynchronizers, jint maxDepth)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    ...
    if (allinfolen > 0) {
        ...
        do {
            ...
            if (vmThread->threadObject
                && (J9VMJAVALANGTHREAD_THREADREF(currentThread, vmThread->threadObject) == vmThread)) {
                {
                    ++numThreads;
                    exc = getThreadInfo(currentThread, vmThread, info, maxDepth, getLockedMonitors);
                    if (exc > 0) {
    ...
    jboolean getLockedMonitors, jboolean getLockedSynchronizers)
{
    ...
    if (numThreads > 0) {
        ...
        for (i = 0; (jint)i < numThreads; ++i) {
            ...
            if (threadIDs[i]) {
                exc = getThreadInfo(
                    currentThread, (J9VMThread*)(UDATA)threadIDs[i], &allinfo[i], maxStackDepth, getLockedMonitors);
                if (exc > 0) {
                    freeThreadInfos(currentThread, allinfo, numThreads);
                    goto getArray_failWithExclusive;
                }
...
static J9VMThread* getThread(JNIEnv* env, jlong threadID)
{
    ...
    while (TRUE) {
        if ((currentThread->threadObject != NULL)
            && (getThreadID((J9VMThread*)env, (j9object_t)currentThread->threadObject) == threadID)) {
            {
                /*
...
static jint initIDCache(JNIEnv* env)
{
    ...
    mid = (*env)->GetMethodID(env, gcls, "<init>",
        "(Ljava/lang/Thread;JIZZJJJJ[Ljava/lang/StackTraceElement;Ljava/lang/Object;Ljava/lang/Thread;[Ljava/lang/"
        "management/MonitorInfo;[Ljava/lang/management/LockInfo;)V");
    if (mid) {
    ...
    mid = (*env)->GetMethodID(env, gcls, "<init>", "(Ljava/lang/String;IILjava/lang/StackTraceElement;)V");
    if (!mid) {
        err = JNI_ERR;
        goto initIDCache_fail;
    }
    ...
    jboolean getLockedMonitors)
{
    ...
    info->thread = vmfns->j9jni_createLocalRef((JNIEnv*)currentThread, (j9object_t)targetThread->threadObject);
    ...
    if (targetThread->threadObject) {
        info->jclThreadState
            = getJclThreadState(info->vmstate, J9VMJAVALANGTHREAD_STARTED(currentThread, targetThread->threadObject));
    } else {
     ...
     */
    if ((J9VMTHREAD_STATE_BLOCKED == info->vmstate) && (NULL != monitorOwner) && (NULL == monitorOwnerObject)) {
    ...
    J9VMThread* currentThread, J9VMThread* targetThread, ThreadInfo* tinfo, jint maxStackDepth)
{
    ...
    walkState.flags = J9_STACKWALK_CACHE_PCS | J9_STACKWALK_WALK_TRANSLATE_PC | J9_STACKWALK_SKIP_INLINES
        | J9_STACKWALK_INCLUDE_NATIVES | J9_STACKWALK_VISIBLE_ONLY | J9_STACKWALK_COUNT_SPECIFIED;
...
static UDATA getSynchronizers(J9VMThread* currentThread, ThreadInfo* allinfo, UDATA allinfolen)
{
    ...
    rc = mmfns->j9mm_iterate_all_ownable_synchronizer_objects(
        currentThread, vm->portLibrary, 0, getSynchronizersHeapIterator, &data);
    ...
    J9VMThread* vmThread, J9MM_IterateObjectDescriptor* objectDesc, void* userData)
{
    ...
    /* OwnableSynchronizer collection should only contain instances of
...
static IDATA getMonitors(J9VMThread* currentThread, J9VMThread* targetThread, ThreadInfo* tinfo, UDATA stackLen)
{
    ...
    infoLen = vm->internalVMFunctions->getOwnedObjectMonitors(currentThread, targetThread, NULL, 0);
    if (infoLen > 0) {
        info = j9mem_allocate_memory(infoLen * sizeof(J9ObjectMonitorInfo), J9MEM_CATEGORY_VM_JCL);
        if (info) {
            rc = vm->internalVMFunctions->getOwnedObjectMonitors(currentThread, targetThread, info, infoLen);
            if (rc >= 0) {
...
static jobject createThreadInfo(JNIEnv* env, ThreadInfo* tinfo, jsize maxStackDepth)
{
    ...
    if (JNI_TRUE == getOwnedLocks) {
        result = (*env)->NewObject(env, cls, ctor, tinfo->thread, tinfo->nativeTID, state, isSuspended, isNative,
            tinfo->blockedCount, tinfo->blockedTime, tinfo->waitedCount, tinfo->waitedTime, prunedTrace, tinfo->blocker,
            tinfo->blockerOwner, lockedMonitors, lockedSynchronizers);
    } else {
        result = (*env)->NewObject(env, cls, ctor, tinfo->thread, tinfo->nativeTID, state, isSuspended, isNative,
            tinfo->blockedCount, tinfo->blockedTime, tinfo->waitedCount, tinfo->waitedTime, prunedTrace, tinfo->blocker,
            tinfo->blockerOwner);
...
static jobjectArray createStackTrace(J9VMThread* currentThread, ThreadInfo* tinfo)
{
    ...
    throwable = (j9object_t)createStackTraceThrowable(currentThread, tinfo->stack.pcs, tinfo->stack.len);
...
static IDATA saveObjectRefs(JNIEnv* env, ThreadInfo* info)
{
    ...
    if (info->lockedMonitors.len > 0) {
        PORT_ACCESS_FROM_ENV(env);
        info->lockedMonitors.arr_safe
            = j9mem_allocate_memory(sizeof(MonitorInfo) * info->lockedMonitors.len, J9MEM_CATEGORY_VM_JCL);
        if (info->lockedMonitors.arr_safe) {
            for (i = 0; i < info->lockedMonitors.len; ++i) {
                ...
                info->lockedMonitors.arr_safe[i].clazz = vmfns->j9jni_createLocalRef(
                    env, J9VM_J9CLASS_TO_HEAPCLASS(J9OBJECT_CLAZZ((J9VMThread*)env, object)));
 ...
 */
static void handle_error(JNIEnv* env, IDATA error)
{
    PORT_ACCESS_FROM_ENV(env);
    ...
    if (-J9THREAD_ERR_USAGE_RETRIEVAL_UNSUPPORTED == error) {
        ...
        msgString = j9nls_lookup_message(J9NLS_DO_NOT_PRINT_MESSAGE_TAG | J9NLS_DO_NOT_APPEND_NEWLINE,
            J9NLS_JCL_JVM_CPU_USAGE_RETRIEVAL_UNSUPPORTED_MSG, NULL);
    } else {
        exceptionClass = (*env)->FindClass(env, "java/lang/InternalError");
        if (-J9THREAD_ERR_USAGE_RETRIEVAL_ERROR == error) {
            msgString = j9nls_lookup_message(J9NLS_DO_NOT_PRINT_MESSAGE_TAG | J9NLS_DO_NOT_APPEND_NEWLINE,
                J9NLS_JCL_JVM_CPU_USAGE_RETRIEVAL_ERROR, NULL);
        } else if (-J9THREAD_ERR_INVALID_TIMESTAMP == error) {
            msgString = j9nls_lookup_message(J9NLS_DO_NOT_PRINT_MESSAGE_TAG | J9NLS_DO_NOT_APPEND_NEWLINE,
                J9NLS_JCL_JVM_CPU_USAGE_INVALID_TIMESTAMP, NULL);
        }
    }
    ...
    JNIEnv* env, jobject beanInstance, jobject jvmCpuMonitorInfoObject)
{
    ...
    (*env)->SetLongArrayRegion(env, appUserArray, 0, (jsize)J9THREAD_MAX_USER_DEFINED_THREAD_CATEGORIES,
        (jlong*)cpuUsage.applicationUserCpuTime);
    if ((*env)->ExceptionCheck(env)) {
        return NULL;
    }

    /* Call the update values method to update the object with the values obtained */
    (*env)->CallVoidMethod(env, jvmCpuMonitorInfoObject, MID_updateValues, (jlong)cpuUsage.timestamp,
        (jlong)cpuUsage.applicationCpuTime, (jlong)cpuUsage.resourceMonitorCpuTime, (jlong)cpuUsage.systemJvmCpuTime,
        (jlong)cpuUsage.gcCpuTime, (jlong)cpuUsage.jitCpuTime, (jlongArray)appUserArray);
 ...
 */
static omrthread_t get_thread_from_id(J9VMThread* currentThread, jlong threadID)
{
    ...
    JNIEnv* env, jobject beanInstance, jlong threadID, jint category)
{
    ...
    if ((J9THREAD_CATEGORY_SYSTEM_THREAD == origCat) || (J9THREAD_CATEGORY_SYSTEM_GC_THREAD == origCat)
 ...
 */
jlong JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_findNativeThreadIDImpl(
    JNIEnv* env, jobject bean, jlong threadID)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* javaVM = currentThread->javaVM;
    J9InternalVMFunctions* vmfns = javaVM->internalVMFunctions;
 ...
 */
void JNICALL Java_com_ibm_java_lang_management_internal_ThreadMXBeanImpl_getNativeThreadIdsImpl(
    JNIEnv* env, jobject bean, jlongArray threadIDs, jlongArray resultArray)
{
    PORT_ACCESS_FROM_ENV(env);
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* javaVM = currentThread->javaVM;
