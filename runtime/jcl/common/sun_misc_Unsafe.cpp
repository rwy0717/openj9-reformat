    ...
    jobject classLoader, jobject protectionDomain)
{
    ...
    result = defineClassCommon(
        env, classLoader, className, classRep, offset, length, protectionDomain, J9_FINDCLASS_FLAG_UNSAFE, NULL);
    ...
    JNIEnv* env, jobject receiver, jclass hostClass, jbyteArray bytecodes, jobjectArray constPatches)
{
    ...
    jclass anonClass = defineClassCommon(env, hostClassLoaderLocalRef, NULL, bytecodes, 0, length,
        protectionDomainLocalRef, J9_FINDCLASS_FLAG_UNSAFE | J9_FINDCLASS_FLAG_ANON, hostClazz);
...
jlong JNICALL Java_sun_misc_Unsafe_allocateMemory(JNIEnv* env, jobject receiver, jlong size)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
jlong JNICALL Java_sun_misc_Unsafe_allocateDBBMemory(JNIEnv* env, jobject receiver, jlong size)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
jlong JNICALL Java_sun_misc_Unsafe_allocateMemoryNoException(JNIEnv* env, jobject receiver, jlong size)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
void JNICALL Java_sun_misc_Unsafe_freeMemory(JNIEnv* env, jobject receiver, jlong address)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    unsafeFreeMemory(currentThread, (void*)(UDATA)address);
}

void JNICALL Java_sun_misc_Unsafe_freeDBBMemory(JNIEnv* env, jobject receiver, jlong address)
{
    J9VMThread* currentThread = (J9VMThread*)env;
...
jlong JNICALL Java_sun_misc_Unsafe_reallocateMemory(JNIEnv* env, jobject receiver, jlong address, jlong size)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
jlong JNICALL Java_sun_misc_Unsafe_reallocateDBBMemory(JNIEnv* env, jobject receiver, jlong address, jlong size)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
void JNICALL Java_sun_misc_Unsafe_ensureClassInitialized(JNIEnv* env, jobject receiver, jclass clazz)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
void JNICALL Java_sun_misc_Unsafe_park(JNIEnv* env, jobject receiver, jboolean isAbsolute, jlong time)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
void JNICALL Java_sun_misc_Unsafe_unpark(JNIEnv* env, jobject receiver, jthread thread)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
void JNICALL Java_sun_misc_Unsafe_throwException(JNIEnv* env, jobject receiver, jthrowable exception)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
void JNICALL Java_sun_misc_Unsafe_monitorEnter(JNIEnv* env, jobject receiver, jobject obj)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
void JNICALL Java_sun_misc_Unsafe_monitorExit(JNIEnv* env, jobject receiver, jobject obj)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
jboolean JNICALL Java_sun_misc_Unsafe_tryMonitorEnter(JNIEnv* env, jobject receiver, jobject obj)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
 ...
 */
static VMINLINE UDATA determineAlignment(UDATA value)
{
    UDATA alignment = 0;
 ...
 */
static VMINLINE UDATA determineCommonAlignment(UDATA sourceOffset, UDATA destOffset, UDATA size)
{
 ...
 */
static VMINLINE void copyMemorySub(J9VMThread* currentThread, j9object_t sourceObject, UDATA sourceOffset,
    j9object_t destObject, UDATA destOffset, UDATA actualSize, UDATA logElementSize, UDATA sourceIndex, UDATA destIndex,
    UDATA elementCount)
{
    if (NULL == sourceObject) {
        if (NULL == destObject) {
            ...
            if ((destOffset > sourceOffset) && (destOffset < sourceEnd)) {
                alignedBackwardsMemcpy(
                    currentThread, (void*)(destOffset + actualSize), (void*)sourceEnd, actualSize, logElementSize);
            } else {
                alignedMemcpy(currentThread, (void*)destOffset, (void*)sourceOffset, actualSize, logElementSize);
            }
        } else {
            VM_ArrayCopyHelpers::memcpyToArray(
                currentThread, destObject, logElementSize, destIndex, elementCount, (void*)sourceOffset);
        }
    } else if (NULL == destObject) {
        VM_ArrayCopyHelpers::memcpyFromArray(
            currentThread, sourceObject, logElementSize, sourceIndex, elementCount, (void*)destOffset);
    } else {
        VM_ArrayCopyHelpers::primitiveArrayCopy(
            currentThread, sourceObject, sourceIndex, destObject, destIndex, elementCount, logElementSize);
    }
}
 ...
 * @param actualSize the number of bytes to be copied
 */
static VMINLINE void copyMemory(J9VMThread* currentThread, j9object_t sourceObject, UDATA sourceOffset,
    j9object_t destObject, UDATA destOffset, UDATA actualSize)
{
    ...
    copyMemorySub(currentThread, sourceObject, sourceOffset, destObject, destOffset, actualSize, logElementSize,
        sourceIndex, destIndex, elementCount);
}
 ...
 * @param destOffset location in destObject to start copy
 */
static VMINLINE void copyMemoryByte(
    J9VMThread* currentThread, j9object_t sourceObject, UDATA sourceOffset, j9object_t destObject, UDATA destOffset)
{
    ...
    copyMemorySub(currentThread, sourceObject, sourceOffset, destObject, destOffset, (UDATA)1, (UDATA)0, sourceIndex,
        destIndex, (UDATA)1);
}

void JNICALL Java_sun_misc_Unsafe_copyMemory__Ljava_lang_Object_2JLjava_lang_Object_2JJ(
    JNIEnv* env, jobject receiver, jobject srcBase, jlong srcOffset, jobject dstBase, jlong dstOffset, jlong size)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
jlong JNICALL Java_sun_misc_Unsafe_objectFieldOffset(JNIEnv* env, jobject receiver, jobject field)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
    ...
    if (NULL == field) {
        ...
        J9JNIFieldID* fieldID
            = vm->reflectFunctions.idFromFieldObject(currentThread, NULL, J9_JNI_UNWRAP_REFERENCE(field));
...
jobject JNICALL Java_sun_misc_Unsafe_staticFieldBase__Ljava_lang_reflect_Field_2(
    JNIEnv* env, jobject receiver, jobject field)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
jlong JNICALL Java_sun_misc_Unsafe_staticFieldOffset(JNIEnv* env, jobject receiver, jobject field)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
jboolean JNICALL Java_sun_misc_Unsafe_unalignedAccess0(JNIEnv* env, jobject receiver) { return JNI_TRUE; }
...
jlong JNICALL Java_jdk_internal_misc_Unsafe_objectFieldOffset1(
    JNIEnv* env, jobject receiver, jclass clazz, jstring name)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
...
static void registerJdkInternalMiscUnsafeNativesCommon(JNIEnv* env, jclass clazz)
{
    /* clazz can't be null */
    JNINativeMethod natives[] = {
        ...
        { (char*)"defineAnonymousClass0", (char*)"(Ljava/lang/Class;[B[Ljava/lang/Object;)Ljava/lang/Class;",
            (void*)&Java_sun_misc_Unsafe_defineAnonymousClass },
        { (char*)"pageSize", (char*)"()I", (void*)&Java_sun_misc_Unsafe_pageSize },
        { (char*)"getLoadAverage0", (char*)"([DI)I", (void*)&Java_sun_misc_Unsafe_getLoadAverage },
        { (char*)"shouldBeInitialized0", (char*)"(Ljava/lang/Class;)Z",
            (void*)&Java_jdk_internal_misc_Unsafe_shouldBeInitialized },
        { (char*)"allocateMemory0", (char*)"(J)J", (void*)&Java_sun_misc_Unsafe_allocateMemory },
        { (char*)"freeMemory0", (char*)"(J)V", (void*)&Java_sun_misc_Unsafe_freeMemory },
        { (char*)"reallocateMemory0", (char*)"(JJ)J", (void*)&Java_sun_misc_Unsafe_reallocateMemory },
        { (char*)"ensureClassInitialized0", (char*)"(Ljava/lang/Class;)V",
            (void*)&Java_sun_misc_Unsafe_ensureClassInitialized },
        { (char*)"park", (char*)"(ZJ)V", (void*)&Java_sun_misc_Unsafe_park },
        { (char*)"unpark", (char*)"(Ljava/lang/Object;)V", (void*)&Java_sun_misc_Unsafe_unpark },
        { (char*)"throwException", (char*)"(Ljava/lang/Throwable;)V", (void*)&Java_sun_misc_Unsafe_throwException },
        { (char*)"copyMemory0", (char*)"(Ljava/lang/Object;JLjava/lang/Object;JJ)V",
            (void*)&Java_sun_misc_Unsafe_copyMemory__Ljava_lang_Object_2JLjava_lang_Object_2JJ },
        { (char*)"objectFieldOffset0", (char*)"(Ljava/lang/reflect/Field;)J",
            (void*)&Java_sun_misc_Unsafe_objectFieldOffset },
        { (char*)"setMemory0", (char*)"(Ljava/lang/Object;JJB)V",
            (void*)&Java_sun_misc_Unsafe_setMemory__Ljava_lang_Object_2JJB },
        { (char*)"staticFieldBase0", (char*)"(Ljava/lang/reflect/Field;)Ljava/lang/Object;",
            (void*)&Java_sun_misc_Unsafe_staticFieldBase__Ljava_lang_reflect_Field_2 },
        { (char*)"staticFieldOffset0", (char*)"(Ljava/lang/reflect/Field;)J",
            (void*)&Java_sun_misc_Unsafe_staticFieldOffset },
        { (char*)"unalignedAccess0", (char*)"()Z", (void*)&Java_sun_misc_Unsafe_unalignedAccess0 },
        { (char*)"isBigEndian0", (char*)"()Z", (void*)&Java_sun_misc_Unsafe_isBigEndian0 },
        { (char*)"getUncompressedObject", (char*)"(J)Ljava/lang/Object;",
...
static void registerJdkInternalMiscUnsafeNativesJava10(JNIEnv* env, jclass clazz)
{
    /* clazz can't be null */
    JNINativeMethod natives[] = { { (char*)"objectFieldOffset1", (char*)"(Ljava/lang/Class;Ljava/lang/String;)J",
 ...
 */
jboolean memOverlapIsNone(
    j9object_t sourceObject, UDATA sourceOffset, j9object_t destObject, UDATA destOffset, UDATA actualCopySize)
{
    jboolean result = JNI_FALSE;
 ...
 * @return true for no memory overlap, otherwise false
 */
jboolean memOverlapIsUnaligned(UDATA sourceOffset, UDATA destOffset) { return (sourceOffset != destOffset); }

void JNICALL Java_jdk_internal_misc_Unsafe_copySwapMemory0(JNIEnv* env, jobject receiver, jobject srcBase,
    jlong srcOffset, jobject dstBase, jlong dstOffset, jlong copySize, jlong elemSize)
{
    J9VMThread* currentThread = (J9VMThread*)env;
    J9JavaVM* vm = currentThread->javaVM;
    J9InternalVMFunctions* vmFuncs = vm->internalVMFunctions;
    ...
    illegal:
        ...
        for (UDATA elementOffset = 0; elementOffset < actualCopySize; elementOffset += actualElementSize) {
            for (UDATA elementIndex = 0; elementIndex < (actualElementSize / 2); elementIndex++) {
                ...
                if (overlapIsNone) {
                    copyMemoryByte(
                        currentThread, sourceObject, sourceOffset + upperIndex, destObject, destOffset + lowerIndex);
                    copyMemoryByte(
                        currentThread, sourceObject, sourceOffset + lowerIndex, destObject, destOffset + upperIndex);
                } else { /* exact or unaligned overlap */
                    copyMemoryByte(currentThread, destObject, destOffset + lowerIndex, NULL, (UDATA)&tempOffset);
                    copyMemoryByte(
                        currentThread, destObject, destOffset + upperIndex, destObject, destOffset + lowerIndex);
