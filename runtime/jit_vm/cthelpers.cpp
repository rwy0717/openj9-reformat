...
void* jitGetCountingSendTarget(J9VMThread* vmThread, J9Method* ramMethod)
{
 ...
 */
J9Method* jitGetImproperInterfaceMethodFromCP(J9VMThread* currentThread, J9ConstantPool* constantPool, UDATA cpIndex)
{
    ...
    /* If the ref is resolved, do not call the resolve helper, as it will currently fail if the interface class is not
     * initialized */
    if (!J9RAMINTERFACEMETHODREF_RESOLVED(interfaceClass, methodIndexAndArgCount)) {
        J9RAMInterfaceMethodRef localEntry;
        if (NULL
            == currentThread->javaVM->internalVMFunctions->resolveInterfaceMethodRefInto(
                   currentThread, constantPool, cpIndex, J9_RESOLVE_FLAG_JIT_COMPILE_TIME, &localEntry)) {
            goto done;
        }
...
J9Class* jitGetInterfaceITableIndexFromCP(
    J9VMThread* currentThread, J9ConstantPool* constantPool, UDATA cpIndex, UDATA* pITableIndex)
{
    J9RAMInterfaceMethodRef* ramMethodRef = (J9RAMInterfaceMethodRef*)constantPool + cpIndex;
    J9Class* interfaceClass = (J9Class*)ramMethodRef->interfaceClass;
    UDATA methodIndexAndArgCount = ramMethodRef->methodIndexAndArgCount;
...
UDATA
jitGetInterfaceVTableOffsetFromCP(
    J9VMThread* currentThread, J9ConstantPool* constantPool, UDATA cpIndex, J9Class* lookupClass)
{
...
J9Method* jitGetInterfaceMethodFromCP(
    J9VMThread* currentThread, J9ConstantPool* constantPool, UDATA cpIndex, J9Class* lookupClass)
{
...
J9UTF8* jitGetConstantDynamicTypeFromCP(J9VMThread* currentThread, J9ConstantPool* constantPool, UDATA cpIndex)
{
    J9ROMConstantDynamicRef* romConstantRef = (J9ROMConstantDynamicRef*)J9_ROM_CP_FROM_CP(constantPool) + cpIndex;
    J9UTF8* sigUTF
        = J9ROMNAMEANDSIGNATURE_SIGNATURE(NNSRP_GET(romConstantRef->nameAndSignature, struct J9ROMNameAndSignature*));
