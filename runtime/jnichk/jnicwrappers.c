...
static jobject JNICALL checkCallNonvirtualObjectMethodV(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, va_list args);
static jobject JNICALL checkCallNonvirtualObjectMethodA(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
static jboolean JNICALL checkCallNonvirtualBooleanMethod(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, ...);
static jboolean JNICALL checkCallNonvirtualBooleanMethodV(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, va_list args);
static jboolean JNICALL checkCallNonvirtualBooleanMethodA(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
static jbyte JNICALL checkCallNonvirtualByteMethod(JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, ...);
static jbyte JNICALL checkCallNonvirtualByteMethodV(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, va_list args);
static jbyte JNICALL checkCallNonvirtualByteMethodA(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
static jchar JNICALL checkCallNonvirtualCharMethod(JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, ...);
static jchar JNICALL checkCallNonvirtualCharMethodV(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, va_list args);
static jchar JNICALL checkCallNonvirtualCharMethodA(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
static jshort JNICALL checkCallNonvirtualShortMethod(JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, ...);
static jshort JNICALL checkCallNonvirtualShortMethodV(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, va_list args);
static jshort JNICALL checkCallNonvirtualShortMethodA(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
static jint JNICALL checkCallNonvirtualIntMethod(JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, ...);
static jint JNICALL checkCallNonvirtualIntMethodV(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, va_list args);
static jint JNICALL checkCallNonvirtualIntMethodA(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
static jlong JNICALL checkCallNonvirtualLongMethod(JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, ...);
static jlong JNICALL checkCallNonvirtualLongMethodV(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, va_list args);
static jlong JNICALL checkCallNonvirtualLongMethodA(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
static jfloat JNICALL checkCallNonvirtualFloatMethod(JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, ...);
static jfloat JNICALL checkCallNonvirtualFloatMethodV(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, va_list args);
static jfloat JNICALL checkCallNonvirtualFloatMethodA(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
static jdouble JNICALL checkCallNonvirtualDoubleMethod(JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, ...);
static jdouble JNICALL checkCallNonvirtualDoubleMethodV(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, va_list args);
static jdouble JNICALL checkCallNonvirtualDoubleMethodA(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
static void JNICALL checkCallNonvirtualVoidMethod(JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, ...);
static void JNICALL checkCallNonvirtualVoidMethodV(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, va_list args);
static void JNICALL checkCallNonvirtualVoidMethodA(
    JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, jvalue* args);
...
const struct JNINativeInterface_ JNICheckTable = { NULL, NULL, NULL, NULL, checkGetVersion, checkDefineClass,
    checkFindClass, checkFromReflectedMethod, checkFromReflectedField, checkToReflectedMethod, checkGetSuperclass,
    checkIsAssignableFrom, checkToReflectedField, checkThrow, checkThrowNew, checkExceptionOccurred,
    checkExceptionDescribe, checkExceptionClear, checkFatalError, checkPushLocalFrame, checkPopLocalFrame,
    checkNewGlobalRef, checkDeleteGlobalRef, checkDeleteLocalRef, checkIsSameObject, checkNewLocalRef,
    checkEnsureLocalCapacity, checkAllocObject, checkNewObject, checkNewObjectV, checkNewObjectA, checkGetObjectClass,
    checkIsInstanceOf, checkGetMethodID, checkCallObjectMethod, checkCallObjectMethodV, checkCallObjectMethodA,
    checkCallBooleanMethod, checkCallBooleanMethodV, checkCallBooleanMethodA, checkCallByteMethod, checkCallByteMethodV,
    checkCallByteMethodA, checkCallCharMethod, checkCallCharMethodV, checkCallCharMethodA, checkCallShortMethod,
    checkCallShortMethodV, checkCallShortMethodA, checkCallIntMethod, checkCallIntMethodV, checkCallIntMethodA,
    checkCallLongMethod, checkCallLongMethodV, checkCallLongMethodA, checkCallFloatMethod, checkCallFloatMethodV,
    checkCallFloatMethodA, checkCallDoubleMethod, checkCallDoubleMethodV, checkCallDoubleMethodA, checkCallVoidMethod,
    checkCallVoidMethodV, checkCallVoidMethodA, checkCallNonvirtualObjectMethod, checkCallNonvirtualObjectMethodV,
    checkCallNonvirtualObjectMethodA, checkCallNonvirtualBooleanMethod, checkCallNonvirtualBooleanMethodV,
    checkCallNonvirtualBooleanMethodA, checkCallNonvirtualByteMethod, checkCallNonvirtualByteMethodV,
    checkCallNonvirtualByteMethodA, checkCallNonvirtualCharMethod, checkCallNonvirtualCharMethodV,
    checkCallNonvirtualCharMethodA, checkCallNonvirtualShortMethod, checkCallNonvirtualShortMethodV,
    checkCallNonvirtualShortMethodA, checkCallNonvirtualIntMethod, checkCallNonvirtualIntMethodV,
    checkCallNonvirtualIntMethodA, checkCallNonvirtualLongMethod, checkCallNonvirtualLongMethodV,
    checkCallNonvirtualLongMethodA, checkCallNonvirtualFloatMethod, checkCallNonvirtualFloatMethodV,
    checkCallNonvirtualFloatMethodA, checkCallNonvirtualDoubleMethod, checkCallNonvirtualDoubleMethodV,
    checkCallNonvirtualDoubleMethodA, checkCallNonvirtualVoidMethod, checkCallNonvirtualVoidMethodV,
    checkCallNonvirtualVoidMethodA, checkGetFieldID, checkGetObjectField, checkGetBooleanField, checkGetByteField,
    checkGetCharField, checkGetShortField, checkGetIntField, checkGetLongField, checkGetFloatField, checkGetDoubleField,
    checkSetObjectField, checkSetBooleanField, checkSetByteField, checkSetCharField, checkSetShortField,
    checkSetIntField, checkSetLongField, checkSetFloatField, checkSetDoubleField, checkGetStaticMethodID,
    checkCallStaticObjectMethod, checkCallStaticObjectMethodV, checkCallStaticObjectMethodA,
    checkCallStaticBooleanMethod, checkCallStaticBooleanMethodV, checkCallStaticBooleanMethodA,
    checkCallStaticByteMethod, checkCallStaticByteMethodV, checkCallStaticByteMethodA, checkCallStaticCharMethod,
    checkCallStaticCharMethodV, checkCallStaticCharMethodA, checkCallStaticShortMethod, checkCallStaticShortMethodV,
    checkCallStaticShortMethodA, checkCallStaticIntMethod, checkCallStaticIntMethodV, checkCallStaticIntMethodA,
    checkCallStaticLongMethod, checkCallStaticLongMethodV, checkCallStaticLongMethodA, checkCallStaticFloatMethod,
    checkCallStaticFloatMethodV, checkCallStaticFloatMethodA, checkCallStaticDoubleMethod, checkCallStaticDoubleMethodV,
    checkCallStaticDoubleMethodA, checkCallStaticVoidMethod, checkCallStaticVoidMethodV, checkCallStaticVoidMethodA,
    checkGetStaticFieldID, checkGetStaticObjectField, checkGetStaticBooleanField, checkGetStaticByteField,
    checkGetStaticCharField, checkGetStaticShortField, checkGetStaticIntField, checkGetStaticLongField,
    checkGetStaticFloatField, checkGetStaticDoubleField, checkSetStaticObjectField, checkSetStaticBooleanField,
    checkSetStaticByteField, checkSetStaticCharField, checkSetStaticShortField, checkSetStaticIntField,
    checkSetStaticLongField, checkSetStaticFloatField, checkSetStaticDoubleField, checkNewString, checkGetStringLength,
    checkGetStringChars, checkReleaseStringChars, checkNewStringUTF, checkGetStringUTFLength, checkGetStringUTFChars,
    checkReleaseStringUTFChars, checkGetArrayLength, checkNewObjectArray, checkGetObjectArrayElement,
    checkSetObjectArrayElement, checkNewBooleanArray, checkNewByteArray, checkNewCharArray, checkNewShortArray,
    checkNewIntArray, checkNewLongArray, checkNewFloatArray, checkNewDoubleArray, checkGetBooleanArrayElements,
    checkGetByteArrayElements, checkGetCharArrayElements, checkGetShortArrayElements, checkGetIntArrayElements,
    checkGetLongArrayElements, checkGetFloatArrayElements, checkGetDoubleArrayElements,
    checkReleaseBooleanArrayElements, checkReleaseByteArrayElements, checkReleaseCharArrayElements,
    checkReleaseShortArrayElements, checkReleaseIntArrayElements, checkReleaseLongArrayElements,
    checkReleaseFloatArrayElements, checkReleaseDoubleArrayElements, checkGetBooleanArrayRegion,
    checkGetByteArrayRegion, checkGetCharArrayRegion, checkGetShortArrayRegion, checkGetIntArrayRegion,
    checkGetLongArrayRegion, checkGetFloatArrayRegion, checkGetDoubleArrayRegion, checkSetBooleanArrayRegion,
    checkSetByteArrayRegion, checkSetCharArrayRegion, checkSetShortArrayRegion, checkSetIntArrayRegion,
    checkSetLongArrayRegion, checkSetFloatArrayRegion, checkSetDoubleArrayRegion, checkRegisterNatives,
    checkUnregisterNatives, checkMonitorEnter, checkMonitorExit, checkGetJavaVM, checkGetStringRegion,
    checkGetStringUTFRegion, checkGetPrimitiveArrayCritical, checkReleasePrimitiveArrayCritical, checkGetStringCritical,
    checkReleaseStringCritical, checkNewWeakGlobalRef, checkDeleteWeakGlobalRef, checkExceptionCheck,
    checkNewDirectByteBuffer, checkGetDirectBufferAddress, checkGetDirectBufferCapacity, checkGetObjectRefType };
