...
{
    int rc = -1;
    Sig_Primary_Sigaction func
        = (Sig_Primary_Sigaction)getFunction(&handlerTable.sig_primary_sigaction, "omrsig_primary_sigaction");
...
{
    sighandler_t rc = SIG_ERR;
    Sig_Primary_Signal func
        = (Sig_Primary_Signal)getFunction(&handlerTable.sig_primary_signal, "omrsig_primary_signal");
