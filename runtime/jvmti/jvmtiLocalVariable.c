...
static jvmtiError jvmtiGetOrSetLocal(jvmtiEnv* env, jthread thread, jint depth, jint slot, void* value_ptr,
    char signature, jboolean isSet, jboolean getLocalInstance);
                ...
                case J9_SLOT_VALIDATE_ERROR_NONE:
                    ...
                    if (isSet) {
                        ...
                        case 'J':
                            ...
                            break;
                        case 'L':
                            /* CMVC 109592 - Must not modify the stack while a thread is halted for inspection - this
                             * includes creation of JNI local refs */
                            objectFetched = TRUE;
                            PUSH_OBJECT_IN_SPECIAL_FRAME(
                                currentThread, (slotValid ? *((j9object_t*)slotAddress) : NULL));
                            break;
                        default:
