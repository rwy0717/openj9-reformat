...
public:
     ...
     */
private:
    static VMINLINE void copyForwardU64(U_64* dest, U_64* source, UDATA count)
    {
...
/* The _mm_storel_epi64 compiler intrinsic is broken on gcc 4.1.2 */
    ...
    static VMINLINE void copyForwardU8(U_8* dest, U_8* source, UDATA count)
    {
        /* Use memmove instead of memcpy becuase memcpy does not work on Ubuntu 10.04 */
        memmove((void*)dest, (void*)source, count);
    }

    static VMINLINE void inlineAlignedMemcpy(void* dest, void* source, UDATA bytes, UDATA alignment)
    {
        switch (alignment) {
        case 3:
    ...
    static VMINLINE UDATA calculateElementsToCopyFromCurrentLeafForwardCopy(
        UDATA arrayletLeafSizeInElements, UDATA index)
    {
    ...
    static VMINLINE UDATA calculateElementsToCopyFromCurrentLeafBackwardCopy(
        UDATA arrayletLeafSizeInElements, UDATA index)
    {
        UDATA leaf = index / arrayletLeafSizeInElements;
        UDATA leafIndex = leaf * arrayletLeafSizeInElements;
    ...
    static VMINLINE bool isContiguousRange(J9VMThread* currentThread, UDATA index, UDATA count, UDATA logElementSize)
    {
    ...
    static VMINLINE void primitiveDiscontiguousBackwardArrayCopy(J9VMThread* currentThread, j9object_t srcObject,
        UDATA srcStart, j9object_t destObject, UDATA destStart, UDATA elementCount, UDATA arrayletLeafSizeInElements,
        UDATA logElementSize)
    {
        ...
        while (elementsToCopy > 0) {
            ...
            UDATA srcLeafCount
                = calculateElementsToCopyFromCurrentLeafBackwardCopy(arrayletLeafSizeInElements, srcEndIndex);
            /* calculate DEST information */
            UDATA destLeafCount
                = calculateElementsToCopyFromCurrentLeafBackwardCopy(arrayletLeafSizeInElements, destEndIndex);
    ...
    static VMINLINE void primitiveDiscontiguousForwardArrayCopy(J9VMThread* currentThread, j9object_t srcObject,
        UDATA srcStart, j9object_t destObject, UDATA destStart, UDATA elementCount, UDATA arrayletLeafSizeInElements,
        UDATA logElementSize)
    {
        ...
        while (elementsToCopy > 0) {
            /* calculate SRC information */
            UDATA srcLeafCount
                = calculateElementsToCopyFromCurrentLeafForwardCopy(arrayletLeafSizeInElements, srcIndex);
            /* calculate DEST information */
            UDATA destLeafCount
                = calculateElementsToCopyFromCurrentLeafForwardCopy(arrayletLeafSizeInElements, destIndex);

            /* Choose the smallest of the two counts since that is the most that can be copied this time through the
             * loop */
            UDATA copyCount = srcLeafCount;
            if (copyCount > destLeafCount) {
                copyCount = destLeafCount;
    ...
    static VMINLINE void primitiveContiguousArrayCopy(J9VMThread* currentThread, j9object_t srcObject, UDATA srcStart,
        j9object_t destObject, UDATA destStart, UDATA elementCount, UDATA logElementSize)
    {
        void* srcAddress = NULL;
        void* destAddress = NULL;
        UDATA bytesToCopy = 0;
        ...
        if ((srcObject != destObject) || (destAddress <= srcAddress)) {
            ...
            /* Do a backward copy */
            alignedBackwardsMemcpy(currentThread, (U_8*)destAddress + bytesToCopy, (U_8*)srcAddress + bytesToCopy,
                bytesToCopy, logElementSize);
        }
    }

    static VMINLINE void primitiveDiscontiguousArrayCopy(J9VMThread* currentThread, j9object_t srcObject,
        UDATA srcStart, j9object_t destObject, UDATA destStart, UDATA elementCount, UDATA logElementSize)
    {
        ...
        if ((srcObject != destObject) || (destStart <= srcStart)) {
            /* Do a forward copy */
            primitiveDiscontiguousForwardArrayCopy(currentThread, srcObject, srcStart, destObject, destStart,
                elementCount, arrayletLeafSizeInElements, logElementSize);
        } else {
            /* Do a backward copy */
            primitiveDiscontiguousBackwardArrayCopy(currentThread, srcObject, srcStart, destObject, destStart,
                elementCount, arrayletLeafSizeInElements, logElementSize);
        }
    }

    static VMINLINE void primitiveContiguousArrayFill(
        J9VMThread* currentThread, j9object_t object, UDATA start, UDATA elementCount, U_8 value)
    {
        memset(J9JAVAARRAY_EA(currentThread, object, start, U_8), value, elementCount);
    }

    static VMINLINE void primitiveDiscontiguousArrayFill(
        J9VMThread* currentThread, j9object_t object, UDATA start, UDATA elementCount, U_8 value)
    {
        UDATA index = start;
    ...
    static VMINLINE void memcpyToOrFromArrayContiguous(J9VMThread* currentThread, j9object_t array, UDATA index,
        UDATA count, void* nativePtr, UDATA logElementSize, bool from)
    {
    ...
    static VMINLINE void memcpyToOrFromArrayDiscontiguous(J9VMThread* currentThread, j9object_t array, UDATA index,
        UDATA count, void* nativePtr, UDATA logElementSize, bool from)
    {
    ...
    static VMINLINE void memcpyToArrayHelper(
        J9VMThread* currentThread, j9object_t array, UDATA index, UDATA count, void* srcPtr, UDATA logElementSize)
    {
    ...
    static VMINLINE void memcpyFromArrayHelper(
        J9VMThread* currentThread, j9object_t array, UDATA index, UDATA count, void* destPtr, UDATA logElementSize)
    {
        if (isContiguousRange(currentThread, index, count, logElementSize)) {
...
public:
     ...
     *
     */
    static VMINLINE void memcpyToArray(
        J9VMThread* currentThread, j9object_t array, UDATA logElementSize, UDATA index, UDATA count, void* srcPtr)
    {
     ...
     */
    static VMINLINE void memcpyToArray(
        J9VMThread* currentThread, j9object_t array, J9Class* clazz, UDATA index, UDATA count, void* srcPtr)
    {
     ...
     */
    static VMINLINE void memcpyToArray(
        J9VMThread* currentThread, j9object_t array, UDATA index, UDATA count, void* srcPtr)
    {
     ...
     *
     */
    static VMINLINE void memcpyFromArray(
        J9VMThread* currentThread, j9object_t array, UDATA logElementSize, UDATA index, UDATA count, void* destPtr)
    {
     ...
     */
    static VMINLINE void memcpyFromArray(
        J9VMThread* currentThread, j9object_t array, J9Class* clazz, UDATA index, UDATA count, void* destPtr)
    {
        UDATA logElementSize = (((J9ROMArrayClass*)clazz->romClass)->arrayShape & 0x0000FFFF);
     ...
     */
    static VMINLINE void memcpyFromArray(
        J9VMThread* currentThread, j9object_t array, UDATA index, UDATA count, void* destPtr)
    {
        J9Class* objectClass = J9OBJECT_CLAZZ(currentThread, array);
        UDATA logElementSize = (((J9ROMArrayClass*)objectClass->romClass)->arrayShape & 0x0000FFFF);
     ...
     *
     */
    static VMINLINE I_32 referenceArrayCopy(J9VMThread* currentThread, j9object_t srcObject, I_32 srcStart,
        j9object_t destObject, I_32 destStart, I_32 elementCount)
    {
        return currentThread->javaVM->memoryManagerFunctions->referenceArrayCopyIndex(currentThread,
            (J9IndexableObject*)srcObject, (J9IndexableObject*)destObject, srcStart, destStart, elementCount);
    }
     ...
     *
     */
    static VMINLINE void primitiveArrayCopy(J9VMThread* currentThread, j9object_t srcObject, UDATA srcStart,
        j9object_t destObject, UDATA destStart, UDATA elementCount, UDATA logElementSize)
    {
        if (isContiguousRange(currentThread, srcStart, elementCount, logElementSize)
            && isContiguousRange(currentThread, destStart, elementCount, logElementSize)) {
            primitiveContiguousArrayCopy(
                currentThread, srcObject, srcStart, destObject, destStart, elementCount, logElementSize);
        } else {
            primitiveDiscontiguousArrayCopy(
                currentThread, srcObject, srcStart, destObject, destStart, elementCount, logElementSize);
        }
    }
     ...
     *
     */
    static VMINLINE void primitiveArrayFill(
        J9VMThread* currentThread, j9object_t object, UDATA start, UDATA elementCount, U_8 value)
    {
     ...
     */
    static VMINLINE bool rangeCheck(
        J9VMThread* currentThread, j9object_t array, I_32 startIndex, I_32 copyCount, I_32* invalidIndex)
    {
        bool inRange = true;
