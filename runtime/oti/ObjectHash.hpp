...
public:
     ...
     */
private:
    static VMINLINE void setHasBeenHashed(j9object_t objectPtr)
    {
    ...
    static VMINLINE U_32 getSalt(J9JavaVM* vm, UDATA objectPointer)
    {
    ...
    static VMINLINE U_32 rotateLeft(U_32 value, U_32 count) { return (value << count) | (value >> (32 - count)); }

    static VMINLINE U_32 mix(U_32 hashValue, U_32 datum)
    {
...
public:
     ...
     */
    static VMINLINE I_32 inlineConvertValueToHash(J9JavaVM* vm, UDATA value)
    {
     ...
     */
    static VMINLINE I_32 inlineComputeObjectAddressToHash(J9JavaVM* vm, j9object_t objectPointer)
    {
     ...
     * @param objectPointer 	a valid object reference.
     */
    static VMINLINE I_32 inlineObjectHashCode(J9JavaVM* vm, j9object_t objectPointer)
    {
        I_32 hashValue = 0;
            ...
            if (J9_ARE_ANY_BITS_SET(flags, OBJECT_HEADER_HAS_BEEN_MOVED_IN_CLASS)) {
                if (J9CLASS_IS_ARRAY(objectClass)) {
                    ...
                    if (0 != offset) {
                        ...
                        offset = ROUND_UP_TO_POWEROF2(
                            (offset << (romClass->arrayShape & 0x0000FFFF)) + sizeof(J9IndexableObjectContiguous),
                            sizeof(I_32));
