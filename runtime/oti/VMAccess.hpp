...
protected:
public:
    static VMINLINE bool inlineOnlyTryAcquireVMAccess(J9VMThread* const vmThread)
    {
        bool acquired = false;
        if (0
            == VM_AtomicSupport::lockCompareExchange(
                   &vmThread->publicFlags, 0, J9_PUBLIC_FLAGS_VMACCESS_ACQUIRE_BITS)) {
    ...
    static VMINLINE bool inlineTryAcquireVMAccess(J9VMThread* const vmThread)
    {
    ...
    static VMINLINE void inlineAcquireVMAccess(J9VMThread* const vmThread)
    {
    ...
    static VMINLINE void inlineAcquireVMAccessExhaustiveCheck(J9VMThread* const vmThread)
    {
        {
            ...
            for (;;) {
                ...
                publicFlags = VM_AtomicSupport::lockCompareExchange(
                    &vmThread->publicFlags, savedPublicFlags, savedPublicFlags | J9_PUBLIC_FLAGS_VMACCESS_ACQUIRE_BITS);
    ...
    static VMINLINE void inlineAcquireVMAccessClearStatus(J9VMThread* const vmThread, const UDATA flags)
    {
        {
            UDATA savedPublicFlags = vmThread->publicFlags;
            UDATA publicFlags = 0;
            ...
            for (;;) {
                ...
                publicFlags = VM_AtomicSupport::lockCompareExchange(&vmThread->publicFlags, savedPublicFlags,
                    (savedPublicFlags | J9_PUBLIC_FLAGS_VMACCESS_ACQUIRE_BITS) & ~flags);
                if (savedPublicFlags == publicFlags) {
                    /* success */
                    VM_AtomicSupport::readBarrier();
                    return;
    ...
    static VMINLINE void inlineReleaseVMAccess(J9VMThread* const vmThread)
    {
        UDATA savedPublicFlags = vmThread->publicFlags;
        UDATA publicFlags = 0;
    ...
    static VMINLINE void inlineReleaseVMAccessSetStatus(J9VMThread* const vmThread, const UDATA flags)
    {
        UDATA savedPublicFlags = vmThread->publicFlags;
        UDATA publicFlags = 0;
     ...
     */
    static VMINLINE void setPublicFlags(J9VMThread* vmThread, UDATA flags, bool indicateEvent = false)
    {
     ...
     */
    static VMINLINE UDATA clearPublicFlagsNoMutex(J9VMThread* vmThread, UDATA flag, bool notifyThread = false)
    {
     ...
     */
    static VMINLINE void clearPublicFlags(J9VMThread* vmThread, UDATA flags, bool notifyThread = false)
    {
        if (notifyThread) {
     ...
     */
    static VMINLINE U_64 updateExclusiveVMAccessStats(
        J9VMThread* currentThread, J9JavaVM* vm, J9PortLibrary* portLibrary)
    {
     ...
     */
    static VMINLINE void respondToExclusiveRequest(
        J9VMThread* currentThread, J9JavaVM* vm, J9PortLibrary* portLibrary, U_64 timeNow, UDATA reason)
    {
        PORT_ACCESS_FROM_PORT(portLibrary);
        U_64 const timeTaken = j9time_hires_delta(
    ...
    static VMINLINE void inlineEnterVMFromJNI(J9VMThread* const currentThread)
    {
    ...
    static VMINLINE void inlineExitVMToJNI(J9VMThread* const currentThread)
    {
#if defined(J9VM_INTERP_ATOMIC_FREE_JNI_USES_FLUSH)
        VM_AtomicSupport::compilerReorderingBarrier();
...
#define inlineExitVMToJNI inlineReleaseVMAccess
    ...
    // assumes PFM is held
    static VMINLINE void backOffFromSafePoint(J9VMThread* const vmThread)
    {
     ...
     */
    static VMINLINE bool mustWaitForVMAccessRelease(J9VMThread* const vmThread)
    {
        bool mustWait = false;
#if defined(J9VM_INTERP_ATOMIC_FREE_JNI)
     ...
     */
    static VMINLINE void setHaltFlagForVMAccessRelease(J9VMThread* const vmThread, UDATA const flags)
    {
