...
#define BCV_BASE_TYPE_MASK                                                                               \
    (BCV_BASE_TYPE_INT_BIT | BCV_BASE_TYPE_FLOAT_BIT | BCV_BASE_TYPE_LONG_BIT | BCV_BASE_TYPE_DOUBLE_BIT \
        | BCV_BASE_TYPE_SHORT_BIT | BCV_BASE_TYPE_BYTE_BIT | BCV_BASE_TYPE_CHAR_BIT | BCV_BASE_TYPE_BOOL_BIT)
#define BCV_BASE_TYPE_TOP (BCV_TAG_BASE_TYPE_OR_TOP) /* used for uninitialized temps and half a long/double */
#define BCV_BASE_TYPE_NULL \
    (BCV_TAG_BASE_ARRAY_OR_NULL | BCV_ARITY_MASK) /* NULL object - arity used to simplify tests */
