...
/* Macros. */
/* This heuristic is based actual experimentation.  It might have changed, though, as the ROM format changed. NOTE:
 * There are 4 buckets. */
#define ESTIMATE_SIZE(dataSize)          \
    ((dataSize < 1000) ? dataSize + 1000 \
                       : (((dataSize < 10000) || (dataSize > 50000)) ? dataSize + 5000 : dataSize + 20000))
...
#define MIN_SIZEOF(typea, typeb) (sizeof(typea) > sizeof(typeb) ? sizeof(typeb) : sizeof(typea))

#define J9_CFR_ALIGN(ptr, type) \
    (ptr = (void*)((char*)ptr + MIN_SIZEOF(UDATA, type) - 1 - (((UDATA)ptr - 1) % MIN_SIZEOF(UDATA, type))))

#define ALLOC(result, type) \
    ((result = (type*)J9_CFR_ALIGN(freePointer, type)), (freePointer += sizeof(type)), (freePointer < segmentEnd))

#define ALLOC_CAST(result, type, cast) \
    ((result = (cast*)J9_CFR_ALIGN(freePointer, cast)), (freePointer += sizeof(type)), (freePointer < segmentEnd))

#define ALLOC_ARRAY(result, size, type)                                                       \
    ((result = (type*)J9_CFR_ALIGN(freePointer, type)), (freePointer += size * sizeof(type)), \
...
#define NEXT_U32(value, index)                                                                                   \
    ((value = ((U_32)(index)[0] << 24) | ((U_32)(index)[1] << 16) | ((U_32)(index)[2] << 8) | (U_32)(index)[3]), \
        index += 4, value)
#define NEXT_I32(value, index)                                                                                        \
    ((value                                                                                                           \
         = (I_32)(((U_32)(index)[0] << 24) | ((U_32)(index)[1] << 16) | ((U_32)(index)[2] << 8) | (U_32)(index)[3])), \
        index += 4, value)

#define NEXT_U8_ENDIAN(bigEndian, value, index) value = *(index++)

#define NEXT_U16_ENDIAN(bigEndian, value, index)                                  \
    ((value) = !(bigEndian) ? ((((U_16)(index)[0])) | (((U_16)(index)[1]) << 8))  \
                            : ((((U_16)(index)[0]) << 8) | (((U_16)(index)[1]))), \
        ((index) += 2))

#define NEXT_I16_ENDIAN(bigEndian, value, index)                                        \
    ((value) = !(bigEndian) ? (I_16)((((U_16)(index)[0])) | (((U_16)(index)[1]) << 8))  \
                            : (I_16)((((U_16)(index)[0]) << 8) | (((U_16)(index)[1]))), \
        ((index) += 2))

#define NEXT_U32_ENDIAN(bigEndian, value, index)                                                                   \
    ((value) = !(bigEndian) ? ((((U_32)(index)[0])) | (((U_32)(index)[1]) << 8) | (((U_32)(index)[2]) << 16)       \
                                  | (((U_32)(index)[3]) << 24))                                                    \
                            : ((((U_32)(index)[0]) << 24) | (((U_32)(index)[1]) << 16) | (((U_32)(index)[2]) << 8) \
                                  | (((U_32)(index)[3]))),                                                         \
        ((index) += 4))

#define NEXT_I32_ENDIAN(bigEndian, value, index)                                                                   \
    ((value) = !(bigEndian) ? (I_32)((((U_32)(index)[0])) | (((U_32)(index)[1]) << 8) | (((U_32)(index)[2]) << 16) \
                                  | (((U_32)(index)[3]) << 24))                                                    \
                            : (I_32)((((U_32)(index)[0]) << 24) | (((U_32)(index)[1]) << 16)                       \
                                  | (((U_32)(index)[2]) << 8) | (((U_32)(index)[3]))),                             \
        ((index) += 4))
