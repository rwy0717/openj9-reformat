...
#define SET_DP_EXPONENT(dblptr, e) \
    HIGH_U32_FROM_DBL_PTR(dblptr) = (HIGH_U32_FROM_DBL_PTR(dblptr) & DOUBLE_MANTISSA_MASK_HI) | ((e) << 20)
#define GET_LWDP_EXPONENT(lwptr) ((HIGH_U32_FROM_LONG64_PTR(lwptr) & DOUBLE_EXPONENT_MASK_HI) >> 20)
#define SET_LWDP_EXPONENT(lwptr, e) \
    HIGH_U32_FROM_LONG64_PTR(lwptr) = (HIGH_U32_FROM_LONG64_PTR(lwptr) & DOUBLE_MANTISSA_MASK_HI) | ((e) << 20)
#define GET_DP_SIGN(dblptr) ((HIGH_U32_FROM_DBL_PTR(dblptr) & DOUBLE_SIGN_MASK_HI) != 0)
#define SET_DP_SIGN(dblptr, s) \
    ((s) ? (HIGH_U32_FROM_DBL_PTR(dblptr) |= DOUBLE_SIGN_MASK_HI) : (HIGH_U32_FROM_DBL_PTR(dblptr) &= 0x7fffffff))
#define SET_LWDP_SIGN(lwptr, s) \
    ((s) ? (HIGH_U32_FROM_LONG64_PTR(lwptr) |= DOUBLE_SIGN_MASK_HI) : (HIGH_U32_FROM_LONG64_PTR(lwptr) &= 0x7fffffff))
...
#define TRUNCATE_LONG_TO_FLOAT(lw) \
    (((HIGH_U32_FROM_LONG64(lw) & 0x001fffff) << 3) | ((LOW_U32_FROM_LONG64(lw) & 0xe0000000) >> 29))
...
#define GET_FLOAT_BITS(dbl) \
    (((HIGH_U32_FROM_DBL(dbl) & 0x000fffff) << 3) | ((LOW_U32_FROM_DBL(dbl) & 0xe0000000) >> 29))
