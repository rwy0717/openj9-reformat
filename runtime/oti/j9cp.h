...
#define J9_CP_TYPE(cpShapeDescription, index)                                      \
    (((cpShapeDescription)[(index) / J9_CP_DESCRIPTIONS_PER_U32]                   \
         >> (((index) % J9_CP_DESCRIPTIONS_PER_U32) * J9_CP_BITS_PER_DESCRIPTION)) \
...
#define J9VM_IS_INITIALIZED_HEAPCLASS_VM(javaVM, _clazzObject)                                              \
    ((_clazzObject) && (J9OBJECT_CLAZZ_VM(((javaVM)), (_clazzObject)) == J9VMJAVALANGCLASS_OR_NULL(javaVM)) \
        && (0 != ((J9Class*)J9VMJAVALANGCLASS_VMREF_VM((javaVM), (j9object_t*)(_clazzObject)))))

#define J9_NATIVE_METHOD_IS_BOUND(nativeMethod) ((nativeMethod)->extra != (void*)J9_STARTPC_NOT_TRANSLATED)
