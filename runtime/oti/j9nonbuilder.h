...
typedef struct J9AOTWalkRelocationInfo {
    ...
    UDATA (*constantPoolImpl)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, struct J9JITRelocationRecordHeader* reloRecord, void* extra,
        UDATA value);
    UDATA (*constantPoolHeaderEntryImpl)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, struct J9JITRelocationRecordHeader* reloRecord, void* extra,
        UDATA value);
    UDATA (*helperAddressRelativeImpl)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, struct J9JITRelocationRecordHeader* reloRecord, void* extra,
        UDATA value);
    UDATA (*helperAddressAbsoluteImpl)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, struct J9JITRelocationRecordHeader* reloRecord, void* extra,
        UDATA value);
    UDATA (*absoluteMethodAddressImpl)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, struct J9JITRelocationRecordHeader* reloRecord, void* extra,
        UDATA value);
    UDATA (*dataAddressImpl)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, struct J9JITRelocationRecordHeader* reloRecord, void* extra,
        UDATA value);
    UDATA (*classObjectImpl)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, struct J9JITRelocationRecordHeader* reloRecord, void* extra,
        UDATA value);
    UDATA (*javaVMFieldOffsetImpl)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, struct J9JITRelocationRecordHeader* reloRecord, void* extra,
        UDATA value);
    UDATA (*resolveInstanceFieldImpl)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, struct J9JITRelocationRecordHeader* reloRecord, void* extra,
        UDATA value);
    UDATA (*resolveVTableSlotImpl)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, struct J9JITRelocationRecordHeader* reloRecord, void* extra,
        UDATA value);
...
typedef struct J9AOTCallbackFunctionTable {
    ...
    void (*initializeResolvedMethod)(
        struct J9AOTConfig* jitConfig, void* methodCookie, U_8** bytecodes, I_32* numParam, I_32* numTemp);
    void (*fetchSignatureFromCP)(struct J9AOTConfig* jitConfig, struct J9ROMClass* aRomClass, I_32 cpIndex,
        struct J9UTF8** className, struct J9UTF8** name, struct J9UTF8** signature);
    void (*fetchSignatureFromMethodCookie)(struct J9AOTConfig* jitConfig, void* methodCookie, struct J9UTF8** className,
        struct J9UTF8** name, struct J9UTF8** signature);
    ...
    IDATA (*fieldsAreSame)
    (struct J9AOTConfig* jitConfig, void* methodCookie1, I_32 cpIndex1, void* methodCookie2, I_32 cpIndex2);
    IDATA (*staticsAreSame)
    (struct J9AOTConfig* jitConfig, void* methodCookie1, I_32 cpIndex1, void* methodCookie2, I_32 cpIndex2);
    IDATA (*fieldAttributes)
    (struct J9AOTConfig* jitConfig, void* methodCookie, I_32 cpIndex, U_32* fieldOffset, UDATA* ltype, I_32* myVolatile,
        I_32* finalP, I_32* privateP);
    IDATA (*staticAttributes)
    (struct J9AOTConfig* jitConfig, void* methodCookie, I_32 cpIndex, U_32* address, U_32* ltype, I_32* myVolatile,
        I_32* finalP, I_32* privateP);
    ...
    void (*getClassRefNameFromCP)(
        struct J9AOTConfig* jitConfig, void* methodCookie, I_32 cpIndex, struct J9UTF8** className);
    void (*getFieldRefSignatureFromCP)(
        struct J9AOTConfig* jitConfig, void* methodCookie, I_32 cpIndex, struct J9UTF8** fieldSignature);
    IDATA (*fieldAttributesNoOffset)
    (struct J9AOTConfig* jitConfig, void* methodCookie, I_32 cpIndex, U_32* ltype, I_32* myVolatile, I_32* finalP,
        I_32* privateP);
    IDATA (*staticAttributesNoOffset)
    (struct J9AOTConfig* jitConfig, void* methodCookie, I_32 cpIndex, U_32* ltype, I_32* myVolatile, I_32* finalP,
        I_32* privateP);
...
typedef struct J9SharedInvariantInternTable {
    UDATA (*performNodeAction)
    (struct J9SharedInvariantInternTable* sharedInvariantInternTable, struct J9SharedInternSRPHashTableEntry* node,
        UDATA action, void* userData);
    UDATA flags;
...
#define J9SHAREDINTERNSRPHASHTABLEENTRY_PREVNODE(base) \
    SRP_GET((base)->prevNode, struct J9SharedInternSRPHashTableEntry*)
#define J9SHAREDINTERNSRPHASHTABLEENTRY_NEXTNODE(base) \
    SRP_GET((base)->nextNode, struct J9SharedInternSRPHashTableEntry*)
...
#define J9SHAREDCACHEHEADER_SHAREDSTRINGHEAD(base) \
    SRP_GET((base)->sharedStringHead, struct J9SharedInternSRPHashTableEntry*)
#define J9SHAREDCACHEHEADER_SHAREDSTRINGTAIL(base) \
    SRP_GET((base)->sharedStringTail, struct J9SharedInternSRPHashTableEntry*)
...
typedef struct J9SharedCacheAPI {
    ...
    UDATA cacheDirPerm;
    IDATA (*iterateSharedCaches)
    (struct J9JavaVM* vm, const char* cacheDir, UDATA groupPerm, BOOLEAN useCommandLineValues,
        IDATA (*callback)(struct J9JavaVM* vm, struct J9SharedCacheInfo* event_data, void* user_data), void* user_data);
    IDATA (*destroySharedCache)
    (struct J9JavaVM* vm, const char* cacheDir, const char* name, U_32 cacheType, BOOLEAN useCommandLineValues);
    ...
    U_8 inContainer; /* It is TRUE only when xShareClassesPresent is FALSE and J9_SHARED_CACHE_DEFAULT_BOOT_SHARING(vm)
                        is TRUE and the JVM is running in container */
} J9SharedCacheAPI;
...
typedef struct J9SharedClassConfig {
    ...
    void (*getUnstoredBytes)(
        struct J9JavaVM* vm, U_32* softmxUnstoredBytes, U_32* maxAOTUnstoredBytes, U_32* maxJITUnstoredBytes);
    UDATA (*getFreeSpaceBytes)(struct J9JavaVM* vm);
    IDATA (*findSharedData)
    (struct J9VMThread* currentThread, const char* key, UDATA keylen, UDATA limitDataType, UDATA includePrivateData,
        struct J9SharedDataDescriptor* firstItem, const struct J9Pool* descriptorPool);
    const U_8* (*storeSharedData)(
        struct J9VMThread* vmThread, const char* key, UDATA keylen, const struct J9SharedDataDescriptor* data);
    UDATA (*storeAttachedData)
    (struct J9VMThread* vmThread, const void* addressInCache, const struct J9SharedDataDescriptor* data,
        UDATA forceReplace);
    const U_8* (*findAttachedData)(struct J9VMThread* vmThread, const void* addressInCache,
        struct J9SharedDataDescriptor* data, IDATA* dataIsCorrupt);
    UDATA (*updateAttachedData)
    (struct J9VMThread* vmThread, const void* addressInCache, I_32 updateAtOffset, const J9SharedDataDescriptor* data);
    UDATA (*updateAttachedUDATA)
    (struct J9VMThread* vmThread, const void* addressInCache, UDATA type, I_32 updateAtOffset, UDATA value);
    ...
    const U_8* (*storeCompiledMethod)(struct J9VMThread* vmThread, const struct J9ROMMethod* romMethod,
...
#define J9RASCompatible(target)                                              \
    ((((target)->j9ras.ras.version & 0xffff0000) >> 16 == J9RASMajorVersion) \
        && (((target)->j9ras.ras.version & 0xffff) >= J9RASMinorVersion))
...
#pragma pack(push, 1)
/* Above covers all the platform for J9 VM compile jobs. DDR is compiled with EDG compiler, there following is for DDR
 * compile */
...
#if defined(__xlC__) || defined(__ibmxl__) || defined(__GNUC__) || defined(_MSC_VER) || defined(J9ZOS390) \
    || defined(LINUX) || defined(AIXPPC) || defined(WIN32)
#pragma pack(pop)
#else
#error "Unrecognized compiler. Cannot pack struct J9MethodParameter and J9MethodParametersData."
#endif
...
typedef struct J9VerboseStruct {
    ...
    U_8* (*getCfrExceptionDetails)(
        struct J9JavaVM* javaVM, J9CfrError* error, U_8* className, UDATA classNameLength, U_8* buf, UDATA* bufLen);
...
typedef struct J9JImageIntf {
    ...
    I_32 (*jimageFindResource)
    (struct J9JImageIntf* jimageIntf, UDATA handle, const char* moduleName, const char* name, UDATA* resourceLocation,
        I_64* size);
    void (*jimageFreeResourceLocation)(struct J9JImageIntf* jimageIntf, UDATA handle, UDATA resourceLocation);
    I_32 (*jimageGetResource)
    (struct J9JImageIntf* jimageIntf, UDATA handle, UDATA resourceLocation, char* buffer, I_64 bufferSize,
        I_64* resourceSize);
...
typedef struct J9TranslationBufferSet {
    ...
    IDATA (*findLocallyDefinedClassFunction)
    (struct J9VMThread* vmThread, struct J9Module* j9module, U_8* className, U_32 classNameLength,
        struct J9ClassLoader* classLoader, struct J9ClassPathEntry* classPath, UDATA classPathEntryCount, UDATA options,
        struct J9TranslationLocalBuffer* localBuffer);
    struct J9Class* (*internalDefineClassFunction)(struct J9VMThread* vmThread, void* className, UDATA classNameLength,
        U_8* classData, UDATA classDataLength, j9object_t classDataObject, struct J9ClassLoader* classLoader,
        j9object_t protectionDomain, UDATA options, struct J9ROMClass* existingROMClass, struct J9Class* hostClass,
        struct J9TranslationLocalBuffer* localBuffer);
    I_32 (*closeZipFileFunction)(struct J9VMInterface* vmi, struct VMIZipFile* zipFile);
    void (*reportStatisticsFunction)(struct J9JavaVM* javaVM, struct J9ClassLoader* loader, struct J9ROMClass* romClass,
        struct J9TranslationLocalBuffer* localBuffer);
    UDATA (*internalLoadROMClassFunction)
    (struct J9VMThread* vmThread, struct J9LoadROMClassData* loadData, struct J9TranslationLocalBuffer* localBuffer);
    IDATA (*transformROMClassFunction)
    (struct J9JavaVM* javaVM, struct J9PortLibrary* portLibrary, struct J9ROMClass* romClass, U_8** classData,
        U_32* size);
...
typedef struct J9BytecodeVerificationData {
    IDATA (*verifyBytecodesFunction)
    (struct J9PortLibrary* portLib, struct J9Class* ramClass, struct J9ROMClass* romClass,
        struct J9BytecodeVerificationData* verifyData);
    UDATA (*checkClassLoadingConstraintForNameFunction)
    (struct J9VMThread* vmThread, struct J9ClassLoader* loader1, struct J9ClassLoader* loader2, U_8* name1, U_8* name2,
        UDATA length, UDATA copyUTFs);
...
typedef struct J9NativeLibrary {
    ...
    UDATA flags;
    char* logicalName;
    IDATA (*send_lifecycle_event)
    (struct J9VMThread* vmThread, struct J9NativeLibrary* library, const char* functionName, IDATA defaultResult);
    UDATA (*close)(struct J9VMThread* vmThread, struct J9NativeLibrary* library);
    UDATA (*bind_method)
    (struct J9VMThread* vmThread, struct J9NativeLibrary* library, struct J9Method* method, char* functionName,
        char* argSignature);
    UDATA (*dispatch_method)
    (struct J9VMThread* vmThread, struct J9NativeLibrary* library, struct J9Method* method,
        struct J9HookedNative* hookInfo, void* arguments, void** returnValue);
...
/*
 * INTERFACE_STATIC and INTERFACE_INSTANCE cpType are used to track the classfile tag of a methodref
 * [CFR_CONSTANT_InterfaceMethodref] These types are need to support correct initializer for constantpool due to how cp
 * entries are pre-initialized These will be used to check for cp consistency during resolve time
 */
...
#define J9ROMCONSTANTDYNAMICREF_NAMEANDSIGNATURE(base) \
    NNSRP_GET((base)->nameAndSignature, struct J9ROMNameAndSignature*)
...
typedef struct J9StackWalkState {
    ...
    void (*objectSlotWalkFunction)(struct J9VMThread* vmThread, struct J9StackWalkState* walkState,
        j9object_t* objectSlot, const void* stackLocation);
    ...
    UDATA elsBitVector;
    void (*savedObjectSlotWalkFunction)(struct J9VMThread* vmThread, struct J9StackWalkState* walkState,
        j9object_t* objectSlot, const void* stackLocation);
...
#define J9OBJECT_MONITOR_EA(vmThread, object) \
    ((j9objectmonitor_t*)((U_8*)(object) + (J9OBJECT_CLAZZ(vmThread, object))->lockOffset))
...
#define J9CLASSLOADER_CLASSLOADEROBJECT(vmThread, object)                                             \
    J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_readObjectFromInternalVMSlot( \
        (vmThread), (j9object_t*)&((object)->classLoaderObject))
#define J9CLASSLOADER_SET_CLASSLOADEROBJECT(vmThread, object, value)                                 \
    J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_storeObjectToInternalVMSlot( \
        (vmThread), (j9object_t*)&((object)->classLoaderObject), (value))
...
typedef struct J9JITConfig {
    ...
    (struct J9JITExceptionTable* methodMetaData, void* stackMap, void* currentInlinedCallSite, UDATA* isSameReceiver);
    ...
    struct J9JITDecompilationInfo* (*jitCleanUpDecompilationStack)(
        struct J9VMThread* currentThread, J9StackWalkState* walkState, UDATA dropCurrentFrame);
    struct J9JITDecompilationInfo* (*jitAddDecompilationForFramePop)(
        struct J9VMThread* currentThread, J9StackWalkState* walkState);
    void (*jitHotswapOccurred)(struct J9VMThread* currentThread);
    void (*jitClassesRedefined)(
        struct J9VMThread* currentThread, UDATA classCount, struct J9JITRedefinedClass* classList);
    ...
    void (*jitFramePopNotificationAdded)(
        struct J9VMThread* currentThread, J9StackWalkState* walkState, UDATA inlineDepth);
    ...
    UDATA* (*jitLocalSlotAddress)(
        struct J9VMThread* currentThread, J9StackWalkState* walkState, UDATA slot, UDATA inlineDepth);
    ...
    IDATA (*retranslateWithPreparation)
    (struct J9JITConfig* jitConfig, struct J9VMThread* vmStruct, J9Method* method, void* oldStartPC, UDATA reason);
    IDATA (*retranslateWithPreparationForMethodRedefinition)
    (struct J9JITConfig* jitConfig, struct J9VMThread* vmStruct, J9Method* method, void* oldStartPC);
    void* j2iInvokeWithArguments;
    void* (*translateMethodHandle)(
        struct J9VMThread* currentThread, j9object_t methodHandle, j9object_t arg, U_32 flags);
    ...
    IDATA (*doAESInHardware)
    (char* inByteArray, I_32 inOffset, I_32 inLength, char* outByteArray, I_32 outOffset, int* rkeysIntArray, I_32 Nr,
        I_32 encrypt);
    ...
    IDATA (*launchGPU)
    (struct J9VMThread* vmThread, jobject invokeObject, J9Method* method, int deviceId, I_32 gridDimX, I_32 gridDimY,
        I_32 gridDimZ, I_32 blockDimX, I_32 blockDimY, I_32 blockDimZ, void** args);
    ...
    J9Method* (*jitGetExceptionCatcher)(
        struct J9VMThread* currentThread, void* handlerPC, struct J9JITExceptionTable* metaData, IDATA* location);
...
typedef struct J9AOTConfig {
    ...
    I_32 (*aotWalkRelocations)
    (struct J9JavaVM* javaVM, struct J9JITExceptionTable* exceptionTable,
        struct J9AOTWalkRelocationInfo* walkRelocationInfo, void* extra);
    U_8* jxeBuffer;
...
typedef struct J9MemoryManagerFunctions {
    j9object_t (*J9AllocateIndexableObject)(
        struct J9VMThread* vmContext, J9Class* clazz, U_32 size, UDATA allocateFlags);
    j9object_t (*J9AllocateObject)(struct J9VMThread* vmContext, J9Class* clazz, UDATA allocateFlags);
    j9object_t (*J9AllocateIndexableObjectNoGC)(
        struct J9VMThread* vmThread, J9Class* clazz, U_32 numberIndexedFields, UDATA allocateFlags);
    ...
    void (*J9WriteBarrierJ9ClassStore)(
        struct J9VMThread* vmThread, J9Class* destinationJ9Class, j9object_t storedObject);
    ...
    (struct J9VMThread* vmThread, J9IndexableObject* srcObject, J9IndexableObject* destObject, fj9object_t* srcAddress,
        fj9object_t* destAddress, I_32 lengthInSlots);
#if defined(J9VM_GC_ARRAYLETS)
    /* TODO: disable this entrypoint once the JIT has been updated */
    I_32 (*referenceArrayCopyIndex)
    (struct J9VMThread* vmThread, J9IndexableObject* srcObject, J9IndexableObject* destObject, I_32 srcIndex,
        I_32 destIndex, I_32 lengthInSlots);
#endif /* J9VM_GC_ARRAYLETS */
    UDATA (*alwaysCallReferenceArrayCopyHelper)(struct J9JavaVM* javaVM);
    void (*j9gc_ext_reachable_objects_do)(struct J9VMThread* vmThread,
        jvmtiIterationControl (*func)(j9object_t* slotPtr, j9object_t sourcePtr, void* userData, IDATA type,
            IDATA index, IDATA wasReportedBefore),
        void* userData, UDATA walkFlags);
    void (*j9gc_ext_reachable_from_object_do)(struct J9VMThread* vmThread, j9object_t objectPtr,
        jvmtiIterationControl (*func)(j9object_t* slotPtr, j9object_t sourcePtr, void* userData, IDATA type,
            IDATA index, IDATA wasReportedBefore),
        void* userData, UDATA walkFlags);
    UDATA (*j9gc_jit_isInlineAllocationSupported)(struct J9JavaVM* javaVM);
    void (*J9MetronomeWriteBarrierStore)(
        struct J9VMThread* vmThread, J9Object* dstObject, fj9object_t* dstAddress, J9Object* srcObject);
    void (*J9MetronomeWriteBarrierJ9ClassStore)(
        struct J9VMThread* vmThread, J9Object* dstObject, J9Object** dstAddress, J9Object* srcObject);
    ...
    IDATA (*j9gc_objaccess_indexableReadI8)
    (struct J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile);
    UDATA (*j9gc_objaccess_indexableReadU8)
    (struct J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile);
    IDATA (*j9gc_objaccess_indexableReadI16)
    (struct J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile);
    UDATA (*j9gc_objaccess_indexableReadU16)
    (struct J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile);
    IDATA (*j9gc_objaccess_indexableReadI32)
    (struct J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile);
    UDATA (*j9gc_objaccess_indexableReadU32)
    (struct J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile);
    I_64 (*j9gc_objaccess_indexableReadI64)
    (struct J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile);
    U_64 (*j9gc_objaccess_indexableReadU64)
    (struct J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile);
    j9object_t (*j9gc_objaccess_indexableReadObject)(
        struct J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile);
    void* (*j9gc_objaccess_indexableReadAddress)(
        struct J9VMThread* vmThread, J9IndexableObject* srcObject, I_32 index, UDATA isVolatile);
    void (*j9gc_objaccess_indexableStoreI8)(
        struct J9VMThread* vmThread, J9IndexableObject* destObject, I_32 index, I_32 value, UDATA isVolatile);
    void (*j9gc_objaccess_indexableStoreU8)(
        struct J9VMThread* vmThread, J9IndexableObject* destObject, I_32 index, U_32 value, UDATA isVolatile);
    ...
    void (*j9gc_objaccess_indexableStoreI64)(
        struct J9VMThread* vmThread, J9IndexableObject* destObject, I_32 index, I_64 value, UDATA isVolatile);
    void (*j9gc_objaccess_indexableStoreU64)(
        struct J9VMThread* vmThread, J9IndexableObject* destObject, I_32 index, U_64 value, UDATA isVolatile);
#if !defined(J9VM_ENV_DATA64)
    void (*j9gc_objaccess_indexableStoreU64Split)(struct J9VMThread* vmThread, J9IndexableObject* destObject,
        I_32 index, U_32 valueSlot0, U_32 valueSlot1, UDATA isVolatile);
#endif /* !J9VM_ENV_DATA64 */
    void (*j9gc_objaccess_indexableStoreObject)(
        struct J9VMThread* vmThread, J9IndexableObject* destObject, I_32 index, j9object_t value, UDATA isVolatile);
    void (*j9gc_objaccess_indexableStoreAddress)(
        struct J9VMThread* vmThread, J9IndexableObject* destObject, I_32 index, void* value, UDATA isVolatile);
    IDATA (*j9gc_objaccess_mixedObjectReadI32)
    (struct J9VMThread* vmThread, j9object_t srcObject, UDATA offset, UDATA isVolatile);
    UDATA (*j9gc_objaccess_mixedObjectReadU32)
    (struct J9VMThread* vmThread, j9object_t srcObject, UDATA offset, UDATA isVolatile);
    I_64 (*j9gc_objaccess_mixedObjectReadI64)
    (struct J9VMThread* vmThread, j9object_t srcObject, UDATA offset, UDATA isVolatile);
    U_64 (*j9gc_objaccess_mixedObjectReadU64)
    (struct J9VMThread* vmThread, j9object_t srcObject, UDATA offset, UDATA isVolatile);
    j9object_t (*j9gc_objaccess_mixedObjectReadObject)(
        struct J9VMThread* vmThread, j9object_t srcObject, UDATA offset, UDATA isVolatile);
    void* (*j9gc_objaccess_mixedObjectReadAddress)(
        struct J9VMThread* vmThread, j9object_t srcObject, UDATA offset, UDATA isVolatile);
    void (*j9gc_objaccess_mixedObjectStoreI32)(
        struct J9VMThread* vmThread, j9object_t destObject, UDATA offset, I_32 value, UDATA isVolatile);
    void (*j9gc_objaccess_mixedObjectStoreU32)(
        struct J9VMThread* vmThread, j9object_t destObject, UDATA offset, U_32 value, UDATA isVolatile);
    void (*j9gc_objaccess_mixedObjectStoreI64)(
        struct J9VMThread* vmThread, j9object_t destObject, UDATA offset, I_64 value, UDATA isVolatile);
    void (*j9gc_objaccess_mixedObjectStoreU64)(
        struct J9VMThread* vmThread, j9object_t destObject, UDATA offset, U_64 value, UDATA isVolatile);
    void (*j9gc_objaccess_mixedObjectStoreObject)(
        struct J9VMThread* vmThread, j9object_t destObject, UDATA offset, j9object_t value, UDATA isVolatile);
    void (*j9gc_objaccess_mixedObjectStoreAddress)(
        struct J9VMThread* vmThread, j9object_t destObject, UDATA offset, void* value, UDATA isVolatile);
#if !defined(J9VM_ENV_DATA64)
    void (*j9gc_objaccess_mixedObjectStoreU64Split)(struct J9VMThread* vmThread, j9object_t destObject, UDATA offset,
        U_32 valueSlot0, U_32 valueSlot1, UDATA isVolatile);
#endif /* !J9VM_ENV_DATA64 */
    UDATA (*j9gc_objaccess_mixedObjectCompareAndSwapInt)
    (struct J9VMThread* vmThread, j9object_t destObject, UDATA offset, U_32 compareValue, U_32 swapValue);
    UDATA (*j9gc_objaccess_mixedObjectCompareAndSwapLong)
    (struct J9VMThread* vmThread, j9object_t destObject, UDATA offset, U_64 compareValue, U_64 swapValue);
    U_32 (*j9gc_objaccess_mixedObjectCompareAndExchangeInt)
    (struct J9VMThread* vmThread, j9object_t destObject, UDATA offset, U_32 compareValue, U_32 swapValue);
    U_64 (*j9gc_objaccess_mixedObjectCompareAndExchangeLong)
    (struct J9VMThread* vmThread, j9object_t destObject, UDATA offset, U_64 compareValue, U_64 swapValue);
    ...
    j9object_t (*j9gc_objaccess_staticReadObject)(
        struct J9VMThread* vmThread, J9Class* clazz, j9object_t* srcSlot, UDATA isVolatile);
    void* (*j9gc_objaccess_staticReadAddress)(
        struct J9VMThread* vmThread, J9Class* clazz, void** srcSlot, UDATA isVolatile);
    void (*j9gc_objaccess_staticStoreI32)(
        struct J9VMThread* vmThread, J9Class* clazz, I_32* destSlot, I_32 value, UDATA isVolatile);
    void (*j9gc_objaccess_staticStoreU32)(
        struct J9VMThread* vmThread, J9Class* clazz, U_32* destSlot, U_32 value, UDATA isVolatile);
    void (*j9gc_objaccess_staticStoreI64)(
        struct J9VMThread* vmThread, J9Class* clazz, I_64* destSlot, I_64 value, UDATA isVolatile);
    void (*j9gc_objaccess_staticStoreU64)(
        struct J9VMThread* vmThread, J9Class* clazz, U_64* destSlot, U_64 value, UDATA isVolatile);
    void (*j9gc_objaccess_staticStoreObject)(
        struct J9VMThread* vmThread, J9Class* clazz, j9object_t* destSlot, j9object_t value, UDATA isVolatile);
    void (*j9gc_objaccess_staticStoreAddress)(
        struct J9VMThread* vmThread, J9Class* clazz, void** destSlot, void* value, UDATA isVolatile);
#if !defined(J9VM_ENV_DATA64)
    void (*j9gc_objaccess_staticStoreU64Split)(struct J9VMThread* vmThread, J9Class* clazz, U_64* destSlot,
        U_32 valueSlot0, U_32 valueSlot1, UDATA isVolatile);
#endif /* !J9VM_ENV_DATA64 */
    void (*j9gc_objaccess_storeObjectToInternalVMSlot)(
        struct J9VMThread* vmThread, j9object_t* destSlot, j9object_t value);
    ...
    void (*j9gc_objaccess_copyObjectFields)(struct J9VMThread* vmThread, J9Class* valueClass, j9object_t srcObject,
        UDATA srcOffset, j9object_t destObject, UDATA destOffset);
    void (*j9gc_objaccess_cloneIndexableObject)(
        struct J9VMThread* vmThread, J9IndexableObject* srcObject, J9IndexableObject* destObject);
    j9object_t (*j9gc_objaccess_asConstantPoolObject)(
        struct J9VMThread* vmThread, j9object_t toConvert, UDATA allocationFlags);
#if defined(J9VM_GC_REALTIME)
...
#endif /* J9VM_GC_REALTIME */
    UDATA (*j9gc_objaccess_compareAndSwapObject)
    (struct J9VMThread* vmThread, j9object_t destObject, j9object_t* destAddress, j9object_t compareObject,
        j9object_t swapObject);
    UDATA (*j9gc_objaccess_staticCompareAndSwapObject)
    (struct J9VMThread* vmThread, J9Class* destClass, j9object_t* destAddress, j9object_t compareObject,
        j9object_t swapObject);
    j9object_t (*j9gc_objaccess_compareAndExchangeObject)(struct J9VMThread* vmThread, j9object_t destObject,
        j9object_t* destAddress, j9object_t compareObject, j9object_t swapObject);
    j9object_t (*j9gc_objaccess_staticCompareAndExchangeObject)(struct J9VMThread* vmThread, J9Class* destClass,
        j9object_t* destAddress, j9object_t compareObject, j9object_t swapObject);
    void (*j9gc_objaccess_fillArrayOfObjects)(
        struct J9VMThread* vmThread, J9IndexableObject* destObject, I_32 destIndex, I_32 count, j9object_t value);
    ...
    jvmtiIterationControl (*j9mm_iterate_heaps)(struct J9JavaVM* vm, J9PortLibrary* portLibrary, UDATA flags,
        jvmtiIterationControl (*func)(struct J9JavaVM* vm, struct J9MM_IterateHeapDescriptor* heapDesc, void* userData),
        void* userData);
    jvmtiIterationControl (*j9mm_iterate_spaces)(struct J9JavaVM* javaVM, J9PortLibrary* portLibrary,
        struct J9MM_IterateHeapDescriptor* heap, UDATA flags,
        jvmtiIterationControl (*func)(
            struct J9JavaVM* vm, struct J9MM_IterateSpaceDescriptor* spaceDesc, void* userData),
        void* userData);
    jvmtiIterationControl (*j9mm_iterate_roots)(struct J9JavaVM* javaVM, J9PortLibrary* portLibrary, UDATA flags,
        jvmtiIterationControl (*func)(void* ptr, struct J9MM_HeapRootSlotDescriptor* rootDesc, void* userData),
        void* userData);
    jvmtiIterationControl (*j9mm_iterate_regions)(struct J9JavaVM* vm, J9PortLibrary* portLibrary,
        struct J9MM_IterateSpaceDescriptor* space, UDATA flags,
        jvmtiIterationControl (*func)(
            struct J9JavaVM* vm, struct J9MM_IterateRegionDescriptor* regionDesc, void* userData),
        void* userData);
    jvmtiIterationControl (*j9mm_iterate_region_objects)(struct J9JavaVM* vm, J9PortLibrary* portLibrary,
        struct J9MM_IterateRegionDescriptor* region, UDATA flags,
        jvmtiIterationControl (*func)(
            struct J9JavaVM* vm, struct J9MM_IterateObjectDescriptor* objectDesc, void* userData),
        void* userData);
    UDATA (*j9mm_find_region_for_pointer)
    (struct J9JavaVM* javaVM, void* pointer, struct J9MM_IterateRegionDescriptor* regionDesc);
    jvmtiIterationControl (*j9mm_iterate_object_slots)(struct J9JavaVM* javaVM, J9PortLibrary* portLibrary,
        struct J9MM_IterateObjectDescriptor* object, UDATA flags,
        jvmtiIterationControl (*func)(struct J9JavaVM* javaVM, struct J9MM_IterateObjectDescriptor* objectDesc,
            struct J9MM_IterateObjectRefDescriptor* refDesc, void* userData),
        void* userData);
    UDATA (*j9mm_arraylet_identification)
    (struct J9JavaVM* javaVM, UDATA* arrayletLeafSize, UDATA* offset, UDATA* width, UDATA* mask, UDATA* result);
#if defined(J9VM_GC_REALTIME)
    UDATA (*j9gc_objaccess_checkStringConstantsLive)
    (struct J9JavaVM* javaVM, j9object_t stringOne, j9object_t stringTwo);
#endif /* J9VM_GC_REALTIME */
    void (*j9mm_initialize_object_descriptor)(
        struct J9JavaVM* javaVM, struct J9MM_IterateObjectDescriptor* descriptor, j9object_t object);
    jvmtiIterationControl (*j9mm_iterate_all_objects)(struct J9JavaVM* vm, J9PortLibrary* portLibrary, UDATA flags,
        jvmtiIterationControl (*func)(struct J9JavaVM* vm, struct J9MM_IterateObjectDescriptor* object, void* userData),
        void* userData);
    ...
    UDATA (*j9mm_abandon_object)
    (struct J9JavaVM* javaVM, struct J9MM_IterateRegionDescriptor* region,
        struct J9MM_IterateObjectDescriptor* objectDesc);
    ...
    void (*j9gc_objaccess_postStoreClassToClassLoader)(
        struct J9VMThread* vmThread, J9ClassLoader* destClassLoader, J9Class* srcClass);
    ...
    j9object_t (*j9gc_allocStringWithSharedCharData)(
        struct J9VMThread* vmThread, U_8* data, UDATA length, UDATA resolveFlags);
#if defined(J9VM_GC_FINALIZATION)
    ...
    void (*j9gc_objaccess_jniReleasePrimitiveArrayCritical)(
        struct J9VMThread* vmThread, jarray array, void* elems, jint mode);
    ...
    void (*j9gc_get_CPU_times)(
        struct J9JavaVM* javaVM, U_64* masterCpuMillis, U_64* slaveCpuMillis, U_32* maxThreads, U_32* currentThreads);
    void* (*omrgc_walkLWNRLockTracePool)(void* omrVM, pool_state* state);
#if defined(J9VM_GC_OBJECT_ACCESS_BARRIER)
    UDATA (*j9gc_objaccess_staticCompareAndSwapInt)
    (struct J9VMThread* vmThread, J9Class* destClass, U_32* destAddress, U_32 compareValue, U_32 swapValue);
    U_32 (*j9gc_objaccess_staticCompareAndExchangeInt)
    (struct J9VMThread* vmThread, J9Class* destClass, U_32* destAddress, U_32 compareValue, U_32 swapValue);
#if !defined(J9VM_ENV_DATA64)
    UDATA (*j9gc_objaccess_mixedObjectCompareAndSwapLongSplit)
    (struct J9VMThread* vmThread, J9Object* destObject, UDATA offset, U_32 compareValueSlot0, U_32 compareValueSlot1,
        U_32 swapValueSlot0, U_32 swapValueSlot1);
#endif /* !J9VM_ENV_DATA64 */
    UDATA (*j9gc_objaccess_staticCompareAndSwapLong)
    (struct J9VMThread* vmThread, J9Class* destClass, U_64* destAddress, U_64 compareValue, U_64 swapValue);
    U_64 (*j9gc_objaccess_staticCompareAndExchangeLong)
    (struct J9VMThread* vmThread, J9Class* destClass, U_64* destAddress, U_64 compareValue, U_64 swapValue);
#if !defined(J9VM_ENV_DATA64)
    UDATA (*j9gc_objaccess_staticCompareAndSwapLongSplit)
    (struct J9VMThread* vmThread, J9Class* destClass, U_64* destAddress, U_32 compareValueSlot0, U_32 compareValueSlot1,
        U_32 swapValueSlot0, U_32 swapValueSlot1);
#endif /* !J9VM_ENV_DATA64 */
#endif /* J9VM_GC_OBJECT_ACCESS_BARRIER */
    UDATA (*j9gc_get_bytes_allocated_by_thread)(struct J9VMThread* vmThread);
    jvmtiIterationControl (*j9mm_iterate_all_ownable_synchronizer_objects)(struct J9VMThread* vmThread,
        J9PortLibrary* portLibrary, UDATA flags,
        jvmtiIterationControl (*func)(
            struct J9VMThread* vmThread, struct J9MM_IterateObjectDescriptor* object, void* userData),
        void* userData);
    UDATA (*ownableSynchronizerObjectCreated)(struct J9VMThread* vmThread, j9object_t object);
    void (*j9gc_notifyGCOfClassReplacement)(
        struct J9VMThread* vmThread, J9Class* originalClass, J9Class* replacementClass, UDATA isFastHCR);
...
typedef struct J9InternalVMFunctions {
    ...
    struct J9Class* (*internalFindClassUTF8)(struct J9VMThread* currentThread, U_8* className, UDATA classNameLength,
        struct J9ClassLoader* classLoader, UDATA options);
    struct J9Class* (*internalFindClassInModule)(struct J9VMThread* currentThread, struct J9Module* j9module,
        U_8* className, UDATA classNameLength, struct J9ClassLoader* classLoader, UDATA options);
    struct J9Class* (*internalFindClassString)(struct J9VMThread* currentThread, j9object_t moduleName,
        j9object_t className, struct J9ClassLoader* classLoader, UDATA options);
    struct J9Class* (*hashClassTableAt)(struct J9ClassLoader* classLoader, U_8* className, UDATA classNameLength);
    UDATA (*hashClassTableAtPut)
    (struct J9VMThread* vmThread, struct J9ClassLoader* classLoader, U_8* className, UDATA classNameLength,
        struct J9Class* value);
    UDATA (*hashClassTableDelete)(struct J9ClassLoader* classLoader, U_8* className, UDATA classNameLength);
    void (*hashClassTableReplace)(struct J9VMThread* vmThread, struct J9ClassLoader* classLoader,
        struct J9Class* originalClass, struct J9Class* replacementClass);
    struct J9ObjectMonitor* (*monitorTableAt)(struct J9VMThread* vmStruct, j9object_t object);
    struct J9VMThread* (*allocateVMThread)(
        struct J9JavaVM* vm, omrthread_t osThread, UDATA privateFlags, void* memorySpace, J9Object* threadObject);
    void (*deallocateVMThread)(struct J9VMThread* vmThread, UDATA decrementZombieCount, UDATA sendThreadDestroyEvent);
    struct J9MemorySegment* (*allocateMemorySegment)(
        struct J9JavaVM* javaVM, UDATA size, UDATA type, U_32 memoryCategory);
    IDATA (*javaThreadProc)(void* entryarg);
    char* (*copyStringToUTF8WithMemAlloc)(struct J9VMThread* currentThread, j9object_t string, UDATA stringFlags,
        const char* prependStr, UDATA prependStrLength, char* buffer, UDATA bufferLength, UDATA* utf8Length);
    J9UTF8* (*copyStringToJ9UTF8WithMemAlloc)(struct J9VMThread* vmThread, j9object_t string, UDATA stringFlags,
        const char* prependStr, UDATA prependStrLength, char* buffer, UDATA bufferLength);
    ...
    IDATA (*instanceFieldOffset)
    (struct J9VMThread* vmStruct, struct J9Class* clazz, U_8* fieldName, UDATA fieldNameLength, U_8* signature,
        UDATA signatureLength, struct J9Class** definingClass, UDATA* instanceField, UDATA options);
    void* (*staticFieldAddress)(struct J9VMThread* vmStruct, struct J9Class* clazz, U_8* fieldName,
        UDATA fieldNameLength, U_8* signature, UDATA signatureLength, struct J9Class** definingClass,
        UDATA* staticField, UDATA options, struct J9Class* sourceClass);
    ...
    void(JNICALL* sendInit)(struct J9VMThread* vmContext, j9object_t object, struct J9Class* senderClass,
        UDATA lookupOptions, UDATA reserved0);
    void (*internalAcquireVMAccessNoMutex)(struct J9VMThread* vmThread);
    struct J9Class* (*internalCreateArrayClass)(
        struct J9VMThread* vmThread, struct J9ROMArrayClass* romClass, struct J9Class* elementClass);
    ...
    j9object_t (*helperMultiANewArray)(struct J9VMThread* vmStruct, J9ArrayClass* classPtr, UDATA dimensions,
        I_32* dimensionArray, UDATA allocationType);
#endif /* J9VM_OPT_REFLECT */
    UDATA (*javaLookupMethod)
    (struct J9VMThread* currentThread, struct J9Class* clazz, struct J9ROMNameAndSignature* selector,
        struct J9Class* senderClass, UDATA options);
    UDATA (*javaLookupMethodImpl)
    (struct J9VMThread* currentThread, struct J9Class* clazz, struct J9ROMNameAndSignature* selector,
        struct J9Class* senderClass, UDATA options, BOOLEAN* foundDefaultConflicts);
    ...
    void (*setCurrentExceptionNLS)(
        struct J9VMThread* vmThread, UDATA exceptionNumber, U_32 moduleName, U_32 messageNumber);
    void (*setCurrentExceptionNLSWithArgs)(
        struct J9VMThread* vmThread, U_32 nlsModule, U_32 nlsID, UDATA exceptionIndex, ...);
    void (*setCurrentExceptionWithCause)(
        struct J9VMThread* currentThread, UDATA exceptionNumber, UDATA* detailMessage, j9object_t cause);
    ...
    struct J9Method* (*resolveStaticMethodRef)(
        struct J9VMThread* vmStruct, J9ConstantPool* constantPool, UDATA cpIndex, UDATA resolveFlags);
    struct J9Method* (*resolveStaticSplitMethodRef)(
        struct J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA splitTableIndex, UDATA resolveFlags);
    struct J9Method* (*resolveSpecialMethodRef)(
        struct J9VMThread* vmStruct, J9ConstantPool* constantPool, UDATA cpIndex, UDATA resolveFlags);
    struct J9Method* (*resolveSpecialSplitMethodRef)(
        struct J9VMThread* vmStruct, J9ConstantPool* constantPool, UDATA splitTableIndex, UDATA resolveFlags);
    void* (*resolveStaticFieldRef)(struct J9VMThread* vmStruct, J9Method* method, J9ConstantPool* constantPool,
        UDATA fieldIndex, UDATA resolveFlags, struct J9ROMFieldShape** resolvedField);
    IDATA (*resolveInstanceFieldRef)
    (struct J9VMThread* vmStruct, J9Method* method, J9ConstantPool* constantPool, UDATA fieldIndex, UDATA resolveFlags,
        struct J9ROMFieldShape** resolvedField);
    struct J9ClassLoader* (*allocateClassLoader)(struct J9JavaVM* javaVM);
    void(JNICALL* internalSendExceptionConstructor)(struct J9VMThread* vmContext, struct J9Class* exceptionClass,
        j9object_t exception, j9object_t detailMessage, UDATA constructorIndex);
    IDATA (*instanceOfOrCheckCast)(struct J9Class* instanceClass, struct J9Class* castClass);
    struct J9Class* (*internalCreateRAMClassFromROMClass)(struct J9VMThread* vmThread,
        struct J9ClassLoader* classLoader, struct J9ROMClass* romClass, UDATA options, struct J9Class* elementClass,
        j9object_t protectionDomain, struct J9ROMMethod** methodRemapArray, IDATA entryIndex, I_32 locationType,
        struct J9Class* classBeingRedefined, struct J9Class* hostClass);
    j9object_t (*resolveStringRef)(
        struct J9VMThread* vmStruct, J9ConstantPool* constantPool, UDATA cpIndex, UDATA resolveFlags);
    ...
    struct J9Class* (*resolveClassRef)(
        struct J9VMThread* vmStruct, J9ConstantPool* constantPool, UDATA cpIndex, UDATA resolveFlags);
    ...
    UDATA (*resolveVirtualMethodRef)
    (struct J9VMThread* vmStruct, J9ConstantPool* constantPool, UDATA cpIndex, UDATA resolveFlags,
        struct J9Method** resolvedMethod);
    struct J9Method* (*resolveInterfaceMethodRef)(
        struct J9VMThread* vmStruct, J9ConstantPool* constantPool, UDATA cpIndex, UDATA resolveFlags);
    UDATA (*getVTableOffsetForMethod)(struct J9Method* method, struct J9Class* clazz, struct J9VMThread* vmThread);
    IDATA (*checkVisibility)
    (struct J9VMThread* currentThread, struct J9Class* sourceClass, struct J9Class* destClass, UDATA modifiers,
        UDATA lookupOptions);
    void(JNICALL* sendClinit)(
        struct J9VMThread* vmContext, struct J9Class* clazz, UDATA reserved1, UDATA reserved2, UDATA reserved3);
    ...
    (struct J9VMThread* currentThread, struct J9Class* thrownExceptionClass, J9ConstantPool* constantPool,
        UDATA handlerIndex, J9StackWalkState* walkState);
#if defined(J9VM_IVE_ROM_IMAGE_HELPERS) \
    || (defined(J9VM_OPT_DYNAMIC_LOAD_SUPPORT) && defined(J9VM_OPT_ROM_IMAGE_SUPPORT))
    struct J9MemorySegment* (*romImageNewSegment)(
        struct J9JavaVM* vm, struct J9ROMImageHeader* header, UDATA isBaseType, struct J9ClassLoader* classLoader);
    ...
    j9object_t (*catUtfToString4)(struct J9VMThread* vmThread, const U_8* data1, UDATA length1, const U_8* data2,
        UDATA length2, const U_8* data3, UDATA length3, const U_8* data4, UDATA length4);
    struct J9MemorySegmentList* (*allocateMemorySegmentList)(
        struct J9JavaVM* javaVM, U_32 numberOfMemorySegments, U_32 memoryCategory);
    struct J9MemorySegmentList* (*allocateMemorySegmentListWithFlags)(
        struct J9JavaVM* javaVM, U_32 numberOfMemorySegments, UDATA flags, U_32 memoryCategory);
    void (*freeMemorySegmentList)(struct J9JavaVM* javaVM, struct J9MemorySegmentList* segmentList);
    struct J9MemorySegment* (*allocateMemorySegmentInList)(
        struct J9JavaVM* javaVM, struct J9MemorySegmentList* segmentList, UDATA size, UDATA type, U_32 memoryCategory);
    struct J9MemorySegment* (*allocateVirtualMemorySegmentInList)(struct J9JavaVM* javaVM,
        struct J9MemorySegmentList* segmentList, UDATA size, UDATA type, J9PortVmemParams* vmemParams);
    struct J9MemorySegment* (*allocateMemorySegmentListEntry)(struct J9MemorySegmentList* segmentList);
    struct J9MemorySegment* (*allocateClassMemorySegment)(struct J9JavaVM* javaVM, UDATA requiredSize,
        UDATA segmentType, struct J9ClassLoader* classLoader, UDATA allocationIncrement);
#if defined(J9VM_GC_FINALIZATION)
    void (*jniResetStackReferences)(JNIEnv* env);
#endif /* J9VM_GC_FINALIZATION */
    void (*freeClassLoader)(
        struct J9ClassLoader* classLoader, struct J9JavaVM* javaVM, struct J9VMThread* vmThread, UDATA needsFrameBuild);
    ...
    struct J9JNIFieldID* (*getJNIFieldID)(struct J9VMThread* currentThread, struct J9Class* declaringClass,
        struct J9ROMFieldShape* field, UDATA offset, UDATA* inconsistentData);
    ...
    void(JNICALL* initializeAttachedThread)(struct J9VMThread* vmContext, const char* name, j9object_t* group,
        UDATA daemon, struct J9VMThread* initializee);
    void (*initializeMethodRunAddressNoHook)(struct J9JavaVM* vm, J9Method* method);
    void(JNICALL* sidecarInvokeReflectMethod)(
        struct J9VMThread* vmContext, jobject methodRef, jobject recevierRef, jobjectArray argsRef, void* unused);
    void(JNICALL* sidecarInvokeReflectConstructor)(
        struct J9VMThread* vmContext, jobject constructorRef, jobject recevierRef, jobjectArray argsRef, void* unused);
    struct J9MemorySegmentList* (*allocateMemorySegmentListWithSize)(
        struct J9JavaVM* javaVM, U_32 numberOfMemorySegments, UDATA sizeOfElements, U_32 memoryCategory);
...
#if defined(J9VM_GC_REALTIME)
    UDATA (*requestExclusiveVMAccessMetronome)
    (struct J9JavaVM* vm, UDATA block, UDATA* responsesRequired, UDATA* gcPriority);
    ...
    UDATA (*requestExclusiveVMAccessMetronomeTemp)
    (struct J9JavaVM* vm, UDATA block, UDATA* vmResponsesRequired, UDATA* jniResponsesRequired, UDATA* gcPriority);
    void (*waitForExclusiveVMAccessMetronomeTemp)(
        struct J9VMThread* vmThread, UDATA vmResponsesRequired, UDATA jniResponsesRequired);
#endif /* J9VM_GC_REALTIME */
    ...
    IDATA (*findArgInVMArgs)
    (J9PortLibrary* portLibrary, struct J9VMInitArgs* j9vm_args, UDATA match, const char* optionName,
        const char* optionValue, UDATA doConsumeArgs);
    IDATA (*optionValueOperations)
    (J9PortLibrary* portLibrary, struct J9VMInitArgs* j9vm_args, IDATA element, IDATA action, char** valuesBuffer,
        UDATA bufSize, char delim, char separator, void* reserved);
    ...
    struct J9Class* (*allClassesStartDo)(
        struct J9ClassWalkState* state, struct J9JavaVM* vm, struct J9ClassLoader* classLoader);
    struct J9Class* (*allClassesNextDo)(struct J9ClassWalkState* state);
    void (*allClassesEndDo)(struct J9ClassWalkState* state);
    struct J9Class* (*allLiveClassesStartDo)(
        struct J9ClassWalkState* state, struct J9JavaVM* vm, struct J9ClassLoader* classLoader);
    struct J9Class* (*allLiveClassesNextDo)(struct J9ClassWalkState* state);
    void (*allLiveClassesEndDo)(struct J9ClassWalkState* state);
    struct J9ClassLoader* (*allClassLoadersStartDo)(
        struct J9ClassLoaderWalkState* state, struct J9JavaVM* vm, UDATA flags);
    ...
    struct J9ROMClass* (*romClassLoadFromCookie)(
        struct J9VMThread* vmStruct, U_8* clsName, UDATA clsNameLength, U_8* romClassBytes, UDATA romClassLength);
...
#endif /* J9VM_GC_DYNAMIC_CLASS_UNLOADING */
    UDATA (*iterateStackTrace)
    (struct J9VMThread* vmThread, j9object_t* exception,
        UDATA (*callback)(struct J9VMThread* vmThread, void* userData, struct J9ROMClass* romClass,
            struct J9ROMMethod* romMethod, J9UTF8* fileName, UDATA lineNumber, struct J9ClassLoader* classLoader),
        void* userData, UDATA pruneConstructors);
    ...
    IDATA (*internalAttachCurrentThread)
    (struct J9JavaVM* vm, struct J9VMThread** p_env, struct J9JavaVMAttachArgs* thr_args, UDATA threadType,
        void* osThread);
    void (*setHaltFlag)(struct J9VMThread* vmThread, UDATA flag);
    void (*returnFromJNI)(struct J9VMThread* env, void* bp);
    IDATA (*j9stackmap_StackBitsForPC)
    (J9PortLibrary* portLib, UDATA pc, struct J9ROMClass* romClass, struct J9ROMMethod* romMethod,
    ...
    struct J9UTF8* (*annotationElementIteratorStart)(
        struct J9AnnotationState* state, struct J9AnnotationInfoEntry* annotation, void** data);
    ...
    UDATA (*getAllAnnotationsFromAnnotationInfo)
    (struct J9AnnotationInfo* annInfo, struct J9AnnotationInfoEntry** annotations);
    struct J9AnnotationInfoEntry* (*getAnnotationDefaultsForAnnotation)(struct J9VMThread* currentThread,
        struct J9Class* containingClass, struct J9AnnotationInfoEntry* annotation, UDATA flags);
    struct J9AnnotationInfoEntry* (*getAnnotationDefaultsForNamedAnnotation)(struct J9VMThread* currentThread,
        struct J9Class* containingClass, char* className, U_32 classNameLength, UDATA flags);
    struct J9AnnotationInfo* (*getAnnotationInfoFromClass)(struct J9JavaVM* vm, struct J9Class* clazz);
    UDATA (*getAnnotationsFromAnnotationInfo)
    (struct J9AnnotationInfo* annInfo, UDATA annotationType, char* memberName, U_32 memberNameLength,
        char* memberSignature, U_32 memberSignatureLength, struct J9AnnotationInfoEntry** annotations);
    struct J9AnnotationInfoEntry* (*getAnnotationFromAnnotationInfo)(struct J9AnnotationInfo* annInfo,
        UDATA annotationType, char* memberName, U_32 memberNameLength, char* memberSignature,
        U_32 memberSignatureLength, char* annotationName, U_32 annotationNameLength);
    void* (*getNamedElementFromAnnotation)(struct J9AnnotationInfoEntry* annotation, char* name, U_32 nameLength);
    UDATA (*registerNativeLibrary)
    (struct J9VMThread* vmThread, struct J9ClassLoader* classLoader, const char* libName, char* libraryPath,
        struct J9NativeLibrary** libraryPtr, char* errorBuffer, UDATA bufferLength);
    UDATA (*registerBootstrapLibrary)
    (struct J9VMThread* vmThread, const char* libName, struct J9NativeLibrary** libraryPtr, UDATA suppressError);
    UDATA (*startJavaThread)
    (struct J9VMThread* currentThread, j9object_t threadObject, UDATA privateFlags, UDATA osStackSize, UDATA priority,
        omrthread_entrypoint_t entryPoint, void* entryArg, j9object_t schedulingParameters);
    ...
    UDATA (*addHiddenInstanceField)
    (struct J9JavaVM* vm, const char* className, const char* fieldName, const char* fieldSignature,
        UDATA* offsetReturn);
    struct J9ROMFieldOffsetWalkResult* (*fieldOffsetsStartDo)(struct J9JavaVM* vm, struct J9ROMClass* romClass,
        struct J9Class* superClazz, struct J9ROMFieldOffsetWalkState* state, U_32 flags);
    struct J9ROMFieldOffsetWalkResult* (*fieldOffsetsNextDo)(struct J9ROMFieldOffsetWalkState* state);
    struct J9ROMFieldShape* (*fullTraversalFieldOffsetsStartDo)(
        struct J9JavaVM* vm, struct J9Class* clazz, struct J9ROMFullTraversalFieldOffsetWalkState* state, U_32 flags);
    ...
    void (*setClassCastException)(
        struct J9VMThread* currentThread, struct J9Class* instanceClass, struct J9Class* castClass);
    UDATA (*compareStrings)(struct J9VMThread* vmThread, j9object_t string1, j9object_t string2);
    UDATA (*compareStringToUTF8)
    (struct J9VMThread* vmThread, j9object_t stringObject, UDATA stringFlags, const U_8* utfData, UDATA utfLength);
    void (*prepareForExceptionThrow)(struct J9VMThread* currentThread);
    void (*copyUTF8ToUnicode)(struct J9VMThread* vmThread, U_8* data, UDATA length, UDATA stringFlags,
        j9object_t charArray, UDATA startIndex);
    UDATA (*verifyQualifiedName)(struct J9VMThread* vmThread, j9object_t string);
    UDATA (*copyStringToUTF8Helper)
    (struct J9VMThread* vmThread, j9object_t string, UDATA stringFlags, UDATA stringOffset, UDATA stringLength,
        U_8* utf8Data, UDATA utf8DataLength);
    void(JNICALL* sendCompleteInitialization)(
        struct J9VMThread* vmContext, UDATA reserved1, UDATA reserved2, UDATA reserved3, UDATA reserved4);
    ...
    struct J9PackageIDTableEntry* (*hashPkgTableStartDo)(
        struct J9ClassLoader* classLoader, struct J9HashTableState* walkState);
    ...
    U_8* (*buildNativeFunctionNames)(
        struct J9JavaVM* javaVM, struct J9Method* ramMethod, struct J9Class* ramClass, UDATA nameOffset);
    IDATA (*resolveInstanceFieldRefInto)
    (struct J9VMThread* vmStruct, J9Method* method, J9ConstantPool* constantPool, UDATA fieldIndex, UDATA resolveFlags,
        struct J9ROMFieldShape** resolvedField, J9RAMFieldRef* ramCPEntry);
    struct J9Method* (*resolveInterfaceMethodRefInto)(struct J9VMThread* vmStruct, J9ConstantPool* constantPool,
        UDATA cpIndex, UDATA resolveFlags, struct J9RAMInterfaceMethodRef* ramCPEntry);
    struct J9Method* (*resolveSpecialMethodRefInto)(struct J9VMThread* vmStruct, J9ConstantPool* constantPool,
        UDATA cpIndex, UDATA resolveFlags, struct J9RAMSpecialMethodRef* ramCPEntry);
    void* (*resolveStaticFieldRefInto)(struct J9VMThread* vmStruct, J9Method* method, J9ConstantPool* constantPool,
        UDATA fieldIndex, UDATA resolveFlags, struct J9ROMFieldShape** resolvedField,
        struct J9RAMStaticFieldRef* ramCPEntry);
    struct J9Method* (*resolveStaticMethodRefInto)(struct J9VMThread* vmStruct, J9ConstantPool* constantPool,
        UDATA cpIndex, UDATA resolveFlags, struct J9RAMStaticMethodRef* ramCPEntry);
    UDATA (*resolveVirtualMethodRefInto)
    (struct J9VMThread* vmStruct, J9ConstantPool* constantPool, UDATA cpIndex, UDATA resolveFlags,
        struct J9Method** resolvedMethod, struct J9RAMVirtualMethodRef* ramCPEntry);
    IDATA (*findObjectDeadlockedThreads)
    (struct J9VMThread* currentThread, j9object_t** pDeadlockedThreads, j9object_t** pBlockingObjects, UDATA flags);
    struct J9ROMClass* (*findROMClassFromPC)(
        struct J9VMThread* vmThread, UDATA methodPC, struct J9ClassLoader** resultClassLoader);
    IDATA (*j9localmap_LocalBitsForPC)
    (struct J9PortLibrary* portLib, struct J9ROMClass* romClass, struct J9ROMMethod* romMethod, UDATA pc,
        U_32* resultArrayBase, void* userData, UDATA* (*getBuffer)(void* userData),
        void (*releaseBuffer)(void* userData));
    ...
    IDATA (*getOwnedObjectMonitors)
    (struct J9VMThread* currentThread, struct J9VMThread* targetThread, struct J9ObjectMonitorInfo* info,
        IDATA infoLen);
    ...
    char* (*illegalAccessMessage)(struct J9VMThread* currentThread, IDATA badMemberModifier, J9Class* senderClass,
        J9Class* targetClass, IDATA errorType);
    ...
    IDATA (*setVMThreadNameFromString)
    (struct J9VMThread* currentThread, struct J9VMThread* vmThread, j9object_t nameObject);
    ...
    j9object_t (*resolveMethodTypeRef)(
        struct J9VMThread* vmThread, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags);
    void(JNICALL* sendFromMethodDescriptorString)(struct J9VMThread* vmThread, J9UTF8* descriptor,
        J9ClassLoader* classLoader, J9Class* appendArgType, UDATA reserved4);
    UDATA (*addToBootstrapClassLoaderSearch)
    (struct J9JavaVM* vm, const char* pathSegment, UDATA classLoaderType, BOOLEAN enforceJarRestriction);
    UDATA (*addToSystemClassLoaderSearch)
    (struct J9JavaVM* vm, const char* pathSegment, UDATA classLoaderType, BOOLEAN enforceJarRestriction);
    ...
    void (*cacheObjectMonitorForLookup)(
        struct J9JavaVM* vm, struct J9VMThread* vmStruct, struct J9ObjectMonitor* objectMonitor);
#endif /* J9VM_THR_LOCK_NURSERY */
    ...
    void(JNICALL* sendForGenericInvoke)(struct J9VMThread* vmThread, j9object_t methodHandle, j9object_t methodType,
        UDATA dropFirstArg, UDATA reserved4);
    void(JNICALL* jitFillOSRBuffer)(
        struct J9VMThread* vmContext, void* osrBlock, UDATA reserved1, UDATA reserved2, UDATA reserved3);
    void(JNICALL* sendResolveMethodHandle)(struct J9VMThread* vmThread, UDATA cpIndex, J9ConstantPool* ramCP,
        J9Class* definingClass, J9ROMNameAndSignature* nameAndSig);
    j9object_t (*resolveConstantDynamic)(
        struct J9VMThread* vmThread, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags);
    j9object_t (*resolveInvokeDynamic)(
        struct J9VMThread* vmThread, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags);
    void(JNICALL* sendResolveConstantDynamic)(struct J9VMThread* vmThread, J9ConstantPool* ramCP, UDATA cpIndex,
        J9ROMNameAndSignature* nameAndSig, U_16* bsmData);
    void(JNICALL* sendResolveInvokeDynamic)(struct J9VMThread* vmThread, J9ConstantPool* ramCP, UDATA callSiteIndex,
        J9ROMNameAndSignature* nameAndSig, U_16* bsmData);
    j9object_t (*resolveMethodHandleRef)(
        struct J9VMThread* vmThread, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags);
    ...
    void (*copyUTF8ToCompressedUnicode)(
        struct J9VMThread* vmThread, U_8* data, UDATA length, UDATA stringFlags, j9object_t byteArray, UDATA offset);
...
#endif /* J9VM_PORT_ZOS_CEEHDLRSUPPORT */
    struct J9Class* (*findFieldSignatureClass)(
        struct J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA fieldRefCpIndex);
    void (*walkBytecodeFrameSlots)(J9StackWalkState* walkState, struct J9Method* method, UDATA offsetPC,
        UDATA* pendingBase, UDATA pendingStackHeight, UDATA* localBase, UDATA numberOfLocals, UDATA alwaysLocalMap);
    void* (*jniNativeMethodProperties)(
        struct J9VMThread* currentThread, struct J9Method* jniNativeMethod, UDATA* properties);
    ...
    IDATA (*monitorWaitImpl)
    (struct J9VMThread* vmThread, j9object_t object, I_64 millis, I_32 nanos, UDATA interruptable);
    ...
    IDATA (*createThreadWithCategory)
    (omrthread_t* handle, UDATA stacksize, UDATA priority, UDATA suspend, omrthread_entrypoint_t entrypoint,
        void* entryarg, U_32 category);
    ...
    struct J9Module* (*findModuleForPackageUTF8)(
        struct J9VMThread* currentThread, struct J9ClassLoader* classLoader, struct J9UTF8* packageName);
    struct J9Module* (*findModuleForPackage)(
        struct J9VMThread* currentThread, struct J9ClassLoader* classLoader, U_8* packageName, U_32 packageNameLen);
    struct J9ModuleExtraInfo* (*findModuleInfoForModule)(
        struct J9VMThread* currentThread, struct J9ClassLoader* classLoader, J9Module* j9module);
    ...
    UDATA (*initializeClassPath)
    (struct J9JavaVM* vm, char* classPath, U_8 classPathSeparator, U_16 cpFlags, BOOLEAN initClassPathEntry,
        struct J9ClassPathEntry** classPathEntries);
    IDATA (*initializeClassPathEntry)(struct J9JavaVM* javaVM, struct J9ClassPathEntry* cpEntry);
    BOOLEAN (*setBootLoaderModulePatchPaths)
    (struct J9JavaVM* javaVM, struct J9Module* j9module, const char* moduleName);
    ...
    void (*setIllegalAccessErrorReceiverNotSameOrSubtypeOfCurrentClass)(
        struct J9VMThread* vmStruct, struct J9Class* receiverClass, struct J9Class* currentClass);
    ...
    void (*setNestmatesError)(
        struct J9VMThread* vmThread, struct J9Class* nestMember, struct J9Class* nestHost, IDATA errorCode);
#endif /* J9VM_OPT_VALHALLA_NESTMATES */
...
typedef struct J9VMThread {
    ...
    UDATA returnValue;
    UDATA returnValue2;
    UDATA* objectFlagSpinLockAddress; /* used by JIT. Do not remove, even though NO VM code uses it see matching comment
                                         in J9VMThread.st */
...
#define J9VMTHREAD_BLOCKINGENTEROBJECT(vmThread, object)                                              \
    J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_readObjectFromInternalVMSlot( \
        (vmThread), (j9object_t*)&((object)->blockingEnterObject))
#define J9VMTHREAD_SET_BLOCKINGENTEROBJECT(vmThread, object, value)                                  \
    J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_storeObjectToInternalVMSlot( \
        (vmThread), (j9object_t*)&((object)->blockingEnterObject), (value))
...
typedef struct J9ReflectFunctionTable {
    ...
    j9object_t (*createConstructorObject)(struct J9Method* ramMethod, struct J9Class* declaringClass,
        j9array_t parameterTypes, struct J9VMThread* vmThread);
    j9object_t (*createDeclaredConstructorObject)(struct J9Method* ramMethod, struct J9Class* declaringClass,
        j9array_t parameterTypes, struct J9VMThread* vmThread);
    j9object_t (*createDeclaredMethodObject)(struct J9Method* ramMethod, struct J9Class* declaringClass,
        j9array_t parameterTypes, struct J9VMThread* vmThread);
    j9object_t (*createMethodObject)(struct J9Method* ramMethod, struct J9Class* declaringClass,
        j9array_t parameterTypes, struct J9VMThread* vmThread);
    void (*fillInReflectMethod)(
        j9object_t methodObject, struct J9Class* declaringClass, jmethodID methodID, struct J9VMThread* vmThread);
    struct J9JNIFieldID* (*idFromFieldObject)(
        struct J9VMThread* vmStruct, j9object_t declaringClassObject, j9object_t fieldObject);
...
typedef struct J9JavaVM {
    ...
    omrthread_monitor_t processReferenceMonitor; /* the monitor for synchronizing between reference process and
                                                    j9gc_wait_for_reference_processing() (only for Java 9 and later) */
    ...
    UDATA (*aotFindAndInitializeMethodEntryPoint)
    (struct J9JavaVM* javaVM, struct J9ConstantPool* ramCP, struct J9Method* method,
        struct J9JXEDescription* jxeDescription);
    UDATA (*aotInitializeJxeEntryPoint)
    (struct J9JavaVM* javaVM, struct J9JXEDescription* description, UDATA beforeBootstrap);
    ...
    struct J9Statistic* nextStatistic;
    I_32(JNICALL* loadAgentLibraryOnAttach)
    (struct J9JavaVM* vm, const char* library, const char* options, UDATA decorate);
