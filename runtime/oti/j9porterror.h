 ...
 * j9error.c::j9error_set_last_error "j9error_set_last_error()" or @ref j9error.c::j9error_set_last_error_with_message
 * "j9error_set_last_error_with_message()".  The mapping of the OS specific error code to a portable error code is the
...
#define J9PORT_ERROR_SOCKET_WOULDBLOCK \
    (J9PORT_ERROR_SOCKET_BASE - 11) /* the socket is marked as nonblocking operation would block */
...
#define J9PORT_ERROR_SOCKET_UNKNOWNSOCKET \
    (J9PORT_ERROR_SOCKET_BASE - 15) /* resolution of fileDescriptor to socket failed */
...
#define J9PORT_ERROR_SOCKET_REMSOCKSHUTDOWN \
    (J9PORT_ERROR_SOCKET_BASE - 19) /* The remote socket has shutdown gracefully */
#define J9PORT_ERROR_SOCKET_NOTLISTENING \
    (J9PORT_ERROR_SOCKET_BASE - 20) /* listen() was not invoked prior to accept() */
#define J9PORT_ERROR_SOCKET_NOTSTREAMSOCK \
    (J9PORT_ERROR_SOCKET_BASE - 21) /* The socket does not support connection-oriented service */
#define J9PORT_ERROR_SOCKET_ALREADYBOUND (J9PORT_ERROR_SOCKET_BASE - 22) /* The socket is already bound to an address \
                                                                          */
#define J9PORT_ERROR_SOCKET_NBWITHLINGER \
    (J9PORT_ERROR_SOCKET_BASE - 23) /* The socket is marked non-blocking & SO_LINGER is non-zero */
...
#define J9PORT_ERROR_SOCKET_BOUNDORCONN \
    (J9PORT_ERROR_SOCKET_BASE - 28) /* The socket has not been bound or is already connected */
...
#define J9PORT_ERROR_SOCKET_SOCKADDRALLOCFAIL \
    (J9PORT_ERROR_SOCKET_BASE - 34) /* Unable to allocate the sockaddr structure */
#define J9PORT_ERROR_SOCKET_FDSET_SIZEBAD \
    (J9PORT_ERROR_SOCKET_BASE - 35) /* The calculated maximum size of the file descriptor set is bad */
#define J9PORT_ERROR_SOCKET_UNKNOWNFLAG (J9PORT_ERROR_SOCKET_BASE - 36) /* The flag is unknown */
#define J9PORT_ERROR_SOCKET_MSGSIZE \
    (J9PORT_ERROR_SOCKET_BASE - 37) /* The datagram was too big to fit the specified buffer & was truncated. */
#define J9PORT_ERROR_SOCKET_NORECOVERY \
    (J9PORT_ERROR_SOCKET_BASE - 38) /* The operation failed with no recovery possible */
#define J9PORT_ERROR_SOCKET_ARGSINVALID (J9PORT_ERROR_SOCKET_BASE - 39) /* The arguments are invalid */
#define J9PORT_ERROR_SOCKET_BADDESC \
    (J9PORT_ERROR_SOCKET_BASE - 40) /* The socket argument is not a valid file descriptor */
#define J9PORT_ERROR_SOCKET_NOTSOCK (J9PORT_ERROR_SOCKET_BASE - 41) /* The socket argument is not a socket */
#define J9PORT_ERROR_SOCKET_HOSTENTALLOCFAIL \
    (J9PORT_ERROR_SOCKET_BASE - 42) /* Unable to allocate the hostent structure */
#define J9PORT_ERROR_SOCKET_TIMEVALALLOCFAIL \
    (J9PORT_ERROR_SOCKET_BASE - 43) /* Unable to allocate the timeval structure */
#define J9PORT_ERROR_SOCKET_LINGERALLOCFAIL \
    (J9PORT_ERROR_SOCKET_BASE - 44) /* Unable to allocate the linger structure */
#define J9PORT_ERROR_SOCKET_IPMREQALLOCFAIL \
    (J9PORT_ERROR_SOCKET_BASE - 45) /* Unable to allocate the ipmreq structure */
...
#define J9PORT_ERROR_SOCKET_WAS_CLOSED \
    (J9PORT_ERROR_SOCKET_BASE - 52) /* the socket was closed (set to NULL or INVALID) */
#define J9PORT_ERROR_SOCKET_EINPROGRESS \
    (J9PORT_ERROR_SOCKET_BASE           \
        - 53) /* Non-blocking socket could not connect immediately, connect is happening asynchronously */
#define J9PORT_ERROR_SOCKET_ALREADYINPROGRESS \
    (J9PORT_ERROR_SOCKET_BASE - 54) /* A connection attempt is already in progress on the socket */
#define J9PORT_ERROR_SOCKET_NOSR \
    (J9PORT_ERROR_SOCKET_BASE - 55) /* Insufficient streams resources for the operation to complete */
#define J9PORT_ERROR_SOCKET_IO \
    (J9PORT_ERROR_SOCKET_BASE - 56) /* I/O error occurred either in making dir entry or allocation inode. */
#define J9PORT_ERROR_SOCKET_ISDIR (J9PORT_ERROR_SOCKET_BASE - 57) /* Null pathname is specified. */
#define J9PORT_ERROR_SOCKET_LOOP \
    (J9PORT_ERROR_SOCKET_BASE - 58) /* Too many symbolic names were encountered in translating the pathname. */
#define J9PORT_ERROR_SOCKET_NOENT \
    (J9PORT_ERROR_SOCKET_BASE - 59) /* Component of the path prefix of the pathname does not exist */
#define J9PORT_ERROR_SOCKET_NOTDIR \
    (J9PORT_ERROR_SOCKET_BASE - 60) /* Component of the path prefix of the pathname is not a directory */
