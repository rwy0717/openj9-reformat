 ...
 * @return omr_error_t
 */
omr_error_t copyDumpSettings(struct J9JavaVM* vm, struct J9RASdumpSettings* src, struct J9RASdumpSettings* dst);
 ...
 * @return IDATA
 */
struct J9RASdumpSettings* copyDumpSettingsQueue(struct J9JavaVM* vm, struct J9RASdumpSettings* toCopy);
 ...
 */
void j9rasSetServiceLevel(J9JavaVM* vm, const char* runtimeVersion);
