 ...
 *
 * @return  The address of the JNI native to encode in the compiled code, or NULL if the method is not a bound JNI
 * native
 */
void* jniNativeMethodProperties(J9VMThread* currentThread, J9Method* jniNativeMethod, UDATA* properties);
 ...
 * @return J9UTF8 *
 */
J9UTF8* annotationElementIteratorNext(J9AnnotationState* state, void** data);
 ...
 * @return void *
 */
void* elementArrayIteratorNext(J9AnnotationState* state);
 ...
 * @return void *
 */
void* elementArrayIteratorStart(J9AnnotationState* state, UDATA start, U_32 count);
 ...
 */
J9AnnotationInfo* getAnnotationInfoFromClass(J9JavaVM* vm, J9Class* clazz);
 ...
 * @return void *
 */
void* getNamedElementFromAnnotation(J9AnnotationInfoEntry* annotation, char* name, U_32 nameLength);
 ...
 * @return j9object_t
 */
j9object_t helperMultiANewArray(
    J9VMThread* vmStruct, J9ArrayClass* classPtr, UDATA dimensions, I_32* dimensionArray, UDATA allocationType);
 ...
 * @return void *
 */
void* alignJNIAddress(J9JavaVM* vm, void* address, J9ClassLoader* classLoader);
 ...
 * @return U_8*
 */
U_8* buildNativeFunctionNames(J9JavaVM* javaVM, J9Method* ramMethod, J9Class* ramClass, UDATA nameOffset);
 ...
 * @return void
 */
void freeNativeMethodBindTable(J9JavaVM* vm);
...
UDATA
initializePackageID(
    J9ClassLoader* classLoader, J9ROMClass* romClass, J9VMThread* vmThread, IDATA entryIndex, I_32 locationType);
 ...
 */
J9ClassLoader* internalAllocateClassLoader(J9JavaVM* javaVM, j9object_t classLoaderObject);
 ...
 * @return J9ClassLoader*
 */
J9ClassLoader* allocateClassLoader(J9JavaVM* javaVM);
 ...
 * @return void
 */
void freeClassLoader(J9ClassLoader* classLoader, J9JavaVM* javaVM, J9VMThread* vmThread, UDATA needsFrameBuild);
 ...
 * @return J9Class*
 */
J9Class* internalCreateArrayClass(J9VMThread* vmThread, J9ROMArrayClass* romClass, J9Class* elementClass);
...
J9Class* internalFindClassString(
    J9VMThread* currentThread, j9object_t moduleName, j9object_t className, J9ClassLoader* classLoader, UDATA options);
 ...
 *
 */
J9Class* internalFindClassInModule(J9VMThread* vmThread, J9Module* j9module, U_8* className, UDATA classNameLength,
    J9ClassLoader* classLoader, UDATA options);
 ...
 * @return void
 */
void internalRunPreInitInstructions(J9Class* ramClass, J9VMThread* vmThread);
 ...
 * @return J9Class*
 */
J9Class* resolveKnownClass(J9JavaVM* vm, UDATA index);
 ...
 * @return J9HashTable*
 */
J9HashTable* contendedLoadTableNew(J9JavaVM* vm, J9PortLibrary* portLib);

/**
 * @brief
 * @param vm
 */
void contendedLoadTableFree(J9JavaVM* vm);
 ...
 * @param cpIndex
 */
void fixCPShapeDescription(J9Class* clazz, UDATA cpIndex);
 ...
 * @return J9Class*
 */
J9Class* internalCreateRAMClassFromROMClass(J9VMThread* vmThread, J9ClassLoader* classLoader, J9ROMClass* romClass,
    UDATA options, J9Class* elementClass, j9object_t protectionDomain, J9ROMMethod** methodRemapArray, IDATA entryIndex,
    I_32 locationType, J9Class* classBeingRedefined, J9Class* hostClass);
...
addToBootstrapClassLoaderSearch(
    J9JavaVM* vm, const char* pathSegment, UDATA classLoaderType, BOOLEAN enforceJarRestriction);
...
jclass getJimModules(J9VMThread* currentThread);
/* ---------------- description.c ---------------- */
 ...
 * @return void
 */
void calculateInstanceDescription(J9VMThread* vmThread, J9Class* ramClass, J9Class* ramSuperClass, UDATA* storage,
    J9ROMFieldOffsetWalkState* walkState, J9ROMFieldOffsetWalkResult* walkResult);
...
void internalExceptionDescribe(J9VMThread* vmThread);
 ...
 */
UDATA
iterateStackTrace(J9VMThread* vmThread, j9object_t* exception,
    UDATA (*callback)(J9VMThread* vmThread, void* userData, J9ROMClass* romClass, J9ROMMethod* romMethod,
        J9UTF8* fileName, UDATA lineNumber, J9ClassLoader* classLoader),
 ...
 */
UDATA
isExceptionTypeCaughtByHandler(J9VMThread* currentThread, J9Class* thrownExceptionClass, J9ConstantPool* constantPool,
 ...
 * @return void
 */
void setNativeBindOutOfMemoryError(J9VMThread* currentThread, J9Method* method);
 ...
 * @return void
 */
void setRecursiveBindError(J9VMThread* currentThread, J9Method* method);
 ...
 * @return void
 */
void setNativeNotFoundError(J9VMThread* currentThread, J9Method* method);
 ...
 * @return void
 */
void setClassLoadingConstraintError(J9VMThread* currentThread, J9ClassLoader* initiatingLoader, J9Class* existingClass);
 ...
 * @return void
 */
void setClassCastException(J9VMThread* currentThread, J9Class* instanceClass, J9Class* castClass);
...
void setCurrentExceptionWithCause(
    J9VMThread* currentThread, UDATA exceptionNumber, UDATA* detailMessage, j9object_t cause);
 ...
 * @return void
 */
void setCurrentExceptionWithUtfCause(
    J9VMThread* currentThread, UDATA exceptionNumber, UDATA* detailMessage, const char* utfMessage, j9object_t cause);
 ...
 * @return void
 */
void setCurrentExceptionNLS(J9VMThread* vmThread, UDATA exceptionNumber, U_32 moduleName, U_32 messageNumber);
 ...
 */
void setCurrentExceptionNLSWithArgs(J9VMThread* vmThread, U_32 nlsModule, U_32 nlsID, UDATA exceptionIndex, ...);
 ...
 * @return void
 */
void setHeapOutOfMemoryError(J9VMThread* currentThread);
 ...
 * @return void
 */
void setArrayIndexOutOfBoundsException(J9VMThread* currentThread, IDATA index);
 ...
 * @return void
 */
void setNativeOutOfMemoryError(J9VMThread* vmThread, U_32 moduleName, U_32 messageNumber);
 ...
 * @return void
 */
void setThreadForkOutOfMemoryError(J9VMThread* vmThread, U_32 moduleName, U_32 messageNumber);
 ...
 * @return void
 */
void setIncompatibleClassChangeErrorForDefaultConflict(J9VMThread* vmThread, J9Method* method);
 ...
 * @return void
 */
void setIllegalAccessErrorNonPublicInvokeInterface(J9VMThread* vmThread, J9Method* method);
...
void setIllegalAccessErrorReceiverNotSameOrSubtypeOfCurrentClass(
    J9VMThread* vmStruct, J9Class* receiverClass, J9Class* currentClass);
 ...
 * @return jint
 */
jint initializeHeapOOMMessage(J9VMThread* currentThread);
 ...
 */
void setIllegalAccessErrorFinalFieldSet(
    J9VMThread* currentThread, UDATA isStatic, J9ROMClass* romClass, J9ROMFieldShape* field, J9ROMMethod* romMethod);
 ...
 */
j9object_t walkStackForExceptionThrow(J9VMThread* currentThread, j9object_t exception, UDATA walkOnly);

struct J9Class;
void setClassLoadingConstraintSignatureError(J9VMThread* currentThread, J9ClassLoader* loader1, J9Class* class1,
    J9ClassLoader* loader2, J9Class* class2, J9Class* exceptionClass, U_8* methodName, UDATA methodNameLength,
    U_8* signature, UDATA signatureLength);

void setClassLoadingConstraintOverrideError(J9VMThread* currentThread, J9UTF8* newClassNameUTF, J9ClassLoader* loader1,
    J9UTF8* class1NameUTF, J9ClassLoader* loader2, J9UTF8* class2NameUTF, J9UTF8* exceptionClassNameUTF,
    U_8* methodName, UDATA methodNameLength, U_8* signature, UDATA signatureLength);
...
/**
 * @brief Called  on vmEntry and return from JNI to detect the case where we had percolated a condition and the user
 * native illegally resumed execution Terminates the VM
 * @param vmThread
 * @return void
 */
void javaAndCStacksMustBeInSync(J9VMThread* vmThread, BOOLEAN fromJIT);
 ...
 * @return void
 */
void initializeMethodRunAddress(J9VMThread* vmThread, J9Method* method);
 ...
 * @return void
 */
void initializeMethodRunAddressNoHook(J9JavaVM* vm, J9Method* method);
 ...
 * @return jint
 */
jint initializeINLInterception(J9JavaVM* vm);
 ...
 * @return void
 */
void initializeInitialMethods(J9JavaVM* vm);
 ...
 * @return void **
 */
void** ensureJNIIDTable(J9VMThread* currentThread, J9Class* clazz);
 ...
 * @param inconsistentData An out parameter that is set to 1 if a redefinition mismatch is detected.  The caller must
 * zero the field before calling.
 * @return J9JNIFieldID *  NULL if the operation fails for any reason, including redefinition conflicts or a
 * J9JNIFieldID if it succeeds
 */
J9JNIFieldID* getJNIFieldID(
    J9VMThread* currentThread, J9Class* declaringClass, J9ROMFieldShape* field, UDATA offset, UDATA* inconsistentData);
 ...
 */
J9JNIMethodID* getJNIMethodID(J9VMThread* currentThread, J9Method* method);
 ...
 * @return void
 */
void initializeMethodID(J9VMThread* currentThread, J9JNIMethodID* methodID, J9Method* method);
 ...
 * @return jint
 */
jint callJNILoad(J9VMThread* vmStruct, UDATA slHandle, char* fnName, jint defaultResult);
 ...
 * @return void
 */
void gpCheckCallin(JNIEnv* env, jobject receiver, jclass cls, jmethodID methodID, void* args);
 ...
 * @return void
 */
void jniPopFrame(J9VMThread* vmThread, UDATA type);
...
internalAttachCurrentThread(
    J9JavaVM* vm, J9VMThread** p_env, J9JavaVMAttachArgs* thr_args, UDATA threadType, void* osThread);
 ...
 * @return void
 */
void printBytecodePairs(J9JavaVM* vm);
 ...
 * @return jint
 */
jint initializeJavaVM(void* osMainThread, J9JavaVM** vmPtr, J9CreateJavaVMParams* createParams);
 ...
 * @return void
 */
void runExitStages(J9JavaVM* vm, J9VMThread* vmThread);
 ...
 * If 'initClassPathEntry' is TRUE, then each class path entry in initialized by calling 'initializeClassPathEntry()'
 * function.
 *
 ...
 */
UDATA
initializeClassPath(J9JavaVM* vm, char* classPath, U_8 classPathSeparator, U_16 cpFlags, BOOLEAN initClassPathEntry,
 ...
 * @return J9ROMClass*
 */
J9ROMClass* checkRomClassForError(J9ROMClass* romClass, J9VMThread* vmThread);
 ...
 * @return J9ROMClass *
 */
J9ROMClass* romClassLoadFromCookie(
    J9VMThread* vmStruct, U_8* clsName, UDATA clsNameLength, U_8* romClassBytes, UDATA romClassLength);
 ...
 * @return void
 */
void setExceptionForErroredRomClass(J9ROMClass* romClass, J9VMThread* vmThread);
 ...
 * @return void
 */
void hashClassTableFree(J9ClassLoader* classLoader);
 ...
 * @return J9Class *
 */
J9Class* hashClassTableAt(J9ClassLoader* classLoader, U_8* className, UDATA classNameLength);
 ...
 * @return J9Class *
 */
J9Class* hashClassTableAtString(J9ClassLoader* classLoader, j9object_t stringObject);
...
UDATA
hashClassTableAtPut(
    J9VMThread* vmThread, J9ClassLoader* classLoader, U_8* className, UDATA classNameLength, J9Class* value);
 ...
 * @return J9HashTable *
 */
J9HashTable* hashClassTableNew(J9JavaVM* javaVM, U_32 initialSize);
...
void hashClassTableReplace(
    J9VMThread* vmThread, J9ClassLoader* classLoader, J9Class* originalClass, J9Class* replacementClass);
 ...
 * @return J9Class*
 */
J9Class* hashClassTableStartDo(J9ClassLoader* classLoader, J9HashTableState* walkState);
 ...
 * @return J9Class*
 */
J9Class* hashClassTableNextDo(J9HashTableState* walkState);
 ...
 */
J9HashTable* hashClassLocationTableNew(J9JavaVM* javaVM, U_32 initialSize);
 ...
 */
J9ClassLocation* findClassLocationForClass(J9VMThread* currentThread, J9Class* clazz);
 ...
 * @return Pointer to new hash table
 */
J9HashTable* hashModuleTableNew(J9JavaVM* javaVM, U_32 initialSize);
 ...
 * @return Pointer to new hash table
 */
J9HashTable* hashPackageTableNew(J9JavaVM* javaVM, U_32 initialSize);
 ...
 * @return Pointer to new hash table
 */
J9HashTable* hashModuleExtraInfoTableNew(J9JavaVM* javaVM, U_32 initialSize);
 ...
 */
J9Module* findModuleForPackageUTF8(J9VMThread* currentThread, J9ClassLoader* classLoader, J9UTF8* packageName);
 ...
 * @return Returns pointer to J9Module that is associated with the given package name or NULL if not found.
 */
J9Module* findModuleForPackage(
    J9VMThread* currentThread, J9ClassLoader* classLoader, U_8* packageName, U_32 packageNameLen);

/**
 * @brief Locates and returns a structure containing extra information like jrt URL, patch path entries associated with
 * the given module
 *
 * @param currentThread current thread pointer
 ...
 */
J9ModuleExtraInfo* findModuleInfoForModule(J9VMThread* currentThread, J9ClassLoader* classLoader, J9Module* j9module);
 ...
 */
J9Method* searchClassForMethod(J9Class* clazz, U_8* name, UDATA nameLength, U_8* sig, UDATA sigLength);
...
UDATA
javaLookupMethod(
    J9VMThread* vmContext, J9Class* clazz, J9ROMNameAndSignature* selector, J9Class* senderClass, UDATA options);

/**
 * Temporary impl of javaLookupMethod for adding BOOLEAN foundDefConflicts. Will be removed as part of work item 67075.
 */
UDATA
javaLookupMethodImpl(J9VMThread* vmContext, J9Class* clazz, J9ROMNameAndSignature* selector, J9Class* senderClass,
    UDATA options, BOOLEAN* foundDefaultConflicts);
 ...
 * @return J9Method*
 */
J9Method* getForwardedMethod(J9VMThread* currentThread, J9Method* method);
 ...
 */
J9ObjectMonitor* objectMonitorInflate(J9VMThread* vmStruct, j9object_t object, UDATA lock);
 ...
 * @param vmThread
 */
void objectMonitorDestroyComplete(J9JavaVM* vm, J9VMThread* vmThread);
 ...
 */
void cancelLockReservation(J9VMThread* vmStruct);
 ...
 * @return void
 */
void destroyMonitorTable(J9JavaVM* vm);
 ...
 * @return omrthread_monitor_t
 */
J9ObjectMonitor* monitorTableAt(J9VMThread* vmStruct, j9object_t object);
 ...
 * @return void
 */
void cacheObjectMonitorForLookup(J9JavaVM* vm, J9VMThread* vmStruct, J9ObjectMonitor* objectMonitor);
...
UDATA
hashPkgTableIDFor(
    J9VMThread* vmThread, J9ClassLoader* classLoader, J9ROMClass* romClass, IDATA entryIndex, I_32 locationType);
 ...
 */
J9PackageIDTableEntry* hashPkgTableAt(J9ClassLoader* classLoader, J9ROMClass* romClass);
 ...
 */
J9PackageIDTableEntry* hashPkgTableStartDo(J9ClassLoader* classLoader, J9HashTableState* walkState);
 ...
 * @return J9PackageIDTableEntry*
 */
J9PackageIDTableEntry* hashPkgTableNextDo(J9HashTableState* walkState);
 ...
 * @return void
 */
void flushBytecodeProfilingData(J9VMThread* vmThread);
 ...
 * @return void
 */
void profilingBytecodeBufferFullHookRegistered(J9JavaVM* vm);
 ...
 * @return void
 */
void freeHiddenInstanceFieldsList(J9JavaVM* vm);
 ...
 * @param fieldName[in] the name of the hidden field to be added (used for information purposes only - no checks for
 * duplicate names will be made)
 * @param fieldSignature[in] the Java signature for the field (e.g. "J" (long), "I" (int), "Ljava/lang/String;", etc)
 * @param offsetReturn[out] the address to store the offset of the field once the class is loaded; may be NULL if not
 * needed
 * @return 0 on success, non-zero if the field could not be recorded or some other error occurred
 */
UDATA
addHiddenInstanceField(
    J9JavaVM* vm, const char* className, const char* fieldName, const char* fieldSignature, UDATA* offsetReturn);
 ...
 */
IDATA
instanceFieldOffset(J9VMThread* vmStruct, J9Class* clazz, U_8* fieldName, UDATA fieldNameLength, U_8* signature,
    UDATA signatureLength, J9Class** definingClass, UDATA* instanceField, UDATA options);
 ...
 */
IDATA
instanceFieldOffsetWithSourceClass(J9VMThread* vmStruct, J9Class* clazz, U_8* fieldName, UDATA fieldNameLength,
    U_8* signature, UDATA signatureLength, J9Class** definingClass, UDATA* instanceField, UDATA options,
    J9Class* sourceClass);
 ...
 */
J9ROMFieldOffsetWalkResult* fieldOffsetsStartDo(
    J9JavaVM* vm, J9ROMClass* romClass, J9Class* superClazz, J9ROMFieldOffsetWalkState* state, U_32 flags);
 ...
 * @return J9ROMFieldOffsetWalkResult *
 */
J9ROMFieldOffsetWalkResult* fieldOffsetsNextDo(J9ROMFieldOffsetWalkState* state);
 ...
 */
J9ROMFieldShape* fullTraversalFieldOffsetsStartDo(
    J9JavaVM* vm, J9Class* clazz, J9ROMFullTraversalFieldOffsetWalkState* state, U_32 flags);
 ...
 * @return J9ROMFieldShape *
 */
J9ROMFieldShape* fullTraversalFieldOffsetsNextDo(J9ROMFullTraversalFieldOffsetWalkState* state);
 ...
 * @return void *
 */
void* staticFieldAddress(J9VMThread* vmStruct, J9Class* clazz, U_8* fieldName, UDATA fieldNameLength, U_8* signature,
    UDATA signatureLength, J9Class** definingClass, UDATA* staticField, UDATA options, J9Class* sourceClass);
 ...
 * @exceptions none
 */
void fieldIndexTableRemove(J9JavaVM* vm, J9Class* ramClass);
 ...
 */
UDATA
packageAccessIsLegal(
    J9VMThread* currentThread, J9Class* targetClass, j9object_t protectionDomain, UDATA canRunJavaCode);
 ...
 * @return j9object_t
 */
j9object_t resolveStringRef(J9VMThread* vmStruct, J9ConstantPool* constantPool, UDATA cpIndex, UDATA resolveFlags);
 ...
 * @return J9Class *
 */
J9Class* findFieldSignatureClass(J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA fieldRefCpIndex);
 ...
 * @return J9Method *
 */
J9Method* resolveStaticMethodRefInto(
    J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags, J9RAMStaticMethodRef* ramCPEntry);
 ...
 * @return J9Method *
 */
J9Method* resolveStaticMethodRef(J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags);
 ...
 * @return J9Method *
 */
J9Method* resolveStaticSplitMethodRef(
    J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA splitTableIndex, UDATA resolveFlags);
 ...
 * @return void *
 */
void* resolveStaticFieldRefInto(J9VMThread* vmStruct, J9Method* method, J9ConstantPool* ramCP, UDATA cpIndex,
    UDATA resolveFlags, J9ROMFieldShape** resolvedField, J9RAMStaticFieldRef* ramCPEntry);
 ...
 * @return void *
 */
void* resolveStaticFieldRef(J9VMThread* vmStruct, J9Method* method, J9ConstantPool* ramCP, UDATA cpIndex,
    UDATA resolveFlags, J9ROMFieldShape** resolvedField);
 ...
 */
IDATA
resolveInstanceFieldRefInto(J9VMThread* vmStruct, J9Method* method, J9ConstantPool* ramCP, UDATA cpIndex,
    UDATA resolveFlags, J9ROMFieldShape** resolvedField, J9RAMFieldRef* ramCPEntry);
 ...
 */
IDATA
resolveInstanceFieldRef(J9VMThread* vmStruct, J9Method* method, J9ConstantPool* ramCP, UDATA cpIndex,
    UDATA resolveFlags, J9ROMFieldShape** resolvedField);
 ...
 * @return UDATA
 */
J9Method* resolveInterfaceMethodRefInto(J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags,
    J9RAMInterfaceMethodRef* ramCPEntry);
 ...
 * @return UDATA
 */
J9Method* resolveInterfaceMethodRef(J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags);
 ...
 * @return J9Method *
 */
J9Method* resolveSpecialMethodRefInto(
    J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags, J9RAMSpecialMethodRef* ramCPEntry);
 ...
 * @return J9Method *
 */
J9Method* resolveSpecialMethodRef(J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags);
 ...
 * @return J9Method *
 */
J9Method* resolveSpecialSplitMethodRef(
    J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA splitTableIndex, UDATA resolveFlags);
 ...
 */
UDATA
resolveVirtualMethodRefInto(J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags,
    J9Method** resolvedMethod, J9RAMVirtualMethodRef* ramCPEntry);
...
resolveVirtualMethodRef(
    J9VMThread* vmStruct, J9ConstantPool* ramCP, UDATA cpIndex, UDATA resolveFlags, J9Method** resolvedMethod);
 ...
 * @return void
 */
void allClassLoadersEndDo(J9ClassLoaderWalkState* state);
 ...
 * @return J9ClassLoader*
 */
J9ClassLoader* allClassLoadersNextDo(J9ClassLoaderWalkState* state);
 ...
 * @return J9ClassLoader*
 */
J9ClassLoader* allClassLoadersStartDo(J9ClassLoaderWalkState* state, J9JavaVM* vm, UDATA flags);
 ...
 * @return J9MemorySegment *
 */
J9MemorySegment* allocateMemorySegmentInList(
    J9JavaVM* javaVM, J9MemorySegmentList* segmentList, UDATA size, UDATA type, U_32 memoryCategory);
 ...
 * @return J9MemorySegment *
 */
J9MemorySegment* allocateVirtualMemorySegmentInList(
    J9JavaVM* javaVM, J9MemorySegmentList* segmentList, UDATA size, UDATA type, J9PortVmemParams* vmemParams);
 ...
 */
J9MemorySegment* allocateClassMemorySegment(
    J9JavaVM* javaVM, UDATA requiredSize, UDATA segmentType, J9ClassLoader* classLoader, UDATA allocationIncrement);
 ...
 * @return J9MemorySegment *
 */
J9MemorySegment* allocateFixedMemorySegmentInList(J9JavaVM* javaVM, J9MemorySegmentList* segmentList, UDATA size,
    UDATA type, U_8* desiredAddress, U_32 memoryCategory);
 ...
 * @return J9MemorySegmentList *
 */
J9MemorySegmentList* allocateMemorySegmentListWithSize(
    J9JavaVM* javaVM, U_32 numberOfMemorySegments, UDATA sizeOfElements, U_32 memoryCategory);
 ...
 * @return J9MemorySegmentList *
 */
J9MemorySegmentList* allocateMemorySegmentListWithFlags(
    J9JavaVM* javaVM, U_32 numberOfMemorySegments, UDATA flags, U_32 memoryCategory);
 ...
 * @return void *
 */
void* addStatistic(J9JavaVM* javaVM, U_8* name, U_8 dataType);
 ...
 * @return void *
 */
void* getStatistic(J9JavaVM* javaVM, U_8* name);
...
void copyUTF8ToCompressedUnicode(
    J9VMThread* vmThread, U_8* data, UDATA length, UDATA stringFlags, j9object_t byteArray, UDATA offset);
...
UDATA
compareStringToUTF8(
    J9VMThread* vmThread, j9object_t stringObject, UDATA stringFlags, const U_8* utfData, UDATA utfLength);
 ...
 * @return J9MemorySegment *
 */
J9MemorySegment* romImageNewSegment(
    J9JavaVM* vm, J9ROMImageHeader* header, UDATA isBaseType, J9ClassLoader* classLoader);
 ...
 * @param[out] utf8Length If not NULL returns the computed length (in bytes) of the copied UTF8 string in the buffer
 * excluding the NULL terminator.
 *
 * @return a char pointer to the string
 */
char* copyStringToUTF8WithMemAlloc(J9VMThread* vmThread, j9object_t string, UDATA stringFlags, const char* prependStr,
    UDATA prependStrLength, char* buffer, UDATA bufferLength, UDATA* utf8Length);
 ...
 */
J9UTF8* copyStringToJ9UTF8WithMemAlloc(J9VMThread* vmThread, j9object_t string, UDATA stringFlags,
 ...
 */
UDATA
copyStringToUTF8Helper(J9VMThread* vmThread, j9object_t string, UDATA stringFlags, UDATA stringOffset,
    UDATA stringLength, U_8* utf8Data, UDATA utf8DataLength);
 ...
 * @return void
 */
void swWalkObjectSlot(J9StackWalkState* walkState, j9object_t* objectSlot, void* indirectSlot, void* tag);
#endif /* J9VM_INTERP_STACKWALK_TRACING */
 ...
 */
void walkBytecodeFrameSlots(J9StackWalkState* walkState, J9Method* method, UDATA offsetPC, UDATA* pendingBase,
    UDATA pendingStackHeight, UDATA* localBase, UDATA numberOfLocals, UDATA alwaysLocalMap);
 ...
 * @return void
 */
void postHelperCall(J9VMThread* vmc, int writesVMThread);
 ...
 * @return void
 */
void preHelperCall(J9VMThread* vmc, void* sp, void* pc, void* literals, void* arg0EA, int readsVMC, int writesVMC,
    char* helperName, char* caller);
#endif /* J9VM_INTERP_UPDATE_VMCTRACING */
 ...
 * @return void
 */
void trace(J9VMThread* vmStruct);
 ...
 */
void setNestmatesError(J9VMThread* vmThread, J9Class* nestMember, J9Class* nestHost, IDATA errorCode);
 ...
 * @return void
 */
void haltThreadForInspection(J9VMThread* currentThread, J9VMThread* vmThread);
 ...
 * @return void
 */
void resumeThreadForInspection(J9VMThread* currentThread, J9VMThread* vmThread);
 ...
 * @return void
 */
void acquireExclusiveVMAccess(J9VMThread* vmThread);
 ...
 * @return void
 */
void acquireSafePointVMAccess(J9VMThread* vmThread);
 ...
 * @return void
 */
void acquireExclusiveVMAccessFromExternalThread(J9JavaVM* vm);
 ...
 * @return void
 */
void mustHaveVMAccess(J9VMThread* vmThread);
 ...
 * @return void
 */
void releaseSafePointVMAccess(J9VMThread* vmThread);
 ...
 * @return void
 */
void releaseExclusiveVMAccessFromExternalThread(J9JavaVM* vm);
 ...
 * @param jniResponsesRequired the number of mutator threads holding JNI critical access that must voluntarily quiesce
 * themselves
 * @param gcPriority returned the new gc collector priority
 * @return effectively a boolean the request is successful or not
 */
...
requestExclusiveVMAccessMetronomeTemp(
    J9JavaVM* vm, UDATA block, UDATA* vmResponsesRequired, UDATA* jniResponsesRequired, UDATA* gcPriority);
 ...
 * @return void
 */
void waitForExclusiveVMAccessMetronome(J9VMThread* vmThread, UDATA responsesRequired);
...
* @return void
*/
void waitForExclusiveVMAccessMetronomeTemp(J9VMThread* vmThread, UDATA vmResponsesRequired, UDATA jniResponsesRequired);
 ...
 * @return void
 */
void releaseExclusiveVMAccessMetronome(J9VMThread* vmThread);
 ...
 */
void releaseAccess(J9VMThread* vmThread, UDATA* accessMask);
 ...
 */
void reacquireAccess(J9VMThread* vmThread, UDATA accessMask);
 ...
 */
UDATA
registerNativeLibrary(J9VMThread* vmThread, J9ClassLoader* classLoader, const char* libName, char* libraryPath,
    J9NativeLibrary** libraryPtr, char* errorBuffer, UDATA bufferLength);
 ...
 * @return J9HookInterface**
 */
J9HookInterface** getVMHookInterface(J9JavaVM* vm);
 ...
 * @return void
 */
void freeSystemProperties(J9JavaVM* vm);
 ...
 * @return const char*
 */
const char* getJ9VMVersionString(J9JavaVM* vm);
 ...
 */
I_32 startVMRuntimeStateListener(J9JavaVM* vm);
 ...
 * @return void
 */
void stopVMRuntimeStateListener(J9JavaVM* vm);
 ...
 */
U_32 getVMRuntimeState(J9JavaVM* vm);
 ...
 */
U_32 getVMMinIdleWaitTime(J9JavaVM* vm);
 ...
 * @param currentThread the current J9VMThread
 */
void threadAboutToStart(J9VMThread* currentThread);
 ...
 * @return J9JavaStack *
 */
J9JavaStack* allocateJavaStack(J9JavaVM* vm, UDATA stackSize, J9JavaStack* previousStack);
 ...
 * @return void
 */
void freeJavaStack(J9JavaVM* vm, J9JavaStack* stack);
 ...
 * @return void
 */
void fatalRecursiveStackOverflow(J9VMThread* currentThread);
 ...
 * @return J9VMThread *
 */
J9VMThread* allocateVMThread(
    J9JavaVM* vm, omrthread_t osThread, UDATA privateFlags, void* memorySpace, J9Object* threadObject);
 ...
 * @return j9object_t
 */
j9object_t createCachedOutOfMemoryError(J9VMThread* currentThread, j9object_t threadObject);
...
findObjectDeadlockedThreads(
    J9VMThread* currentThread, j9object_t** pDeadlockedThreads, j9object_t** pBlockingObjects, UDATA flags);
 ...
 */
UDATA
startJavaThread(J9VMThread* currentThread, j9object_t threadObject, UDATA privateFlags, UDATA osStackSize,
    UDATA priority, omrthread_entrypoint_t entryPoint, void* entryArg, j9object_t schedulingParameters);
 ...
 * @return void
 */
void OMRNORETURN exitJavaThread(J9JavaVM* vm);
 ...
 * @return jint
 */
jint threadParseArguments(J9JavaVM* vm, char* optArg);
 ...
 */
void dispatchAsyncEvents(J9VMThread* currentThread, UDATA asyncEventFlags);
 ...
 * @return IDATA
 *
 * Returns the rom class, or NULL on failure.  resultClassLoader is filled in if non-null with the classloader
 * associated.
 */
 ...
 */
IDATA
getOwnedObjectMonitors(J9VMThread* currentThread, J9VMThread* targetThread, J9ObjectMonitorInfo* info, IDATA infoLen);
 ...
 * @return void
 */
void fillJITVTableSlot(J9VMThread* vmStruct, UDATA* currentSlot, J9Method* currentMethod);
...
j9object_t resolveMethodTypeRef(J9VMThread* vmThread, J9ConstantPool* constantPool, UDATA cpIndex, UDATA resolveFlags);

j9object_t resolveMethodHandleRef(
    J9VMThread* vmThread, J9ConstantPool* constantPool, UDATA cpIndex, UDATA resolveFlags);
 ...
 */
J9SFMethodTypeFrame* buildMethodTypeFrame(J9VMThread* currentThread, j9object_t methodType);
 ...
 * @return void
 */
void prepareForExceptionThrow(J9VMThread* currentThread);
 ...
 */
typedef enum { IF_ZIPSUP } J9_INTERFACE_SELECTOR;
 ...
 */
void* J9_GetInterface(J9_INTERFACE_SELECTOR interfaceSelector, J9PortLibrary* portLib, void* userData);
 ...
 */
j9object_t enterInitializationLock(J9VMThread* currentThread, j9object_t initializationLock);
 ...
 */
void initializeImpl(J9VMThread* currentThread, J9Class* j9clazz);
 ...
 */
void prepareClass(J9VMThread* currentThread, J9Class* clazz);
 ...
 */
void initializeClass(J9VMThread* currentThread, J9Class* clazz);

/* -------------------- threadpark.c ------------ */

void threadParkImpl(J9VMThread* vmThread, IDATA timeoutIsEpochRelative, I_64 timeout);
void threadUnparkImpl(J9VMThread* vmThread, j9object_t threadObject);
 ...
 * @return a JNI error code
 */
jint attachVMThreadToOMR(J9JavaVM* vm, J9VMThread* vmThread, omrthread_t osThread);
 ...
 * @param[in] *vmThread the J9VMThread
 */
void detachVMThreadFromOMR(J9JavaVM* vm, J9VMThread* vmThread);
 ...
 */
J9JavaVM* allocateJavaVMWithOMR(J9PortLibrary* portLibrary);
 ...
 * @return a JNI error code
 */
jint attachVMToOMR(J9JavaVM* vm);
 ...
 * @param[in] *vm the J9JavaVM
 */
void detachVMFromOMR(J9JavaVM* vm);
...
typedef struct J9ThreadEnv {
    ...
    intptr_t (*create)(omrthread_t* handle, uintptr_t stacksize, uintptr_t priority, uintptr_t suspend,
