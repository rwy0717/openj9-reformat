...
static J9PortLibrary MasterPortLibraryTable = { { NULL }, /* omrPortLibrary */
    ...
    j9sysinfo_startup, j9sysinfo_shutdown, j9sysinfo_get_classpathSeparator, /* sysinfo_get_classpathSeparator */
    ...
    j9ri_params_init, j9ri_initialize, j9ri_deinitialize, j9ri_enable, j9ri_disable, j9ri_enableRISupport,
    j9ri_disableRISupport,
#endif /* J9VM_PORT_RUNTIME_INSTRUMENTATION */
#if defined(OMR_GC_CONCURRENT_SCAVENGER)
    j9gs_params_init, j9gs_enable, j9gs_disable, j9gs_initialize, j9gs_deinitialize, j9gs_isEnabled,
 ...
 */
int32_t j9port_init_library(struct J9PortLibrary* portLibrary, struct J9PortLibraryVersion* version, uintptr_t size)
{
 ...
 */
int32_t j9port_shutdown_library(struct J9PortLibrary* portLibrary)
{
...
int32_t j9port_create_library(struct J9PortLibrary* portLibrary, struct J9PortLibraryVersion* version, uintptr_t size)
{
 ...
 */
int32_t j9port_startup_library(struct J9PortLibrary* portLibrary)
{
    OMRPORT_ACCESS_FROM_J9PORT(portLibrary);
    int32_t rc = 0;
 ...
 */
uintptr_t j9port_getSize(struct J9PortLibraryVersion* version)
{
 ...
 */
int32_t j9port_getVersion(struct J9PortLibrary* portLibrary, struct J9PortLibraryVersion* version)
{
    if (NULL == version) {
        return -1;
    }
 ...
 */
int32_t j9port_isCompatible(struct J9PortLibraryVersion* expectedVersion)
{
 ...
 */
int32_t j9port_isFunctionOverridden(struct J9PortLibrary* portLibrary, uintptr_t offset)
{
 ...
 */
int32_t j9port_allocate_library(struct J9PortLibraryVersion* version, struct J9PortLibrary** portLibrary)
{
