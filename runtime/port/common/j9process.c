 ...
 *				Indicates that child process J9PORT_PROCESS_STDIN will be the same as those of the
 *parent process. This is the normal behavior of most operating system command interpreters (shells).
 *		J9PORT_PROCESS_INHERIT_STDOUT
 *				Indicates that child process J9PORT_PROCESS_STDOUT will be the same as those of the
 *parent process. This is the normal behavior of most operating system command interpreters (shells).
 *		J9PORT_PROCESS_INHERIT_STDERR
 *				Indicates that child process J9PORT_PROCESS_STDERR will be the same as those of the
 *parent process. This is the normal behavior of most operating system command interpreters (shells).
 ...
 *				Create the child in a new process group. An intended side-effect is that the child will
 *not be killed if CTRL + C is issued in the console of the parent process.
 ...
 **/
uintptr_t j9process_get_private_bytes(struct J9PortLibrary* portLibrary, uintptr_t pid) { return 0; }
