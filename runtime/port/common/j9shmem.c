 ...
 */
void* j9shmem_attach(struct J9PortLibrary* portLibrary, struct j9shmem_handle* handle, uint32_t category)
{
 ...
 */
int32_t j9shmem_startup(struct J9PortLibrary* portLibrary) { return 0; }
/**
 ...
 */
uintptr_t j9shmem_findfirst(struct J9PortLibrary* portLibrary, char* cacheDirName, char* resultbuf) { return -1; }
/**
 ...
 */
int32_t j9shmem_findnext(struct J9PortLibrary* portLibrary, uintptr_t findhandle, char* resultbuf) { return -1; }
 ...
 * @param[in] findhandle  Handle returned from @ref j9shmem_findfirst.
 */
void j9shmem_findclose(struct J9PortLibrary* portLibrary, uintptr_t findhandle) { return; }
 ...
 * @param[in] portLibrary The port library
 * @param[in] handle A valid shared memory handle
 * @param[out] statbuf Pointer to J9PortShmemStatistic which is populated with statistics returned by the operating
 ...
 * j9shmem_get_region_granularity
 *
 ...
 * marked J9PORT_PAGE_PROTECT_READ and j9shmem_protect is called with J9PORT_PAGE_PROTECT_WRITE, it will no longer be
 * readable.
 *
 * @param[in] portLibrary the Port Library.
 * @param[in] cacheDirName The name of the cache directory
