 ...
 * value.
 */
int32_t j9sock_close(struct J9PortLibrary* portLibrary, j9socket_t* sock) { return J9PORT_ERROR_SOCKET_BADSOCKET; }
/**
 ...
 */
const char* j9sock_error_message(struct J9PortLibrary* portLibrary) { return "Operation Failed"; }
/**
 ...
 */
int32_t j9sock_freeaddrinfo(struct J9PortLibrary* portLibrary, j9addrinfo_t handle) { return 0; }
/**
 ...
 * @note Added for IPv6 support.
 */
int32_t j9sock_getaddrinfo_length(struct J9PortLibrary* portLibrary, j9addrinfo_t handle, int32_t* length) { return 0; }
/**
 ...
 * @return	0, if no errors occurred, otherwise the (negative) error code.
 */
int32_t j9sock_gethostbyname(struct J9PortLibrary* portLibrary, const char* name, j9hostent_t handle) { return 0; }
/**
 ...
 * @return	0, if no errors occurred, otherwise the (negative) error code
 */
int32_t j9sock_gethostname(struct J9PortLibrary* portLibrary, char* buffer, int32_t length) { return 0; }
/**
 ...
 */
int32_t j9sock_hostent_addrlist(struct J9PortLibrary* portLibrary, j9hostent_t handle, uint32_t index) { return 0; }
/**
 ...
 * @return	0, if no errors occurred, otherwise the (negative) error code
 */
int32_t j9sock_hostent_aliaslist(struct J9PortLibrary* portLibrary, j9hostent_t handle, char*** aliasList) { return 0; }
/**
 ...
 */
int32_t j9sock_hostent_hostname(struct J9PortLibrary* portLibrary, j9hostent_t handle, char** hostName) { return 0; }
/**
 ...
 */
int32_t j9sock_htonl(struct J9PortLibrary* portLibrary, int32_t val) { return val; }
/**
 ...
 */
uint16_t j9sock_htons(struct J9PortLibrary* portLibrary, uint16_t val) { return val; }
/**
 ...
 * @return	0, if no errors occurred, otherwise the (negative) error code.
 */
int32_t j9sock_inetaddr(struct J9PortLibrary* portLibrary, const char* addrStr, uint32_t* addr) { return 0; }
/**
 ...
 * @return	0, if no errors occurred, otherwise the (negative) error code.
 */
int32_t j9sock_inetntoa(struct J9PortLibrary* portLibrary, char** addrStr, uint32_t nipAddr) { return 0; }
/**
 ...
 */
int32_t j9sock_linger_enabled(struct J9PortLibrary* portLibrary, j9linger_t handle, BOOLEAN* enabled) { return 0; }
/**
 ...
 * @return	0, the function does not validate the access.
 */
int32_t j9sock_linger_linger(struct J9PortLibrary* portLibrary, j9linger_t handle, uint16_t* linger) { return 0; }
/**
 ...
 */
int32_t j9sock_ntohl(struct J9PortLibrary* portLibrary, int32_t val) { return val; }
/**
 ...
 */
uint16_t j9sock_ntohs(struct J9PortLibrary* portLibrary, uint16_t val) { return val; }
/**
 ...
 *
 * 	Non-blocking socket:
 * 		- If no incoming data is immediately available, the negative portable error code
 *J9PORT_ERROR_SOCKET_WOULDBLOCK is returned.
 * 		- J9PORT_ERROR_SOCKET_WOULDBLOCK is non-fatal and it is normal practice for the caller to retry @ref
 *j9sock_read() upon receiving it.
 *
 * @param[in]	portLibrary The port library.
 ...
 * The actual contents of the fdset are not available for inspection (as provided in the more general 'select'
 * function). The timeout is specified in seconds and microseconds.
 *
 * @param[in] portLibrary The port library.
 ...
 * @return	0 if no error occurs, otherwise return the (negative) error code.
 */
int32_t j9sock_setflag(struct J9PortLibrary* portLibrary, int32_t flag, int32_t* arg) { return 0; }
/**
 ...
 * @param[in] portNetworkOrder The target port, in network byte order. Use @ref j9sock_htons() to convert from to host
 * to network order.
 *
 * @return	0, if no errors occurred, otherwise the (negative) error code.
 */
 ...
 * @param[in] ipAddrNetworkOrder The target host address, in network order. Use @ref j9sock_htonl() to convert the ip
 * address from host to network byte order.
 * @param[in] portNetworkOrder The target port, in network byte order. Use @ref j9sock_htons() to convert the port from
 ...
 * @param[in] family The address family.
 * @param[in] portNetworkOrder The target port, in network order. Use @ref j9sock_htons() to convert the port from host
 * to network byte order.
 * @param[in] flowinfo The flowinfo value for IPv6 addresses in HOST order.  Set to 0 for IPv4 addresses or if no
 * flowinfo needs to be set for IPv6 address
 * @param[in] scope_id The scope id for an IPv6 address in HOST order.  Set to 0 for IPv4 addresses and for non-scoped
 * IPv6 addresses
 ...
 */
uint16_t j9sock_sockaddr_port(struct J9PortLibrary* portLibrary, j9sockaddr_t handle) { return handle->addr.sin_port; }
/**
...
int32_t j9sock_socketIsValid(struct J9PortLibrary* portLibrary, j9socket_t handle) { return 0; }
/**
 ...
 */
void j9sock_fdset_zero(struct J9PortLibrary* portLibrary, j9fdset_t j9fdset) { return; }
 ...
 * @param[in] j9fdset a j9 file descriptor set.
 */
void j9sock_fdset_set(struct J9PortLibrary* portLibrary, j9socket_t aSocket, j9fdset_t j9fdset) { return; }
 ...
 * @param[in] j9fdset a j9 file descriptor set.
 */
void j9sock_fdset_clr(struct J9PortLibrary* portLibrary, j9socket_t aSocket, j9fdset_t j9fdset) { return; }

/**
 * Returns TRUE if a j9 socket is part of the j9 file descriptor set.
 * This is designed to be used after a call to @ref j9socket_select to determine if the j9 socket is ready for a
 * read/write.
 *
 * Note: j9fdset_t does not support multiple entries.
 *
 ...
 */
BOOLEAN
j9sock_fdset_isset(struct J9PortLibrary* portLibrary, j9socket_t aSocket, j9fdset_t j9fdset) { return FALSE; }
