 ...
 */
J9SocketPTB* j9sock_ptb_get(J9PortLibrary* portLibrary)
{
 ...
 */
int32_t j9sock_ptb_init(J9PortLibrary* portLibrary)
{
 ...
 */
void j9sock_ptb_shutdown(J9PortLibrary* portLibrary)
{
