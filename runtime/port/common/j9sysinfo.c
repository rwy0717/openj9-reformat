 ...
 */
int32_t j9sysinfo_startup(struct J9PortLibrary* portLibrary) { return 0; }
 ...
 */
intptr_t j9sysinfo_get_processor_description(struct J9PortLibrary* portLibrary, J9ProcessorDesc* desc) { return -1; }
