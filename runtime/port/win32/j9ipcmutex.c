 ...
 */
int32_t j9ipcmutex_acquire(struct J9PortLibrary* portLibrary, const char* name)
{
    HANDLE hMutex;
    DWORD dwResult;
 ...
 */
int32_t j9ipcmutex_release(struct J9PortLibrary* portLibrary, const char* name)
{
    HANDLE hMutex;
