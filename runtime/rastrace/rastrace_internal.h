...
#define UT_THREAD_FROM_ENV(env) (env ? UT_THREAD_FROM_OMRVM_THREAD((OMR_VMThread*)env) : twThreadSelf())
...
omr_error_t registerRecordSubscriber(UtThreadData** thr, char* description, utsSubscriberCallback func,
    utsSubscriberAlarmCallback alarm, void* userData, UtTraceBuffer* start, UtTraceBuffer* stop, UtSubscription**,
    int32_t);
...
omr_error_t trcRegisterRecordSubscriber(UtThreadData** thr, const char* description, utsSubscriberCallback func,
    utsSubscriberAlarmCallback alarm, void* userData, UtTraceBuffer* start, UtTraceBuffer* stop, UtSubscription**,
    int32_t);
