...
#define SWAP_4BYTES(v)                                                                                   \
    ((((v) << (8 * 3)) & 0xFF000000) | (((v) << (8 * 1)) & 0x00FF0000) | (((v) >> (8 * 1)) & 0x0000FF00) \
        | (((v) >> (8 * 3)) & 0x000000FF))

#define SWAP_8BYTES(v)                                                                                            \
    ((((v) << (8 * 7))) | (((v) << (8 * 5)) & 0x00FF000000000000ull) | (((v) << (8 * 3)) & 0x0000FF0000000000ull) \
        | (((v) << (8 * 1)) & 0x000000FF00000000ull) | (((v)&0x00000000FF000000ull) >> (8 * 1))                   \
        | (((v)&0x0000000000FF0000ull) >> (8 * 3)) | (((v)&0x000000000000FF00ull) >> (8 * 5))                     \
