...
public:
    ...
    public:
        ...
        virtual U_32 getResourceLength() { return _dataSize; }

        virtual U_16 getResourceDataSubType() { return _type; }

        virtual U_32 getWrapperLength() { return sizeof(AttachedDataWrapper); }

        virtual U_16 getResourceType() { return TYPE_ATTACHED_DATA; }

        virtual U_32 getAlign() { return SHC_DOUBLEALIGN; }

        virtual const ShcItem* wrapperToItem(const void* wrapper) { return (const ShcItem*)ADWITEM(wrapper); }
        ...
        virtual const void* unWrap(const void* wrapper) { return (const void*)ADWDATA(wrapper); }
        ...
        virtual void updateDataInCache(
            const ShcItem* cacheItem, I_32 updateAtOffset, const J9SharedDataDescriptor* data)
        {
            ...
            if ((UnitTest::ATTACHED_DATA_TEST == UnitTest::unitTest)
                || (UnitTest::ATTACHED_DATA_CORRUPT_COUNT_TEST == UnitTest::unitTest)) {
                return;
            }
        ...
        virtual UDATA generateKey(const void* resourceAddress) { return (UDATA)((UDATA)resourceAddress + _type); }
