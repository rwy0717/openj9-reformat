...
#define J9SH_OSCACHE_MMAP_HEADER_LOCK_RETRY_SLEEP_MILLIS \
    2 /* 2ms chosen after measuring the maximum time we hold the header lock for */
...
public:
    static IDATA getCacheStats(
        J9JavaVM* vm, const char* cacheDirName, const char* filePath, SH_OSCache_Info* returnVal, UDATA reason);

    SH_OSCachemmap(J9PortLibrary* portlib, J9JavaVM* vm, const char* cacheDirName, const char* cacheName,
