 ...
 */
static UDATA sharedInternTable_performNodeAction(
    J9SharedInvariantInternTable* table, J9SharedInternSRPHashTableEntry* entry, UDATA action, void* userData)
{
    switch (action) {
 ...
 *
 */
static UDATA sharedInternHashEqualFn(void* existingEntry, void* key, void* userData)
{
 ...
 */
static UDATA sharedInternHashFn(void* key, void* userData)
{
    UDATA length;
    U_8* data;
