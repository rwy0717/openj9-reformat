...
#define PRINTSTATS_SHOW_ALL                                                                                      \
    (PRINTSTATS_SHOW_CLASSPATH | PRINTSTATS_SHOW_URL | PRINTSTATS_SHOW_TOKEN | PRINTSTATS_SHOW_ROMCLASS          \
        | PRINTSTATS_SHOW_ROMMETHOD | PRINTSTATS_SHOW_AOT | PRINTSTATS_SHOW_JITPROFILE | PRINTSTATS_SHOW_JITHINT \
        | PRINTSTATS_SHOW_ZIPCACHE | PRINTSTATS_SHOW_INVALIDATEDAOT | PRINTSTATS_SHOW_ALL_STALE)
...
/* Private filters */
#define PRINTSTATS_SHOW_EXTRA                                                                        \
    (PRINTSTATS_SHOW_ALL | PRINTSTATS_SHOW_ORPHAN | PRINTSTATS_SHOW_AOTCH | PRINTSTATS_SHOW_AOTTHUNK \
        | PRINTSTATS_SHOW_AOTDATA | PRINTSTATS_SHOW_JCL | PRINTSTATS_SHOW_BYTEDATA)
