...
static I_32 verifyWildcard(J9PortLibrary* portLib, const char* pattern, const char* expectedMatch,
    const char* expectedMismatch, UDATA* passCount, UDATA* failCount);
