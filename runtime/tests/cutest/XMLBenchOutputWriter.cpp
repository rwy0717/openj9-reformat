...
XMLBenchOutputWriter* XMLBenchOutputWriter::newInstance(J9PortLibrary* portlib, bool createOutput)
{
    ...
    XMLBenchOutputWriter* obj
        = (XMLBenchOutputWriter*)j9mem_allocate_memory(sizeof(XMLBenchOutputWriter), OMRMEM_CATEGORY_VM);
    if (obj) {
 ...
 */
void XMLBenchOutputWriter::startChart(
    char* chartName, char* chartImage, char* xAxisLabel, char* yAxisLabel, bool xAxisLog, bool yAxisLog)
{
    if (_outputXml) {
        ...
        j9tty_printf(PORTLIB,
            "      <chart chartName=\"%s\" imageName=\"%s\" XAxisLabel=\"%s\" YAxisLabel=\"%s\" XAxisLog=\"%s\" "
            "YAxisLog=\"%s\">\n",
 ...
 * @param extendedId the extended id for the dataset to be included in the chart, a value of 0 matches all extendedId
 * values
