...
public:
     ...
     */
    bool isEnabled() { return _outputXml; }
     ...
     * @param extendedId the extended id for the dataset to be included in the chart, a value of 0 matches all
     * extendedId values
     ...
     * @param extendedLabel the label to be added to the base name for the dataset when selected based on the extended
     * id
     */
