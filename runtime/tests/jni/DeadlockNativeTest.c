...
void JNICALL Java_j9vm_test_corehelper_DeadlockCoreGenerator_setup(JNIEnv* env)
{
...
void JNICALL Java_j9vm_test_corehelper_DeadlockCoreGenerator_enterFirstMonitor(JNIEnv* env)
{
    omrthread_monitor_enter(firstMonitor); /* No way to exit from Java code, but used for deadlocks only. */
}

void JNICALL Java_j9vm_test_corehelper_DeadlockCoreGenerator_enterSecondMonitor(JNIEnv* env)
{
    omrthread_monitor_enter(secondMonitor); /* No way to exit from Java code, but used for deadlocks only. */
}

static int J9THREAD_PROC genericTestThreadMain(void* arg)
{
...
void JNICALL Java_j9vm_test_corehelper_DeadlockCoreGenerator_spawnNativeThread(JNIEnv* env)
{
...
static int J9THREAD_PROC test5FirstThreadMain(void* arg)
{
    PORT_ACCESS_FROM_PORT(arg);
    omrthread_t* osthread = NULL;
...
void JNICALL Java_j9vm_test_corehelper_DeadlockCoreGenerator_createNativeDeadlock(JNIEnv* env)
{
    PORT_ACCESS_FROM_ENV(env);
    omrthread_t* osthread = NULL;
    J9VMThread* currentThread = (J9VMThread*)env;
