...
void reportError(JNIEnv* env, jclass clazz)
{
...
jboolean JNICALL Java_j9vm_test_jni_CriticalRegionTest_returnsDirectPointer(JNIEnv* env, jclass clazz, jbyteArray array)
{
    void* elems;
    jboolean isCopy;
