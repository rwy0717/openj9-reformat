...
static void* getArrayElements(JNIEnv* env, jobject array, jchar type, jboolean* isCopy)
{
    switch (type) {
    case 'B':
...
static void releaseArrayElements(JNIEnv* env, jobject array, jchar type, void* data, jint mode)
{
    switch (type) {
    case 'B':
 ...
 * This method is called concurrently across many threads and stresses the concurrent access/mutation of the
 * jniGlobalReferences pool. (see CMVC 133653)
 */
