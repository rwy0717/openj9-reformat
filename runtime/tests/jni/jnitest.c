...
jint JNICALL Java_jvmti_test_nativeMethodPrefixes_UnwrappedNative_nat(JNIEnv* env, jclass clazz) { return 33; }
...
jint JNICALL Java_jvmti_test_nativeMethodPrefixes_WrappedNative_nat(JNIEnv* env, jclass clazz) { return 11; }
...
#define CHECK_VALUE(callFn, mtdName, mtdSig, varName, constName, resultFlag) \
    do {                                                                     \
...
jboolean JNICALL Java_j9vm_test_jni_LocalRefTest_testPushLocalFrame1(JNIEnv* env, jobject rcv)
{
    ...
    if ((*env)->PushLocalFrame(env, 1024))
        return JNI_FALSE;
 ...
 */
jobject JNICALL Java_j9vm_utils_JNI_NewDirectByteBuffer(JNIEnv* env, jclass clazz, jlong address, jlong capacity)
{
 ...
 */
jlong JNICALL Java_j9vm_utils_JNI_GetDirectBufferAddress(JNIEnv* env, jclass clazz, jobject buffer)
{
 ...
 * Signature: (Ljava/nio/ByteBuffer;)J
 */
jlong JNICALL Java_j9vm_utils_JNI_GetDirectBufferCapacity(JNIEnv* env, jclass clazz, jobject buffer)
{
    return (*env)->GetDirectBufferCapacity(env, buffer);
}

jboolean JNICALL Java_j9vm_test_memory_MemoryAllocator_allocateMemory(
    JNIEnv* env, jclass clazz, jlong byteAmount, jint category)
{
    PORT_ACCESS_FROM_VMC(((J9VMThread*)env));
...
jboolean JNICALL Java_j9vm_test_memory_MemoryAllocator_allocateMemory32(
    JNIEnv* env, jclass clazz, jlong byteAmount, jint category)
{
    PORT_ACCESS_FROM_VMC(((J9VMThread*)env));
...
jboolean JNICALL Java_j9vm_test_harmonyvmi_Test_testGetEnv(JNIEnv* env, jclass clazz)
{
    JavaVM* javaVM;
    VMInterface* vmi;
...
jint JNICALL Java_j9vm_test_jni_Utf8Test_testAttachCurrentThreadAsDaemon(
    JNIEnv* env, jclass clazz, jbyteArray threadName)
{
#ifdef LINUX
    JvmInfo* vmInfo;
    char* threadNameCopy;
...
void JNICALL JNI_OnUnload(JavaVM* vm, void* reserved) { return; }
...
jboolean JNICALL Java_j9vm_test_jni_PthreadTest_attachAndDetach(JNIEnv* env, jclass clazz)
{
    PORT_ACCESS_FROM_VMC((J9VMThread*)env);
#if defined(WIN32)
