 ...
 */
jstring Java_com_ibm_jvmti_tests_util_TestSuite_getSelectedTestClassName(JNIEnv* jni_env, jclass klazz)
{
...
jstring Java_com_ibm_jvmti_tests_util_TestCase_getSelectedTestArguments(JNIEnv* jni_env, jclass klazz)
{
    jstring testArgs;
...
jstring Java_com_ibm_jvmti_tests_util_TestCase_getSpecificSubTestName(JNIEnv* jni_env, jclass klazz)
{
    jstring subtest;
