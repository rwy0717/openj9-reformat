...
static jvmtiTest jvmtiTestList[] = {
    ...
    { "ecflh001", ecflh001, "com.ibm.jvmti.tests.eventClassFileLoadHook.ecflh001",
        "EventClassFIleLoadHook - check for class file load events" },
    { "ets001", ets001, "com.ibm.jvmti.tests.eventThreadStart.ets001",
        "EventThreadStart - check for thread start events" },
    { "evmoa001", evmoa001, "com.ibm.jvmti.tests.eventVMObjectAllocation.evmoa001",
        "EventVMObjectAllocate - tests based around object allocation events" },
    { "emeng001", emeng001, "com.ibm.jvmti.tests.eventMethodEntryGrow.emeng001",
        "EventMethodEntryGrow - check growing the stack during MethodEntry event of a native method" },
    { "emex001", emex001, "com.ibm.jvmti.tests.eventMethodExit.emex001",
        "EventMethodExit - check firing of Method Exit events" },
    { "fer001", fer001, "com.ibm.jvmti.tests.forceEarlyReturn.fer001",
        "ForceEarlyReturn - check return values - depracated in favour of fer003" },
    { "fer002", fer002, "com.ibm.jvmti.tests.forceEarlyReturn.fer002",
        "ForceEarlyReturn - check method exit event and return value passed through it" },
    { "fer003", fer003, "com.ibm.jvmti.tests.forceEarlyReturn.fer003", "ForceEarlyReturn - check return values" },
    { "ioioc001", ioioc001, "com.ibm.jvmti.tests.iterateOverInstancesOfClass.ioioc001",
    ...
    { "gpc002", gpc002, "com.ibm.jvmti.tests.getPotentialCapabilities.gpc002",
        "GetPotentialCapabilities - Test retention of capabilities in latter phases" },
    { "gst001", gst001, "com.ibm.jvmti.tests.getStackTrace.gst001", "GetStackTrace - check a predefined stack trace" },
    { "gst002", gst002, "com.ibm.jvmti.tests.getStackTrace.gst002",
        "GetStackTrace - check return of an empty stack for a dead thread" },
    ...
    { "gtlste001", gtlste001, "com.ibm.jvmti.tests.getThreadListStackTracesExtended.gtlste001",
        "GetThreadListStackTracesExtended" },
    { "gomsdi001", gomsdi001, "com.ibm.jvmti.tests.getOwnedMonitorStackDepthInfo.gomsdi001",
        "GetOwnedMonitorStackDepthInfo" },
    { "gomsdi002", gomsdi002, "com.ibm.jvmti.tests.getOwnedMonitorStackDepthInfo.gomsdi002",
        "GetOwnedMonitorStackDepthInfo" },
    ...
    { "abcl001", abcl001, "com.ibm.jvmti.tests.addToBootstrapClassLoaderSearch.abcl001",
        "AddToBootstrapClassLoaderSearch during OnLoad" },
    { "abcl002", abcl002, "com.ibm.jvmti.tests.addToBootstrapClassLoaderSearch.abcl002",
        "AddToBootstrapClassLoaderSearch during live" },
    { "abcl003", abcl003, "com.ibm.jvmti.tests.addToBootstrapClassLoaderSearch.abcl003",
        "AddToBootstrapClassLoaderSearch reject bad jar during live" },
    { "ascl001", ascl001, "com.ibm.jvmti.tests.addToSystemClassLoaderSearch.ascl001",
        "AddToSystemClassLoaderSearch during OnLoad" },
    { "ascl002", ascl002, "com.ibm.jvmti.tests.addToSystemClassLoaderSearch.ascl002",
        "AddToSystemClassLoaderSearch during live" },
    { "ascl003", ascl003, "com.ibm.jvmti.tests.addToSystemClassLoaderSearch.ascl003",
        "AddToSystemClassLoaderSearch reject bad jar during live" },
    { "gcf001", gcf001, "com.ibm.jvmti.tests.getClassFields.gcf001", "GetClassFields on a class with known fields" },
    { "gcvn001", gcvn001, "com.ibm.jvmti.tests.getClassVersionNumbers.gcvn001",
        "GetClassVersionNumbers on a class with known version numbers" },
    { "gctcti001", gctcti001, "com.ibm.jvmti.tests.getCurrentThreadCpuTimerInfo.gctcti001",
        "GetCurrentThreadCpuTimerInfo, check return of correct static data" },
    ...
    { "ghftm001", ghftm001, "com.ibm.jvmti.tests.getHeapFreeTotalMemory.ghftm001",
        "EventGarbageCollectionCycle - check for gc cycle start/end events" },
    ...
    { "gmcpn001", gmcpn001, "com.ibm.jvmti.tests.getMethodAndClassNames.gmcpn001",
        "Get Class, Method and Package names for a set of ram method pointers" },
    { "decomp001", decomp001, "com.ibm.jvmti.tests.decompResolveFrame.decomp001",
        "Decompile method resolve frame with stacked args" },
    { "decomp002", decomp002, "com.ibm.jvmti.tests.decompResolveFrame.decomp002",
        "Intermittent single stepping throught some code" },
    { "decomp003", decomp003, "com.ibm.jvmti.tests.decompResolveFrame.decomp003",
        "Decompile at exception catch at various levels of inlining" },
    ...
    { "glc001", glc001, "com.ibm.jvmti.tests.getLoadedClasses.glc001",
        "Verify correct return of all relevant loaded classes" },
    { "rtc001", rtc001, "com.ibm.jvmti.tests.retransformClasses.rtc001",
        "RetransformClasses on a class loaded by sun.misc.Unsafe" },
    ...
    { "jlm001", jlm001, "com.ibm.jvmti.tests.javaLockMonitoring.jlm001",
        "Java lock monitoring - JlmSet, JlmDump, and JlmDumpStats" },
    ...
    { "gjvmt001", gjvmt001, "com.ibm.jvmti.tests.getJ9vmThread.gjvmt001",
        "Fetch J9VMThread from a java.lang.thread instance" },
    { "gj9m001", gj9m001, "com.ibm.jvmti.tests.getJ9method.gj9m001", "Fetch J9Method from a mid" },
    { "rrc001", rrc001, "com.ibm.jvmti.tests.retransformRedefineCombo.rrc001",
        "Test Retransform-Redefine combination" },
    { "cma001", cma001, "com.ibm.jvmti.tests.classModificationAgent.cma001",
        "Sanity test for JVMTI class transformer" },
    { "ria001", ria001, "com.ibm.jvmti.tests.retransformationIncapableAgent.ria001",
        "Retransformation incapable agent" },
    { "rca001", rca001, "com.ibm.jvmti.tests.retransformationCapableAgent.rca001", "Retransformation capable agent" },
    { "rnwr001", rnwr001, "com.ibm.jvmti.tests.registerNativesWithRetransformation.rnwr001",
        "Test RegisterNatives JNI API in FSD" },
    ...
    { "snmp001", snmp001, "com.ibm.jvmti.tests.setNativeMethodPrefix.snmp001",
        "Tests setting a native method prefix and disposing a subsequent environment" },
    { NULL, NULL, NULL, NULL }
};
...
jint Java_com_ibm_jvmti_tests_util_TestSuite_getTestCount(JNIEnv* jni_env, jclass klazz) { return getTestCount(); }

jstring Java_com_ibm_jvmti_tests_util_TestSuite_getTestClassName(JNIEnv* jni_env, jclass klazz, jint testNumber)
{
