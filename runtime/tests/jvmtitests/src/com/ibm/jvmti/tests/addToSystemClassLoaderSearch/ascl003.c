...
jint JNICALL ascl003(agentEnv* agent_env, char* args)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_addToSystemClassLoaderSearch_ascl003_addJar(JNIEnv* jni_env, jclass clazz)
{
