...
jboolean JNICALL Java_com_ibm_jvmti_tests_classModificationAgent_cma001_retransformClass(
    JNIEnv* jni_env, jobject obj, jclass originalClass)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_classModificationAgent_cma001_redefineClass(
