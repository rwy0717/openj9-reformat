...
static void JNICALL cbException(jvmtiEnv* jvmti_env, JNIEnv* jni_env, jthread thread, jmethodID method,
...
static void JNICALL cbExceptionCatch(
...
jint JNICALL decomp003(agentEnv* _env, char* args)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_decompResolveFrame_decomp003_startStepping(
    JNIEnv* jni_env, jclass cls, jthread thread)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_decompResolveFrame_decomp003_stopStepping(
    JNIEnv* jni_env, jclass cls, jthread thread)
{
    JVMTI_ACCESS_FROM_AGENT(env);
    jvmtiError err = JVMTI_ERROR_NONE;
