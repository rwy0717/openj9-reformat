...
typedef enum ModType { NO_MODIFY = 0, MODIFY_BOOTSTRAP, MODIFY_NON_BOOTSTRAP, MODIFY_ALL, MOD_NUM_TYPE } ModType;

static const char* ModTypeStrings[]
    = { "noModify", "modifyBootstrap", "modifyNonBootstrap", "modifyAll", "modStringEnd" };
 ...
 */
jint JNICALL ecflh001(agentEnv* agent_env, char* args)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_eventClassFileLoadHook_ecflh001_checkReenableInLivePhase(
