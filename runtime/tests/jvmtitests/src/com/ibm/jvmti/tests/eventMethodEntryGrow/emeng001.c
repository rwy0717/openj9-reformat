...
jint JNICALL emeng001(agentEnv* agent_env, char* args)
{
...
void JNICALL Java_com_ibm_jvmti_tests_eventMethodEntryGrow_emeng001_emeng001NativeMethod(
    JNIEnv* env, jobject rcv, jobject o, jint i, jlong l, jobject o2)
{
