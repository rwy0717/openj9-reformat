...
static void JNICALL testForceEarlyReturn_methodEntry(
...
static jvmtiError JNICALL testForceEarlyReturn_waitForTestThread(
    agentEnv* env, jthread thread, jmethodID method, jthread* suspendedThread);
...
static jboolean JNICALL testForceEarlyReturn_isSuspendable(const char* methodName)
{
    ...
    static const char* methodNames[]
        = { "Lcom/ibm/jvmti/tests/forceEarlyReturn/TestForceEarlyReturnRunner;.earlyReturnInt(II)I",
              ...
              "Lcom/ibm/jvmti/tests/forceEarlyReturn/TestForceEarlyReturnRunner;.earlyReturnObject(II)Lcom/ibm/jvmti/"
              "tests/forceEarlyReturn/TestForceEarlyReturnRunner;",
              "Lcom/ibm/jvmti/tests/forceEarlyReturn/TestForceEarlyReturnRunner;.earlyReturnVoid(II)V", NULL };
...
static const testForceEarlyReturn_testTrigger triggerNames[]
    = { { "Lcom/ibm/jvmti/tests/forceEarlyReturn/TestForceEarlyReturnTrigger;.triggerForceEarlyReturnInt()V",
            JVMTI_TYPE_JINT },
          { "Lcom/ibm/jvmti/tests/forceEarlyReturn/TestForceEarlyReturnTrigger;.triggerForceEarlyReturnLong()V",
              JVMTI_TYPE_JLONG },
          { "Lcom/ibm/jvmti/tests/forceEarlyReturn/TestForceEarlyReturnTrigger;.triggerForceEarlyReturnFloat()V",
              JVMTI_TYPE_JFLOAT },
          { "Lcom/ibm/jvmti/tests/forceEarlyReturn/TestForceEarlyReturnTrigger;.triggerForceEarlyReturnDouble()V",
              JVMTI_TYPE_JDOUBLE },
          { "Lcom/ibm/jvmti/tests/forceEarlyReturn/TestForceEarlyReturnTrigger;.triggerForceEarlyReturnObject()V",
              JVMTI_TYPE_JOBJECT },
          { "Lcom/ibm/jvmti/tests/forceEarlyReturn/TestForceEarlyReturnTrigger;.triggerForceEarlyReturnVoid()V",
              JVMTI_TYPE_CVOID },
          { NULL, 0 } };
    ...
    *suspendedThread = NULL;
    ...
    while (NULL == *suspendedThread && itterations > 0) {
        for (i = 0; i < threadCount; ++i) {
            ...
            if (state & JVMTI_THREAD_STATE_SUSPENDED && !strcmp(thrName, "Thread-Runner")) {
                ...
                *suspendedThread = threads[i];
                ...
                tprintf(env, 300, "\t%-10s state 0x%x thr 0x%x susThr 0x%p i%d is SUSPENDED. returning\n",
