...
jboolean static setupFER(
    JNIEnv* jni_env, jvmtiEventMethodExit methodExitCB, jthread t, jclass c, char* methodName, char* methodSig)
{
    jvmtiError err;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_forceEarlyReturn_fer002_methodExitState(JNIEnv* jni_env, jclass klass)
{
    return (methodExitState == JNI_OK) ? JNI_TRUE : JNI_FALSE;
}

static void JNICALL testForceEarlyReturn_methodExitInt(jvmtiEnv* jvmti_env, JNIEnv* jni_env, jthread thread,
...
jboolean JNICALL Java_com_ibm_jvmti_tests_forceEarlyReturn_fer002_forceEarlyReturnInt(
...
static void JNICALL testForceEarlyReturn_methodExitObject(jvmtiEnv* jvmti_env, JNIEnv* jni_env, jthread thread,
    jmethodID method, jboolean was_popped_by_exception, jvalue return_value)
{
    agentEnv* env = _agentEnv;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_forceEarlyReturn_fer002_forceEarlyReturnObject(
    JNIEnv* jni_env, jclass klass, jobject retVal, jthread t, jclass c)
{
    ...
    if (setupFER(jni_env, testForceEarlyReturn_methodExitObject, t, c, "workObject", "()Ljava/lang/String;")
        != JNI_OK) {
        return JNI_FALSE;
    }
...
jboolean JNICALL Java_com_ibm_jvmti_tests_forceEarlyReturn_fer002_forceEarlyReturnBoolean(
    JNIEnv* jni_env, jclass klass, jobject retVal, jthread t, jclass c)
{
    return JNI_FALSE;
}

jboolean JNICALL Java_com_ibm_jvmti_tests_forceEarlyReturn_fer002_forceEarlyReturnChar(
    JNIEnv* jni_env, jclass klass, jobject retVal, jthread t, jclass c)
{
    return JNI_FALSE;
}

jboolean JNICALL Java_com_ibm_jvmti_tests_forceEarlyReturn_fer002_forceEarlyReturnShort(
    JNIEnv* jni_env, jclass klass, jobject retVal, jthread t, jclass c)
{
    return JNI_FALSE;
}

jboolean JNICALL Java_com_ibm_jvmti_tests_forceEarlyReturn_fer002_forceEarlyReturnLong(
    JNIEnv* jni_env, jclass klass, jobject retVal, jthread t, jclass c)
{
    return JNI_FALSE;
}

jboolean JNICALL Java_com_ibm_jvmti_tests_forceEarlyReturn_fer002_forceEarlyReturnDouble(
    JNIEnv* jni_env, jclass klass, jobject retVal, jthread t, jclass c)
{
    return JNI_FALSE;
}

jboolean JNICALL Java_com_ibm_jvmti_tests_forceEarlyReturn_fer002_forceEarlyReturnVoid(
    JNIEnv* jni_env, jclass klass, jobject retVal, jthread t, jclass c)
{
    return JNI_FALSE;
}
