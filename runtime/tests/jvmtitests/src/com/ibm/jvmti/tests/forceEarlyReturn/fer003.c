...
jboolean JNICALL Java_com_ibm_jvmti_tests_forceEarlyReturn_fer003_forceEarlyReturn(
    JNIEnv* jni_env, jclass klass, jthread thread, jint returnType, jobject testObject)
{
    jvmtiError err;
