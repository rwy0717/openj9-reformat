...
jint JNICALL gosl001(agentEnv* agent_env, char* args)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_getOrSetLocal_gosl001_getInt(JNIEnv* jni_env, jclass clazz, jthread thread,
    jint depth, jclass methodClass, jstring s_methodName, jstring s_methodSignature, jstring s_varName,
    jint expectedInt)
{
