...
jint JNICALL gomsdi002(agentEnv* agent_env, char* args)
{
...
void JNICALL Java_com_ibm_jvmti_tests_getOwnedMonitorStackDepthInfo_gomsdi002_callGet(
    JNIEnv* jni_env, jclass klass, jthread thread)
{
