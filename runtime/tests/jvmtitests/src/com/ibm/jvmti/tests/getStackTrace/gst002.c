...
jint JNICALL gst002(agentEnv* agent_env, char* args)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_getStackTrace_gst002_check(JNIEnv* jni_env, jclass cls, jthread t)
{
    char pad1[256];
