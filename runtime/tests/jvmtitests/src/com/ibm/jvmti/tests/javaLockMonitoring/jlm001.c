...
static void JNICALL cbMonitorContendedEntered(jvmtiEnv* jvmti, JNIEnv* jni_env, jthread thread, jobject object);

jint JNICALL jlm001(agentEnv* agent_env, char* args)
{
...
jint JNICALL Java_com_ibm_jvmti_tests_javaLockMonitoring_jlm001_jvmtiJlmSet(JNIEnv* jni_env, jclass klazz, jint mode)
{
    jvmtiError error;
...
jobject JNICALL Java_com_ibm_jvmti_tests_javaLockMonitoring_jlm001_jvmtiJlmDump(
    JNIEnv* jni_env, jclass klazz, jint dumpFunction, jint format)
{
    jvmtiError error;
    jclass cls;
    jmethodID method;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_javaLockMonitoring_jlm001_enableMonitoringEvent(JNIEnv* jni_env, jclass klazz)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_javaLockMonitoring_jlm001_disableMonitoringEvent(
    JNIEnv* jni_env, jclass klazz)
{
