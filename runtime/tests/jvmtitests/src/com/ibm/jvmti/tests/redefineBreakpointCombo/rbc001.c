...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineBreakpointCombo_rbc001_redefineClass(
    JNIEnv* jni_env, jobject obj, jclass originalClass, jbyteArray redefinedClassBytes)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineBreakpointCombo_rbc001_setBreakpoint(
    JNIEnv* jni_env, jobject obj, jclass clazz, jstring methodName, jstring methodSig, jlocation pos)
{
    JVMTI_ACCESS_FROM_AGENT(env);
    jvmtiError err = JVMTI_ERROR_NONE;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineBreakpointCombo_rbc001_clearBreakpoint(
    JNIEnv* jni_env, jobject obj, jclass clazz, jstring methodName, jstring methodSig, jlocation pos)
{
    JVMTI_ACCESS_FROM_AGENT(env);
    jvmtiError err = JVMTI_ERROR_NONE;
...
jlong JNICALL Java_com_ibm_jvmti_tests_redefineBreakpointCombo_rbc001_getMethodIDFromStack(
    JNIEnv* jni_env, jobject obj, jint framePosition)
{
    JVMTI_ACCESS_FROM_AGENT(env);
    jvmtiError err = JVMTI_ERROR_NONE;
    jthread thread = NULL;
...
jlong JNICALL Java_com_ibm_jvmti_tests_redefineBreakpointCombo_rbc001_getMethodID(
    JNIEnv* jni_env, jobject obj, jclass clazz, jstring methodName, jstring methodSig)
{
    char* utfMethodName = NULL;
    char* utfMethodSig = NULL;
...
void JNICALL breakpointEvent(jvmtiEnv* jvmti_env, JNIEnv* jni_env, jthread thread, jmethodID method, jlocation location)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineBreakpointCombo_rbc001_setBreakpointInMethodID(
    JNIEnv* jni_env, jobject obj, jmethodID methodID, jlocation pos)
{
    JVMTI_ACCESS_FROM_AGENT(env);
    jvmtiError err = JVMTI_ERROR_NONE;
