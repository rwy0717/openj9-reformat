...
jint JNICALL rc004(agentEnv* agent_env, char* args)
{
    jvmtiError err;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineClasses_rc004_redefineClass(
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineClasses_rc004_accessStoredIDs(
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineClasses_rc004_redefineClassAndTestFieldIDs(
    JNIEnv* jni_env, jclass klass, jclass originalClass, jint classBytesSize, jbyteArray classBytes)
{
    JVMTI_ACCESS_FROM_AGENT(env);
    jbyte* class_bytes;
