...
jint JNICALL rc006(agentEnv* agent_env, char* args)
{
    jvmtiError err;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineClasses_rc006_accessStoredIDs(
    JNIEnv* jni_env, jclass klass, jclass originalClass, jobject obj)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineClasses_rc006_redefineClassAndTestMethodIDs(
    JNIEnv* jni_env, jclass klass, jclass originalClass, jobject obj, jint classBytesSize, jbyteArray classBytes)
{
    JVMTI_ACCESS_FROM_AGENT(env);
    jbyte* class_bytes;
