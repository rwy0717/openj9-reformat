...
jint JNICALL rc017(agentEnv* agent_env, char* args)
{
    jvmtiError err;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineClasses_rc017_redefineMultipleClass(JNIEnv* jni_env, jclass klass,
    jobjectArray originalClasses, jint classCount, jobjectArray classBytes, jintArray classBytesLength)
{
