...
jint JNICALL rc019a(agentEnv* agent_env, char* args)
{
    jvmtiError err;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineClasses_rc019a_redefineClass(
...
jobject JNICALL Java_com_ibm_jvmti_tests_redefineClasses_rc019a_getValue(JNIEnv* jni_env, jclass klass, jobject o)
{
    jobject result = NULL;
