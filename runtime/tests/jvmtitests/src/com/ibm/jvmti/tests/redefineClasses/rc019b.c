...
jint JNICALL rc019b(agentEnv* agent_env, char* args)
{
    jvmtiError err;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_redefineClasses_rc019b_redefineClass(
...
jobject JNICALL Java_com_ibm_jvmti_tests_redefineClasses_rc019b_getValue(JNIEnv* jni_env, jclass klass, jobject o)
{
    jobject result = NULL;
