...
jboolean JNICALL Java_com_ibm_jvmti_tests_registerNativesWithRetransformation_rnwr001_registerNative(
    JNIEnv* jni_env, jobject obj, jclass klass)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_registerNativesWithRetransformation_rnwr001_retransformClass(
    JNIEnv* jni_env, jobject obj, jclass originalClass, jstring className, jbyteArray transformedClassBytes)
{
