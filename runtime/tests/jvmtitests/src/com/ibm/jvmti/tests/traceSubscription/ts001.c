...
jint JNICALL ts001(agentEnv* agent_env, char* args)
{
    jvmtiError err;
    jint extensionCount;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_traceSubscription_ts001_tryRegisterTraceSubscriber(
...
jboolean JNICALL Java_com_ibm_jvmti_tests_traceSubscription_ts001_tryFlushTraceData(JNIEnv* jni_env, jclass clazz)
{
    jvmtiError err;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
...
jint JNICALL Java_com_ibm_jvmti_tests_traceSubscription_ts001_tryDeregisterTraceSubscriber(
    JNIEnv* jni_env, jclass clazz)
{
...
jint JNICALL Java_com_ibm_jvmti_tests_traceSubscription_ts001_getBufferCount(JNIEnv* jni_env, jclass clazz)
{
    return bufferCount;
}

jint JNICALL Java_com_ibm_jvmti_tests_traceSubscription_ts001_getFinalBufferCount(JNIEnv* jni_env, jclass clazz)
{
    return bufferCountFinal;
}

jbyte JNICALL Java_com_ibm_jvmti_tests_traceSubscription_ts001_tryGetTraceMetadata(
    JNIEnv* jni_env, jclass clazz, jint index)
{
    jvmtiError err = JVMTI_ERROR_NONE;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
    void* data;
