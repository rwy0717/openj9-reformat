...
jint JNICALL vgc001(agentEnv* agent_env, char* args)
{
    jvmtiError err;
    jint extensionCount;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_tryRegisterVerboseGCSubscriber(JNIEnv* jni_env, jclass clazz)
{
    jvmtiError err;
...
jint JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_tryDeregisterVerboseGCSubscriber(JNIEnv* jni_env, jclass clazz)
{
...
jint JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_getBufferCount(JNIEnv* jni_env, jclass clazz)
{
    return bufferCount;
}

jboolean JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_hasAlarmed(JNIEnv* jni_env, jclass clazz)
{
    return alarmed ? JNI_TRUE : JNI_FALSE;
}

jboolean JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_tryRegisterVerboseGCSubscriber2(
...
jint JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_tryDeregisterVerboseGCSubscriber2(JNIEnv* jni_env, jclass clazz)
{
    jvmtiError err = JVMTI_ERROR_NONE;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
...
jint JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_getBufferCount2(JNIEnv* jni_env, jclass clazz)
{
    return bufferCount2;
}

jboolean JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_hasAlarmed2(JNIEnv* jni_env, jclass clazz)
{
    return alarmed2 ? JNI_TRUE : JNI_FALSE;
}

jboolean JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_tryRegisterVerboseGCSubscriber3(
    JNIEnv* jni_env, jclass clazz)
{
    jvmtiError err;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
...
jint JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_tryDeregisterVerboseGCSubscriber3(JNIEnv* jni_env, jclass clazz)
{
    jvmtiError err = JVMTI_ERROR_NONE;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
...
jint JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_getBufferCount3(JNIEnv* jni_env, jclass clazz)
{
    return bufferCount3;
}

jboolean JNICALL Java_com_ibm_jvmti_tests_verboseGC_vgc001_hasAlarmed3(JNIEnv* jni_env, jclass clazz)
{
