...
jint JNICALL vmd001(agentEnv* agent_env, char* args)
{
...
jboolean JNICALL Java_com_ibm_jvmti_tests_vmDump_vmd001_tryQueryDumpSmallBuffer(JNIEnv* jni_env, jclass cls)
{
    int err;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_vmDump_vmd001_tryQueryDumpBigBuffer(JNIEnv* jni_env, jclass cls)
{
    int err;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_vmDump_vmd001_tryQueryDumpInvalidBufferSize(JNIEnv* jni_env, jclass cls)
{
    int err;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_vmDump_vmd001_tryQueryDumpInvalidBuffer(JNIEnv* jni_env, jclass cls)
{
    int err;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_vmDump_vmd001_tryQueryDumpInvalidDataSize(JNIEnv* jni_env, jclass cls)
{
    int err;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_vmDump_vmd001_trySetVmDump(JNIEnv* jni_env, jclass cls)
{
    int err;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_vmDump_vmd001_tryResetVmDump(JNIEnv* jni_env, jclass cls)
{
    int err;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
...
jboolean JNICALL Java_com_ibm_jvmti_tests_vmDump_vmd001_tryDisableVmDump(JNIEnv* jni_env, jclass cls)
{
    int err;
    jvmtiEnv* jvmti_env = env->jvmtiEnv;
