 ...
 */
void fileWrite(struct J9PortLibrary* portLibrary, IDATA fd, const char* format, ...)
{
...
I_32 j9file_close_helper(struct J9PortLibrary* portLibrary, IDATA fd)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    return isAsync ? j9file_blockingasync_close(fd) : j9file_close(fd);
}

I_32 j9file_lock_bytes_helper(struct J9PortLibrary* portLibrary, IDATA fd, I_32 lockFlags, U_64 offset, U_64 length)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    return isAsync ? j9file_blockingasync_lock_bytes(fd, lockFlags, offset, length)
                   : j9file_lock_bytes(fd, lockFlags, offset, length);
}

I_32 j9file_unlock_bytes_helper(struct J9PortLibrary* portLibrary, IDATA fd, U_64 offset, U_64 length)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
I_32 j9file_set_length_helper(struct J9PortLibrary* portLibrary, IDATA fd, I_64 newLength)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    return isAsync ? j9file_blockingasync_set_length(fd, newLength) : j9file_set_length(fd, newLength);
}

I_64 j9file_flength_helper(struct J9PortLibrary* portLibrary, IDATA fd)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 */
int j9file_test0(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 */
int j9file_test1(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test2(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test3(struct J9PortLibrary* portLibrary)
{
...
/**
 */
void openFlagTest(struct J9PortLibrary* portLibrary, const char* testName, const char* pathName, I_32 flags, I_32 mode)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    IDATA fd;
    J9FileStat buf;
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test4(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    if (0 == j9sysinfo_get_executable_name("java.properties", &knownFile)) {
        ...
        if (EsIsFile != rc) {
            outputErrorMessage(
                PORTTEST_ERROR_ARGS, "j9file_attr(%s) returned %d expected %d\n", knownFile, rc, EsIsFile);
        }
    } else {
        outputErrorMessage(
            PORTTEST_ERROR_ARGS, "j9sysinfo_get_executable_name(\"java.properties\", &knownFile) failed\n");
    }
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test5(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test6(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test7(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test8(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test9(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    for (i = 0; i < numberIterations; i++) {
        ...
        if (length > 2) {
            ...
            if (length != (savedLength - 1)) {
                outputErrorMessage(
                    PORTTEST_ERROR_ARGS, "j9file_length() returned %lld expected %lld\n", length, savedLength - 1);
                goto exit;
            }
        ...
        if (-1 == lastmod) {
            outputErrorMessage(
                PORTTEST_ERROR_ARGS, "j9file_lastmod() returned %d expected %d, iteration %d\n", lastmod, -1, i + 1);
            goto exit;
        }
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test10(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    if (resultingOffset != expectedOffset) {
        outputErrorMessage(
            PORTTEST_ERROR_ARGS, "j9file_seek() returned %lld expected %lld\n", resultingOffset, expectedOffset);
        goto exit;
    }
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test11(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on failure
 */
int j9file_test12(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on failure
 */
int j9file_test13(struct J9PortLibrary* portLibrary)
{
    ...
    if (0 != rc) {
        outputErrorMessage(
            PORTTEST_ERROR_ARGS, "j9file_move() from %s to %s returned %d, expected %d\n", dir1, dir2, rc, 0);
        goto exit;
    }
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test14(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test15(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    for (i = 0; i < numberIterations; i++) {
        ...
        if (0 != rc) {
            outputErrorMessage(
                PORTTEST_ERROR_ARGS, "j9file_sync() returned %d expected %d, iteration %d\n", rc, 0, i + 1);
            goto exit;
        }
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test16(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test17(struct J9PortLibrary* portLibrary)
{
    /* first we need a file to copy use with vprintf */
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 *
 */
int j9file_test18(J9PortLibrary* portLibrary, char* argv0)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    lockRc = FILE_LOCK_BYTES_FUNCTION(
        portLibrary, fd, J9PORT_FILE_READ_LOCK | J9PORT_FILE_NOWAIT_FOR_LOCK, offset, length);
 ...
 *
 */
int j9file_test19(J9PortLibrary* portLibrary, char* argv0)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    lockRc = FILE_LOCK_BYTES_FUNCTION(
        portLibrary, fd, J9PORT_FILE_WRITE_LOCK | J9PORT_FILE_NOWAIT_FOR_LOCK, offset, length);
...
int j9file_test20(J9PortLibrary* portLibrary, char* argv0)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test20_child_1(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test20_child_2(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test21(J9PortLibrary* portLibrary, char* argv0)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test21_child_1(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test21_child_2(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test22(J9PortLibrary* portLibrary, char* argv0)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test22_child_1(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test22_child_2(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    lockRc
        = FILE_LOCK_BYTES_FUNCTION(portLibrary, fd, J9PORT_FILE_WRITE_LOCK | J9PORT_FILE_WAIT_FOR_LOCK, offset, length);
...
int j9file_test23(J9PortLibrary* portLibrary, char* argv0)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test23_child_1(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test23_child_2(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    lockRc
        = FILE_LOCK_BYTES_FUNCTION(portLibrary, fd, J9PORT_FILE_READ_LOCK | J9PORT_FILE_WAIT_FOR_LOCK, offset, length);
...
int j9file_test24(J9PortLibrary* portLibrary, char* argv0)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test24_child_1(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test24_child_2(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test25(J9PortLibrary* portLibrary, char* argv0)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test25_child_1(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    lockRc = FILE_LOCK_BYTES_FUNCTION(
        portLibrary, fd, J9PORT_FILE_WRITE_LOCK | J9PORT_FILE_WAIT_FOR_LOCK, (offset + 2), length);
...
int j9file_test25_child_2(J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test26(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    if (0 == j9sysinfo_get_executable_name("java.properties", &knownFile)) {
        ...
        if (rc >= 0) {
            outputErrorMessage(
                PORTTEST_ERROR_ARGS, "j9file_stat(%s, ..) returned %d expected %d\n", localFilename, rc, -1);
        }
        ...
        if (rc != 0) {
            ...
            outputErrorMessage(
                PORTTEST_ERROR_ARGS, "j9file_stat(%s, ..) set buf.isDir = %d expected 1\n", ".", buf.isDir);
        }
        ...
        if (rc != 0) {
            ...
            outputErrorMessage(
                PORTTEST_ERROR_ARGS, "j9file_stat(%s, ..) set buf.isFile = %d expected 1\n", ".", buf.isFile);
        }
    } else {
        outputErrorMessage(
            PORTTEST_ERROR_ARGS, "j9sysinfo_get_executable_name(\"java.properties\", &knownFile) failed\n");
...
#define nModes 22
    ...
    I_32 testModes[nModes] = { 0, 1, 2, 4, 6, 7, 010, 020, 040, 070, 0100, 0200, 0400, 0700, 0666, 0777, 0755, 0644,
    ...
    if (-1 != rc) {
        outputErrorMessage(
            PORTTEST_ERROR_ARGS, "j9file_chmod() on non-existent file returned %d expected %d\n", rc, -1);
    }
...
int j9file_test28(struct J9PortLibrary* portLibrary)
{
    ...
    I_32 rc;
#define nModes 22
    I_32 testModes[nModes] = { 0, 1, 2, 4, 6, 7, 01010, 02020, 04040, 070, 0100, 0200, 0400, 0700, 0666, 0777, 0755,
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test30(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    /* try to create the file again, this should fail. The only reason we do this is to have j9file set the last error
     * code */
    existingFileFd
        = FILE_OPEN_FUNCTION(portLibrary, validFilename, EsOpenCreateNew | EsOpenWrite | EsOpenTruncate, 0666);
    if (-1 != existingFileFd) {
    ...
    invalidFileFd
        = FILE_OPEN_FUNCTION(portLibrary, illegalFileName, EsOpenCreateNew | EsOpenWrite | EsOpenTruncate, 0666);
    if (-1 == invalidFileFd) {
        I_32 lastErrorNumber = j9error_last_error_number();

        if (lastErrorNumber == J9PORT_ERROR_FILE_EXIST) {
            outputErrorMessage(PORTTEST_ERROR_ARGS,
                "j9error_last_error_number(\"%s\") returned %i (J9PORT_ERROR_FILE_EXIST), anything but would be fine "
                "%i\n",
    ...
    invalidFileFd
        = FILE_OPEN_FUNCTION(portLibrary, illegalFileName, EsOpenCreateNew | EsOpenRead | EsOpenTruncate, 0666);
    if (-1 == invalidFileFd) {
        I_32 lastErrorNumber = j9error_last_error_number();
 ...
 */
int j9file_test31(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    if (-1 == fileFd) {
        outputErrorMessage(PORTTEST_ERROR_ARGS, "%s failed to create file %s: error_last_error_number %i\n",
            FILE_OPEN_FUNCTION_NAME, filename, j9error_last_error_number());
        goto exit;
    }
...
int j9file_test32(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
...
int j9file_test33(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 */
int j9file_test_long_file_name(struct J9PortLibrary* portLibrary)
{
    /* first we need a file to copy use with vprintf */
    PORT_ACCESS_FROM_PORT(portLibrary);
...
#define FILENAME_LENGTH \
    ...
    for (i = 0; i < 2; i++) {
        ...
        while (strlen(filePathName) < MIN_LENGTH) {
            ...
            j9str_printf(portLibrary, filePathName + strlen(filePathName), FILENAME_LENGTH - strlen(filePathName), "%s",
                longDirName);
        ...
        j9str_printf(
            portLibrary, filePathName + strlen(filePathName), FILENAME_LENGTH - strlen(filePathName), "\\%s", testName);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test34(struct J9PortLibrary* portLibrary)
{
#define J9FILETEST_FILESIZE 1000 * 512
    ...
    if (buf.isRemote) {
        outputComment(
            portLibrary, "WARNING: Test j9file_test34 cannot be run on a remote file system.\nSkipping test.\n");
 ...
 */
int j9file_test34_multiple_tries(struct J9PortLibrary* portLibrary, int nbOfTries)
{
    int i, rc;
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test35(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test36(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    if (j9fileFD != nativeFD) {
        outputErrorMessage(PORTTEST_ERROR_ARGS,
            "j9fileFD != nativeFD, they should be the same. j9fileFD: %x, nativeFD: %x\n", j9fileFD, nativeFD);
    }
#else /* defined(J9ZOS390) */
    if (j9fileFD == nativeFD) {
        outputErrorMessage(PORTTEST_ERROR_ARGS,
            "j9fileFD == nativeFD, they should be different. j9fileFD: %x, nativeFD: %x\n", j9fileFD, nativeFD);
    }
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test37(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    if (rc >= 0) {
        outputErrorMessage(PORTTEST_ERROR_ARGS,
            "Negative test failure: j9file_fstat(-1, ..) on invalid file descriptor is expected to fail but it "
    ...
    if (0 == j9sysinfo_get_executable_name(NULL, &knownFile)) {
        ...
        if (-1 != fd) {
            ...
            if (0 != rc) {
                outputErrorMessage(
                    PORTTEST_ERROR_ARGS, "j9file_fstat(...) failed for fd=%d(filename=%s)\n", fd, knownFile);
            } else if (1 != buf.isFile) {
                outputErrorMessage(PORTTEST_ERROR_ARGS,
                    "j9file_fstat(...) for %s returned buf.isFile = %d, expected 1\n", knownFile, buf.isFile);
            }
        } else {
            outputErrorMessage(
 ...
 */
int j9file_test38(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    ...
    if (-1 != fd) {
        ...
        if (0 != rc) {
            ...
            if (myUid != stat.ownerUid) {
                outputErrorMessage(PORTTEST_ERROR_ARGS,
                    "j9file_fstat(...) for %s returned ownerUid as %d, expected %d\n", filename, stat.ownerUid, myUid);
            }
            ...
            if (myGid != fileGid) {
                ...
                if (0 != rc) {
                    outputErrorMessage(
                        PORTTEST_ERROR_ARGS, "j9file_stat(...) failed for current directory with rc=%d\n", rc);
                } else {
                    if (fileGid != stat.ownerGid) {
                        outputErrorMessage(PORTTEST_ERROR_ARGS,
                            "j9file_fstat(...) for current directory returned ownerGid as %d, expected %d\n", fileGid,
                            stat.ownerGid);
                    }
                }
            }
 ...
 */
int j9file_test39(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
int j9file_test40(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 */
I_32 j9file_runTests(struct J9PortLibrary* portLibrary, char* argv0, char* j9file_child, BOOLEAN async)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
    int rc;
    ...
    if (TEST_PASS == rc) {
        ...
        j9tty_printf(portLibrary,
            "\n\n!!! j9file_test20 has been disabled on this platform until the implementation/test has been "
            "fixed\n\n");
#endif
...
#else
        j9tty_printf(portLibrary,
            "\n\n!!! j9file_test22 has been disabled on this platform until the implementation/test has been "
            "fixed\n\n");
#endif
...
#else
        j9tty_printf(portLibrary,
            "\n\n!!! j9file_test24/25 has been disabled on this platform until the implementation/test has been "
            "fixed\n\n");
#endif
