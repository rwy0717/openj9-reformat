 ...
 */
I_32 j9nls_verify_function_slots(struct J9PortLibrary* portLibrary)
{
 ...
 */
I_32 j9nls_test1(struct J9PortLibrary* portLibrary)
{
    PORT_ACCESS_FROM_PORT(portLibrary);
 ...
 */
I_32 j9nls_runTests(struct J9PortLibrary* portLibrary)
{
