...
JNIEXPORT jint JNICALL Agent_Prepare(JavaVM* vm, char* phase, char* options, void* reserved)
{
    jint rc;
    jvmtiError err;
 ...
 * @param obj the object on which the method was invoked (this will be a dummy value for the tests in which this method
 * is invoked)
 * @param value the value to return
 * @returns the value passed in
 */
void JNICALL Java_com_ibm_thread_TestNatives_setSpinCounts(JNIEnv* env, jobject obj, jlong spin1, jlong spin2,
    jlong yield, jlong tryEnterSpin1, jlong tryEnterSpin2, jlong tryEnterYield, jlong threeTierSpinCount1,
    jlong threeTierSpinCount2, jlong threeTierSpinCount3)
{
 ...
 */
jint JNICALL Java_j9vm_test_thread_TestNatives_getSchedulingPolicy(JNIEnv* env, jclass clazz, jobject javaThread)
{
 ...
 */
jint JNICALL Java_j9vm_test_thread_TestNatives_getSchedulingPriority(JNIEnv* env, jclass clazz, jobject javaThread)
{
    J9VMThread* vmThread = (J9VMThread*)env;
    J9JavaVM* javaVM = vmThread->javaVM;
    J9Object* javaThreadObject = NULL;
 ...
 */
jint JNICALL Java_j9vm_test_thread_TestNatives_getGCAlarmSchedulingPolicy(JNIEnv* env, jclass clazz)
{
#if defined(LINUX)
    J9VMThread* vmThread = (J9VMThread*)env;
    J9JavaVM* javaVM = vmThread->javaVM;
 ...
 */
jint JNICALL Java_j9vm_test_thread_TestNatives_getGCAlarmSchedulingPriority(JNIEnv* env, jclass clazz)
{
#if defined(LINUX)
    J9VMThread* vmThread = (J9VMThread*)env;
    J9JavaVM* javaVM = vmThread->javaVM;
...
jint JNICALL Java_com_ibm_tests_perftests_jlm_JLMInfoHelper_jvmtiJlmSet(JNIEnv* jni_env, jclass klazz, jint mode)
{
...
jobject JNICALL Java_com_ibm_tests_perftests_jlm_JLMInfoHelper_jvmtiJlmDump(JNIEnv* jni_env, jclass klazz)
{
...
jlong JNICALL Java_com_ibm_j9_monitor_tests_TestNatives_getLockWordValue(
    JNIEnv* env, jobject testNativesObject, jobject lockwordObj)
{
    j9object_t obj;
...
jlong JNICALL Java_com_ibm_j9_monitor_tests_TestNatives_getLockWordOffset(
    JNIEnv* env, jobject testNativesObject, jobject lockwordObj)
{
    j9object_t obj;
    J9JavaVM* vm = ((J9VMThread*)env)->javaVM;
...
jlong JNICALL Java_com_ibm_j9_monitor_tests_TestNatives_getHeaderSize(JNIEnv* env, jclass clazz)
{
    return sizeof(J9Object);
}

jlong JNICALL Java_com_ibm_j9_monitor_tests_TestNatives_getLockwordSize(JNIEnv* env, jclass clazz)
{
 ...
 *
 */
void JNICALL Java_j9vm_test_softmx_TestNatives_setAggressiveGCPolicy(JNIEnv* env, jclass clazz)
{
    J9VMThread* vmThread = (J9VMThread*)env;
    J9JavaVM* javaVM = vmThread->javaVM;
    ...
    javaVM->memoryManagerFunctions->j9gc_modron_global_collect_with_overrides(
        vmThread, J9MMCONSTANT_IMPLICIT_GC_AGGRESSIVE);
