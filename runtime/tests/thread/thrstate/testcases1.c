...
test_vBfVC_nNull(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), NULL, J9_PUBLIC_FLAGS_THREAD_BLOCKED, TESTDATA(blockingObject),
        getFlatLock(TESTDATA(otherVmthread), 0));
    setJ9MonitorState(TESTDATA(objMonitor)->monitor, NULL, 0);

    rc |= checkObjAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, TESTDATA(blockingObject), TESTDATA(otherVmthread), 1);
    rc |= checkRawAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, TESTDATA(blockingObject),
        TESTDATA(objMonitor)->monitor, TESTDATA(otherVmthread), 1);
    rc |= checkOldAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, TESTDATA(objMonitor)->monitor,
...
test_vBaVC_nNull(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), NULL, J9_PUBLIC_FLAGS_THREAD_BLOCKED, TESTDATA(blockingObject),
        getInflLock(TESTDATA(objMonitor)));
...
test_vWaoc_nNull(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), NULL, J9_PUBLIC_FLAGS_THREAD_WAITING, TESTDATA(blockingObject),
        getInflLock(TESTDATA(objMonitor)));
    setJ9MonitorState(TESTDATA(objMonitor)->monitor, NULL, 0);

    rc |= checkObjAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING, TESTDATA(blockingObject), NULL, 0);
    rc |= checkRawAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING, TESTDATA(blockingObject),
        TESTDATA(objMonitor)->monitor, NULL, 0);
#if 0 /* this crashes */
...
test_vWTaoc_nNull(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), NULL, J9_PUBLIC_FLAGS_THREAD_WAITING | J9_PUBLIC_FLAGS_THREAD_TIMED,
        TESTDATA(blockingObject), getInflLock(TESTDATA(objMonitor)));
    setJ9MonitorState(TESTDATA(objMonitor)->monitor, NULL, 0);

    rc |= checkObjAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING_TIMED, TESTDATA(blockingObject), NULL, 0);
    rc |= checkRawAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING_TIMED, TESTDATA(blockingObject),
        TESTDATA(objMonitor)->monitor, NULL, 0);
#if 0 /* this crashes */
...
test_vPMoc_nNull(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkRawAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_PARKED, TESTDATA(blockingObject), NULL, NULL, 0);
#if 0 /* this crashes */
...
test_vPTm_nNull(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(
        TESTDATA(selfVmthread), NULL, J9_PUBLIC_FLAGS_THREAD_PARKED | J9_PUBLIC_FLAGS_THREAD_TIMED, NULL, 0);
...
static void explainWhyOldGetStateShouldReturnNullMonitor(JNIEnv* env)
{
...
static void explainSuspendedThreadsShouldNotBeBlocked(JNIEnv* env)
{
    PORT_ACCESS_FROM_ENV(env);
...
test_v0_nStMOc(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(
        TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED, TESTDATA(rawMonitor)->monitor, TESTDATA(selfOsthread), 0);
...
test_v0_nStMOC(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED, TESTDATA(rawMonitor)->monitor,
        TESTDATA(selfOsthread), MON_COUNT);
...
test_v0_nStMNc(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(
        TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED, TESTDATA(rawMonitor)->monitor, TESTDATA(unattachedOsthread), 0);
...
test_v0_nStMNC(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED, TESTDATA(rawMonitor)->monitor,
        TESTDATA(unattachedOsthread), MON_COUNT);
...
test_v0_nStMVc(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(
        TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED, TESTDATA(rawMonitor)->monitor, TESTDATA(otherOsthread), 0);
...
test_v0_nStMVC(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED, TESTDATA(rawMonitor)->monitor,
        TESTDATA(otherOsthread), MON_COUNT);
...
test_v0_nDMoc(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(
        TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_DEAD, TESTDATA(rawMonitor)->monitor, NULL, 0);
...
test_v0_nDMoC(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_DEAD, TESTDATA(rawMonitor)->monitor,
        NULL, MON_COUNT);
...
test_v0_nZMoc(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_SUSPENDED,
...
test_v0_nBm(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    j9tty_printf(PORTLIB, "Expected failure in getVMThreadStatus:\n");
    j9tty_printf(
        PORTLIB, "This test has an invalid omrthread state (omrthread.flags = BLOCKED, omrthread.monitor = NULL).\n");
...
test_v0_nBMNc(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkObjAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_RUNNING, NULL, NULL, 0);
    rc |= checkRawAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, NULL, TESTDATA(rawMonitor)->monitor, NULL, 0);
    rc |= checkOldAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, TESTDATA(rawMonitor)->monitor, NULL, 0);
...
test_v0_nBMNC(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkObjAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_RUNNING, NULL, NULL, 0);
    rc |= checkRawAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, NULL, TESTDATA(rawMonitor)->monitor, NULL, MON_COUNT);
    rc |= checkOldAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, TESTDATA(rawMonitor)->monitor, NULL, MON_COUNT);
...
test_v0_nBMVC(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkObjAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_RUNNING, NULL, NULL, 0);
    rc |= checkRawAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, NULL, TESTDATA(rawMonitor)->monitor,
        TESTDATA(otherVmthread), MON_COUNT);
    rc |= checkOldAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, TESTDATA(rawMonitor)->monitor,
        TESTDATA(otherVmthread), MON_COUNT);
...
test_v0_nZBm(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(
        TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_SUSPENDED | J9THREAD_FLAG_BLOCKED, NULL, NULL, 0);
...
test_v0_nZBMoc(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_SUSPENDED | J9THREAD_FLAG_BLOCKED,
        TESTDATA(rawMonitor)->monitor, NULL, 0);
...
test_v0_nWMNC(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkObjAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_RUNNING, NULL, NULL, 0);
    rc |= checkRawAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING, NULL, TESTDATA(rawMonitor)->monitor, NULL, MON_COUNT);
    rc |= checkOldAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING, TESTDATA(rawMonitor)->monitor, NULL, MON_COUNT);
...
test_v0_nBMVC_2(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_BLOCKED,
        TESTDATA(objMonitor)->monitor, TESTDATA(otherOsthread), MON_COUNT);

    rc |= checkObjAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_RUNNING, NULL, NULL, 0);
    rc |= checkRawAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, TESTDATA(blockingObject),
        TESTDATA(objMonitor)->monitor, TESTDATA(otherVmthread), MON_COUNT);
    rc |= checkOldAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_BLOCKED, TESTDATA(objMonitor)->monitor,
        TESTDATA(otherVmthread), MON_COUNT);
...
test_v0_nWMVC_2(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkRawAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING, TESTDATA(blockingObject),
        TESTDATA(objMonitor)->monitor, TESTDATA(otherVmthread), MON_COUNT);
    rc |= checkOldAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING, TESTDATA(objMonitor)->monitor,
        TESTDATA(otherVmthread), MON_COUNT);
...
test_v0_nBNm(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(
        TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_BLOCKED | J9THREAD_FLAG_NOTIFIED, NULL, NULL, 0);
...
test_v0_nSI(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread),
        J9THREAD_FLAG_STARTED | J9THREAD_FLAG_SLEEPING | J9THREAD_FLAG_INTERRUPTABLE, NULL, NULL, 0);
...
test_v0_nSII(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), 0, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread),
        J9THREAD_FLAG_STARTED | J9THREAD_FLAG_SLEEPING | J9THREAD_FLAG_INTERRUPTABLE | J9THREAD_FLAG_INTERRUPTED, NULL,
        NULL, 0);
