...
test_vWaoc_nSt(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), J9_PUBLIC_FLAGS_THREAD_WAITING,
...
test_vWaoc_nW(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkOldAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING, TESTDATA(objMonitor)->monitor, NULL, 0);
...
test_vWaVC_nB(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_BLOCKED,
        TESTDATA(objMonitor)->monitor, TESTDATA(otherOsthread), 1);
...
test_vWaVC_nW(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkObjAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING, TESTDATA(blockingObject), TESTDATA(otherVmthread), 1);
    rc |= checkRawAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING, TESTDATA(blockingObject),
        TESTDATA(objMonitor)->monitor, TESTDATA(otherVmthread), 1);
...
test_vWaOC_nB(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), J9_PUBLIC_FLAGS_THREAD_WAITING,
        TESTDATA(blockingObject), getInflLock(TESTDATA(objMonitor)));
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_BLOCKED,
        TESTDATA(objMonitor)->monitor, TESTDATA(selfOsthread), 1);
...
test_vWTaoc_nSt(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread),
        J9_PUBLIC_FLAGS_THREAD_WAITING | J9_PUBLIC_FLAGS_THREAD_TIMED, TESTDATA(blockingObject),
...
test_vWTaoc_nW(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkRawAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING_TIMED, TESTDATA(blockingObject),
        TESTDATA(objMonitor)->monitor, NULL, 0);
    rc |= checkOldAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING_TIMED, TESTDATA(objMonitor)->monitor, NULL, 0);
...
test_vWTaVC_nW(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkObjAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING_TIMED, TESTDATA(blockingObject),
        TESTDATA(otherVmthread), 1);
    rc |= checkRawAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING_TIMED, TESTDATA(blockingObject),
        TESTDATA(objMonitor)->monitor, TESTDATA(otherVmthread), 1);
    rc |= checkOldAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_WAITING_TIMED, TESTDATA(objMonitor)->monitor,
        TESTDATA(otherVmthread), 1);
