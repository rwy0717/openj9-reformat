...
static void explainParkedAreIgnored(JNIEnv* env)
{
...
static void explainAtypicalState(JNIEnv* env)
{
    PORT_ACCESS_FROM_ENV(env);
...
test_vPm_nZP(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), J9_PUBLIC_FLAGS_THREAD_PARKED, NULL, 0);
    setJ9ThreadState(
        TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_PARKED | J9THREAD_FLAG_SUSPENDED, NULL, NULL, 0);
...
test_vPm_nZBMVC(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), J9_PUBLIC_FLAGS_THREAD_PARKED, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_BLOCKED | J9THREAD_FLAG_SUSPENDED,
        TESTDATA(rawMonitor)->monitor, TESTDATA(otherOsthread), 1);
...
test_vPm_nZWMVC(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), J9_PUBLIC_FLAGS_THREAD_PARKED, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_WAITING | J9THREAD_FLAG_SUSPENDED,
        TESTDATA(rawMonitor)->monitor, TESTDATA(otherOsthread), 1);
...
test_vPTm_nSt(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread),
        J9_PUBLIC_FLAGS_THREAD_PARKED | J9_PUBLIC_FLAGS_THREAD_TIMED, NULL, 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED, NULL, NULL, 0);
...
test_vPTm_nPT(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread),
        J9_PUBLIC_FLAGS_THREAD_PARKED | J9_PUBLIC_FLAGS_THREAD_TIMED, NULL, 0);
    setJ9ThreadState(
        TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED | J9THREAD_FLAG_PARKED | J9THREAD_FLAG_TIMER_SET, NULL, NULL, 0);
...
test_vPMoc_nSt(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(
        TESTDATA(selfVmthread), TESTDATA(selfOsthread), J9_PUBLIC_FLAGS_THREAD_PARKED, TESTDATA(blockingObject), 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED, NULL, NULL, 0);
...
test_vPTMoc_nSt(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread),
        J9_PUBLIC_FLAGS_THREAD_PARKED | J9_PUBLIC_FLAGS_THREAD_TIMED, TESTDATA(blockingObject), 0);
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED, NULL, NULL, 0);
...
test_vPTMoc_nPT(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    rc |= checkObjAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_PARKED_TIMED, TESTDATA(blockingObject), NULL, 0);
    rc |= checkRawAnswers(
        env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_PARKED_TIMED, TESTDATA(blockingObject), NULL, NULL, 0);
    rc |= checkOldAnswers(env, TESTDATA(selfVmthread), J9VMTHREAD_STATE_PARKED_TIMED, NULL, NULL, 0);
...
test_vPMOC_nSt(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread), J9_PUBLIC_FLAGS_THREAD_PARKED,
...
test_vPTMOC_nSt(JNIEnv* env, BOOLEAN ignoreExpectedFailures)
{
    ...
    setVMThreadState(TESTDATA(selfVmthread), TESTDATA(selfOsthread),
        J9_PUBLIC_FLAGS_THREAD_PARKED | J9_PUBLIC_FLAGS_THREAD_TIMED, TESTDATA(blockingObject),
        getFlatLock(TESTDATA(selfVmthread), 0));
    setJ9ThreadState(TESTDATA(selfOsthread), J9THREAD_FLAG_STARTED, NULL, NULL, 0);
