 ...
 */
jint JNICALL Java_com_ibm_j9_zostest_ZosNativesTest_ifaSwitchTest1(JNIEnv* env, jclass clazz)
{
 ...
 */
jint JNICALL Java_com_ibm_j9_zostest_ZosNativesTest_ifaSwitchTest2(JNIEnv* env, jclass clazz)
{
    PORT_ACCESS_FROM_ENV(env);
    char* buffer_str;
    jstring testStr;
 ...
 */
jint JNICALL Java_com_ibm_j9_zostest_ZosNativesTest_ifaSwitchTest3(JNIEnv* env, jclass clazz)
{
    PORT_ACCESS_FROM_ENV(env);
    jbyteArray array_b;
    jbyte* buffer_b;
 ...
 */
jint JNICALL Java_com_ibm_j9_zostest_ZosNativesTest_ifaSwitchTest4(JNIEnv* env, jclass clazz)
{
    PORT_ACCESS_FROM_ENV(env);
    jint* buffer_i;
    jintArray array_i;
 ...
 */
jint JNICALL Java_com_ibm_j9_zostest_ZosNativesTest_ifaSwitchTest5(JNIEnv* env, jclass clazz)
{
    PORT_ACCESS_FROM_ENV(env);
 ...
 */
jint JNICALL Java_com_ibm_j9_zostest_ZosNativesTest_ifaSwitchTest6(JNIEnv* env, jclass clazz)
{
    PORT_ACCESS_FROM_ENV(env);
    jboolean isCopy; /* dummy variable */
    jthrowable ex = NULL;
 ...
 */
jint JNICALL Java_com_ibm_j9_zostest_ZosNativesTest_ifaSwitchTest7(JNIEnv* env, jclass clazz)
{
    PORT_ACCESS_FROM_ENV(env);
    jboolean isCopy; /* dummy variable */
    jthrowable ex = NULL;
 ...
 */
jint JNICALL Java_com_ibm_j9_zostest_ZosNativesTest_ifaSwitchTest8(JNIEnv* env, jclass clazz)
{
    PORT_ACCESS_FROM_ENV(env);
    char* buffer_str;
    jstring testStr;
...
jint JNICALL registeredNativeMethod() { return 100; }
 ...
 */
jint JNICALL Java_com_ibm_j9_zostest_ZosNativesTest_registerNative(JNIEnv* env, jobject obj, jclass klass)
{
    PORT_ACCESS_FROM_ENV(env);
