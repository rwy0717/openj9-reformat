...
#if defined(WIN32) || defined(J9X86) || defined(J9_NO_DENORMAL_FLOAT_SUPPORT) \
    || (defined(LINUXPPC) && defined(HARDHAT)) || defined(ARMGNU) || defined(J9ZTPF)
...
static void scaleUpFloat(float* fp, int s)
{
    ...
    if (e == 0) {
        ...
        if (s > (SPFRACTION_LENGTH - leading))
            e = 1;
...
void scaleUpDouble(double* dp, int s)
{
    ...
    if (e == 0) {
        ...
        HIGH_U32_FROM_DBL_PTR(dp) = HIGH_U32_FROM_LONG64(l);
        LOW_U32_FROM_DBL_PTR(dp) = LOW_U32_FROM_LONG64(l);
        if (s > (DPFRACTION_LENGTH - leading))
            e = 1;
        s -= sl;
    }
    e += s;
...
static void oldAddDD(double d1, double d2, double* rp)
{
    ...
    e1 += DPEXPONENT_BIAS;
    e2 += DPEXPONENT_BIAS;
    if ((e1 == 0 && e2 == 0) && leadingr > tmp && leadingr >= DPFRACTION_LENGTH)
        be += leadingr - tmp;
    /* if a denormal was generated */
    if (tmp >= DPFRACTION_LENGTH && (be + leadingr) < DPFRACTION_LENGTH)
        be -= 1;
...
static void oldMultiplyDD(double d1, double d2, double* rp)
{
    ...
    if (leadingr > tmpl && leadingr >= DPFRACTION_LENGTH)
        e += leadingr - tmpl;
    /* if a denormal was generated */
    if (tmpl >= DPFRACTION_LENGTH && leadingr < DPFRACTION_LENGTH)
        e -= 1;
...
static void oldAddDF(float f1, float f2, float* rp)
{
    ...
    e1 += SPEXPONENT_BIAS;
    e2 += SPEXPONENT_BIAS;
    if ((e1 == 0 && e2 == 0) && leadingr > tmp && leadingr >= SPFRACTION_LENGTH)
        be += leadingr - tmp;

    /* if a denormal was generated 	*/
    if (tmp >= SPFRACTION_LENGTH && (be + leadingr) < SPFRACTION_LENGTH)
        be -= 1;
    ...
    if (ir != 0 || borrow != 0 || round != 0) {
        ...
        if (aediff <= SPFRACTION_LENGTH) {
            round = (truncValueSum & 0x80000000)
                || ((truncValueSum & 0x40000000) && (truncValueSum & 0x20000000) && (truncValueSum & 0x7fffffff));
