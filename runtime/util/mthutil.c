...
VMINLINE J9MethodParametersData* methodParametersFromROMMethod(J9ROMMethod* romMethod)
{
    U_32* stackMap;
...
J9ROMMethod* nextROMMethod(J9ROMMethod* romMethod)
{
    ...
    if (J9ROMMETHOD_HAS_METHOD_PARAMETERS(romMethod)) {
        return J9_U32_ALIGNED_ADDRESS(
            (U_8*)methodParamsData + J9_METHOD_PARAMS_SIZE_FROM_NUMBER_OF_PARAMS(methodParamsData->parameterCount));
    } else {
...
static VMINLINE U_32* methodAnnotationsDataFromROMMethod(J9ROMMethod* romMethod)
{
...
U_32* getMethodAnnotationsDataFromROMMethod(J9ROMMethod* romMethod)
{
...
#define SKIP_OVER_LENGTH_DATA_AND_PADDING(annotation, result)                                                         \
    do {                                                                                                              \
        ...
        /* Add the size of the annotation data (*annotation) and the size of the size of the annotation (4) and a pad \
         * to U_32*/                                                                                                  \
        result = (void*)((UDATA)annotation + *annotation + 4 + bytesToPad);                                           \
    } while (0);

U_32 getExtendedModifiersDataFromROMMethod(J9ROMMethod* romMethod)
{
...
static VMINLINE U_32* parameterAnnotationsFromROMMethod(J9ROMMethod* romMethod)
{
    U_32* annotation;
    void* result;
...
U_32* getParameterAnnotationsDataFromROMMethod(J9ROMMethod* romMethod)
{
...
static VMINLINE U_32* defaultAnnotationFromROMMethod(J9ROMMethod* romMethod)
{
    U_32* annotation;
    void* result;
...
U_32* getDefaultAnnotationDataFromROMMethod(J9ROMMethod* romMethod)
{
...
static VMINLINE U_32* methodTypeAnnotationsFromROMMethod(J9ROMMethod* romMethod)
{
...
U_32* getMethodTypeAnnotationsDataFromROMMethod(J9ROMMethod* romMethod)
{
    U_32* result = NULL;
...
static VMINLINE U_32* codeTypeAnnotationsFromROMMethod(J9ROMMethod* romMethod)
{
...
U_32* getCodeTypeAnnotationsDataFromROMMethod(J9ROMMethod* romMethod)
{
    U_32* result = NULL;
...
J9MethodDebugInfo* methodDebugInfoFromROMMethod(J9ROMMethod* romMethod)
{
...
J9MethodDebugInfo* getMethodDebugInfoFromROMMethod(J9ROMMethod* romMethod)
{
...
U_32* stackMapFromROMMethod(J9ROMMethod* romMethod)
{
...
J9MethodParametersData* getMethodParametersFromROMMethod(J9ROMMethod* romMethod)
{
    if (J9ROMMETHOD_HAS_METHOD_PARAMETERS(romMethod)) {
...
static VMINLINE U_8* walkStackMapSlots(U_8* framePointer, U_16 typeInfoCount)
{
    /*
 ...
 */
UDATA* getNextStackMapFrame(U_32* stackMap, UDATA* previousFrame)
{
    /*
 ...
 */
static VMINLINE UDATA methodIndexWithinClass(J9Method* method, J9Class* clazz)
{
    J9ROMClass* romClass = clazz->romClass;
    UDATA methodCount = romClass->romMethodCount;
    UDATA methodIndex = method - clazz->ramMethods;

    if ((methodIndex >= methodCount) || ((((UDATA)method - (UDATA)clazz->ramMethods) % sizeof(J9Method)) != 0)) {
