 ...
 */
static char* propsfile_read_text(struct J9PortLibrary* portLibrary, IDATA fd, char* buf, IDATA nbytes)
{
...
static UDATA hashFn(void* entry, void* userData)
{
...
static UDATA equalsFn(void* leftEntry, void* rightEntry, void* userData)
{
 ...
 */
static void trimTrailing(char* input)
{
...
j9props_file_t props_file_open(J9PortLibrary* portLibrary, const char* file, char* errorBuf, UDATA errorBufLength)
{
    ...
    result->properties = hashTableNew(OMRPORT_FROM_J9PORT(PORTLIB), J9_GET_CALLSITE(), 0, sizeof(KeyValuePair), 0, 0,
        OMRMEM_CATEGORY_VM, hashFn, equalsFn, NULL, NULL);
