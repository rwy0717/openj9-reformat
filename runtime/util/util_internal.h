 ...
 * 								which is needed to determine which monitor table to
 * search
 ...
 * @param targetVMThread	Used solely by the multi-tenant JVM: identifies the TenantContext of the object, which is
 * needed to determine which monitor table to search
