...
typedef enum { VM_NO, VM_YES, VM_MAYBE } VM_YesNoMaybe;
...
private:
     ...
     */
    VMINLINE VM_BytecodeAction interpretMethodHandle(REGISTER_ARGS_LIST, j9object_t methodHandle)
    {
     ...
     */
    VMINLINE void modifyMethodHandleCountForI2J(REGISTER_ARGS_LIST, j9object_t methodHandle)
    {
...
#if defined(DO_SINGLE_STEP)
    void VMINLINE skipNextSingleStep()
    {
    ...
    VM_BytecodeAction VMINLINE singleStep(REGISTER_ARGS_LIST)
    {
        ...
        if (J9_EVENT_IS_HOOKED(_vm->hookInterface, J9HOOK_VM_SINGLE_STEP)) {
            if (_skipSingleStep) {
                ...
                updateVMStruct(REGISTER_ARGS);
                ALWAYS_TRIGGER_J9HOOK_VM_SINGLE_STEP(
                    _vm->hookInterface, _currentThread, _literals, _pc - _literals->bytecodes);
                VMStructHasBeenUpdated(REGISTER_ARGS);
                if (JBbreakpoint == *_pc) {
     ...
     * 			J9Method *callingMethod;
     */
    VMINLINE U_8* startProfilingRecord(REGISTER_ARGS_LIST, UDATA dataSize)
    {
    ...
    VMINLINE void profileCallingMethod(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE void profileInvokeReceiver(
        REGISTER_ARGS_LIST, J9Class* clazz, J9Method* callingMethod, J9Method* targetMethod)
    {
        ...
        if (NULL != profilingCursor) {
             ...
             */
            asm("str %[clazz],  [%[cursor], #0]\n\t"
                "str %[method], [%[cursor], #4]\n\t"
                "str %[target], [%[cursor], #8]\n\t"
                : // No outputs
                : [cursor] "r"(profilingCursor), [clazz] "r"(clazz), [method] "r"(callingMethod),
    ...
    VMINLINE void profileCast(REGISTER_ARGS_LIST, J9Class* clazz)
    {
    ...
    VMINLINE void profileSwitch(REGISTER_ARGS_LIST, I_32 index)
    {
    ...
    VMINLINE void updateVMStruct(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE void VMStructHasBeenUpdated(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE UDATA* buildSpecialStackFrame(REGISTER_ARGS_LIST, UDATA type, UDATA flags, bool visible)
    {
    ...
    VMINLINE void buildGenericSpecialStackFrame(REGISTER_ARGS_LIST, UDATA flags)
    {
        _arg0EA = buildSpecialStackFrame(REGISTER_ARGS, J9SF_FRAME_TYPE_GENERIC_SPECIAL, flags, false);
    }

    VMINLINE UDATA* buildMethodFrame(REGISTER_ARGS_LIST, J9Method* method, UDATA flags)
    {
    ...
    VMINLINE UDATA jitStackFrameFlags(REGISTER_ARGS_LIST, UDATA constantFlags)
    {
    ...
    VMINLINE void restoreGenericSpecialStackFrame(REGISTER_ARGS_LIST)
    {
        _sp = _arg0EA + 1;
    ...
    VMINLINE void restoreSpecialStackFrameLeavingArgs(REGISTER_ARGS_LIST, UDATA* bp)
    {
        _sp = bp + 1;
    ...
    VMINLINE void restoreSpecialStackFrameAndDrop(REGISTER_ARGS_LIST, UDATA* bp)
    {
        _sp = _arg0EA + 1;
        _literals = (J9Method*)(bp[-2]);
        _pc = (U_8*)(bp[-1]);
    ...
    VMINLINE UDATA* buildInternalNativeStackFrame(REGISTER_ARGS_LIST)
    {
        UDATA* bp = buildSpecialStackFrame(
            REGISTER_ARGS, J9SF_FRAME_TYPE_NATIVE_METHOD, jitStackFrameFlags(REGISTER_ARGS, 0), true);
        *--_sp = (UDATA)_sendMethod;
        _arg0EA = bp + J9_ROM_METHOD_FROM_RAM_METHOD(_sendMethod)->argCount;
        return bp;
    }

    VMINLINE void restoreInternalNativeStackFrame(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE J9SFJNINativeMethodFrame* recordJNIReturn(REGISTER_ARGS_LIST, UDATA* bp)
    {
     ...
     */
    VMINLINE void restoreMethodTypeFrame(REGISTER_ARGS_LIST, J9SFMethodTypeFrame* frame, UDATA* spPriorToFrameBuild)
    {
    ...
    VMINLINE UDATA* bpForCurrentBytecodedMethod(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE void pushObjectInSpecialFrame(REGISTER_ARGS_LIST, j9object_t object)
    {
        _sp -= 1;
    ...
    VMINLINE j9object_t popObjectInSpecialFrame(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction i2jTransition(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction i2jMHTransition(REGISTER_ARGS_LIST)
    {
        ...
        return jitTransition(
            REGISTER_ARGS, J9VMJAVALANGINVOKEMETHODTYPE_ARGSLOTS(_currentThread, methodType) + 1, jitStartAddress);
    }

    VMINLINE VM_BytecodeAction j2iTransition(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction promotedMethodOnTransitionFromJIT(
        REGISTER_ARGS_LIST, void* returnAddress, void* jumpAddress)
    {
    ...
    VMINLINE J9Method* j2iVirtualMethod(REGISTER_ARGS_LIST, j9object_t receiver, UDATA interfaceVTableIndex)
    {
    ...
    VMINLINE void restorePreservedRegistersFromWalkState(REGISTER_ARGS_LIST, J9StackWalkState* walkState)
    {
    ...
    VMINLINE VM_BytecodeAction retFromNativeHelper(REGISTER_ARGS_LIST, UDATA slots, void* jitReturn)
    {
    ...
    VMINLINE VM_BytecodeAction fillOSRBuffer(REGISTER_ARGS_LIST, void* osrBlock)
    {
    ...
    VMINLINE VM_BytecodeAction returnFromJIT(REGISTER_ARGS_LIST, UDATA slotCount, bool isConstructor)
    {
        VM_JITInterface::disableRuntimeInstrumentation(_currentThread);
        if (isConstructor) {
    ...
    VMINLINE VM_BytecodeAction jitTransition(REGISTER_ARGS_LIST, UDATA argCount, void* jitStartAddress)
    {
    ...
    VMINLINE void* j2iReturnPoint(J9UTF8* signature)
    {
    ...
    VMINLINE void* j2iReturnPoint(J9Class* returnType)
    {
        J9JITConfig* const jitConfig = _vm->jitConfig;
        void* returnPoint = jitConfig->jitExitInterpreter1;
    ...
    VMINLINE void fillInJ2IValues(
        J9SFJ2IFrame* const j2iFrame, void* const exitPoint, void* const jitReturnAddress, UDATA* returnSP)
    {
        J9VMEntryLocalStorage* const els = _currentThread->entryLocalStorage;
        UDATA* const jitGlobalStorageBase = els->jitGlobalStorageBase;
    ...
    VMINLINE void restoreJ2IValues(J9SFJ2IFrame* const j2iFrame)
    {
        J9VMEntryLocalStorage* const els = _currentThread->entryLocalStorage;
        UDATA* const jitGlobalStorageBase = els->jitGlobalStorageBase;
        UDATA* const j2iPreservedBase = ((UDATA*)&j2iFrame->previousJ2iFrame) + 1;
    ...
    VMINLINE VM_BytecodeAction j2iReturn(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE U_8* nativeReturnBytecodePC(REGISTER_ARGS_LIST, J9ROMMethod* const romMethod)
    {
    ...
    VMINLINE VM_BytecodeAction j2iInvokeExact(REGISTER_ARGS_LIST, j9object_t methodHandle)
    {
        VM_JITInterface::disableRuntimeInstrumentation(_currentThread);
        ...
        UDATA argCount = J9VMJAVALANGINVOKEMETHODTYPE_ARGSLOTS(_currentThread, methodType)
            + 1; /* argSlots does not include the receiver of the invokeExact */
         ...
         */
        J9VMJAVALANGINVOKEMETHODHANDLE_SET_INVOCATIONCOUNT(_currentThread, methodHandle,
            J9VMJAVALANGINVOKEMETHODHANDLE_INVOCATIONCOUNT(_currentThread, methodHandle) - 1);
#if defined(J9SW_NEEDS_JIT_2_INTERP_CALLEE_ARG_POP)
        /* Variable frame - return SP should pop the arguments */
        ...
        if (J9_ARE_ANY_BITS_SET(_currentThread->publicFlags, J9_PUBLIC_FLAGS_STOP)) {
            ...
            if (NULL != jitConfig->translateMethodHandle) {
                i2jThunkAddress = jitConfig->translateMethodHandle(
                    _currentThread, methodHandle, NULL, J9_METHOD_HANDLE_COMPILE_SHARED);
     ...
     */
    VMINLINE j9object_t allocateObject(
        REGISTER_ARGS_LIST, J9Class* clazz, bool initializeSlots = true, bool memoryBarrier = true)
    {
        j9object_t instance
            = _objectAllocate.inlineAllocateObject(_currentThread, clazz, initializeSlots, memoryBarrier);
        if (NULL == instance) {
            updateVMStruct(REGISTER_ARGS);
            instance = _vm->memoryManagerFunctions->J9AllocateObject(
                _currentThread, clazz, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
            VMStructHasBeenUpdated(REGISTER_ARGS);
        }
        return instance;
    }
     ...
     * @returns the new object, or NULL if allocation failed
     */
    VMINLINE j9object_t allocateIndexableObject(REGISTER_ARGS_LIST, J9Class* arrayClass, U_32 size,
        bool initializeSlots = true, bool memoryBarrier = true, bool sizeCheck = true)
    {
        j9object_t instance = _objectAllocate.inlineAllocateIndexableObject(
            _currentThread, arrayClass, size, initializeSlots, memoryBarrier, sizeCheck);
        if (NULL == instance) {
            updateVMStruct(REGISTER_ARGS);
            instance = _vm->memoryManagerFunctions->J9AllocateIndexableObject(
                _currentThread, arrayClass, size, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
            VMStructHasBeenUpdated(REGISTER_ARGS);
        }
        return instance;
    }
     ...
     */
    VMINLINE VM_BytecodeAction initializeClassIfNeeded(REGISTER_ARGS_LIST, J9Class*& j9clazz)
    {
    ...
    VMINLINE IDATA enterObjectMonitor(REGISTER_ARGS_LIST, j9object_t obj)
    {
        IDATA rc = (IDATA)obj;
    ...
    VMINLINE IDATA exitObjectMonitor(REGISTER_ARGS_LIST, j9object_t obj)
    {
        IDATA rc = 0;
    ...
    VMINLINE VM_BytecodeAction doReferenceArrayCopy(REGISTER_ARGS_LIST, j9object_t srcObject, I_32 srcStart,
        j9object_t destObject, I_32 destStart, I_32 elementCount)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (elementCount < 0) {
            ...
            if (!VM_ArrayCopyHelpers::rangeCheck(_currentThread, srcObject, srcStart, elementCount, &invalidIndex)) {
                ...
                if (!VM_ArrayCopyHelpers::rangeCheck(
                        _currentThread, destObject, destStart, elementCount, &invalidIndex)) {
                    buildInternalNativeStackFrame(REGISTER_ARGS);
                    _currentThread->tempSlot = (UDATA)invalidIndex;
                    rc = THROW_AIOB;
                } else {
                    I_32 value = VM_ArrayCopyHelpers::referenceArrayCopy(
                        _currentThread, srcObject, srcStart, destObject, destStart, elementCount);
                    if (-1 != value) {
                        buildInternalNativeStackFrame(REGISTER_ARGS);
    ...
    VMINLINE VM_BytecodeAction doPrimitiveArrayCopy(REGISTER_ARGS_LIST, j9object_t srcObject, I_32 srcStart,
        j9object_t destObject, I_32 destStart, U_32 arrayShape, I_32 elementCount)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        /* Primitive array */
        if (elementCount < 0) {
            ...
            if (!VM_ArrayCopyHelpers::rangeCheck(_currentThread, srcObject, srcStart, elementCount, &invalidIndex)) {
                ...
                if (!VM_ArrayCopyHelpers::rangeCheck(
                    ...
                    if (elementCount > 0) {
                        VM_ArrayCopyHelpers::primitiveArrayCopy(
                            _currentThread, srcObject, srcStart, destObject, destStart, elementCount, arrayShape);
                    }
                }
            }
        }
...
#if defined(DEBUG_VERSION)
    VMINLINE void cleanUpForFramePop(REGISTER_ARGS_LIST, UDATA* bp)
    {
    ...
    VMINLINE void pushForceEarlyReturnValue(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction handlePopFramesInterrupt(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (0 == _currentThread->ferReturnType) {
            ...
            case JBinvokehandlegeneric: {
                 ...
                 * 'would be' slot of MH. We must decrement sp and clear all the slots above unwindSP so that we throw a
                 * NPE instead of trying to run using the saved method slot. All the slots must be cleared because when
                 * the sp is decremented there is a possibility that the stack slot values do not match with the
                 * expected types. By clearing all entries we avoid a situation where the GC treats an native (or
                 * garbage) value as a live object */
            ...
            if (hooked || traced) {
                ...
                if (hooked) {
                    ALWAYS_TRIGGER_J9HOOK_VM_METHOD_RETURN(
                        _vm->hookInterface, _currentThread, _literals, FALSE, returnValue, 0);
                }
                VMStructHasBeenUpdated(REGISTER_ARGS);
            }
    ...
    VMINLINE VM_BytecodeAction checkAsync(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE bool objectArrayStoreAllowed(j9object_t array, j9object_t storeValue)
    {
        bool rc = true;
        if (NULL != storeValue) {
    ...
    VMINLINE VM_BytecodeAction throwUnsatisfiedLinkOrAbstractMethodError(REGISTER_ARGS_LIST)
    {
        /* We need a frame to describe the method arguments (in particular, for the case where we got here directly from
         * the JIT) */
        buildMethodFrame(REGISTER_ARGS, _sendMethod, jitStackFrameFlags(REGISTER_ARGS, 0));
        ...
        if (romMethod->modifiers & J9AccAbstract) {
            ...
            if (J9ROMCLASS_IS_INTERFACE(methodClass->romClass)) {
                J9Method* method
                    = (J9Method*)javaLookupMethod(_currentThread, J9OBJECT_CLAZZ(_currentThread, *(j9object_t*)_arg0EA),
                        &romMethod->nameAndSignature, NULL, J9_LOOK_VIRTUAL | J9_LOOK_NO_THROW);
                if (NULL != method) {
                    U_32 modifiers = J9_ROM_METHOD_FROM_RAM_METHOD(method)->modifiers;
                    /* Finding a public method means it is necessarily abstract (this function only handles exceptional
                     * cases) */
    ...
    VMINLINE VM_BytecodeAction throwForDefaultConflict(REGISTER_ARGS_LIST)
    {
        /* We need a frame to describe the method arguments (in particular, for the case where we got here directly from
         * the JIT) */
        buildMethodFrame(REGISTER_ARGS, _sendMethod, jitStackFrameFlags(REGISTER_ARGS, 0));
    ...
    VMINLINE VM_BytecodeAction inlineSendTarget(REGISTER_ARGS_LIST, VM_YesNoMaybe isStatic, VM_YesNoMaybe isSynchonized,
        VM_YesNoMaybe isObjectConstructor, VM_YesNoMaybe zeroing, bool j2i = false, bool decompileOccurred = false)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        J9ROMMethod* romMethod = J9_ROM_METHOD_FROM_RAM_METHOD(_sendMethod);
        ...
        bool methodIsSynchronized
            = (VM_YES == isSynchonized) || ((VM_MAYBE == isSynchonized) && (modifiers & J9AccSynchronized));
        bool methodIsStatic = (VM_YES == isStatic) || ((VM_MAYBE == isStatic) && (modifiers & J9AccStatic));
        bool methodIsObjectConstructor = (VM_YES == isObjectConstructor)
            || ((VM_MAYBE == isObjectConstructor) && J9ROMMETHOD_IS_OBJECT_CONSTRUCTOR(romMethod));
        bool tempsNeedZeroing = (VM_YES == zeroing)
            || ((VM_MAYBE == zeroing) && (_vm->extendedRuntimeFlags & J9_EXTENDED_RUNTIME_DEBUG_MODE));
...
#if defined(DO_HOOKS)
    VMINLINE VM_BytecodeAction reportMethodEnter(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (hooked || traced) {
            ...
            if (hooked) {
                ALWAYS_TRIGGER_J9HOOK_VM_METHOD_ENTER(
                    _vm->hookInterface, _currentThread, _sendMethod, (void*)receiverAddress, 0);
            }
            VMStructHasBeenUpdated(REGISTER_ARGS);
            if (immediateAsyncPending()) {
                rc = GOTO_ASYNC_CHECK;
    ...
    VMINLINE VM_BytecodeAction enterMethodMonitor(REGISTER_ARGS_LIST)
    {
    ...
    /* A method has just been entered (stack frame built, no monitor entered or method enter hook called) and the SP is
     * below the stackOverflowMark */
    VMINLINE VM_BytecodeAction stackOverflow(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        J9ROMMethod* romMethod = J9_ROM_METHOD_FROM_RAM_METHOD(_literals);
        UDATA relativeBP = 0;
    ...
    VMINLINE VM_BytecodeAction takeBranch(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        UDATA volatile stackOverflowMark = (UDATA)_currentThread->stackOverflowMark;
    ...
    VMINLINE VM_BytecodeAction performDLT(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction sendTargetSmallNonSync(REGISTER_ARGS_LIST)
    {
        return inlineSendTarget(REGISTER_ARGS, VM_NO, VM_NO, VM_NO, VM_NO);
    }
    VMINLINE VM_BytecodeAction sendTargetSmallSync(REGISTER_ARGS_LIST)
    {
        return inlineSendTarget(REGISTER_ARGS, VM_NO, VM_YES, VM_NO, VM_NO);
    }
    VMINLINE VM_BytecodeAction sendTargetSmallSyncStatic(REGISTER_ARGS_LIST)
    {
        return inlineSendTarget(REGISTER_ARGS, VM_YES, VM_YES, VM_NO, VM_NO);
    }
    VMINLINE VM_BytecodeAction sendTargetSmallObjectConstructor(REGISTER_ARGS_LIST)
    {
        return inlineSendTarget(REGISTER_ARGS, VM_NO, VM_NO, VM_YES, VM_NO);
    }
    VMINLINE VM_BytecodeAction sendTargetSmallZeroing(REGISTER_ARGS_LIST)
    {
        return inlineSendTarget(REGISTER_ARGS, VM_MAYBE, VM_MAYBE, VM_MAYBE, VM_YES);
    }

    VMINLINE VM_BytecodeAction sendTargetEmptyObjectConstructor(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE UDATA pushVMState(REGISTER_ARGS_LIST, UDATA newState)
    {
    ...
    VMINLINE bool methodIsBreakpointed(J9Method* method)
    {
        return J9_ARE_ANY_BITS_SET((UDATA)method->constantPool, J9_STARTPC_METHOD_BREAKPOINTED);
    }
    VMINLINE bool methodCanBeRunCompiled(J9Method* method)
    {
        return !singleStepEnabled() && !methodIsBreakpointed(method);
    }

    VMINLINE bool countAndCompile(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction initialStaticMethod(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = GOTO_RUN_METHOD;
        ...
        updateVMStruct(REGISTER_ARGS);
        if (split) {
            _sendMethod = resolveStaticSplitMethodRef(
                _currentThread, ramConstantPool, index, J9_RESOLVE_FLAG_RUNTIME_RESOLVE | J9_RESOLVE_FLAG_CHECK_CLINIT);
        } else {
            _sendMethod = resolveStaticMethodRef(
                _currentThread, ramConstantPool, index, J9_RESOLVE_FLAG_RUNTIME_RESOLVE | J9_RESOLVE_FLAG_CHECK_CLINIT);
        }
    ...
    VMINLINE VM_BytecodeAction initialSpecialMethod(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = GOTO_RUN_METHOD;
        ...
        if (split) {
            _sendMethod
                = resolveSpecialSplitMethodRef(_currentThread, ramConstantPool, index, J9_RESOLVE_FLAG_RUNTIME_RESOLVE);
        } else {
            _sendMethod
                = resolveSpecialMethodRef(_currentThread, ramConstantPool, index, J9_RESOLVE_FLAG_RUNTIME_RESOLVE);
        }
        VMStructHasBeenUpdated(REGISTER_ARGS);
        restoreGenericSpecialStackFrame(REGISTER_ARGS);
        if (immediateAsyncPending()) {
    ...
    VMINLINE VM_BytecodeAction initialVirtualMethod(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = GOTO_RUN_METHOD;
        U_16 index = *(U_16*)(_pc + 1);
        J9ConstantPool* ramConstantPool = J9_CP_FROM_METHOD(_literals);
...
#if defined(J9VM_OPT_VALHALLA_NESTMATES)
    VMINLINE VM_BytecodeAction invokePrivateMethod(REGISTER_ARGS_LIST)
    {
        U_16 index = *(U_16*)(_pc + 1);
        J9ConstantPool* ramConstantPool = J9_CP_FROM_METHOD(_literals);
    ...
    VMINLINE VM_BytecodeAction bindNative(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = GOTO_RUN_METHOD;
        ;
        buildMethodFrame(REGISTER_ARGS, _sendMethod, jitStackFrameFlags(REGISTER_ARGS, 0));
        ...
        if (J9_NATIVE_METHOD_BIND_OUT_OF_MEMORY == bindRC) {
            _vm->memoryManagerFunctions->j9gc_modron_global_collect_with_overrides(
                _currentThread, J9MMCONSTANT_EXPLICIT_GC_NATIVE_OUT_OF_MEMORY);
    ...
    VMINLINE VM_BytecodeAction countAndSendJNINative(REGISTER_ARGS_LIST)
    {
        VM_AtomicSupport::lockCompareExchange((UDATA*)&_sendMethod->methodRunAddress,
    ...
    VMINLINE VM_BytecodeAction compileJNINative(REGISTER_ARGS_LIST)
    {
        UDATA methodRunAddress = (UDATA)J9_BCLOOP_ENCODE_SEND_TARGET(J9_BCLOOP_SEND_TARGET_RUN_JNI_NATIVE);
        VM_AtomicSupport::lockCompareExchange((UDATA*)&_sendMethod->methodRunAddress,
            (UDATA)J9_BCLOOP_ENCODE_SEND_TARGET(J9_BCLOOP_SEND_TARGET_COMPILE_JNI_NATIVE), methodRunAddress);
        /* Attempt to compile the method */
    ...
    VMINLINE VM_BytecodeAction runJNINative(REGISTER_ARGS_LIST)
    {
        ...
        bool isSynchronized
            = J9_ARE_ALL_BITS_SET(J9_ROM_METHOD_FROM_RAM_METHOD(_sendMethod)->modifiers, J9AccSynchronized);
         ...
         */
        bp = buildSpecialStackFrame(
            REGISTER_ARGS, J9SF_FRAME_TYPE_JNI_NATIVE_METHOD, jitStackFrameFlags(REGISTER_ARGS, 0), true);
        *--_sp = (UDATA)_sendMethod;
        _arg0EA = &_sp[J9_ROM_METHOD_FROM_RAM_METHOD(_sendMethod)->argCount
            + (sizeof(J9SFNativeMethodFrame) / sizeof(UDATA)) - 1];
        ...
        }
        {
            ...
            if (tracing || enterHooked) {
                ...
                if (enterHooked) {
                    ALWAYS_TRIGGER_J9HOOK_VM_NATIVE_METHOD_ENTER(
                        _vm->hookInterface, _currentThread, _sendMethod, _arg0EA);
                }
                VMStructHasBeenUpdated(REGISTER_ARGS);
                bp = _arg0EA - relativeBP;
                if (immediateAsyncPending()) {
        ...
        ret = callCFunction(
            REGISTER_ARGS, jniMethodStartAddress, receiverAddress, javaArgs, &bp, isStatic, &returnType);
        ...
        /* If there's an exception pending, don't report the method exit event - immediately invoke the exception
         * thrower who will do it. */
        ...
        }
        {
            ...
            if (tracing || exitHooked) {
                ...
                jobject returnRef
                    = (jobject)_currentThread
                          ->returnValue2; /* The JNI send target put the returned ref here in the object case */
                ...
                if (exitHooked) {
                    ALWAYS_TRIGGER_J9HOOK_VM_NATIVE_METHOD_RETURN(
                        _vm->hookInterface, _currentThread, _sendMethod, FALSE, returnValuePtr, returnRef);
                }
                if (returnType == J9NtcObject) {
        ...
        }
        {
            ...
            _currentThread->jitStackFrameFlags
                = nativeMethodFrame->specialFrameFlags & J9_SSF_JIT_NATIVE_TRANSITION_FRAME;
            J9SFStackFrame* frame = (((J9SFStackFrame*)(bp + 1)) - 1);
            _sp = _arg0EA;
            _literals = frame->savedCP;
            _pc = frame->savedPC + 3;
    ...
    VMINLINE FFI_Return callCFunction(REGISTER_ARGS_LIST, void* jniMethodStartAddress, void* receiverAddress,
        UDATA* javaArgs, UDATA** bp, bool isStatic, U_8* returnType)
    {
        ...
        FFI_Return result = cJNICallout(REGISTER_ARGS, receiverAddress, javaArgs, returnType,
            &(_currentThread->returnValue), jniMethodStartAddress, isStatic);
    ...
    static const VMINLINE ffi_type* getFFIType(U_8 j9ntc)
    {
    ...
    VMINLINE FFI_Return cJNICallout(REGISTER_ARGS_LIST, void* receiverAddress, UDATA* javaArgs, U_8* returnType,
        void* returnStorage, void* function, bool isStatic)
    {
...
#if FFI_NATIVE_RAW_API
            values_raw = (ffi_raw*)j9mem_allocate_memory(
                (valRawWorstCaseMulFactor * sizeof(ffi_raw)) * (argCount + extraArgs), OMRMEM_CATEGORY_VM);
            if (NULL == values_raw) {
                goto ffi_exit;
            }
#endif /* FFI_NATIVE_RAW_API */
    ...
    VMINLINE VM_BytecodeAction throwException(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        J9StackWalkState* walkState = _currentThread->stackWalkState;
        updateVMStruct(REGISTER_ARGS);
        /* Toss the pushes in the current stack frame so the GC won't need a description for them and build a special
         * stack frame so we can find classes */
        prepareForExceptionThrow(_currentThread);
        /* Fetch the exception and clear it from the vmThread */
        j9object_t exception = _currentThread->currentException;
        _currentThread->currentException = NULL;
        /* Only report the event if the tag is set - this prevents reporting multiple throws of the same exception when
         * returning from internal call-in */
    ...
    VMINLINE J9RAMConstantPoolItem* ramConstantPoolItem(J9Method*& _literals, U_16 index)
    {
        return (J9RAMConstantPoolItem*)ramConstantPool(_literals) + index;
    }
    VMINLINE J9ROMConstantPoolItem* romConstantPool(J9Method*& _literals)
    {
        return J9_ROM_CP_FROM_CP(ramConstantPool(_literals));
    }
    VMINLINE J9ROMConstantPoolItem* romConstantPoolItem(J9Method*& _literals, U_16 index)
    {
        return romConstantPool(_literals) + index;
    }
    ...
    VMINLINE void returnVoidFromINL(REGISTER_ARGS_LIST, UDATA slotCount)
    {
        _pc += 3;
        _sp += slotCount;
    }

    VMINLINE void returnSingleFromINL(REGISTER_ARGS_LIST, I_32 value, UDATA slotCount)
    {
        _pc += 3;
        _sp += (slotCount - 1);
        *(I_32*)_sp = value;
    ...
    VMINLINE void returnDoubleFromINL(REGISTER_ARGS_LIST, I_64 value, UDATA slotCount)
    {
        _pc += 3;
        _sp += (slotCount - 2);
        *(I_64*)_sp = value;
    ...
    VMINLINE void returnObjectFromINL(REGISTER_ARGS_LIST, j9object_t value, UDATA slotCount)
    {
        _pc += 3;
        _sp += (slotCount - 1);
    ...
    VMINLINE void returnThisFromINL(REGISTER_ARGS_LIST, UDATA slotCount)
    {
        _pc += 3;
        _sp += (slotCount - 1);
    }
    ...
    VMINLINE VM_BytecodeAction inlThreadCurrentThread(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlThreadOnSpinWait(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlThreadInterrupted(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 result = 0;
#if defined(WIN32)
    ...
    VMINLINE VM_BytecodeAction inlObjectGetClass(REGISTER_ARGS_LIST)
    {
        returnObjectFromINL(
            REGISTER_ARGS, J9VM_J9CLASS_TO_HEAPCLASS(J9OBJECT_CLAZZ(_currentThread, *(j9object_t*)_sp)), 1);
        return EXECUTE_BYTECODE;
    }

    /* java.lang.Object: public final native void notify(); */
    /* java.lang.Object: public final native void notifyAll(); */
    VMINLINE VM_BytecodeAction inlObjectNotify(REGISTER_ARGS_LIST, IDATA (*notifyFunction)(omrthread_monitor_t))
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction inlClassIsAssignableFrom(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (NULL == cls) {
            ...
            if (J9ROMCLASS_IS_PRIMITIVE_TYPE(parmClazz->romClass)
                || J9ROMCLASS_IS_PRIMITIVE_TYPE(receiverClazz->romClass)) {
    ...
    VMINLINE VM_BytecodeAction inlClassIsArray(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlClassIsPrimitive(REGISTER_ARGS_LIST)
    {
        J9Class* receiverClazz = J9VM_J9CLASS_FROM_HEAPCLASS(_currentThread, *(j9object_t*)_sp);
    ...
    VMINLINE VM_BytecodeAction inlClassIsInstance(REGISTER_ARGS_LIST)
    {
        I_32 result = 0;
    ...
    VMINLINE VM_BytecodeAction inlClassGetModifiersImpl(REGISTER_ARGS_LIST)
    {
        J9Class* receiverClazz = J9VM_J9CLASS_FROM_HEAPCLASS(_currentThread, *(j9object_t*)_sp);
    ...
    VMINLINE VM_BytecodeAction inlClassGetComponentType(REGISTER_ARGS_LIST)
    {
        J9Class* receiverClazz = J9VM_J9CLASS_FROM_HEAPCLASS(_currentThread, *(j9object_t*)_sp);
    ...
    VMINLINE VM_BytecodeAction inlClassGetSimpleNameImpl(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        J9Class* receiverClazz = J9VM_J9CLASS_FROM_HEAPCLASS(_currentThread, *(j9object_t*)_sp);
        ...
        if (NULL != simpleNameUTF) {
            buildInternalNativeStackFrame(REGISTER_ARGS);
            updateVMStruct(REGISTER_ARGS);
            simpleName = _vm->memoryManagerFunctions->j9gc_createJavaLangString(
                _currentThread, J9UTF8_DATA(simpleNameUTF), J9UTF8_LENGTH(simpleNameUTF), 0);
            VMStructHasBeenUpdated(REGISTER_ARGS);
    ...
    /* java.lang.System: public static native void arraycopy(Object src, int srcPos, Object dest, int destPos, int
     * length); */
    VMINLINE VM_BytecodeAction inlSystemArraycopy(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
                ...
                if (!J9ROMCLASS_IS_ARRAY(destRom)) {
                    ...
                    if (OBJECT_HEADER_SHAPE_POINTERS == J9CLASS_SHAPE(srcClass)) {
                        ...
                        if (srcClass != destClass) {
                            ...
                            rc = doPrimitiveArrayCopy(REGISTER_ARGS, src, srcPos, dest, destPos,
                                ((J9ROMArrayClass*)srcClass->romClass)->arrayShape & 0x0000FFFF, length);
                        }
                    }
                }
            } else {
    ...
    VMINLINE VM_BytecodeAction inlSystemCurrentTimeMillis(REGISTER_ARGS_LIST)
    {
        PORT_ACCESS_FROM_JAVAVM(_vm);
    ...
    VMINLINE VM_BytecodeAction inlSystemNanoTime(REGISTER_ARGS_LIST)
    {
        PORT_ACCESS_FROM_JAVAVM(_vm);
    ...
    VMINLINE VM_BytecodeAction inlInternalsGetSuperclass(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction inlInternalsIdentityHashCode(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlStringIntern(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction inlThrowableFillInStackTrace(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (0 == (_vm->runtimeFlags & J9_RUNTIME_OMIT_STACK_TRACES)) {
             ...
             */
            if (VM_VMHelpers::vmConstantPoolFieldIsResolved(
                    _vm, J9VMCONSTANTPOOL_JAVALANGTHROWABLE_ENABLEWRITABLESTACKTRACE)
                ...
                J9StackWalkState* walkState = _currentThread->stackWalkState;
                UDATA walkFlags = J9_STACKWALK_CACHE_PCS | J9_STACKWALK_WALK_TRANSLATE_PC | J9_STACKWALK_VISIBLE_ONLY
                 ...
                 */
                if ((NULL == walkback)
                    || (0 == (_currentThread->privateFlags & J9_PRIVATE_FLAGS_FILL_EXISTING_TRACE))) {
#if defined(J9VM_ENV_DATA64)
    ...
    /* java.lang.J9VMInternals: native static Object newInstanceImpl(Class clazz) throws IllegalAccessException,
     * InstantiationException; */
    VMINLINE VM_BytecodeAction inlInternalsNewInstanceImpl(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t clazz = *(j9object_t*)_sp;
        ...
        /* The cache is only filled in for public constructors, and only if the class can be instantiated and is
         * initialized */
        ...
        if (NULL == method) {
            ...
            if (J9_UNEXPECTED(!VM_VMHelpers::classCanBeInstantiated(j9clazz))) {
                updateVMStruct(REGISTER_ARGS);
                setCurrentException(
                    _currentThread, J9_EX_CTOR_CLASS | J9VMCONSTANTPOOL_JAVALANGINSTANTIATIONEXCEPTION, (UDATA*)clazz);
                VMStructHasBeenUpdated(REGISTER_ARGS);
                rc = GOTO_THROW_CURRENT_EXCEPTION;
                goto done;
            }
            ...
            if (TRUE == (UDATA)walkState->userData3) {
                setCurrentExceptionNLS(_currentThread, J9VMCONSTANTPOOL_JAVALANGINTERNALERROR,
                    J9NLS_VM_CALLER_NOT_ANNOTATED_AS_CALLERSENSITIVE);
                VMStructHasBeenUpdated(REGISTER_ARGS);
                rc = GOTO_THROW_CURRENT_EXCEPTION;
                goto done;
            }
            ...
            if (NULL != senderClass) {
                IDATA checkResult = checkVisibility(
                    _currentThread, senderClass, j9clazz, j9clazz->romClass->modifiers, J9_LOOK_REFLECT_CALL);
                VMStructHasBeenUpdated(REGISTER_ARGS);
        ...
        /* If the method is known and empty, just do the post-construction finalize check instead of calling in to send
         * the method */
     ...
     */
    VMINLINE VM_BytecodeAction inlInternalsPrimitiveClone(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (flags & J9AccClassArray) {
            ...
            copy
                = _objectAllocate.inlineAllocateIndexableObject(_currentThread, objectClass, size, false, false, false);
            if (NULL == copy) {
                pushObjectInSpecialFrame(REGISTER_ARGS, original);
                updateVMStruct(REGISTER_ARGS);
                copy = _vm->memoryManagerFunctions->J9AllocateIndexableObject(
                    _currentThread, objectClass, size, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                VMStructHasBeenUpdated(REGISTER_ARGS);
            ...
            if (NULL == copy) {
                pushObjectInSpecialFrame(REGISTER_ARGS, original);
                updateVMStruct(REGISTER_ARGS);
                copy = _vm->memoryManagerFunctions->J9AllocateObject(
                    _currentThread, objectClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                VMStructHasBeenUpdated(REGISTER_ARGS);
                original = popObjectInSpecialFrame(REGISTER_ARGS);
                if (J9_UNEXPECTED(NULL == copy)) {
                    rc = THROW_HEAP_OOM;
    ...
    VMINLINE VM_BytecodeAction inlReferenceGetImpl(REGISTER_ARGS_LIST)
    {
        /* Only called from java for metronome GC policy */
        j9object_t referent
            = _vm->memoryManagerFunctions->j9gc_objaccess_referenceGet(_currentThread, *(j9object_t*)_sp);
        returnObjectFromINL(REGISTER_ARGS, referent, 1);
        return EXECUTE_BYTECODE;
    }

    VMINLINE VM_BytecodeAction unsafePutEpilogue(REGISTER_ARGS_LIST, UDATA argCount)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction unsafeGetEpilogue(REGISTER_ARGS_LIST, I_64 value, UDATA argCount, bool returnDouble)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction inlUnsafeAllocateInstance(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (!VM_VMHelpers::classCanBeInstantiated(clazz)) {
            updateVMStruct(REGISTER_ARGS);
            setCurrentException(_currentThread, J9_EX_CTOR_CLASS | J9VMCONSTANTPOOL_JAVALANGINSTANTIATIONEXCEPTION,
                (UDATA*)classObject);
            VMStructHasBeenUpdated(REGISTER_ARGS);
            rc = GOTO_THROW_CURRENT_EXCEPTION;
            goto done;
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetByteNative(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetByte(REGISTER_ARGS_LIST, bool isVolatile)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutByteNative(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutByte(REGISTER_ARGS_LIST, bool isVolatile)
    {
        I_8 value = (I_8) * (I_32*)_sp;
        UDATA offset = (UDATA) * (I_64*)(_sp + 1);
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetBoolean(REGISTER_ARGS_LIST, bool isVolatile)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        j9object_t obj = *(j9object_t*)(_sp + 2);
        U_8 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutBoolean(REGISTER_ARGS_LIST, bool isVolatile)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetShortNative(REGISTER_ARGS_LIST)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        I_16 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetShort(REGISTER_ARGS_LIST, bool isVolatile)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        j9object_t obj = *(j9object_t*)(_sp + 2);
        I_16 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutShortNative(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutShort(REGISTER_ARGS_LIST, bool isVolatile)
    {
        I_16 value = (I_16) * (I_32*)_sp;
        UDATA offset = (UDATA) * (I_64*)(_sp + 1);
        j9object_t obj = *(j9object_t*)(_sp + 3);
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetCharNative(REGISTER_ARGS_LIST)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        U_16 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetChar(REGISTER_ARGS_LIST, bool isVolatile)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        j9object_t obj = *(j9object_t*)(_sp + 2);
        U_16 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutCharNative(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutChar(REGISTER_ARGS_LIST, bool isVolatile)
    {
        U_16 value = (U_16) * (I_32*)_sp;
        UDATA offset = (UDATA) * (I_64*)(_sp + 1);
        j9object_t obj = *(j9object_t*)(_sp + 3);
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetIntNative(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetInt(REGISTER_ARGS_LIST, bool isVolatile)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        j9object_t obj = *(j9object_t*)(_sp + 2);
        I_32 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutIntNative(REGISTER_ARGS_LIST)
    {
        I_32 value = *(I_32*)_sp;
        UDATA offset = (UDATA) * (I_64*)(_sp + 1);
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutInt(REGISTER_ARGS_LIST, bool isVolatile)
    {
        I_32 value = *(I_32*)_sp;
        UDATA offset = (UDATA) * (I_64*)(_sp + 1);
        j9object_t obj = *(j9object_t*)(_sp + 3);
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetFloatNative(REGISTER_ARGS_LIST)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        U_32 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetFloat(REGISTER_ARGS_LIST, bool isVolatile)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        j9object_t obj = *(j9object_t*)(_sp + 2);
        U_32 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutFloatNative(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutFloat(REGISTER_ARGS_LIST, bool isVolatile)
    {
        U_32 value = (U_32) * (I_32*)_sp;
        UDATA offset = (UDATA) * (I_64*)(_sp + 1);
        j9object_t obj = *(j9object_t*)(_sp + 3);
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetLongNative(REGISTER_ARGS_LIST)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        I_64 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetLong(REGISTER_ARGS_LIST, bool isVolatile)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        j9object_t obj = *(j9object_t*)(_sp + 2);
        I_64 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutLongNative(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutLong(REGISTER_ARGS_LIST, bool isVolatile)
    {
        I_64 value = (I_64) * (I_64*)_sp;
        UDATA offset = (UDATA) * (I_64*)(_sp + 2);
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetDoubleNative(REGISTER_ARGS_LIST)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        U_64 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetDouble(REGISTER_ARGS_LIST, bool isVolatile)
    {
        UDATA offset = (UDATA) * (I_64*)_sp;
        j9object_t obj = *(j9object_t*)(_sp + 2);
        U_64 value = 0;
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutDoubleNative(REGISTER_ARGS_LIST)
    {
        I_64 value = (I_64) * (I_64*)_sp;
        UDATA offset = (UDATA) * (I_64*)(_sp + 2);
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutDouble(REGISTER_ARGS_LIST, bool isVolatile)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetObject(REGISTER_ARGS_LIST, bool isVolatile)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        UDATA offset = (UDATA) * (I_64*)_sp;
        j9object_t obj = *(j9object_t*)(_sp + 2);
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutObject(REGISTER_ARGS_LIST, bool isVolatile)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction inlUnsafeGetAddress(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafePutAddress(REGISTER_ARGS_LIST)
    {
        I_64 value = *(I_64*)_sp;
    ...
    VMINLINE VM_BytecodeAction inlUnsafeArrayBaseOffset(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t classObject = *(j9object_t*)_sp;
        if (NULL == classObject) {
    ...
    VMINLINE VM_BytecodeAction inlUnsafeArrayIndexScale(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t classObject = *(j9object_t*)_sp;
        if (NULL == classObject) {
    ...
    VMINLINE VM_BytecodeAction inlUnsafeAddressSize(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafeLoadFence(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction inlUnsafeStoreFence(REGISTER_ARGS_LIST)
    {
    ...
    /* sun.misc.Unsafe: public final native boolean compareAndSwapObject(java.lang.Object obj, long offset,
     * java.lang.Object compareValue, java.lang.Object swapValue); */
    VMINLINE VM_BytecodeAction inlUnsafeCompareAndSwapObject(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        buildInternalNativeStackFrame(REGISTER_ARGS);
        updateVMStruct(REGISTER_ARGS);
        bool value = VM_UnsafeAPI::compareAndSwapObject(
            _currentThread, &_objectAccessBarrier, obj, offset, compareValue, swapValue);
        restoreInternalNativeStackFrame(REGISTER_ARGS);
    ...
    /* sun.misc.Unsafe: public final native boolean compareAndSwapLong(java.lang.Object obj, long offset, long
     * compareValue, long swapValue); */
    VMINLINE VM_BytecodeAction inlUnsafeCompareAndSwapLong(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        buildInternalNativeStackFrame(REGISTER_ARGS);
        updateVMStruct(REGISTER_ARGS);
        bool value = VM_UnsafeAPI::compareAndSwapLong(
            _currentThread, &_objectAccessBarrier, obj, offset, compareValue, swapValue);
        restoreInternalNativeStackFrame(REGISTER_ARGS);
    ...
    /* sun.misc.Unsafe: public final native boolean compareAndSwapInt(java.lang.Object obj, long offset, int
     * compareValue, int swapValue); */
    VMINLINE VM_BytecodeAction inlUnsafeCompareAndSwapInt(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        buildInternalNativeStackFrame(REGISTER_ARGS);
        updateVMStruct(REGISTER_ARGS);
        bool value = VM_UnsafeAPI::compareAndSwapInt(
            _currentThread, &_objectAccessBarrier, obj, offset, compareValue, swapValue);
        restoreInternalNativeStackFrame(REGISTER_ARGS);
    ...
    VMINLINE VM_BytecodeAction inlInternalsPrepareClassImpl(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t clazz = *(j9object_t*)_sp;
        buildInternalNativeStackFrame(REGISTER_ARGS);
    ...
    VMINLINE VM_BytecodeAction inlInternalsGetInterfaces(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t clazz = *(j9object_t*)_sp;
        buildInternalNativeStackFrame(REGISTER_ARGS);
    ...
    VMINLINE VM_BytecodeAction inlArrayNewArrayImpl(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (J9ROMCLASS_IS_ARRAY(componentType->romClass)
            ...
            /* The spec says to throw this exception if the number of dimensions is greater than
             * J9_ARRAY_DIMENSION_LIMIT */
            updateVMStruct(REGISTER_ARGS);
            prepareForExceptionThrow(_currentThread);
            setCurrentExceptionUTF(_currentThread, J9VMCONSTANTPOOL_JAVALANGILLEGALARGUMENTEXCEPTION, NULL);
            VMStructHasBeenUpdated(REGISTER_ARGS);
        ...
        if (NULL == arrayClass) {
            ...
            arrayClass = internalCreateArrayClass(
                _currentThread, (J9ROMArrayClass*)J9ROMIMAGEHEADER_FIRSTCLASS(romHeader), componentType);
            VMStructHasBeenUpdated(REGISTER_ARGS);
            if (VM_VMHelpers::exceptionPending(_currentThread)) {
                rc = GOTO_THROW_CURRENT_EXCEPTION;
                goto done;
    ...
    VMINLINE VM_BytecodeAction inlClassLoaderFindLoadedClassImpl(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (NULL != className) {
            ...
            if (NULL != loader) {
                if (CLASSNAME_INVALID != verifyQualifiedName(_currentThread, className)) {
                    buildInternalNativeStackFrame(REGISTER_ARGS);
                    updateVMStruct(REGISTER_ARGS);
                    j9Class = internalFindClassString(
                        _currentThread, NULL, className, loader, J9_FINDCLASS_FLAG_EXISTING_ONLY);
                    VMStructHasBeenUpdated(REGISTER_ARGS);
                    if (VM_VMHelpers::exceptionPending(_currentThread)) {
                        rc = GOTO_THROW_CURRENT_EXCEPTION;
                        goto done;
    ...
    VMINLINE VM_BytecodeAction inlVMGetStackClassLoader(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 depth = *(I_32*)_sp;
    ...
    VMINLINE VM_BytecodeAction inlVMFindClassOrNull(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (CLASSNAME_VALID_NON_ARRARY == verifyQualifiedName(_currentThread, className)) {
            updateVMStruct(REGISTER_ARGS);
            j9Class = internalFindClassString(
                _currentThread, NULL, className, loader, J9_FINDCLASS_FLAG_USE_LOADER_CP_ENTRIES);
            VMStructHasBeenUpdated(REGISTER_ARGS);
            if (VM_VMHelpers::exceptionPending(_currentThread)) {
    ...
    /* java.lang.ClassLoader: static final native void initAnonClassLoader(InternalAnonymousClassLoader
     * anonClassLoader); */
    VMINLINE VM_BytecodeAction inlInitializeAnonClassLoader(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    /* com.ibm.oti.vm.VM: public static final native void initializeClassLoader(ClassLoader classLoader, int loaderType,
     * boolean parallelCapable); */
    VMINLINE VM_BytecodeAction inlVMInitializeClassLoader(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    /* com.ibm.oti.vm.VM: public static final native int getClassPathEntryType(java.lang.ClassLoader classLoader, int
     * cpIndex); */
    VMINLINE VM_BytecodeAction inlVMGetClassPathEntryType(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction inlVMIsBootstrapClassLoader(REGISTER_ARGS_LIST)
    {
        I_32 isBoot = 0;
        j9object_t classLoaderObject = *(j9object_t*)_sp;
        if (NULL == classLoaderObject) {
    ...
    /* java.lang.Class: private static native Class forNameImpl(String className, boolean initializeBoolean, ClassLoader
     * classLoader) throws ClassNotFoundException; */
    VMINLINE VM_BytecodeAction inlClassForNameImpl(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t classLoaderObject = *(j9object_t*)_sp;
        ...
        if (NULL == foundClass) {
            ...
            throwCNFE:
                updateVMStruct(REGISTER_ARGS);
                setCurrentException(
                    _currentThread, J9VMCONSTANTPOOL_JAVALANGCLASSNOTFOUNDEXCEPTION, (UDATA*)classNameObject);
                VMStructHasBeenUpdated(REGISTER_ARGS);
            }
            rc = GOTO_THROW_CURRENT_EXCEPTION;
            goto done;
    ...
    VMINLINE VM_BytecodeAction inlVMGetCPIndexImpl(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    /* com.ibm.tools.attach.target.Attachment: private native int loadAgentLibraryImpl(ClassLoader loader, String
     * agentLibrary, String options, boolean decorate); */
    VMINLINE VM_BytecodeAction inlAttachmentLoadAgentLibraryImpl(REGISTER_ARGS_LIST)
    {
        UDATA decorate = *(I_32*)_sp;
        jstring agentOptions = (jstring)(_sp + 1);
        jstring agentLibrary = (jstring)(_sp + 2);
        UDATA* bp = buildSpecialStackFrame(REGISTER_ARGS, J9SF_FRAME_TYPE_JNI_NATIVE_METHOD,
            jitStackFrameFlags(REGISTER_ARGS, J9_STACK_FLAGS_USE_SPECIFIED_CLASS_LOADER), true);
        *--_sp = (UDATA)_sendMethod;
        _arg0EA = bp + 5;
        updateVMStruct(REGISTER_ARGS);
    ...
    VMINLINE VM_BytecodeAction inlVMGetStackClass(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 depth = *(I_32*)_sp;
    ...
    VMINLINE VM_BytecodeAction inlThreadSleep(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 nanos = *(I_32*)_sp;
    ...
    VMINLINE VM_BytecodeAction inlObjectWait(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 nanos = *(I_32*)_sp;
        I_64 millis = *(I_64*)(_sp + 1);
    ...
    /* java.lang.ClassLoader: static private native byte[] loadLibraryWithPath(byte[] libName, ClassLoader loader,
     * byte[] libraryPath); */
    VMINLINE VM_BytecodeAction inlClassLoaderLoadLibraryWithPath(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction inlThreadIsInterruptedImpl(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction outOfLineINL(REGISTER_ARGS_LIST)
    {
        updateVMStruct(REGISTER_ARGS);
        J9OutOfLineINLMethod* target
            = (J9OutOfLineINLMethod*)(((UDATA)_sendMethod->extra) & ~J9_STARTPC_NOT_TRANSLATED);
    ...
    /* ... => ... */
    VMINLINE VM_BytecodeAction nop(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        return EXECUTE_BYTECODE;
    }
    ...
    /* ... => ..., value */
    VMINLINE VM_BytecodeAction aconst(REGISTER_ARGS_LIST, UDATA value)
    {
        _pc += 1;
        _sp -= 1;
        *_sp = value;
    ...
    /* ... => ..., value */
    VMINLINE VM_BytecodeAction iconst(REGISTER_ARGS_LIST, I_32 value)
    {
        _pc += 1;
        _sp -= 1;
        *(I_32*)_sp = value;
    ...
    /* ... => ..., value1, value2 */
    VMINLINE VM_BytecodeAction lconst(REGISTER_ARGS_LIST, I_64 value)
    {
        _pc += 1;
        _sp -= 2;
        *(I_64*)_sp = value;
    ...
    /* ... => ..., value */
    VMINLINE VM_BytecodeAction bipush(REGISTER_ARGS_LIST)
    {
        I_32 val = *(I_8*)(_pc + 1);
        _pc += 2;
        _sp -= 1;
    ...
    /* ... => ..., value */
    VMINLINE VM_BytecodeAction sipush(REGISTER_ARGS_LIST)
    {
        I_32 val = *(I_16*)(_pc + 1);
        _pc += 3;
        _sp -= 1;
    ...
    /* ... => ..., value1, value2 */
    VMINLINE VM_BytecodeAction ldc2lw(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_16 index = *(U_16*)(_pc + 1);
        J9ConstantPool* ramConstantPool = J9_CP_FROM_METHOD(_literals);
        ...
        if (J9CPTYPE_CONSTANT_DYNAMIC
            == J9_CP_TYPE(J9ROMCLASS_CPSHAPEDESCRIPTION(J9_CLASS_FROM_METHOD(_literals)->romClass), index)) {
    ...
    /* ... => ..., value */
    VMINLINE VM_BytecodeAction aload(REGISTER_ARGS_LIST)
    {
        U_8 index = _pc[1];
        _pc += 2;
        _sp -= 1;
    ...
    /* ... => ..., value */
    VMINLINE VM_BytecodeAction aload(REGISTER_ARGS_LIST, UDATA index)
    {
        _pc += 1;
        _sp -= 1;
        *_sp = *(_arg0EA - index);
    ...
    /* ..., value => ... */
    VMINLINE VM_BytecodeAction astore(REGISTER_ARGS_LIST)
    {
        U_8 index = _pc[1];
        _pc += 2;
        *(_arg0EA - index) = *_sp;
    ...
    /* ..., value => ... */
    VMINLINE VM_BytecodeAction astore(REGISTER_ARGS_LIST, UDATA index)
    {
        _pc += 1;
        *(_arg0EA - index) = *_sp;
        _sp += 1;
    ...
    /* ... => ..., value1, value2 */
    VMINLINE VM_BytecodeAction lload(REGISTER_ARGS_LIST)
    {
        U_8 index = _pc[1];
        _pc += 2;
        _sp -= 2;
    ...
    /* ... => ..., value1, value2 */
    VMINLINE VM_BytecodeAction lload(REGISTER_ARGS_LIST, UDATA index)
    {
        _pc += 1;
        _sp -= 2;
        _sp[0] = *(_arg0EA - index - 1);
    ...
    /* ..., value1, value2 => ... */
    VMINLINE VM_BytecodeAction lstore(REGISTER_ARGS_LIST)
    {
        U_8 index = _pc[1];
        _pc += 2;
    ...
    /* ..., value1, value2 => ... */
    VMINLINE VM_BytecodeAction lstore(REGISTER_ARGS_LIST, UDATA index)
    {
        _pc += 1;
        *(_arg0EA - index - 1) = _sp[0];
#if !defined(J9VM_ENV_DATA64)
    ...
    /* ..., value1...valueN => ... */
    VMINLINE VM_BytecodeAction pop(REGISTER_ARGS_LIST, UDATA slots)
    {
        _pc += 1;
        _sp += slots;
        return EXECUTE_BYTECODE;
    ...
    /* ..., value => ..., value, value */
    VMINLINE VM_BytecodeAction dup(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        _sp -= 1;
        _sp[0] = _sp[1];
    ...
    VMINLINE VM_BytecodeAction dupx1(REGISTER_ARGS_LIST)
    {
        UDATA value1 = _sp[0];
        UDATA value2 = _sp[1];
        _pc += 1;
    ...
    VMINLINE VM_BytecodeAction dupx2(REGISTER_ARGS_LIST)
    {
        UDATA value1 = _sp[0];
        UDATA value2 = _sp[1];
        UDATA value3 = _sp[2];
    ...
    VMINLINE VM_BytecodeAction dup2(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        _sp -= 2;
        _sp[0] = _sp[2];
    ...
    VMINLINE VM_BytecodeAction dup2x1(REGISTER_ARGS_LIST)
    {
        UDATA value1 = _sp[0];
        UDATA value2 = _sp[1];
        UDATA value3 = _sp[2];
    ...
    VMINLINE VM_BytecodeAction dup2x2(REGISTER_ARGS_LIST)
    {
        UDATA value1 = _sp[0];
        UDATA value2 = _sp[1];
        UDATA value3 = _sp[2];
    ...
    VMINLINE VM_BytecodeAction swap(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        UDATA temp = _sp[1];
        _sp[1] = _sp[0];
    ...
    /* ..., lhs, rhs => ..., result */
    VMINLINE VM_BytecodeAction iadd(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_32*)(_sp + 1) += *(I_32*)_sp;
        _sp += 1;
    ...
    VMINLINE VM_BytecodeAction ladd(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *((I_64*)(_sp + 2)) += *(I_64*)_sp;
        _sp += 2;
    ...
    /* ..., lhs, rhs => ..., result */
    VMINLINE VM_BytecodeAction fadd(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., lhs1, lhs2, rhs1, rhs2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction dadd(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., lhs, rhs => ..., result */
    VMINLINE VM_BytecodeAction isub(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_32*)(_sp + 1) -= *(I_32*)_sp;
        _sp += 1;
    ...
    /* ..., lhs1, lhs2, rhs1, rhs2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction lsub(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_64*)(_sp + 2) -= *(I_64*)_sp;
        _sp += 2;
    ...
    /* ..., lhs, rhs => ..., result */
    VMINLINE VM_BytecodeAction fsub(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., lhs1, lhs2, rhs1, rhs2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction dsub(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    VMINLINE VM_BytecodeAction imul(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_32*)(_sp + 1) *= *(I_32*)_sp;
        _sp += 1;
    ...
    /* ..., lhs1, lhs2, rhs1, rhs2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction lmul(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_64*)(_sp + 2) *= *(I_64*)_sp;
        _sp += 2;
    ...
    /* ..., lhs, rhs => ..., result */
    VMINLINE VM_BytecodeAction fmul(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., lhs1, lhs2, rhs1, rhs2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction dmul(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    VMINLINE VM_BytecodeAction fdiv(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    VMINLINE VM_BytecodeAction ddiv(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., dividend, divisor => ..., result */
    VMINLINE VM_BytecodeAction frem(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., dividend1, dividend2, divisor1, divisor2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction drem(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value => ..., result */
    VMINLINE VM_BytecodeAction ineg(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_32*)_sp = -*(I_32*)_sp;
        return EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction lneg(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_64*)_sp = -*(I_64*)_sp;
        return EXECUTE_BYTECODE;
    ...
    /* ..., value => ..., result */
    VMINLINE VM_BytecodeAction fneg(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value1, value2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction dneg(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value, shift => ..., result */
    VMINLINE VM_BytecodeAction ishl(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    VMINLINE VM_BytecodeAction lshl(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value, shift => ..., result */
    VMINLINE VM_BytecodeAction ishr(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_32*)(_sp + 1) >>= (*(U_32*)_sp & 31);
        _sp += 1;
    ...
    /* ..., value1, value2, shift => ..., result1, result2 */
    VMINLINE VM_BytecodeAction lshr(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_64*)(_sp + 1) >>= (*(U_32*)_sp & 63);
        _sp += 1;
    ...
    /* ..., value, shift => ..., result */
    VMINLINE VM_BytecodeAction iushr(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value1, value2, shift => ..., result1, result2 */
    VMINLINE VM_BytecodeAction lushr(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value1, value2 => ..., result */
    VMINLINE VM_BytecodeAction iand(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_32*)(_sp + 1) &= *(I_32*)_sp;
        _sp += 1;
    ...
    VMINLINE VM_BytecodeAction land(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_64*)(_sp + 2) &= *(I_64*)_sp;
        _sp += 2;
    ...
    /* ..., value1, value2 => ..., result */
    VMINLINE VM_BytecodeAction ior(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_32*)(_sp + 1) |= *(I_32*)_sp;
        _sp += 1;
    ...
    /* ..., value1, value2, value3, value4 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction lor(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_64*)(_sp + 2) |= *(I_64*)_sp;
        _sp += 2;
    ...
    /* ..., value1, value2 => ..., result */
    VMINLINE VM_BytecodeAction ixor(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_32*)(_sp + 1) ^= *(I_32*)_sp;
        _sp += 1;
    ...
    /* ..., value1, value2, value3, value4 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction lxor(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        *(I_64*)(_sp + 2) ^= *(I_64*)_sp;
        _sp += 2;
    ...
    /* ... => ... */
    VMINLINE VM_BytecodeAction iinc(REGISTER_ARGS_LIST, UDATA parmSize)
    {
        U_16 index = 0;
        I_16 val = 0;
        if (parmSize == 1) {
    ...
    VMINLINE VM_BytecodeAction i2l(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        _sp -= 1;
        *(I_64*)_sp = *(I_32*)(_sp + 1);
    ...
    /* ..., value => ..., result */
    VMINLINE VM_BytecodeAction i2f(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value => ..., result1, result2 */
    VMINLINE VM_BytecodeAction i2d(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        _sp -= 1;
    ...
    /* ..., value1, value2 => ..., result */
    VMINLINE VM_BytecodeAction l2i(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value1, value2 => ..., result */
    VMINLINE VM_BytecodeAction l2f(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value1, value2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction l2d(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value => ..., result */
    VMINLINE VM_BytecodeAction f2i(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value => ..., result1, result2 */
    VMINLINE VM_BytecodeAction f2l(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        _sp -= 1;
    ...
    /* ..., value => ..., result1, result2 */
    VMINLINE VM_BytecodeAction f2d(REGISTER_ARGS_LIST)
    {
        _pc += 1;
        _sp -= 1;
    ...
    /* ..., value1, value2 => ..., result */
    VMINLINE VM_BytecodeAction d2i(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value1, value2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction d2l(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value1, value2 => ..., result */
    VMINLINE VM_BytecodeAction d2f(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value => ..., result */
    VMINLINE VM_BytecodeAction i2b(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value => ..., result */
    VMINLINE VM_BytecodeAction i2c(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    /* ..., value => ..., result */
    VMINLINE VM_BytecodeAction i2s(REGISTER_ARGS_LIST)
    {
        _pc += 1;
    ...
    VMINLINE VM_BytecodeAction lcmp(REGISTER_ARGS_LIST)
    {
        I_64 rhs = *(I_64*)_sp;
        I_64 lhs = *(I_64*)(_sp + 2);
        _pc += 1;
    ...
    /* ..., lhs, rhs => ..., result */
    VMINLINE VM_BytecodeAction fcmp(REGISTER_ARGS_LIST, I_32 nanValue)
    {
    ...
    VMINLINE VM_BytecodeAction dcmp(REGISTER_ARGS_LIST, I_32 nanValue)
    {
    ...
    VMINLINE VM_BytecodeAction iaload(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    /* ..., arrayref, index, value => ... */
    VMINLINE VM_BytecodeAction iastore(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    /* ..., arrayref, index => ..., value */
    VMINLINE VM_BytecodeAction faload(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 1);
        if (NULL == arrayref) {
    ...
    /* ..., arrayref, index, value => ... */
    VMINLINE VM_BytecodeAction fastore(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 2);
        if (NULL == arrayref) {
    ...
    /* ..., arrayref, index => ..., value */
    VMINLINE VM_BytecodeAction laload(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 1);
        if (NULL == arrayref) {
    ...
    VMINLINE VM_BytecodeAction lastore(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    /* ..., arrayref, index => ..., value */
    VMINLINE VM_BytecodeAction daload(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 1);
        if (NULL == arrayref) {
    ...
    /* ..., arrayref, index, value1, value2 => ... */
    VMINLINE VM_BytecodeAction dastore(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 3);
        if (NULL == arrayref) {
    ...
    /* ..., arrayref, index => ..., value */
    VMINLINE VM_BytecodeAction baload(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 1);
        if (NULL == arrayref) {
    ...
    /* ..., arrayref, index, value => ... */
    VMINLINE VM_BytecodeAction bastore(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 2);
        if (NULL == arrayref) {
    ...
    /* ..., arrayref, index => ..., value */
    VMINLINE VM_BytecodeAction caload(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 1);
        if (NULL == arrayref) {
    ...
    /* ..., arrayref, index, value => ... */
    VMINLINE VM_BytecodeAction castore(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 2);
        if (NULL == arrayref) {
    ...
    /* ..., arrayref, index => ..., value */
    VMINLINE VM_BytecodeAction saload(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 1);
        if (NULL == arrayref) {
    ...
    /* ..., arrayref, index, value => ... */
    VMINLINE VM_BytecodeAction sastore(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 2);
        if (NULL == arrayref) {
    ...
    /* ..., arrayref, index => ..., value */
    VMINLINE VM_BytecodeAction aaload(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 1);
        if (NULL == arrayref) {
            ...
            if (index >= arrayLength) {
                ...
                j9object_t value
                    = _objectAccessBarrier.inlineIndexableObjectReadObject(_currentThread, arrayref, index);
                _pc += 1;
                _sp += 1;
                *(j9object_t*)_sp = value;
            }
    ...
    /* ..., arrayref, index, value => ... */
    VMINLINE VM_BytecodeAction aastore(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t arrayref = *(j9object_t*)(_sp + 2);
        if (NULL == arrayref) {
    ...
    /* ... => ..., value */
    VMINLINE VM_BytecodeAction aloadw(REGISTER_ARGS_LIST)
    {
        U_16 index = *(U_16*)(_pc + 1);
        _pc += 4;
        _sp -= 1;
    ...
    /* ... => ..., value1, value2 */
    VMINLINE VM_BytecodeAction lloadw(REGISTER_ARGS_LIST)
    {
        U_16 index = *(U_16*)(_pc + 1);
        _pc += 4;
        _sp -= 2;
    ...
    /* ..., value => ... */
    VMINLINE VM_BytecodeAction astorew(REGISTER_ARGS_LIST)
    {
        U_16 index = *(U_16*)(_pc + 1);
        _pc += 4;
        *(_arg0EA - index) = *_sp;
    ...
    /* ..., value1, value2 => ... */
    VMINLINE VM_BytecodeAction lstorew(REGISTER_ARGS_LIST)
    {
        U_16 index = *(U_16*)(_pc + 1);
        _pc += 4;
        *(_arg0EA - index - 1) = _sp[0];
    ...
    /* ..., dividend, divisor => ..., result */
    VMINLINE VM_BytecodeAction idiv(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    /* ..., dividend1, dividend2, divisor1, divisor2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction ldiv(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    /* ..., dividend, divisor => ..., result */
    VMINLINE VM_BytecodeAction irem(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 divisor = *(I_32*)_sp;
        I_32 dividend = *(I_32*)(_sp + 1);
    ...
    /* ..., dividend1, dividend2, divisor1, divisor2 => ..., result1, result2 */
    VMINLINE VM_BytecodeAction lrem(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_64 divisor = *(I_64*)_sp;
        I_64 dividend = *(I_64*)(_sp + 2);
    ...
    /* ..., objectref => ..., length */
    VMINLINE VM_BytecodeAction arraylength(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction returnSlotsImpl(REGISTER_ARGS_LIST, UDATA slots)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
#if defined(DO_HOOKS)
        UDATA* bp = NULL;
    ...
    /* <0, 1 or 2 slot value> => empty */
    VMINLINE VM_BytecodeAction syncReturn(REGISTER_ARGS_LIST, UDATA slots)
    {
    ...
    /* <0, 1 or 2 slot value> => empty */
    VMINLINE VM_BytecodeAction returnSlots(REGISTER_ARGS_LIST, UDATA slots)
    {
        return returnSlotsImpl(REGISTER_ARGS, slots);
    }

    /* empty => empty */
    VMINLINE VM_BytecodeAction returnFromConstructor(REGISTER_ARGS_LIST)
    {
        VM_AtomicSupport::writeBarrier();
        return returnSlotsImpl(REGISTER_ARGS, 0);
    }

    VMINLINE VM_BytecodeAction returnC(REGISTER_ARGS_LIST)
    {
        *(I_32*)_sp = (U_16) * (I_32*)_sp;
        return returnSlots(REGISTER_ARGS, 1);
    }

    VMINLINE VM_BytecodeAction returnS(REGISTER_ARGS_LIST)
    {
        *(I_32*)_sp = (I_16) * (I_32*)_sp;
        return returnSlots(REGISTER_ARGS, 1);
    }

    VMINLINE VM_BytecodeAction returnB(REGISTER_ARGS_LIST)
    {
        *(I_32*)_sp = (I_8) * (I_32*)_sp;
        return returnSlots(REGISTER_ARGS, 1);
    }

    VMINLINE VM_BytecodeAction returnZ(REGISTER_ARGS_LIST)
    {
        *(U_32*)_sp = 1 & *(U_32*)_sp;
        return returnSlots(REGISTER_ARGS, 1);
    }
    ...
    /* ... => ..., value */
    VMINLINE VM_BytecodeAction ldc(REGISTER_ARGS_LIST, UDATA parmSize)
    {
    retry:
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_16 index = 0;
        ...
        if (J9_UNEXPECTED(NULL == value)) {
            ...
            case J9DescriptionCpTypeConstantDynamic:
                if (((J9RAMConstantDynamicRef*)ramCPEntry)->exception == _vm->voidReflectClass->classObject) {
                    /* Void.class placed in the exception slot represents a valid null reference returned from
                     * resolution directly restore the special frame and return the null reference
                     */
                    restoreGenericSpecialStackFrame(REGISTER_ARGS);
                    goto resolved;
                }
    ...
    /* ... => ..., <1 or 2 slot value> */
    VMINLINE VM_BytecodeAction getstatic(REGISTER_ARGS_LIST)
    {
    retry:
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_16 index = *(U_16*)(_pc + 1);
        ...
        if (J9_UNEXPECTED(!VM_VMHelpers::staticFieldRefIsResolved(flagsAndClass, valueOffset))) {
            ...
            buildGenericSpecialStackFrame(REGISTER_ARGS, 0);
            updateVMStruct(REGISTER_ARGS);
            void* resolveResult = resolveStaticFieldRef(_currentThread, NULL, ramConstantPool, index,
                J9_RESOLVE_FLAG_RUNTIME_RESOLVE | J9_RESOLVE_FLAG_CHECK_CLINIT, NULL);
            VMStructHasBeenUpdated(REGISTER_ARGS);
            restoreGenericSpecialStackFrame(REGISTER_ARGS);
            if (immediateAsyncPending()) {
                rc = GOTO_ASYNC_CHECK;
        ...
        if (J9_EVENT_IS_HOOKED(_vm->hookInterface, J9HOOK_VM_GET_STATIC_FIELD)) {
            ...
            if (J9_ARE_ANY_BITS_SET(fieldClass->classFlags, J9ClassHasWatchedFields)) {
                updateVMStruct(REGISTER_ARGS);
                ALWAYS_TRIGGER_J9HOOK_VM_GET_STATIC_FIELD(_vm->hookInterface, _currentThread, _literals,
                    _pc - _literals->bytecodes, fieldClass, valueAddress);
                VMStructHasBeenUpdated(REGISTER_ARGS);
                if (immediateAsyncPending()) {
                    rc = GOTO_ASYNC_CHECK;
                    goto done;
...
#endif
        {
            ...
            if (classAndFlags & J9StaticFieldRefBaseType) {
                if (classAndFlags & J9StaticFieldRefDouble) {
                    _sp -= 2;
                    *(U_64*)_sp = _objectAccessBarrier.inlineStaticReadU64(
                        _currentThread, fieldClass, (U_64*)valueAddress, isVolatile);
                } else {
                    _sp -= 1;
                    *(U_32*)_sp = _objectAccessBarrier.inlineStaticReadU32(
                        _currentThread, fieldClass, (U_32*)valueAddress, isVolatile);
                }
            } else {
                _sp -= 1;
                *(j9object_t*)_sp = _objectAccessBarrier.inlineStaticReadObject(
                    _currentThread, fieldClass, (j9object_t*)valueAddress, isVolatile);
            }
        }
        _pc += 3;
    done:
    ...
    /* ..., <1 or 2 slot value> => ... */
    VMINLINE VM_BytecodeAction putstatic(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_16 index = *(U_16*)(_pc + 1);
        J9ConstantPool* ramConstantPool = J9_CP_FROM_METHOD(_literals);
        ...
        resolve:
            ...
            buildGenericSpecialStackFrame(REGISTER_ARGS, 0);
            updateVMStruct(REGISTER_ARGS);
            resolveResult = resolveStaticFieldRef(_currentThread, method, ramConstantPool, index,
                J9_RESOLVE_FLAG_RUNTIME_RESOLVE | J9_RESOLVE_FLAG_FIELD_SETTER | J9_RESOLVE_FLAG_CHECK_CLINIT, NULL);
            VMStructHasBeenUpdated(REGISTER_ARGS);
            restoreGenericSpecialStackFrame(REGISTER_ARGS);
            if (immediateAsyncPending()) {
                rc = GOTO_ASYNC_CHECK;
            ...
            UDATA const resolvedBit = (UDATA)J9StaticFieldRefPutResolved
                << (8 * sizeof(UDATA) - J9_REQUIRED_CLASS_SHIFT);
        ...
        if (J9_EVENT_IS_HOOKED(_vm->hookInterface, J9HOOK_VM_PUT_STATIC_FIELD)) {
            ...
            if (J9_ARE_ANY_BITS_SET(fieldClass->classFlags, J9ClassHasWatchedFields)) {
                updateVMStruct(REGISTER_ARGS);
                ALWAYS_TRIGGER_J9HOOK_VM_PUT_STATIC_FIELD(_vm->hookInterface, _currentThread, _literals,
                    _pc - _literals->bytecodes, fieldClass, valueAddress, *(U_64*)_sp);
                VMStructHasBeenUpdated(REGISTER_ARGS);
                if (immediateAsyncPending()) {
                    rc = GOTO_ASYNC_CHECK;
                    goto done;
...
#endif
        {
            ...
            if (classAndFlags & J9StaticFieldRefBaseType) {
                if (classAndFlags & J9StaticFieldRefDouble) {
                    _objectAccessBarrier.inlineStaticStoreU64(
                        _currentThread, fieldClass, (U_64*)valueAddress, *(U_64*)_sp, isVolatile);
                    _sp += 2;
                } else {
                    U_32 value = *(U_32*)_sp;
                    ...
                    _objectAccessBarrier.inlineStaticStoreU32(
                        _currentThread, fieldClass, (U_32*)valueAddress, value, isVolatile);
                    _sp += 1;
                }
            } else {
                _objectAccessBarrier.inlineStaticStoreObject(
                    _currentThread, fieldClass, (j9object_t*)valueAddress, *(j9object_t*)_sp, isVolatile);
                _sp += 1;
            }
        }
        _pc += 3;
    ...
    VMINLINE VM_BytecodeAction getfieldLogic(
        REGISTER_ARGS_LIST, UDATA indexOffset, j9object_t* objectLocation, UDATA slotsToPop)
    {
    retry:
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (J9_UNEXPECTED(!VM_VMHelpers::instanceFieldRefIsResolved(flags, valueOffset))) {
            ...
            resolveInstanceFieldRef(
                _currentThread, NULL, ramConstantPool, index, J9_RESOLVE_FLAG_RUNTIME_RESOLVE, NULL);
            VMStructHasBeenUpdated(REGISTER_ARGS);
            restoreGenericSpecialStackFrame(REGISTER_ARGS);
            if (immediateAsyncPending()) {
                rc = GOTO_ASYNC_CHECK;
            ...
            if (NULL == objectref) {
                ...
                if (J9_EVENT_IS_HOOKED(_vm->hookInterface, J9HOOK_VM_GET_FIELD)) {
                    if (J9_ARE_ANY_BITS_SET(
                            J9OBJECT_CLAZZ(_currentThread, objectref)->classFlags, J9ClassHasWatchedFields)) {
                        updateVMStruct(REGISTER_ARGS);
                        ALWAYS_TRIGGER_J9HOOK_VM_GET_FIELD(_vm->hookInterface, _currentThread, _literals,
                            _pc - _literals->bytecodes, objectref, valueOffset);
                        VMStructHasBeenUpdated(REGISTER_ARGS);
                        if (immediateAsyncPending()) {
                            rc = GOTO_ASYNC_CHECK;
                            goto done;
...

                {
                    ...
                    if (flags & J9FieldSizeDouble) {
                        _sp += (slotsToPop - 2);
                        *(U_64*)_sp = _objectAccessBarrier.inlineMixedObjectReadU64(
                            _currentThread, objectref, newValueOffset, isVolatile);
                    } else if (flags & J9FieldFlagObject) {
                        _sp += (slotsToPop - 1);
                        *(j9object_t*)_sp = _objectAccessBarrier.inlineMixedObjectReadObject(
                            _currentThread, objectref, newValueOffset, isVolatile);
                    } else {
                        _sp += (slotsToPop - 1);
                        *(U_32*)_sp = _objectAccessBarrier.inlineMixedObjectReadU32(
                            _currentThread, objectref, newValueOffset, isVolatile);
                    }
                }
                _pc += (indexOffset + 2);
    ...
    /* ... => ..., <1 or 2 slot value> */
    VMINLINE VM_BytecodeAction aload0getfield(REGISTER_ARGS_LIST)
    {
        return getfieldLogic(REGISTER_ARGS, 2, (j9object_t*)_arg0EA, 0);
    }

    /* ..., objectref => ..., <1 or 2 slot value> */
    VMINLINE VM_BytecodeAction getfield(REGISTER_ARGS_LIST)
    {
        return getfieldLogic(REGISTER_ARGS, 1, (j9object_t*)_sp, 1);
    }

    /* ..., objectref, <1 or 2 slot value> => ... */
    VMINLINE VM_BytecodeAction putfield(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_16 index = *(U_16*)(_pc + 1);
        J9ConstantPool* ramConstantPool = J9_CP_FROM_METHOD(_literals);
        ...
        resolve:
            ...
            buildGenericSpecialStackFrame(REGISTER_ARGS, 0);
            updateVMStruct(REGISTER_ARGS);
            resolveInstanceFieldRef(_currentThread, method, ramConstantPool, index,
                J9_RESOLVE_FLAG_RUNTIME_RESOLVE | J9_RESOLVE_FLAG_FIELD_SETTER, NULL);
            VMStructHasBeenUpdated(REGISTER_ARGS);
            restoreGenericSpecialStackFrame(REGISTER_ARGS);
            if (immediateAsyncPending()) {
                rc = GOTO_ASYNC_CHECK;
        ...
        if (J9_EVENT_IS_HOOKED(_vm->hookInterface, J9HOOK_VM_PUT_FIELD)) {
            ...
            if (NULL != objectref) {
                if (J9_ARE_ANY_BITS_SET(
                        J9OBJECT_CLAZZ(_currentThread, objectref)->classFlags, J9ClassHasWatchedFields)) {
                    updateVMStruct(REGISTER_ARGS);
                    ALWAYS_TRIGGER_J9HOOK_VM_PUT_FIELD(_vm->hookInterface, _currentThread, _literals,
                        _pc - _literals->bytecodes, objectref, valueOffset, *(U_64*)_sp);
                    VMStructHasBeenUpdated(REGISTER_ARGS);
                    if (immediateAsyncPending()) {
                        rc = GOTO_ASYNC_CHECK;
                        goto done;
...
#endif
        {
            ...
            if (flags & J9FieldSizeDouble) {
                ...
                _objectAccessBarrier.inlineMixedObjectStoreU64(
                    _currentThread, objectref, newValueOffset, *(U_64*)_sp, isVolatile);
                _sp += 3;
            } else if (flags & J9FieldFlagObject) {
                ...
                _objectAccessBarrier.inlineMixedObjectStoreObject(
                    _currentThread, objectref, newValueOffset, *(j9object_t*)_sp, isVolatile);
                _sp += 2;
            } else {
                j9object_t objectref = *(j9object_t*)(_sp + 1);
                if (NULL == objectref) {
                ...
                _objectAccessBarrier.inlineMixedObjectStoreU32(
                    _currentThread, objectref, newValueOffset, value, isVolatile);
                _sp += 2;
            }
        }
        _pc += 3;
    ...
    /* ..., objectref => objectref */
    VMINLINE VM_BytecodeAction athrow(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction invokevirtualLogic(REGISTER_ARGS_LIST, bool fromBytecode)
    {
        VM_BytecodeAction rc = GOTO_RUN_METHOD;
        U_16 index = *(U_16*)(_pc + 1);
        J9ConstantPool* ramConstantPool = J9_CP_FROM_METHOD(_literals);
    ...
    VMINLINE VM_BytecodeAction invokevirtual(REGISTER_ARGS_LIST) { return invokevirtualLogic(REGISTER_ARGS, true); }

    VMINLINE VM_BytecodeAction invokespecialLogic(REGISTER_ARGS_LIST, bool fromBytecode, bool split)
    {
        VM_BytecodeAction rc = GOTO_RUN_METHOD;
        U_16 index = *(U_16*)(_pc + 1);
        J9ConstantPool* ramConstantPool = J9_CP_FROM_METHOD(_literals);
        ...
        /* argCount was initialized when we initialized the class (i.e. it is non-volatile), so no memory barrier is
         * required */
            ...
            if (J9_ARE_ALL_BITS_SET(currentClass->romClass->modifiers, J9AccInterface)) {
                ...
                if ((0 != nameLength) && (name[0] != '<')) {
                    ...
                    if (!fromBytecode || ((J9Method*)_vm->initialMethods.initialSpecialMethod != _sendMethod)) {
                        ...
                        if ((0 != J9CLASS_DEPTH(resolvedClass))
                            || J9_ARE_NO_BITS_SET(romMethod->modifiers, J9AccFinal)) {
                            J9Class* receiverClass = J9OBJECT_CLAZZ(_currentThread, receiver);
                            if (!instanceOfOrCheckCast(receiverClass, currentClass)) {
                                ...
                                setIllegalAccessErrorReceiverNotSameOrSubtypeOfCurrentClass(
                                    _currentThread, receiverClass, currentClass);
                                VMStructHasBeenUpdated(REGISTER_ARGS);
                                rc = GOTO_THROW_CURRENT_EXCEPTION;
                                goto done;
                            }
    ...
    VMINLINE VM_BytecodeAction invokespecial(REGISTER_ARGS_LIST)
    {
        return invokespecialLogic(REGISTER_ARGS, true, false);
    }

    VMINLINE VM_BytecodeAction invokespecialsplit(REGISTER_ARGS_LIST)
    {
        return invokespecialLogic(REGISTER_ARGS, true, true);
    }

    VMINLINE VM_BytecodeAction invokestatic(REGISTER_ARGS_LIST)
    {
        U_16 index = *(U_16*)(_pc + 1);
        profileCallingMethod(REGISTER_ARGS);
    ...
    VMINLINE VM_BytecodeAction invokestaticsplit(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction invokeinterfaceOffset(REGISTER_ARGS_LIST, UDATA offset)
    {
    retry:
        VM_BytecodeAction rc = GOTO_RUN_METHOD;
            ...
            while (NULL != iTable) {
                ...
                foundITableCache:
                    ...
                    if (J9_ARE_NO_BITS_SET(romMethod->modifiers, J9AccPublic | J9AccPrivate)) {
                        /* We need a frame to describe the method arguments (in particular, for the case where we got
                         * here directly from the JIT) */
                        buildMethodFrame(REGISTER_ARGS, _sendMethod, jitStackFrameFlags(REGISTER_ARGS, 0));
                        updateVMStruct(REGISTER_ARGS);
    ...
    VMINLINE VM_BytecodeAction invokeinterface2(REGISTER_ARGS_LIST) { return invokeinterfaceOffset(REGISTER_ARGS, 2); }

    VMINLINE VM_BytecodeAction invokeinterface(REGISTER_ARGS_LIST) { return invokeinterfaceOffset(REGISTER_ARGS, 0); }

#if defined(J9VM_ENV_DATA64)
    /* ..., objectref => ... */
    VMINLINE VM_BytecodeAction ifnull(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    /* ..., objectref => ... */
    VMINLINE VM_BytecodeAction ifnonnull(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_8* profilingCursor = startProfilingRecord(REGISTER_ARGS, sizeof(U_8));
        if (*_sp++ != 0) {
    ...
    /* ..., value => ... */
    VMINLINE VM_BytecodeAction ifeq(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_8* profilingCursor = startProfilingRecord(REGISTER_ARGS, sizeof(U_8));
        if (*(I_32*)(_sp++) == 0) {
    ...
    /* ..., value => ... */
    VMINLINE VM_BytecodeAction ifne(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_8* profilingCursor = startProfilingRecord(REGISTER_ARGS, sizeof(U_8));
        if (*(I_32*)(_sp++) != 0) {
    ...
    /* ..., value => ... */
    VMINLINE VM_BytecodeAction iflt(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_8* profilingCursor = startProfilingRecord(REGISTER_ARGS, sizeof(U_8));
        if (*(I_32*)(_sp++) < 0) {
    ...
    /* ..., value => ... */
    VMINLINE VM_BytecodeAction ifge(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_8* profilingCursor = startProfilingRecord(REGISTER_ARGS, sizeof(U_8));
        if (*(I_32*)(_sp++) >= 0) {
    ...
    /* ..., value => ... */
    VMINLINE VM_BytecodeAction ifgt(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_8* profilingCursor = startProfilingRecord(REGISTER_ARGS, sizeof(U_8));
        if (*(I_32*)(_sp++) > 0) {
    ...
    /* ..., value => ... */
    VMINLINE VM_BytecodeAction ifle(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_8* profilingCursor = startProfilingRecord(REGISTER_ARGS, sizeof(U_8));
        if (*(I_32*)(_sp++) <= 0) {
    ...
    /* ..., lhs, rhs => ... */
    VMINLINE VM_BytecodeAction ificmpeq(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 rhs = *(I_32*)_sp;
        I_32 lhs = *(I_32*)(_sp + 1);
    ...
    /* ..., lhs, rhs => ... */
    VMINLINE VM_BytecodeAction ificmpne(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 rhs = *(I_32*)_sp;
        I_32 lhs = *(I_32*)(_sp + 1);
    ...
    /* ..., lhs, rhs => ... */
    VMINLINE VM_BytecodeAction ificmplt(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 rhs = *(I_32*)_sp;
        I_32 lhs = *(I_32*)(_sp + 1);
    ...
    /* ..., lhs, rhs => ... */
    VMINLINE VM_BytecodeAction ificmpge(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 rhs = *(I_32*)_sp;
        I_32 lhs = *(I_32*)(_sp + 1);
    ...
    /* ..., lhs, rhs => ... */
    VMINLINE VM_BytecodeAction ificmpgt(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 rhs = *(I_32*)_sp;
        I_32 lhs = *(I_32*)(_sp + 1);
    ...
    /* ..., lhs, rhs => ... */
    VMINLINE VM_BytecodeAction ificmple(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        I_32 rhs = *(I_32*)_sp;
        I_32 lhs = *(I_32*)(_sp + 1);
    ...
    /* ..., lhs, rhs => ... */
    VMINLINE VM_BytecodeAction ifacmpeq(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
    ...
    /* ..., lhs, rhs => ... */
    VMINLINE VM_BytecodeAction ifacmpne(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t rhs = *(j9object_t*)_sp;
        j9object_t lhs = *(j9object_t*)(_sp + 1);
    ...
    /* ... => ... */
    VMINLINE VM_BytecodeAction gotoImpl(REGISTER_ARGS_LIST, UDATA parmSize)
    {
        if (parmSize == 2) {
            _pc += *(I_16*)(_pc + 1);
        } else if (parmSize == 4) {
    ...
    /* ..., index => ... */
    VMINLINE VM_BytecodeAction tableswitch(REGISTER_ARGS_LIST)
    {
    ...
    /* ..., key => ... */
    VMINLINE VM_BytecodeAction lookupswitch(REGISTER_ARGS_LIST)
    {
        I_32* data = (I_32*)((((UDATA)_pc) + 1 + 3) & ~(UDATA)3);
        I_32 defaultValue = *data++;
        I_32 nPairs = *data++;
    ...
    VMINLINE VM_BytecodeAction newLogic(REGISTER_ARGS_LIST, j9object_t* newObject)
    {
    retry:
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_16 index = *(U_16*)(_pc + 1);
        ...
        if ((NULL != resolvedClass) && (resolvedClass->romClass->modifiers & (J9AccAbstract | J9AccInterface)) == 0) {
            if (!VM_VMHelpers::classRequiresInitialization(_currentThread, resolvedClass)) {
                ...
                if (NULL == instance) {
                    updateVMStruct(REGISTER_ARGS);
                    instance = _vm->memoryManagerFunctions->J9AllocateObject(
                        _currentThread, resolvedClass, J9_GC_ALLOCATE_OBJECT_INSTRUMENTABLE);
                    VMStructHasBeenUpdated(REGISTER_ARGS);
                    if (J9_UNEXPECTED(NULL == instance)) {
                        rc = THROW_HEAP_OOM;
                        goto done;
        ...
        buildGenericSpecialStackFrame(REGISTER_ARGS, 0);
        updateVMStruct(REGISTER_ARGS);
        resolveClassRef(_currentThread, ramConstantPool, index,
            J9_RESOLVE_FLAG_RUNTIME_RESOLVE | J9_RESOLVE_FLAG_INIT_CLASS | J9_RESOLVE_FLAG_INSTANTIABLE);
        VMStructHasBeenUpdated(REGISTER_ARGS);
        restoreGenericSpecialStackFrame(REGISTER_ARGS);
        if (immediateAsyncPending()) {
            rc = GOTO_ASYNC_CHECK;
    ...
    /* ... => ..., objectref */
    VMINLINE VM_BytecodeAction newImpl(REGISTER_ARGS_LIST)
    {
    ...
    /* ... => ..., objectref, objectref */
    VMINLINE VM_BytecodeAction newdup(REGISTER_ARGS_LIST)
    {
        j9object_t newObject = NULL;
        VM_BytecodeAction rc = newLogic(REGISTER_ARGS, &newObject);
        if (EXECUTE_BYTECODE == rc) {
    ...
    /* ..., count => ..., arrayref */
    VMINLINE VM_BytecodeAction newarray(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_8 arrayType = _pc[1];
        I_32 size = *(I_32*)_sp;
        if (J9_UNEXPECTED(size < 0)) {
            ...
            if (NULL == instance) {
                updateVMStruct(REGISTER_ARGS);
                instance = _vm->memoryManagerFunctions->J9AllocateIndexableObject(
                    _currentThread, arrayClass, (U_32)size, J9_GC_ALLOCATE_OBJECT_INSTRUMENTABLE);
                VMStructHasBeenUpdated(REGISTER_ARGS);
                if (J9_UNEXPECTED(NULL == instance)) {
                    rc = THROW_HEAP_OOM;
                    goto done;
    ...
    /* ..., count => ..., arrayref */
    VMINLINE VM_BytecodeAction anewarray(REGISTER_ARGS_LIST)
    {
    retry:
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_16 index = *(U_16*)(_pc + 1);
        ...
        if (J9_EXPECTED(NULL != resolvedClass)) {
            ...
            if (J9_EXPECTED(NULL != arrayClass)) {
                j9object_t instance
                    = _objectAllocate.inlineAllocateIndexableObject(_currentThread, arrayClass, (U_32)size);
                if (NULL == instance) {
                    updateVMStruct(REGISTER_ARGS);
                    instance = _vm->memoryManagerFunctions->J9AllocateIndexableObject(
                        _currentThread, arrayClass, (U_32)size, J9_GC_ALLOCATE_OBJECT_INSTRUMENTABLE);
            ...
            updateVMStruct(REGISTER_ARGS);
            arrayClass = internalCreateArrayClass(
                _currentThread, (J9ROMArrayClass*)J9ROMIMAGEHEADER_FIRSTCLASS(_vm->arrayROMClasses), resolvedClass);
            VMStructHasBeenUpdated(REGISTER_ARGS);
            restoreGenericSpecialStackFrame(REGISTER_ARGS);
            if (VM_VMHelpers::exceptionPending(_currentThread)) {
                rc = GOTO_THROW_CURRENT_EXCEPTION;
    ...
    /* ..., objectref => ..., objectref */
    VMINLINE VM_BytecodeAction checkcast(REGISTER_ARGS_LIST)
    {
    retry:
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t obj = *(j9object_t*)_sp;
    ...
    /* ..., objectref => ..., result */
    VMINLINE VM_BytecodeAction instanceof (REGISTER_ARGS_LIST)
    {
    retry:
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t obj = *(j9object_t*)_sp;
    ...
    /* ..., objectref => ... */
    VMINLINE VM_BytecodeAction monitorenter(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t obj = *(j9object_t*)_sp;
        if (NULL == obj) {
            ...
            if (0 == monitorRC) {
                ...
                if (J9_UNEXPECTED(!VM_ObjectMonitor::recordBytecodeMonitorEnter(
                        _currentThread, (j9object_t)monitorRC, _arg0EA))) {
    ...
    /* ..., objectref => ... */
    VMINLINE VM_BytecodeAction monitorexit(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        j9object_t obj = *(j9object_t*)_sp;
        _sp += 1;
    ...
    VMINLINE VM_BytecodeAction multianewarray(REGISTER_ARGS_LIST)
    {
    retry:
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        U_16 index = *(U_16*)(_pc + 1);
        ...
        if (NULL != resolvedClass) {
            ...
            buildGenericSpecialStackFrame(REGISTER_ARGS, 0);
            updateVMStruct(REGISTER_ARGS);
            instance = helperMultiANewArray(_currentThread, (J9ArrayClass*)arrayClass, dimensions, dimensionsArray,
    ...
    VMINLINE VM_BytecodeAction genericReturn(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        J9ROMMethod* romMethod = J9_ROM_METHOD_FROM_RAM_METHOD(_literals);
        ;
...
#if defined(DO_HOOKS)
        {
            ...
            if (hooked || traced) {
                ...
                if (hooked) {
                    ALWAYS_TRIGGER_J9HOOK_VM_METHOD_RETURN(
                        _vm->hookInterface, _currentThread, _literals, FALSE, _sp, 0);
                }
                VMStructHasBeenUpdated(REGISTER_ARGS);
                if (immediateAsyncPending()) {
                    rc = GOTO_ASYNC_CHECK;
    ...
    VMINLINE VM_BytecodeAction unimplementedBytecode(REGISTER_ARGS_LIST)
    {
        updateVMStruct(REGISTER_ARGS);
        Assert_VM_unreachable();
        return EXECUTE_BYTECODE;
    ...
    VMINLINE VM_BytecodeAction invokedynamic(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction invokehandle(REGISTER_ARGS_LIST)
    {
#if defined(J9VM_OPT_METHOD_HANDLE)
    retry:
    ...
    VMINLINE VM_BytecodeAction invokehandlegeneric(REGISTER_ARGS_LIST)
    {
#if defined(J9VM_OPT_METHOD_HANDLE)
    retry:
        VM_BytecodeAction rc = GOTO_RUN_METHODHANDLE;
        ...
        if (J9_EXPECTED(NULL != type)) {
            ...
            if (J9VMJAVALANGINVOKEMETHODHANDLE_TYPE(_currentThread, mhReceiver) != type) {
                ...
                j9object_t const cachedHandle
                    = J9VMJAVALANGINVOKEMETHODHANDLE_PREVIOUSASTYPE(_currentThread, mhReceiver);
    ...
    VMINLINE j9object_t countAndCompileMethodHandle(
        REGISTER_ARGS_LIST, j9object_t methodHandle, void** compiledEntryPoint)
    {
#if defined(J9VM_OPT_METHOD_HANDLE)
        J9JITConfig* jitConfig = _vm->jitConfig;
        if (NULL != jitConfig) {
            ...
            do {
                ...
                isUpdated = _objectAccessBarrier.inlineMixedObjectCompareAndSwapU32(_currentThread, thunks,
                    J9VMJAVALANGINVOKETHUNKTUPLE_INVOCATIONCOUNT_OFFSET(_currentThread), count, count + 1);
            } while (!isUpdated);
            ...
            if (count == (IDATA)_vm->methodHandleCompileCount) {
                ...
                *compiledEntryPoint = jitConfig->translateMethodHandle(
                    _currentThread, methodHandle, NULL, J9_METHOD_HANDLE_COMPILE_SHARED);
    ...
    VMINLINE VM_BytecodeAction retFromNative0(REGISTER_ARGS_LIST)
    {
        return retFromNativeHelper(REGISTER_ARGS, 0, _vm->jitConfig->jitExitInterpreter0);
    }

    VMINLINE VM_BytecodeAction invokevarhandle(REGISTER_ARGS_LIST)
    {
        VM_BytecodeAction rc = GOTO_RUN_METHODHANDLE;
        ...
        if (J9_UNEXPECTED(NULL == varHandle)) {
            ...
            if (callSiteType != handleType) {
                /* Generic invoke */
                j9object_t const cachedHandle
                    = J9VMJAVALANGINVOKEMETHODHANDLE_PREVIOUSASTYPE(_currentThread, methodHandle);
                j9object_t cachedHandleType = NULL;
                if (cachedHandle != NULL) {
                    cachedHandleType = J9VMJAVALANGINVOKEMETHODHANDLE_TYPE(_currentThread, cachedHandle);
                }
                if (cachedHandleType == callSiteType) {
                    ...
                    sendForGenericInvoke(
                        _currentThread, methodHandle, callSiteType, FALSE /* dropFirstArg */, 0 /* reserved */);
                    VMStructHasBeenUpdated(REGISTER_ARGS);
    ...
    VMINLINE VM_BytecodeAction impdep2(REGISTER_ARGS_LIST)
    {
    ...
    VMINLINE VM_BytecodeAction defaultvalue(REGISTER_ARGS_LIST)
    {
    retry:
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if ((NULL != resolvedClass) && J9_IS_J9CLASS_VALUETYPE(resolvedClass)
        ...
        if (NULL == resolvedClass) {
            ...
            setCurrentExceptionNLSWithArgs(_currentThread, J9NLS_VM_ERROR_BYTECODE_CLASSREF_MUST_BE_VALUE_TYPE,
                J9VMCONSTANTPOOL_JAVALANGINCOMPATIBLECLASSCHANGEERROR, J9UTF8_LENGTH(badClassName),
                J9UTF8_DATA(badClassName));
    ...
    VMINLINE VM_BytecodeAction withfield(REGISTER_ARGS_LIST)
    {
    retry:
        VM_BytecodeAction rc = EXECUTE_BYTECODE;
        ...
        if (J9_UNEXPECTED((flags <= valueOffset) || J9_ARE_NO_BITS_SET(flags, J9FieldFlagPutResolved))) {
            ...
            updateVMStruct(REGISTER_ARGS);
            resolveInstanceFieldRef(_currentThread, method, ramConstantPool, index,
                J9_RESOLVE_FLAG_RUNTIME_RESOLVE | J9_RESOLVE_FLAG_FIELD_SETTER | J9_RESOLVE_FLAG_WITH_FIELD, NULL);
            VMStructHasBeenUpdated(REGISTER_ARGS);
            if (immediateAsyncPending()) {
                rc = GOTO_ASYNC_CHECK;
                goto done;
        ...
        {
            j9object_t originalObjectRef
                = *(j9object_t*)(_sp + (J9_ARE_ALL_BITS_SET(flags, J9FieldSizeDouble) ? 2 : 1));
            ...
            if (!J9_IS_J9CLASS_VALUETYPE(objectRefClass)) {
                ...
                setCurrentExceptionNLSWithArgs(_currentThread, J9NLS_VM_ERROR_BYTECODE_OBJECTREF_MUST_BE_VALUE_TYPE,
                    J9VMCONSTANTPOOL_JAVALANGINCOMPATIBLECLASSCHANGEERROR, J9UTF8_LENGTH(badClassName),
                    J9UTF8_DATA(badClassName));
                rc = GOTO_THROW_CURRENT_EXCEPTION;
                goto done;
            ...
            if (NULL == copyObjectRef) {
                ...
                updateVMStruct(REGISTER_ARGS);
                copyObjectRef = _vm->memoryManagerFunctions->J9AllocateObject(
                    _currentThread, objectRefClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                VMStructHasBeenUpdated(REGISTER_ARGS);
        ...
        }
        {
            ...
            if (J9_ARE_ALL_BITS_SET(flags, J9FieldSizeDouble)) {
                _objectAccessBarrier.inlineMixedObjectStoreU64(
                    _currentThread, copyObjectRef, newValueOffset, *(U_64*)_sp, isVolatile);
                _sp += 2;
            } else if (J9_ARE_ALL_BITS_SET(flags, J9FieldFlagObject)) {
                _objectAccessBarrier.inlineMixedObjectStoreObject(
                    _currentThread, copyObjectRef, newValueOffset, *(j9object_t*)_sp, isVolatile);
                _sp += 1;
            } else {
                _objectAccessBarrier.inlineMixedObjectStoreU32(
                    _currentThread, copyObjectRef, newValueOffset, *(U_32*)_sp, isVolatile);
                _sp += 1;
            }
        }
...
public:
    ...
    || ((defined(J9VM_ARCH_X86) || defined(S390)) && defined(__GNUC__) \
...
#define SINGLE_STEP()
    ...
    i2j : PERFORM_ACTION(i2jTransition(REGISTER_ARGS));

    jni : PERFORM_ACTION(runJNINative(REGISTER_ARGS));
...
#if defined(J9VM_OPT_METHOD_HANDLE)
        _sendMethod
        = (J9Method*)_currentThread->tempSlot;
    goto runMethod;
#else
        Assert_VM_unreachable();
#endif /* J9VM_OPT_METHOD_HANDLE */

    asyncCheck : PERFORM_ACTION(checkAsync(REGISTER_ARGS));

    throwCurrentException : PERFORM_ACTION(throwException(REGISTER_ARGS));

    branchWithAsyncCheck : PERFORM_ACTION(takeBranch(REGISTER_ARGS));

    javaStackOverflow : PERFORM_ACTION(stackOverflow(REGISTER_ARGS));

    nullPointer : updateVMStruct(REGISTER_ARGS);
    prepareForExceptionThrow(_currentThread);
    setCurrentExceptionUTF(_currentThread, J9VMCONSTANTPOOL_JAVALANGNULLPOINTEREXCEPTION, NULL);
    VMStructHasBeenUpdated(REGISTER_ARGS);
    goto throwCurrentException;

    wrongMethodType : updateVMStruct(REGISTER_ARGS);
    prepareForExceptionThrow(_currentThread);
    ...
    divideByZero : updateVMStruct(REGISTER_ARGS);
    prepareForExceptionThrow(_currentThread);
    ...
    executeBreakpointedBytecode:
    {
        ...
        TRIGGER_J9HOOK_VM_BREAKPOINT(
            _vm->hookInterface, _currentThread, _literals, _pc - _literals->bytecodes, originalBytecode);
        VMStructHasBeenUpdated(REGISTER_ARGS);
        if (immediateAsyncPending()) {
            goto asyncCheck;
        }
    ...
    done : updateVMStruct(REGISTER_ARGS);
    noUpdate :
#if defined(TRACE_TRANSITIONS)
        switch (_nextAction)
    {
    case J9_BCLOOP_EXECUTE_BYTECODE:
        ...
        j9tty_printf(PORTLIB, "<%p> exit : %s J9_BCLOOP_EXECUTE_BYTECODE %s (%d)\n", vmThread, currentMethodName,
            JavaBCNames[*vmThread->pc], *vmThread->pc);
        break;
    case J9_BCLOOP_RUN_METHOD:
