...
ffi_type** FFITypeHelpers::getStructFFITypeElements(char** layout, bool inPtr)
{
...
ffi_type* FFITypeHelpers::getStructFFIType(char** layout, bool inPtr)
{
    ffi_type* typeFFI = NULL;
    /** The Layout is incremented for the '[' case in getStructFFITypeElements(char **layout, bool inPtr).
     * The remaining layout string is then traversed when getStructFFITypeElements(char **layout, bool inPtr) is called
     * again recursively.
     */
    (*layout)++;
...
void FFITypeHelpers::freeStructFFITypeElements(ffi_type** elements)
{
    PORT_ACCESS_FROM_JAVAVM(_vm);
    if (NULL != elements) {
...
void FFITypeHelpers::freeStructFFIType(ffi_type* ffiType)
{
    if (NULL != ffiType) {
        PORT_ACCESS_FROM_JAVAVM(_vm);
