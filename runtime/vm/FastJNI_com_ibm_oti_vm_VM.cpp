...
j9object_t JNICALL Fast_java_lang_VMAccess_findClassOrNull(
    J9VMThread* currentThread, j9object_t className, j9object_t classloaderObject)
{
    ...
    if (NULL == className) {
        ...
        if (CLASSNAME_VALID_NON_ARRARY == verifyQualifiedName(currentThread, className)) {
            j9Class = internalFindClassString(
                currentThread, NULL, className, loader, J9_FINDCLASS_FLAG_USE_LOADER_CP_ENTRIES);
 ...
 * cpIndex); */
jint JNICALL Fast_com_ibm_oti_vm_VM_getClassPathEntryType(
    J9VMThread* currentThread, j9object_t classLoaderObject, jint cpIndex)
{
...
jint JNICALL Fast_com_ibm_oti_vm_VM_getCPIndexImpl(J9VMThread* currentThread, j9object_t targetClass)
{
...
void JNICALL Fast_com_ibm_oti_vm_VM_initializeClassLoader(
    J9VMThread* currentThread, j9object_t classLoaderObject, jint loaderType, jboolean parallelCapable)
{
...
jboolean JNICALL Fast_com_ibm_oti_vm_VM_isBootstrapClassLoader(J9VMThread* currentThread, j9object_t classLoaderObject)
{
...
J9_FAST_JNI_METHOD("findClassOrNull", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;",
    Fast_java_lang_VMAccess_findClassOrNull,
...
J9_FAST_JNI_METHOD("getClassPathEntryType", "(Ljava/lang/ClassLoader;I)I", Fast_com_ibm_oti_vm_VM_getClassPathEntryType,
    J9_FAST_JNI_RETAIN_VM_ACCESS | J9_FAST_JNI_NOT_GC_POINT | J9_FAST_JNI_NO_NATIVE_METHOD_FRAME
        | J9_FAST_JNI_NO_EXCEPTION_THROW | J9_FAST_JNI_NO_SPECIAL_TEAR_DOWN | J9_FAST_JNI_DO_NOT_WRAP_OBJECTS
        | J9_FAST_JNI_DO_NOT_PASS_RECEIVER)
J9_FAST_JNI_METHOD("getCPIndexImpl", "(Ljava/lang/Class;)I", Fast_com_ibm_oti_vm_VM_getCPIndexImpl,
    J9_FAST_JNI_RETAIN_VM_ACCESS | J9_FAST_JNI_NOT_GC_POINT | J9_FAST_JNI_NO_NATIVE_METHOD_FRAME
        | J9_FAST_JNI_NO_EXCEPTION_THROW | J9_FAST_JNI_NO_SPECIAL_TEAR_DOWN | J9_FAST_JNI_DO_NOT_WRAP_OBJECTS
        | J9_FAST_JNI_DO_NOT_PASS_RECEIVER)
J9_FAST_JNI_METHOD("initializeClassLoader", "(Ljava/lang/ClassLoader;IZ)V",
    Fast_com_ibm_oti_vm_VM_initializeClassLoader,
    J9_FAST_JNI_RETAIN_VM_ACCESS | J9_FAST_JNI_DO_NOT_WRAP_OBJECTS | J9_FAST_JNI_DO_NOT_PASS_RECEIVER)
J9_FAST_JNI_METHOD("isBootstrapClassLoader", "(Ljava/lang/ClassLoader;)Z",
    Fast_com_ibm_oti_vm_VM_isBootstrapClassLoader,
    J9_FAST_JNI_RETAIN_VM_ACCESS | J9_FAST_JNI_NOT_GC_POINT | J9_FAST_JNI_NO_NATIVE_METHOD_FRAME
        | J9_FAST_JNI_NO_EXCEPTION_THROW | J9_FAST_JNI_NO_SPECIAL_TEAR_DOWN | J9_FAST_JNI_DO_NOT_WRAP_OBJECTS
        | J9_FAST_JNI_DO_NOT_PASS_RECEIVER)
