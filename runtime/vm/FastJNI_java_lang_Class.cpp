...
jboolean JNICALL Fast_java_lang_Class_isAssignableFrom(
    J9VMThread* currentThread, j9object_t receiverObject, j9object_t parmObject)
{
...
j9object_t JNICALL Fast_java_lang_Class_forNameImpl(
    J9VMThread* currentThread, j9object_t classNameObject, jboolean initializeBoolean, j9object_t classLoaderObject)
{
    ...
    if (NULL == foundClass) {
        ...
        throwCNFE:
            setCurrentException(
                currentThread, J9VMCONSTANTPOOL_JAVALANGCLASSNOTFOUNDEXCEPTION, (UDATA*)classNameObject);
        }
        goto done;
    }
...
jboolean JNICALL Fast_java_lang_Class_isArray(J9VMThread* currentThread, j9object_t classObject)
{
...
jboolean JNICALL Fast_java_lang_Class_isPrimitive(J9VMThread* currentThread, j9object_t classObject)
{
    J9Class* receiverClazz = J9VM_J9CLASS_FROM_HEAPCLASS(currentThread, classObject);
...
jboolean JNICALL Fast_java_lang_Class_isInstance(
    J9VMThread* currentThread, j9object_t receiverObject, j9object_t object)
{
    jboolean result = JNI_FALSE;
...
jint JNICALL Fast_java_lang_Class_getModifiersImpl(J9VMThread* currentThread, j9object_t receiverObject)
{
    J9Class* receiverClazz = J9VM_J9CLASS_FROM_HEAPCLASS(currentThread, receiverObject);
...
j9object_t JNICALL Fast_java_lang_Class_getComponentType(J9VMThread* currentThread, j9object_t receiverObject)
{
    J9Class* receiverClazz = J9VM_J9CLASS_FROM_HEAPCLASS(currentThread, receiverObject);
...
J9_FAST_JNI_METHOD("forNameImpl", "(Ljava/lang/String;ZLjava/lang/ClassLoader;)Ljava/lang/Class;",
    Fast_java_lang_Class_forNameImpl,
