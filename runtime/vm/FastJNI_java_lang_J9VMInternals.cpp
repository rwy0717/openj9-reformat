...
j9object_t JNICALL Fast_java_lang_J9VMInternals_getSuperclass(J9VMThread* currentThread, j9object_t classObject)
{
...
jint JNICALL Fast_java_lang_J9VMInternals_identityHashCode(J9VMThread* currentThread, j9object_t objectPointer)
{
...
j9object_t JNICALL Fast_java_lang_J9VMInternals_primitiveClone(J9VMThread* currentThread, j9object_t original)
{
    ...
    if (flags & J9AccClassArray) {
        ...
        if (NULL == copy) {
            ...
            copy = currentThread->javaVM->memoryManagerFunctions->J9AllocateIndexableObject(
                currentThread, objectClass, size, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
        ...
        if (NULL == copy) {
            VM_VMHelpers::pushObjectInSpecialFrame(currentThread, original);
            copy = currentThread->javaVM->memoryManagerFunctions->J9AllocateObject(
                currentThread, objectClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
            original = VM_VMHelpers::popObjectInSpecialFrame(currentThread);
            if (J9_UNEXPECTED(NULL == copy)) {
                setHeapOutOfMemoryError(currentThread);
                goto done;
...
j9object_t JNICALL Fast_java_lang_J9VMInternals_getInterfaces(J9VMThread* currentThread, j9object_t clazz)
{
...
void JNICALL Fast_java_lang_J9VMInternals_prepareClassImpl(J9VMThread* currentThread, j9object_t classObject)
{
...
J9_FAST_JNI_METHOD("identityHashCode", "(Ljava/lang/Object;)I", Fast_java_lang_J9VMInternals_identityHashCode,
    J9_FAST_JNI_RETAIN_VM_ACCESS | J9_FAST_JNI_NOT_GC_POINT | J9_FAST_JNI_NO_NATIVE_METHOD_FRAME
        | J9_FAST_JNI_NO_EXCEPTION_THROW | J9_FAST_JNI_NO_SPECIAL_TEAR_DOWN | J9_FAST_JNI_DO_NOT_WRAP_OBJECTS
        | J9_FAST_JNI_DO_NOT_PASS_RECEIVER)
J9_FAST_JNI_METHOD("primitiveClone", "(Ljava/lang/Object;)Ljava/lang/Object;",
    Fast_java_lang_J9VMInternals_primitiveClone,
