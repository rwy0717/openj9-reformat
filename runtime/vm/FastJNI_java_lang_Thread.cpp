...
void JNICALL Fast_java_lang_Thread_sleep(J9VMThread* currentThread, jlong millis, jint nanos)
{
...
j9object_t JNICALL Fast_java_lang_Thread_currentThread(J9VMThread* currentThread)
{
    return currentThread->threadObject;
}

/* java.lang.Thread: public static native boolean interrupted(); */
jboolean JNICALL Fast_java_lang_Thread_interrupted(J9VMThread* currentThread)
{
...
jboolean JNICALL Fast_java_lang_Thread_isInterruptedImpl(J9VMThread* currentThread, j9object_t receiverObject)
{
...
void JNICALL Fast_java_lang_Thread_onSpinWait(J9VMThread* currentThread) { VM_AtomicSupport::yieldCPU(); }

#if defined(WIN32)
/* Exception may be thrown from monitor enter on windows */
#define INTERRUPTED_FLAGS \
    J9_FAST_JNI_RETAIN_VM_ACCESS | J9_FAST_JNI_DO_NOT_WRAP_OBJECTS | J9_FAST_JNI_DO_NOT_PASS_RECEIVER
#else /* WIN32 */
#define INTERRUPTED_FLAGS                                                                                \
    J9_FAST_JNI_RETAIN_VM_ACCESS | J9_FAST_JNI_DO_NOT_WRAP_OBJECTS | J9_FAST_JNI_DO_NOT_PASS_RECEIVER    \
        | J9_FAST_JNI_NOT_GC_POINT | J9_FAST_JNI_NO_NATIVE_METHOD_FRAME | J9_FAST_JNI_NO_EXCEPTION_THROW \
...
J9_FAST_JNI_METHOD("interrupted", "()Z", Fast_java_lang_Thread_interrupted, INTERRUPTED_FLAGS)
