...
void JNICALL Fast_sun_misc_Unsafe_park(J9VMThread* currentThread, jboolean isAbsolute, jlong time)
{
    threadParkImpl(currentThread, (IDATA)isAbsolute, (I_64)time);
}

/* sun.misc.Unsafe: public native void unpark(java.lang.Object thread); */
void JNICALL Fast_sun_misc_Unsafe_unpark(J9VMThread* currentThread, j9object_t threadObject)
{
