...
static const char* names[] = {
    "J9_METHOD_HANDLE_KIND_BOUND", "J9_METHOD_HANDLE_KIND_GET_FIELD", "J9_METHOD_HANDLE_KIND_GET_STATIC_FIELD",
    "J9_METHOD_HANDLE_KIND_PUT_FIELD", "J9_METHOD_HANDLE_KIND_PUT_STATIC_FIELD", "J9_METHOD_HANDLE_KIND_VIRTUAL",
    "J9_METHOD_HANDLE_KIND_STATIC", "J9_METHOD_HANDLE_KIND_SPECIAL", "J9_METHOD_HANDLE_KIND_CONSTRUCTOR",
    "J9_METHOD_HANDLE_KIND_INTERFACE", "J9_METHOD_HANDLE_KIND_COLLECT", "J9_METHOD_HANDLE_KIND_INVOKE_EXACT",
    "J9_METHOD_HANDLE_KIND_INVOKE_GENERIC", "J9_METHOD_HANDLE_KIND_ASTYPE", "J9_METHOD_HANDLE_KIND_DYNAMIC_INVOKER",
    "J9_METHOD_HANDLE_KIND_FILTER_RETURN", "J9_METHOD_HANDLE_KIND_EXPLICITCAST",
    "J9_METHOD_HANDLE_KIND_VARARGS_COLLECTOR", "J9_METHOD_HANDLE_KIND_PASSTHROUGH", "J9_METHOD_HANDLE_KIND_SPREAD",
    "J9_METHOD_HANDLE_KIND_INSERT", "J9_METHOD_HANDLE_KIND_PERMUTE", "J9_METHOD_HANDLE_KIND_CONSTANT_OBJECT",
    "J9_METHOD_HANDLE_KIND_CONSTANT_INT", "J9_METHOD_HANDLE_KIND_CONSTANT_FLOAT", "J9_METHOD_HANDLE_KIND_CONSTANT_LONG",
    "J9_METHOD_HANDLE_KIND_CONSTANT_DOUBLE", "J9_METHOD_HANDLE_KIND_FOLD_HANDLE",
    "J9_METHOD_HANDLE_KIND_GUARD_WITH_TEST", "J9_METHOD_HANDLE_KIND_FILTER_ARGUMENTS",
    "J9_METHOD_HANDLE_KIND_VARHANDLE_INVOKE_EXACT", "J9_METHOD_HANDLE_KIND_VARHANDLE_INVOKE_GENERIC",
...
VM_BytecodeAction VM_MHInterpreter::dispatchLoop(j9object_t methodHandle)
{
    ...
    while (true) {
        ...
        case J9_METHOD_HANDLE_KIND_CONSTANT_OBJECT:
            ...
            *((j9object_t*)_currentThread->sp)
                = J9VMJAVALANGINVOKECONSTANTOBJECTHANDLE_VALUE(_currentThread, methodHandle);
            goto returnFromSend;
        ...
        case J9_METHOD_HANDLE_KIND_FILTER_RETURN: {
            ...
            insertPlaceHolderFrame(
                slotCount, returnFilter, J9VMJAVALANGINVOKEMETHODHANDLE_RETURNFILTERPLACEHOLDER_METHOD(_vm));
        ...
        case J9_METHOD_HANDLE_KIND_GUARD_WITH_TEST: {
            ...
            insertPlaceHolderFrame(
                guardArgSlots, methodHandle, J9VMJAVALANGINVOKEMETHODHANDLE_GUARDWITHTESTPLACEHOLDER_METHOD(_vm));
        ...
        case J9_METHOD_HANDLE_KIND_FILTER_ARGUMENTS: {
            ...
            /* [... FAH args MTFrame FAH.next UpdatedArgs MTFrame FAH index parentOffset nextOffset PlaceHolderFrame
             * FAH] */
            _currentThread->sp -= 1;
            insertFourArgumentPlaceHolderFrame(
                0, parentHandle, 0, 0, 0, J9VMJAVALANGINVOKEMETHODHANDLE_FILTERARGUMENTSPLACEHOLDER_METHOD(_vm));
            ...
            for (U_32 i = 0; i < startPosition; i++) {
                currentClass = J9VM_J9CLASS_FROM_HEAPCLASS(
                    _currentThread, J9JAVAARRAYOFOBJECT_LOAD(_currentThread, parentTypeArguments, i));
                *--nextPtr = *--parentPtr;
                offset += 1;
            ...
            *(U_32*)(offsetPtr - 1) = offset; /* Update nextOffset */
            ...
            /* [... FAH args MTFrame FAH.next UpdatedArgs MTFrame FAH index parentOffset nextOffset PlaceHolderFrame
             * FAH.filters[0] arg] */
            J9Class* startClass = J9VM_J9CLASS_FROM_HEAPCLASS(
                _currentThread, J9JAVAARRAYOFOBJECT_LOAD(_currentThread, parentTypeArguments, startPosition));
        ...
        case J9_METHOD_HANDLE_KIND_CONSTRUCTOR: {
            ...
            if (NULL == newObject) {
                ...
                newObject = _vm->memoryManagerFunctions->J9AllocateObject(
                    _currentThread, allocateClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                if (NULL == newObject) {
                    goto throwHeapOOM;
                }
            ...
            insertPlaceHolderFrame(
                slotCount, newObject, J9VMJAVALANGINVOKEMETHODHANDLE_CONSTRUCTORPLACEHOLDER_METHOD(_vm));
            goto runMethod;
        }
        case J9_METHOD_HANDLE_KIND_GET_FIELD: {
            ...
            if (J9ROMCLASS_IS_PRIMITIVE_TYPE(fieldClass->romClass)) {
                if (8 == ((J9ROMReflectClass*)(fieldClass->romClass))->elementSize) {
                    _currentThread->sp -= 1;
                    *(U_64*)_currentThread->sp = _objectAccessBarrier->inlineMixedObjectReadU64(
                        _currentThread, object, fieldOffset, isVolatile);
                } else {
                    *(U_32*)_currentThread->sp = _objectAccessBarrier->inlineMixedObjectReadU32(
                        _currentThread, object, fieldOffset, isVolatile);
                }
            } else {
                *(j9object_t*)_currentThread->sp = _objectAccessBarrier->inlineMixedObjectReadObject(
                    _currentThread, object, fieldOffset, isVolatile);
            }
            goto returnFromSend;
        }
        case J9_METHOD_HANDLE_KIND_PUT_FIELD: {
            ...
            j9object_t fieldClassObject = _objectAccessBarrier->inlineIndexableObjectReadObject(
                _currentThread, getMethodTypeArguments(type), 1);
            ...
            if (J9ROMCLASS_IS_PRIMITIVE_TYPE(fieldClass->romClass)) {
                if (8 == ((J9ROMReflectClass*)(fieldClass->romClass))->elementSize) {
                    ...
                    _objectAccessBarrier->inlineMixedObjectStoreU64(
                        _currentThread, objectref, fieldOffset, *(U_64*)_currentThread->sp, isVolatile);
                    _currentThread->sp += 3;
                } else {
                    ...
                    _objectAccessBarrier->inlineMixedObjectStoreU32(
                        _currentThread, objectref, fieldOffset, *(U_32*)_currentThread->sp, isVolatile);
                    _currentThread->sp += 2;
                }
            } else {
                j9object_t objectref = *(j9object_t*)(_currentThread->sp + 1);
                ...
                _objectAccessBarrier->inlineMixedObjectStoreObject(
                    _currentThread, objectref, fieldOffset, *(j9object_t*)_currentThread->sp, isVolatile);
                _currentThread->sp += 2;
            }
        ...
        case J9_METHOD_HANDLE_KIND_GET_STATIC_FIELD: {
            ...
            bool isVolatile = (J9StaticFieldRefVolatile == (modifiers & J9StaticFieldRefVolatile));
            {
                if (J9ROMCLASS_IS_PRIMITIVE_TYPE(fieldClass->romClass)) {
                    if (8 == ((J9ROMReflectClass*)(fieldClass->romClass))->elementSize) {
                        _currentThread->sp -= 1;
                        *(U_64*)_currentThread->sp = _objectAccessBarrier->inlineStaticReadU64(
                            _currentThread, defc, (U_64*)srcAddress, isVolatile);
                    } else {
                        *(U_32*)_currentThread->sp = _objectAccessBarrier->inlineStaticReadU32(
                            _currentThread, defc, (U_32*)srcAddress, isVolatile);
                    }
                } else {
                    *(j9object_t*)_currentThread->sp = _objectAccessBarrier->inlineStaticReadObject(
                        _currentThread, defc, (j9object_t*)srcAddress, isVolatile);
                }
            }
            goto returnFromSend;
        }
        case J9_METHOD_HANDLE_KIND_PUT_STATIC_FIELD: {
            ...
            srcAddress &= ~J9_SUN_FIELD_OFFSET_MASK;
            srcAddress += (UDATA)defc->ramStatics;
            j9object_t fieldClassObject = J9JAVAARRAYOFOBJECT_LOAD(_currentThread, getMethodTypeArguments(type), 0);
            J9Class* fieldClass = J9VM_J9CLASS_FROM_HEAPCLASS(_currentThread, fieldClassObject);
            U_32 modifiers = getPrimitiveHandleModifiers(methodHandle);
            bool isVolatile = (J9StaticFieldRefVolatile == (modifiers & J9StaticFieldRefVolatile));
            {
                if (J9ROMCLASS_IS_PRIMITIVE_TYPE(fieldClass->romClass)) {
                    if (8 == ((J9ROMReflectClass*)(fieldClass->romClass))->elementSize) {
                        _objectAccessBarrier->inlineStaticStoreU64(
                            _currentThread, defc, (U_64*)srcAddress, *(U_64*)_currentThread->sp, isVolatile);
                        _currentThread->sp += 3;
                    } else {
                        _objectAccessBarrier->inlineStaticStoreU32(
                            _currentThread, defc, (U_32*)srcAddress, *(U_32*)_currentThread->sp, isVolatile);
                        _currentThread->sp += 2;
                    }
                } else {
                    _objectAccessBarrier->inlineStaticStoreObject(
                        _currentThread, defc, (j9object_t*)srcAddress, *(j9object_t*)_currentThread->sp, isVolatile);
                    _currentThread->sp += 2;
                }
            }
            goto returnFromSend;
        ...
        case J9_METHOD_HANDLE_KIND_VARHANDLE_INVOKE_GENERIC: {
            ...
            j9object_t accessModeType
                = J9VMJAVALANGINVOKEVARHANDLEINVOKEHANDLE_ACCESSMODETYPE(_currentThread, methodHandle);
            ...
            if (accessModeType == handleTypeFromTable) {
                ...
                sendForGenericInvoke(
                    _currentThread, methodHandleFromTable, accessModeType, FALSE /* dropFirstArg */, 0 /* reserved */);
...
VM_BytecodeAction VM_MHInterpreter::impdep1()
{
    ...
    if (J9VMJAVALANGINVOKEMETHODHANDLE_CONSTRUCTORPLACEHOLDER_METHOD(_vm) == _currentThread->literals) {
        ...
        /* Overwrite inital GWT_Handle with either GWT_Handle.trueTarget or GWT_Handle.falseTarget based upon
         * testHandleReturnValue */
        ...
        *(j9object_t*)(mhPtr) = nextHandle;
        ...
        /* [... FAH[1] args MTFrame FAH.next UpdatedArgs MTFrame FAH[2] index parentOffset nextOffset PlaceHolderFrame
         * filterReturnValue] */
        ...
        frame = ((J9SFStackFrame*)(_currentThread->arg0EA - 3))
            - 1; /* Recalculate frame location while taking into account 4 placeHolderMethod arguments */
        ...
        J9Class* returnClass = J9VM_J9CLASS_FROM_HEAPCLASS(
            _currentThread, J9JAVAARRAYOFOBJECT_LOAD(_currentThread, nextTypeArguments, (startPosition + *index)));
        ...
        *nextOffset += returnArgSlots;
        ...
        for (; i < filtersLength; i++) {
            ...
            currentParentClass = J9VM_J9CLASS_FROM_HEAPCLASS(
                _currentThread, J9JAVAARRAYOFOBJECT_LOAD(_currentThread, parentTypeArguments, (startPosition + i)));
            if (NULL == currentFilterHandle) {
                if (_vm->voidReflectClass != currentParentClass) {
                    *--nextPtr = *--parentPtr;
                    offset += 1;
                    if ((_vm->doubleReflectClass == currentParentClass)
                        || (_vm->longReflectClass == currentParentClass)) {
                        *--nextPtr = *--parentPtr;
                        offset += 1;
                    }
                }
...
extern "C" J9SFMethodTypeFrame* buildMethodTypeFrame(J9VMThread* currentThread, j9object_t methodType)
{
...
j9object_t VM_MHInterpreter::convertArgumentsForAsType(j9object_t methodHandle)
{
    ...
    U_32 nextArgSlots = (U_32)J9VMJAVALANGINVOKEMETHODTYPE_ARGSLOTS(_currentThread, nextType);
    UDATA explicitCast
        = (J9VMJAVALANGINVOKEMETHODHANDLE_KIND(_currentThread, methodHandle) == J9_METHOD_HANDLE_KIND_EXPLICITCAST);
    ...
    if (0 != requiresBoxing) {
        ...
        *--(_currentThread->sp) = (UDATA)nextHandle;
        ...
        rc = convertArguments(currentArgs, &currentTypeFrame->methodType, nextArgs, &nextTypeFrame->methodType,
            explicitCast, &exceptionData);
        if (NO_EXCEPTION != rc) {
...
j9object_t VM_MHInterpreter::doInvokeGeneric(j9object_t methodHandle)
{
...
j9object_t VM_MHInterpreter::spreadForAsSpreader(j9object_t methodHandle)
{
    ...
    if (0 == spreadCount) {
         ...
         */
        if (isPrimitiveType && ((argumentClazz == _vm->longArrayClass) || (argumentClazz == _vm->doubleArrayClass))) {
...
j9object_t VM_MHInterpreter::collectForAsCollector(j9object_t methodHandle, BOOLEAN* foundHeapOOM)
{
    j9object_t currentType = getMethodHandleMethodType(methodHandle);
    U_32 currentArgSlots = getMethodTypeArgSlots(currentType);
    ...
    j9object_t posArgumentType
        = _objectAccessBarrier->inlineIndexableObjectReadObject(_currentThread, argumentTypes, collectPosition);
    ...
    if (NULL == collectedArgsArrayRef) {
        ...
        collectedArgsArrayRef = _vm->memoryManagerFunctions->J9AllocateIndexableObject(
            _currentThread, posArgumentClass, collectArraySize, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
        if (NULL == collectedArgsArrayRef) {
            *foundHeapOOM = TRUE;
    ...
    if (0 == currentArgSlots) {
        ...
        if (!J9ROMCLASS_IS_PRIMITIVE_TYPE(arrayComponentClass->romClass)) {
            ...
            while (0 != collectCount) {
                collectCount -= 1;
                _objectAccessBarrier->inlineIndexableObjectStoreObject(
                    _currentThread, collectedArgsArrayRef, collectCount, *(j9object_t*)spPtr);
                spPtr += 1;
            }
        } else {
...
U_32 VM_MHInterpreter::getArgSlotsBeforePosition(j9object_t argumentTypes, U_32 argPosition)
{
    ...
    for (argumentIndex = 0; argumentIndex < argPosition; argumentIndex++) {
        j9object_t argumentTypeAtIndex
            = _objectAccessBarrier->inlineIndexableObjectReadObject(_currentThread, argumentTypes, argumentIndex);
        J9Class* argumentClassAtIndex = J9VM_J9CLASS_FROM_HEAPCLASS(_currentThread, argumentTypeAtIndex);

        if ((_vm->doubleReflectClass == argumentClassAtIndex) || (_vm->longReflectClass == argumentClassAtIndex)) {
            argumentSlots += 2;
        } else {
            argumentSlots += 1;
        }
...
j9object_t VM_MHInterpreter::foldForFoldArguments(j9object_t methodHandle)
{
    ...
    insertPlaceHolderFrame(
        foldArgSlots, methodHandle, J9VMJAVALANGINVOKEMETHODHANDLE_FOLDHANDLEPLACEHOLDER_METHOD(_vm));
    ...
    if (0 == argumentIndicesCount) {
        ...
        for (arrayIndex = 0; arrayIndex < argumentIndicesCount; arrayIndex++) {
             ...
             */
            j9object_t argumentTypeAtIndex = _objectAccessBarrier->inlineIndexableObjectReadObject(
                _currentThread, argumentTypes, argumentTypeIndex);
            J9Class* argumentClassAtIndex = J9VM_J9CLASS_FROM_HEAPCLASS(_currentThread, argumentTypeAtIndex);
...
j9object_t VM_MHInterpreter::insertReturnValueForFoldArguments()
{
    UDATA* bp = _currentThread->arg0EA - (sizeof(J9SFStackFrame) / sizeof(UDATA*));
    J9SFStackFrame* frame = (J9SFStackFrame*)(bp);
...
j9object_t VM_MHInterpreter::permuteForPermuteHandle(j9object_t methodHandle)
{
    j9object_t currentType = J9VMJAVALANGINVOKEMETHODHANDLE_TYPE(_currentThread, methodHandle);
    ...
    *(j9object_t*)(_currentThread->sp + currentArgSlots) = nextHandle;
    ...
    for (i = 0; i < currentTypeArgumentsLength; i++) {
        J9Class* sourceClass = J9VM_J9CLASS_FROM_HEAPCLASS(
            _currentThread, J9JAVAARRAYOFOBJECT_LOAD(_currentThread, currentTypeArguments, i));
        U_32 j = 0;
    ...
    for (i = 0; i < permuteArrayLength; i++) {
        ...
        J9Class* sourceClass = J9VM_J9CLASS_FROM_HEAPCLASS(
            _currentThread, J9JAVAARRAYOFOBJECT_LOAD(_currentThread, currentTypeArguments, sourceArgument));
...
j9object_t VM_MHInterpreter::insertArgumentsForInsertHandle(j9object_t methodHandle)
{
    j9object_t currentType = J9VMJAVALANGINVOKEMETHODHANDLE_TYPE(_currentThread, methodHandle);
    U_32 currentArgSlots = (U_32)J9VMJAVALANGINVOKEMETHODTYPE_ARGSLOTS(_currentThread, currentType);
    j9object_t currentTypeArguments = J9VMJAVALANGINVOKEMETHODTYPE_ARGUMENTS(_currentThread, currentType);
    ...
    *(j9object_t*)(_currentThread->sp + currentArgSlots) = nextHandle;
    ...
    if (currentArgSlots != currentTypeArgumentsLength) {
        ...
        for (j = 0; j < insertionIndex; j++) {
            J9Class* sourceClass = J9VM_J9CLASS_FROM_HEAPCLASS(
                _currentThread, J9JAVAARRAYOFOBJECT_LOAD(_currentThread, currentTypeArguments, j));
...
void VM_MHInterpreter::primitiveArraySpread(j9object_t arrayObject, I_32 spreadCount, J9Class* arrayClass)
{
    I_32 i;
    J9JavaVM* vm = _currentThread->javaVM;
...
void VM_MHInterpreter::primitiveArrayCollect(
    j9object_t collectedArgsArrayRef, U_32 collectArraySize, J9Class* arrayComponentClass)
{
    ...
    if (_vm->booleanReflectClass == arrayComponentClass) {
        while (0 != collectCount) {
            collectCount -= 1;
            _objectAccessBarrier->inlineIndexableObjectStoreU8(
                _currentThread, collectedArgsArrayRef, collectCount, (U_8) * (I_32*)spPtr);
            spPtr += 1;
        }
    } else if (_vm->byteReflectClass == arrayComponentClass) {
        while (0 != collectCount) {
            collectCount -= 1;
            _objectAccessBarrier->inlineIndexableObjectStoreI8(
                _currentThread, collectedArgsArrayRef, collectCount, (I_8) * (I_32*)spPtr);
            spPtr += 1;
        }
    } else if (_vm->charReflectClass == arrayComponentClass) {
        while (0 != collectCount) {
            collectCount -= 1;
            _objectAccessBarrier->inlineIndexableObjectStoreU16(
                _currentThread, collectedArgsArrayRef, collectCount, (U_16) * (I_32*)spPtr);
            spPtr += 1;
        }
    } else if (_vm->shortReflectClass == arrayComponentClass) {
        while (0 != collectCount) {
            collectCount -= 1;
            _objectAccessBarrier->inlineIndexableObjectStoreI16(
                _currentThread, collectedArgsArrayRef, collectCount, (I_16) * (I_32*)spPtr);
            spPtr += 1;
        }
    } else if (_vm->intReflectClass == arrayComponentClass) {
        while (0 != collectCount) {
            collectCount -= 1;
            _objectAccessBarrier->inlineIndexableObjectStoreI32(
                _currentThread, collectedArgsArrayRef, collectCount, *(I_32*)spPtr);
            spPtr += 1;
        }
    } else if (_vm->floatReflectClass == arrayComponentClass) {
        while (0 != collectCount) {
            collectCount -= 1;
            _objectAccessBarrier->inlineIndexableObjectStoreU32(
                _currentThread, collectedArgsArrayRef, collectCount, *(U_32*)spPtr);
            spPtr += 1;
        }
    } else if (_vm->doubleReflectClass == arrayComponentClass) {
        while (0 != collectCount) {
            collectCount -= 1;
            _objectAccessBarrier->inlineIndexableObjectStoreU64(
                _currentThread, collectedArgsArrayRef, collectCount, *(U_64*)spPtr);
            spPtr += 2;
        }
        ...
        while (0 != collectCount) {
            collectCount -= 1;
            _objectAccessBarrier->inlineIndexableObjectStoreI64(
                _currentThread, collectedArgsArrayRef, collectCount, *(I_64*)spPtr);
            spPtr += 2;
        }
    } else {
        Assert_VM_unreachable();
...
ExceptionType VM_MHInterpreter::convertArguments(UDATA* currentArgs, j9object_t* currentType, UDATA* nextArgs,
    j9object_t* nextType, UDATA explicitCast, ClassCastExceptionData* exceptionData)
{
    U_32 argCount = (U_32)J9INDEXABLEOBJECT_SIZE(
        _currentThread, J9VMJAVALANGINVOKEMETHODTYPE_ARGUMENTS(_currentThread, *currentType));
    U_32 i;
    J9JavaVM* vm = _currentThread->javaVM;
    ...
    for (i = 0; i < argCount; ++i) {
        J9Class* currentClass = J9VM_J9CLASS_FROM_HEAPCLASS(_currentThread,
            J9JAVAARRAYOFOBJECT_LOAD(
                _currentThread, J9VMJAVALANGINVOKEMETHODTYPE_ARGUMENTS(_currentThread, *currentType), i));
        J9Class* nextClass = J9VM_J9CLASS_FROM_HEAPCLASS(_currentThread,
            J9JAVAARRAYOFOBJECT_LOAD(
                _currentThread, J9VMJAVALANGINVOKEMETHODTYPE_ARGUMENTS(_currentThread, *nextType), i));
            ...
            if (J9ROMCLASS_IS_PRIMITIVE_TYPE(currentClass->romClass)) {
                if (J9ROMCLASS_IS_PRIMITIVE_TYPE(nextClass->romClass)) {
                    ...
                    *(I_32*)--nextArgs = intValue;
                    ...
                    if (currentClass == booleanReflectClass) {
                        box = vm->memoryManagerFunctions->J9AllocateObject(
                            _currentThread, booleanWrapperClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (box != NULL) {
                            intValue = *(I_32*)--currentArgs;
                        ...
                        box = vm->memoryManagerFunctions->J9AllocateObject(
                            _currentThread, byteWrapperClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (box != NULL) {
                            intValue = *(I_32*)--currentArgs;
                        ...
                        box = vm->memoryManagerFunctions->J9AllocateObject(
                            _currentThread, shortWrapperClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (box != NULL) {
                            intValue = *(I_32*)--currentArgs;
                        ...
                        box = vm->memoryManagerFunctions->J9AllocateObject(
                            _currentThread, charWrapperClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (box != NULL) {
                        ...
                        box = vm->memoryManagerFunctions->J9AllocateObject(
                            _currentThread, intWrapperClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (box != NULL) {
                            intValue = *(I_32*)--currentArgs;
                        ...
                        box = vm->memoryManagerFunctions->J9AllocateObject(
                            _currentThread, floatWrapperClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (box != NULL) {
                            U_32 u32Value = *(U_32*)--currentArgs;
                        ...
                        box = vm->memoryManagerFunctions->J9AllocateObject(
                            _currentThread, doubleWrapperClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (box != NULL) {
                            U_64 u64Value;
                        ...
                        box = vm->memoryManagerFunctions->J9AllocateObject(
                            _currentThread, longWrapperClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                        if (box != NULL) {
                            memcpy(&longValue, currentArgs -= 2, sizeof(longValue));
                ...
                if (J9ROMCLASS_IS_PRIMITIVE_TYPE(nextClass->romClass)) {
                    ...
                    if (currentClass == floatWrapperClass) {
                        ...
                        *(U_32*)--nextArgs = temp;
                        ...
                        if (!explicitCast) {
                            if ((nextClass == booleanReflectClass) || (nextClass == byteReflectClass)
                                || (nextClass == charReflectClass)) {
                                goto classCastException;
                            }
                        }
                        goto convertInt;
                        ...
                        if (!explicitCast) {
                            if ((nextClass == booleanReflectClass) || (nextClass == byteReflectClass)
                                || (nextClass == shortReflectClass) || (nextClass == charReflectClass)) {
                                goto classCastException;
                            }
                        }
                        goto convertInt;
...
U_8 VM_MHInterpreter::doesMHandStackMHMatch(j9object_t methodhandle)
{
    j9object_t currentType = J9VMJAVALANGINVOKEMETHODHANDLE_TYPE(_currentThread, methodhandle);
    U_32 currentArgSlots = (U_32)J9VMJAVALANGINVOKEMETHODTYPE_ARGSLOTS(_currentThread, currentType);
...
void VM_MHInterpreter::mhStackValidator(j9object_t methodhandle)
{
    J9JavaVM* vm = _currentThread->javaVM;
    J9Class* doubleReflectClass = vm->doubleReflectClass;
    J9Class* longReflectClass = vm->longReflectClass;
    ...
    for (i = 0; i < argCount; ++i) {
        J9Class* currentClass
            = J9VM_J9CLASS_FROM_HEAPCLASS(_currentThread, J9JAVAARRAYOFOBJECT_LOAD(_currentThread, arguments, i));
            ...
            if (NULL != stackObject) {
                ...
                if (J9ROMCLASS_IS_INTERFACE(currentClass->romClass)) {
                    ...
                    if (0 == instanceOfOrCheckCast(stackClass, currentClass)) {
                        ...
                        Trc_VM_mhStackValidator_mh_class(
                            _currentThread, J9UTF8_LENGTH(className), J9UTF8_DATA(className));
                        j9tty_printf(
                            vm->portLibrary, "\tClass = %.*s\n", J9UTF8_LENGTH(className), J9UTF8_DATA(className));
                        ...
                        Trc_VM_mhStackValidator_sp_class(
                            _currentThread, J9UTF8_LENGTH(className), J9UTF8_DATA(className));
                        j9tty_printf(
                            vm->portLibrary, "\tClass = %.*s\n", J9UTF8_LENGTH(className), J9UTF8_DATA(className));
...
#ifdef J9VM_OPT_PANAMA
VMINLINE VM_BytecodeAction VM_MHInterpreter::runNativeMethodHandle(j9object_t methodHandle)
{
...
VMINLINE FFI_Return VM_MHInterpreter::callFunctionFromNativeMethodHandle(
    void* nativeMethodStartAddress, UDATA* javaArgs, U_8* returnType, j9object_t methodHandle)
{
    UDATA structReturnSize = 0;
    FFI_Return result = nativeMethodHandleCallout(nativeMethodStartAddress, javaArgs, returnType, methodHandle,
        &(_currentThread->returnValue), &structReturnSize);
...
VMINLINE FFI_Return VM_MHInterpreter::nativeMethodHandleCallout(void* function, UDATA* javaArgs, U_8* returnType,
    j9object_t methodHandle, void* returnStorage, UDATA* structReturnSize)
{
    ...
    J9NativeCalloutData* nativeCalloutData
        = J9VMJAVALANGINVOKENATIVEMETHODHANDLE_J9NATIVECALLOUTDATAREF(_currentThread, methodHandle);
    ...
    *returnType = getJ9NativeTypeCode(returnTypeClass);
    ...
    if (isMinimal) {
        ...
        values_raw = (ffi_raw*)j9mem_allocate_memory(
            (valRawWorstCaseMulFactor * sizeof(ffi_raw)) * argCount, OMRMEM_CATEGORY_VM);
        if (NULL == values_raw) {
            goto ffi_exit;
        }
#endif /* FFI_NATIVE_RAW_API */
    }
    {
        ...
        for (U_8 i = 0; i < argTypeCount; i++) {
            ...
            /**
             * args[0] is the ffi_type of the return argument of the method. The remaining args array contains the
             * ffi_type of the input arguments. This loop is traversing the input arguments of the method.
             */
        ...
        if (FFI_OK == status) {
            /**
             * TODO Add ZOS support to perform the zaap offload switch. See VM_VMHelpers::beforeJNICall(_currentThread)
             * and VM_VMHelpers::afterJNICall(_currentThread). In these functions, the J9Method in the
             * J9SFJNINativeMethodFrame is incorrect for Panama native calls.
             */
