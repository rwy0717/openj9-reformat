...
typedef enum { NO_EXCEPTION, NULL_POINTER_EXCEPTION, CLASS_CAST_EXCEPTION } ExceptionType;
...
private:
     ...
     */
    VMINLINE UDATA getVMSlot(j9object_t primitiveHandle) const
    {
     ...
     */
    VMINLINE U_32 getPrimitiveHandleModifiers(j9object_t primitiveHandle) const
    {
     ...
     */
    VMINLINE J9Class* getPrimitiveHandleDefc(j9object_t primitiveHandle) const
    {
        return J9VM_J9CLASS_FROM_HEAPCLASS(
            _currentThread, J9VMJAVALANGINVOKEPRIMITIVEHANDLE_DEFC(_currentThread, primitiveHandle));
    }
     ...
     */
    VMINLINE U_32 getMethodHandleKind(j9object_t methodHandle) const
    {
     ...
     */
    VMINLINE j9object_t getMethodHandleMethodType(j9object_t methodHandle) const
    {
     ...
     */
    VMINLINE U_32 getMethodTypeArgSlots(j9object_t methodType) const
    {
     ...
     */
    VMINLINE j9object_t getMethodHandleArrayClass(j9object_t methodHandle) const
    {
     ...
     */
    VMINLINE U_32 getMethodHandleFoldPosition(j9object_t methodHandle) const
    {
     ...
     */
    VMINLINE j9object_t getCombinerHandle(j9object_t methodHandle) const
    {
     ...
     */
    VMINLINE J9Class* getMethodTypeReturnClass(j9object_t methodType) const
    {
        return J9VM_J9CLASS_FROM_HEAPCLASS(
            _currentThread, J9VMJAVALANGINVOKEMETHODTYPE_RETURNTYPE(_currentThread, methodType));
    }
     ...
     */
    VMINLINE j9object_t getMethodTypeArguments(j9object_t methodType) const
    {
     ...
     */
    VMINLINE bool isVolatileCallsite(j9object_t callsite) const
    {
     ...
     */
    VMINLINE void dropAllArgumentsLeavingMH(j9object_t methodHandle) const
    {
     ...
     */
    VMINLINE void shiftStackedArguments(U_32 slotCount) const
    {
     ...
     */
    VMINLINE VM_BytecodeAction returnFromSend() const
    {
        _currentThread->pc += 3;
     ...
     */
    VMINLINE J9Method* convertITableIndexToVirtualMethod(
        J9Class* receiverClass, J9Class* interfaceClass, UDATA iTableIndex) const
    {
     ...
     */
    VMINLINE void restoreMethodTypeFrame(J9SFMethodTypeFrame* frame, UDATA* spPriorToFrameBuild) const
    {
     ...
     */
    VMINLINE void insertPlaceHolderFrame(U_32 slotCount, j9object_t preservedObject, J9Method* placeHolderMethod) const
    {
     ...
     * @param placeHolderMethod[in] The J9Method to become literals.
     */
    VMINLINE void insertFourArgumentPlaceHolderFrame(U_32 slotCount, j9object_t preservedObject1, U_32 preservedValue1,
        U_32 preservedValue2, U_32 preservedValue3, J9Method* placeHolderMethod) const
    {
        const UDATA sizeof_J9SFStackFrame_inSlots = (sizeof(J9SFStackFrame) / sizeof(UDATA*));
     ...
     * @return
     */
    VMINLINE j9object_t initializeClassIfNeeded(j9object_t methodHandle)
    {
     ...
     */
    VMINLINE void convertJNIReturnValue(U_8 returnType, UDATA* returnStorage, j9object_t methodHandle, UDATA structSize)
    {
        switch (returnType) {
        case J9NtcBoolean:
     ...
     */
    VMINLINE U_8 getJ9NativeTypeCode(J9Class* type)
    {
        U_8 typeCode = 0;
     ...
     */
    j9object_t convertArgumentsForAsType(j9object_t methodHandle);
     ...
     * @return j9object_t The target MethodHandle (the one to execute next)
     */
    j9object_t doInvokeGeneric(j9object_t methodHandle);
     ...
     * @return j9object_t The target MethodHandle (the one to execute next)
     */
    j9object_t spreadForAsSpreader(j9object_t methodHandle);
     ...
     * @return j9object_t The target MethodHandle  (the one to execute next)
     */
    j9object_t collectForAsCollector(j9object_t methodHandle, BOOLEAN* foundHeapOOM);
     ...
     */
    U_32 getArgSlotsBeforePosition(j9object_t argumentTypes, U_32 argPosition);
     ...
     */
    j9object_t foldForFoldArguments(j9object_t methodHandle);
     ...
     */
    j9object_t insertReturnValueForFoldArguments();
     ...
     * @return j9object_t The target MethodHandle (the one to execute next)
     */
    j9object_t permuteForPermuteHandle(j9object_t methodHandle);
     ...
     * @return j9object_t The target MethodHandle (the one to execute next)
     */
    j9object_t insertArgumentsForInsertHandle(j9object_t methodHandle);
     ...
     * @param arrayClass
     */
    void primitiveArraySpread(j9object_t arrayObject, I_32 spreadCount, J9Class* arrayClass);
     ...
     */
    void primitiveArrayCollect(j9object_t collectedArgsArrayRef, U_32 collectArraySize, J9Class* arrayComponentClass);
     ...
     */
    ExceptionType convertArguments(UDATA* currentArgs, j9object_t* currentType, UDATA* nextArgs, j9object_t* nextType,
        UDATA explicitCast, ClassCastExceptionData* exceptionData);
     ...
     */
    U_8 doesMHandStackMHMatch(j9object_t methodhandle);
     ...
     * @return void
     */
    void mhStackValidator(j9object_t methodhandle);

#ifdef J9VM_OPT_PANAMA
    VMINLINE VM_BytecodeAction runNativeMethodHandle(j9object_t methodHandle);

    VMINLINE FFI_Return callFunctionFromNativeMethodHandle(
        void* nativeMethodStartAddress, UDATA* javaArgs, U_8* returnType, j9object_t methodHandle);

    VMINLINE FFI_Return nativeMethodHandleCallout(void* function, UDATA* javaArgs, U_8* returnType,
        j9object_t methodHandle, void* returnStorage, UDATA* structSize);
#endif /* J9VM_OPT_PANAMA */

#if defined(ENABLE_DEBUG_FUNCTIONS)
    void printStack(U_32 numSlots)
    {
...
public:
     ...
     */
    VM_BytecodeAction dispatchLoop(j9object_t methodHandle);
     ...
     * 		Refer to the implementation in MHInterpreter.cpp
     */
    VM_BytecodeAction impdep1();

    VM_MHInterpreter(J9VMThread* currentThread, MM_ObjectAllocationAPI* objectAllocate,
