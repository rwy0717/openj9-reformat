...
static UDATA bindNative(
    J9VMThread* currentThread, J9Method* nativeMethod, char* longJNI, char* shortJNI, UDATA bindJNINative);
static UDATA lookupNativeAddress(J9VMThread* currentThread, J9Method* nativeMethod, J9NativeLibrary* handle,
    char* longJNI, char* shortJNI, UDATA functionArgCount, UDATA bindJNINative);
...
static inlMapping mappings[] = {
    ...
    { "Java_java_lang_J9VMInternals_getSuperclass__Ljava_lang_Class_2",
        J9_BCLOOP_SEND_TARGET_INL_INTERNALS_GET_SUPERCLASS },
    { "Java_java_lang_J9VMInternals_identityHashCode__Ljava_lang_Object_2",
    ...
    { "Java_sun_misc_Unsafe_putByteVolatile__Ljava_lang_Object_2JB",
    ...
    { "Java_sun_misc_Unsafe_getBooleanVolatile__Ljava_lang_Object_2J",
    ...
    { "Java_sun_misc_Unsafe_putBooleanVolatile__Ljava_lang_Object_2JZ",
    ...
    { "Java_sun_misc_Unsafe_getShortVolatile__Ljava_lang_Object_2J",
    ...
    { "Java_sun_misc_Unsafe_putShortVolatile__Ljava_lang_Object_2JS",
    ...
    { "Java_sun_misc_Unsafe_putCharVolatile__Ljava_lang_Object_2JC",
    ...
    { "Java_sun_misc_Unsafe_getFloatVolatile__Ljava_lang_Object_2J",
    ...
    { "Java_sun_misc_Unsafe_putFloatVolatile__Ljava_lang_Object_2JF",
    ...
    { "Java_sun_misc_Unsafe_putLongVolatile__Ljava_lang_Object_2JJ",
    ...
    { "Java_sun_misc_Unsafe_getDoubleVolatile__Ljava_lang_Object_2J",
    ...
    { "Java_sun_misc_Unsafe_putDoubleVolatile__Ljava_lang_Object_2JD",
    ...
    { "Java_sun_misc_Unsafe_getObjectVolatile__Ljava_lang_Object_2J",
    ...
    { "Java_sun_misc_Unsafe_putOrderedObject__Ljava_lang_Object_2JLjava_lang_Object_2",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTOBJECT_VOLATILE },
    ...
    { "Java_sun_misc_Unsafe_compareAndSwapInt__Ljava_lang_Object_2JII",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_COMPAREANDSWAPINT },
    { "Java_java_lang_J9VMInternals_prepareClassImpl__Ljava_lang_Class_2",
    ...
    { "Java_java_lang_reflect_Array_newArrayImpl__Ljava_lang_Class_2I",
        J9_BCLOOP_SEND_TARGET_INL_ARRAY_NEW_ARRAY_IMPL },
    { "Java_java_lang_ClassLoader_findLoadedClassImpl__Ljava_lang_String_2",
        J9_BCLOOP_SEND_TARGET_INL_CLASSLOADER_FIND_LOADED_CLASS_IMPL },
    { "Java_java_lang_VMAccess_findClassOrNull__Ljava_lang_String_2Ljava_lang_ClassLoader_2",
        J9_BCLOOP_SEND_TARGET_INL_VM_FIND_CLASS_OR_NULL },
    { "Java_java_lang_Class_forNameImpl__Ljava_lang_String_2ZLjava_lang_ClassLoader_2",
    ...
    { "Java_org_apache_harmony_kernel_vm_VM_getStackClassLoader__I",
    ...
    { "Java_com_ibm_oti_vm_VM_initializeClassLoader__Ljava_lang_ClassLoader_2IZ",
        J9_BCLOOP_SEND_TARGET_INL_VM_INITIALIZE_CLASS_LOADER },
    { "Java_com_ibm_oti_vm_VM_getClassPathEntryType__Ljava_lang_Object_2I",
        J9_BCLOOP_SEND_TARGET_INL_VM_GET_CLASS_PATH_ENTRY_TYPE },
    { "Java_com_ibm_oti_vm_VM_isBootstrapClassLoader__Ljava_lang_ClassLoader_2",
    ...
    { "Java_com_ibm_tools_attach_target_Attachment_loadAgentLibraryImpl__Ljava_lang_ClassLoader_2Ljava_lang_String_"
      "2Ljava_lang_String_2Z",
    ...
    { "Java_java_lang_ClassLoader_initAnonClassLoader__Ljava_lang_InternalAnonymousClassLoader_2",
    ...
    { "Java_jdk_internal_misc_Unsafe_getByteVolatile__Ljava_lang_Object_2J",
    ...
    { "Java_jdk_internal_misc_Unsafe_getShortVolatile__Ljava_lang_Object_2J",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_GETSHORT_VOLATILE },
    ...
    { "Java_jdk_internal_misc_Unsafe_putShortVolatile__Ljava_lang_Object_2JS",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTSHORT_VOLATILE },
    ...
    { "Java_jdk_internal_misc_Unsafe_getCharVolatile__Ljava_lang_Object_2J",
    ...
    { "Java_jdk_internal_misc_Unsafe_putCharVolatile__Ljava_lang_Object_2JC",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTCHAR_VOLATILE },
    ...
    { "Java_jdk_internal_misc_Unsafe_getIntVolatile__Ljava_lang_Object_2J",
    ...
    { "Java_jdk_internal_misc_Unsafe_putIntVolatile__Ljava_lang_Object_2JI",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTINT_VOLATILE },
    { "Java_jdk_internal_misc_Unsafe_putOrderedInt__Ljava_lang_Object_2JI",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTINT_VOLATILE },
    ...
    { "Java_jdk_internal_misc_Unsafe_getFloatVolatile__Ljava_lang_Object_2J",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_GETFLOAT_VOLATILE },
    ...
    { "Java_jdk_internal_misc_Unsafe_putFloatVolatile__Ljava_lang_Object_2JF",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTFLOAT_VOLATILE },
    ...
    { "Java_jdk_internal_misc_Unsafe_getLongVolatile__Ljava_lang_Object_2J",
    ...
    { "Java_jdk_internal_misc_Unsafe_putLongVolatile__Ljava_lang_Object_2JJ",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTLONG_VOLATILE },
    { "Java_jdk_internal_misc_Unsafe_putOrderedLong__Ljava_lang_Object_2JJ",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTLONG_VOLATILE },
    ...
    { "Java_jdk_internal_misc_Unsafe_getDoubleVolatile__Ljava_lang_Object_2J",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_GETDOUBLE_VOLATILE },
    ...
    { "Java_jdk_internal_misc_Unsafe_putDoubleVolatile__Ljava_lang_Object_2JD",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTDOUBLE_VOLATILE },
    ...
    { "Java_jdk_internal_misc_Unsafe_getObjectVolatile__Ljava_lang_Object_2J",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_GETOBJECT_VOLATILE },
    { "Java_jdk_internal_misc_Unsafe_putObject__Ljava_lang_Object_2JLjava_lang_Object_2",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTOBJECT },
    { "Java_jdk_internal_misc_Unsafe_putObjectVolatile__Ljava_lang_Object_2JLjava_lang_Object_2",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTOBJECT_VOLATILE },
    { "Java_jdk_internal_misc_Unsafe_putOrderedObject__Ljava_lang_Object_2JLjava_lang_Object_2",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_PUTOBJECT_VOLATILE },
    ...
    { "Java_jdk_internal_misc_Unsafe_arrayBaseOffset__Ljava_lang_Class_2",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_ARRAY_BASE_OFFSET },
    { "Java_jdk_internal_misc_Unsafe_arrayBaseOffset0__Ljava_lang_Class_2",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_ARRAY_BASE_OFFSET },
    { "Java_jdk_internal_misc_Unsafe_arrayIndexScale__Ljava_lang_Class_2",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_ARRAY_INDEX_SCALE },
    { "Java_jdk_internal_misc_Unsafe_arrayIndexScale0__Ljava_lang_Class_2",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_ARRAY_INDEX_SCALE },
    ...
    { "Java_jdk_internal_misc_Unsafe_compareAndSwapInt__Ljava_lang_Object_2JII",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_COMPAREANDSWAPINT },
    { "Java_jdk_internal_misc_Unsafe_compareAndSetObject__Ljava_lang_Object_2JLjava_lang_Object_2Ljava_lang_Object_2",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_COMPAREANDSWAPOBJECT },
    { "Java_jdk_internal_misc_Unsafe_compareAndSetLong__Ljava_lang_Object_2JJJ",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_COMPAREANDSWAPLONG },
    { "Java_jdk_internal_misc_Unsafe_compareAndSetInt__Ljava_lang_Object_2JII",
        J9_BCLOOP_SEND_TARGET_INL_UNSAFE_COMPAREANDSWAPINT },
    { "Java_jdk_internal_misc_Unsafe_allocateInstance__Ljava_lang_Class_2",
...
static J9OutOfLineINLMapping outOfLineINLmappings[] = {
    ...
    { "Java_jdk_internal_misc_Unsafe_compareAndExchangeObjectVolatile__Ljava_lang_Object_2JLjava_lang_Object_2Ljava_"
      "lang_Object_2",
        OutOfLineINL_jdk_internal_misc_Unsafe_compareAndExchangeObjectVolatile },
    { "Java_jdk_internal_misc_Unsafe_compareAndExchangeObject__Ljava_lang_Object_2JLjava_lang_Object_2Ljava_lang_"
      "Object_2",
        OutOfLineINL_jdk_internal_misc_Unsafe_compareAndExchangeObjectVolatile },
    { "Java_jdk_internal_misc_Unsafe_compareAndExchangeIntVolatile__Ljava_lang_Object_2JII",
    ...
    { "Java_jdk_internal_misc_Unsafe_compareAndExchangeInt__Ljava_lang_Object_2JII",
        OutOfLineINL_jdk_internal_misc_Unsafe_compareAndExchangeIntVolatile },
    { "Java_jdk_internal_misc_Unsafe_compareAndExchangeLongVolatile__Ljava_lang_Object_2JJJ",
        OutOfLineINL_jdk_internal_misc_Unsafe_compareAndExchangeLongVolatile },
    { "Java_jdk_internal_misc_Unsafe_compareAndExchangeLong__Ljava_lang_Object_2JJJ",
        OutOfLineINL_jdk_internal_misc_Unsafe_compareAndExchangeLongVolatile },
    { "Java_com_ibm_jit_JITHelpers_acmplt__Ljava_lang_Object_2Ljava_lang_Object_2",
        OutOfLineINL_com_ibm_jit_JITHelpers_acmplt },
#if defined(J9VM_OPT_PANAMA)
    { "Java_java_lang_invoke_NativeMethodHandle_initJ9NativeCalloutDataRef___3Ljava_lang_String_2",
        OutOfLineINL_java_lang_invoke_NativeMethodHandle_initJ9NativeCalloutDataRef },
    { "Java_java_lang_invoke_NativeMethodHandle_freeJ9NativeCalloutDataRef__",
        OutOfLineINL_java_lang_invoke_NativeMethodHandle_freeJ9NativeCalloutDataRef },
#endif /* defined(J9VM_OPT_PANAMA) */
};

static UDATA inlIntercept(J9VMThread* currentThread, J9Method* nativeMethod, const char* symbolName)
{
    ...
    for (UDATA i = 0; i < sizeof(outOfLineINLmappings) / sizeof(J9OutOfLineINLMapping); ++i) {
        if (0 == strcmp(symbolName, outOfLineINLmappings[i].nativeName)) {
            ...
            if (((UDATA)functionAddress) & (J9JNIREDIRECT_REQUIRED_ALIGNMENT - 1)) {
                functionAddress = alignJNIAddress(
                    currentThread->javaVM, functionAddress, J9_CLASS_FROM_METHOD(nativeMethod)->classLoader);
...
static void nativeSignature(J9Method* nativeMethod, char* resultBuffer)
{
    ...
    methodSig = J9ROMMETHOD_GET_SIGNATURE(
        J9_CLASS_FROM_METHOD(nativeMethod)->romClass, J9_ROM_METHOD_FROM_RAM_METHOD(nativeMethod));
    ...
    while (i < J9UTF8_LENGTH(methodSig)) {
        ...
        case 'L':
            nextType = 'L';
            while (J9UTF8_DATA(methodSig)[i++] != ';') {
            } /* a type string - loop scanning for ';' to end it - i points past ';' when done loop */
            break;
        case 'Z':
            nextType = 'Z';
            break;
...
void* alignJNIAddress(J9JavaVM* vm, void* address, J9ClassLoader* classLoader)
{
    ...
    if ((block == NULL) || ((block->end - block->alloc) < J9JNIREDIRECT_SEQUENCE_ALIGNMENT)) {
        ...
        block = (J9JNIRedirectionBlock*)j9vmem_reserve_memory(NULL, J9JNIREDIRECT_BLOCK_SIZE, &identifier,
        ...
        block->alloc = (U_8*)((((UDATA)(block + 1)) + (J9JNIREDIRECT_SEQUENCE_ALIGNMENT - 1))
            & ~(J9JNIREDIRECT_SEQUENCE_ALIGNMENT - 1));
        block->end = ((U_8*)block) + J9JNIREDIRECT_BLOCK_SIZE;
        classLoader->jniRedirectionBlocks = block;
        TRIGGER_J9HOOK_VM_DYNAMIC_CODE_LOAD(
            vm->hookInterface, currentVMThread(vm), NULL, block, J9JNIREDIRECT_BLOCK_SIZE, "JNI trampoline area", NULL);
    }
...
{
    vm->nativeMethodBindTable = hashTableNew(OMRPORT_FROM_J9PORT(vm->portLibrary), "Native method bind table", 0,
        sizeof(J9NativeMethodBindEntry), 0, 0, OMRMEM_CATEGORY_VM, nativeMethodHash, nativeMethodEqual, NULL, NULL);
    ...
    J9VMThread* currentThread, J9Method* nativeMethod, char* longJNI, char* shortJNI, UDATA bindJNINative)
{
    ...
    while (nativeLibrary != NULL) {
        UDATA rc = lookupNativeAddress(
            currentThread, nativeMethod, nativeLibrary, longJNI, shortJNI, argCount, bindJNINative);
        if (J9_NATIVE_METHOD_IS_BOUND(nativeMethod)) {
     ...
     */
    if (bindJNINative) {
        TRIGGER_J9HOOK_VM_LOOKUP_NATIVE_ADDRESS(
            vm->hookInterface, currentThread, nativeMethod, longJNI, shortJNI, argCount, lookupNativeAddress);
        if (J9_NATIVE_METHOD_IS_BOUND(nativeMethod)) {
            return J9_NATIVE_METHOD_BIND_SUCCESS;
        }
    }
 ...
 * \param bindJNINative Non-zero if JNI natives are allowed, zero for INL-only.
 */
static UDATA lookupNativeAddress(J9VMThread* currentThread, J9Method* nativeMethod, J9NativeLibrary* nativeLibrary,
    char* longJNI, char* shortJNI, UDATA functionArgCount, UDATA bindJNINative)
{
    UDATA lookupResult;
    ...
    if (bindJNINative) {
        lookupResult
            = (*nativeLibrary->bind_method)(currentThread, nativeLibrary, nativeMethod, shortJNI, argSignature);
        if (lookupResult == 0) {
            return J9_NATIVE_METHOD_BIND_SUCCESS;
        }
