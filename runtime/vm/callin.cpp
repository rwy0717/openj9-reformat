            ...
            if (J9ROMCLASS_IS_PRIMITIVE_TYPE(type->romClass)) {
                if (NULL != argObject) {
                    ...
                    if (type == intReflectClass) {
                        if ((argType == integerClass) || (argType == characterClass) || (argType == shortClass)
                            || (argType == byteClass)) {
                            goto pushSingle;
                        }
                        goto done;
...
static VMINLINE J9Method* mapVirtualMethod(
    J9VMThread* currentThread, J9Method* method, UDATA vTableOffset, J9Class* receiverClass)
{
...
static VMINLINE void javaOffloadSwitchOn(J9VMThread* currentThread)
{
...
static VMINLINE void javaOffloadSwitchOff(J9VMThread* currentThread)
{
#if defined(J9VM_OPT_JAVA_OFFLOAD_SUPPORT)
    J9JavaVM* vm = currentThread->javaVM;
...
static VMINLINE bool buildCallInStackFrame(
    J9VMThread* currentThread, J9VMEntryLocalStorage* newELS, bool returnsObject = false, bool releaseVMAccess = false)
{
        ...
        if ((IDATA)freeBytes < 0) {
            if (J9_ARE_NO_BITS_SET(currentThread->privateFlags, J9_PRIVATE_FLAGS_CONSTRUCTING_EXCEPTION)) {
                setCurrentExceptionNLS(
                    currentThread, J9VMCONSTANTPOOL_JAVALANGSTACKOVERFLOWERROR, J9NLS_VM_OS_STACK_OVERFLOW);
...
static void restoreCallInFrame(J9VMThread* currentThread)
{
    Assert_VM_mustHaveVMAccess(currentThread);
...
void JNICALL sendClinit(J9VMThread* currentThread, J9Class* clazz, UDATA reserved1, UDATA reserved2, UDATA reserved3)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, false, false)) {
        /* Lookup the method */
        J9Method* method = (J9Method*)javaLookupMethod(currentThread, clazz, (J9ROMNameAndSignature*)&clinitNameAndSig,
            NULL, J9_LOOK_STATIC | J9_LOOK_NO_CLIMB | J9_LOOK_NO_THROW | J9_LOOK_DIRECT_NAS);
        /* If the method was found, run it */
        if (NULL != method) {
            Trc_VM_sendClinit_forClass(currentThread, J9UTF8_LENGTH(J9ROMCLASS_CLASSNAME(clazz->romClass)),
...
void JNICALL sendLoadClass(J9VMThread* currentThread, j9object_t classLoaderObject, j9object_t classNameObject,
    UDATA reserved1, UDATA reserved2)
{
...
void JNICALL cleanUpAttachedThread(
    J9VMThread* currentThread, UDATA reserved1, UDATA reserved2, UDATA reserved3, UDATA reserved4)
{
...
void JNICALL handleUncaughtException(
    J9VMThread* currentThread, UDATA reserved1, UDATA reserved2, UDATA reserved3, UDATA reserved4)
{
...
void JNICALL initializeAttachedThreadImpl(
    J9VMThread* currentThread, const char* name, j9object_t* group, UDATA daemon, J9VMThread* initializee)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, false, true)) {
        ...
        if (NULL != cachedOOM) {
            ...
            }
            {
                ...
                j9object_t threadObject = mmFuncs->J9AllocateObject(
                    currentThread, J9VMJAVALANGTHREAD_OR_NULL(vm), J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
...
void JNICALL internalSendExceptionConstructor(J9VMThread* currentThread, J9Class* exceptionClass, j9object_t exception,
    j9object_t detailMessage, UDATA constructorIndex)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, false, false)) {
        ...
        J9Method* method = (J9Method*)javaLookupMethod(
            currentThread, exceptionClass, (J9ROMNameAndSignature*)nas, NULL, lookupFlags);
        /* If the requested constructor is not found, just use <init>(String)V with no detail message */
        if (NULL == method) {
            method = (J9Method*)javaLookupMethod(
                currentThread, exceptionClass, (J9ROMNameAndSignature*)&throwableNameAndSig, NULL, lookupFlags);
            detailMessage = NULL;
...
void JNICALL printStackTrace(
    J9VMThread* currentThread, j9object_t exception, UDATA reserved1, UDATA reserved2, UDATA reserved3)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, false, false)) {
        ...
        J9Method* method = (J9Method*)javaLookupMethod(currentThread, exceptionClass,
            (J9ROMNameAndSignature*)&printStackTraceNameAndSig, NULL, J9_LOOK_VIRTUAL | J9_LOOK_DIRECT_NAS);
    ...
    J9VMThread* currentThread, UDATA reserved1, UDATA reserved2, UDATA reserved3, UDATA reserved4)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, false, false)) {
        ...
        J9Method* method = (J9Method*)javaLookupMethod(currentThread, clazz,
            (J9ROMNameAndSignature*)&threadRunNameAndSig, NULL, J9_LOOK_VIRTUAL | J9_LOOK_DIRECT_NAS);
        /* If the method was found, run it (exception is already set if the method cannot be found) */
        if (NULL != method) {
            *--currentThread->sp = (UDATA)threadObject;
            currentThread->returnValue = J9_BCLOOP_RUN_METHOD;
...
void JNICALL runStaticMethod(
    J9VMThread* currentThread, U_8* className, J9NameAndSignature* selector, UDATA argCount, UDATA* arguments)
{
    ...
    J9VMEntryLocalStorage newELS;
    if (buildCallInStackFrame(currentThread, &newELS, false, true)) {
        J9Class* foundClass = internalFindClassUTF8(currentThread, className, strlen((char*)className),
            currentThread->javaVM->systemClassLoader, J9_FINDCLASS_FLAG_THROW_ON_FAIL);
        if (NULL != foundClass) {
            /* Initialize the class */
            initializeClass(currentThread, foundClass);
            if (!VM_VMHelpers::exceptionPending(currentThread)) {
                /* Look up the method */
                J9Method* method = (J9Method*)javaLookupMethod(currentThread, foundClass,
                    (J9ROMNameAndSignature*)selector, NULL, J9_LOOK_STATIC | J9_LOOK_DIRECT_NAS);
                /* If the method was found, run it (exception is already set if the method cannot be found) */
                if (NULL != method) {
...
void JNICALL internalRunStaticMethod(
    J9VMThread* currentThread, J9Method* method, BOOLEAN returnsObject, UDATA argCount, UDATA* arguments)
{
...
void JNICALL sendCheckPackageAccess(
    J9VMThread* currentThread, J9Class* clazz, j9object_t protectionDomain, UDATA reserved3, UDATA reserved4)
{
    ...
    J9VMThread* currentThread, UDATA reserved1, UDATA reserved2, UDATA reserved3, UDATA reserved4)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, false, true)) {
        ...
        currentThread->returnValue2
            = (UDATA)J9VMJAVALANGJ9VMINTERNALS_COMPLETEINITIALIZATION_METHOD(currentThread->javaVM);
        c_cInterpreter(currentThread);
        restoreCallInFrame(currentThread);
    }
...
static bool isAccessibleToAllModulesViaReflection(J9VMThread* currentThread, J9Class* clazz, bool javaBaseLoaded)
{
    ...
    if (!J9_IS_J9MODULE_UNNAMED(vm, module) && !J9_IS_J9MODULE_OPEN(module)) {
        if (javaBaseLoaded) {
            ...
            package
                = getPackageDefinitionWithName(currentThread, module, (U_8*)packageName, (U_16)packageNameLength, &err);
...
void JNICALL sendInit(
    J9VMThread* currentThread, j9object_t object, J9Class* senderClass, UDATA lookupOptions, UDATA reserved4)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, false, false)) {
        ...
        if (NULL == method) {
            ...
            method = (J9Method*)javaLookupMethod(currentThread, clazz, (J9ROMNameAndSignature*)&initNameAndSig,
                senderClass, J9_LOOK_VIRTUAL | J9_LOOK_DIRECT_NAS | lookupOptions);
...
void JNICALL sendInitCause(
    J9VMThread* currentThread, j9object_t receiver, j9object_t cause, UDATA reserved3, UDATA reserved4)
{
    Trc_VM_sendInitCause_Entry(currentThread);
    J9VMEntryLocalStorage newELS;
    if (buildCallInStackFrame(currentThread, &newELS, true, false)) {
        /* Look up initCause */
        J9Method* method = (J9Method*)javaLookupMethod(currentThread, J9OBJECT_CLAZZ(currentThread, receiver),
            (J9ROMNameAndSignature*)&initCauseNameAndSig, NULL,
            J9_LOOK_VIRTUAL | J9_LOOK_DIRECT_NAS | J9_LOOK_NO_THROW);
...
void JNICALL sendInitializationAlreadyFailed(
    J9VMThread* currentThread, J9Class* clazz, UDATA reserved2, UDATA reserved3, UDATA reserved4)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, true, false)) {
        ...
        *--currentThread->sp = (UDATA)J9VM_J9CLASS_TO_HEAPCLASS(clazz);
        currentThread->returnValue = J9_BCLOOP_RUN_METHOD;
        currentThread->returnValue2
            = (UDATA)J9VMJAVALANGJ9VMINTERNALS_INITIALIZATIONALREADYFAILED_METHOD(currentThread->javaVM);
        c_cInterpreter(currentThread);
        restoreCallInFrame(currentThread);
    }
...
void JNICALL sendRecordInitializationFailure(
    J9VMThread* currentThread, J9Class* clazz, j9object_t throwable, UDATA reserved3, UDATA reserved4)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, true, false)) {
        ...
        *--currentThread->sp = (UDATA)throwable;
        currentThread->returnValue = J9_BCLOOP_RUN_METHOD;
        currentThread->returnValue2
            = (UDATA)J9VMJAVALANGJ9VMINTERNALS_RECORDINITIALIZATIONFAILURE_METHOD(currentThread->javaVM);
        c_cInterpreter(currentThread);
        restoreCallInFrame(currentThread);
    }
...
void JNICALL sendFromMethodDescriptorString(
    J9VMThread* currentThread, J9UTF8* descriptor, J9ClassLoader* classLoader, J9Class* appendArgType, UDATA reserved4)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, true, false)) {
        ...
        J9JavaVM* vm = currentThread->javaVM;
        J9MemoryManagerFunctions const* const mmFuncs = vm->memoryManagerFunctions;
        j9object_t descriptorString
            = mmFuncs->j9gc_createJavaLangString(currentThread, J9UTF8_DATA(descriptor), J9UTF8_LENGTH(descriptor), 0);
        if (NULL != descriptorString) {
            ...
            *--currentThread->sp = (UDATA)J9VM_J9CLASS_TO_HEAPCLASS(appendArgType);
            currentThread->returnValue = J9_BCLOOP_RUN_METHOD;
            currentThread->returnValue2
                = (UDATA)J9VMJAVALANGINVOKEMETHODTYPE_VMRESOLVEFROMMETHODDESCRIPTORSTRING_METHOD(vm);
            c_cInterpreter(currentThread);
        }
        restoreCallInFrame(currentThread);
    }
...
void JNICALL sendResolveMethodHandle(J9VMThread* currentThread, UDATA cpIndex, J9ConstantPool* ramCP,
    J9Class* definingClass, J9ROMNameAndSignature* nameAndSig)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, true, false)) {
        ...
        j9object_t nameString
            = mmFuncs->j9gc_createJavaLangString(currentThread, J9UTF8_DATA(nameUTF), J9UTF8_LENGTH(nameUTF), 0);
        if (NULL != nameString) {
            J9UTF8* sigUTF = J9ROMNAMEANDSIGNATURE_SIGNATURE(nameAndSig);
            PUSH_OBJECT_IN_SPECIAL_FRAME(currentThread, nameString);
            j9object_t sigString
                = mmFuncs->j9gc_createJavaLangString(currentThread, J9UTF8_DATA(sigUTF), J9UTF8_LENGTH(sigUTF), 0);
...
void JNICALL sendForGenericInvoke(
    J9VMThread* currentThread, j9object_t methodHandle, j9object_t methodType, UDATA dropFirstArg, UDATA reserved4)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, true, false)) {
        ...
        *(I_32*)--currentThread->sp = (I_32)dropFirstArg;
        currentThread->returnValue = J9_BCLOOP_RUN_METHOD;
        currentThread->returnValue2
            = (UDATA)J9VMJAVALANGINVOKEMETHODHANDLE_FORGENERICINVOKE_METHOD(currentThread->javaVM);
        c_cInterpreter(currentThread);
        restoreCallInFrame(currentThread);
    }
...
void JNICALL sendResolveConstantDynamic(
    J9VMThread* currentThread, J9ConstantPool* ramCP, UDATA cpIndex, J9ROMNameAndSignature* nameAndSig, U_16* bsmData)
{
...
void JNICALL sendResolveInvokeDynamic(J9VMThread* currentThread, J9ConstantPool* ramCP, UDATA callSiteIndex,
            ...
            if (NULL != receiverObject) {
                *--currentThread->sp = (UDATA)receiverObject;
                ...
                if (NULL != j9clazz) {
                    ...
                    currentThread->javaVM->memoryManagerFunctions->j9gc_objaccess_recentlyAllocatedObject(
                        currentThread, receiverObject);
                }
            }
...
void JNICALL sidecarInvokeReflectMethodImpl(
    J9VMThread* currentThread, jobject methodRef, jobject recevierRef, jobjectArray argsRef, void* unused)
{
    ...
    if (buildCallInStackFrame(currentThread, &newELS, true, true)) {
        ...
        J9Class* returnType = J9VM_J9CLASS_FROM_HEAPCLASS(
            currentThread, J9VMJAVALANGREFLECTMETHOD_RETURNTYPE(currentThread, methodObject));
        J9JNIMethodID* methodID
            = currentThread->javaVM->reflectFunctions.idFromMethodObject(currentThread, methodObject);
        ...
        if (J9_ARE_ANY_BITS_SET(J9_ROM_METHOD_FROM_RAM_METHOD(method)->modifiers, J9AccStatic)) {
            ...
            }
            {
                ...
                if (!VM_VMHelpers::inlineCheckCast(receiverClass, declaringClass)) {
                    setCurrentExceptionNLS(currentThread, J9VMCONSTANTPOOL_JAVALANGILLEGALARGUMENTEXCEPTION,
                        J9NLS_VM_INVALID_RECEIVER_CLASS);
                    goto done;
                }
        ...
        }
        {
            ...
            UDATA pushRC = pushReflectArguments(
                currentThread, J9VMJAVALANGREFLECTMETHOD_PARAMETERTYPES(currentThread, methodObject), argsObject);
            switch (pushRC) {
            case 1:
                dropPendingSendPushes(currentThread);
                setCurrentExceptionNLS(currentThread, J9VMCONSTANTPOOL_JAVALANGILLEGALARGUMENTEXCEPTION,
                    J9NLS_VM_WRONG_NUMBER_OF_ARGUMENTS);
                goto done;
            case 2:
                dropPendingSendPushes(currentThread);
                setCurrentExceptionNLS(
                    currentThread, J9VMCONSTANTPOOL_JAVALANGILLEGALARGUMENTEXCEPTION, J9NLS_VM_INVALID_ARGUMENT_CLASS);
                goto done;
            }
        }
        {
            ...
            if (NULL == exception) {
                if (J9ROMCLASS_IS_PRIMITIVE_TYPE(returnType->romClass)) {
                    ...
                    if (returnType != vm->voidReflectClass) {
                        ...
                        j9object_t wrapperObject = vm->memoryManagerFunctions->J9AllocateObject(
                            currentThread, wrapperClass, J9_GC_ALLOCATE_OBJECT_NON_INSTRUMENTABLE);
                ...
                VM_VMHelpers::clearException(currentThread);
                /* stack is already clean */
                setCurrentException(currentThread,
                    J9VMCONSTANTPOOL_JAVALANGREFLECTINVOCATIONTARGETEXCEPTION + J9_EX_CTOR_THROWABLE,
                    (UDATA*)exception);
            }
        }
    done:
...
void JNICALL sidecarInvokeReflectConstructorImpl(
    J9VMThread* currentThread, jobject constructorRef, jobject recevierRef, jobjectArray argsRef, void* unused)
{
        ...
        *--currentThread->sp = (UDATA)receiverObject;
        {
            ...
            UDATA pushRC = pushReflectArguments(currentThread,
                J9VMJAVALANGREFLECTCONSTRUCTOR_PARAMETERTYPES(currentThread, constructorObject), argsObject);
            switch (pushRC) {
            case 1:
                dropPendingSendPushes(currentThread);
                setCurrentExceptionNLS(currentThread, J9VMCONSTANTPOOL_JAVALANGILLEGALARGUMENTEXCEPTION,
        ...
        {
            J9JNIMethodID* methodID
                = currentThread->javaVM->reflectFunctions.idFromConstructorObject(currentThread, constructorObject);
            /* Run the method */
            currentThread->returnValue = J9_BCLOOP_RUN_METHOD;
...
void JNICALL jitFillOSRBuffer(
    struct J9VMThread* currentThread, void* osrBlock, UDATA reserved1, UDATA reserved2, UDATA reserved3)
{
...
void JNICALL initializeAttachedThread(
    J9VMThread* currentThread, const char* name, j9object_t* group, UDATA daemon, J9VMThread* initializee)
{
