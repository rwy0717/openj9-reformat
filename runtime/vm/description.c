 ...
 */
static BOOLEAN isLeafField(J9ROMFieldShape* field)
{
...
/* Calculate total instance size, instance description bits, and leaf descriptions bits (if build flag enabled)
        ...
        Parameters:
                ...
                ramSuperClass: the parent class which already has an instance description, may be NULL (eg.
   java.lang.Object) storage: space to store the description if it does not fit in a slot
*/
    ...
    J9ROMFieldOffsetWalkState* walkState, J9ROMFieldOffsetWalkResult* walkResult)
{
...

    {
        ...
        ramClass->backfillOffset = sizeof(J9Object)
            + ((walkResult->backfillOffset == -1) ? walkResult->totalInstanceSize : walkResult->backfillOffset);
...
/* Calculate the lock offset for this class using the following heuristic
        ...
        Parameters:
                ...
                ramSuperClass: the parent class which already has an instance description, may be NULL
   (java.lang.Object) Returns:  one of NO_LOCKWORD_NEEDED, LOCKWORD_NEEDED or the offset of the lockword already present
   in a superclass
*/
UDATA
checkLockwordNeeded(J9JavaVM* vm, J9ROMClass* romClass, J9Class* ramSuperClass, U_32 walkFlags)
{
    ...
    /* See if we inherit a lockword from our superclass. If direct subclass of java.lang.Object then don't inherit
     * automatically!!! */
    ...
    if (J9UTF8_DATA_EQUALS(J9UTF8_DATA(className), J9UTF8_LENGTH(className), JAVA_LANG_CLASS_CLASSNAME,
            sizeof(JAVA_LANG_CLASS_CLASSNAME) - 1)) {
