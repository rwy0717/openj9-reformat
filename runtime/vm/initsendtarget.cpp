...
static VMINLINE bool initializeMethodRunAddressVarHandle(J9Method* method)
{
    ...
    if (((J9AccNative | J9AccPublic) & modifiers) == J9AccNative) {
        ...
        if (J9UTF8_LITERAL_EQUALS(
                J9UTF8_DATA(classNameUTF), J9UTF8_LENGTH(classNameUTF), "java/lang/invoke/VarHandleInternal")) {
...
void initializeMethodRunAddressNoHook(J9JavaVM* vm, J9Method* method)
{
    ...
    /* If the method is java/lang/Object.<init>()V, use J9_BCLOOP_SEND_TARGET_EMPTY_OBJ_CTOR or
