...
#define METHODID_CLASS_REF(methodID) \
    ((jclass) & (J9_CP_FROM_METHOD(((J9JNIMethodID*)(methodID))->method)->ramClass->classObject))
...
static void* getMethodOrFieldID(
    JNIEnv* env, jclass classReference, const char* name, const char* signature, UDATA flags);
...
#define GET_BOOLEAN_ARRAY_ELEMENTS \
    ((jboolean * (JNICALL*)(JNIEnv * env, jbooleanArray array, jboolean * isCopy)) getArrayElements)
#define GET_BYTE_ARRAY_ELEMENTS \
    ((jbyte * (JNICALL*)(JNIEnv * env, jbyteArray array, jboolean * isCopy)) getArrayElements)
#define GET_CHAR_ARRAY_ELEMENTS \
    ((jchar * (JNICALL*)(JNIEnv * env, jcharArray array, jboolean * isCopy)) getArrayElements)
#define GET_SHORT_ARRAY_ELEMENTS \
    ((jshort * (JNICALL*)(JNIEnv * env, jshortArray array, jboolean * isCopy)) getArrayElements)
#define GET_INT_ARRAY_ELEMENTS ((jint * (JNICALL*)(JNIEnv * env, jintArray array, jboolean * isCopy)) getArrayElements)
#define GET_LONG_ARRAY_ELEMENTS \
    ((jlong * (JNICALL*)(JNIEnv * env, jlongArray array, jboolean * isCopy)) getArrayElements)
#define GET_FLOAT_ARRAY_ELEMENTS \
    ((jfloat * (JNICALL*)(JNIEnv * env, jfloatArray array, jboolean * isCopy)) getArrayElements)
#define GET_DOUBLE_ARRAY_ELEMENTS \
    ((jdouble * (JNICALL*)(JNIEnv * env, jdoubleArray array, jboolean * isCopy)) getArrayElements)

#define RELEASE_BOOLEAN_ARRAY_ELEMENTS \
    ((void(JNICALL*)(JNIEnv * env, jbooleanArray array, jboolean * elems, jint mode)) releaseArrayElements)
#define RELEASE_BYTE_ARRAY_ELEMENTS \
    ((void(JNICALL*)(JNIEnv * env, jbyteArray array, jbyte * elems, jint mode)) releaseArrayElements)
#define RELEASE_CHAR_ARRAY_ELEMENTS \
    ((void(JNICALL*)(JNIEnv * env, jcharArray array, jchar * elems, jint mode)) releaseArrayElements)
#define RELEASE_SHORT_ARRAY_ELEMENTS \
    ((void(JNICALL*)(JNIEnv * env, jshortArray array, jshort * elems, jint mode)) releaseArrayElements)
#define RELEASE_INT_ARRAY_ELEMENTS \
    ((void(JNICALL*)(JNIEnv * env, jintArray array, jint * elems, jint mode)) releaseArrayElements)
#define RELEASE_LONG_ARRAY_ELEMENTS \
    ((void(JNICALL*)(JNIEnv * env, jlongArray array, jlong * elems, jint mode)) releaseArrayElements)
#define RELEASE_FLOAT_ARRAY_ELEMENTS \
    ((void(JNICALL*)(JNIEnv * env, jfloatArray array, jfloat * elems, jint mode)) releaseArrayElements)
#define RELEASE_DOUBLE_ARRAY_ELEMENTS \
    ((void(JNICALL*)(JNIEnv * env, jdoubleArray array, jdouble * elems, jint mode)) releaseArrayElements)

#define GET_BOOLEAN_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jbooleanArray array, jsize start, jsize len, jboolean * buf)) getArrayRegion)
#define GET_BYTE_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jbyteArray array, jsize start, jsize len, jbyte * buf)) getArrayRegion)
#define GET_CHAR_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jcharArray array, jsize start, jsize len, jchar * buf)) getArrayRegion)
#define GET_SHORT_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jshortArray array, jsize start, jsize len, jshort * buf)) getArrayRegion)
#define GET_INT_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jintArray array, jsize start, jsize len, jint * buf)) getArrayRegion)
#define GET_LONG_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jlongArray array, jsize start, jsize len, jlong * buf)) getArrayRegion)
#define GET_FLOAT_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jfloatArray array, jsize start, jsize len, jfloat * buf)) getArrayRegion)
#define GET_DOUBLE_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jdoubleArray array, jsize start, jsize len, jdouble * buf)) getArrayRegion)

#define SET_BOOLEAN_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jbooleanArray array, jsize start, jsize len, jboolean * buf)) setArrayRegion)
#define SET_BYTE_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jbyteArray array, jsize start, jsize len, jbyte * buf)) setArrayRegion)
#define SET_CHAR_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jcharArray array, jsize start, jsize len, jchar * buf)) setArrayRegion)
#define SET_SHORT_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jshortArray array, jsize start, jsize len, jshort * buf)) setArrayRegion)
#define SET_INT_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jintArray array, jsize start, jsize len, jint * buf)) setArrayRegion)
#define SET_LONG_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jlongArray array, jsize start, jsize len, jlong * buf)) setArrayRegion)
#define SET_FLOAT_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jfloatArray array, jsize start, jsize len, jfloat * buf)) setArrayRegion)
#define SET_DOUBLE_ARRAY_REGION \
    ((void(JNICALL*)(JNIEnv * env, jdoubleArray array, jsize start, jsize len, jdouble * buf)) setArrayRegion)
...
#define ARG(type, sig) (jvalues ? (jvalues++->sig) : va_arg(*(va_list*)args, type))
    ...
    sigChar = &J9UTF8_DATA(J9ROMMETHOD_GET_SIGNATURE(
        J9_CLASS_FROM_METHOD(method)->romClass, J9_ROM_METHOD_FROM_RAM_METHOD(method)))[1]; /* skip the opening '(' */
    ...
    for (;;) {
        ...
        case 'I':
            /* int type */
            *(I_32*)(--sp) = (I_32)(jint)ARG(
                jint, i); /* NOTE: jint may be larger than int, but jchar, jshort, etc, must be no larger than int */
            break;
...
static jboolean isDirectBuffer(JNIEnv* env, jobject buf)
{
    if (initDirectByteBufferCache(env) && (buf != NULL) && ((*(j9object_t*)buf) != NULL)) {
        ...
        if (env->IsInstanceOf(buf, javaVM->java_nio_Buffer)
            && env->IsInstanceOf(buf, javaVM->sun_nio_ch_DirectBuffer)) {
            return JNI_TRUE;
        }
    }
 ...
 */
static jclass JNICALL findClassAndCreateGlobalRef(JNIEnv* env, const char* className)
{
    jclass globalRef;
 ...
 */
static jboolean JNICALL initDirectByteBufferCacheSun(
    JNIEnv* env, jclass java_nio_Buffer, jclass java_nio_DirectByteBuffer)
{
    J9JavaVM* javaVM = ((J9VMThread*)env)->javaVM;
    ...
    if ((NULL != sun_nio_ch_DirectBuffer) && (NULL != java_nio_DirectByteBuffer_init)
...
static jobject JNICALL newDirectByteBuffer(JNIEnv* env, void* address, jlong capacity)
{
    ...
    result = env->NewObject(javaVM->java_nio_DirectByteBuffer, javaVM->java_nio_DirectByteBuffer_init,
        (jlong)(UDATA)address, actualCapacity);
...
/*		1) Private routine.  Used to create a jni local reference from an actual object pointer.
                2) We don't acquire VM access - if you have an object pointer in your hands, you had better already have
   it.
*/
...
static void JNICALL deleteGlobalRef(JNIEnv* env, jobject globalRef) { deallocateGlobalRef(env, globalRef, JNI_FALSE); }
...
static jboolean JNICALL exceptionCheck(JNIEnv* env) { return ((J9VMThread*)env)->currentException != NULL; }
...
void initializeJNITable(J9JavaVM* vm) { vm->jniFunctionTable = GLOBAL_TABLE(EsJNIFunctions); }
...
void JNICALL j9jni_deleteGlobalRef(JNIEnv* env, jobject globalRef, jboolean isWeak)
{
    ...
    if (globalRef != NULL) {
        ...
        if (J9_EXTENDED_RUNTIME_USER_REALTIME_ACCESS_BARRIER
            == (vm->extendedRuntimeFlags & J9_EXTENDED_RUNTIME_USER_REALTIME_ACCESS_BARRIER)) {
...
jobject JNICALL j9jni_createGlobalRef(JNIEnv* env, j9object_t object, jboolean isWeak)
{
    ...
    if (result != NULL) {
        /* Initialize the ref under mutex as a concurrent collector may read from the slot as soon as we release the
         * mutex */
        *result = object;
    }
...
retry:
    ...
    if (!isField) {
        ...
        if (isStatic) {
            void* fieldAddress = staticFieldAddress(vmThread, clazz, (U_8*)name, strlen(name), (U_8*)signature,
                strlen(signature), &declaringClass, &element, 0, NULL);
            ...
            offset = instanceFieldOffset(vmThread, clazz, (U_8*)name, strlen(name), (U_8*)signature, strlen(signature),
                &declaringClass, &element, 0);
    ...
    if (declaringClass) {
        ...
        if (declaringClass->initializeStatus != J9ClassInitSucceeded
            && declaringClass->initializeStatus != (UDATA)vmThread) {
    ...
    TRIGGER_J9HOOK_VM_LOOKUP_JNI_ID(
        vmThread->javaVM->hookInterface, vmThread, classReference, name, signature, (U_8)isStatic, (U_8)isField, id);
...
static UDATA jniPushFrame(J9VMThread* vmThread, UDATA type, UDATA capacity)
{
    ...
    if (vmThread->jniReferenceFrames == NULL) {
        if ((vmThread->jniReferenceFrames = pool_new(sizeof(struct J9JNIReferenceFrame), 16, 0, POOL_NO_ZERO,
                 J9_GET_CALLSITE(), J9MEM_CATEGORY_JNI, POOL_FOR_PORT(javaVM->portLibrary)))
            == NULL) {
            goto exit;
        }
    }
    ...
    if (frame) {
        ...
        frame->references = pool_new(sizeof(UDATA), capacity, sizeof(UDATA), POOL_NO_ZERO, J9_GET_CALLSITE(),
            J9MEM_CATEGORY_JNI, POOL_FOR_PORT(javaVM->portLibrary));
        if (frame->references) {
...
static jstring JNICALL newString(JNIEnv* env, const jchar* uchars, jsize len)
{
    ...
    if (len < 0) {
        ...
        j9object_t stringObject = vmThread->javaVM->memoryManagerFunctions->j9gc_createJavaLangString(
            vmThread, (U_8*)uchars, ((UDATA)len) * 2, J9_STR_UNICODE);
...
static jboolean JNICALL isInstanceOf(JNIEnv* env, jobject obj, jclass clazz)
{
    ...
    if (obj != NULL) {
        ...
        object = *(j9object_t*)obj;
        if (object != NULL) {
            result = (jboolean)VM_VMHelpers::inlineCheckCast(
                J9OBJECT_CLAZZ(vmThread, object), J9VM_J9CLASS_FROM_JCLASS(vmThread, clazz));
        }
        VM_VMAccess::inlineExitVMToJNI(vmThread);
    }
...
void** ensureJNIIDTable(J9VMThread* currentThread, J9Class* clazz)
{
    ...
    if (classLoader->jniIDs == NULL) {
        J9Pool* idPool = pool_new(sizeof(J9GenericJNIID), 16, 0, 0, J9_GET_CALLSITE(), J9MEM_CATEGORY_JNI,
...
J9Method* findJNIMethod(J9VMThread* currentThread, J9Class* clazz, char* name, char* signature)
{
    ...
    while (count != 0) {
        ...
        if ((J9UTF8_LENGTH(methodSignature) == signatureLength) && (J9UTF8_LENGTH(methodName) == nameLength)
    ...
    while (scan_start < scan_limit) {
        ...
        if (try_scan(&scan_start, "help")) {
            /*
                    ...
                    J9NLS_VM_XJNI_OPTIONS_2=\   -Xjni:arrayCacheMax=[<x>|unlimited] set maximum size of JNI cached
               array\n
            */
...
#define JAVA_PACKAGE_NAME_LENGTH 5 /* Number of characters in "java/" */
        ...
        if (!errorOccurred && (JAVA_PACKAGE_NAME_LENGTH < classNameLength)) { /* className includes the package name */
            ...
            if (0 == memcmp(javaPackageName, className, JAVA_PACKAGE_NAME_LENGTH)) {
                ...
                PORT_ACCESS_FROM_JAVAVM(vm);
                char* msgChars = NULL;
                const char* nlsMsgFormat
                    = j9nls_lookup_message(J9NLS_DO_NOT_PRINT_MESSAGE_TAG | J9NLS_DO_NOT_APPEND_NEWLINE,
                        J9NLS_VM_EXCEPTION_DEFINECLASS_IN_PROTECTED_SYSTEM_PACKAGE, NULL);
                ...
                if (NULL != nlsMsgFormat) {
                    ...
                    if (NULL != msgChars) {
                        j9str_printf(PORTLIB, msgChars, msgCharLength, nlsMsgFormat, classNameLength, className,
                            JAVA_PACKAGE_NAME_LENGTH, javaPackageName);
                    }
                }

                setCurrentExceptionUTF(currentThread, J9VMCONSTANTPOOL_JAVALANGSECURITYEXCEPTION, msgChars);
        ...
        if (!errorOccurred) {
            ...
            if (NULL == dynamicLoadBuffers) {
                ...
                setCurrentExceptionUTF(
                    currentThread, J9VMCONSTANTPOOL_JAVALANGNOCLASSDEFFOUNDERROR, "dynamic loader is unavailable");
            } else {
                ...
                clazz = dynamicLoadBuffers->internalDefineClassFunction(currentThread, className, classNameLength,
                    (U_8*)buf, (UDATA)bufLen, NULL, classLoader, NULL, J9_FINDCLASS_FLAG_THROW_ON_FAIL, NULL, NULL,
                    &localBuffer);
...
{
    J9VMThread* vmThread = (J9VMThread*)env;
    return vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_jniGetPrimitiveArrayCritical(
        vmThread, array, isCopy);
}

static void JNICALL releasePrimitiveArrayCritical(JNIEnv* env, jarray array, void* elems, jint mode)
{
    J9VMThread* vmThread = (J9VMThread*)env;
    vmThread->javaVM->memoryManagerFunctions->j9gc_objaccess_jniReleasePrimitiveArrayCritical(
        vmThread, array, elems, mode);
}
