 ...
 */
J9VMDllLoadInfo* createLoadInfo(
    J9PortLibrary* portLibrary, J9Pool* aPool, char* name, U_32 flags, void* methodPointer, UDATA verboseFlags)
{
    ...
    returnVal->j9vmdllmain
        = (flags & (NOT_A_LIBRARY | BUNDLED_COMP)) ? (IDATA(*)(struct J9JavaVM*, IDATA, void*))methodPointer : NULL;
    return returnVal;
}
...
{
    return (jniVersion == JNI_VERSION_1_1) || (jniVersion == JNI_VERSION_1_2) || (jniVersion == JNI_VERSION_1_4)
        || (jniVersion == JNI_VERSION_1_6) || (jniVersion == JNI_VERSION_1_8) || (jniVersion == JNI_VERSION_9)
