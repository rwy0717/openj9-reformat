...
J9Method* getForwardedMethod(J9VMThread* currentThread, J9Method* method)
{
    ...
    while (J9ROMMETHOD_IS_FORWARDER(currentROMMethod)) {
        ...
        currentMethod = (J9Method*)javaLookupMethod(
            currentThread, lookupClass, nameAndSig, currentClass, J9_LOOK_VIRTUAL | J9_LOOK_NO_JAVA);
...
mustReportEnterStepOrBreakpoint(J9JavaVM* vm)
{
    ...
    return ((*hookInterface)->J9HookDisable(hookInterface, J9HOOK_VM_METHOD_ENTER) != 0)
