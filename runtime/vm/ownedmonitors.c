...
static IDATA getJNIMonitors(J9VMThread* currentThread, J9VMThread* targetThread, J9ObjectMonitorInfo* minfoStart,
    J9ObjectMonitorInfo* minfoEnd);
...
getOwnedObjectMonitors(J9VMThread* currentThread, J9VMThread* targetThread, J9ObjectMonitorInfo* info, IDATA infoLen)
{
    ...
    walkState.flags = J9_STACKWALK_VISIBLE_ONLY | J9_STACKWALK_INCLUDE_NATIVES | J9_STACKWALK_SKIP_INLINES
...
static IDATA getJNIMonitors(
    J9VMThread* currentThread, J9VMThread* targetThread, J9ObjectMonitorInfo* firstInfo, J9ObjectMonitorInfo* lastInfo)
{
    IDATA count = 0;
