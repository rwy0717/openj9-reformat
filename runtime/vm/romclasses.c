...
#define INLINE_UTF(name, value)      \
    struct {                         \
        U_16 length;                 \
        U_8 data[sizeof(value) - 1]; \
    } name
 ...
 */
static void initializeArrayROMClass(
    J9ROMArrayClass* romClass, J9UTF8* className, U_32 arrayShape, U_32 instanceShape, U_32 size)
{
 ...
 * @param size[in] the size for the ROM class
 */
static void initializeBaseTypeROMClass(
    J9ROMReflectClass* romClass, J9UTF8* className, U_32 typeCode, U_32 instanceShape, U_32 elementSize, U_32 size)
{
    romClass->romSize = size;
    NNSRP_SET(romClass->className, className);
...
void initializeROMClasses(J9JavaVM* vm)
{
    ...
    initializeArrayROMClass(&arrayROMClasses.objectArrayROMClass, (J9UTF8*)&arrayROMClasses.objectArrayClassName,
        sizeof(fj9object_t) == 4 ? J9ArraySizeLongs : J9ArraySizeDoubles, OBJECT_HEADER_SHAPE_POINTERS,
        sizeof(J9ROMArrayClass));
    initializeArrayROMClass(&arrayROMClasses.booleanArrayROMClass, (J9UTF8*)&arrayROMClasses.booleanArrayClassName,
        J9ArraySizeBytes, OBJECT_HEADER_SHAPE_BYTES, sizeof(J9ROMArrayClass));
    initializeArrayROMClass(&arrayROMClasses.charArrayROMClass, (J9UTF8*)&arrayROMClasses.charArrayClassName,
        J9ArraySizeWords, OBJECT_HEADER_SHAPE_WORDS, sizeof(J9ROMArrayClass));
    initializeArrayROMClass(&arrayROMClasses.floatArrayROMClass, (J9UTF8*)&arrayROMClasses.floatArrayClassName,
        J9ArraySizeLongs, OBJECT_HEADER_SHAPE_LONGS, sizeof(J9ROMArrayClass));
    initializeArrayROMClass(&arrayROMClasses.doubleArrayROMClass, (J9UTF8*)&arrayROMClasses.doubleArrayClassName,
        J9ArraySizeDoubles, OBJECT_HEADER_SHAPE_DOUBLES, sizeof(J9ROMArrayClass));
    initializeArrayROMClass(&arrayROMClasses.byteArrayROMClass, (J9UTF8*)&arrayROMClasses.byteArrayClassName,
        J9ArraySizeBytes, OBJECT_HEADER_SHAPE_BYTES, sizeof(J9ROMArrayClass));
    initializeArrayROMClass(&arrayROMClasses.shortArrayROMClass, (J9UTF8*)&arrayROMClasses.shortArrayClassName,
        J9ArraySizeWords, OBJECT_HEADER_SHAPE_WORDS, sizeof(J9ROMArrayClass));
    initializeArrayROMClass(&arrayROMClasses.intArrayROMClass, (J9UTF8*)&arrayROMClasses.intArrayClassName,
        J9ArraySizeLongs, OBJECT_HEADER_SHAPE_LONGS, sizeof(J9ROMArrayClass));
    initializeArrayROMClass(&arrayROMClasses.longArrayROMClass, (J9UTF8*)&arrayROMClasses.longArrayClassName,
        J9ArraySizeDoubles, OBJECT_HEADER_SHAPE_DOUBLES,
        sizeof(J9ArrayROMClasses) - offsetof(J9ArrayROMClasses, longArrayROMClass));
    ...
    baseTypePrimitiveROMClasses.header.romSize
        = sizeof(baseTypePrimitiveROMClasses) - sizeof(baseTypePrimitiveROMClasses.header);
    ...
    initializeBaseTypeROMClass(&baseTypePrimitiveROMClasses.voidReflectROMClass,
        (J9UTF8*)&baseTypePrimitiveROMClasses.voidClassName, J9VMCONSTANTPOOL_JAVALANGOBJECT, OBJECT_HEADER_SHAPE_MIXED,
        0, sizeof(J9ROMReflectClass));
    initializeBaseTypeROMClass(&baseTypePrimitiveROMClasses.booleanReflectROMClass,
        (J9UTF8*)&baseTypePrimitiveROMClasses.booleanClassName, J9VMCONSTANTPOOL_JAVALANGBOOLEAN,
        OBJECT_HEADER_SHAPE_BYTES, 1, sizeof(J9ROMReflectClass));
    initializeBaseTypeROMClass(&baseTypePrimitiveROMClasses.charReflectROMClass,
        (J9UTF8*)&baseTypePrimitiveROMClasses.charClassName, J9VMCONSTANTPOOL_JAVALANGCHARACTER,
        OBJECT_HEADER_SHAPE_WORDS, 2, sizeof(J9ROMReflectClass));
    initializeBaseTypeROMClass(&baseTypePrimitiveROMClasses.floatReflectROMClass,
        (J9UTF8*)&baseTypePrimitiveROMClasses.floatClassName, J9VMCONSTANTPOOL_JAVALANGFLOAT, OBJECT_HEADER_SHAPE_LONGS,
        4, sizeof(J9ROMReflectClass));
    initializeBaseTypeROMClass(&baseTypePrimitiveROMClasses.doubleReflectROMClass,
        (J9UTF8*)&baseTypePrimitiveROMClasses.doubleClassName, J9VMCONSTANTPOOL_JAVALANGDOUBLE,
        OBJECT_HEADER_SHAPE_DOUBLES, 8, sizeof(J9ROMReflectClass));
    initializeBaseTypeROMClass(&baseTypePrimitiveROMClasses.byteReflectROMClass,
        (J9UTF8*)&baseTypePrimitiveROMClasses.byteClassName, J9VMCONSTANTPOOL_JAVALANGBYTE, OBJECT_HEADER_SHAPE_BYTES,
        1, sizeof(J9ROMReflectClass));
    initializeBaseTypeROMClass(&baseTypePrimitiveROMClasses.shortReflectROMClass,
        (J9UTF8*)&baseTypePrimitiveROMClasses.shortClassName, J9VMCONSTANTPOOL_JAVALANGSHORT, OBJECT_HEADER_SHAPE_WORDS,
        2, sizeof(J9ROMReflectClass));
    initializeBaseTypeROMClass(&baseTypePrimitiveROMClasses.intReflectROMClass,
        (J9UTF8*)&baseTypePrimitiveROMClasses.intClassName, J9VMCONSTANTPOOL_JAVALANGINTEGER, OBJECT_HEADER_SHAPE_LONGS,
        4, sizeof(J9ROMReflectClass));
    initializeBaseTypeROMClass(&baseTypePrimitiveROMClasses.longReflectROMClass,
        (J9UTF8*)&baseTypePrimitiveROMClasses.longClassName, J9VMCONSTANTPOOL_JAVALANGLONG, OBJECT_HEADER_SHAPE_DOUBLES,
        8, sizeof(J9BaseTypePrimitiveROMClasses) - offsetof(J9BaseTypePrimitiveROMClasses, longReflectROMClass));
}
...
internalCreateBaseTypePrimitiveAndArrayClasses(J9VMThread* currentThread)
{
    ...
    for (i = 0; i < TYPE_COUNT; ++i) {
        ...
        ramClass = internalCreateRAMClassFromROMClass(currentThread, /* currentThread */
