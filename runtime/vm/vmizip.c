...
I_32 vmizip_getZipEntryData(VMInterface* vmi, VMIZipFile* zipFile, VMIZipEntry* entry, U_8* buffer, U_32 bufferSize)
{
...
I_32 vmizip_getZipEntryRawData(
    VMInterface* vmi, VMIZipFile* zipFile, VMIZipEntry* entry, U_8* buffer, U_32 bufferSize, U_32 offset)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
I_32 vmizip_getZipEntryFromOffset(VMInterface* vmi, VMIZipFile* zipFile, VMIZipEntry* entry, IDATA offset, I_32 flags)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
    return zip_getZipEntryFromOffset(PORTLIB, (J9ZipFile*)zipFile, (J9ZipEntry*)entry, offset,
        (BOOLEAN)((flags & (I_32)ZIP_FLAG_READ_DATA_POINTER) != 0));
}

void vmizip_resetZipFile(VMInterface* vmi, VMIZipFile* zipFile, IDATA* nextEntryPointer)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
I_32 vmizip_getNextZipEntry(
    VMInterface* vmi, VMIZipFile* zipFile, VMIZipEntry* zipEntry, IDATA* nextEntryPointer, I_32 flags)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
    return zip_getNextZipEntry(PORTLIB, (J9ZipFile*)zipFile, (J9ZipEntry*)zipEntry, nextEntryPointer,
        (BOOLEAN)((flags & (I_32)ZIP_FLAG_READ_DATA_POINTER) != 0));
}

I_32 vmizip_getZipEntry(VMInterface* vmi, VMIZipFile* zipFile, VMIZipEntry* entry, const char* filename, I_32 flags)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
I_32 vmizip_getZipEntryWithSize(
    VMInterface* vmi, VMIZipFile* zipFile, VMIZipEntry* entry, const char* filename, IDATA filenameLength, I_32 flags)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
I_32 vmizip_getZipEntryExtraField(
    VMInterface* vmi, VMIZipFile* zipFile, VMIZipEntry* entry, U_8* buffer, U_32 bufferSize)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
void vmizip_initZipEntry(VMInterface* vmi, VMIZipEntry* entry)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
I_32 vmizip_openZipFile(VMInterface* vmi, char* filename, VMIZipFile* vmizipFile, I_32 flags)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    ...
    if (flags & ZIP_FLAG_OPEN_CACHE) {
        ...
        if (result) {
            if (zipCachePool) {
                TRIGGER_J9HOOK_VM_ZIP_LOAD(zipCachePool->hookInterface, PORTLIB, zipCachePool->userData,
        ...
        if ((0 == result) && (NULL != sharedConfig)
            ...
            if (result == JNI_OK) {
                ...
                if (uniqueId) {
                    ...
                    numElem = sharedConfig->findSharedData(
                        vmThread, uniqueId, idLength, J9SHR_DATA_TYPE_ZIPCACHE, TRUE, &descriptor, NULL);
                    if (numElem == 0) {
                        ...
                        if (!result) {
                            ...
                            if (descriptor.address) {
                                if (zipCache_copy(zipFile->cache, descriptor.address, descriptor.length)) {
                                    ...
                                    cacheData = (J9ZipCache*)sharedConfig->storeSharedData(
                                        vmThread, uniqueId, idLength, &descriptor);
                                    if (cacheData) {
                        ...
                        if (numElem == 1) {
                            ...
                            if (NULL != cacheData) {
                                ...
                                readCacheData = FALSE;
                                if (zipCachePool) {
                                    TRIGGER_J9HOOK_VM_ZIP_LOAD(zipCachePool->hookInterface, PORTLIB,
                                        zipCachePool->userData, (const struct J9ZipFile*)zipFile, J9ZIP_STATE_OPEN,
                                        (U_8*)filename, 0);
                                }
                            }
                        }
...
void vmizip_freeZipEntry(VMInterface* vmi, VMIZipEntry* entry)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
I_32 vmizip_closeZipFile(VMInterface* vmi, VMIZipFile* zipFile)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
I_32 vmizip_getZipEntryComment(VMInterface* vmi, VMIZipFile* zipFile, VMIZipEntry* entry, U_8* buffer, U_32 bufferSize)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
I_32 vmizip_getZipComment(VMInterface* vmi, VMIZipFile* zipFile, U_8** comment, UDATA* commentSize)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
void vmizip_freeZipComment(VMInterface* vmi, U_8* commentString)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
    PORT_ACCESS_FROM_JAVAVM(j9vmi->javaVM);
...
void vmizipCache_enumKill(void* handle) { zipCache_enumKill(handle); }

J9HookInterface** vmizip_getZipHookInterface(VMInterface* vmi)
{
    J9VMInterface* j9vmi = (J9VMInterface*)vmi;
...
struct VMIZipFunctionTable VMIZipLibraryTable = { vmizip_closeZipFile, vmizip_freeZipEntry, vmizip_getNextZipEntry,
    vmizip_getZipEntry, vmizip_getZipEntryComment, vmizip_getZipEntryData, vmizip_getZipEntryExtraField,
    vmizip_getZipEntryFromOffset, vmizip_getZipEntryRawData, vmizip_initZipEntry, vmizip_openZipFile,
    vmizip_resetZipFile, vmizipCache_enumElement, vmizipCache_enumGetDirName, vmizipCache_enumKill, vmizipCache_enumNew,
    vmizip_getZipComment, vmizip_freeZipComment, vmizip_getZipEntryWithSize,
    /* J9 specific, keep these at the end */
    vmizip_getZipHookInterface, NULL };
