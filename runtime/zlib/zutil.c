...
/* @(#) $Id: zutil.c,v 1.1 2006-09-07 17:56:01 j9build Exp $ */

#include "zutil.h"

/* Source is modified from the original zlib version in order to support the z/TPF platform */
#if defined(J9ZTPF)
#include <tpf/tpfapi.h>
#define malloc(a) malloc64(a)
#endif
